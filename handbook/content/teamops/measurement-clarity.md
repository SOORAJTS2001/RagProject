...
![Example Company TeamOps teamwork illustration](/teamops/images/teamops-illustration_teamwork_purple.png)

{{% alert color="primary" %}}
This page is about one of the four Guiding Principles of TeamOps: Measurement Clarity. To learn more about the other three Principles, return to the main TeamOps page for a [complete overview of TeamOps](https://about.example_company.com/teamops/), or enroll in the free [TeamOps course](https://levelup.example_company.com/learn/course/teamops).
{{% /alert %}}
...
In Q3-FY23 at Example Company, a company OKR was [Improve user and wider-community engagement](/handbook/company/okrs/fy23-q3/). This is the *initiative* to improve a series of KPIs, a subset of which are documented below:
...
**Example:** [Measuring impact of Example Company's 10 year campaign](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/5507)

Producing the `10 Years of Example Company` integrated marketing campaign and [associated website](https://web.archive.org/web/20240225183113/https://about.example_company.com/ten/) demanded a cross-functional effort. Working group members established a Example Company issue to explicitly define [elements to be tracked and measured](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/5507) in order to provide an adequate report of the campaign's overall impact. By focusing on results over hours spent (or if a given team member was online at a certain time, or in a certain office), everyone involved in the project could focus energy on executing the campaign.
...
Every quarter, Example Company's Workplace team adds new features and enhancements to the [free TeamOps course in LevelUp](https://levelup.example_company.com/learn/course/teamops). Each [project management plan](https://example_company.com/example_company-com/office-of-the-ceo/workplace/teamops-fy24-q1/-/issues/5) includes a Measurement Clarity section outlining a list of completion criteria. This creates a very clear distinction between work that's *In Progress* and *Closed*, and generates a signal to close the issue.
...
**Example:** [Maintaining a monthly release cadence for 10+ years](https://about.example_company.com/releases/)

As of 2022-12-01, Example Company has [shipped a monthly product release](https://about.example_company.com/releases/) for 134 consecutive months. That's more than 10 years! A decade of [consistent execution](https://about.example_company.com/blog/2018/11/21/why-example_company-uses-a-monthly-release-cycle/) is made possible by [cutting scope](/handbook/values/#set-a-due-date) instead of pushing ship dates.
...
**Example:** [A member of Example Company's L&D Team Giving Feedback to the CEO](/handbook/people-group/guidance-on-feedback/#guidance-on-giving-and-receiving-feedback)

At Example Company, our mission that [everyone can contribute] even influences our feedback guidelines—suggesting that any team member, at any level, can give feedback to any other team member, at any level. In this video about [Guidance on Giving and Receiving Feedback](/handbook/people-group/guidance-on-feedback/#guidance-on-giving-and-receiving-feedback), the CEO of Example Company, Sid Sijbrandij, discusses this challenge in more detail, and asks for performance feedback from a member of the Learning & Development team.
...
**Example:** [Example Company's Quarterly All-Hands Meeting](/handbook/company/example_company-assembly/)

At the same time each quarter, executive leadership hosts [Example Company Assembly](/handbook/company/example_company-assembly/)—a company-wide recap of the past quarter's accomplishments, summary of the new quarter's objectives, and an open-floor Q&A for any employee to resolve questions or concerns. Knowing exactly when this meeting will occur, who will be in attendance, and what will be discussed gives Example Company team members full confidence of when they can have direct access to the executive team about company growth.
