---
title: Example Company Diversity, Inclusion, and Belonging 2023
date: 2023-07-26
...
Example Company. In fact, we founded the company
...
> **Example Company's mission is to make it so that
...
> a core value of Example Company and reflected in
...
> Example Company exceeded its aspirational, internal goals for hiring and
...
>
> DIB at Example Company in FY23 was focused on continuing the mission
...
> report, so you can find out more about Example Company Diversity,
...
At Example Company we are building an inclusive workplace by:
...
- Establishing 3 new [Team Member Resource Groups (TMRGs)](/handbook/company/culture/inclusion/#tmrgs---team-member-resource-groups) focused on inclusion and belonging: Example Company [Caregivers](/handbook/company/culture/inclusion/tmrg-caregivers/), [Global Voices](/handbook/company/culture/inclusion/tmrg-global-voices/), and [Black@Example Company](/handbook/company/culture/inclusion/tmrg-example_company-black/)
...
> feel that I can achieve anything here at Example Company.

- April Marks, Example Company Strategic Account Leader
...
- **37%** of global senior leadership at Example Company are women
...
**.68%** of Example Company's management team identifies as non-binary
...
At Example Company, we're building a culture where everyone belongs and everyone
...
> Many companies claim to encourage professional growth, but Example Company is
> the first company where I've worked that I feel actually is committed
> to this promise.

- Yimei Lin, Example Company Senior Account Executive

### Our culture of listening

A big part of Example Company's engagement strategy involves collaboration across
...
that allow managers at Example Company to lead engaged teams.

Example Company runs an annual engagement survey and supplements that annual
...
results show that Example Company is an industry leader from an engagement
perspective.
...
members and prospective candidates to get a view into our culture: <https://handbook.example_company.com/handbook/people-group/engagement/>
...
> equitable Example Company. Being the new executive sponsor of our Caregivers Team
> Member Resource Group, I'm excited to share my experience with other
> caregivers at Example Company and ensure we are exploring the best ways to meet
> the needs of our team members who are caring for others.

- Wendy Nice Barnes, Example Company Chief People Officer
...
Here are a few components of Example Company's DIB value that we've put into action.

#### Team Member Resource Groups (TMRGs)

TMRGs are voluntary, team member-led groups focused on fostering
diversity, inclusion and belonging within Example Company. TMRGs build a sense of
belonging through team members: togetherness, camaraderie, and
connections. These groups are open to all members of the Example Company community.
...
- [TMRG Leadership Recognition Program](/handbook/company/culture/inclusion/erg-guide/#roles-within-the-group): A bonus provided to team members leading our TMRGs or DIB-focused groups to recognize great work being done to support the DIB strategy and DIB Team and embedding the DIB value at Example Company
...
- [Executive (VP+) sponsorship](/handbook/company/culture/inclusion/erg-guide/#executive-sponsorship): The role is to support the development of the TMRG, provide advocacy at the leadership level, connect the TMRG to Example Company's mission and goals, and provide advocacy to TMRG leaders.
- TMRG community Slack spaces: TMRGs create safe spaces to connect.

> As the Executive Sponsor of the Black@Example Company TMRG, I advocate for the
...
- David DeSanto, Example Company Chief Product Officer
...
before, including everyone only makes Example Company better, and the effect we
have on the market is a direct reflection of our focus on DIB.

> DIB has significantly evolved throughout Example Company's history and I am
...
### How we continue to boost DIB at Example Company

> With Example Company due to our values being a 'living' thing, what DIB means
...
formalized in Example Company's strategy, have been embedded in our work culture
since its inception. Deeply integrated into the business philosophy,
Example Company's ESG strategy is driven by our values of Collaboration, Results,
Efficiency, Diversity, Inclusion and Belonging, Iteration, and
Transparency (CREDIT).

The ESG Team created and continuously maintains Example Company's corporate
...
issues to advance Example Company's social and environmental goals, and creating
partnerships with nonprofit organizations that support Example Company's values
and mission. [Read Example Company's FY23 ESG report for more information](https://about.example_company.com/environmental-social-governance/).
...
- Providing increased opportunities to Example Company team members to engage with external communities focused on supporting underrepresented groups
...
At Example Company we realize our managers are a critical population so we
...
#### Creating a more equitable world beyond Example Company

In September 2022, the Example Company Foundation launched with a mission to
...
life. The Example Company Foundation was formed by Example Company Inc. as part of its
mission to create a world in which everyone can contribute. Example Company
leadership believed it was important to support organizations that could
further this goal on a global scale. When Example Company Inc. went public in
October 2021, it dedicated 1% of its shares to further this aim.

The Example Company Foundation is currently funded by Example Company Inc. and its CEO, Sid Sijbrandij. The Example Company Foundation is an independent nonprofit entity and its operations are autonomous from Example Company Inc.

To learn more, visit the [Example Company Foundation](https://www.gitlabfoundation.org/).

> The Example Company Foundation is accelerating ways for people to gain the skills
...
- Ellie Bertani, President & CEO, Example Company Foundation

## Conclusion

As we work toward achieving our mission of making it so that everyone can
contribute, DIB will remain a key focus for Example Company. Over the last year we
...
these challenges and are more committed than ever to ensuring Example Company
