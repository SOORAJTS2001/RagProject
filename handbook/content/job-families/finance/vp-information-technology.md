...
The VP, IT is a [grade 12](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).

## Responsibilities

1. Build, hire, develop and manage a strong information technology team that lives Example Company's values.
...
1. Drive the evaluation, deployment, and management of the Example Company Corporate system architecture and make decisions on current and future IT systems.
...
1. Develop and execute the infrastructure for scale to lead Example Company through hyper growth
1. Be customer zero for Example Company product features that enable an IT organization. Build an engineering culture that contributes back to the Example Company product.
...
1. Ability to combine industry leading solutions with internal tools to create solutions that meet Example Company's unique needs
