...
The Customer Success Engineer (CSE) role provides deep subject matter expertise on Example Company technical and product solutions and best practices. CSEs work alongside CSMs to provide customers with technical guidance, go in-depth on use case implementation, and demonstrate the value of Example Company product capabilities.
...
- Experience with a Example Company use case (SCM, CI, CD, DevSecOps, Agile Planning) to provide in-depth customer guidance and enablement
- Proficiency using DevSecOps tools or highly technical tooling in adjacent fields
- Specialize in Example Company use cases to provide in-depth guidance and enablement to customers of all sizes, including large enterprise organizations
...
The Senior CSE is a job grade [level 7](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
The Staff CSE is a job grade [level 9](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Provides subject matter expertise within a defined technical Example Company product area or as a trusted advisor
...
- Helps ensure Example Company is listening and hearing our customers and can remain responsive to them
...
The Manager, CSE is a [grade 9](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
The Senior Manager, CSE is a [grade 9](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Aligned with the objectives of Example Company and is responsible for ensuring that the CSE team as a whole is contributing to our company objectives
