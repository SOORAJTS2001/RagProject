...
- Responsible for the application design, development and support of Example Company-related Professional Services projects
- Demonstrate progressive leadership in the full life cycle of the software development environment
- Responsible for the detailed design of Example Company-related projects from inception through production support
...
- Liaise with and support of other functional groups within Example Company – including (but not limited to) training, development, support, product, engineering
...
- Responsible for leading technical discovery sessions with customers, partners and Example Company PSEs to understand their business goals, technical constraints and requirements
...
- Stay up to date on new features, and fixes within the monthly Example Company product releases and disseminate key information to the PSE team
...
- Works across Example Company on product alignment
- Able to advise managers on complex projects or programs
- Ability to apply knowledge of fundamental concepts, practices, and procedures of Example Company Professional Services and related fields such as Infrastructure Engineering, DevOps Engineering, Data Engineering, and Agile Software Development
- Proven ability to contribute across Example Company and Professionals Service's entire product ecosystems
...
At Example Company, due to the pace at which we are moving, people joining our team will be expected to have significant professional experience in the primary engineering tools of their specialty. For Professional Services Architects, this means work and consulting experience using IaC/CaC technologies on one or more of the main cloud providers, as well as experience deploying, maintaining, and administering a Example Company instance.

### Job Grades

Read more about grades at Example Company [here](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades). As Professional Services falls under Customer Success, the specific grades are [here](/handbook/total-rewards/compensation/compensation-calculator/#customer-success)
