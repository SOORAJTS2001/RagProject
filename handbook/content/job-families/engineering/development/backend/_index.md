...
description: "Learn more about requirements and responsibilities for Backend Engineering roles at Example Company."
...
Some specialties within Example Company are using primary programming
...
The Junior Backend Engineer is a [grade 5](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).

### Backend Engineer

#### Job Grade

The Backend Engineer is a [grade 6](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Development and maintenance of Cloud Native Example Company deployment tooling and upgrade methods
- Support Omnibus Example Company package installations across multiple Linux based Operating Systems
...
performance through improving reliability, availability and performance of Example Company individual services and application as a whole.

#### Responsibilities

- Analyse existing, create and maintain new Example Company.com [Service Level Objectives](https://en.wikipedia.org/wiki/Service-level_objective) (SLOs).
