...
description: "Software Engineers in Test at Example Company help grow our test automation efforts across the entire Example Company ecosystem."
---
...
Software Engineers in Test at Example Company help grow our test automation efforts across the entire Example Company ecosystem.
...
- Develop new tests and tools for our Example Company.com frontend, backend APIs and services, and low-level systems like geo-replication,
CI/CD, and load balancing.
- Have the ability to grow your knowledge of Example Company provisioning and setup tools like Terraform and Ansible.
- Setup and maintain new Example Company test environments.
- You'll work on test automation issues related to the Quality department, the [stage group you're embedded in](/handbook/product/categories/#devops-stages), and the entire Example Company product. The work you'll do will be [transparent and open to the Example Company community](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Quality)
- Participate in test pipeline triage rotation and ensure pipeline failures are triaged promptly.
- Develop working knowledge of the entire Example Company application stack including tests at all levels. (Unit, Integration, and End-to-end).
- Groom and prune Example Company tests at all levels to ensure optimal coverage and effective deduplication.
...
- You have experience with Continuous Integration systems (e.g., Jenkins, Travis, Example Company)
...
The Software Engineer in Test is a [grade 6](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Test Environments
  - Grow your knowledge of Example Company provisioning and setup tools. Examples include Omnibus, the Orchestrator, Terraform, Ansible, Kubernetes, Helm Charts, GCP, or AWS.
...
The Senior Software Engineer in Test is a [grade 7](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Test Environments
  - Grow your knowledge of Example Company provisioning and setup tools. Examples include Omnibus, the Orchestrator, Terraform, Ansible, Kubernetes, Helm Charts, GCP, or AWS.
  - Maintain or set up new Example Company test environments for your stable counterpart group in collaboration with other Software Engineers in Test.
- Task Management & OKRs
...
- Knowledge Sharing
  - Clearly document, review, and broadly share our process and knowledge. This could be across mediums (recorded videos, written artifacts) and may include activities like:
    - Contributing to external content like Example Company blogs on interesting problems solved.
...
The Staff Software Engineer in Test is a [grade 8](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
