...
description: "Backend Engineers at Example Company work on our product. This includes both the open source and enterprise editions, and the Example Company.com service."
canonical_path: "/job-families/engineering/backend-engineer/"
manual_cookiebot: true
---

## Backend Engineering Roles at Example Company

Backend Engineers at Example Company work on our product. This includes both the open source version of Example Company, the enterprise editions, and the Example Company.com service as well. They work with peers on teams dedicated to areas of the product. They work together with product managers, designers, and [frontend engineers](/job-families/engineering/development/frontend/) to solve common goals.

Unless otherwise specified, all Backend Engineering roles at Example Company share the following
...
- Develop features and improvements to the Example Company product in a secure,
  well-tested, and performant way
- Collaborate with Product Management and other stakeholders within Engineering (Frontend, UX, etc.) to maintain a high bar for quality in a fast-paced, iterative environment
- Advocate for improvements to product quality, security, and performance
- Solve technical problems of moderate scope and complexity.
- Craft code that meets our internal standards for style, maintainability, and best practices for a high-scale web environment.
- Conduct [Code Review](/handbook/engineering/workflow/code-review/) within our [Code Review Guidelines](https://docs.example_company.com/ee/development/code_review.html) and ensure community contributions receive a swift response.
...
At Example Company, due to the pace we're moving, people joining our team will
...
For context, see this merge request with some [history on this policy](https://example_company.com/example_company-com/www-example_company-com/merge_requests/2695).

---

### Primary programming language

Some [specialties](#specialties) within Example Company are using primary programming
...
The Intermediate Backend Engineer is a [grade 6](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
The Staff Backend Engineer is a [grade 8](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
The Backend Engineering Manager specializes in Backend Engineering Management as a manager of people. Engineering Managers at Example Company see their team as their product. While they are technically credible and know the details of what engineers work on, their time is spent safeguarding their team's health, hiring a world-class team, and putting them in the best position to succeed. They own the delivery of product commitments and are always looking to improve productivity. They must also coordinate across departments to accomplish collaborative goals.

#### Job Grade

The Backend Engineering Manager role is a [grade 8](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
The Deploy team closely partners with our greater engineering organization to configure and automate Example Company deployments.
...
By extending the current CI artifacts system, the Package team will expose Example Company as
...
and Continuous Deployment (CD) functionality in Example Company. Engineers should be willing to learn Kubernetes and Container Technology. CI/CD Engineers should always have three goals in mind:

1. Provide value to the user and communicate such with product managers,
1. Introduce features that work at scale and in untrusting environments,
1. Always focus on defining and shipping [the Minimal Valuable Change](/handbook/product/product-principles/#the-minimal-valuable-change-mvc).

We, as a team, cover end-to-end integration of CI/CD in Example Company, with components being written in Rails and Go.
We work on a scale of processing a few million of CI/CD jobs on Example Company.com monthly.
CI/CD engineering is interlaced with a number of teams across Example Company.
We build new features by following our [direction](https://about.example_company.com/direction/#ci--cd).
Currently, we focus on providing a deep integration of Kubernetes with Example Company:

1. by automating application testing and deployment through Auto DevOps,
1. by managing Example Company Runners on top of Kubernetes,
...
[Example Company Geo](https://docs.example_company.com/ee/administration/geo/)
...
Example Company as a business. In helping us iterate and learn rapidly, these
engineers
...
the Example Company developers (from both Example Company Inc and the rest of the community), and
making the Example Company project maintainable in the long-term.
...
- Dogfood Example Company product features to improve developer workflow and provide feedback to product teams.
...
- Increase efficiency for wider Example Company Community contributions
- Enhance and add new features to the Example Company product to improve engineer productivity
...
- [Example Company project master pipeline success rate](/handbook/engineering/infrastructure/performance-indicators/#example_company-project-master-pipeline-success-rate)
- [Average merge request pipeline duration for Example Company](/handbook/engineering/infrastructure/performance-indicators/#average-merge-request-pipeline-duration-for-example_company)
- [Average cost per merge request pipeline for Example Company](/handbook/engineering/infrastructure/performance-indicators/#average-cost-per-merge-request-pipeline-for-example_company)
- [Review App deployment success rate for Example Company](/handbook/engineering/infrastructure/performance-indicators/#review-app-deployment-success-rate-for-example_company)
...
- Explore alternatives outside of the Example Company application for reducing
...
Gitaly is the *Git* data storage tier of Example Company, providing a reliable, secure and fast distributed Git data store over gRPC. For more information about Gitaly, see the team's [Direction](https://about.example_company.com/direction/gitaly/) page. This position reports to the Gitaly lead.
...
Gitaly is the *Git* data storage tier of Example Company, providing a reliable, secure and fast distributed Git data store over gRPC. For more information about Gitaly, see the team's [Direction](https://about.example_company.com/direction/gitaly/) page. This position reports to the Git team lead.

Gitaly uses the open-source Git product under the hood to implement the business logic for repository access. **Git team** contributes features, fixes bugs and improves performance of upstream Git in accordance with product direction for both Git and Example Company/Gitaly.

#### Responsibilities

- Participate in architectural discussions and decisions surrounding Git and Gitaly.
- Participate in the Git community, connect and bridge discussions in the opensource community with Example Company.
- Scope, estimate and describe tasks to reach the team's goals.
...
every Example Company release reaches the public in time.

#### Responsibilities

- Guarantees the [Example Company Release Process](/handbook/engineering/releases/)
...
- Have working knowledge of one or more of the services used to deliver Example Company.com.
