...
- Prioritizes and guides the effort to scope Example Company's Prometheus monitoring and alerting infrastructure
- Manage the bundling of Prometheus as an out-of-the-box monitoring solution for Example Company CE/EE packages
- Improve coverage of Example Company performance monitoring
- Prioritize features that enable measurement of applications deployed with Example Company
