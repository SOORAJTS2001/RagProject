...
Engineering Analysts at Example Company build and improve on the data capabilities needed to support a highly productive Engineering Division.
They equip Engineering leaders with metric intelligence and actionable performance indicators.
They work closely with Example Company's Data team to enable new data capabilities that drives our analysis and visualizations.
...
The Engineering Analyst is a [grade 6](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
The Senior Engineering Analyst is a [grade 7](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Deep understanding of how data is created and transformed into Sisense visualization at Example Company.
...
The Staff Engineering Analyst is a [grade 8](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Deep understanding of how data flows within Example Company and identify new data sources needed to unblock business objectives.
...
- Drive innovation across Example Company and research new data analytics methodologies with minimal guidance and support from other team members.
...
- Merge Request Rate (known as Throughput outside of Example Company)
- Review Efficiency
...
- Business & finance intuition, interface and guide non-engineering partners on cost & contract management:
  ...
  - Understand Sales pipeline and it's effect on Example Company.com Infrastructure.
- Deep understanding of Infrastructure data, common data framework, business processes and policies.
- Support Infrastructure with cost efficiency in service of Example Company.com and the rest of the company.
...
- Infrastructure Specialty:
  - [Infrastructure Cost per Example Company.com Monthly Active Users](/handbook/engineering/infrastructure/performance-indicators/#infrastructure-cost-per-example_company-com-monthly-active-users)
...
- Next, candidates will be invited to schedule a forth interview with an additional members of the Example Company Data Team.
