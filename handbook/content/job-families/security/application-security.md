...
description: "Application Security Engineers work closely with development teams, product managers (PM), and third-party groups to ensure that Example Company products are secure."
extra_js:
- libs/mermaid.min.js
---

## What's it like to work in security at Example Company?

🤝 Application Security Engineers work closely with development teams, product managers (PM), and third-party groups (including the paid bug bounty program) to ensure that Example Company products are secure.

🎉 **Hear from two team members about what it's like working here at Example Company in our Security department.** 🎉

*AppSec Engineer [Nick Malcolm](/handbook/company/team/#nmalcolm) talks about what makes him proud to work at Example Company and what makes the experience unique, as well as what helps someone succeed on the team.*

<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/DgJhvait4gI" frameborder="0" allowfullscreen="true"> </iframe>
</figure>

*[Andrew Kelly](/handbook/company/team/#ankelly), one of our former AppSec team managers talks about his experience here at Example Company, including what makes Example Company a unique and exciting place to learn and grow.*
...
This position reports to the [Security Manager, Application Security](#security-manager-application-security) role at Example Company.
...
This position reports to the [Product Security Director](/job-families/security/security-leadership/) role at Example Company.
...
- Drive the technical direction, roadmap, and [6-month architecture blueprints](/handbook/engineering/architecture/#architecture-at-example_company) of the Application Security program.
- Drive the business value relation of metrics calculations for the Application Security program.
- Represent the Application Security team across and outside of Example Company as a subject matter expert in technology, development, and application security concepts.
- Work in a leveraged manner influencing other organizations and teams across Example Company with application security approaches and a focus on problem solving.
...
- Must conduct all Example Company related work within the United States of America.
...
- Lead and perform application security reviews on all contributed code from [Example Company Information Technology (Hubei) Co., Ltd. (JiHu, pronounced "G Who")](https://about.example_company.com/blog/2021/03/18/example_company-licensed-technology-to-new-independent-chinese-company/).
...
This position reports to the [Application Security Senior Manager](/job-families/security/application-security/) role at Example Company.

#### Job Grade

The Application Security Manager is a [grade 8](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
The Application Security Senior Manager is a [grade 9](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- <https://app.periscopedata.com/app/example_company/641782/Appsec-hackerone-vulnerability-metrics?widget=8715519&udv=0>
- <https://app.periscopedata.com/app/example_company/641782/Appsec-hackerone-vulnerability-metrics?widget=8729826&udv=0>
