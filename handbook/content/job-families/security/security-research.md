...
Security research engineers are subject matter experts (SME) that conduct research in their personal area of expertise to protect Example Company the product and Example Company company assets. They are also expected to participate in the larger security community through blog posts and participation in industry conferences.

## Responsibilities

- Conduct research in their area of expertise to protect Example Company and Example Company.com assets.
- Research security posture of FOSS tools that are integrated with Example Company.
- Report findings to tool developers and track mitigation process, following [responsible disclosure guidelines](https://about.example_company.com/security/disclosure/#disclosure-guidelines-for-vulnerabilities-in-3rd-party-software).
...
- Apply [Secure tools](https://about.example_company.com/stages-devops-lifecycle/secure/) to [secure Example Company](/handbook/security/#secure-the-product) and contribute to the improvement of the tools by providing feedback to the engineering team.
- Identify gaps in existing security test automation and develop tools to close the gap.
- Support other Example Company initiatives as a SME.
...
This position reports to the [Security Manager, Security Research](#security-manager-security-research) role at Example Company.
...
- Write public blog posts and represent Example Company in the wider security community
...
- Participate in defining Example Company security requirements in area(s) of expertise.
...
This position reports to the [Senior Security Manager, Security Research](#senior-security-manager-security-research) role at Example Company.
...
This position reports to the [Threat Management Director](/job-families/security/security-leadership/) role at Example Company.
...
- Take lead role in decision making for Example Company security requirements in area(s) of expertise.
...
- Represent the Security Engineering team across and outside of Example Company as a subject matter expert in technology, development, and security concepts.
- Work in a leveraged manner influencing other organizations and teams across Example Company with security research approaches and a focus on problem solving.
...
This position reports to the [Security Engineering Director](/job-families/security/security-leadership/#director-security-engineering--research) role at Example Company.

#### Job Grade

The {Security Research Manager} is a [grade 8](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
The {Security Research Senior Manager} is a [grade 9](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
