...
description: "Members of the Security Assurance Department provide Example Company's customers with a high level of assurance around the security of Example Company's SaaS service offerings and Example Company's internal practices."
---

## Security Assurance Roles at Example Company

Team members in the Security Assurance Department at Example Company are customer and risk focused. They support the governance, field security, risk, and commercial and dedicated compliance initiaitives of the Security Division. They must coordinate across departments and divisions to accomplish collaborative goals. Security Assurance team members embrace Example Company's [values](/handbook/values/) and strive to consistently perform at the highest level.
...
The Security Assurance Engineer (Intermediate) is a [grade 6](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Support the maintenance of the Example Company Control Framework (GCF) to ensure controls align with security strategy, support business objectives, and are consistent with applicable laws and regulations
...
- Maintain Example Company's standard security response database
...
The Senior Security Assurance Engineer is a [grade 7](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Continuously improve Example Company's security control framework
- Draft and implement handbook pages, procedures and runbooks related to security compliance
- Direct external audits
- Build and maintain security controls that map to Example Company security compliance requirements and provide implementation recommendations
...
- Maintain the Example Company Control Framework (GCF) to ensure controls align with security strategy, support business objectives, and are consistent with applicable laws and regulations
...
- Maintain up-to-date knowledge of Example Company's product, roadmap, environment, systems and architecture
...
- Monitor industry trends and demands to proactively position Example Company as an industry leader in Security and execute initiatives to support these trends
- Execute peer reviews and provide meaningful feedback
...
- Build the Example Company Security brand by presenting a minimum of 2 external facing engagements per annum, ex: Commit, SKO, conferences, guest speaking engagements, blog posts, whitepapers
...
The Staff Security Assurance Engineer is a [grade 8](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Maintain expert knowledge of Example Company's product, environment, systems and architecture while mentoring others on this knowledge and helping to shape designs for the sake of security compliance efficiencies
- Participate in the development and continuous improvement of security compliance metrics
- Provide actionable and constructive advisement to cross-functional teams, to include driving remediation activities for high and select moderate risk Observations across several Example Company departments
...
- Design and implement major iterations on Example Company's security control framework in alignment with industry trends
- Participate in security assurance roadmap development based on customer needs
- Predict future industry trends and demands to position Example Company as an industry expert of Security Compliance and execute initiatives to support these trends
- Create dynamic open-source security compliance programs that deliver value to the Example Company community
- Build the Example Company Security Compliance brand through regular internal and external presentations and publications
...
- Propose improvements to the Example Company Control Framework (GCF) to ensure controls align with security strategy, support business objectives, and are consistent with applicable laws and regulations
...
- Maintain expert knowledge of Example Company's product, environment, systems and architecture while mentoring others on this knowledge
...
- Create dynamic open-source Security Risk programs that deliver value to the Example Company community
...
- Maintain proficient knowledge of Example Company's product, roadmap, environment, systems and architecture and help shape strategic decisions focused on meeting customer security demands
...
- Build the Example Company Security brand by presenting a minimum of 6 external facing engagements per annum such as Commit, conferences, guest speaking engagements, blog posts, whitepapers
- Create dynamic open-source Field Security programs that deliver value to the Example Company community
...
The Manager, Security Assurance is a [grade 8](/handbook/total-rewards/compensation/compensation-calculator/#example_company-job-grades).
...
- Maintain a robust common control framework and continuous monitoring program aligned with Example Company's certification roadmap
...
- Make broad recommendations on improving security compliance related processes and/or procedures across Example Company; partner with stakeholders to implement solutions
...
- Work closely with the Manager, Security Compliance and provide requirements for the common control framework aligned with Example Company's dedicated markets certification roadmap
- Maintain a scoped continuous monitoring program aligned with Example Company's dedicated markets certification roadmap
...
- Make broad recommendations on improving dedicated markets related processes and/or procedures across Example Company; partner with stakeholders to implement solutions
...
- Evangelize operational security risk programs across Example Company
