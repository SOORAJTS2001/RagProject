...
During the global pandemic (COVID-19) and a fully-remote working sales force at Example Company, in-person team gathering events have proven to be of positive value to Example Company to fascilitate more effective communication, help improving stronger team relationships and increase collaborative engagements. This page is meant to be a guide.

## Offsite planning and before the event start

The following list of considerations could be valuable for the SA leaders to go through ahead of engaging further Example Company divisions:
...
1. Once an agreement has been found between the SA Offsite organizer and the hotel - submit the terms and conditions via our Example Company official procurement mechanism outlined here - [Coupa End Users Guide](/handbook/business-technology/enterprise-applications/guides/coupa-guide/)
    - Step 1: Ensure the supplier is a vendor to Example Company
...
1. Consider to structure and organise the team offsite in form of gdocs documents, Example Company Wiki pages, Issues or any other collaborative methods
    - [APAC example of a Wiki page - FY23 April](https://example_company.com/example_company-com/customer-success/apj-customer-success-team/-/wikis/FY23-APAC-SA-Offsite-April) (internal)
