...
- **Why use gainsight for account planning**
  - It's an existing platform already loved by existing teams in Example Company. Gainsight provides metrics, timelines, call to action like reminders. It also has the ability to create playbooks defining different steps in a process for eg: [an ultimate play](/handbook/solutions-architects/sales-plays/)
...
- [Account Planning for SAs](https://example_company.edcast.com/pathways/gainsight-for-solutions-architects-sas)
