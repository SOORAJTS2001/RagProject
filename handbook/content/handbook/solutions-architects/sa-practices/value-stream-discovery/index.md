...
* **Discovery Session (with Value Stream Concepts):** Integrate value stream mapping concepts into standard discovery sessions. This aligns well with Example Company's [Command of the Message](/handbook/sales/command-of-the-message/) approach, focusing on understanding the customer's current state, future desired state, and the metrics they'll use to measure success.  It's vital to grasp how the customer's value stream ties into achieving their larger business goals.
...
* Please create a new issue in [value stream discovery project](https://example_company.com/example_company-com/customer-success/value-stream-assessment)
* Use the template labeled `request_value_stream_assessment`

This gives the team at Example Company the ability to both track the progress of the Value Stream Discovery and allocate team members to the effort, a key requirement for the next preparation steps.
...
* Identify and communicate to a [Example Company Executive Sponsor](/handbook/sales/field-operations/gtm-resources/#executive-sponsorship-program)
...
| Role    | Responsibilities | Example Company Roles |
| -------- | ------- |------- |
...
1. What are typical outcomes for a customer?
    ...
    * Financial Services customers have realized the below outcomes when coupling a Value Stream Workshop with Example Company investment:
...
The single source of truth for training and VSW artifacts can be found on the associated [HighSpot page](https://example_company.highspot.com/items/6418507b8913729120197bbf).

#### Value Stream Workshop Overview

This course is designed to provide an overview of how Example Company account teams should assist prospects and customers by providing a lightweight assessment of their value stream. The course outlines the approaches, tools, and artifacts used to conduct a value stream assessment for our prospects and customers.

* [Example Company Value Stream Workshop Accreditation on LevelUp](https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/learning-path/value-stream-assessment-accreditation)

#### Past Enablement

* [2023-03-23 Webcast - Winning With Value Stream Assessments - Jonathan Fullam](https://example_company.highspot.com/items/641d1b3c054fb79cebe7288f)
...
* Add feedback or tasks to the [Value Stream Workshop Issue](https://example_company.com/example_company-com/customer-success/solutions-architecture-leaders/sa-initiatives/-/issues/44)
