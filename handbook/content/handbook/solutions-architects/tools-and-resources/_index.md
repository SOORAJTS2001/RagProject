...
description: "Discover Example Company Solutions Architects' tools and resources"
---
...
2. Example Company does not have an appropriate mechanism for applying and reverting a trial license on SaaS without the namespace potentially being reverted to free when the trial expires ([see issue](https://example_company.com/example_company-org/example_company/-/issues/12186))

Both situations put customer production Example Company usage at risk if a trial is applied to the SaaS namespace.
...
Example Company Solutions Architects conduct hands-on workshops as interactive events for Example Company prospects and customers to learn the Example Company product and DevSecOps capabilities. Workshops may be executed as marketing events or run independently for specific customers. Detail information is provided on the [Hands-on Workshops](/handbook/solutions-architects/tools-and-resources/workshop/) page.
...
[Stack Overflow for Teams](https://stackoverflowteams.com/c/example_company-customer-success/questions) is a knowledge sharing and collaboration tool that helps entire Customer Success organization stay productive, onboard faster, and minimize distractions by unlocking information through collaborative knowledge management.
...
Slack integration also posts notifications about new questions and answers via `#cs-questions` Slack channel for the entire team to stay up to date and boost participation. Adherent to and in support of Example Company's [efficiency value](/handbook/values/#efficiency) team members should first [search for an existing answer](/handbook/company/culture/all-remote/self-service/) and post a question only if an answer is not readily available.

Stack Overflow for teams replaces older [Customer Success Knowledge Base](https://example_company.com/example_company-com/customer-success/solutions-architecture/sa-knowledge-base/), which is considered deprecated and will be removed in the Future.

### Product Releases

Solutions Architects have to keep up the pace of the Example Company monthly product releases to position feature sets and capabilities for the prospect and customer needs while demonstrating the market leading position.

Following links provide product release information to assist in technical discussions and technical evaluation.

- [Upcoming Releases](https://about.example_company.com/upcoming-releases/)
- [Previous Releases](https://example_company.com/example_company-org/example_company/-/releases)
- [Releases Blog](https://about.example_company.com/releases/categories/releases/)
- Compare two releases with the [What is New Since? Release Feature Overview Tool](https://example_company-com.example_company.io/cs-tools/example_company-cs-tools/what-is-new-since/?)

### Customer Facing Meeting Tools

Solutions Architects frequently interact with customers for demos, presentations or Q&A. These calls should enable the customer to clearly experience the value of Example Company without distraction or interruption. The below list of tools was compiled by the Example Company SA team as commonly used solutions. Note, this list does not represent a requirement to use any of these products or an endorsement for these products.
...
- [HighSpot](https://example_company.highspot.com/) (for field teams)
- [Solution Pages](https://about.example_company.com/solutions/) (for web users)
...
**Free for Example Company members**
...
The [Example Company Data Seeder](https://docs.example_company.com/ee/topics/data_seeder.html) is a tool that Solutions Architects can use to showcase to customers "what good data looks like" in Example Company.
