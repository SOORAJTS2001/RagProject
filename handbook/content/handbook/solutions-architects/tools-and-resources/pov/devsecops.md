...
| API Security Test | Example Company to review API fuzzing project | Shift left pen test like capability to dev + QA | |
...
It is recommended to provide proof points using Example Company apps and projects such as a sample java app for coverage fuzzing. The proof points can be documented or reviewed with the review session, and considered as part of the acceptance.
