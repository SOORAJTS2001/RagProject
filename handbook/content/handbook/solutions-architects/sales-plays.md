...
description: "Discover Example Company Solutions Architects' Sales Plays practices"
---
...
**Objective** - Land new accounts, logos & new teams in existing account with Example Company Ultimate.
...
**Ideal Customer Profile** - Prospects or new teams in existing customers who are listed in this qualification [list](https://example_company.my.salesforce.com/00O4M000004aULR) for enterprise customers
...
1. For SAEs/SDRs please make sure the customers are on the qualification list for your region. Eg: For enterprise west look at [this](https://example_company.my.salesforce.com/00O4M000004aULR)
1. During qualification, make sure to identify the pain points, customer profile using the collaterals highlighted below:
    ...
    1. [Discovery questions](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/devsecops/#discovery-questions) for Example Company Protect/Secure
...
1. Review how to position Example Company's values & why does Example Company does it better [here](/handbook/marketing/sales-plays-cicd/playbook-premium-to-ultimate/#positioning-value)
...
1. Identify & get access to high-level exec for higher-level initiatives using collateral below
        1. [Accelerating Digital Transformation](https://about.example_company.com/solutions/digital-transformation/)
        1. [Value Stream Management](https://about.example_company.com/solutions/value-stream-management/)
        1. [Example Company is optimized for cloud native](https://docs.google.com/presentation/d/1oq7ODy9TJpuZqH_tvVtCm2t-C0QkTbuG4ZRlRzRNcUY/edit#slide=id.gbb4f272403_0_546)
...
1. Strategize with your sales team on which play would you like to run & agree on the expected outcome before the meeting. We dont recommend starting a technical evaluation with a POV.
    - Demo/Deck: Vision & transformation play, where you would likely focus on Example Company holistically
    ...
    1. [How Example Company meets market requirements](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/devsecops/#how-example_company-meets-the-market-requirements)
    ...
    1. [Demo catalog](https://example_company.com/example_company-com/customer-success/solutions-architecture/demo-catalog)
    ...
    1. [Additional info including TCO workshop](https://example_company.com/example_company-com/customer-success/tko/nuts-and-bolts-devsecops-motion-feedback)
    - Demo/Deck: Integrate vs Compete play
    1. [Compete : Argo CD/TeamCity](https://gitlabdemo.com/catalog/libraries/categories/ac509772)
    1. [Example Company advantages over competitors](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/devsecops/#competitive-comparison)
...
| Sr. Manager App Dev, Director of Engineering | [Standard service packages](https://about.example_company.com/services/catalog/) or Custom Scoped Offerings| Customers who are interested in [training](https://about.example_company.com/services/education/) on one ore more specific topic. Customers who need help in [implementing Example Company Self Managed](https://about.example_company.com/services/implementation/) or need data to be [migrated to Example Company](https://about.example_company.com/services/migration/)  |

Not sure? Get in contact with your region's [PS Engagement Manager](/handbook/company/team/?department=practice-management) in [#professional-services](https://example_company.slack.com/archives/CFRLYG77X) to discuss specific customer opportunities.
