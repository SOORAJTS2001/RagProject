...
Solutions Architecture team members you should review the [Example Company People Group Career Development page](/handbook/people-group/learning-and-development/career-development/) for the roles, responsibilities, and helpful career development resources.

### Solution Architecture Specific Career Development

#### Career Paths

Because of the valuable experience and skills gained while driving customer outcomes, Solutions Architects can move to a variety of technical, sales and leadership roles in Example Company and across industries.
...
1. Have a [career development conversation](/handbook/people-group/learning-and-development/career-development/#what-is-career-development) with your manager to discuss the learning opportunity. It's important to:
    ...
    - Draft an [Individual Growth Plan](/handbook/people-group/learning-and-development/career-development/#individual-growth-plan) where you highlight:
         ...
         - Timing
         - Explore existing and future job openings in Example Company

2. If the career move you are looking to do is in Example Company but outside of your current team, discuss with your manager to speak to the DRI for the job opening you are looking to potentially apply for
...
1. Before the SA Manager starts the [Promotion Approval Process](/handbook/people-group/promotions-transfers/#processing-a-promotion), the manager will inform the Director/VP of Solutions Architecture that the justification document is ready for review, typically during a 1 on 1 weekly meeting.
    ...
    - For Principal level promotions, the Principal candidates will prepare and present their accomplishments and their vision for improving Example Company and the SA organization to a panel of SA leaders and Principal level SAs after calibration has occurred.
...
In FY23, Example Company kicked off its first ever Associate Program across Customer Success with the aim to:

- Build the next generation of highly-diverse, well-prepared Example Company Solutions Architects
- Grow pre-sales engineering skill sets that are focused on Example Company's product offering, business model and aligned to customer needs
...
The Associate SA Program aims to embody as many Example Company values as possible as it aims to instill a passion for DevOps, Open-Source Software, and Example Company.  Key values and sub-values include:
...
| **[Call Review](https://example_company.com/example_company-com/customer-success/solutions-architecture/associate-program/training/-/issues/new?issuable_template=Bi-Weekly%20Call%20Review)**                |  Bi-Weekly, first 3 months        | Upon receiving access to Chorus, the cohort ought to review a single call at least every other week |
| **[Getting Good with Troops](https://example_company.com/example_company-com/customer-success/solutions-architecture/associate-program/training/-/issues/new?issuable_template=Getting%20Good%20With%20Troops)** | For 4 weeks at the 3-4 months mark | Associate SAs should plan to attend at least 3 calls per week and record these calls via Troops |
|**[Example Company Exercise](https://example_company.com/example_company-com/customer-success/solutions-architecture/associate-program/training/-/issues/new?issuable_template=Example Company%20Exercise)**||The goal of this activity is to become comfortable with Example Company mechanisms for educating oneself about the wider Example Company initiatives throughout the organization|
...
the value of different [Example Company categories within our stages](/handbook/product/categories/#hierarchy). Upon completion of Demo2Win, every week, the team is assigned a new Category to learn about and
show the value of that category through the tell-show-tell methodology. Sign up for updates by including your Example Company username as a CC recipient to the
[Weekly Capability Deep Dive](https://example_company.com/-/ide/project/example_company-com/customer-success/solutions-architecture/associate-program/training/tree/main/-/.example_company/issue_templates/Weekly%20Capability%20Deep%20Dive.md/) issue template which is used to determine the weekly category.
...
- [Discretionary Bonuses](/handbook/total-rewards/incentives/#discretionary-bonuses-for-individuals) (If an SA has gone above and beyond and truly lived up to Example Company's CREDIT values, a discretionary bonus of $1000 US can be awarded. These nominations can come from anyone in the company and at any time.)
...
- [President's Club](https://internal.example_company.com/handbook/sales/presidents-club/) (13 members of the SA organization (and their optional guests) from across the globe are selected based on contributions throughout the year. More on the selection criteria can be found in the internal link)
