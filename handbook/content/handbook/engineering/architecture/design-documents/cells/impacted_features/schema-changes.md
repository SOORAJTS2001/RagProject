...
For example, [when removing a column we need to make changes over 3 separate deployments](https://docs.example_company.com/ee/development/database/avoiding_downtime_in_migrations.html#dropping-columns).
...
A key benefit of Cells may be that it allows us to run different customers on different versions of Example Company.
