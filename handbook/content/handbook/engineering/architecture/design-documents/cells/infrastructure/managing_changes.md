...
- [Deployment](deployments.md) - The process of installing the Example Company application and its components into our infrastructure.
...
- We explored the idea of a [kubernete operator](https://example_company.com/nolith/ringctl-operator), a [private recorded demo](https://www.youtube.com/watch?v=55glecMYD7k&t=1m) is available. As part of this effort, we realized that we want to focus on human interaction first. The ergonomics of operating the system are more important than the implementation details of the engine itself.
...
- [Impact on the current work](https://example_company.com/example_company-com/gl-infra/production-engineering/-/issues/25601#note_1996861638) due to the lack of a sequencing engine to apply changes.
