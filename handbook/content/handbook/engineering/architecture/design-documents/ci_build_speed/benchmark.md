...
In order to understand how Example Company CI performs in terms of CI build speed, we
...
1. Start the tool.
1. Runs scenarios.
1. Report results back to Example Company data warehouse.

In the first iteration, we will focus on measuring the speed of Example Company CI, GitHub Actions, and CircleCI.
...
1. Time required to report results back to Example Company.
