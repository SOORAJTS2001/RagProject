---
title: "Retrieval Augmented Generation (RAG) for Example Company"
status: ongoing
...
The goal of this blueprint is to describe viable options for RAG at Example Company
...
Example Company Duo Chat, utilizing the
...
- **L2 Distance (Euclidean Distance):** Takes into account both the direction
  ...
  processing the data source through an embedding model. Currently, in Example Company
  ...
  with Example Company policies. See the
  [Security, Legal, and Compliance](https://example_company.com/example_company-org/example_company/-/blob/52f4fcb033d13f3d909a777728ba8f3fa2c93256/doc/architecture/blueprints/gitlab_duo_rag/index.md#security-legal-and-compliance)
...
[issues](https://example_company.com/example_company-org/example_company/-/issues/451431), merge requests,
etc. This will be used to perform [Hybrid Search](https://example_company.com/example_company-org/example_company/-/issues/440424)
...
If one of the existing [indexed document types](https://docs.example_company.com/ee/integration/advanced_search/elasticsearch.html#advanced-search-index-scopes)
is not covered, a [new document type](https://docs.example_company.com/ee/development/advanced_search.html#add-a-new-document-type-to-elasticsearch) can be added.
...
Elasticsearch provides blob search which supports [Advanced Search Syntax](https://docs.example_company.com/ee/user/search/advanced_search.html#syntax).

[Zoekt](https://docs.example_company.com/ee/architecture/blueprints/code_search_with_zoekt/index.html) is employed on Example Company.com to provide
...
[Example Company Data Classification Standard](../../../../security/data-classification-standard/).
If the user doesn't have access to the data, Example Company will not fetch the data for
building a prompt.

For example:

- When the data is Example Company Documentation (GREEN level), the data can be fetched
...
data isn't inappropriate for Example Company to process.
...
- [Data privacy](https://docs.example_company.com/ee/user/gitlab_duo/data_usage.html#data-privacy)
- [Data retention](https://docs.example_company.com/ee/user/gitlab_duo/data_usage.html#data-retention)
- [Training data](https://docs.example_company.com/ee/user/gitlab_duo/data_usage.html#training-data)
...
basic requirements of vector storage and retrieval for Example Company Duo Chat with
Example Company documentation. Click the links to learn more about each solutions
...
To read more about the [Example Company Duo Chat PoCs](../gitlab_duo_rag/) conducted, see:
