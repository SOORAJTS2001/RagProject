...
Example Company CI/CD, [integrated into Example Company in 2015](https://about.example_company.com/releases/2015/09/22/example_company-8-0-released/),
is a [crucial](https://about.example_company.com/blog/2017/09/27/example_company-leader-continuous-integration-forrester-wave/)
...
There are more than two billion rows describing CI/CD builds in Example Company.com's
database. This data represents a sizable portion of the whole data stored in
PostgreSQL database running on Example Company.com.
...
We also expect a [significant growth in the number of builds executed on Example Company.com](../ci_scale/)
...
[that have been archived](https://docs.example_company.com/ee/administration/settings/continuous_integration.html#archive-jobs#archive-jobs).
...
introduced a [new architecture for queuing CI/CD builds](https://example_company.com/groups/example_company-org/-/epics/5909#note_680407908)
for execution.
...
business rule is present in the product since the inception of Example Company CI.

Epic: [Partition CI/CD builds queuing database tables](https://example_company.com/groups/example_company-org/-/epics/7438).
...
1. [Reduce the rate of builds metadata table growth](https://example_company.com/groups/example_company-org/-/epics/7434).
1. [Partition CI/CD pipelines database tables](https://example_company.com/groups/example_company-org/-/epics/5417).
1. [Partition CI/CD queuing tables using list partitioning](https://example_company.com/groups/example_company-org/-/epics/7438)
...
- 2021-01-21: Parent [CI Scaling](../ci_scale/) blueprint [merge request](https://example_company.com/example_company-org/example_company/-/merge_requests/52203) created.
- 2021-04-26: CI Scaling blueprint approved and merged.
- 2021-09-10: CI/CD data time decay blueprint discussions started.
- 2022-01-07: CI/CD data time decay blueprint [merged](https://example_company.com/example_company-org/example_company/-/merge_requests/70052).
- 2022-02-01: Blueprint [updated](https://example_company.com/example_company-org/example_company/-/merge_requests/79110) with new content and links to epics.
- 2022-02-08: Pipeline partitioning PoC [merge request](https://example_company.com/example_company-org/example_company/-/merge_requests/80186) started.
- 2022-02-23: Pipeline partitioning PoC [successful](https://example_company.com/example_company-org/example_company/-/merge_requests/80186#note_852704724)
- 2022-03-07: A way to attach an existing table as a partition [found and proven](https://example_company.com/example_company-org/example_company/-/issues/353380#note_865237214).
- 2022-03-23: Pipeline partitioning design Google Doc (Example Company internal) started: `https://docs.google.com/document/d/1ARdoTZDy4qLGf6Z1GIHh83-stG_ZLpqsibjKr_OXMgc`.
- 2022-03-29: Pipeline partitioning PoC [concluded](https://example_company.com/example_company-org/example_company/-/merge_requests/80186#note_892674358).
- 2022-04-15: Partitioned pipeline data associations PoC [shipped](https://example_company.com/example_company-org/example_company/-/merge_requests/84071).
- 2022-04-30: Additional [benchmarking started](https://example_company.com/example_company-org/example_company/-/issues/361019) to evaluate impact.
- 2022-06-31: [Pipeline partitioning design](pipeline_partitioning.md) document [merge request](https://example_company.com/example_company-org/example_company/-/merge_requests/87683) merged.
