...
Architecture issue: <https://example_company.com/example_company-org/architecture/tasks/-/issues/7>
...
tracked under [Consolidate Groups and Projects](https://example_company.com/groups/example_company-org/-/epics/6473)
epic.

### Phase 1 (complete)

- [Phase 1 epic](https://example_company.com/groups/example_company-org/-/epics/6697).
- **Goals**:
...
- **Update project:** Use the `after_save` callback in Rails to ensure some
  ...
  Read [`project#after_save`](https://example_company.com/example_company-org/example_company/blob/6d26634e864d7b748dda0e283eb2477362263bc3/app/models/project.rb#L101-L101)
...
[Backfill `ProjectNamespace` for every Project](https://example_company.com/example_company-org/example_company/-/issues/337100).

### Phase 2 (complete)

- [Phase 2 epic](https://example_company.com/groups/example_company-org/-/epics/6768).
...
- [Phase 3 epic](https://example_company.com/groups/example_company-org/-/epics/6585).
...
- [Unify members/members actions](https://example_company.com/groups/example_company-org/-/epics/8010) - on UI and API level.
...
- [Phase 4 epic](https://example_company.com/groups/example_company-org/-/epics/8687)
...
- [Migrate Project#namespace to reference ProjectNamespace](https://example_company.com/groups/example_company-org/-/epics/6581).
- [Routes consolidation between Project & ProjectNamespace](https://example_company.com/example_company-org/example_company/-/issues/337103).
- [Policies consolidation](https://example_company.com/groups/example_company-org/-/epics/6689).

### Phase 5

- [Phase 5 epic](https://example_company.com/groups/example_company-org/-/epics/6944)
...
1. **Conceptual model**: What are the current and future state conceptual models of these features ([see object modeling for designers](https://hpadkisson.medium.com/object-modeling-for-designers-an-introduction-7871bdcf8baf))? These should be documented in Pajamas (example: [merge requests](https://design.example_company.com/objects/merge-request/)).
1. **Merge conflicts**: What inconsistencies are there across project, group, and administrator levels? How might these be addressed? For an example of how we rationalized this for labels, see [this issue](https://example_company.com/example_company-org/example_company/-/issues/338820).
1. **Inheritance & information flow**: How is information inherited across our container hierarchy currently? How might this be impacted if complying with the new [inheritance behavior](https://example_company.com/example_company-org/example_company/-/issues/343316) framework?
...
- [Organization developer documentation](https://docs.example_company.com/ee/development/organization/index.html)
- [Organization user documentation](https://docs.example_company.com/ee/user/organization/index.html)
