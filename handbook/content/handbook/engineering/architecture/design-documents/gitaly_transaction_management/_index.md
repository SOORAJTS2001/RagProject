...
- Write-ahead logging. Work on this is already underway and tracked in [Implement write-ahead logging in Gitaly](https://example_company.com/groups/example_company-org/-/epics/8911).
...
This is the first stage of implementing a [decentralized Raft-based architecture for Gitaly Cluster](https://example_company.com/groups/example_company-org/-/epics/8903).
...
can be cleared when the log entry is pruned. For more information, see [issue 154](https://example_company.com/example_company-org/git/-/issues/154) on the Example Company fork of Git.
...
get serializability guarantees. For more information, see [epic 8903](https://example_company.com/groups/example_company-org/-/epics/8903).
