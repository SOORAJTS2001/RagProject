---
title: "Example Company Modular Monolith"
status: proposed
...
The main [Example Company Rails](https://example_company.com/example_company-org/example_company)
...
Even though we strive for having [an approachable open-core architecture](https://about.example_company.com/blog/2022/07/14/open-core-is-worse-than-plugins/)
...
- We need to use `CODEOWNERS` file feature for several domains but
  [these rules are complex](https://example_company.com/example_company-org/example_company/-/blob/409228f064a950af8ff2cecdd138fc9da41c8e63/.example_company/CODEOWNERS#L1396-1457).
...
- There is little structure inside the monolith. We have attempted to enforce
  the creation [of some modules](https://example_company.com/example_company-org/example_company/-/issues/212156)
...
- Build abstractions required to deploy and run Example Company components separately.
...
pragmatic way which works well on Example Company.com but also on self-managed
instances, but we need to align modularization with the way in which we want to
work at Example Company.
...
- A working group [Bounded Contexts](../../../../company/working-groups/bounded-contexts/)
  was concluded in April 2024 which defined a list of bounded contexts to be enforced for Example Company Rails domain and
