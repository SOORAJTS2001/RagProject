...
This design document supersedes the previous [Composable Example Company Codebase](../../composable_codebase_using_rails_engines/)
...
![Hexagonal Architecture for Example Company monolith](hexagonal_architecture.png)
...
that is unique to Example Company product.
...
This follows the existing [guideline on naming namespaces](https://docs.example_company.com/ee/development/software_design.html#use-namespaces-to-define-bounded-contexts)
...
[ubiquitous language](https://docs.example_company.com/ee/development/software_design.html#use-ubiquitous-language-instead-of-crud-terminology).
...
is very cheap.
Using feature categories also helps new contributors, either as Example Company team members of members of the wider community,
...
Base classes to extend Rails framework such as `ApplicationRecord` or `ApplicationWorker` as well as Example Company base classes
...
One of the unique challenges of modularizing the Example Company codebase is the presence of EE extensions (managed by Example Company)
