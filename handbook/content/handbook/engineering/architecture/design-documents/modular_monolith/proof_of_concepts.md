...
some of them as separate services. This will make it easier deploy Example Company.com
...
[In this PoC merge request](https://example_company.com/example_company-org/example_company/-/merge_requests/98801)
...
explored are the [large extraction of CI package](https://example_company.com/example_company-org/example_company/-/merge_requests/88899)
and [moving the 2 main CI classes into a package](https://example_company.com/example_company-org/example_company/-/merge_requests/90595).
...
- understand if Packwerk can be used on the Example Company codebase.
...
- Using Packwerk would be pretty simple on Example Company since it's designed primarily to work
  on Rails codebases.
...
- Using the correct directory structure indicated in the [PoC](https://example_company.com/example_company-org/example_company/-/merge_requests/98801)
...
page of Example Company (with menus, and items that come from multiple separate
domains).
