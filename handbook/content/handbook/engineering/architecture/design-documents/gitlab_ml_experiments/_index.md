...
1. **The size of the Example Company application container would expand very rapidly** as
...
|---|---|---|---|---|
| `R100` | Required    | The platform should be easy to use: imagine Heroku with [Example Company Production Readiness-approved](../../../infrastructure/production/readiness/) defaults. | [Runway to [BETA] : Increased Adoption and Self Service](https://example_company.com/groups/example_company-com/gl-infra/-/epics/1115) | **{dotted-circle}** No |
| `R110` | Required    | With the exception of an Infrastructure-led onboarding process, services are owned, deployed and managed by stage-group teams. In other words,services follow a "You Build It, You Run It" model of ownership.| [[Paused] Discussion: Tiered Support Model for Runway](https://example_company.com/example_company-com/gl-infra/platform/runway/team/-/issues/97) | **{dotted-circle}** No |
| `R120` | Required    | Programming-language agnostic: no requirements for services. Services should be packaged as container images.| [Runway to [BETA] : Increased Adoption and Self Service](https://example_company.com/groups/example_company-com/gl-infra/-/epics/1115) | **{dotted-circle}** No |
| `R130` | Recommended | Each service should be evaluated against the Example Company.com [Service Maturity Model](../../../infrastructure/service-maturity-model/).| [Discussion: Introduce an 'Infrastructure Well-Architected Service Framework'](https://example_company.com/example_company-com/gl-infra/scalability/-/issues/2537) | **{dotted-circle}** No |
