---
title: 'Example Company Secrets Manager ADR 002: Use GCP Key Management Service'
...
used by the Example Company Secrets Manager vaults.
...
identities defined in Example Company so that decryption requests can be authenticated accordingly.
...
To make this feature available to Self-Managed customers, this feature needs to be a Example Company Cloud Connector feature.

## Alternatives

We considered generating and storing private keys within Example Company Secrets Service,
but this would not meet the requirements for [FIPS Compliance](https://docs.example_company.com/ee/development/fips_compliance.html).
