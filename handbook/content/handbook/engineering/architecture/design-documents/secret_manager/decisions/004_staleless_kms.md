---
title: 'Example Company Secrets Manager ADR 004: Sateless Key Management Service'
...
In this ADR we are going to describe the desired architecture of Example Company Secrets
...
Make Example Company Secrets Management Service a stateless application, not being
...
1. Protection tier will be defined on per-organization level on the Example Company Rails Service side.
...
1. The Example Company Secrets Management Service will not store access-control metadata.
1. Identity de-multiplexing will happen on Example Company Rails Service side.
