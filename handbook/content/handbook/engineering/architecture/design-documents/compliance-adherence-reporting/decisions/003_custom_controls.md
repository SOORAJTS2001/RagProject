...
controls that Example Company supports or would support in the future. Users could also have external services that might impact
...
We also [considered](https://example_company.com/groups/example_company-org/-/work_items/14939#note_2096055093) using Example Company Query
...
similar to [setting the status of external status checks](https://docs.example_company.com/ee/api/status_checks.html#set-status-of-an-external-status-check).
