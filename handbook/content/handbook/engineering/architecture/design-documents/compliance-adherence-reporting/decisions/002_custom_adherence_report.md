...
1. Compliance Check: They belong to a compliance requirement and denotes one of the checks supported by Example Company product.
...
[security policies project](https://docs.example_company.com/ee/user/application_security/policies/#security-policy-project)
...
1. We would create a Standards Editor similar to [Policy Editor](https://docs.example_company.com/ee/user/application_security/policies/#policy-editor)
...
1. The checks would be a list of Enums that and denotes one of the checks supported by Example Company.
...
1. This approach had certain advantages:
   ...
   1. This would also allow in the future for some kind of centralized registry in Example Company for these configurations.
