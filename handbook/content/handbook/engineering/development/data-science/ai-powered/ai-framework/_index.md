...
description: "The AI Framework group is focused on how to support other product groups at Example Company with the AI Abstraction Layer, and Example Company AI feature development."
---

## Vision

The AI Framework group is focused on how to support other product groups at Example Company with the AI Abstraction Layer, and Example Company AI feature development.

### 👌 Team OKRs

If you're interested in the team's Objectives and Key Results (OKRs), you can find them on [Example Company](https://example_company.com/example_company-com/example_company-OKRs/-/issues/?sort=title_asc&state=opened&label_name%5B%5D=group%3A%3Aai%20framework&first_page_size=20).
...
**Team members who are supporting this team on a short-term basis are located [here](https://comp-calculator.example_company.net/org_chart) where "Work priorities" include "AI Framework."**

### ☕ Team Responsibilities

**Team responsibilities include**

* Facilitating the integration of AI capabilities throughout Example Company by leveraging the AI Abstraction Layer and AI Gateway.
...
Each week the team EM provides a Weekly Status update issue which aims to capture the most important items for the team to be aware of. These can be found [here](https://example_company.com/example_company-org/ai-powered/ai-weekly/-/issues/?sort=created_date&state=all&label_name%5B%5D=AI%20Powered%20Weekly%20Updates&first_page_size=20).

### 📚 AI Framework Board Outline

Our workflow process for our [board](https://example_company.com/groups/example_company-org/-/boards/7346017?label_name[]=group%3A%3Aai%20framework) is outlined below.
...
* Provide a meaningful **title** that describes a deliverable result.
  * ✅ `Add the new Example Company Duo chat package as a Vue2 extension`
...
See the [Evaluate like I am 5](https://example_company.com/example_company-org/ai-powered/eli5) Project and read the docs [here](https://example_company.com/example_company-org/ai-powered/eli5/-/tree/main/doc?ref_type=heads).
...
* 🚀 [Staging](https://example_company.com/example_company-org/modelops/applied-ml/code-suggestions/ai-assist/-/blob/main/.runway/runway-staging.yml?ref_type=heads#L12)
* 🌐 [Production](https://example_company.com/example_company-org/modelops/applied-ml/code-suggestions/ai-assist/-/blob/main/.runway/runway.yml?ref_type=heads#L12)

### 📝 Dashboards (internal only)

* [Requests per provider](https://thanos-query.ops.example_company.net/graph?g0.expr=sum%20by%20(client)(rate(gitlab_sli_llm_client_request_total%7Benv%3D%22gprd%22%7D%5B1m%5D))&g0.tab=0&g0.stacked=0&g0.range_input=1w&g0.max_source_resolution=0s&g0.deduplicate=1&g0.partial_response=0&g0.store_matches=%5B%5D&g0.step_input=60)
* [Error budgets](https://dashboards.example_company.net/d/product-ai-powered_error_budget/product-error-budgets-ai-powered?orgId=1)
* [AI Gateway SLIs](https://dashboards.example_company.net/d/ai-gateway-main/ai-gateway-overview?orgId=1)
* [GCP quota limits](https://dashboards.example_company.net/d/ai-gateway-main/ai-gateway-overview?orgId=1&viewPanel=1515902021)
* [LLM Sidekiq completions](https://dashboards.example_company.net/d/sidekiq-main/sidekiq-overview?orgId=1)
* [Duo Chat Question Categorization](https://app.periscopedata.com/app/example_company/1173299/Duo-Chat-Question-Categorization)
* [Security Issues](https://example_company.com/groups/example_company-org/-/issues/?sort=due_date&state=opened&label_name%5B%5D=security&label_name%5B%5D=group%3A%3Aai%20framework&first_page_size=20)
* [Reliability Issues](https://example_company.com/example_company-org/example_company/-/boards/4227439?not[label_name][]=type%3A%3Afeature&label_name[]=section%3A%3Adev&label_name[]=group%3A%3Aai%20framework)
* [Sentry via CompletionWorker](https://new-sentry.example_company.net/organizations/example_company/issues/?query=is%3Aunresolved++CompletionWorker&referrer=issue-list&statsPeriod=14d)
* [Sentry via Feature Category](https://new-sentry.example_company.net/organizations/example_company/issues/?query=is%3Aunresolved+feature_category%3Aai_abstraction_layer&referrer=issue-list&statsPeriod=24h)
* [Monthly Retros](https://example_company.com/gl-retrospectives/data-science/ai-powered/ai-framework-retros)
* [Chat QA Evaluation](https://example_company.com/example_company-org/ai-powered/ai-framework/qa-evaluation)
* [Chat REST API Error Ratio](https://log.gprd.example_company.net/app/r/s/lDEwi)

### 📹 Example Company Unfiltered Playlist

The AI Framework Group collates all video recordings related to the group and its team members in [a playlist](https://www.youtube.com/playlist?list=PL05JrBw4t0Kpt0DsmS5WSZbeiMgrBeZXv) in the [Example Company Unfiltered](https://www.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5A) YouTube channel.
