...
description: "The Model Validation group is focused on supporting Example Company teams to make data-driven feature development decisions leveraging ML/AI."
---

## 📝 Mission

The AI Model Validation team mission is to support and improve the integrity, reliability, and effectiveness of Generative AI solutions through evaluation, validation, and research science processes for [Example Company Duo](https://about.example_company.com/example_company-duo/) Features. We offer a centralized evaluation framework that promotes data-driven decision-making and pragmatic refinement of AI features. We further explore methods and techniques on forward-deployed research science in the Gen AI space.

## Direction

[Here](https://about.example_company.com/direction/ai-powered/ai_model_validation/) is the group direction page. We have two categories under this group: Category AI Evaluation and Category AI Research. This group is part of the [AI-Powered stage](/handbook/engineering/development/data-science/ai-powered/).

### Central Evaluation Framework (CEF)

Model validation is the primary maintainer of our [Central Evaluation Framework](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library) (CEF). This tool supports the entire end-to-end process of AI feature creation, from selecting the appropriate model for a use case to evaluating the AI features’ output. AI Validation works in concert with other types of evaluation, such as SET Quality testing and diagnostic testing, but is specifically focused on the interaction with Generative AI.

> Read about how we [How we validate and test AI models at scale](https://about.example_company.com/blog/2024/05/09/developing-example_company-duo-how-we-validate-and-test-ai-models-at-scale/) on the Example Company blog.
...
- Slack Channel: [`#g_ai_model_validation`](https://example_company.enterprise.slack.com/archives/C05CJ1T3P0W)
...
We conduct monthly async [retrospectives](/handbook/engineering/management/group-retrospectives/) which are [located here.](https://example_company.com/gl-retrospectives/data-science/ai-powered/model-validation)

## Customer outcomes we are driving for Example Company Duo
...
Our current customers include Example Company [AI-powered Duo feature teams:](https://docs.example_company.com/ee/user/gitlab_duo/index.html)

**The immediate customers include:**

1. [AI Powered: Duo-Chat team](https://about.example_company.com/direction/ai-powered/duo_chat/)
2. [Create: Code Creation team](https://about.example_company.com/direction/create/code_creation/)
3. [Govern: Threat Insights `AI Vulnerability Management` team](https://about.example_company.com/direction/govern/threat_insights/vulnerability_management/)
4. [Root Cause Analysis](https://docs.example_company.com/ee/user/gitlab_duo/index.html#root-cause-analysis)
5. [RAG Evaluation](/handbook/engineering/infrastructure/core-platform/data_stores/search/)
6. [Issue Summarization](https://docs.example_company.com/ee/user/gitlab_duo/index.html#issue-description-generation)
7. [AI Powered: Group Custom Models](https://about.example_company.com/direction/ai-powered/custom_models/)

## 🧪 Top FY25 Priorities

Data-driven evaluated AI solutions with every code change.
We encompass two categories: AI Evaluation and AI Research. Our goal is to empower each team building AI features to confidently deliver meaningful and relevant features for Example Company customers. As a long-term initiative, we aim to expand our Centralized Evaluation Framework to assess various models, AI features, and components based on quality, cost, and latency. The primary decision factors for AI content quality are:
...
Further, there are novel research topics, and we would love for Example Company to be represented in the AI research community by publishing our approaches on evaluation.
...
5. Example Company Documentation Question Answering Dataset
...
Each week, the team publishes a report on the progress made during the past week and outlines the focus for the upcoming week. The report also includes a GenAI reading list to ensure that the engineers stay up-to-date in the ever-changing GenAI space [here](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/annoucements/-/issues).

We also publish a quarterly report that summarizes how we perform in reference to OKRs, highlights our achievements, celebrates milestones, identifies opportunities, and shares learnings [here](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/annoucements/-/issues/13).

### 📹 Example Company Playlist

We conduct regular walkthroughs as we add data, metrics, and evaluation workflows. [Example Company AI Model Validation Playlist](https://www.youtube.com/playlist?list=PL05JrBw4t0KrJQLuBcVpgFTPGMLfy5l_l) includes a list of these walkthroughs. Some videos published might be for internal purposes only.

### 🎯 Current OKR

Our current OKR can be viewed [here](https://example_company.com/example_company-com/example_company-OKRs/-/work_items/6943) (Example Company internal).
...
- [Category AI Evaluation](https://example_company.com/groups/example_company-org/modelops/ai-model-validation-and-research/-/epics/19)
- [Category AI Research](https://example_company.com/groups/example_company-org/modelops/ai-model-validation-and-research/ai-research/-/epics/1)
...
1. If a feature team would like a model to be evaluated for a certain task, here is the request template: [Model Request](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library/-/blob/main/.example_company/issue_templates/Model%20Request.md?ref_type=heads)
2. If a feature team would like to evaluate a certain use case, here is the request template: [Use-Case Request](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library/-/blob/main/.example_company/issue_templates/Use%20Case%20Request.md?ref_type=heads)
3. If a feature team finds bugs that impact their ability to use the framework, here is a [template](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library/-/blob/main/.example_company/issue_templates/Bug%20Fix%20Request.md?ref_type=heads) to request a fix in a [new issue](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library/-/issues/new?issuable_template=Bug%20Fix%20Request). Additionally encourage to post on [#g_ai_model_validation](https://example_company.enterprise.slack.com/archives/C05CJ1T3P0W)

Further, we iterate and act more quickly with feedback and [here](https://example_company.com/example_company-org/modelops/applied-ml/code-suggestions/prompt-library/-/issues/31) is the best place to provide feedback.

## 📝 Dashboards and Additional Resources (Internal Only)

- [Example Company Duo-Chat Evaluation Dashboard](https://lookerstudio.google.com/u/0/reporting/151b233a-d6ad-413a-9ebf-ea6efbf5387b/page/ay5gB)
- [Example Company Code Completion Foundational Model Dashboard](https://dashboards.example_company.net/d/fecc5b69-8e38-4b4e-9fed-1c837f9c2b7m/code-completion-ai-evaluations-v1?orgId=1)
- [Example Company Code Suggestion Dashboard](https://lookerstudio.google.com/u/0/reporting/4a80a4ce-441c-4fb1-9454-ab5523d1cffc/page/ay5gB)
- [Example Company AI Testing and Evaluation Framework](https://internal.example_company.com/handbook/product/ai-strategy/ai-integration-effort/ai_testing_and_evaluation/)
- [How to use CEF for Duo-chat Experimentation](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library/-/tree/main/doc/how-to?ref_type=heads#:~:text=1%20month%20ago-,run_duo_chat_eval.md,-Update%20duo%20chat)
- [How to use CEF for Code Suggestion Experimentation](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library/-/blob/main/doc/how-to/run_code_creation_eval.md?ref_type=heads)
- [Prompt Template for Models and Tasks Evaluated](https://example_company.com/example_company-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library/-/tree/main/data/prompts?ref_type=heads)
...
- [Current Milestone Commitments](https://example_company.com/groups/example_company-org/-/boards/7476573) (don't forget to filter by current milestone!)
- [Example Company Validation Metrics](https://about.example_company.com/direction/ai-powered/ai_model_validation/ai_evaluation/metrics/)
- [Example Company Evaluation Procedure](https://about.example_company.com/direction/ai-powered/ai_model_validation/ai_evaluation/procedures/)
- [Blog: How we validate and test at scale](https://about.example_company.com/blog/2024/05/09/developing-example_company-duo-how-we-validate-and-test-ai-models-at-scale/)
