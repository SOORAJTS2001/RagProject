...
description: "Information about creating and running experiments at Example Company."
---
...
* [Experiment Guide](https://docs.example_company.com/ee/development/experiment_guide/) (Example Company Developer Documentation)
...
1. Create an [Experiment idea](https://example_company.com/example_company-org/example_company/-/issues/new?issuable_template=Experiment%20Idea) issue to define the scope of the experiment (label added: `~"experiment idea"`, optionally add: `~"growth experiment"`)
...
1. Project Managers (PM) review the [Experiment backlog](https://example_company.com/groups/example_company-org/-/boards/2028884) regularly to ensure they meet the necessary criteria of a well-defined experiment
...
1. Engineering teams deliver changes in line with our product development flow, being mindful of changes affecting other Example Company teams.
...
A backlog of experiments are tracked on the [Experiment backlog](https://example_company.com/groups/example_company-org/-/boards/2028884?&label_name[]=growth%20experiment) board.
...
| example_company-org | example_company-com | all groups |
| ------ | ------ | ------ | ------ |
| [Experiment rollout](https://example_company.com/groups/example_company-org/-/boards/1352542) | [Experiment rollout](https://example_company.com/groups/example_company-com/-/boards/1542208) | [Issues List](https://example_company.com/dashboard/issues?scope=all&state=opened&label_name[]=experiment-rollout) |

#### Experiment Setup

* Once the experiment hypothesis & measurement criteria are well-defined, an [Experiment Epic](#experiment-epic) is created at the top-level group most appropriate for the experimentation work (usually the `example_company-org` group)
...
This issue is used to clean up an experiment after an experiment has been completed. It is created within the project where the cleanup work will be done (e.g. the `example_company-org/example_company` project).
...
The [Experiment Successful Cleanup](https://example_company.com/example_company-org/example_company/-/issues/new?issuable_template=Experiment%20Successful%20Cleanup) issue template can be used for the `example_company-org/example_company` project.

#### Experiment issue templates

* Example Company `example_company-org/example_company` project
  * [Experiment idea](https://example_company.com/example_company-org/example_company/-/issues/new?issuable_template=Experiment%20Idea) issue template
  * [Experiment implementation](https://example_company.com/example_company-org/example_company/-/issues/new?issuable_template=Experimentation%20Implementation) issue template for Engineering
  * [Experiment rollout](https://example_company.com/example_company-org/example_company/-/issues/new?issuable_template=Experiment%20Rollout)
  * [Experiment successful cleanup](https://example_company.com/example_company-org/example_company/-/issues/new?issuable_template=Experiment%20Successful%20Cleanup) issue template for converting a successful experiment into a feature
* Growth `team-tasks` project
  * [Milestone planning](https://example_company.com/example_company-org/growth/team-tasks/-/issues/new?issuable_template=growth_team_planning_template) issue template for Growth groups
  * [Experiment idea](https://example_company.com/example_company-org/growth/team-tasks/-/issues/new?issuable_template=Growth%20experiment) issue template for Growth groups
  * [Experiment rollout](https://example_company.com/example_company-org/growth/team-tasks/-/issues/new?issuable_template=Experiment%20Rollout) issue template for Growth groups

## Minimum Viable Experiment (MVE)

Experimentation, like everything at Example Company, should be approached with [the Example Company CREDIT values](/handbook/values/) in mind, specifically the values of [Iteration](/handbook/values/#iteration), [Efficiency](/handbook/values/#efficiency), and [Results](/handbook/values/#results).
...
For real time experiment rollout status Example Company team members can view the [experiments API](https://example_company.com/api/v4/experiments) ([docs](https://docs.example_company.com/ee/api/experiments.html)) (a JSON viewer for your browser is recommended).

The "current_status" will be on, off, or conditional. If conditional, there will be either a percentage_of_time or percentage_of_actors. Refer to the [note on feature flags](https://docs.example_company.com/ee/development/experiment_guide/experiment_rollout.html) in the experiment guide.

There are dashboards in Sisense to indicate whether the experiment flag still exists, but not the current status. These are also only available to Example Company team members.

The [experiment rollout board](https://example_company.com/groups/example_company-org/-/boards/1352542?label_name[]=experiment-rollout) lists rollout issues linked to [experiment feature flags](https://docs.example_company.com/ee/development/feature_flags/#experiment-type) used in development and on SaaS.
