...
**[Optimize FY24 direction and goals](https://example_company.com/groups/example_company-org/-/epics/9882#fy24-goals)**
...
- We do an optional, asynchronous daily stand-up in our stage stand-up channel:
  - Plan:Optimize [#s_plan_standup](https://example_company.slack.com/archives/CF6QWHRUJ)
...
These targets will be [reviewed monthly](/handbook/product/product-processes/) after each release during the [retrospective](https://example_company.com/gl-retrospectives/manage-stage/optimize/-/issues).
...
To visualize our flow of value to customers, we're [dogfooding](/handbook/engineering/development/principles/#dogfooding) [Value Stream Analytics](https://example_company.com/groups/example_company-org/-/analytics/value_stream_analytics?value_stream_id=1022&project_ids[]=278964&label_name[]=group%3A%3Aoptimize) to measure the time it takes to go from planning to production.
...
To do so, engineering managers, engineers, and designers can be pinged directly from the issue. We're currently exploring [converting the Manage project into a group](https://example_company.com/example_company-org/manage/-/issues/16983) to be able to create groups to more easily ping group members.
...
- By the 4th, Product should have created a planning issue for their group in the [Manage project](https://example_company.com/example_company-org/manage/issues) for the coming release.
...
- [Milestone retrospectives](https://example_company.com/gl-retrospectives/manage-stage/optimize/-/issues)
- Our Slack channels
  - Plan:Optimize [#g_plan_optimize](https://example_company.slack.com/messages/CJZR6KPB4)
  - Daily standups [#s_plan_standup](https://example_company.slack.com/archives/CF6QWHRUJ)
- Issue boards
  - Optimize [build board](https://example_company.com/groups/example_company-org/-/boards/1401511) and [refinement board](https://example_company.com/groups/example_company-org/-/boards/1874426)ֿ
