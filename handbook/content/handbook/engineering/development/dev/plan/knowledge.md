...
Learn more on our [direction page](https://about.example_company.com/direction/plan/knowledge/).
...
The [build board](https://example_company.com/groups/example_company-org/-/boards/5454834) shows
...
Using this label, it's possible to easily analyze the upcoming milestone. The [Planning Board](https://example_company.com/groups/example_company-org/-/boards/7109724) mimics the Build Board but is scoped to this label instead of the current milestone. Use it to:
...
| ~type::* | Communicates the type of work being done. Used to quantify and report the split of work to roles inside and outside Example Company. | [Work Type Classification](/handbook/product/groups/product-analysis/engineering/dashboards/#work-type-classification) | |
| ~Deliverable/~Stretch | ~Deliverable communicates to customers and stakeholders that we intend to deliver an issue within the assigned milestone. ~Stretch indicates that it might be started during the milestone but is not expected to complete. | [Release Scoping Labels](https://docs.example_company.com/ee/development/labels/#release-scoping-labels) | Engineering Manager |
...
| Team | Domain overlap |
| ---  | ---    |
| [Pipeline Authoring](/handbook/engineering/development/ops/verify/pipeline-authoring/) | Example Company Pages [.example_company-ci.yml syntax](https://docs.example_company.com/ee/ci/yaml/) |
...
- [Stage-Group Dashboard](https://dashboards.example_company.net/d/stage-groups-knowledge/stage-groups-knowledge-group-dashboard?orgId=1) (including 28-day Error Budget)
- [Error Budget Detail](https://dashboards.example_company.net/d/stage-groups-detail-knowledge/stage-groups-knowledge-group-error-budget-detail?orgId=1)

## Useful links

- [Plan:Knowledge](https://example_company.com/groups/example_company-org/-/boards/1569369?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=group%3A%3Aknowledge) - Apply a milestone filter to see work in the current release
