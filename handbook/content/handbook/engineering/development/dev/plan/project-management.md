...
Example Company's [Project Management category](/handbook/product/categories/#project-management-group) in the [Plan stage](/handbook/engineering/development/dev/plan/).
...
| ---- | ---          | ---                            | ---                | ---    | ---   | ---    |
| Primary key int4 overflow | `system_note_metadata.id` column is at 50% saturation and must be converted to bigint (int8). | March 2024 - 2025 | 2023-12-22 | Sub-50% | [#424114](https://example_company.com/example_company-org/example_company/-/issues/424114) | <span style='border-radius:0.2em; font-weight:bold; padding-left:1em; padding-right:1em; color:white; background-color:red;'>Urgent</span> |
...
For the backend team specifically, we use the standard Example Company
...
(typically [Example Company](https://example_company.com/example_company-org/example_company)) and add the ~"group::project management" label, along
...
For more urgent items, feel free to use [#s_plan](https://example_company.slack.com/archives/s_plan) on Slack.
...
| --- | --- | --- | --- |
| Alexandru Croitor | 2023-01-23 | 2023-02-03 | [Moving work items](https://example_company.com/example_company-org/example_company/-/issues/387304) |
| Simon Knox | 2023-02-06 | 2023-02-17 | [Frontend of work items at the group level](https://example_company.com/example_company-org/example_company/-/issues/390432) |
| Heinrich Lee Yu | 2023-02-20 | 2023-03-03 | [Group by work items](https://example_company.com/example_company-org/example_company/-/issues/392418) |
| Coung Ngo | 2023-03-13 | 2023-03-24 | [Group by work items](https://example_company.com/example_company-org/example_company/-/issues/392418) ~frontend focused |
...
The [Plan:Project Management Build board](https://example_company.com/groups/example_company-org/-/boards/1285239?label_name[]=backend) shows prioritized work with [workflow columns](/handbook/product-development-flow/) relevant to implementation. There is an
...
As part of our ongoing efforts to improve efficiency, we will experiment with [queuing techniques](https://www.brightball.com/articles/story-points-are-pointless-measure-queues) instead of traditional weight/story points for the [migration of legacy issues to work items project](https://example_company.com/example_company-org/example_company/-/issues/461855). Starting in milestone 17.3, we will:

1. **Refine Required Issues**: Review the [list of required issues for the first MVC](https://example_company.com/example_company-org/example_company/-/issues/?sort=created_date&state=opened&label_name%5B%5D=work%20items::ga-issues&label_name%5B%5D=work%20items&first_page_size=100).
...
1. Share it in [#s_plan](https://example_company.slack.com/archives/s_plan) - if not even more widely (like in #development
   or #backend).
...
- [Plan:Project Management Build board](https://example_company.com/groups/example_company-org/-/boards/1285239?label_name[]=backend) - this shows work in the current release
