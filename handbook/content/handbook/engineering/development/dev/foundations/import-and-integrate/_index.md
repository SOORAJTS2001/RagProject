...
- by migrating between Example Company instances and from other providers
- with 3rd party integrations, REST APIs and GraphQL foundational code, and Webhooks.

This page covers processes and information specific to the Import and Integrate group. See also the [group direction page](https://about.example_company.com/direction/manage/import_and_integrate/) and the [features we support per category](/handbook/product/categories/features/#manageimport-and-integrate-group).

## How to reach us

To get in touch with the Import and Integrate group, it's best to create an
issue in the relevant project (typically [Example Company](https://example_company.com/example_company-org/example_company)) and add the
...
For more urgent items, feel free to use the Slack Channel (internal): [#g_manage_import_and_integrate](https://example_company.slack.com/archives/g_manage_import_and_integrate).
...
In general, we use the standard Example Company [engineering workflow](/handbook/engineering/workflow/).
...
or all issues assigned to a specific person, is through the [Current milestone board](https://example_company.com/groups/example_company-org/-/boards/1459244?milestone_title=Upcoming&label_name%5B%5D=group%3A%3Aimport%20and%20integrate),
...
- [Current milestone board](https://example_company.com/groups/example_company-org/-/boards/1459244?milestone_title=Upcoming&label_name[]=group%3A%3Aimport%20and%20integrate)
...
Team members might find it helpful to use a comment template to help apply labels correctly. See [an example here](https://example_company.com/example_company-org/manage/import-and-integrate/discussions/-/issues/76#note_1718035490).
...
[patch release process](https://example_company.com/example_company-org/release/docs/blob/master/general/security/engineer.md).
...
- [Infradev Issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name[]=group%3A%3Aimport%20and%20integrate&label_name[]=infradev&weight=None)
- [Issues scheduled for the next milestone without weight](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name[]=group%3A%3Aimport%20and%20integrate&milestone_title=%23upcoming&weight=None)
- [Security Issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name[]=group%3A%3Aimport%20and%20integrate&label_name[]=security&weight=None)
- [Performance issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name[]=group%3A%3Aimport%20and%20integrate&label_name[]=performance&weight=None)
- [Application Limits](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name[]=group%3A%3Aimport%20and%20integrate&label_name[]=Application%20Limits&weight=None)
- [Missed-SLO](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name[]=group%3A%3Aimport%20and%20integrate&label_name[]=missed-SLO&weight=None)
- [Approaching-SLO](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name[]=group%3A%3Aimport%20and%20integrate&label_name[]=approaching-SLO&weight=None)
- [Bugs](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name[]=group%3A%3Aimport%20and%20integrate&label_name[]=type::bug&weight=None)
- [Issues without weight](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name[]=group%3A%3Aimport%20and%20integrate&weight=None)
...
The engineering manager will use the [Refinement Bot](https://example_company.com/example_company-org/manage/import-and-integrate/refinement-bot)
...
selected for backlog refinement. [Current backlog refinement issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&state=opened&label_name%5B%5D=ready%20for%20next%20refinement).
...
The group has an existing [threat model](https://example_company.com/example_company-com/gl-security/product-security/appsec/threat-models/-/blob/master/example_company-org/example_company/Example Company%20Migration.md) to assist in identifying issues that may have security implications, but there are other considerations.
...
This is a supplement to Example Company's common [development guidance](https://docs.example_company.com/ee/development/feature_flags)
for use of feature flags. It applies to all flag types besides the [`ops` type](https://docs.example_company.com/ee/development/feature_flags/#ops-type).

Changes to Import and Integrate features often happen in high-traffic code paths and have
led to outages on Example Company.com in the past. Outages are often to do with resource contention that can
...
- [2023-09-21: Group import allows impersonation of users in CI pipelines](https://example_company.com/example_company-sirt/shared-incidents/incident_4304/-/issues/1)
- [2023-10-30: Gitlab.com is down](https://example_company.com/example_company-com/gl-infra/production/-/issues/17054)
- [2024-01-30: Sidekiq Apdex SLO](https://example_company.com/example_company-com/gl-infra/production/-/issues/17504)
...
1. QA the changes using large data to proactively flush out any problems at scale.
   For importers, see [our runbook](https://example_company.com/example_company-org/manage/import-and-integrate/team/-/blob/main/importers/runbook.md)
   for tips.
1. When you come to release the feature, change the feature flag to be `default_enabled: true`
   ...
   [optional release the feature with the flag](https://example_company.com/example_company-org/example_company/-/blob/e730c474ed80143ebae33df90900b342020ad7c0/.example_company/issue_templates/Feature%20Flag%20Roll%20Out.md?plain=1#L83)
...
- By the 15th, engineering merge requests should be merged. In other words, we assume code merged after the 15th will not be in the release. That allows time for the release to be finalized, and any associated [release posts](/handbook/marketing/blog/release-posts/) to be merged by the 17th. (This is an [experiment starting with 13.11](https://example_company.com/example_company-org/manage/general-discussion/-/issues/17330).)
...
The Import and Integrate group conducts [milestone retrospectives in Example Company issues](https://example_company.com/gl-retrospectives/manage-stage/import-and-integrate/-/issues). These include the engineers, UX, PM, and
...
for each month's [Example Company retrospective](/handbook/engineering/workflow/#retrospective). For more information, see [group retrospectives](/handbook/engineering/management/group-retrospectives/).
...
1. [Create an issue](https://example_company.com/example_company-org/manage/import-and-integrate/discussions/-/issues) explaining why you want to have a retrospective and indicate whether this should be synchronous or asynchronous.
...
| ------ | ------ | ------ | ------ |
| Direct Transfer - User contribution mapping | Rodrigo Tomonari | [Epic](https://example_company.com/groups/example_company-org/-/epics/12378) | - |
| Improve the efficiency of developer contributions to the importers | James Nutt | [OKR](https://example_company.com/example_company-com/example_company-OKRs/-/work_items/6658) | - |
| Congregate | tbd | https://example_company.com/example_company-org/example_company/-/issues/428657 | |
| GitHub Actions | tbd | https://example_company.com/example_company-org/manage/general-discussion/-/issues/17652 | |
|  | | |  |

## Merge request roulette reviews

When areas of the Import and Integrate codebase are changed, the [reviewer roulette](https://docs.example_company.com/ee/development/code_review.html#reviewer-roulette)
...
authored by people outside of the Import and Integrate team. See [this example](https://example_company.com/example_company-org/example_company/-/merge_requests/74338#note_731247058) of how the review recommendation looks.

The [reasoning](https://example_company.com/example_company-org/example_company/-/issues/343486) behind these special recommendations
...
[list of regular expressions](https://example_company.com/example_company-org/example_company/-/blob/240d4c37c955878c224718e47f4d527bea250299/tooling/danger/project_helper.rb#L42-62).
...
are [first match wins](https://example_company.com/example_company-org/example_company/-/blob/54e182410219d1c77c5c6b2b7c88a6639f622cc6/tooling/danger/project_helper.rb#L18)
...
To see which files in the Example Company repository produce a match, paste the following in a Rails console:
...
- [Import and Integrate group dashboard](https://dashboards.example_company.net/d/stage-groups-import_and_integrate/stage-groups-import-and-integrate-group-dashboard?orgId=1) which contain:
  - Links to various Kibana logs, filtered to our feature categories
  - Our [error budget](#error-budgets) spend attribution
- [Worker queues](https://dashboards.example_company.net/d/sidekiq-queue-detail/sidekiq-queue-detail?orgId=1&var-PROMETHEUS_DS=Global&var-environment=gprd&var-stage=main&var-queue=jira_connect:jira_connect_sync_branch) where you can switch queues with the `queue` dropdown

### Sentry errors

- [Matching "IntegrationsController"](https://new-sentry.example_company.net/organizations/example_company/issues/?project=3&query=is%3Aunresolved+IntegrationsController&referrer=issue-list&statsPeriod=14d)
- [Matching "Integrations"](https://new-sentry.example_company.net/organizations/example_company/issues/?project=3&query=is%3Aunresolved+Integrations&referrer=issue-list&statsPeriod=14d)
- [Matching "Jira"](https://new-sentry.example_company.net/organizations/example_company/issues/?project=3&query=is%3Aunresolved+Jira&referrer=issue-list&statsPeriod=14d)

### Kibana logs and dashboards

#### JiraConnect workers

- [`JiraConnect::SyncMergeRequestWorker`](https://log.gprd.example_company.net/goto/309f97d4a5c3e918e2c07754fefc94ee) errors.
- [`JiraConnect::SyncBranchWorker`](https://log.gprd.example_company.net/goto/96364e957898896c4dc7e9ee5534b6de) errors.
- [`JiraConnect::SyncProjectWorker`](https://log.gprd.example_company.net/goto/5f0e03847ddc1b074d6346199c8bc4d2) errors.
- [All JiraConnect sync worker](https://log.gprd.example_company.net/goto/39348f2d169e6929c41dba2d6fb063ee) timeout errors.

#### Import dashboards

- [Project Import/Export - Overview](https://log.gprd.example_company.net/app/dashboards#/view/03a11c50-ba46-11ec-b73f-692cc1ae8214)
- [GitHub Import - Overview](https://log.gprd.example_company.net/app/dashboards#/view/62965d10-9c0e-11ed-9f43-e3784d7fe3ca)
- [GitHub Import - Project import debug](https://log.gprd.example_company.net/app/dashboards#/view/be0fb6d0-9c24-11ed-85ed-e7557b0a598c)
- [Example Company Direct Transfer - Overview](https://log.gprd.example_company.net/app/dashboards#/view/f2640580-a8bd-11ed-85ed-e7557b0a598c)

### Error budgets

Example Company uses [error budgets](/handbook/engineering/error-budgets/) to measure the availability and performance of our features.
Each engineering group has its own budget spend. The current 28-day spend for the Import and Integrate team
shows in this [Grafana dashboard](https://dashboards.example_company.net/d/stage-groups-import_and_integrate/stage-groups-import-and-integrate-group-dashboard?orgId=1).
...
To determine the highest-priority problems in our [Grafana dashboard](https://dashboards.example_company.net/d/stage-groups-import_and_integrate/stage-groups-import-and-integrate-group-dashboard?orgId=1):
...
- [What Apdex is and how it works](https://docs.example_company.com/ee/development/application_slis/rails_request.html)
- [Error budget in Grafana dashboards](https://docs.example_company.com/ee/development/stage_group_observability/index.html#error-budget)
- [Feature categorization](https://docs.example_company.com/ee/development/feature_categorization): our code is attributed to us by `feature_category: :api`, `feature_category: :integrations`, `feature_category: :internationalization`, `feature_category: :importers`, and `feature_category: :webhooks`

## Links and resources {#links}

{{% include "includes/engineering/foundations/shared-links.md" %}}

- [Milestone retrospectives](https://example_company.com/gl-retrospectives/manage-stage/import-and-integrate/-/issues)
- Our Slack channels
  - Manage:Import and Integrate [#g_manage_import_and_integrate](https://example_company.slack.com/archives/C04RDL3MEH5)
  - Daily standups [#g_manage_import_and_integrate_daily](https://example_company.slack.com/archives/C04UYQV7716)
- Issue boards
  - [Current milestone board](https://example_company.com/groups/example_company-org/-/boards/1459244?milestone_title=Upcoming&label_name[]=group%3A%3Aimport%20and%20integrate)
- Contribution guides
  - [Principles of importer design](https://docs.example_company.com/ee/development/import/principles_of_importer_design/)
  - [Contributing to Direct Transfer](https://docs.example_company.com/ee/development/bulk_imports/contributing)
    - [Feedback issue](https://example_company.com/example_company-org/example_company/-/issues/456468)
- Onboarding videos (Example Company Unfiltered Youtube)
  - [Direct Transfer](https://www.youtube.com/watch?v=vVQ6Ex9fSl8) (formerly known as Example Company Migration)
  - [Introduction to GitHub Importer](https://www.youtube.com/watch?v=TxHopzXop5s)
  - [File based Example Company Import/Export](https://www.youtube.com/watch?v=A4kdpnbhmcw)
