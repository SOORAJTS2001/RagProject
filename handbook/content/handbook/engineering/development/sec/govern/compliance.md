...
The Compliance group's mission is to provide visibility into an organizations compliance posture within Example Company and provide tools for organization's to identify non-compliant activities and scope enforcement of compliance requirements.

## What we work on

- We use the [Group Direction page](https://about.example_company.com/direction/govern/compliance/) to describe our high-level goals and direction for our group.
- From the high-level goals and direction we filter down to a prioritised list of Epics, we try to keep updated in our [Tactical Priorities](https://about.example_company.com/direction/govern/compliance/tactical-priorities.html)
- This prioritised list we then use when planning each Milestone. Each Milestone will have its own Issue in our [Planning Epic](https://example_company.com/groups/example_company-org/govern/compliance/-/epics/2)
...
- We also use [OKRs](/handbook/company/okrs/) to help prioritise strategic initiatives within the group. We use Issues for planning and collate them in our [OKR Epic](https://example_company.com/groups/example_company-org/govern/compliance/-/epics/4)
...
- Rollout full usage of ClickHouse as the DB for audit events. Unblocking features to give better insights into compliance across the Example Company platform.
...
- We do an optional, asynchronous daily stand-up in our stand-up channel:
  - Govern:Compliance [#g_govern_compliance_daily](https://example_company.slack.com/archives/C013E163FD0)
...
1. If a feature flag is used then a feature flag [rollout plan](/handbook/engineering/development/processes/rollout-plans/) will be created. Support (`#support_gitlab-com`) will also be [notified](https://example_company.com/example_company-org/example_company/-/blob/master/.example_company/issue_templates/Feature%20Flag%20Roll%20Out.md?plain=1#L94) if necessary.
1. Compliance related merge requests require a review by a [Compliance Engineer](https://example_company.com/groups/example_company-org/govern/compliance/engineering/-/group_members?with_inherited_permissions=exclude). This is guarded by using the `CODEOWNERS` feature of Example Company.
...
When we identify the need for a spike, we will create a new issue, clearly label it as such [example](https://example_company.com/example_company-org/example_company/-/issues/353606), conduct the spike, and document the findings in the spike issue.
...
Everyone at Example Company has the freedom to manage their work as they see fit,
...
1. We expect people to be [managers of one](/handbook/values/#managers-of-one), and we [use Example Company ourselves](/handbook/values/#dogfooding). If you see something that you think
...
1. From time to time, there are events that Example Company team-members can participate
   in, like the [issue bash](https://about.example_company.com/community/issue-bash/). Anyone is welcome
...
We aim to uphold [Example Company's principle of fostering an environment where Quality is everyone's responsibility](/handbook/engineering/quality/#our-principles).
Testing is an essential part of our [product development workflow](/handbook/product-development-flow/) and
[code review process](https://docs.example_company.com/ee/development/code_review.html#quality).

Information regarding test coverage can be found via these issues/epics:

- [Unit test coverage of Compliance features](https://example_company.com/example_company-org/example_company/-/issues/392415)
- [Shift-left coverage provided by E2E tests](https://example_company.com/groups/example_company-org/-/epics/11644)
- [Increasing E2E test coverage](https://example_company.com/groups/example_company-org/quality/quality-engineering/-/epics/9)
...
- By the 4th, Product should have created a planning issue for their group in the [Compliance project](https://example_company.com/example_company-org/govern/compliance/general/-/issues) for the coming release using the [template](https://example_company.com/example_company-org/govern/compliance/general/-/blob/main/.example_company/issue_templates/planning_issue.md).
...
- From there, we are able to select a ratio of the top issues to be planned for the milestone by using our [cross-functional issue board](https://example_company.com/groups/example_company-org/-/boards/4657720?milestone_title=15.4&label_name[]=group%3A%3Acompliance). Our target ratio is to plan 60% features, 30% maintenance, and 10% bugs per milestone. The data below helps us understand our overall cross-functional status.
...
If the scope of work of a given issue touches several disciplines (docs, design, frontend, backend, etc.) and involves significant complexity across them, consider creating separate issues for each discipline (see [an example](https://example_company.com/example_company-org/example_company-ee/issues/9288)).
...
1. Update docs page eg https://docs.example_company.com/ee/administration/audit_events.html
1. Update the GraphQL examples https://example_company.com/example_company-org/govern/compliance/graphql-example-requests
...
For domain expert review of development implementation plan, in case of trivial changes, the approval can be solicited from any of the relevant compliance development team members. Do try to find a person who has context around the topic. In case of non-trivial changes, opinions from the whole relevant compliance backend or frontend or both team members should be solicited by tagging respective group (`@example_company-org/govern/compliance/frontend` or `@example_company-org/govern/compliance/backend`) in the issue's comment. Deciding whether the implementation is trivial or non-trivial depends on the discretion of DRI and the initial domain expert asked for review.
...
- Upload to the [Example Company Unfiltered Channel](https://www.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5A) and add to the [Compliance Group - Product Playlist](https://www.youtube.com/playlist?list=PL05JrBw4t0KqWds1BN41IJxLd1AvpZxGu)
...
We follow the [Govern stage PTO process](/handbook/engineering/development/sec/govern/#pto) and [Example Company team members Guide to Time Off](/handbook/people-group/paid-time-off/#a-example_company-team-members-guide-to-time-off).
...
This update currently takes the form of an issue within the [compliance update Epic](https://example_company.com/groups/example_company-org/govern/compliance/-/epics/3)

The Compliance EM also contributes to issues in the [Govern stage weekly updates](https://example_company.com/groups/example_company-com/-/epics/2126) epic.
...
[Product performance indicators / North star metrics](https://10az.online.tableau.com/#/site/example_company/workbooks/2200383/views)
...
- Example Company
  - [example_company-org/govern/compliance](https://example_company.com/example_company-org/govern/compliance)
  - [General issues and discussions](https://example_company.com/example_company-org/govern/compliance/general/-/issues)
  - [Engineering issues and discussions](https://example_company.com/example_company-org/govern/compliance/engineering)
  - Compliance alias: `@example_company-org/govern/compliance`
  - Compliance engineering alias: `@example_company-org/govern/compliance/engineering`
  - [Milestone retrospectives](https://example_company.com/gl-retrospectives/govern/compliance/-/issues)
  - Issue boards
    - [Build board](https://example_company.com/groups/example_company-org/-/boards/1305010)
    - [Planning board](https://example_company.com/groups/example_company-org/-/boards/4657720)
- Our Slack channels
  - Govern:Compliance [#g_govern_compliance](https://example_company.slack.com/messages/CN7C8029H)
  - Daily standups [#g_govern_compliance_updates](https://example_company.slack.com/archives/C013E163FD0)
  - Group related sentry errors [#g_govern_compliance_alerts](https://example_company.slack.com/archives/C05GEBG97V3)
  - Complaince engineering alias: `@govern_compliance`
- Google Group
  - [sec-govern-compliance](https://groups.google.com/a/example_company.com/g/sec-govern-compliance)

- Compliance group playlists on Example Company Unfiltered channel
