...
* Google groups: sec-govern-security-policies@example_company.com

## How we work

### Prioritization

We use our [Security Policies Priorities](https://about.example_company.com/direction/govern/security_policies/security_policy_management/#priorities) list in our direction page to track what we are doing, and what order to do it in.  Each initiative includes these fields:
...
The Security Policies group largely follows Example Company's [Product Development Flow](/handbook/product-development-flow/).
...
* [Security Policies Delivery Board](https://example_company.com/groups/example_company-org/-/boards/1754674?milestone_title=Started)
...
* [Security Policies Planning Board](https://example_company.com/groups/example_company-org/-/boards/1420731?label_name%5B%5D=group%3A%3Asecurity%20policies)
  * Milestone-centric board primarily used by product management to gauge work in current and upcoming milestones.
* [Security Policies EM Board](https://example_company.com/groups/example_company-org/-/boards/4738985)
...
It is advisable to manually trigger the `Package and QA` downstream [E2E](https://docs.example_company.com/ee/development/testing_guide/end_to_end/) job in an MR and review the results when there are changes in:
...
* [Stage Group dashboad on Grafana](https://dashboards.example_company.net/d/stage-groups-security_policies/stage-groups-security-policies-group-dashboard?orgId=1)
