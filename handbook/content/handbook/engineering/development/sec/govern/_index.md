...
To support Example Company's product vision through alignment with the [Govern stage](https://about.example_company.com/direction/govern/) product direction.
...
- [Anti-abuse](https://about.example_company.com/direction/govern/anti-abuse/#priorities)
- [Authentication](https://about.example_company.com/direction/govern/authentication/#priorities)
- [Authorization](https://about.example_company.com/direction/govern/authorization/#priorities)
- [Compliance](https://about.example_company.com/direction/govern/compliance/tactical-priorities.html#priorities)
- [Pipeline Security](https://about.example_company.com/direction/govern/pipeline_security/#priorities)
- [Security Policies](https://about.example_company.com/direction/govern/security_policies/#priorities)
- [Threat Insights](https://about.example_company.com/direction/govern/threat_insights/17_threat_insights_priorities.html#priorities) ([16.x](https://about.example_company.com/direction/govern/threat_insights/16_threat_insights_priorities.html#priorities))

### Product Documentation Links

- [Security Dashboard](https://docs.example_company.com/ee/user/application_security/security_dashboard/)
- [Vulnerability Pages](https://docs.example_company.com/ee/user/application_security/vulnerabilities/)
- [Security scanner integration](https://docs.example_company.com/ee/development/integrations/secure.html)
- [Secure and Govern terminology](https://docs.example_company.com/ee/user/application_security/terminology/)
- [Govern testing priorities](https://about.example_company.com/direction/govern/testing_priorities.html)
- [Pipeline Security](https://docs.example_company.com/ee/ci/pipelines/pipeline_security.html)
...
- Example Company: `@example_company-org/govern/managers`
...
We use the [Govern Sub-department Board](https://example_company.com/example_company-com/govern-sub-department/-/boards/4833026) to better organize our discussions.

### Weekly updates

The Govern development teams provide [weekly status updates](https://example_company.com/groups/example_company-com/-/epics/2126) using an issue template and CI scheduled job.
As priorities change, engineering managers update the [template](https://example_company.com/example_company-com/govern-sub-department/-/blob/main/.example_company/issue_templates/govern_stage_weekly_update.md) to include areas of interest such as priorities, opportunities, risks, and security and availability concerns. The updates are Example Company internal.
...
The issue provides a place to discuss and document coverage for any work in progress, or projects where the team member is the directly responsible individual (DRI), and support the [Paid Time Off at Example Company](/handbook/people-group/paid-time-off/) policy.

We use an internal issue tracker as team member PTO is not public information, and a PTO template

- [PTO issue list](https://example_company.com/example_company-com/govern-sub-department/-/issues/?sort=weight_desc&state=opened&label_name%5B%5D=PTO&first_page_size=20)
- [New PTO issue template](https://example_company.com/example_company-com/govern-sub-department/-/issues/new?issuable_template=ooo_template)
...
At Example Company our goal is that [everyone can contribute](/handbook/company/mission/#contribute-to-example_company-application). This applies to Example Company team members and the wider community through community contributions. We welcome contributions to any and all features, but recognize that first time contributors may prefer to start with smaller features. To support this we maintain a list of `quick wins` that may be more suitable for first time contributors, and contributors new to the domains in Govern.

- [Quick wins](https://example_company.com/example_company-org/example_company/-/issues/?sort=updated_desc&state=opened&label_name%5B%5D=quick%20win&label_name%5B%5D=devops%3A%3Agovern&first_page_size=100)
...
- Group [#g_govern_security_policies](https://example_company.slack.com/archives/CU9V380HW)
- Group [#g_govern_threat_insights](https://example_company.slack.com/archives/CV09DAXEW)
- Group [#g_govern_compliance](https://example_company.slack.com/messages/CN7C8029H)
- [Software Supply Chain Security working group](/handbook/company/working-groups/software-supply-chain-security/)

### Technical Documentation Links

- [End-to-end tests](https://example_company.com/example_company-org/example_company/-/tree/master/qa/qa/specs/features/ee/browser_ui/10_govern)
