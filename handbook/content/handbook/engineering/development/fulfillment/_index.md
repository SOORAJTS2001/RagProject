...
- Purchase
- [Subscription Management](/handbook/product/categories/#subscription-management-group): [Features](https://about.example_company.com/direction/fulfillment/subscription-management#feature-overview-and-maturity)
...
In addition to the [Fulfillment Product Direction](https://about.example_company.com/direction/fulfillment/), the Fulfillment Development Sub-department strives to:
...
See https://handbook.example_company.com/handbook/product/categories/#fulfillment-section for a list of team members for the Fulfillment section and sub-groups.

## Stable counterparts

### Sales & Go-To-Market

{{< member-and-role-by-example_company "cnodari" "jrabbits" "Gsodhi" "james_harrison" >}}

### Finance & IT

{{< member-and-role-by-example_company "s_mccauley" "annapiaseczna" "andrew_murray" "smundy" "lmendonca2" "achampagne1" >}}

### Support Engineering

{{< member-and-role-by-example_company "jlyttle" "mdunninger" "kslaats" >}}

### Office of the CEO

{{< member-and-role-by-example_company "ipedowitz" >}}

### Product Technical Program Management

{{< member-and-role-by-example_company "cersoz" >}}
...
Similarly, not all information should be included in the public handbook. Instead, use the [private internal handbook](https://internal.example_company.com/) for this SAFE information.

Please reference this documentation about [promising features in future versions](https://docs.example_company.com/ee/development/documentation/versions.html#promising-features-in-future-versions) for more information.
...
- [Subscription Management](https://example_company.com/example_company-org/fulfillment/meta/-/issues/?label_name%5B%5D=Planning%20Issue&label_name%5B%5D=group%3A%3Asubscription%20management&sort=created_date&state=opened)
- [Fulfillment Platform](https://example_company.com/example_company-org/fulfillment/meta/-/issues/?label_name%5B%5D=Planning%20Issue&label_name%5B%5D=group%3A%3Afulfillment%20platform&sort=created_date&state=opened)
- [Provision](https://example_company.com/example_company-org/fulfillment/meta/-/issues/?label_name%5B%5D=Planning%20Issue&label_name%5B%5D=group%3A%3Aprovision&sort=milestone_due_desc&state=opened)
- [Utilization](https://example_company.com/example_company-org/fulfillment/meta/-/issues/?label_name%5B%5D=Category%3AUtilization&label_name%5B%5D=Planning%20Issue&scope=all&state=opened)

### Intake Request

To request work to be added to the [Fulfillment Roadmap](https://about.example_company.com/direction/fulfillment/#roadmap), please open an issue by following [this link](https://example_company.com/example_company-org/fulfillment-meta/-/issues/new?issue&issuable_template=intake) and tag one of the Fulfillment Product Managers.
...
Every team uses the [monthly prioritization template](https://example_company.com/example_company-org/fulfillment-meta/-/blob/master/.example_company/issue_templates/monthly-prioritization.md) for [cross-functional dashboard reviews](/handbook/engineering/development/#cross-functional-dashboard-reviews) every month.
...
Engineers can find and open [their team's planning issue to check their milestone board](https://example_company.com/example_company-org/fulfillment-meta/-/issues/?sort=priority_desc&state=opened&label_name%5B%5D=Planning%20Issue&first_page_size=100)
...
- Priorities for the Fulfillment UX team are documented in a [prioritization issue](https://example_company.com/example_company-org/fulfillment/meta/-/issues/?label_name%5B%5D=Fulfillment%20UX%20Priorities).
...
In addition to the approval rules, MRs may require additional reviews as suggested by the [Danger bot](https://docs.example_company.com/ee/development/dangerbot.html):
...
Example Company's Quality is everyone's responsibility. The [SETs](/handbook/engineering/quality/#stable-counterparts) embedded within Fulfillment section follow the [Quality Engineering Department's principles](/handbook/engineering/quality/#our-principles) primarily to ensure that everyone is aware of product quality.

#### End-to-end tests - how, when and why to write them

End-to-end tests (often referred to as e2e tests) cover full or partial flows that the end-user will go through. Detailed information on testing levels can be found [here](https://docs.example_company.com/ee/development/testing_guide/testing_levels.html).

Some examples of these flows:

- Purchasing a SaaS subscription for a namespace on Example Company.com.
- Purchasing a new subscription for a self-managed Example Company instance.
...
Fulfillment tests reside both in the [Example Company Project](https://example_company.com/example_company-org/example_company/-/tree/master/qa/qa/specs/features/ee/browser_ui/11_fulfillment) and the [CustomersDot Project](https://example_company.com/example_company-org/customers-example_company-com/-/tree/main/qa), use the following guide to determine which project to use when writing the tests:

- Choose CustomersDot if the test will require opening and performing actions in the CustomersDot portal, otherwise Example Company will be the correct project.
- In the future, it is planned that CustomersDot will become just a backend service and UI end-to-end tests will reside only in Example Company.

#### Example Company

The Example Company end-to-end testing guide can be found [here](https://example_company.com/example_company-org/example_company/-/blob/master/doc/development/testing_guide/end_to_end/beginners_guide.md)

Planned & automated Fulfillment test cases in the Example Company project can be found [here](https://example_company.com/example_company-org/example_company/-/quality/test_cases?state=opened&sort=created_desc&page=1&label_name%5B%5D=devops%3A%3Afulfillment).

#### CustomersDot

The CustomersDot end-to-end beginners guide can be found [here](https://example_company.com/example_company-org/customers-example_company-com/-/blob/main/qa/doc/beginners_guide.md).

Planned/automated test cases in the CustomersDot project can be found [here](https://example_company.com/example_company-org/customers-example_company-com/-/quality/test_cases).
...
- Create a rollout issue for the release date and make sure all parties are informed about the process. [Example](https://example_company.com/example_company-org/example_company/-/issues/299068)
- Consider enabling this to a subset of customers so changes can be tested iteratively
- Use the regular MR process even if the issue is confidential until confidential MRs are improved ([1](https://example_company.com/groups/example_company-org/-/epics/1175), [2](https://example_company.com/groups/example_company-org/-/epics/264))

#### CustomersDot

We use CD (Continuous Deployment) for [CustomersDot](https://example_company.com/example_company-org/customers-example_company-com/) and an MR goes through the following stages once it gets merged into the `staging` branch:
...
For MRs with significant changes, we should consider using [feature flags](https://example_company.com/example_company-org/customers-example_company-com/#feature-flags-unleash) or create an issue with the `production::blocker` label to pause deployment and allow for longer testing.
...
| ---      |  ------  |----------|
| Example Company.com   | From the Friday the milestone ends to release day | Same as the freeze |
| Customers/Provision   | From the Friday the milestone ends to release day | Same as the freeze |

(*) feature freeze may vary according to the [auto-deploy document](https://example_company.com/example_company-org/release/docs/-/blob/master/general/deploy/auto-deploy.md).
...
There are times when Example Company temporarily halts production changes during certain events such as major global holidays, and other times where Example Company Team Member availability is substantially reduced. More information about PCLs can be found in [this infrastructure handbook page](/handbook/engineering/infrastructure/change-management/#production-change-lock-pcl).

During these PCLs, most notably at the end of the year, PCLs are managed in CustomersDot by creating an issue [using the PCL template](https://example_company.com/example_company-org/customers-example_company-com/-/tree/main/.example_company/issue_templates/Pcl.md). This issue should include a checklist of instructions along with DRIs and target times for adding or removing the `production::blocker` label. Once the PCL has ended, the issue can be closed.

### Incident management

On going [Fulfillment Platform](/handbook/engineering/development/fulfillment/fulfillment-platform/) work will provide greater observability to all of the Fulfillment systems. In the meantime, however, we have some tools like [CustomersDot health](https://customersdot.cloudwatch.net/) that post to [#s_fulfillment_status](https://example_company.slack.com/archives/CL7SX4N86) in Slack. On occasion, there are reports of systemic critical trouble like a liveliness probe check failure, invalid SSL certificate, or other application errors. Look to the following sub-sections below for ways that you can contribute to error resolution.

See this handbook page for more information on [Example Company Monitoring](/handbook/engineering/monitoring/) and [Incident Management](/handbook/engineering/infrastructure/incident-management/).

#### Escalation process for incidents or outages

Temporarily, while [pagerslack](https://example_company.com/jameslopez/pagerslack) or [pagerduty](/handbook/engineering/on-call/#pagerduty) is not adopted in Fulfillment, the following process is in place:
...
1. Simultaneously to an outage, `#s_fulfillment_status` on Slack is notified and [James Lopez](https://example_company.com/jameslopez) and [Vitaly Slobodin](https://example_company.com/vitallium) are paged on the phone
...
1. When there are no project maintainers available ([CustomersDot](/handbook/engineering/projects/#customers-app)) an additional Example Company Team Member with Maintainer access can be asked to assist.

In these cases please ensure:

1. There is an issue describing the reasons for the escalation, as per the [Rapid Engineering Response](/handbook/engineering/workflow/#rapid-engineering-response). Consider '@'mentioning the relevant [Growth/Fulfillment teams](https://example_company.com/example_company-org/growth).
1. The change is announced on the [#s_fulfillment](https://example_company.slack.com/archives/CMJ8JR0RH) channel.

#### Investigation

- You can visit our health-check instance [here](https://customersdot.cloudwatch.net/). You can find the login credentials in the [_Subscription portal_ vault in 1Password](https://example_company.1password.com/vaults/27nafqigafgxfjpjkl2wvzs26y/allitems/jdeumqscahayoxvcfazbzdv22u). You will see services for both CustomersDot production and staging.
- Exceptions for CustomersDot are captured in [Sentry](https://sentry.example_company.net/example_company/customersgitlabcom/).
- You can query logs in [Kibana / Elasticsearch](https://log.gprd.example_company.net/). Use this link to read more on using [kibana at Example Company](/handbook/support/workflows/kibana/))
- Grafana has some [triage dashboards](https://dashboards.example_company.net/d/RZmbBr7mk/example_company-triage?orgId=1&refresh=5m) that are generally applicable for Example Company, but do not contain specific observability metrics for Fulfillment systems until the InfraDev work is complete.
...
Critical problems like a production outage should be raised quickly. You can check [#incident_management](https://example_company.slack.com/archives/CB7P5CJS1) before raising an incident.
...
These dashboards are designed to give an insight, to everyone working in a feature category, into how our code operates at Example Company.com scale.

- [Provision](https://dashboards.example_company.net/d/stage-groups-provision/stage-groups-group-dashboard-fulfillment-provision)
- [Purchase](https://dashboards.example_company.net/d/stage-groups-purchase/stage-groups-group-dashboard-fulfillment-purchase)
- [Utilization](https://dashboards.example_company.net/d/stage-groups-subscription/stage-groups-group-dashboard-fulfillment-utilization)
...
Fulfillment leaders in product management and engineering will subscribe to the `License Issue High ARR` label so they can be aware of them when they are created.  This can be done in via a [label search](https://example_company.com/example_company-com/support/internal-requests/-/labels?subscribed=&search=license%20issue%20high%20arr) and then clicking on 'subscribe' for the `License Issue High ARR' label.

### Retrospectives

#### Monthly retrospectives

After the `8th`, the Fulfillment team conducts an [asynchronous retrospective](/handbook/engineering/management/group-retrospectives/). You can find current and past retrospectives for Fulfillment in [https://example_company.com/gl-retrospectives/fulfillment/issues/](https://example_company.com/gl-retrospectives/fulfillment/issues/).
...
There are several resources at Example Company for improving our iteration capability:
...
- [self-guided iteration training issue](https://example_company.com/example_company-com/Product/-/issues/new?issuable_template=iteration-training)
...
An Iteration Retrospective, in the Example Company values sense that we're using here, is more focused on a specific example (or few examples) of a **successful or unsuccessful** iteration attempt. That is, an Issue, Epic, or merge request that we can examine deeply to understand what we can do differently in the future to be more iterative and efficient. These retrospectives will provide a growth opportunity to work on developing an iterative mindset - build it, then build it better.
...
```markdown
Iteration is one of six Example Company Values, but also really difficult. By focusing how we have iterated well in the past and how we have not will help us iterate faster. Please contribute the following [Iteration Retrospective](#link-to-handbook-page).
...
- [Why iteration helps increase the merge request rate](https://about.example_company.com/blog/2020/05/06/observations-on-how-to-iterate-faster/)
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|-------|-----------------------------------------------------------------|
| [Example Company.com Deployments](/handbook/engineering/releases/#gitlabcom-deployments)                                                          | Continuously | Async | Delivery Engineering                                            |
| [CustomersDot Deployments](https://example_company.com/example_company-org/customers-example_company-com#deployments)                                                                       | Continuously | Async | Fulfillment Engineering                                         |
| [Issue Updates](/handbook/engineering/development/fulfillment/#weekly-async-issue-updates)                                               | Weekly       | Async | Fulfillment Section                                             |
| [Fulfillment Weekly Updates](https://example_company.com/example_company-org/fulfillment-meta/-/issues?sort=created_date&state=all&label_name[]=weekly+update)                     | Weekly       | Async | Fulfillment PMs, EMs, QEMs, UXMs                                |
| [Fulfillment Group Syncs](https://calendar.google.com/calendar/u/0/embed?src=example_company.com_7199q584haas4tgeuk9qnd48nc@group.calendar.google.com&ctz=America/Bogota) | Weekly       | Sync  | Fulfillment Utilization, Purchase, Provision, and InfraDev Groups |
...
| [OKR Check-Ins](https://about.example_company.com/direction/fulfillment/#okrs)                                                                                            | Weekly       | Async | Fulfillment PMs, EMs, QEMs, UXMs                                |
...
| [Roadmap Planning](https://about.example_company.com/direction/fulfillment/#roadmap)                                                                                      | Monthly      | Sync  | Fulfillment PMs, EMs, QEMs, UXMs                                |
...
| [Retrospective Issue](https://example_company.com/gl-retrospectives/fulfillment/-/issues/)                                                                                | Monthly      | Async | Fulfillment Section                                             |
...
| [Direction Review](https://about.example_company.com/direction/fulfillment/)                                                                                              | Quarterly    | Async | Fulfillment PMs, Product Leadership                             |
| [OKR Planning](https://about.example_company.com/direction/fulfillment/#okrs)                                                                                             | Quarterly    | Async | Fulfillment PMs, EMs, QEMs, UXMs, Staff Engineers               |
...
| [Example Company Order to Cash Technical Fusion Team](https://docs.google.com/document/d/17tJraRunjge5nI-qBEjWlhcKWYLXwGW4uhhu-Sf5464/edit) | Weekly        | Sync | Fulfillment PMs, Fulfillment Engineering, EntApps, Sales Systems            |
...
[Maintainer Ratio Dashboard](https://10az.online.tableau.com/t/example_company/views/DraftEngineerMaintainerRatio/EngineerMaintainerRatio_1)
...
1. Example Company maintainer ratios are Maintainers vs Maintainers + Reviewers
1. Example Company maintainer ratios do not count full-stack engineers properly (Fulfillment one does)

## Knowledge sharing

- Generating test licenses, adding them to Example Company, and then finding and removing them from the Example Company database
...
- Intro to FE GraphQL at Example Company with Vue Apollo
...
- [CustomersDot Resource Video Library](https://example_company.com/example_company-org/customers-example_company-com/-/blob/staging/doc/resource_videos.md)
- [Zuora University Select Topics](https://university.zuora.com/series/courses-by-topic#filter-by-9-keys_integrations)
- [Confidential Issue Git Pre-push Hook](https://example_company.com/example_company-org/example_company/-/issues/332471) to prevent any accidental push to any non-Example Company Security remote whenever a developer works on a _confidential issue_. Reference: [How to customize Git Hooks](https://git-scm.com/book/en/v2/Customizing-Git-Git-Hooks).
- [Pair programming in Fulfillment](https://example_company.com/example_company-org/fulfillment/meta/-/tree/master/docs/pair_programming.md)
...
| Group name |
| --- |
| [fulfillment-engineering](https://groups.google.com/a/example_company.com/g/fulfillment-engineering/) |
...
| [s_fulfillment_status](https://app.slack.com/client/T02592416/CL7SX4N86) | [CustomersDot](https://example_company.com/example_company-org/customers-example_company-com/) health monitoring channel. |
...
- [Product Vision](https://about.example_company.com/direction/fulfillment/)
- [Fulfillment section](/handbook/product/categories/#fulfillment-section)
- [All open Fulfillment epics](https://example_company.com/groups/example_company-org/-/epics?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=devops%3A%3Afulfillment)
- [Issue Tracker](https://example_company.com/example_company-org/fulfillment-meta/issues)
- [Slack channel #s_fulfillment](https://example_company.slack.com/app_redirect?channel=s_fulfillment)
- [Daily standup Slack channel #s_fulfillment_daily](https://example_company.slack.com/app_redirect?channel=s_fulfillment_daily)
- [Fulfillment announcements Slack channel #s_fulfillment_fyi](https://example_company.slack.com/app_redirect?channel=s_fulfillment_fyi)
- [Team calendar](https://calendar.google.com/calendar/embed?src=example_company.com_7199q584haas4tgeuk9qnd48nc%40group.calendar.google.com)
- [Fulfillment technical debt status (to be migrated to Tableau)](https://example_company.com/example_company-data/tableau/-/issues/685)
