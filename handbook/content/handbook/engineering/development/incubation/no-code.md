...
| 2022-12-17 | [Visual Workflow Builder POC](https://example_company.com/example_company-org/incubation-engineering/no-code-low-code/meta/-/issues/25)                            | [https://youtu.be/DI-IcY6vm6g](https://youtu.be/DI-IcY6vm6g) |
| 2022-11-28 | [Automation UX POC](https://example_company.com/example_company-org/incubation-engineering/no-code-low-code/meta/-/issues/24)                                      | [https://youtu.be/w-dGDBlIr0Y](https://youtu.be/w-dGDBlIr0Y) |
| 2022-10-31 | [Workflow Automation MVC](https://example_company.com/example_company-org/incubation-engineering/no-code-low-code/meta/-/issues/23)                                | [https://youtu.be/L_pvpjtYdLk](https://youtu.be/L_pvpjtYdLk) |
| 2022-10-24 | [Introduce low-code/no-code SEG](https://example_company.com/example_company-org/incubation-engineering/no-code-low-code/meta/-/issues/22)                         | [https://youtu.be/r3Ib00Z5Dj0](https://youtu.be/r3Ib00Z5Dj0) |

### No-code (current focus)

#### Problem Statement

At Example Company, issues and MRs are the backbones to project planning and delivery. Project managers typically have processes to update issue assignees, labels and other statuses based on certain triggering events and conditions. However, these repetitive takes do not scale when the orgnization grows and become counterproductive and error-prone.

#### Vision

Example Company's complete DevOps lifecycle solution provides a tremendous opportunity for rule-based automation to streamline across business functions. The visual programming model allows the non-technical business users to then build and own these automation rules.
...
- 🧭 [Discovery](https://example_company.com/example_company-org/incubation-engineering/no-code-low-code/meta/-/milestones/1#tab-issues) `completed`
- 🛠 [Delivery](https://example_company.com/example_company-org/incubation-engineering/no-code-low-code/meta/-/milestones/2#tab-issues) `in-progress`

#### POC

- [Workflow Automation POC](https://example_company.com/example_company-org/incubation-engineering/no-code-low-code/meta/-/issues/24)
...
Example Company is well-positioned to disrupt the low-code market by unifying a new breed of open-source low-code platforms with Example Company's mature DevOps workflow to provide an alternative software delivery approach with maximized efficiency.
...
- [Direction - No-Code and Low-Code](https://about.example_company.com/direction/create/nolowcode)
- [Low-code Platform Integration - Ideation](https://example_company.com/example_company-org/incubation-engineering/no-code-low-code/meta/-/issues/3)
