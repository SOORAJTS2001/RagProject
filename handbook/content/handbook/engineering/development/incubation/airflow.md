...
Below are a few of the initial options to integrate Example Company and Airflow:

1. Integration of the DAG overview into Example Company
1. Example Company as authentication provider for Airflow
1. Using Example Company runners as compute for Airflow
1. Using preview apps to create an instance of Airflow per MR to ease the code review process
1. Provision an Airflow instance directly from Example Company
