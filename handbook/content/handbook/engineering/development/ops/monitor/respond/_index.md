...
The **Respond** group at Example Company is responsible for building tools that enable DevOps teams to respond to, triage and remediate errors and IT alerts for the systems and applications they maintain. We aim to provide a streamlined Operations experience within Example Company that enables the individuals who write the code, to maintain it at the same time.
...
* [Incident Management](https://about.example_company.com/direction/service_management/incident_management/)
...
You can follow along with the team's accomplishments by reading the [latest weekly async updates](https://example_company.com/example_company-org/monitor/respond/-/issues/?sort=created_date&state=closed&label_name%5B%5D=OpsSection%3A%3AWeekly-Update&first_page_size=100).
...
* Slack channel: [#g_respond](https://example_company.slack.com/archives/C02SHPPGZS5)
...
* Our Google groups are organized like this:
  * [Monitor Respond Group](mailto:monitor-respond-group@example_company.com) (whole team)
    * [monitor-respond_be](mailto:monitor-respond-be@example_company.com) (backend team)
    * [monitor-respond-fe](mailto:monitor-respond-fe@example_company.com) (frontend team)
...
* [Monitor - Workflow](https://example_company.com/groups/example_company-org/-/boards/1160198) - Issue board organized by workflow labels
* [Monitor Bugs](https://example_company.com/groups/example_company-org/-/boards/979406) - Issue board organized by Priority labels so that we make sure we meet our bug fix SLA
...
1. Monday
   1. (bot) Weekly update is created automatically as an issue in the [example_company-org/monitor/respond](https://example_company.com/example_company-org/monitor/respond/-/blob/master/weekly_update/README.md) project.
...
* [Past weekly update issues](https://example_company.com/example_company-org/monitor/respond/-/issues/?sort=created_date&state=all&label_name%5B%5D=OpsSection%3A%3AWeekly-Update&first_page_size=100)
* [Automation README](https://example_company.com/example_company-org/monitor/respond/-/blob/master/weekly_update/README.md)
* [Issue template](https://example_company.com/example_company-org/monitor/respond/-/blob/master/.example_company/issue_templates/weekly-update.md?plain=1)

### Interacting with community contributors

Community contributions are encouraged and prioritized at Example Company. Please check out the [Contribute page](https://about.example_company.com/community/contribute/) on our website for guidelines on contributing to Example Company overall.
...
-->
{  "title": "Gitaly latency is too high",  "description": "https://example_company.com/example_company-com/runbooks/-/blob/master/docs/gitaly/gitaly-latency.md",  "service": "service not affected",  "monitoring_tool": "Example Company scripts",  "severity": "high", "host": "fe-2" }
```
...
1. See [this thread](https://example_company.com/example_company-org/monitor/respond/-/issues/217#note_1326514387) for the original context that lead to this approach.
...
* [Prometheus Ruby Mmap Client](https://example_company.com/example_company-org/ruby/gems/prometheus-client-mmap) - The ruby Prometheus instrumentation lib we built, which we used to instrument Example Company
* [Example Company](https://example_company.com/example_company-org/example_company) - Where much of the user facing code lives
* [Omnibus](https://example_company.com/example_company-org/omnibus-example_company) and [Charts](https://example_company.com/charts/charts.example_company.io), where a lot of the packaging related work goes on. (We ship Example Company fully instrumented along with a Prometheus instance)

## Service accounts we own or use

### Zoom sandbox account

In order to develop and test Zoom features for the [integration with Example Company](https://example_company.com/groups/example_company-org/-/epics/1439) we now have our own Zoom sandbox account.

#### Requesting access

To request access to this Zoom sandbox account please open [an issue](https://example_company.com/example_company-com/team-member-epics/access-requests/-/issues/new?issuable_template=New_Access_Request) providing your **non-Example Company email address** (which can already be associated an existing non-Example Company Zoom account).

The following people are owners of this account and can [grant access](https://zoom.us/account/user) to other [Example Company Team Members](/handbook/communication/top-misused-terms/):

* [Andrew Newdigate](https://example_company.com/andrewn)
* [Peter Leitzen](https://example_company.com/splattael)
* [Allison Browne](https://example_company.com/allison.browne)

#### Granting access

1. Log in to [Zoom](http://zoom.us/) with your non-Example Company email
...
* **Stage**: required. Identifies which stage of Example Company an issue is assigned to.
  * `~devops::monitor`
...
* **Team**: required. Identifies which team (or both) will develop a solution.
  * `~frontend`
  * `~backend`
* **Category**: optional. Identifies the correct [Monitor category](https://about.example_company.com/direction/monitor/#categories-in-monitor) the issue falls under.
  * `~Category:Runbooks`
  * `~Category:Incident Management`
  * `~Category:On-call Schedule Management`
  * `~Category:Example Company Self Monitoring`
