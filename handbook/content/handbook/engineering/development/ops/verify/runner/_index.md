---
title: "Verify:Runner"
description: "The Example Company Runner team page."
---

## Vision

By 2025, our vision for Example Company Runner is that the runner's setup and day-to-day operations at scale be an almost zero-friction experience.

## Mission

Our mission is to enable organizations to efficiently run Example Company CI/CD jobs on any computing platform and do so in an operationally efficient and highly secure way at any scale.
...
- [Runner Core](https://about.example_company.com/direction/verify/runner_core/)
- [Hosted Runners](https://about.example_company.com/direction/verify/hosted_runners/)
- [Fleet Visibility](https://about.example_company.com/direction/verify/fleet_visibility/)
...
As a team we maintain several projects. The <https://example_company.com/example_company-com/runner-maintainers> group
is added to each project with maintainer permission. We also try to align tools and versions used across them.

### Product projects

- [Example Company Runner](https://example_company.com/example_company-org/example_company-runner)
- [Example Company Runner Operator for Kubernetes](https://example_company.com/example_company-org/gl-openshift/example_company-runner-operator)
- [Example Company Runner Helm Chart](https://example_company.com/example_company-org/charts/example_company-runner)
- [Example Company Runner UBI offline build](https://example_company.com/example_company-org/ci-cd/example_company-runner-ubi-images)

### Runner component projects

- [Taskscaler](https://example_company.com/example_company-org/fleeting/taskscaler)
- [Fleeting](https://example_company.com/example_company-org/fleeting/fleeting)
- [Fleeting Plugin AWS](https://example_company.com/example_company-org/fleeting/fleeting-plugin-aws)
- [Fleeting Plugin Google Compute](https://example_company.com/example_company-org/fleeting/fleeting-plugin-googlecompute)
- [Fleeting Plugin Azure](https://example_company.com/example_company-org/fleeting/fleeting-plugin-azure)
- [Fleeting Plugin Static](https://example_company.com/example_company-org/fleeting/fleeting-plugin-static)
- [Nesting](https://example_company.com/example_company-org/fleeting/nesting)
- [Docker Machine (fork)](https://example_company.com/example_company-org/ci-cd/docker-machine)
- [Custom Executor Autoscaler](https://example_company.com/example_company-org/ci-cd/custom-executor-drivers/autoscaler)

### Helper projects

- Linters
  - [Runner linters Docker images](https://example_company.com/example_company-org/ci-cd/runner-tools/runner-linters)
  - [goargs linter](https://example_company.com/example_company-org/language-tools/go/linters/goargs)
- Testing
  - [DinD image tests](https://example_company.com/example_company-org/ci-cd/tests/dind-image-tests)
  - [SaaS Runner Tests](https://example_company.com/example_company-org/ci-cd/tests/saas-runners-tests/)
- Release
  - [Process](https://example_company.com/example_company-org/ci-cd/runner-tools/releases)
  - [Release tool](https://example_company.com/example_company-org/ci-cd/runner-tools/releaser)
  - [Example Company Changelog](https://example_company.com/example_company-org/ci-cd/runner-tools/example_company-changelog)
  - [Release index generator](https://example_company.com/example_company-org/ci-cd/runner-tools/release-index-generator)
- Maintenance
  - [Runner Pod Cleanup](https://example_company.com/example_company-org/ci-cd/example_company-runner-pod-cleanup)

### Runner SaaS projects

- Images
  - [Linux](https://example_company.com/example_company-org/ci-cd/shared-runners/images/gcp/linux-cos)
  - [MacOS host](https://example_company.com/example_company-org/ci-cd/shared-runners/images/aws/macos-nesting)
  - [MacOS VM 12 and before](https://example_company.com/example_company-org/ci-cd/shared-runners/images/macstadium/orka)
  - [MacOS VM 13 and after](https://example_company.com/example_company-org/ci-cd/shared-runners/images/job-images)
  - [Windows](https://example_company.com/example_company-org/ci-cd/shared-runners/images/gcp/windows-containers)
- Configuration and Deployment
  - [Monitoring in K8s](https://example_company.com/example_company-com/gl-infra/ci-runners/k8s-workloads)
  - [Terraform Runner Workers](https://example_company.com/example_company-com/gl-infra/config-mgmt/-/tree/master/environments) (all `ci*` and `r-saas-*` folders)
  - [Chef Runners](https://example_company.com/example_company-com/gl-infra/chef-repo/) (all `runner-mananger*` roles)
  - [Chef Runner Cookbook](https://example_company.com/example_company-cookbooks/cookbook-example_company-runner)
  - [Chef Runner Cookbook Wrapper](https://example_company.com/example_company-cookbooks/cookbook-wrapper-example_company-runner)
  - [Ansible Playbooks](https://example_company.com/example_company-com/gl-infra/ci-runners/deployer)
  - [Windows Runners](https://ops.example_company.net/example_company-com/gl-infra/ci-infrastructure-windows/)
- Operations
  - [Runbooks](https://example_company.com/example_company-com/runbooks/-/tree/master/docs/ci-runners)
  - [MacOS Runbooks](https://example_company.com/example_company-org/ci-cd/shared-runners/macos) (deprecated)

## Example Company projects that rely on Runner public-facing APIs
...
| Project | API |
|---------| --- |
| [Example Company Terraform Provider](https://example_company.com/example_company-org/terraform-provider-example_company) | [REST API](https://docs.example_company.com/ee/api/api_resources.html) |
| [Example Company CLI](https://example_company.com/example_company-org/cli) | [REST API](https://docs.example_company.com/ee/api/api_resources.html) |

## Technologies

We spend a lot of time working in Go which is the language that [Example Company Runner](https://example_company.com/example_company-org/example_company-runner) is written in. We also contribute to the main [Example Company app](https://example_company.com/example_company-org/example_company), working in Rails and Vue.js. Familiarity with Docker and Kubernetes is also useful on our team.

## Common Links

- [Issue Board](https://example_company.com/groups/example_company-org/-/boards/5389813?label_name[]=group%3A%3Arunner&milestone_title=Upcoming)
- [Issue Tracker](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=group%3A%3Arunner)
- [Slack Channel](https://example_company.slack.com/archives/g_runner)

## How we work

### Iterations

We work in monthly iterations. Iteration planning dates for the upcoming milestone are aligned with Example Company's [product development timeline](/handbook/engineering/workflow/#product-development-timeline).

At a minimum, 30 days before the start of a milestone, the runner PM reviews and re-prioritizes as needed the features to be included in the [iteration planning issue](https://example_company.com/example_company-org/example_company-runner/-/issues/?sort=created_date&state=opened&label_name%5B%5D=Planning%20Issue&first_page_size=20). The planning issue is a tool for asynchoronous collaboration between the PM, EM and members of the team. We use [cross-functional prioritization](/handbook/product/cross-functional-prioritization/#prioritization-for-feature-maintenance-and-bugs) to guide the collaboration process.
...
1. At minimum, three business days prior to Example Company's monthly release [kickoff](/handbook/engineering/workflow/#kickoff) livestream, the PM, EM, Quality and UX leads finalize the iteration plan for the upcoming milestone.
...
1. The reliability team commits to their issues in the iteration plan as long as:
    ...
    2. They fit under one of the quarterly [OKRs of the Reliability::Practices team](https://example_company.com/example_company-com/example_company-OKRs/-/issues/?sort=created_date&state=opened&label_name%5B%5D=Reliability%3A%3APractices&first_page_size=20).
...
At the end of the iteration we release Runner and associated projects. The release process is documented [here](https://example_company.com/example_company-org/ci-cd/runner-tools/releases/-/blob/main/README.md).

### Guidelines for Merge Requests

As a developer on the runner team, you will be contributing to the various runner projects. Since the Example Company Runner project reviewers and maintainers review all code contributions (runner team members and community contributions), we must try and be as efficient as possible when submitting merge requests for review.

#### The responsibility of the merge request author

We follow the [merge request author responsibility guidelines](https://docs.example_company.com/ee/development/code_review.html#the-responsibility-of-the-merge-request-author).

#### The responsibility of Reviewers and Maintainers

We follow the [code review guidelines](https://docs.example_company.com/ee/development/code_review.html#the-responsibility-of-the-reviewer).
...
Managing CVE vulnerability issues is part of Example Company's vulnerability management effort
([1](https://internal.example_company.com/handbook/security/threat_management/vulnerability_management/),
[2](../../../../../security/product-security/vulnerability-management/)), and is an important part of maintaining the
Example Company FedRAMP certification.

Using the [`container-scanners`](https://example_company.com/example_company-com/gl-security/appsec/container-scanners) project, Example Company
scans all images we produce to highlight CVE vulnerabilities. From those scans, the
[`vulnmapper`](https://example_company.com/example_company-com/gl-security/threatmanagement/vulnerability-management/vulnerability-management-internal/vulnmapper)
...
- Use one of the following to surface active CVE issues assigned to our team:
  - [Issue search](https://example_company.com/groups/example_company-org/-/issues/?sort=created_date&state=opened&label_name%5B%5D=FedRAMP%3A%3AVulnerability&label_name%5B%5D=group%3A%3Arunner&not%5Blabel_name%5D%5B%5D=FedRAMP%3A%3ADR%20Status%3A%3AAccepted&not%5Blabel_name%5D%5B%5D=FedRAMP%3A%3ADR%20Status%3A%3AOpen&first_page_size=50)
  - The [`example_company-dashboard cves`](https://example_company.com/avonbertoldi/example_company-dashboard) command.
  - The [`cver imageVulns`](https://example_company.com/example_company-org/ci-cd/runner-tools/cver.git) command.
...
Note that issues that reference `ubi-fips` flavors of `example_company-runner` or `example_company-runner-helper` images take precedence
over other image flavors (like `alpine` or `ubuntu`) since the Example Company FedRAMP certification is contingent on `ubi-fips`
images only.
...
- The vulnerability exists in `example_company-runner` in one of its dependencies.
- The vulnerability exists in `example_company-runner` in code we've written.
...
[`deviation request issue`](https://example_company.com/example_company-com/gl-security/security-assurance/team-security-dedicated-compliance/poam-deviation-requests/-/issues)
(see
https://handbook.example_company.com/handbook/security/security-assurance/dedicated-compliance/poam-deviation-request-procedure/).
...
- A note to all the relevant `example_company-runner` issues pointing to the deviation request issue
...
`example_company-runner` and deviation request issues can be closed.

### `example_company-runner` dependencies

The simplest course of action here is to update the dependency to the latest compatible version (or at least a version
that addresses the vulnerability). Once the MR with the dependency update is merged, the `example_company-runner` issue can be
closed.
...
Example Company.com: `@example_company-com/runner-group`
Slack: [`#g_runner`](https://example_company.slack.com/archives/CBQ76ND6W)

### Code review

Our code review process follows the [general process](https://docs.example_company.com/ee/development/code_review.html)
where you choose a reviewer (usually not a maintainer) and then send it over to a maintainer for the final review.

Current maintainers are members of the [`runner-maintainers`](https://example_company.com/groups/example_company-com/runner-maintainers/-/group_members?with_inherited_permissions=exclude) group.
Current reviewers are members of the [`runner-group`](https://example_company.com/groups/example_company-com/runner-group/-/group_members?with_inherited_permissions=exclude) group.

## Runner PM and engineering pre and post-sales process for runner scaling and configuration deep dives

As part of the pre-sales and post-sales engagement, your customer may have in-depth questions regarding topics such as Example Company Runner configuration, autoscaling options, how concurrency works, distributing the CI jobs workload, monitoring runners, and so on. The goal of the process below is to enable the runner team to be as efficient as possible in providing the level of support that our sales team and customers require.

### Step 1

- Start with the current [documentation page](https://docs.example_company.com/runner/fleet_scaling/) on scaling a fleet of runners.

### Step 2

- Open an issue in the customer collaboration project and capture the specific configuration questions that the customer has. The purpose of the issue is to address some questions async if possible and finalize the agenda for any follow up synch calls . It also allows us to identify if we need to invite a specific engineer to the customer  call. Example [issue](https://example_company.com/example_company-com/account-management/eastern-north-america/walmart-poc-planning/-/issues/5).
