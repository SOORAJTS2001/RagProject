...
Epic: [https://example_company.com/groups/example_company-org/-/epics/11535](https://example_company.com/groups/example_company-org/-/epics/11535)
...
- Iterating on technical strategy in [Architectural blueprint](https://example_company.com/example_company-org/example_company/-/merge_requests/131688)
...
- [Iterate on the Architectural blueprint MR](https://example_company.com/example_company-org/example_company/-/merge_requests/131688)
...
- [Resolved threads and merge the Architectural blueprint MR](https://example_company.com/example_company-org/example_company/-/merge_requests/131688)
...
1. Implement Example Company CI Steps support in Rails. This will elevate the "steps in env variable" to a properly supported syntax, including CI Editor support. This also involves collaboration with a Rails Engineer on Pipeline Authoring.
...
1. Build support for GitHub Actions in CI Steps (up until this point, only Example Company-based steps will be supported)
