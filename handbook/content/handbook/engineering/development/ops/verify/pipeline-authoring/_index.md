...
description: "The Example Company team page for the Pipeline Authoring Group"
---
...
- [Product Vision](https://about.example_company.com/direction/ops/#verify)
- [Pipeline Authoring Category direction](https://about.example_company.com/direction/verify/pipeline_authoring/)
- [number of unique users who trigger ci_pipelines (Performance indicator)](https://internal.example_company.com/handbook/company/performance-indicators/product/ops-section/#verifypipeline-authoring---gmau---number-of-unique-users-interacting-with-example_company-ciyml-file) - Internal link
- [CI/CD Development Documentation](https://docs.example_company.com/ee/development/cicd/index.html)
- [CI/CD Components Documentation](https://docs.example_company.com/ee/ci/components/)
- [CI/CD Catalog Documentation](https://docs.example_company.com/ee/ci/components/#cicd-catalog)

## Team Handles

| Category | Handle |
|---------------|------|
|Example Company Team Handle | @verify-pa-team |
| Slack Channel | [#g_pipeline-authoring](https://example_company.slack.com/archives/C019R5JD44E) |
...
- [Workflow board: `~group::pipeline authoring`](https://example_company.com/example_company-org/example_company/-/boards/5726606?label_name[]=group%3A%3Apipeline%20authoring&milestone_title=Started)

### Videos

- [Example Company Unfiltered: Pipeline Execution group (CI Related)](https://www.youtube.com/playlist?list=PL05JrBw4t0KpsVi6PG4PvDaVM8lKmB6lV)
...
| ------- | ---------- | ------------- |
| **CI/CD Pipelines** | [Build >> Pipelines](https://example_company.com/example_company-org/example_company/-/pipelines) | [Example Company docs](https://docs.example_company.com/ee/ci/pipelines/) |
| **Pipeline editor** | [Build >> Pipeline editor](https://example_company.com/example_company-org/example_company/-/ci/editor?branch_name=master) | [Example Company docs](https://docs.example_company.com/ee/ci/pipeline_editor/) |
| **CI/CD Catalog** | [Explore >> CI/CD Catalog](https://example_company.com/explore/catalog) | [Example Company docs](https://docs.example_company.com/ee/ci/components/) |

### Features

- [Pipeline creation](https://docs.example_company.com/ee/ci/quick_start/)
- [YAML syntax](https://docs.example_company.com/ee/ci/yaml/)
- [CI/CD configuration lint tool](https://docs.example_company.com/ee/ci/lint.html)
- [CI/CD Variables](https://docs.example_company.com/ee/ci/variables/)
...
**NOTE:** Pipeline creation feedback [issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/34984).  We welcome your thoughts on your experience with the pipeline creation process.

Goals:

- Understand the components of the pipeline creation service to improve speed. 
  - This [graph](https://log.gprd.example_company.net/app/r/s/r5Owf) captures data around the pipeline creation performance.
- Top 3 identified issues to optimize pipeline creation performance.
  - [Bulk insert Sidekiq jobs when creating a pipeline](https://example_company.com/example_company-org/example_company/-/issues/348553)
  - [Expand CI variables lazily and selectively](https://example_company.com/example_company-org/example_company/-/issues/410143)
  - [Evaluate rules once for parallel jobs](https://example_company.com/example_company-org/example_company/-/issues/450687)
...
- Address top-level variables keyword problem - [Epic](https://example_company.com/groups/example_company-org/-/epics/6565)
- Implement a new CI/CD variable structure from scratch. [Epic](https://example_company.com/groups/example_company-org/-/epics/8439)
...
- Transition from entry classes to JSON schema for data structure validation. - [Issue](https://example_company.com/example_company-org/example_company/-/issues/463062)
...
- Top 3 identified issues to add more visibility for usage in CI/CD Catalog with adding instrumentation.
  - [Capture GraphQL call times](https://example_company.com/example_company-org/example_company/-/issues/452247)
  - [Implement instrumentation to track performance of Ci::Catalog::Listing queries](https://example_company.com/example_company-org/example_company/-/issues/435440)
  - [Capture page load times](https://example_company.com/example_company-org/example_company/-/issues/452246)

### FY26 top of mind

- Support for GraphQL subscriptions - [epic](https://example_company.com/groups/example_company-org/-/epics/15108)
- Pipeline performance improvements - [epic](https://example_company.com/groups/example_company-org/-/epics/15244)
- CI Variables improvements - [epic](https://example_company.com/groups/example_company-org/-/epics/15250)
- MR Pipeline Tab migration to GraphQL - [epic](https://example_company.com/groups/example_company-org/-/epics/15133)
...
- Recently, we released the CI/CD Catalog to [GA](https://example_company.com/groups/example_company-org/-/epics/12153).
- We added usage statistics and a sort option for popularity in the CI/CD Catalog [index page](https://example_company.com/example_company-org/example_company/-/issues/434333)
...
- [CI/CD Catalog Feedback](https://example_company.com/example_company-org/example_company/-/issues/407556)
...
We create a [planning issue](https://example_company.com/example_company-org/ci-cd/pipeline-authoring/-/blob/master/.example_company/issue_templates/Planning_issue_PA.md) as part of our milestone planning process and the [workflow board](https://example_company.com/example_company-org/example_company/-/boards/5726606?label_name[]=group%3A%3Apipeline%20authoring&milestone_title=Started) is the single source of truth ([SSOT](https://docs.example_company.com/ee/development/documentation/styleguide/#documentation-is-the-single-source-of-truth-ssot)) for current and upcoming work. Product is the DRI in prioritizing work, with input from Engineering, UX, and Technical Writers. The planning issue is used to discuss questions and team capacity. Prior to the beginning of each milestone, issues identified in the planning issue will be assigned to that milestone and engineers can assign prioritized issues to themselves from the top of the `workflow::ready for development` column in the [workflow board](https://example_company.com/example_company-org/example_company/-/boards/5726606?label_name[]=group%3A%3Apipeline%20authoring&milestone_title=Started).
...
You can access all these issues using this [issue filter](https://example_company.com/example_company-org/example_company/-/boards/5726606?label_name[]=group%3A%3Apipeline%20authoring&milestone_title=Started).
...
Example Company does not have a versioning system for CI/CD configuration. Therefore, it is critical to over-communicate our deprecation purposes to our users and take the necessary precautions to reduce the impact on their projects. Deprecating a keyword is risky because it will break all pipelines using it, and in some cases, users are not aware of the keyword they use in their pipeline. The deprecation process described below is similar to the [deprecating and removing features](/handbook/product/example_company-the-product/#process-for-deprecating-and-removing-a-feature) process, with additional steps to reduce the risks which involved with removing a CI/CD keyword.
...
1. Track keyword usage - Tracking keyword usage should begin as early as possible. It is a mandatory step that helps estimate the user impact, timing, and needed effort. The more users use the keyword, the more time it takes to remove it (It took more than four years to move from [remove](https://example_company.com/example_company-org/example_company-foss/-/merge_requests/9766) to [deprecation](https://example_company.com/example_company-org/example_company/-/issues/346823) for 'type' keyword).
...
We use the [Pipeline Authoring Workflow issue board](https://example_company.com/example_company-org/example_company/-/boards/5726606?label_name[]=group%3A%3Apipeline%20authoring&milestone_title=Started) to track what we work on in the current milestone.
...
We use the [Issue Health Status feature](https://docs.example_company.com/ee/user/project/issues/#health-status) to indicate the probability that an issue will ship in the assigned milestone.
...
1. When team members are selecting work from the [ready for development board](https://example_company.com/example_company-org/example_company/-/boards/5726606?label_name[]=group%3A%3Apipeline%20authoring&label_name[]=workflow%3A%3Aready%20for%20development), it simplifies what issue relates to which component.
...
| Label                 | |  | | |
| ----------------------| -------| ----|------------| ---|
| `Category:Pipeline Authoring` | [Issues](https://example_company.com/example_company-org/example_company/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Category%3APipeline%20Authoring) | [MRs](https://example_company.com/example_company-org/example_company/-/merge_requests?label_name%5B%5D=Category%3APipeline%20Authoring) | [Direction](https://about.example_company.com/direction/verify/pipeline_authoring/) | [Documentation](https://docs.example_company.com/ee/ci/) |
| `Category:Jenkins Importer` | [Issues](https://example_company.com/example_company-org/example_company/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Category%3AJenkins%20Importer) | [MRs](https://example_company.com/example_company-org/example_company/-/merge_requests?label_name%5B%5D=Category%3AJenkins%20Importer) | [Direction](https://about.example_company.com/direction/verify/jenkins_importer/) | |
| `Category:Component Catalog` | [Issues](https://example_company.com/groups/example_company-org/-/issues/?sort=created_date&state=opened&label_name%5B%5D=Category%3AComponent%20Catalog) | [MRs](https://example_company.com/example_company-org/example_company/-/merge_requests?scope=all&state=opened&label_name[]=Category%3AComponent%20Catalog) | [Direction](https://example_company.com/groups/example_company-org/-/epics/7462) | [Documentation](https://docs.example_company.com/ee/architecture/blueprints/ci_pipeline_components/) |

#### Feature Labels

| Label                 | |  | Description |
| ----------------------| -------| ----|------------|
| `CI integrations` | [Issues](https://example_company.com/groups/example_company-org/-/issues/?label_name%5B%5D=ci%20integrations) | [MRs](https://example_company.com/groups/example_company-org/-/merge_requests?scope=all&state=opened&label_name[]=CI%20integrations) | Issues related to supporting different CI targets directly (for example, Java or Mobile). Pipeline Authoring |
| `CI persistence` | [Issues](https://example_company.com/groups/example_company-org/-/issues/?label_name%5B%5D=ci%20persistence) | [MRs](https://example_company.com/groups/example_company-org/-/merge_requests?scope=all&state=opened&label_name[]=CI%20persistence) | Issues related to Persistence (workspaces, caching). Does not include artifacts, which is its own label |
| `CI rules` | [Issues](https://example_company.com/groups/example_company-org/-/issues/?label_name%5B%5D=ci%20rules) | [MRs](https://example_company.com/groups/example_company-org/-/merge_requests?scope=all&state=opened&label_name[]=CI%20rules) | Issues related to CI rules or linting |
| `pipeline visualizations` | [Issues](https://example_company.com/groups/example_company-org/-/issues/?label_name%5B%5D=pipeline%20visualizations) | [MRs](https://example_company.com/groups/example_company-org/-/merge_requests?scope=all&state=opened&label_name[]=pipeline%20visualizations) | Issues related to pipeline visualization, including pipeline dependencies for triggers, cross-project pipelines, needs keyword, and child/parent pipelines. For job or pipeline execution, refer to [`pipeline processing`](../pipeline-execution/#feature-labels) (owned by the Pipeline Execution team) |
| `pipeline authoring` | [Issues](https://example_company.com/groups/example_company-org/-/issues?label_name%5B%5D=pipeline+authoring) | [MRs](https://example_company.com/groups/example_company-org/-/merge_requests?label_name%5B%5D=pipeline+authoring) | Issues related to authoring the .example_company-ci.yml file and CI YAML configuration (https://docs.example_company.com/ee/ci/yaml/) but excludes issues handled by another label such as "CI rules" |

#### Other Notable Labels

| Label                 | |  | Description |
| ----------------------| -------| ----|------------|
| `CI/CD core platform` | [Issues](https://example_company.com/groups/example_company-org/-/issues/?label_name%5B%5D=CI%2FCD%20Core%20Platform) | [MRs](https://example_company.com/groups/example_company-org/-/merge_requests?label_name%5B%5D=pipeline+authoringhttps://example_company.com/example_company-org/example_company/-/merge_requests?label_name%5B%5D=CI%2FCD%20Core%20Platform) | Any issues and merge requests related to [CI/CD core domain](#core-domain), either as changes to be made or as observable side effects. |
...
| `Seeking community contributions` | [Issues](https://example_company.com/groups/example_company-org/-/issues?sort=created_date&state=opened&label_name[]=group::pipeline+authoring&label_name[]=Seeking+community+contributions) | | Issues we would like the wider community to contrbute and may also be labeled `Seeking community contributions` |
| `quick win` | [Issues](https://example_company.com/groups/example_company-org/-/issues/?sort=created_date&state=opened&label_name%5B%5D=group%3A%3Apipeline%20authoring&label_name%5B%5D=quick%20win&first_page_size=20) | | Issues we would like the wider community to contrbute and may also be labeled `quick win` |
...
For both planning and building this means direct, cross-functional, and other relevant stakeholders are included early into the process. This makes sure everyone is able to contribute to the best of their capabilities at the right time in the process. This can include, but is not limited to, Example Company objects, Slack, meetings, and daily standups.
...
A lot has changed since this was introduced so we're making steps to re-align ourselves with the [code review guidelines](https://docs.example_company.com/ee/development/code_review.html#approval-guidelines) and ensuring all MRs with user facing changes are reviewed by a product designer.
...
Many pipeline authoring features require a runner to run the pipeline in the GDK. Review apps have runners available by default. [Instructions for enabling a runner in Gitpod GDK](https://example_company.com/example_company-org/example_company-development-kit/-/blob/main/doc/howto/gitpod.md#enable-runners)
...
The results of the first UX collaboration survey can be found in the [UX Collaboration Survey issue](https://example_company.com/example_company-org/ci-cd-ux/-/issues/38). We are making iterative process changes based on the results of this survey and sync retrospective discussions, and will reassess the quality of our UX collaboration at the end of FY22-Q2.
...
- We track our team's technical debt using the following the [Technical Debt Prioritization board](https://example_company.com/example_company-org/example_company/-/boards/7735063?label_name[]=group%3A%3Apipeline%20authoring&label_name[]=type%3A%3Amaintenance), where we track issues with upcoming candidate labels and compare against current milestone.
- In an effort to promote more transparency across the stage where collaboration may be needed, starting in August 2024, we've introduced a [Verify Pipeline teams Technical Debt board](https://example_company.com/groups/example_company-org/-/boards/1438885?not%5Blabel_name%5D%5B%5D=group%3A%3Ahosted%20runners&not%5Blabel_name%5D%5B%5D=group%3A%3Arunner&label_name%5B%5D=devops%3A%3Averify&label_name%5B%5D=type%3A%3Amaintenance) that shows the top of mind priorities in the Pipeline teams.
...
[View the current Pipeline Authoring retrospective](https://example_company.com/gl-retrospectives/verify-stage/pipeline-authoring/-/issues/?sort=created_date&state=opened&label_name%5B%5D=retrospective).

### Team Communication

{{% engineering/verify-team-communication slack-channel="g_pipeline-authoring" slack-url="https://example_company.slack.com/archives/CPCJ8CCCX', group_label: 'group::pipeline authoring', group_issues_url: 'https://example_company.com/groups/example_company-org/-/issues?label_name%5B%5D=group%3A%3Apipeline+authoring&scope=all', gitlab_subgroup: 'pipeline-authoring-group" %}}

#### Team Co-Working Sessions

At Example Company, we advocate for having an async-first mindset in our daily work. Starting in May 2023, we are trialing a process that we use when there is a specific need to sync. We chose the format below because it is transparent and inclusive.
...
- Share a link to the meeting in [`#g_pipeline_authoring_engineering`](https://example_company.slack.com/archives/C03RZTZ59QE) to make other team members aware so that they may optionally attend.
- After the meeting, summarize the results in a comment in the issue.

#### Shared Team Calendar

The Pipeline Authoring team has a shared calendar that integrates with the [`#g_pipeline-authoring`](https://example_company.slack.com/archives/C019R5JD44E) Slack channel to inform the team of important dates from Time Off by Deel.  Instructions on how
to integrate with the `Verify:Pipeline Authoring` calendar can be found [here](https://example_company.com/example_company-org/ci-cd/pipeline-authoring/-/issues/28).
