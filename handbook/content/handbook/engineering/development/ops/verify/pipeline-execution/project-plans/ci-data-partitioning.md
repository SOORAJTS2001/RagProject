...
[Related Epic](https://example_company.com/groups/example_company-org/-/epics/5417)
...
- [x] Merge [MR](https://example_company.com/example_company-org/example_company/-/merge_requests/122919) to use routing table
- [x] Merge [MR](https://example_company.com/example_company-org/example_company/-/merge_requests/125002) fo ensure id uniqueness across partitions
- [x] Confirm execution of [MR](https://example_company.com/example_company-org/example_company/-/merge_requests/125002) on .com or retry in case of failure(autovacuum conflict is still an option)
...
- [~] [Analyze partitioned parent tables on a schedule](https://example_company.com/example_company-org/example_company/-/issues/423135)
- [~] [Manually analyze `p_ci_builds` and `p_ci_builds_metadata`](https://example_company.com/example_company-org/example_company/-/merge_requests/129812#note_1527675793)
- [~] Deploy the [table name switch to canary](https://example_company.com/example_company-org/example_company/-/merge_requests/129812) and confirm there are no more timeouts
...
- [~] Fix caching issue blocking enabling use of routing table
- [~] Enable query analyzers: [Issue](https://example_company.com/example_company-org/example_company/-/issues/398134)
...
- [x] [Manually analyze `p_ci_builds` and `p_ci_builds_metadata`](https://example_company.com/example_company-org/example_company/-/merge_requests/129812#note_1527675793)
- [x] Deploy the [table name switch to canary](https://example_company.com/example_company-org/example_company/-/merge_requests/129812) and confirm there are no more timeouts
...
- [~] Enable query analyzers for ci_builds: [Issue](https://example_company.com/example_company-org/example_company/-/issues/398134) (blocked by table name change)
...
- [x] [Analyze partitioned parent tables on a schedule](https://example_company.com/example_company-org/example_company/-/issues/423135)
- [~] Enable query analyzers for ci_builds: [Issue](https://example_company.com/example_company-org/example_company/-/issues/398134) (blocked by table name change)
...
- [x] Enable query analyzers for ci_builds: [Issue](https://example_company.com/example_company-org/example_company/-/issues/398134)
...
- [x] start adding partition_id filters to related queries [Issue](https://example_company.com/example_company-org/example_company/-/issues/423054)
- [~] Switch writes to second partition: [Issue](https://example_company.com/example_company-org/example_company/-/issues/387810)
- [~] Reintroduce migration for self-managed for ensuring uniqueness of ids across partitions
...
We can start rebalancing old partitions using functionality in PG15 - [Issue](https://example_company.com/example_company-org/example_company/-/issues/438394).
[Example Company Postgres Upgrade Cadence](/handbook/engineering/infrastructure/core-platform/data_stores/database/postgresql-upgrade-cadence/)
