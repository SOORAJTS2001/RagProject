...
Groups within the Ops Sub-department follow an async planning process to coordinate planning and discussion between members of the group. This process is related to the general [Example Company Product Development Timeline](/handbook/engineering/workflow/#product-development-timeline) process and adds additional practices we've found useful.
...
* Engineering Managers: add a comment asking for feedback on Scope of Engineering work from engineers or other Example Company team members
...
* [Environments Team Template](https://example_company.com/example_company-org/ci-cd/deploy-stage/environments-group/general/-/blob/master/.example_company/issue_templates/Planning_Issue.md)
* [Monitor APM Team Template](https://example_company.com/example_company-org/monitor/apm/-/blob/master/.example_company/issue_templates/planning-issue.md)
* [Monitor Health Team Template](https://example_company.com/example_company-org/monitor/health/-/blob/master/.example_company/issue_templates/planning-issue.md)

#### Planning Issue Board

All the planning issues are viewable on the [Ops Section - Issue Planning (Issue Board)](https://example_company.com/groups/example_company-org/-/boards/1567586)
