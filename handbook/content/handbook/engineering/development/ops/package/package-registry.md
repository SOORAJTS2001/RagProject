...
The Package Registry is part of the Example Company [Package stage](/handbook/engineering/development/ops/package/), which integrates with [Example Company's CI/CD product](https://about.example_company.com/direction/ops/).
...
| Format | DRI    |
| ------ | ------ |
| npm       | [@dmeshcharakou](https://example_company.com/dmeshcharakou)    |
| Maven     | [@10io](https://example_company.com/10io)             |
| PyPI      | [@radbatnag](https://example_company.com/radbatnag)        |
| NuGet     | [@mkhalifa3](https://example_company.com/mkhalifa3)        |
| Terraform | [@radbatnag](https://example_company.com/radbatnag)        |
| Generic   | [@dmeshcharakou](https://example_company.com/dmeshcharakou)    |

### How we handle breaking changes

Announce deprecations, breaking changes, and removals at least 3 milestone before (according to https://docs.example_company.com/ee/development/deprecation_guidelines/#when-can-a-feature-be-removedchanged).
...
| Project                                                                                                                                        | DRI                                                                                       |
|------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| [Automated packages import from Artifactory or Sonatype](https://example_company.com/groups/example_company-org/-/epics/8730)                                    | [@10io](https://example_company.com/10io)                                                          |
| [Maven dependency proxy](https://example_company.com/groups/example_company-org/-/epics/3610)                                                                    | [@10io](https://example_company.com/10io)                                                          |
| [Improve the performance of package metadata generation](https://example_company.com/groups/example_company-org/-/epics/9835)                                 | [@dmeshcharakou](https://example_company.com/dmeshcharakou)                                        |
| [Eliminating duplicate npm packages](https://example_company.com/groups/example_company-org/-/epics/9812)                                                        | [@dmeshcharakou](https://example_company.com/dmeshcharakou)                                        |
| [Key improvements for the npm registry](https://example_company.com/groups/example_company-org/-/epics/7037)                                                     | [@radbatnag](https://example_company.com/radbatnag)                                                |
| [Key improvements for the NuGet registry](https://example_company.com/groups/example_company-org/-/epics/7039)                                                   | [@mkhalifa3](https://example_company.com/mkhalifa3)                                               |

## Documentation

Package Registry documentation is available [here](https://docs.example_company.com/ee/user/packages/package_registry).
