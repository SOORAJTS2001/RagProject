...
1. Request a Example Company Hiring Plan ID (GHPID) from Director of Engineering, Ops (@sgoldstein)
1. Once the GHPID has been requested the assigned recruiter will create a kickoff issue in the [gl-talent-acquisition/req-intake project](https://example_company.com/gl-talent-acquisition/req-intake/) and mention you on it.  Once the kickoff issue is created confirm that:
    ...
    1. The kickoff issue has the ~section::ops label applied so we can track in [this board](https://example_company.com/gl-talent-acquisition/req-intake/-/boards/3516477?label_name[]=section%3A%3Aops) (confidential) and use it as the single source of truth (SSOT)
...
1. Add the new vacancy to the handbook https://example_company.com/example_company-com/www-example_company-com/-/tree/master/data/team_members/vacancy
...
- [Ops reach out templates](https://example_company.com/example_company-com/ops-sub-department/ops-hiring-process/-/blob/main/outreach-messages.md) (private)
...
1. Justification scorecard will be reviewed by Director of Ops (or a delegate) for these criteria (see [Engineering Hiring Process README](https://example_company.com/example_company-com/people-group/hiring-processes/-/blob/master/Engineering/README.md) for additional detail):
    ...
    1. ❌ Any previous Example Company job application rejections must be explicitly addressed in Justification. (Confirm with TA)
...
<br/>
    How do we intend on setting this candidate up for success? *<br/>
      - Expand on each flag described above and how you, as the HM plan to mitigate that flag and set the candidate up for success at Example Company.<br/>
<br/>
