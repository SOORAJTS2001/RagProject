...
This section seeks to remove confusion around backports at Example Company. Please raise an MR to this page or reach out to the [Delivery Group](/handbook/engineering/infrastructure/team/delivery) if you have questions. Also remember to check the [Backports FAQ](/handbook/engineering/releases/backports/#backports-faq)
...
graph TD
    ...
    click F "https://example_company.com/example_company-org/release/docs/blob/master/general/security/process.md#non-critical-security-releases"
...
- Backports are delivered according to the [Maintenance Policy](https://docs.example_company.com/ee/policy/maintenance.html) and backport exceptions out of that policy are delivered on a best-effort basis and not guaranteed
...
You can check the [Maintenance Policy](https://docs.example_company.com/ee/policy/maintenance.html) to see what is covered
...
1. Raising a [backport request](https://example_company.com/example_company-org/release/tasks/-/issues/new?issuable_template=Backporting-request) in the [release/tasks](https://example_company.com/example_company-org/release/tasks) repository
...
1. Communicate to your stakeholders if/when the release is available on our [releases blog](https://about.example_company.com/releases/categories/releases/)
...
At Example Company, we backport security fixes and bug fixes according to the [Maintenance Policy](https://docs.example_company.com/ee/policy/maintenance.html).

### Is that the same as a Patch Release?

No it's not. Backporting is a catch-all term for any activity that applies updates or patches from a newer version of software to an older version. At Example Company we have a specific [Patch Release process](/handbook/engineering/releases/#patch-releases-overview) that is applied according to the [Maintenance Policy](https://docs.example_company.com/ee/policy/maintenance.html). This is one of the release methods we use to ship self-managed, along with the security release and regular monthly release. There is a separate [exception process](https://docs.example_company.com/ee/policy/maintenance.html#backporting-to-older-releases) for backports that are outside the scope of our maintenance policy and these are delivered on a best effort basis and not guaranteed.
...
If your backport is a security fix and covered by the maintenance policy, please follow the [Security Release Process](https://docs.example_company.com/ee/policy/maintenance.html#security-releases).
