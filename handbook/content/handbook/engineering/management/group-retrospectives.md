...
1. **Use an issue to collect feedback asynchronously.** Consider using an issue to collect
   ...
   own time.  It is recommended that the group uses the [retrospective issue template](https://example_company.com/example_company-org/async-retrospectives/-/blob/master/templates/default.erb) for the issue.
...
like to collect retrospective notes - Example Company issues, Google docs, etc. After the
