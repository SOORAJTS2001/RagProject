...
- [My Example Company profile: @emchang](https://example_company.com/emchang)
- Slack handle: `@emchang`
- [My Curriculum Vitae](https://emchang.example_company.io/)
...
The [Example Company value](/handbook/values/) that resonates with me the most is [🤝 Collaboration](/handbook/values/#collaboration) - although [it's impossible to know everything](/handbook/values/#its-impossible-to-know-everything), I believe we can always learn from each other!
...
- I practise [Focus Fridays](/handbook/communication/#focus-fridays) where I typically spend the morning replying to my assigned tickets and work on non-ticket work like learning and writing my [Weekly Logs](https://example_company.com/emchang/open-notebook/-/issues?scope=all&state=all&label_name[]=Weekly%20Log%20%F0%9F%93%9D) in the afternoon.
- I use Example Company To-Do regularly, feel free to ping me on merge requests (MR) or issues.
