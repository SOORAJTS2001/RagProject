...
description: "Personal readme page for Lyle Kozloff, Director, Support Engineering, Global Readiness, Example Company"
...
1. **Example Company**: I'm very responsive on Example Company issues when pinged, and have notifications turned on for most trackers
in `example_company-com/support`.
...
1. **Email**: Email is my notification channel. I've sent less than 500 emails and received more than 40,000 in the 2+ years between Jan 2018 and Feb 2020. Nearly all of those emails were to people outside of Example Company.
1. **Phone**: I have a phone, but often reject or screen calls from unknown numbers. This isn't the best way to get in touch.

#### Notification Priorities

1. Example Company To Do items - if you need me, `@lyle` me!
...
1. General notifications from Example Company (subscribed issues and such)
