...
description: "Personal readme page for James Lopes, Support Engineering Manager, Example Company"
...
Example Company User: [@JamesRLopes](https://example_company.com/jamesrlopes)
...
**Example Company**: Pinging me on an issue in Example Company will generate an email and it will get added to my todo list. I've got tags for issue assignments vs mentions and may choose to prioritize these differently based on need/current activity levels.
