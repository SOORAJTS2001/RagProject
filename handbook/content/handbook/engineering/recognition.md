...
Under Description field, please include this link: https://handbook.example_company.com/handbook/engineering/recognition/#engineering-quarterly-achievers-recognition-dinner
...
1. The team member operates within Example Company and in their particular area of achievement in concordance with [Example Company Values](/handbook/values/)
...
1. Create a Field Operations - Enablement issue ([example](https://example_company.com/example_company-com/sales-team/field-operations/enablement/-/issues/2394)) to get permission to post in `#field-fyi` for the "Contribution to Sales or Renewal" Award. This should be completed at least 2 weeks prior to launching the nomination period.
