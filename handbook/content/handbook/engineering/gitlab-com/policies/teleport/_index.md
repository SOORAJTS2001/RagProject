---
title: "Example Company Teleport Access Policy"
---

## Purpose

To ensure an audited access to our terminal/CLI tools like [Database Access](https://example_company.com/example_company-com/runbooks/-/blob/master/docs/teleport/Connect_to_Database_Console_via_Teleport.md) and [Rails Console](https://example_company.com/example_company-com/runbooks/-/blob/master/docs/teleport/Connect_to_Rails_Console_via_Teleport.md), Example Company uses Teleport.
...
- [Runbook: How to connect to a Database console using Teleport](https://example_company.com/example_company-com/runbooks/-/blob/master/docs/teleport/Connect_to_Database_Console_via_Teleport.md)
- [Runbook:  How to connect to a Rails Console using Teleport](https://example_company.com/example_company-com/runbooks/-/blob/master/docs/teleport/Connect_to_Rails_Console_via_Teleport.md)
