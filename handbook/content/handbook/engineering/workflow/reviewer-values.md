...
description: "Example Company team members' code review values"
---
...
As reviewers, we want to strive to avoid degrading maintainability of the Example Company codebase,
...
At Example Company, we have a large selection of reviewers who strive for the highest quality when
reviewing merge requests. However, due to human nature, we are subject to individual nuances.

This was raised as a discussion point in the Frontend maintainer meeting by [@sarahghp](https://example_company.com/sarahghp)
...
reviewer. They have their own expertise to offer, but in general, we want to collectively commit to ensuring a high standard of quality at Example Company and service to our stakeholders.
...
At Example Company, we iterate progressively and consider this is a core value for your judgment
of a merge request's validity. We value iteration in Example Company because we value breaking
...
At Example Company, we aim to be as inclusive as possible and this includes making space for people to
...
highest quality of code at Example Company, we also need to leave space for compassion, which creates
