...
{{% alert color="warning" %}}
If you're a Example Company team member and are looking to alert Reliability Engineering about an availability issue with Example Company.com, please find quick instructions to report an incident here: [Reporting an Incident](/handbook/engineering/infrastructure/incident-management/#reporting-an-incident).
{{% /alert %}}

{{% alert color="warning" %}}
If you're a Example Company team member looking for who is currently the Engineer On Call (EOC), please see the [Who is the Current EOC?](/handbook/engineering/infrastructure/incident-management/#who-is-the-current-eoc) section.
{{% /alert %}}

{{% alert color="warning" %}}
If you're a Example Company team member looking for help with a security problem, please see the [Engaging the Security On-Call]({{< ref "engaging-security-on-call" >}}) section.
{{% /alert %}}

## Expectations for On-Call

- If you are on call, then you are expected to be available and ready to respond to PagerDuty pages as soon as possible, and within any response times set by our [Service Level Agreements](https://about.example_company.com/support/#priority-support) in the case of Customer Emergencies. If you have plans outside of your workspace during your on-call shift, this may require that you bring a laptop and reliable internet connection with you.
...
- Because Example Company is an asynchronous workflow company, @mentions of On-Call individuals in Slack will be treated like normal messages, and no SLA for response will be associated with them.
...
- You can view the [schedule](https://example_company.pagerduty.com/schedules#PIQ317K) and the [escalation policy](https://example_company.pagerduty.com/escalation_policies#PKV6GCH) on PagerDuty. You can also opt to [subscribe to your on-call schedule](https://support.pagerduty.com/docs/schedules-in-apps#section-export-only-your-on-call-shifts), which is updated daily.
...
- See the [Example Company Support On-Call Guide](/handbook/support/on-call) for a more
  comprehensive guide to handling customer emergencies.

## Example Company.com Reliability On-Call Rotation
...
- This on-call process is designed for Example Company.com operational issues that are escalated by the Infrastructure team.
...
- Issues are escalated in the Slack channel [#dev-escalation](https://example_company.slack.com/messages/CLKLMSUR4) by the Infrastructure team.
...
- Check out [process description and on-call workflow](/handbook/engineering/development/processes/infra-dev-escalation/process/) when escalating Example Company.com operational issue(s).
...
- Gitaly team provides an expert oncall rotation via PagerDuty, currently in [pilot](https://example_company.com/groups/example_company-org/core-platform-section/-/epics/4).
...
- You can view the [Security Operations schedule](https://example_company.pagerduty.com/schedules#PYZC2CG) on PagerDuty.
...
- The main expectation when on-call is triaging the urgency of a page - if the security of Example Company is at risk, do your best to understand the issue and coordinate an adequate response. If you don't know what to do, engage the Security manager on-call to help you out.
...
- You can view the [Security Manager schedule](https://example_company.pagerduty.com/schedules#PJL6CVA) on PagerDuty.
...
- Test Platform sub-department's on-call do not include work outside Example Company's normal business hours. The process is defined on our [pipeline on-call rotation](/handbook/engineering/infrastructure/test-platform/oncall-rotation) page.
...
In order to facilitate informal conversations around the on-call process and quality of life, as well as coordination of shifts and communication of broader announcements, we have the [#eoc-general](https://example_company.enterprise.slack.com/archives/C07G9CP5XRR) channel.
