...
description: "Automation and tooling for processing un-triaged issues at Example Company"
---

Any Example Company team-member can triage issues. Keeping the number of [un-triaged issues](/handbook/engineering/infrastructure/engineering-productivity/issue-triage/#triaging-issues) low is essential for maintainability, and is our collective responsibility.
...
* [Stage creation or rename](https://example_company.com/example_company-org/quality/triage-ops/issues/new?issuable_template=category-stage-group-label-change)
* [Group creation or rename](https://example_company.com/example_company-org/quality/triage-ops/issues/new?issuable_template=category-stage-group-label-change)
* [Category label creation or rename](https://example_company.com/example_company-org/quality/triage-ops/issues/new?issuable_template=category-label-change)

## Auto-labelling of issues and merge requests

Our triage bot will automatically infer section, stage, and group labels based
on the category/feature already set on an issue or MR. This is available for **open** issues/MRs within the `example_company-org` group.
...
[this merge request](https://example_company.com/example_company-org/quality/triage-ops/merge_requests/155#workflow):
...
Check out the
[list of actual use-cases](https://example_company.com/example_company-org/quality/triage-ops/merge_requests/155#test-cases)
...
A [triage report](https://example_company.com/example_company-org/quality/team-tasks/issues/35) is an issue containing a checklist of issues or merge requests requiring attention.
...
[the stages definition file](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/stages.yml).
...
[run some scripts](https://example_company.com/example_company-org/quality/triage-ops#generating-policy-files-and-ci-jobs)
...
This report contains community merge requests requiring [partial triage](/handbook/engineering/infrastructure/engineering-productivity/merge-request-triage/#partial-triage-example_company-org).
...
* Frequency: Daily.
* Assignees: [Merge Request Coaches](https://example_company.com/example_company-org/coaches) who are not out of the office by [example_company roulette](https://example_company.com/example_company-org/example_company-roulette#features).
...
* Example: <https://example_company.com/example_company-org/quality/triage-reports/-/issues/7903>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/report/untriaged-community-merge-requests.yml>

#### Community merge requests requiring attention

This report contains community merge requests that may require some attention from Example Company team members.

* Frequency: Weekly.
* Assignees: [Contributor Success team](/handbook/engineering/quality/contributor-success/) + volunteer wider community members.
* Listed merge requests (all awaiting Example Company response):
...
* Example: <https://example_company.com/example_company-org/quality/triage-reports/-/issues/7690>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/groups/example_company-org/quality/community-contribution-mr-report.yml>
...
An example: [https://example_company.com/example_company-org/quality/triage-ops/issues/118](https://example_company.com/example_company-org/quality/triage-ops/issues/118)
...
There is also an optional stage policy for [missing categories](https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/missing-categories.yml).
...
This report contains idle [group](/handbook/product/categories/) merge requests authored by Example Company team members.
...
An example report: [Merge requests requiring attention for `group::access` - 2020-11-08](https://example_company.com/example_company-org/quality/triage-reports/-/issues/751). Current reports can be found in the [triage-reports project](https://example_company.com/example_company-org/quality/triage-reports/-/issues?scope=all&utf8=%E2%9C%93&state=all&search=%22Merge+Requests+requiring+attention%22)
...
An example report: [Feature Flags requiring attention for `group::continuous integration` - 2021-03-01](https://example_company.com/example_company-org/quality/triage-reports/-/issues/2161). Current reports can be found in the [triage-reports project](https://example_company.com/example_company-org/quality/triage-reports/-/issues?scope=all&utf8=%E2%9C%93&state=all&search=%22Feature+flags+requiring+attention%22)

The feature flag triage reports are generated in a [quality toolbox scheduled pipeline](https://example_company.com/example_company-org/quality/toolbox/-/pipeline_schedules) with the [example_company-feature-flag-alert](https://example_company.com/example_company-org/example_company-feature-flag-alert) project.
...
* Triage actions:
     ...
     1. Assign either a versioned milestone or to the `Backlog`.
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/template/group/bug-prioritization.yml.erb>

An example report: [2023-11-01 - Bugs Prioritization for "group::source code" for upcoming milestone - 16.7](https://example_company.com/example_company-org/quality/triage-reports/-/issues/14732). Current reports can be found in the [triage-reports project](https://example_company.com/example_company-org/quality/triage-reports/-/issues/?sort=updated_desc&state=all&search=Bugs%20Prioritization%20for&first_page_size=100)

#### Auto closure of triage reports

Reports open for more than 2 weeks with the `~"triage report"` label will be closed automatically with the [close old triage reports](https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/close-reports/close-old-triage-reports.yml) automation.
...
graph LR
    ...
    MR_INITIAL(["Wider Community Merge request<br />(author is not a member of `example_company-org`)"])
    ...
    WHAT_AUTHOR_NOTE --->|"@example_company-bot label ..."| AUTOMATED_LABEL_COMMAND_REPLY
    WHAT_AUTHOR_NOTE --->|"@example_company-bot feedback"| AUTOMATED_FEEDBACK_COMMAND_REPLY

    WHAT_ANYONE_NOTE --->|"@example_company-bot help"| AUTOMATED_HELP_COMMAND_REPLY
    WHAT_ANYONE_NOTE --->|"@example_company-bot ready"| AUTOMATED_REVIEW_COMMAND_REPLY
...
* Automation conditions:
  * MR was opened
  * The MR is opened in a project under the `example_company-org` group or for the `example_company-com/www-example_company-com` project, and its
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/thank_contribution.rb>
...
* Automation conditions:
  ...
  * The MR is not opened in a distribution project listed at <https://example_company.com/example_company-org/distribution/monitoring/-/raw/master/lib/data_sources/projects.yaml>
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/automated_review_request_generic.rb>
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/automated_review_request_doc.rb>
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/automated_review_request_ux.rb>

#### Reactive `help` command

* Automation conditions:
  * A new MR note that starts with `@example_company-bot help` is posted on a merge request
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/command_mr_help.rb>

#### Reactive `ready` command

* Automation conditions:
  * A new MR note that starts with `@example_company-bot ready [@user1 @user2 ...]`, `@example_company-bot review [@user1 @user2 ...]`,
    or `@example_company-bot request_review [@user1 @user2 ...]`
  * The note is posted by the MR author or a team member
* Automation actions:
  * Adds the `workflow::ready for review` label to the MR
  * Assigns the provided users (any Example Company community member) as reviewers, otherwise picks a random MR coach as reviewer
* Rate limiting: once per author/MR per hour, or 100 times per team member/MR per hour
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/command_mr_request_review.rb>

#### Reactive `unassign_review` command

* Automation conditions:
  * A new MR note that starts with `@example_company-bot unassign_review`
  * The note is posted by one of the currently assigned reviewers (any Example Company community member)
* Automation actions:
  * Removes the posting user from the list of currenly assigned reviewers
* Rate limiting: 100 times per hour
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/command_mr_unassign_review.rb>

#### Reactive `label` and `unlabel` commands

* Automation conditions:
  * A new note that starts with `@example_company-bot label ~"label-name"` or `@example_company-bot unlabel ~"label-name"` where `label-name` matches:
...
* **Note**: to add or remove multiple labels, list all labels after the command, for example: `@example_company-bot label ~"group::project management" ~"type::bug"`
* Automation actions:
  * Adds or removes the requested label
* Rate limiting: 60 times per requester/item per hour
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/command_mr_label.rb>
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/remove_idle_labels_on_activity.rb>
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/code_review_experience_feedback.rb>

#### Reactive `feedback` command

* Automation conditions:
  * A new MR note that starts with `@example_company-feedback`
  * The note is posted by the MR author or a team member
* Automation actions:
  * Posts the contributor feedback note in the `#mr-feedback` Slack channel (internal)
* Rate limiting: once per requester/MR per day
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/command_mr_feedback.rb>
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/label_leading_organization.rb>
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/hackathon_label.rb>
...
* Automation actions:
  * Posts a note linking to [Example Company Website Terms of Use](/handbook/legal/policies/website-terms-of-use/)
  * Relabels (removes all other labels) as `Spam`
  * Closes the MR
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/community/detect_and_flag_spam.rb>
...
guidelines at
<https://handbook.example_company.com/handbook/engineering/infrastructure/engineering-productivity/issue-triage/#availability-prioritization>
...
* `example_company.zendesk.com`
* `example_company.my.salesforce.com`
...
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/apply_type_label_from_related_issue.rb>

#### Reactive `retry_job` command

* Automation conditions:
  * A new issue note with `@example_company-bot retry_job <job_id>` posted by a Example Company team member in a broken master incident.
  * This automation can only be invoked from the [example_company-org/quality/engineering-productivity/master-broken-incidents](https://example_company.com/example_company-org/quality/engineering-productivity/master-broken-incidents) project right now.
* Automation actions:
  * `@example_company-bot` will send a request to retry the target job and reply with a new job link.
* Example: <https://example_company.com/example_company-org/quality/engineering-productivity/master-broken-incidents/-/issues/3188#note_1496059720>
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/gitlab_internal_commands/command_retry_pipeline_or_job.rb>

#### Reactive `retry_pipeline` command

* Automation conditions:
  * A new issue note with `@example_company-bot retry_pipeline <pipeline_id>` posted by a Example Company team member in a broken master incident.
  * This automation can only be invoked from the [example_company-org/quality/engineering-productivity/master-broken-incidents](https://example_company.com/example_company-org/quality/engineering-productivity/master-broken-incidents) project right now.
* Automation actions:
  * `@example_company-bot` will send a request to retry all failed jobs in the target pipeline and reply with the pipeline link.
* Example: <https://example_company.com/example_company-org/quality/engineering-productivity/master-broken-incidents/-/issues/3187#note_1496076800>
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/gitlab_internal_commands/command_retry_pipeline_or_job.rb>
...
* Processor: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/triage/processor/database/database_review_experience_feedback.rb>
...
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/label-seeking-community-contributions.yml>
...
Merge requests which have an author that is not a member of `example_company-org` will have the `Community contribution` label applied. This scheduled automation is a backup for the reactive automation that applies `Community contribution` in the [welcome message](#community-contribution-thank-you-note).

* Automation conditions:
  * Merge request under `example_company-org` with author that is not ia member of the `example_company-org` group, or with author that is a member of the `example_company-org/example_company-core-team/community-members` group
* Frequency: daily
* Automation actions:
...
* Example: <https://example_company.com/example_company-org/example_company-ce/merge_requests/30909/#note_0a1c0937d1b2851e9695fb89848d8425dcf28e00>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/label-community-contributions.yml>
...
* Example: <TBD>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/add-milestone-to-community-merge-requests.yml>
...
* Example: <TBD>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/label-idle-community-mrs.yml>
...
* Automation actions:
  * An Engineering Manager is pinged to decide if a Example Company team member will pick up the work on it or close the merge request
* Example: <TBD>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/nudge-stale-community-contributions.yml>
...
* Example: <https://example_company.com/example_company-org/example_company-pages/-/merge_requests/788#note_1011327312>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/community/hygiene/ping-inactive-reviewers.yml>
...
* Example: <https://example_company.com/example_company-org/example_company-runner/-/merge_requests/3460#note_1011327399>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/community/hygiene/ping-inactive-reviewers.yml>
...
**Note:** Confidential issues will be skipped as part of the `missed` label application. Please see the [this issue](https://example_company.com/example_company-org/quality/triage-ops/-/issues/45) for more information
...
* Example: [Rescheduled Issue](https://example_company.com/example_company-org/example_company-ce/issues/63145)
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/missed-resources.yml>
...
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/remove-far-deliverable.yml>
...
* Example: <https://example_company.com/example_company-org/example_company-ce/issues/61662>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/label-missed-slo.yml>
...
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/set-priority-from-severity.yml>
...
* Example: <https://example_company.com/example_company-org/example_company-ee/issues/12363>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/label-reminders.yml#L27-45>
...
* Examples:
  * Potential: <https://example_company.com/example_company-org/example_company-ce/issues/62067#note_ca6949d26c3d121c421b4f8b20f7e5dc2028c0a6>
  * Popular: <https://example_company.com/example_company-org/example_company-ce/issues/55638#note_b15ea9cbc76b8dea82963d7f14a4a65da52c2b09>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/discover.yml>

#### Auto-close inactive bugs

Example Company values the time spent by contributors on reporting bugs. However, if a bug remains inactive for a very long period, it will qualify for auto-closure.
...
identified as eligible for auto-closure. At this point, the following actions occur:
  ...
  * Comment by Example Company Bot to the author to check whether the reported bug still persists and to comment accordingly within the next 7 days.
* After 7 days, one of the below mentioned actions happen:
  ...
  * Issues with a comment from anyone other than the example_company-bot in the last 7 days are considered active and `~"stale"` is removed
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/close-stale-bugs.yml>
...
* ~"Example Company Free"
* ~"Example Company Premium"
* ~"Example Company Ultimate"
...
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/prompt-for-tier-labels.yml>

#### Prompt for Type labels on issues

[Type labels](https://docs.example_company.com/ee/development/labels/index.html#type-labels) are applied to issues to increase the visibility and discoverability during team issue refinement. This policy applies to `example_company-org` team member created issues and prompts the author to apply a type label to the issue within the first week.
...
* Automation conditions:
  * Open issue with no type label applied, opened in the past 7 days, authored by `example_company-org` member
* Automation actions:
  * Mention the author asking to add appropriate type label
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/prompt-team-member-type-label.yml>

##### Data

* [Chart displaying the number of open issues by type label](https://10az.online.tableau.com/#/site/example_company/views/DRAFTIssueTypesDetail/TotalIssuesbyTypes?:iid=1)
...
* Example: <TBD>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/comment-slo-breaching-bugs.yml>
...
* Example: <TBD>
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/ask-severity-priority-for-infradev-issues.yml>
...
* Policy: <https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/policies/stages/hygiene/ask-severity-for-customer-bug-issues.yml>
...
* Chat channels; we use our chat internally as a realtime communication tool:
  * [#triage](https://example_company.slack.com/messages/triage): general triage team channel.
  * [#example_company-issue-feed](https://example_company.slack.com/messages/example_company-issue-feed) - Feed of all Example Company-CE issues
  * [#support-tracker-feed](https://example_company.slack.com/messages/support-tracker-feed) - Feed of the Example Company.com Support Tracker
  * [#mr-coaching](https://example_company.slack.com/messages/mr-coaching): for general conversation about Merge Request Coaching.
  * [#opensource](https://example_company.slack.com/messages/opensource): for general conversation about Open Source.
