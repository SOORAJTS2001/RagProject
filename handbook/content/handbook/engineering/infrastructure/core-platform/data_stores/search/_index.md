...
description: "The Global Search team is focused on bringing world class search functionality to Example Company.com and self-managed instances."
---

## Vision

The Global Search Group focuses on bringing world class search functionality to Example Company.com and self-managed instances.

This page covers processes and information specific to the Global Search group. See also the [Global Search](https://about.example_company.com/direction/global-search/) and [Code Search](https://about.example_company.com/direction/global-search/code-search/) direction pages.
...
This team doesn't own custom searches for specific features, such as the "filter bar" on issues which is part of the [Issue Tracking](https://about.example_company.com/direction/plan/project_management/team_planning/) category owned by the [Project Management group](/handbook/product/categories/#project-management-group).
...
- We use asynchronous communication with each other and with other Example Company teams via Example Company, Slack, Google Docs, etc.
...
- We organize our tasks under Epics and Issues. The Product Manager and Engineering Manager go through the backlog at the planning phase of each release and put issues into the next one or two milestones. The issues on the [milestone board](https://example_company.com/groups/example_company-org/-/boards/1339901?label_name[]=group%3A%3Aglobal%20search) are sorted based on priority. The higher priority issues are placed on the top.
...
- We work with our stable counterpart in the Security team for issues that need input from a security perspective. We suggest using team planning issues, for example, [this one](https://example_company.com/example_company-org/search-team/team-tasks/-/issues/17), for communication.
...
### Advanced Global Search Rollout on Example Company.com

The team has been actively working on enabling Elasticsearch powered Advanced Search on Example Company.com. [Based on our analysis](https://example_company.com/groups/example_company-org/-/epics/1736), we set our first target to roll this feature out for all the paid groups on Example Company.com. You can find more details about the timeline and progress in the links below.

- [Plan of Advanced. Search Rollout on Example Company.com](https://example_company.com/groups/example_company-com/-/epics/649)
- [Steps and Enhancements of Advanced Search Rollout on Example Company.com](/handbook/engineering/infrastructure/core-platform/data_stores/search/es-rollout-timeline.html)
...
- Recall Record, Global: This is the time it takes to recall a record using a globally scoped search of Example Company.com. Records could be entities such as projects, users, groups, etc.
- Time until inserted record is recallable: This is the elapsed time between adding a new record and having that new record be recallable via a search. This process depends on many underlying technologies such as the [Go indexer](https://example_company.com/example_company-org/example_company-elasticsearch-indexer), [Sidekiq queues](https://docs.example_company.com/ee/development/advanced_search.html#how-does-it-work), and the Elasticsearch database.
...
- [Global Search Team Milestone Board](https://example_company.com/groups/example_company-org/-/boards/1339901?label_name[]=group%3A%3Aglobal%20search)
- [Global Search Team Workflow Board](https://example_company.com/groups/example_company-org/-/boards/1584459?label_name[]=group%3A%3Aglobal%20search)
- [Global Search Team Epics](https://example_company.com/groups/example_company-org/-/epics?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=group%3A%3Aglobal%20search)
- Global Search team slack channel (internal) [#g_global_search](https://example_company.slack.com/app_redirect?channel=g_global_search)
- [Global Search Roadmap](https://example_company.com/groups/example_company-org/-/roadmap?state=all&sort=start_date_asc&layout=MONTHS&timeframe_range_type=CURRENT_YEAR&label_name%5B%5D=group%3A%3Aglobal+search&label_name%5B%5D=Roadmap&progress=COUNT&show_progress=true&show_milestones=false&milestones_type=ALL)
- [Bug Review Board](https://example_company.com/groups/example_company-org/-/boards/2118530?label_name[]=type::bug&label_name[]=group%3A%3Aglobal%20search)
...
- [Example Company Elasticsearch Integration](https://docs.example_company.com/ee/integration/advanced_search/elasticsearch.html)
- [Example Company Advanced Search Development Guidelines](https://docs.example_company.com/ee/development/advanced_search.html)
- [GDK Elasticsearch Setup Instructions](https://example_company.com/example_company-org/example_company-development-kit/-/blob/main/doc/howto/elasticsearch.md)
- [GDK Zoekt Setup Instructions](https://example_company.com/example_company-org/example_company-development-kit/-/blob/main/doc/howto/zoekt.md)

### Blog Posts

- [Lessons from our journey to enable global code search with Elasticsearch on Example Company.com](https://about.example_company.com/blog/2019/03/20/enabling-global-search-elasticsearch-example_company-com/)
- [Update: The challenge of enabling Elasticsearch on Example Company.com](https://about.example_company.com/blog/2019/07/16/elasticsearch-update/)
- [Update: Elasticsearch lessons learnt for Advanced Global Search 2020-04-28](https://about.example_company.com/blog/2020/04/28/elasticsearch-update/)
- [How the Search Team at Example Company Implemented a Risk Map to Direct Automated Testing Efforts](https://about.example_company.com/blog/2020/09/03/risk-mapping/)
- [Example Company's data migration process for Advanced Search](https://about.example_company.com/blog/2021/06/01/advanced-search-data-migrations/)

### Product Demos

- [Example Company search with Custom Search Engines](https://www.youtube.com/watch?v=YESlLDxHH4o)
- [Use the Example Company search bar to navigate](https://www.youtube.com/watch?v=OE9b0Qc6KaI)
- [Search suggestions for recently viewed issues and merge requests](https://www.youtube.com/watch?v=_5s4ZjnDZPo)
- [How to search for epics in Example Company](https://www.youtube.com/watch?v=bu6kaBqcYFc)
