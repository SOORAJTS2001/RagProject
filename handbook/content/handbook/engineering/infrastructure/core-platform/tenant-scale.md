...
our main focus is a long-term horizontal scaling solution for Example Company.

This page covers processes and information specific to the Tenant Scale group.
See also the [direction page](https://about.example_company.com/direction/enablement/tenant-scale/) and the
...
project (typically [Example Company](https://example_company.com/example_company-org/example_company)) and add the
`~"group::tenant scale"` label, along with any other appropriate labels.

For urgent items, feel free to use the Slack channel (internal): [#g_tenant-scale](https://example_company.slack.com/archives/g_tenant-scale).
...
to provide a solution to accommodate Example Company.com's daily-active user growth.
...
Currently, [Cells](https://docs.example_company.com/ee/architecture/blueprints/cells/) is
...
- Support Example Company.com's daily-active user growth
...
| [Organization for Cells 1.0](https://example_company.com/groups/example_company-org/-/epics/10018) | Alex | Abdul, Rutger, Peter, Zack Cuddy |
| [Organization isolation](https://example_company.com/groups/example_company-org/-/epics/11670) | Shubham | Leonardo da Rosa, Krasimir Angelov |
| Cells Services: [SSH Routing](https://example_company.com/groups/example_company-org/-/epics/12708) | Vasilii Iakliushin | |
| Cells Services: [HTTP Routing](https://example_company.com/groups/example_company-org/-/epics/12491) and [Topology Service](https://example_company.com/groups/example_company-org/-/epics/13153) | Thong | Bojan, Filipe Santos, Omar, Manoj, David Leach, Jonathon Sisson |
| Cells Services: [Database sequences](https://example_company.com/groups/example_company-org/-/epics/13155) | Prabakaran Murugesan | |
...
Before starting a milestone, the group coordinates using [planning issues](https://example_company.com/example_company-org/tenant-scale-group/group-tasks/-/issues/?label_name%5B%5D=Planning%20Issue).
...
The primary source for things to work on is the [milestone prioritization board](https://example_company.com/groups/example_company-org/-/boards/5548886),
...
We follow the Example Company [product development workflow](/handbook/product-development-flow/)
guidelines. To get a high-level overview of the status of all issues in the
current milestone, check the [development workflow board](https://example_company.com/groups/example_company-org/-/boards/2594854).
...
We follow the Example Company [engineering workflow](/handbook/engineering/workflow/)
guidelines. To get a high-level overview of the status of all issues in the
current milestone, check the [development workflow board](https://example_company.com/groups/example_company-org/-/boards/2594854).
...
- [Core Platform:Tenant Scale milestone prioritization](https://example_company.com/groups/example_company-org/-/boards/5548886?label_name[]=group%3A%3Atenant%20scale)
- [Core Platform:Tenant Scale cross-functional prioritization](https://example_company.com/groups/example_company-org/-/boards/4424394?label_name[]=group%3A%3Atenant%20scale)
- [Core Platform:Tenant Scale planning](https://example_company.com/groups/example_company-org/-/boards/7487616?label_name[]=group%3A%3Atenant%20scale)
- [Core Platform:Tenant Scale validation](https://example_company.com/groups/example_company-org/-/boards/7487708?label_name[]=group%3A%3Atenant%20scale)
- [Core Platform:Tenant Scale development workflow](https://example_company.com/groups/example_company-org/-/boards/2594854?label_name[]=group%3A%3Atenant%20scale)
- [Core Platform:Tenant Scale bugs](https://example_company.com/groups/example_company-org/-/boards/7487700?label_name[]=group%3A%3Atenant%20scale&label_name[]=type%3A%3Abug)
- [Core Platform:Tenant Scale release posts](https://example_company.com/groups/example_company-org/-/boards/7487687?label_name[]=group%3A%3Atenant%20scale)
- [Core Platform:Tenant Scale milestones](https://example_company.com/groups/example_company-org/-/boards/5549104?label_name[]=group%3A%3Atenant%20scale)
- [Core Platform:Tenant Scale team members](https://example_company.com/groups/example_company-org/-/boards/5549106?label_name[]=group%3A%3Atenant%20scale)
- [Core Platform:Tenant Scale important](https://example_company.com/groups/example_company-org/-/boards/1438588?label_name[]=group%3A%3Atenant%20scale)
- [Core Platform:Tenant Scale community contributions](https://example_company.com/groups/example_company-org/-/boards/7487739?label_name[]=group%3A%3Atenant%20scale&label_name[]=Community%20contribution)

### Tracking Dashboards

In addition to issue boards, we also track progress on major initiatives with bespoke dashboards such as the [Cells Progress Tracker](https://example_company.com/example_company-org/tenant-scale-group/cells-progress-tracker).

The team has also spun off [Epic Dashboards](https://example_company.com/example_company-org/tenant-scale-group/epic-dashboard) into a project that other teams can use to create their own epic-based tracking dashboards.

@manojmj is the creator and DRI of [Epic Dashboards](https://example_company.com/example_company-org/tenant-scale-group/epic-dashboard) and supports this project on a best-effort basis outside of core project responsibilities.
...
The EM will use the [refinement script](https://example_company.com/example_company-org/tenant-scale-group/group-tasks/-/blob/main/scripts/refinement)
...
selected for backlog refinement. [Current backlog refinement issues](https://example_company.com/example_company-org/tenant-scale-group/group-tasks/-/issues/?label_name%5B%5D=workflow%3A%3Arefinement).
...
We have [milestone retrospectives issues](https://example_company.com/gl-retrospectives/enablement-section/tenant-scale/-/issues).
...
1. [Create an issue](https://example_company.com/example_company-org/tenant-scale-group/group-tasks/-/issues) explaining why you want to have a retrospective and indicate whether this should be synchronous or asynchronous.
...
check the [OKR project](https://example_company.com/example_company-com/example_company-OKRs/-/issues/?sort=created_date&state=opened&label_name%5B%5D=group%3A%3Atenant%20scale&milestone_title=Started).

## Error Budgets

Example Company uses [error budgets](/handbook/engineering/error-budgets/) to measure the
...
in this [Grafana dashboard](https://dashboards.example_company.net/d/stage-groups-detail-tenant_scale/stage-groups-tenant-scale-group-error-budget-detail?orgId=1).

An error budget exception of 99.85% was [approved](https://example_company.com/example_company-com/www-example_company-com/-/merge_requests/121190)
