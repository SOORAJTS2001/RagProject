...
A metric has a set of labels. Example Company adds the following set of labels to all metrics:
...
1. Make scripts executable `find /opt/example_company/embedded/bin/gitaly-git-v* -exec chmod 777 {} \;`
1. Start Gitaly
