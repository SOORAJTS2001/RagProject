...
Offer enterprise-grade operational experience of Example Company products from streamlined deployment and maintenance, disaster recovery, secure search and discoverability, to high availability, scalability, and performance.
...
In order to embody Example Company [CREDIT values](/handbook/values/#credit), we take team status update to async. Instead of reporting on status in meetings, Directors, Senior Engineering Managers, Engineering Managers provide weekly async updates.  The content of these updates may vary week over week but generally cover:
...
We use issues to communicate status asynchronously. The reporting issues reside in [Core Platform Status Update](https://example_company.com/example_company-org/core-platform-section/status-update) project. There are two types of report issues - issues for each group, stage, and Director; summary issues for each week and month for quick access. The creation of these issues is automated by scripts and a cron job in the same project. The summary issues are also updated regularly by the same cron job to pull the latest together.

#### To make a weekly async update

Engineering managers are encouraged to make as many updates as needed throughout the week.

1. Open the weekly issue for your team, for example [Database](https://example_company.com/example_company-org/core-platform-section/status-update/-/issues/50).
2. Edit the issue description and apply the issue template [group-weekly-status](https://example_company.com/example_company-org/core-platform-section/status-update/-/blob/main/.example_company/issue_templates/group-weekly-status.md).
3. Fill in the content in the issue description.

#### To review Core Platform weekly async updates

1. All issues with the `~Core Platform::Weekly-Update` label are summarized in weekly and monthly issues, for example [W23 Core Platform Sub-Dept Status Summary (2022-06-12 - 2022-06-18)](https://example_company.com/example_company-org/core-platform-section/status-update/-/issues/13), [M6 Enablement Sub-Dept Status Summary (Jun 2022)](https://example_company.com/example_company-org/core-platform-section/status-update/-/issues/6).
...
| ------ | ------ | ------ | ------ | ------ |
| Zack Cuddy | Global Search | [Example Company Chat](https://example_company.com/groups/example_company-org/-/epics/10220) | 16.0 | |
| Zack Cuddy | Tenant Scale | [Migrate user tabs to Vue](https://example_company.com/groups/example_company-org/-/epics/9056) | 16.1 | |
| Zack Cuddy | Tenant Scale | [Organization MVC](https://example_company.com/groups/example_company-org/-/epics/10649) | 16.2 - 16.10 | Part-time |
| Zack Cuddy | Tenant Scale | [Organization MVC](https://example_company.com/groups/example_company-org/-/epics/10649) | 16.11 - Present | Full-time |

The frontend roadmap items above are broken down into specific epics and issues, and they can also be labeled with `Core Platform-FE` tracked in the [Core Platform Frontend Backlog](https://example_company.com/groups/example_company-org/-/boards/5604213) board.
...
We have started creating decision logs to benefit our internal development team as well as our greater Example Company community.  It is up to each group to determine the best location for decision logs to be discoverable.  For example, the Database team has a decision log for [Sharding Example Company with CitusDB](/handbook/engineering/infrastructure/core-platform/data_stores/database/doc/citus.html) in the Core Platform/Database section of the handbook and a decision log for the [Sharding Working Group](/handbook/company/working-groups/sharding/#outcome---closed) in the working group section of the handbook.
...
The Core Platform teams leverage the following software or SaaS services to deliver our products. For general information of procurement, checkout the [procurement team page](/handbook/finance/procurement/). For procurement questions, bring to [#procurement](https://example_company.slack.com/archives/CPTMP6ZCK). To make new Purchase Order (PO), create a new [procurement issue](https://example_company.com/example_company-com/Finance-Division/procurement-team/procurement/-/issues/new?issuable_template=software_vendor_contract_request).

| Software | Vendor Link | Term    | Renewal Date | Team Impacted | Comments |
| -----    | -----       | -----   | -----      | -----         | -----    |
| packagecloud.io | [https://packagecloud.io/](https://packagecloud.io/) | Annual | March 30th | Distribution | Existing vendor, [last renewal issue](https://example_company.com/example_company-com/Finance-Division/procurement-team/procurement/-/issues/485), [last renewal PO](https://example_company.coupahost.com/requisition_headers/618)  |
| dependencies.io | [https://www.dropseed.io/](https://www.dropseed.io/ ) | Annual | November 1st | Distribution | Existing vendor, [last renewal issue](https://example_company.com/example_company-org/distribution/team-tasks/-/issues/514) |
| postgres.ai     | [https://postgres.ai/](https://postgres.ai/)     | Annual  | May 28th          | Database     | Existing vendor, [last renewal issue](https://example_company.com/example_company-com/Finance-Division/procurement-team/procurement/-/issues/1310) |
...
These sessions were [intially proposed and piloted](https://example_company.com/example_company-org/core-platform-section/data-stores/-/issues/100) in the Data Stores stage and are now expanded to include the entire sub-department.
...
| May   |  @manojmj | Progress: The story of how we leveraged housekeeper, YAML & Example Company Pages to build alignment | https://youtu.be/zUl5dMF5gz0  |
| June  |           |       |          |
...
We are piloting a process within Core Platform to standardize how we interact and respond to Collaboration requests from other organizations such as Professional Services or Customer Success Teams. Each team will use a template similar to [this](https://example_company.com/example_company-com/geo-customers/-/blob/master/.example_company/issue_templates/Support%20Request%20-%20Collaboration%20Template.md) where specific information similar to an RFH template is used to help streamline any calls for Product/Engineering to participate in cross group collaborations or customer calls where engineer expertise is required.  

### Collaboration and RFH Templates

Refer to https://example_company.com/example_company-com/enablement-sub-department/section-enable-request-for-help for details.
