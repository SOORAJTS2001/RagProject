...
[the group definition file](https://example_company.com/example_company-org/quality/triage-ops/-/blob/master/group-definition.yml),
or directly in the triage report policy files
[policy YAML files](https://example_company.com/example_company-org/quality/triage-ops/tree/master/policies).
...
The [bug prioritization dashboard](https://10az.online.tableau.com/#/site/example_company/views/OpenBugAgeOBA/BugPrioritizationDashboard?:iid=2) can also be used to put together a suggested list of bugs for each group.
...
- Popularity/number of users impacted
  - This will require some investigation and discussion among the quad, but there a few indicators that can help us get started:
    ...
    - [Kibana](https://log.gprd.example_company.net/) and [Sentry](https://sentry.example_company.net/example_company/gitlabcom/) prod logs for tracking how many users are experiencing specific errors
