...
* Here is one example of a big picture framework to guide the conversation in cases where team members could use some coaching:
  ...
  2. "What do you see yourself doing at the pinnacle of your career?"
     * The goal in this section is to capture their highest aspirations, at Example Company and beyond. This can be challenging to answer for some people who have never been asked this before. You can prompt them by asking further questions like:
  ...
  4. Action Item plan in 4 part using SMART goals
     1. Growing your Network - Identify people who can get you further along the path.
        * This includes mentors and sponsors both inside and outside Example Company.
...
* Actions to make changes to a Example Company team-member's level can be taken during the [360 Feedback](/handbook/people-group/360-feedback/), and the data collected throughout this workflow should be useful at that time.
...
While there is no time-boxing for level progress, the company does operate on a [specific cycle](/handbook/people-group/360-feedback/) to make changes to a Example Company team-members level during the [360 Feedback](/handbook/people-group/360-feedback/).
...
Don't know what to learn? Check out the [SRE I](https://example_company.com/example_company-com/support/support-training/-/blob/master/.example_company/issue_templates/SRE%20Introduction.md) and the [SRE II](https://example_company.com/example_company-com/support/support-training/-/blob/master/.example_company/issue_templates/SRE%20II.md) Training Modules, these cover a range of topics related to how we do Reliability Engineering at Example Company. It is recommended that you come to your internship prepared, and by completing both modules, you'll ensure a richer internship experience as you'll make the best use of your time during your internship with an extra focus on more advanced topics.
...
If you're interested in learning more about SREs in general, you may wish to read Alice Goldfuss's blog post, "[How to Get Into SRE](https://blog.alicegoldfuss.com/how-to-get-into-sre/)." This blog post is an overview of all sorts of SRE related things, some of which may not be in use here at Example Company. However, it can be a valuable tool to learn more about SREs in general, and it links to many resources that you can use to learn more about a variety of SRE related topics.
...
3. Shadow the Delivery team to learn more about how we release to Example Company.com

## Staff+ IC Gearing in Infrastructure

Example Company Engineering employs a gearing method for determining the reporting relationship and number of Staff+ roles, generally referred to as [Staff+ IC Gearing Ratios](/handbook/engineering/career-development).
