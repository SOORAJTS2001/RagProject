...
### Observability for Example Company, not just SaaS Platforms

We are better when we work together.

Although our main mandate is to support Example Company's SaaS Platforms, we actively share knowledge with other teams at Example Company and other customers and build tools and frameworks that work for everyone.
...
In line with our [Dogfooding philosophy](/handbook/product/product-processes/dogfooding-for-product-mgt/), we go beyond the SaaS context and consider what we can offer upstream to other Example Company customers.
Similarly, we prefer using Example Company's own features and tools when they fit our requirements.

### Tool Portability

Example Company's SaaS Infrastructure is complex.
...
### Theme 1: Improve how we work with other teams at Example Company

We are faster together.  If we improve how we work with other teams at Example Company, we make their jobs and our jobs easier, and we can focus on new and additional problems.
...
- Dogfood the Monitor:Observability tracing tool for Example Company.com
- Collaborate with Dedicated to help create and integrate Observability Units
- Support the observability components of Cells and other Example Company initiatives
...
- Create reusable abstractions that can be used for a wide variety of systems within Example Company and are easy to self-service
