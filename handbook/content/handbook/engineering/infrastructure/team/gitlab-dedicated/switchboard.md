...
Switchboard is a team within the [Dedicated Group](/handbook/engineering/infrastructure/team/example_company-dedicated/). Our mission is to empower external Example Company Dedicated customers to manage their tenant environments and reduce the operational overhead on the Environment Automation team so we can scale up the Example Company Dedicated offering. We follow the same processes as listed on the [Dedicated Group](/handbook/engineering/infrastructure/team/example_company-dedicated/), unless a difference exists which is explicitly noted on this page.

### Resources

- [Switchboard Direction Page](https://about.example_company.com/direction/saas-platforms/switchboard/)
- [Switchboard Demo Library](https://example_company.com/example_company-com/gl-infra/example_company-dedicated/switchboard/-/blob/main/docs/walkthrough-library.md)
...
- In case you want to get attention please use the specific team handle, `@example_company-dedicated/switchboard`, as defined in [Dedicated group hierarchy](/handbook/engineering/infrastructure/team/example_company-dedicated/#example_company-group-hierarchy)
- As a cross-functional team Switchboard uses `@example_company-dedicated/switchboard/frontend-engineers` and `@example_company-dedicated/switchboard/backend-engineers` internally to seek input from engineers with specific expertise
- [Switchboard issue board](https://example_company.com/groups/example_company-com/gl-infra/example_company-dedicated/-/boards/4498935?label_name[]=component%3A%3ASwitchboard) tracks all of the team's current work

- Slack channels
  - For Switchboard specific questions, you can find us in [#g_dedicated-switchboard-team](https://example_company.slack.com/archives/C04DG7DR1LG)
  - Our Slack group handle is `@dedicated-switchboard-team`
  - Issues relevant to the wider Dedicated Group may be raised [#g_dedicated-team](https://example_company.slack.com/archives/C025LECQY0M)
...
- Create an [Access Request](https://example_company.com/example_company-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request) specifying
...
- Access & Provision Details for the application can be found in the `Switchboard - Example Company Dedicated` section of the [Tech Stack](https://example_company.com/example_company-com/www-example_company-com/-/blob/d3561ab939029faf4ac25f32612c57e861eb8b39/data/tech_stack.yml)
...
It is expected that these meetings are private streamed, or recorded(1*), and then uploaded to [Example Company Unfiltered playlist](https://www.youtube.com/playlist?list=PL05JrBw4t0Kp3NBMl7c0DGXCjW5rSPeOK).
...
- [Switchboard team roadmap](https://example_company.com/groups/example_company-com/gl-infra/example_company-dedicated/-/roadmap?state=all&sort=start_date_asc&layout=WEEKS&timeframe_range_type=CURRENT_QUARTER&label_name[]=team::Switchboard&progress=COUNT&show_progress=true&show_milestones=false&milestones_type=ALL&show_labels=false)
- [Switchboard team top-level epic](https://example_company.com/groups/example_company-com/gl-infra/-/epics/1048)
- [Switchboard team issue board](https://example_company.com/groups/example_company-com/gl-infra/example_company-dedicated/-/boards/4498935?label_name[]=team%3A%3ASwitchboard)
- [Switchboard technical writing board](https://example_company.com/groups/example_company-com/gl-infra/example_company-dedicated/-/boards/7068209?label_name[]=component%3A%3ASwitchboard&label_name[]=Technical%20Writing)
- [Dedicated Issue Tracker](https://example_company.com/example_company-com/gl-infra/example_company-dedicated/team/-/issues/?sort=created_date&state=opened&first_page_size=100)
...
1. Team members look at issues in the `Open` column of the [issue board](https://example_company.com/groups/example_company-com/gl-infra/example_company-dedicated/-/boards/4498935?label_name[]=team%3A%3ASwitchboard) and ask questions on the issue to drive clarity
...
1. SRE dependencies should be called out as early as possible with requirements clearly documented in issues ([example SRE dependency issue](https://example_company.com/example_company-com/gl-infra/example_company-dedicated/team/-/issues/2798))
...
1. ~"workflow-infra::Ready" column on the [issue board](https://example_company.com/groups/example_company-com/gl-infra/example_company-dedicated/-/boards)
   1. Pick an issue from the ~"workflow-infra::Ready" column on the [issue board](https://example_company.com/groups/example_company-com/gl-infra/example_company-dedicated/-/boards/4498935?label_name[]=team%3A%3ASwitchboard)
...
1. [Switchboard team top-level epic](https://example_company.com/groups/example_company-com/gl-infra/-/epics/1048)
    1. Look at the Switchboard top level epic and offer to work on issues with the nearest due date
    1. Use the [Switchboard team roadmap](https://example_company.com/groups/example_company-com/gl-infra/example_company-dedicated/-/roadmap?state=all&sort=start_date_asc&layout=WEEKS&timeframe_range_type=CURRENT_QUARTER&label_name[]=team::Switchboard&progress=COUNT&show_progress=true&show_milestones=false&milestones_type=ALL&show_labels=false) for guidance

1. `Open` column on the [issue board](https://example_company.com/groups/example_company-com/gl-infra/example_company-dedicated/-/boards/4498935?label_name[]=team%3A%3ASwitchboard)
...
|---------------------------------------------|-------------------------|---------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| `switchboard_bug.md`                        | Example Company team members     | Reporting a bug in the Switchboard application                                                                                        | Usually used by EA and Switchboard team members                                                                                     |
| `feature_proposal_switchboard.md`           | Example Company team members     | Proposing a new feature                                                                                                               | Usually used by Switchboard team members. Could possibly be replaced by Epic template or updated to ensure more fields are optional |
| `switchboard-feedback.md`                   | Example Company team members     | This is used to make suggestions and provide feedback to Switchboard. It feeds into the EA Requests epic which the EM & PM prioritise | This template is used regularly by EA team members to provide feedback                                                              |
...
We specifically adhere to the [Example Company Code Review Guidelines](#example_company-code-review-guidelines) and follow
the [Dedicated group principles](/handbook/engineering/infrastructure/team/example_company-dedicated/#merge-requests) when requesting merge request reviews.

#### Merge request review process

As the Switchboard team is currently small, we use an 'Approve and Merge' approach:

1. When you're ready to have your merge request reviewed, select one or more [Switchboard reviewers](https://example_company.com/groups/example_company-dedicated/switchboard/reviewers/-/group_members).
...
1. Reviewers will perform a review based on [reviewing a merge request guidelines](https://docs.example_company.com/ee/development/code_review.html#reviewing-a-merge-request).
...
**UI changes visible to internal Example Company users:**
...
- As per the [Example Company Review Guidelines](https://docs.example_company.com/ee/development/code_review.html#merging-a-merge-request) there are scenarios where it is appropriate for the author to merge the merge request: If there are no blocking comments, and the merge request has all the required approvals, the author or maintainer can merge.
- Switchboard project is configured to use [pipelines for merged results](https://docs.example_company.com/ee/ci/pipelines/merged_results_pipelines.html) which means that reviewers need to run a pipeline pre-merge to guarantee that updates are compatible with the latest main branch.
...
- We label merge requests using the [Specialization labels](https://example_company.com/example_company-org/example_company-foss/-/blob/master/doc/development/labels/index.md#specialization-labels) found in the [Example Company documentation](https://example_company.com/example_company-org/example_company-foss/-/blob/master/doc/development/labels/index.md). MRs should be labeled ~"frontend", ~"backend" or ~"documentation"

#### Approval guidelines

| If your merge request includes  | It must be approved by a |
| ------------------------------- | ------------------------ |
| `~backend` changes        | [Backend maintainer](https://example_company.com/groups/example_company-dedicated/switchboard/maintainers/-/group_members). |
| `~frontend` changes       | [Frontend maintainer](https://example_company.com/groups/example_company-dedicated/switchboard/maintainers/-/group_members). |

#### Reviewer roulette

Reviewer roulette is an internal tool for use on Example Company.com projects that randomly picks a maintainer for each area of the codebase. To select a maintainer:

1. Go to the [reviewer roulette](https://example_company-org.example_company.io/example_company-roulette/?currentProject=switchboard&sortKey=stats.avg30&mode=show&order=-1) page.
...
#### Example Company Code Review Guidelines

- [Having your merge request reviewed](https://docs.example_company.com/ee/development/code_review.html#having-your-merge-request-reviewed)
- [Reviewing a merge request](https://docs.example_company.com/ee/development/code_review.html#reviewing-a-merge-request)
- [The Right Balance](https://docs.example_company.com/ee/development/code_review.html#the-right-balance)
- [Quality](https://docs.example_company.com/ee/development/code_review.html#quality)
- [Performance, reliability and availability](https://docs.example_company.com/ee/development/code_review.html#performance-reliability-and-availability)
- [Merge request performance guidelines](https://docs.example_company.com/ee/development/merge_request_concepts/performance.html)

### Reviewers and maintainers

There are two groups for Switchboard, [Reviewers and Maintainers](https://example_company.com/example_company-dedicated/switchboard):
...
|----------|----------|-------------------|
| [Internal - Operator](https://about.example_company.com/direction/saas-platforms/switchboard/internal-user-roles/) |  |  |
| [Internal - Support](https://about.example_company.com/direction/saas-platforms/switchboard/internal-user-roles/) |  |  |
| [Internal - Provisioner](https://about.example_company.com/direction/saas-platforms/switchboard/internal-user-roles/) |  |  |
| [Internal - Read Only](https://about.example_company.com/direction/saas-platforms/switchboard/internal-user-roles/) |  |  |
| [External - Tenant Admin](https://docs.example_company.com/ee/administration/dedicated/configure_instance.html#add-users-to-an-instance) |  |  |
| [Internal - Read Only](https://docs.example_company.com/ee/administration/dedicated/configure_instance.html#add-users-to-an-instance) |  |  |
...
Demo Link - see https://handbook.example_company.com/handbook/engineering/infrastructure/team/example_company-dedicated/switchboard/#switchboard-demos
