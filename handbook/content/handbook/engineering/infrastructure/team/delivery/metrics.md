...
description: "The Delivery Team enables Example Company Engineering to deliver features in a safe, scalable and efficient fashion to both Example Company.com and self-managed customers."
---
...
MTTP measures the elapsed time (in hours) from merging a change in example_company-org/example_company project master
branch, to deploying that change to Example Company.com.
...
- **Target: 8 hours.**
- [Dashboard](https://dashboards.example_company.net/d/delivery-deployment_slo/delivery-deployment-slo?orgId=1&refresh=5m)
...
![Deployment SLO apdex](https://example_company.com/api/v4/projects/430285/jobs/artifacts/master/raw/deployment-slo-apdex.png?job=refresh-delivery-slo-apdex-graph)

Next: Include [Deployment SLO metric as part of our release process](https://example_company.com/groups/example_company-com/gl-infra/-/epics/533)
...
More details about what is being measured, and how, can be found in [the release docs](https://example_company.com/example_company-org/release/docs/-/blob/master/metrics/release_manager_workload.md).
