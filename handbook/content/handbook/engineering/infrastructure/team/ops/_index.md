...
1. Incident Management - Ops is responsible for improving the processes Example Company uses for incident management
...
3. Patching Processes - Ops is responsible for defining and maintaining the Example Company.com patching process

## How We Work - Prioritization

### Project Management

The Ops team top level Epic can be found [here](https://example_company.com/groups/example_company-com/gl-infra/-/epics/1176).
...
Project status is maintained in the description of the top-level epic so that it is visible at a glance. This is auto-generated using the [epic issues summary project](https://example_company.com/example_company-com/gl-infra/epic-issue-summaries). You can watch a [short demo of this process](https://youtu.be/6Wb1f-c1_og) to see how to use status labels on the epics to make use of this automation.
...
1. [Historical Service Level Availability](/handbook/engineering/monitoring/#historical-service-level-availability) including [maintenance windows](https://status.example_company.com/pages/history/5b36dc6502d06804c08349f7) from the month in the comments

Each of these items should be updated to reflect the most recent month.  ([Sample MR](https://example_company.com/example_company-com/content-sites/handbook/-/merge_requests/4115)).

Latest results are on the [Example Company.com General SLA Dashboard](https://dashboards.example_company.net/d/general-slas/general-slas?orgId=1&from=now-1M%2FM&to=now-1M%2FM) (internal only)
...
- Generate and delegate action items to the relevant teams based on the review process.  This includes:
  ...
  - [Reliability Improvement Issues](https://example_company.com/example_company-com/gl-infra/reliability/-/issues/new)

These efforts are coordinated asynchronously via the [Example Company Incident and Pager Trends Monthly Review Agenda](https://docs.google.com/document/d/1SBoyuKK_g3RbYMcwJZs6dFqCGH9NCqu-M3QsHIwiKMw/edit#)
...
- Ops Epic List: https://example_company.com/groups/example_company-com/gl-infra/-/epics/1176
- Issue Board: [All issue by priority](https://example_company.com/example_company-com/gl-infra/production-engineering/-/boards/3993753?label_name[]=team%3A%3AOps)
