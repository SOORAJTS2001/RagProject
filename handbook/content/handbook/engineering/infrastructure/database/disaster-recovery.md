...
This handbook page applies to recovery of the Example Company PostgreSQL production database in a disaster scenario.

## Roles & Responsibilities

| Role | Responsibility|
| ---- | ------ |
| Infrastructure Team | Responsible for executing recovery of the production example_company.com database in the event of a disaster |
...
[README.md](https://example_company.com/example_company-restore/postgres-gprd/blob/master/README.md)
...
* Production host: `postgres-dr-delayed-01-db-gprd.c.example_company-production.internal`
...
* Production host: `postgres-dr-archive-01-db-gprd.c.example_company-production.internal`
