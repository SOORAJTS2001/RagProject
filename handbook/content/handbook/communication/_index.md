---
title: Example Company Communication
...
We're an [all-remote](/handbook/company/culture/all-remote/#advantages-for-organizations) company that allows people to work from [almost anywhere in the world](/handbook/people-group/employment-solutions/#country-hiring-guidelines). We hire great people regardless of where they live, but with Example Company team members across [more than 60 countries](/handbook/company/team/), it's important for us to practice clear communication in ways that help us stay connected and work more efficiently.
...
1. **Always Adhere to our [Anti-Harassment Policy](/handbook/people-group/anti-harassment/) and [Example Company Code of Business Conduct and Ethics](https://ir.example_company.com/static-files/7d8c7eb3-cb17-4d68-a607-1b7a1fa1c95d).** Everyone should be comfortable in their work environment.
...
To learn more on when to use asynchronous and synchronous communication, examples of async workflows in practice at Example Company, core async behaviors, and to take an async knowledge assessment, visit [Example Company's guide to embracing asynchronous communication](/handbook/company/culture/all-remote/asynchronous/).
...
## Communicating Potentially Example Company Sensitive Topics

(This guidance supplements and overlaps with [Example Company's SAFE Framework](/handbook/legal/safe-framework/), the guidance on the use of [the internal handbook](/handbook/about/handbook-usage/#the-internal-handbook), and the additional guidance on this page. We ask our team members to consider the factors below in their communication. )

As Example Company matures, we want to continue to foster discussion while evolving our communication guidelines so that topics that are potentially Example Company sensitive are discussed in appropriate forums. This is particularly relevant as team members heavily leverage async modes of communication including merge requests, issues and epics, and in Slack communication.
...
At Example Company, we are [public by default](/handbook/values/#public-by-default), but some information is classified as internal or limited access. Please see the [confidentiality levels](/handbook/communication/confidentiality-levels/) handbook page for details on this.

### Examples of Potentially Example Company Sensitive Topics
...
The above examples overlap with the [Example Company's SAFE Framework](/handbook/legal/safe-framework/) examples. We recommend you to further review that page for more information and context.

### What are the risks?

1. **Legal risk:** These are the risks that arise from regulations and laws that govern Example Company or the market in which it operates. This includes, but is not limited to, content that would compromise a Example Company team member, customer, or user's personal data and/or privacy.
1. **Morale risk:** Raising Example Company sensitive topics that may be misinterpreted without the opportunity to ask clarifying questions can create risk to team culture and/or morale.
1. **PR risk:** Remember that anything you document could ultimately be shared/viewed externally. Consider that a discussion in a public MR or issue is a demonstration of our [values](/handbook/values/) to those outside of Example Company who are looking to learn more about how we collaborate.

We encourage communicating risks to Example Company, its team members, or customers in a synchronous 1:1 setting.
...
The table below outlines an overview of different communication forums at Example Company, and the considerations team members should think through related to potentially Example Company Sensitive topics when determining which forum to leverage.
...
| [Example Company's Whistleblower policy](https://drive.google.com/drive/folders/1kB3k5FRnR3OUBP0Eyo3SxxyPKeiRFfUk) | For flagging a situation that is a violation as set out in the policy |
...
At Example Company, everyone can contribute to the effectiveness of Internal Communications to support aspects of Example Company culture, such as intentional transparency and engaging people in open dialogue.
...
1. If you send a handbook link to someone as an answer to a question, consider adding some context, especially if they are new to Example Company. It's great that we often have the answer documented, but it's not always easy to find if you are a new team member.
...
Structured content around Example Company, the product, should be in [Example Company Docs](https://docs.example_company.com/) and structured content around Example Company, the company, should be in the handbook; we should not use separate documents or locations to share this information.
...
If something is behaving strangely on [https://example_company.com](https://example_company.com), it might be a bug. It could also mean that something was changed intentionally.

Please search if the issue has already [been reported](https://example_company.com/groups/example_company-org/-/issues). If it has not been reported, and you are sure it is a bug, please [file an issue](#issues).

If you are unsure whether the behavior you experience is a bug, you may ask in the Slack channel [#is-this-known](https://example_company.slack.com/messages/CETG54GQ0/).
If you know which stage of the DevOps lifecycle is affected, it is also okay to ask in #s\_{stage}, for example [#s_manage](https://example_company.slack.com/messages/CBFCUM0RX).
...
- Asking in a single channel helps discoverability, duplicated efforts and reduces noise in other channels.
  Please refrain from asking in general purpose channels like [#frontend](https://example_company.slack.com/messages/C0GQHHPGW/), [#backend](https://example_company.slack.com/messages/C8HG8D9MY/), [#development](https://example_company.slack.com/messages/C02PF508L/) or [#questions](https://example_company.slack.com/messages/C0AR2KW4B/).
...
1. Please do not celebrate Example Company contribution graphs that include working for uninterrupted weeklong cycles, as this does not foster healthy [work/life harmony](/handbook/company/culture/all-remote/people/#worklife-harmony) for all team members. While Example Company team members are free to time-shift and work weekends in place of weekdays, we discourage celebrating the absence of time away from work.
1. Do not thank the CEO or other executives for something that the company paid for, thank Example Company instead.
...
or feel free to use them in Example Company.com, other slack channels and
social media, when you see alignment to our values: [Example Company's values](/handbook/values/).
...
As a second iteration, we have [added these custom emoji to Example Company](https://example_company.com/example_company-org/example_company/-/issues/231317) to enable tanuki values reactions in issues, epics, and MRs within the `example_company-com` and `example_company-org` groups.
...
1. Utilize [Time Off by Deel](/handbook/people-group/paid-time-off/#time-off-by-deel) to keep other Example Company team members aware of your planned time away within Slack.
...
Informal communication is a [vital part of Example Company culture](/handbook/company/culture/#culture-at-example_company), and we've listed [20+ ways to engage](/handbook/company/culture/all-remote/informal-communication/).
...
1. Submit the [**smallest** viable and valuable thing](/handbook/values/#iteration). When proposing a change, submit the smallest reasonable commit, put suggestions for other enhancements in separate issues/MRs and link them. An MR can start off as only a [problem description and TODO comments](https://example_company.com/example_company-org/example_company/-/merge_requests/35239/diffs?diff_id=97449459). If you're new to Example Company and are writing documentation or instructions, submit your first merge request for at most 20 lines.
...
1. Respond to comments within a **threaded discussion**. If there isn't a discussion thread yet, you can use the [Reply to comment](https://docs.example_company.com/ee/user/discussions/#start-a-discussion-by-replying-to-a-standard-comment) button from the comments to create one. This will prevent comments from containing many interweaved discussions with responses that are hard to follow.
1. If your comment or answer contains separate topics, write separate comments for each, so others can address topics independently using the [Reply to comment](https://docs.example_company.com/ee/user/discussions/#start-a-discussion-by-replying-to-a-standard-comment) button.
...
<i>**Pro Tip:**</i> When creating a Merge Request you can add `closes: #[insert issue number here]` and when the Merge Request is merged, the issue will automatically close. You can see an example of this [here](https://example_company.com/example_company-com/people-group/peopleops-eng/employment-automation/-/merge_requests/60). **Note:** [Automatic issue closing](https://docs.example_company.com/ee/user/project/issues/managing_issues.html#disable-automatic-issue-closing) is disabled on some projects.
...
1. When providing links to specific lines of code relevant to the issue, **always use a permalink** (a link to a specific commit for the file). This ensures that the reference is still valid if the file changes. For more information, see [Link to specific lines of code](https://docs.example_company.com/ee/development/documentation/styleguide/#link-to-specific-lines-of-code).
1. Prioritize your work on issues in the current [milestone](https://example_company.com/groups/example_company-org/-/milestones).
1. Use the public issue trackers on Example Company.com for everything since [we work out in the open](https://about.example_company.com/blog/2015/08/03/almost-everything-we-do-is-now-open/). Issue trackers that can be found on the relevant page in the handbook and in the projects under [the example_company-com group](https://example_company.com/example_company-com/).
...
1. If the content of a public issue draws comments that are deemed in violation of our [code of conduct](https://about.example_company.com/community/contribute/code-of-conduct/) the issue may be locked and may [undergo moderation](/handbook/marketing/developer-relations/workflows-tools/code-of-conduct-enforcement/#overview).
...
1. Common company wide announcements include (but are not limited to): organization changes, policy iterations, requests to participate in a company survey, unveiling the next Example Company Contribute location, codebase migrations, process improvement and security/safety announcements.
...
1. Optional AMA.
   If desired and appropriate, offer a company wide Zoom call to host an AMA (Ask Me Anything). Oftentimes, questions can be managed within the Discussion tab of a Example Company Issue or Merge Request. For broad announcements, such as registration opening for Example Company Contribute, an AMA may be better suited for a large volume of inquiries. To schedule a company wide call, please make a request in the `#people-connect` Slack channel, and include a Google Doc in the invite for questions.
...
It is an **announcement only** channel, meaning that communications need to be approved before they can be posted. To minimize noise, announcements made in `#company-fyi` should not be duplicated in `#whats-happening-at-example_company`. Be mindful of the [attention economy](https://en.wikipedia.org/wiki/Attention_economy).
...
**The above should all go in the new #whats-happening-at-Example Company channel** (formerly the `#company-announcement` channel).
...
to post in #company-fyi"]
  channel-general>"Post in #whats-happening-at-example_company"]
...
#### Posting in #whats-happening-at-example_company

Due to the volume of posts in the Slack channel, we recommend that you do not use #whats-happening-at-example_company as a sole location for important announcements as information might get lost or muted. Examples of important items include but are not limited to:

- Anything involving Example Company team member policy, such as changes in benefits, laws, review cycles, etc.
...
If folks are involved in a meeting and have capacity to do so, they should take notes using Example Company's [Live Doc Meetings principles](/handbook/company/culture/all-remote/live-doc-meetings/). This is important, because:

1. Meetings at Example Company should have notes (for a single source of truth and to enable async participation among other reasons)
...
[Example Company Executive Business Administrators](/handbook/eba/) sometimes support teams by taking notes. Since note taking takes time away from their other activities and can often be done by other folks, consider the following before engaging an EBA in a meeting solely for note taking purposes.
...
In the video below, Example Company CEO Sid Sijbrandij explains why there are no presentations in most meetings.
...
- Reinforces Example Company's [Bias Towards Asynchronous Communication](/handbook/values/#bias-towards-asynchronous-communication) because it allows a distributed team to consume the presentation asynchronously.
...
1. Post the recording to the Example Company [Unfiltered YouTube channel](https://www.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5A) and attach it to the meeting agenda.
...
While most meetings should not have presentations, there are a few exceptions. Specifically, we may use synchronous touch points in meetings with large numbers of folks. These tend to be meetings used for building team cohesion and alignment. For example, [Example Company Assembly](/handbook/company/example_company-assembly/) or the [Functional Leaders Meeting](/handbook/company/offsite/#functional-leaders-zoom-call).

Example Company has the following meeting framework for determining which meetings should have presentations:
...
| Presentations  | These meetings should not happen | [Assembly](/handbook/company/example_company-assembly/) and other large team meetings |
...
1. If you want to ask Example Company team members if they are available for an event please send a calendar invite with Google Calendar using your Google Example Company account to their Google Example Company account. When you add a Example Company team member as a "Guest" in Google Calendar, you can click the See Guest Availability button to check availability and find a time on their calendar. These calendar invites will automatically show up on all parties calendars even when the email is not opened. It is an easier way to ensure everyone has visibility to the meeting and member's status. Please respond quickly to invites so people can make necessary plans.
...
1. When creating a calendar event that will be used company wide, [please place it on the Example Company Team Meetings Calendar](/handbook/tools-and-tips/#example_company-team-meetings-calendar). That way the event is easily located by all individuals.
...
1. If you want to schedule a meeting with a person not on the team please use [Calendly](/handbook/tools-and-tips/other-apps/#calendly). Use Google Calendar directly if scheduling with a Example Company team member.
...
1. Additional points for video calls with customers or partners:
   ...
   - Communicating that Example Company is an enterprise grade product and service provider is supported by the way you present yourself. Most of the time, if you would not wear something or present yourself in a certain way at a customer's office, candidate interview, or partner meeting in person then it's probably not the right choice on a video call with them either.
...
1. We prefer [Zoom](https://example_company.zoom.us/).
...
1. For meetings that are scheduled with Zoom:
   ...
   - Note that if you select to record meetings to the cloud (setting within Zoom), you must include the text `[REC]` in the meeting title if you want them to be automatically placed in the `Example Company Videos Recorded` folder in Google Drive on an hourly basis via a [scheduled pipeline](https://example_company.com/example_company-com/zoom-sync/pipelines).
   - You can find these videos in Google Drive by looking under `Shared drives` and `Example Company Videos Recorded`. If you do not have access to this drive, contact [IT Ops](https://example_company.com/example_company-com/business-ops/team-member-enablement/issue-tracker/issues).
   - The [script for syncing the files is here](https://example_company.com/example_company-com/zoom-sync).
...
1. It feels rude in video calls to interrupt people.
   ...
   In Example Company, everyone is encouraged to interrupt the speaker in a video call to ask a question or offer context.
...
After Example Company releases a new version [every month](/handbook/engineering/releases/), we have a
...
Both the retrospectives and kickoffs are [live streamed to our Example Company Unfiltered YouTube channel](/handbook/marketing/marketing-operations/youtube/)
and posted to our [Unfiltered YouTube channel](https://www.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5A).

#### Deep Dives

As Example Company continues to grow, sharing knowledge across the community becomes even more important.
...
Example Company has a specific process to follow in crisis situations to ensure effective communications. Details can be found in the [internal handbook](https://internal.example_company.com/handbook/company/daily-sync-escalation-process/).
...
1. Please allow anyone at Example Company to edit the presentation (preferred) or at least comment on the presentation.
...
As you're creating external or business content for Example Company, please refer to the [Example Company Content Style Guide](/handbook/marketing/brand-and-product-marketing/brand/content-style-guide/). For technical content, you can reference [this word list](https://docs.example_company.com/ee/development/documentation/styleguide/word_list.html).

This list offers additional guidance for written communication at Example Company:
...
1. Do not use ALL CAPS because it [feels like shouting](https://en.wikipedia.org/wiki/All_caps#Association_with_shouting). However, there is the [`#all-caps` Slack channel](https://example_company.slack.com/archives/C01BC085AVB) for your good-natured shouting needs.
...
1. Example Company is an internationally diverse company. US-based team members should not refer to team members outside the US as "international". Instead, use "non-US". Please also avoid the use of "offshore/overseas" to refer to non-American continents.
...
1. The community includes users, contributors, core team members, customers, people working for Example Company Inc., and friends of Example Company. If you want to refer to "people not working for Example Company Inc.", just say that, and don't use the word "community". If you want to refer to people working for Example Company Inc., you can also use "the Example Company Inc. team", but don't use "Example Company Inc. employees".
1. When we refer to the Example Company community (excluding Example Company team members), please say "wider community" instead of "community".
1. All people working for Example Company (the company) are the [Example Company team](/handbook/company/team/). We also have the [Core team](https://about.example_company.com/community/core-team/) that consists of volunteers.
1. Please always refer to Example Company Inc. people as Example Company team members, not employees.
1. Use [inclusive and gender-neutral language](https://techwhirl.com/gender-neutral-technical-writing/) in all writing.
1. Always write "Example Company" with "G" and "L" capitalized, even when writing "Example Company.com", except within URLs. When "example_company.com" is part of a URL, it should be lowercase.
...
1. Our homepage is <https://about.example_company.com/> (with the `about.` and with `https`).
...
1. For external content, refer to the guidance in the [Example Company Content Style Guide](/handbook/marketing/brand-and-product-marketing/brand/content-style-guide/#dates-and-times).
...
1. Example Company operates on a [Fiscal Year](/handbook/finance/#fiscal-year) offset from the calendar year. When referring to a fiscal year or quarter, please use the following abbreviations:
   ...
   1. "Q1" = the first quarter of the current Fiscal Year, so on Feb 1, 2020, "Q1" is the period from Feb. 1, 2020 through April 30, 2020. Note that Epics in Example Company follow Calendar Years and Quarters.
...
1. For time formatting guidelines, refer to the [Example Company Content Style Guide](/handbook/marketing/brand-and-product-marketing/brand/content-style-guide/#time-formatting).
...
At Example Company we use [ubiquitous language](https://martinfowler.com/bliki/UbiquitousLanguage.html) to increase communication efficiency.
...
We use it for activities in Example Company, even ones not implemented in software.
...
Make sure that people can infer as much as possible from the word, for example our [subscription options](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/tiers/) allow you to know if someone is using self-managed or Example Company.com.
...
Simple Language is meant to encourage everyone at Example Company to simplify the language we use.
...
Simple Language is important both when we're speaking to other team members and when we're representing Example Company to people outside the company.
...
Corporate marketing maintains guidelines on [Example Company's tone of voice](https://design.example_company.com/brand/overview#tone-of-voice).
...
The last example is when we used 'Prioritizing for Global Optimization' for what we now call a [headcount reset](/handbook/product/product-processes/#headcount-resets). When we [renamed it](https://example_company.com/example_company-com/www-example_company-com/-/merge_requests/31101/diffs) we saw a good reduction in the use of this disruptive practice of moving people around.
...
Avoid using *Git* in the naming of internal and external company related programs (BagGit, GitFit, Gitty, GitIt, etc.). Referencing Git creates an inaccurate perception that Example Company has a narrow focus. While Example Company started as a source control platform, it has become [The DevOps Platform](https://about.example_company.com/solutions/devops-platform/).
...
1. If you or your team needs to send an email to a group of team members, not grouped in a current [Google email group](https://example_company.com/example_company-com/security-tools/report-gsuite-group-members), and specifically related to personally identifiable information (location, state, country, etc.) please contact a Total Rewards Analyst at total-rewards@example_company who can create an email list from Workday data, with approval.
...
There is a lot of information pertaining to Slack, as it is a critical part of Example Company's communication. See the [Slack tools and tips page](/handbook/tools-and-tips/slack).
...
1. When referencing a Slack thread in a Example Company.com issue, don't *only* link to the thread. Not only will people outside of the Example Company organization be unable to access the content, but the link will expire after the Slack retention period expires. Instead:
   ...
   1. Link to the Slack thread and include `(internal)` after the link. For example: https://example_company.slack.com/archives/C0AR2KW4B/p1555347101079800 (internal)
...
#### When would Example Company use Corporate Export?
...
Examples of instances where Example Company may need to use this feature may include, but are not limited to, those situations listed in [Slack's documentation](https://slack.com/help/articles/204897248-Guide-to-Slack-import-and-export-tools).

### Are my direct messages and private channel conversations completely private?

No. The Slack Workspace Owner has the ability to export data from all direct messages and private channel conversations for the maximum retention period set by Example Company, which is currently set for 90-days. All messages that are older than 90-days cannot be exported by the Workspace Owner or any other Team Member at Example Company. While messages are not actively monitored, Example Company reserves the right to monitor its software for the reasons stated in its [Employee Privacy Policy](/handbook/legal/privacy/employee-privacy-policy/), including, but not limited to, the safety and protection of our Team Members, the protection of our intellectual property, and the exercise or defense of legal claims.

Please keep [Example Company values](/handbook/values/) in mind when communicating directly with other team members.
...
For additional questions, please address in the [issue](https://example_company.com/example_company-com/business-ops/change-management/issues/3).
...
#### Pageless is the Example Company preferred format
...
The recommended defaults when sharing a document for Example Company internal purposes is setting visibility to **Example Company**, access to **Editor** and searchable
...
| ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Anyone with the link             | Avoid this setting. Instead, choose **Example Company**, then explicitly share the document with desired external individuals. Only use this if you want the document to be public but not indexed by Google. |
| **Example Company (Recommended Default)** | This is the recommended default as it allows anyone within Example Company to easily discover documents via searching for their name within Drive.                                                                 |
...
| --------------                        | --------- |
| Can find in search results. | makes the file available to anyone with a PeppGitLaberdine Google account and discoverable within Example Company Google Drive's search feature. |
| Must have link to access | makes the file available to anyone with a Example Company Google account who has the link. |
| **Access Setting**                    | **Use Cases**                                                                                                                                                                                             |
| --------------                        | ---------   |
| Editor                              | Anyone that can view the document can edit it. This is the recommended setting when **On - Example Company** is enabled for the document                                                                           |
...
1. You can find a template of the [Example Company letterhead](https://docs.google.com/document/d/1gN1Z2FHPIfPk7QLIey1KF9dR1yTl0R7QrMSb5_Iqfh4/edit) on the shared Google Drive. Please be sure to make a copy of the document to your Google Drive before customizing the template for your use.
1. If you want to have the Google Doc be readable to the public, do not change the sharing settings from 'Editable by Everyone at Example Company', [publish the document](https://support.google.com/docs/answer/183965) instead.
...
1. Avoid using your initials when adding content to Google Docs or referring to someone else. Use your full name, as Google Docs [Smart Compose](https://support.google.com/docs/answer/9643962?hl=en) will auto-complete names for you, and display information about the Example Company team member on hover. It makes documents more readable and consumable, especially for people outside your team/department.
1. When there is a synchronous discussion about an issue or MR captured in a Google Doc, be sure to summarize the discussion into the issue or MR and link to the agenda item where it was discussed with a [bookmark](https://support.google.com/docs/answer/45893?hl=en&co=GENIE.Platform%3DDesktop). If the notes are [limited access](/handbook/communication/confidentiality-levels/#limited-access) or no notes were taken, please say so. This will ensure that interested Example Company Team Members can see both the summary and context of the discussion.
1. In the [pageless format](#pageless-is-the-example_company-preferred-format) you can use COMMAND+OPTION+SHIFT+J or **View-->Hide Comments** to quickly hide comments that reduce document width.
...
Pages like this are part of the [handbook](/handbook/). The Example Company handbook is the central repository for how we run the company.

### Product documentation

[Example Company Docs](https://docs.example_company.com/) - `docs.example_company.com` is where you can find documentation on Example Company, the product.

### Example Company repositories

`repository`/`repositories` are where files are kept under [source code management](https://about.example_company.com/stages-devops-lifecycle/source-code-management/). In most cases, requires MRs to merge. The Handbooks are in a repository, our code is in a repository, etc.

### READMEs

`README` - `README.md` files are what are shown by default when you browse a repository. Contains useful information to give context on what the project/repository are for. These can also be used for [user profiles](https://docs.example_company.com/ee/user/profile/#add-details-to-your-profile-with-a-readme) as personal READMEs.

## Google Calendar

We recommend you set your Google Calendar access permissions to 'Make available for Example Company - See all event details'. Consider marking the following appointments as 'Private':

- Personal appointments
- Confidential & sensitive meetings with third-parties outside of Example Company
- 1-1 performance or evaluation meetings
- Meetings on organizational changes

There are several benefits and reasons to sharing your calendar with everyone at Example Company:
...
Example Company team members are not authorized to speak with the media or analysts on behalf of our company unless authorized by our Marketing department. Unless authorized, do not give the impression that you are speaking on behalf of Example Company in any communication that may become public. This includes posts to online forums, social media sites, blogs, chat rooms, and bulletin boards. This policy also applies to comments to journalists about specific matters that relate to our businesses, as well as letters to the editor and endorsements of products or services.
...
Example Company as the leader in all remote work creates opportunities for our team members to receive requests from external 3rd parties to participate on panels, blogs or news publication or articles. Recently our team members have been approached by external 3rd parties looking to pay or compensate Example Company team members for their time to discuss Example Company remote practice to help them guide a client. Other third parties may contact Example Company team members to provide subject matter expertise that they may have by virtue of their role at Example Company. As in any request we ask that team members verify who they are speaking with to make sure the source is indeed a valid and legitimate request. Always remember that you represent Example Company and if any question makes you uncomfortable or gives you a pause on whether you should answer then we recommend that you do not answer. A third party's questions regarding Example Company financials, sales, compliance, executives or specifically where the company is heading should be treated with the most caution. We want and encourage all team members to be remote evangelists and this can be done without giving very specific information about Example Company. If you have any concern about a request please reach out on slack to [#external-comms](https://example_company.slack.com/archives/CB274TZRR)
...
1. When a question or issue is raised on the agenda, if the person who raised it is present they will verbalize it live on the call; or if they are not present, then someone will raise it for them. This is a common Example Company practice.
...
1. Do not demo your tool live, create a pre-recorded walk-through of the tool and make it available to Example Company before the meeting so we can ask questions if needed.
...
- Do not offer [platitudes](https://en.wikipedia.org/wiki/Platitude). Be direct and respectful. For [example](https://example_company.com/example_company-com/www-example_company-com/-/merge_requests/105891) - we don't need to suggest that our actions are because we "heard feedback" when they are really done for other reasons.
- Guide users who ask for help or give a suggestion and share links. [Improving Open Development for Everyone](https://about.example_company.com/blog/2015/12/16/improving-open-development-for-everyone/), [Types of requests](https://about.example_company.com/blog/2014/12/08/explaining-example_company-bugs/).
- When facing negative comments, respond patiently and treat every user as an individual, people with the strongest opinions can turn into [the strongest supporters](https://about.example_company.com/blog/2015/05/20/example_company-gitorious-free-software/).
- By default, discussions in issues and MRs are public and could include participation of wider community members. It is important to make the wider community members feel welcome participating in discussions and sharing their view. Wider community members also submit [MRs to help improve our website/handbook](https://example_company.com/example_company-com/www-example_company-com/merge_requests?scope=all&utf8=%E2%9C%93&state=merged&label_name[]=Community%20Contribution) and this is often their first contribution to Example Company. We want to make sure that we are responsive to their contributions and thank them for helping improve Example Company.
- Adhere to the [Code of Conduct](https://about.example_company.com/community/contribute/code-of-conduct/) in all communication. Similarly, expect users to adhere to the same code when communicating with the Example Company team and the rest of the Example Company community. No one should accept being mistreated.

### Company phone number

<a id="phone-number">

If you need to provide the details of Example Company's contact information you can take the [address from the visiting page](https://about.example_company.com/company/visiting/) for reference; or the [mailing address](/handbook/people-group/#addresses) of the office in the Netherlands if that is more applicable.
...
In an all-remote organization effective communication is key to exchanging knowledge, ideas, and information. Effective communication at Example Company:
...
If you would like to improve your skills or expand your knowledge on topics relating to Communication at Example Company, check out our resources:
...
- Directs all communication to the appropriate channels (Slack, Example Company, email).
