---
title: Compensation
description: Find answers to your questions about Example Company's compensation framework.
---
...
Team members can access the [calculator](https://comp-calculator.example_company.net/users/sign_in) at any time with their Example Company credentials. Applicants will be given credentials and will be able access the calculator themselves as well, during the application process.
...
## Example Company's Compensation Principles
...
1. We adjust our calculator based on survey data, feedback from applicants and team members, and candidate data. Please email `total-rewards@ example_company` if you want to contribute.
1. We offer [restricted stock units (RSUs)](/handbook/total-rewards/stock-options/) for most positions.
1. We base compensation on current position and performance at Example Company – not on what we paid you last month – and, generally, we don't reduce compensation.
...
1. Example Company will continue to monitor [pay equality](/handbook/people-group/people-success-performance-indicators/#sts=Pay%20Equality) to ensure underrepresented groups are paid at the same rate as the company.
1. We want to follow the processes on this page for everyone, please email `total-rewards@ example_company` when we don't. If you have a specific question around your compensation or one of your direct reports' please schedule a call with `total-rewards@ example_company` to review.
...
1. We offer [bonuses and incentives]({{< ref "incentives" >}}), but we don't offer ping pong tables or free lunches. We think it is more important to offer people flexibility and freedom. See the [Top 10 reasons to work for Example Company on our culture page](/handbook/company/culture/#advantages/).
...
When discussing a competitive rate for a single person at Example Company, please refer to this as their lottery factor. For example, if this person won the lottery and left the company what impact would that have. Other common industry terms are walk away factor or bus factor, but those both hold a negative connotation.
...
It is important to note that where someone falls within the compensation range is *not* an indicator of performance, nor is it a sign of promotional readiness. For more information on how performance is linked to compensation please review the following [handbook section]({{< ref "compensation-review-cycle#performance-factor" >}}). This is *different* from the Compa Groups Example Company used to have when the bands were more narrow. Additionally, where a team member sits in the range may change as Example Company's compensation philosophy around competitive rates iterates to allow more room for salary growth.

### Sharing Compensation

There are no policies in place at Example Company that prevent team members from sharing their personal compensation data, though we encourage that any concern a team member has with compensation be directed directly to your manager or Total Rewards as the most efficient route to address concerns and arrive to a resolution.
...
We also wrote a [blog post about paying local rates](https://about.example_company.com/blog/2019/02/28/why-we-pay-local-rates/).
...
**Note:** The team member must be an active team member of Example Company at the end of the interim role period to be eligible to recive a bonus payment. If a team member leaves Example Company during the interim role period, they will not be eligible for a prorated payment.
...
- Area Sales Manager interim manages an entire Region after an AVP leaves Example Company. AVP base commission rates are 0.3% for Net ARR and $800 per New Logo. During the interim coverage period, the team closes $5M of Net ARR and 4 New Logos. The bonus calculation would be ($5,000,000.00 x 0.003) + (4 x $800.00) = $18,200.00.
...
Example Company is committed to following all applicable wage and working hours laws and regulations. To help ensure that all work performed for Example Company is compensated correctly, team members compensated on the basis of hours worked must [report and record time](/handbook/finance/#timesheets-for-hourly-employees) accurately.

## Sales Compensation

Sales and Sales Development roles at Example Company that are subject to quota and paid commission based on the [Sales Compensation Plan](/handbook/finance/sales-comp-plan/) are not located in the [compensation calculator]({{< ref "compensation-calculator" >}}). This includes roles in the following departments:
...
Executive Compensation (VP and above) is derived outside of the Example Company Compensation Calculator using the following process:
...
1. The Total Rewards team collects survey data to review against current compensation to ensure alignment in cash (base/variable) and equity refresh values.
    - Survey Data from the Example Company peer group: Example Company will analyze the peer group data from Radford against peer group data from Compensia.
...
- In addition, the team member must be actively employed by Example Company at the time of payout.

Example Company reserves the right to change or discontinue the bonus program at any time. All bonus payouts are discretionary and require the achieving of specific company results that will be communicated each year.

[Sales Commissions handbook page](/handbook/sales/commissions/).

### Bonus Payout Approvals

The Compensation Leadership Development Committee approves all bonus payouts for direct reports to the CEO and overall bonus funding at the end of each Fiscal Year. The Compensation Group internally at Example Company approves all other bonus payouts.
...
## Learning Example Company's Compensation Framework
...
Please take time to complete the [Total Rewards Compensation Fundamentals Training](https://levelup.example_company.com/courses/total-rewards-compensation-fundamentals-training) in Level Up.
...
- [Why does Example Company aim to pay a competitive rate?](#competitive-rate)
- [Why does Example Company pay local rates?](#paying-local-rates)
- [Why does Example Company have a Compensation Calculator?]({{< ref "compensation-calculator#the-compensation-calculator" >}})

### The What Questions

- [What is the foundation of Example Company's compensation framework?]({{< ref "compensation-calculator#the-compensation-calculator" >}})
...
You can test your knowledge on our compensation by taking the [Example Company Compensation Knowledge Assessment](https://docs.google.com/forms/d/e/1FAIpQLSe7cf8j9EMk3raWY7nHwSSVSdO0eE7bSHZ8TxSbm-L7hgQvuw/viewform) quiz.
