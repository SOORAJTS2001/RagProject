...
description: Information on Example Company's Global Benefits Survey.
---

## Global Benefits Survey

Example Company has incorporated the annual benefits survey as part of the Engagement Survey from 2021 forward. The Total Rewards team will review the engagement scores relating to Benefits along with market data from our Broker, Willis Towers Watson, to iterate on benefits offerings each year.
...
- Increased Education around benefits as `I understand my benefits package at Example Company` decreased by 7% company wide. Also to increase awareness on the Total Rewards team is who to reach out to since there is company wide score of 3.82 out of 5 (lowest score among ICs). [Related Issue](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/191).
  - Actions taken:
    ...
    - [WIP](https://example_company.com/example_company-com/people-group/peopleops-eng/people-group-engineering/-/issues/206) - Embed the entity-specific benefits calculator under respective [entity benefit pages]({{< ref "general-and-entity-benefits#entity-benefits" >}}).
    ...
    - Updated the [onboarding issue](https://example_company.com/example_company-com/people-group/employment-templates/-/blob/main/.example_company/issue_templates/onboarding.md) to prompt new team members to familiarize themselves on their Total Rewards package and complete the knowledge assessments.
    - Updated the [Becoming a Example Company Manager](https://example_company.com/example_company-com/people-group/Training/-/blob/master/.example_company/issue_templates/becoming-a-example_company-manager.md) issue template to prompt new managers to read the Total Rewards pages and check-in with their team members to ensure they understand their Total Rewards package.
...
- Existing Entity Benefits Review
  ...
  - [Canada Pension Plan](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/110): Received FP&A budgetary pre-approval, review slated to begin in May.
  - [Belgium Benefits](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/263): Received FP&A budgetary pre-approval, review slated to begin in April.
  - [UK Life/Income Protection](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/262): Received FP&A budgetary pre-approval, review slated to begin in April.
  - [Germany Pension Plan](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/264): Received FP&A budgetary pre-approval, review slated to begin in April.
...
1. I understand my benefits package at Example Company.

    | Example Company                 | 2019 Score | 2020 Score | YOY Change |
    |------------------------|------------|------------|------------|
    | Male                     | 4.16       | 3.89       | -7.63%     |
...
1. The general benefits at Example Company are equal to or better than what is offered by similar employers.
...
1. The general benefits at Example Company save me a great deal of time and/or money, and add significant value to my employee experience.
...
1. The wellness offerings at Example Company help me lead a happier, healthier life.
...
1. I believe our benefits package is one of the top reasons people apply to work at Example Company.
...
1. I believe our benefits package is one of the top reasons why people stay at Example Company.
...
1. I believe investing more of the company's money into improving benefits at Example Company will help to attract and retain talent.
...
1. I participated in the Simple Habit free trial and would like to see this benefit offered permanently (survey respondents were instructed to select one).
    ...
    | No, I did not participate, but am interested in Example Company offering a meditation and mental-wellness benefit in addition to Modern Health. | 500   | 64%              |
    | Yes, I participated and do not agree with the statement above.                                                                         | 6     | 1%               |
    | No, I did not participate and am not interested in Example Company offering a mediation and mental-wellness benefit.                            | 258   | 33%              |

1. What corporate social responsibility activities would you like to see Example Company enter? The purpose of corporate social responsibility is to give back to the community, take part in philanthropic causes, and provide positive social value.
   - Summary of Responses:
     ...
     - Donating free licenses and Example Company support/training to charitable organizations.
     - Providing mentorships and internships in support of D&I initiatives.

#### Entity Specific Questions

1. The country-specific benefits provided by Example Company are comparable or better than what is offered by similar employers in my country.

    | Example Company                 | Australia Score | United States Score | Netherlands Score | Canada Score | India Score | United Kingdom Score | Germany Score | New Zealand Score |
    |------------------------|-----------------|---------------------|-------------------|--------------|-------------|----------------------|---------------|-------------------|
...
1. My benefits package provides quality coverage for myself and, if applicable, my dependents.
    ...
    | Example Company                 | United States Score | Canada Score | India Score | United Kingdom Score |
    |------------------------|---------------------|--------------|-------------|----------------------|
...
1. The benefits provided by Safeguard are comparable or better than what is offered by similar employers.
    ...
    | Example Company                 | Ireland Score   | Hungary Score |
    |------------------------|-----------------|---------------|
    | Male                     | 1.54            | 2.67          |
    | Female                 | 1.50            | 1.50          |
...
1. The 401k match is equivalent to or better than what is offered by similar companies.
    ...
    | Example Company                 | United States Score |
    |------------------------|---------------------|
    | Male                     | 2.66                |
    | Female                 | 2.73                |
...
1. The 17% uplift to my salary is sufficient to pay for costs and benefits that would ordinarily be paid for by an employer.
    ...
    | Example Company | Austria Score | Mexico Score | Poland Score | Romania Score | Russian Federation Score | Singapore Score | Turkey Score | Ukraine Score |
    |--------|---------------|--------------|--------------|---------------|--------------------------|-----------------|--------------|---------------|
...
1. Out of the following options, which benefit would you most like to see Example Company offer in the future? (select up to 4)
...
1. Which benefits do you most want Example Company to retain? (select up to 4)
...
- Summary of Other responses:
  ...
  - Not enrolled in Example Company's plan.
...
- Summary of Other responses:
      ...
      - Not on Example Company's policy.
...
1. If Example Company were to convert you to a team member employed through an entity, what benefits would you expect to receive/are offered by most employers in your country? (select all that apply)
...
1. If Example Company were to convert you to a team member employed through an entity, what benefits could Example Company offer that would be considered premium/only a top-tier employer would provide? (select all that apply)
...
Further information and corresponding discussion are available under [Compensation Issue #15](https://example_company.com/example_company-com/people-ops/Compensation/issues/15) (internal).
...
Further information, survey results, and corresponding discussion are available under [Total Rewards Issue #30](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/30) (internal).

### Wellness Program

We researched and selected three vendors and conducted a cost analysis with Finance. At this time, it does not fit into the budget for benefits to be offered for FY21, but will be revisited when we evaluate benefits and budget for the next fiscal year. Further information and corresponding discussion are available under [Total Rewards Issue #37](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/37) (internal).

### SafetyWing

SafetyWing is a global medical benefits provider. At this time we will not be offering this benefit globally as we are focused on entity specific benefits (which many have medical plans already in place) and the ongoing international expansion process (where a team member is converted to an employee of either a PEO or a Example Company Entity). Further information, survey results, and corresponding discussion are available under [Total Rewards Issue #124](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/124) (internal).

### Family Planning

Example Company has reviewed adding more comprehensive family planning benefits. We did a introductory call with a company that provides fertility benefits who advised the company would pay claims out of pocket which integrates better with self funded medical plans. Since we are not yet at the size or stage to be self funded it would currently be difficult to offer this benefit. At the time we are able to be self funded we will reevaluate. Further information and corresponding discussion are available under [Total Rewards Issue #196](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/196) (internal).
