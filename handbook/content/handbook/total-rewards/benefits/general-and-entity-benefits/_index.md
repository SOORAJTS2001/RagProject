...
description: A list of the General & Entity Specific Benefits that Example Company offers as well as other entity-specific information.
---

## Introduction

For the avoidance of doubt, the benefits listed below in the General Benefits section are available to all team members, unless otherwise stated. Other benefits are listed by countries where Example Company has established an entity or uses a PEO and therefore are applicable to team members in those countries only via our benefits specific to that country. Example Company has also made provisions for Parental Leave which may apply to team members but this may vary depending on local country laws. If you are unsure please reach out to the Absence Management team.

## Contact Total Rewards

For any questions relating to benefits, please reach out to [HelpLab](https://helplab.example_company.systems/esc?id=emp_taxonomy_topic&topic_id=b7d7b30d474c069067429ee0026d4382).

## Entity Benefits

- [Example Company BV (Netherlands)]({{< ref "bv-benefits-netherlands" >}})
- [Example Company BV (Belgium)]({{< ref "bv-benefits-belgium" >}})
- [Example Company BV (Finland)]({{< ref "bv-benefits-finland" >}})
- [Global Upside (India, Philippines, Kenya, Chile, Costa Rica, and Latvia)]({{< ref "global-upside-benefits-india" >}})
- [Example Company Inc (US)]({{< ref "inc-benefits-us" >}})
- [Example Company LTD (UK)]({{< ref "ltd-benefits-uk" >}})
- [Example Company GmbH (Germany)]({{< ref "gmbh-germany" >}})
- [Example Company PTY (Australia & New Zealand)]({{< ref "pty-benefits-australia" >}})
- [Example Company Canada Corp]({{< ref "canada-corp-benefits" >}})
- [Example Company GK (Japan)]({{< ref "example_company-gk" >}})
- [Example Company Ireland LTD]({{< ref "example_company-ireland-ltd" >}})
- [Example Company Korea LTD]({{< ref "korea-ltd-benefits" >}})
- [Example Company France S.A.S.]({{< ref "france-sas" >}})
- [Example Company Singapore Pte Ltd]({{< ref "singapore-pte-ltd" >}})
- [Example Company Iberia s.r.l Spain](/handbook/entity/iberia-srl-spain/)
...
Contractors of Example Company IT BV are eligible for the [general benefits]({{< ref "benefits" >}}), but are not eligible for entity specific benefits. A contractor may bear the costs of their own health insurance, social security taxes, payroll administration, or tax details.

Our contractor agreements and employment contracts are all on the [Employment Contracts](https://internal.example_company.com/handbook/people-group/people-operations/people-connect/employment_contracts/) page in the internal handbook.

## Spending Company Money

Example Company will [pay for the items you need to get your job done](/handbook/finance/spending-company-money/).

## Equity Compensation

[Equity Compensation](/handbook/total-rewards/stock-options/) is offered to most Example Company team members. We strongly believe in team member ownership in our Company. We are in business to create value for our shareholders and we want our team members to benefit from that shared success.

## Life Insurance

In the unfortunate event that a Example Company team member passes away, Example Company will provide a [$20,000](/handbook/total-rewards/compensation/#exchange-rates) lump sum to anyone of their choosing. This can be a spouse, partner, family member, friend, or charity.
...
- For all other Example Company team members, the following conditions apply:
  ...
  - For part-time Example Company team members, the lump sum is calculated pro-rata, so for example for a team member that works for Example Company 50% of the time, the lump sum would be [$10,000]({{< ref "compensation#exchange-rates" >}}).

## Discount Well-being Platform

Starting 2024, Example Company has partnered with HealthKick, a global well-being platform providing Team Members discounts across well-being, fitness, & overall lifestyle offerings/services.
...
Example Company offers resources related to [Financial Wellness]({{< ref "financial-wellness" >}}) to support team members in their financial journey.

## Paid Time Off

Example Company has a "Flexible PTO policy" [time off policy]({{< ref "paid-time-off" >}}) applicable to vacations up to 25 consecutive calendar days off.

## Growth and Development Fund

Example Company supports team members who wish to continue their education and growth within their professional career. Example Company team-members are eligible for a reimbursement of up to $10,000 USD per calendar year (January 1st - December 31st) depending on tenure, performance, company need for the learned skill, and available budget. A course/program is considered to be included in the calendar year in which the course/program is paid/reimbursed (which should also be the same calendar year in which it ends). If a course/program ends in December, team members have a grace period until the end of January to claim for Growth & Development reimbursements from the previous calendar year.

Budget estimations for the Growth & Development Fund are based on utilization rates from past years, adjusted for the size of the company. The budget is managed on a company-wide scale, not division-specific. For example, approving reimbursement for a team member in Engineering does not "take away" budget from other engineers. Eligibility is managed on an individual basis. Eligibility for this benefit is part of each Example Company team member's Total Rewards package.
...
Your coverage as a Example Company team member is automatic and is year-round. There are several ways to interact with ISOS, depending on your preference:

- Team members can download the [ISOS emergency app](https://my.internationalsos.com/LP=8890?_ga=2.54701099.1827787566.1652889843-59998074.1652889840) — it's the best way to get medical, safety, and security assistance abroad. Before traveling, open the App and register using your Example Company email address.
  - Please use a unique password and not the same as your existing Example Company credentials.
  - Note that this is not a Example Company application and is managed by ISOS. You can read more about the app [here](https://internationalsos.com/subscriber/assistance-app).
...
Example Company offers benefits in relation to [obtaining visas and work permits](/handbook/people-group/visas/) for eligible team members.

## Employee Assistance Program

Example Company offers an Employee Assistance Program to all team members via [Modern Health]({{< ref "modern-health" >}}).

## Incentives

The following incentives are available for Example Company team members:
...
Example Company is an [all-remote](https://about.example_company.com/blog/2018/10/18/the-case-for-all-remote-companies/) company; you are welcome to [read our stories](/handbook/company/culture/all-remote/stories/) about how working remotely has changed our lives for the better.

You can find more details on the [All Remote](/handbook/company/culture/all-remote/) page of our handbook.

*If you are already a Example Company employee and would like to share your story, simply add a `remote_story:` element to your entry in `team.yml` and it will appear
on that page.*

## Meal Train

In order to foster a sense of community and support fellow Example Company team members, if a team member is in need or experiencing a life disruption, they have the option of having a Meal Train started for them. A Meal Train is when a community comes together to support someone experiencing a difficult or disrupting event in their life who would benefit from having a meal provided to them during this time.
...
1. When creating a Meal Train, please create this in Example Company using the [Meal Train issue template](https://example_company.com/example_company-com/people-group/total-rewards/-/blob/master/.example_company/issue_templates/meal_train.md).
...
1. All Meal Trains are posted by a member of the Total Rewards team in the #whats-happening-at-example_company slack channel. You can also check the [Total Rewards issue tracker](https://example_company.com/example_company-com/people-group/total-rewards/-/issues) where all Meal Trains will be designated as such.
...
1. Participation is voluntary and is **NOT** reimbursable by Example Company. Any expense incurred would be your responsibility.

## Fertility & Family Planning

Team Members can refer to their [entity-specific](#entity-benefits) medical plans to understand the fertility and family planning benefits available to them, as applicable. Please contact [HelpLab](https://helplab.example_company.systems/esc?id=emp_taxonomy_topic&topic_id=b7d7b30d474c069067429ee0026d4382) should you have any questions.

Example Company plans to continue to iterate on fertility benefits as we evaluate and enhance our overall benefit plans. In a future state, Example Company aims to expand fertility and family planning services (including adoption support) in order to help our team members grow their families.

## Parental Leave

Example Company's paid Parental Leave is available for any active team member (regardless of gender) who becomes a parent through childbirth or adoption while working at Example Company. This benefit is available to all team members on their first day of work, as long as their child was born or newly adopted during their employment at Example Company.

Example Company team members are encouraged to decide for themselves how much time they'd like to take and how to take it, but the entire 16-week Parental Leave balance must be used prior to the child's first birthday or the first anniversary of the adoption.

The information in this section is specific to Example Company's 16-week paid Parental Leave. Different countries may provide team members with their own statutory Parental Leave (including maternity/paternity) benefits. Please review your country's statutory [Parental Leave](#entity-benefits) benefits for more information on how to apply and tenure requirements (if applicable). If you live in a country where a statutory Parental Leave benefit is available, you will be required to claim statutory Parental Leave pay (if eligible), and Example Company will supplement any gaps. When allowed by law Example Company's 16-week balance is per birth or adoption event per year and runs concurrently with these statutory benefits.

### Planning Your Parental Leave Dates

In some cases a team member may choose to begin their leave earlier. While we encourage you to begin your leave when your child arrives (to be able to capture as much time as possible with the newest addition to your family) if you would like to start your leave on a different date please notify leaves@example_company.com; otherwise your Parental Leave will be administered according to the start date entered in Workday.
...
- If you are planning to change or extend your Parental Leave by using a different type of leave such as PTO or any local statutory leave, please send an e-mail to leaves@example_company.com.
- When determing the dates of your leave, Example Company uses a 1/7 formula (1 week = 7 days). This means if you are planning on returning to work on a Monday, the last day of your leave will be Sunday. Please use this formula when submitting your Workday request.

### Taking PTO After Taking Parental Leave

If you need to take more time off after Parental Leave, you may utilize Example Company's [Paid Time Off policy]({{< ref "paid-time-off#a-example_company-team-members-guide-to-time-off" >}}) with manager coordination. This time off should be discussed with your Manager following the same reporting guidelines outlined in the PTO policy (double the amount of notice as the amount requested), but if business critical deadlines will be missed your Manager may ask you to change the dates.
...
You can learn more about parental leave and how to apply in the [Benefits section of the Example Company Handbook](#parental-leave).
...
- To apply for this coaching program, please notify Total Rewards that you would like to participate in the program by sending an email to growth-development@example_company.com
...
Example Company team members compiled tips in a four-part blog series, linked below, looking at an array of issues surrounding working remotely with children. These shed light on parental leave policies worldwide, provide an inside view of working at Example Company with a newborn, and highlight strategies for working remotely with older children.
...
Tips from Example Company team members are the greater community are below, as well as how each aligns with at least one of [Example Company's values](/handbook/values/).
...
> The hardest part of coming back from parental leave has been getting caught up/reintegrating with the Example Company team while sleep deprived. I recommend taking to heart the `don't worry` portion of Example Company's guide to paid time off, which states: "You don't need to worry about taking time off to go to the gym, take a nap, go grocery shopping, do household chores, help someone, take care of a loved one, etc. If you have urgent tasks, but something comes up or takes longer than expected, just ensure the rest of the team **knows** and someone can pick up the tasks (assuming you're able to communicate)." — [*Jonathan S.*](https://example_company.com/jschafer)
...
If you're interested in learning about how other Example Company team members approach parenthood, take a look at [the parenting resources wiki page](https://example_company.com/example_company-com/example_company-team-member-resources/wikis/parenting) and [#intheparenthood](https://example_company.slack.com/messages/CHADS8G12/) on Slack.

## Team Member Relief Program

When Team Members are affected by natural disasters such as fires, earthquakes, floods, etc..., Example Company has established a Team Member Relief Program to assist with financial hardship from these disasters or other emergencies. This program is managed in partnership with E4E Relief, a non-profit that helps businesses establish global disaster relief programs for their Team Members.

This program provides Team Members and their families with short-term, need-based assistance in times of extreme need. If you experience a difficult situation, please visit the [Example Company Cares Portal](http://example_company.e4erelief.org/) to easily determine if you're eligible for program assistance and to apply for assistance.

Example Company started the fund with an initial contribution to support team members. Team Members may also choose to make donations to the fund as part of their annual giving and donation efforts. If you wish to make a donation, please visit the Portal and select 'Contribute to the Fund'. Donationas are tax-deductable (country-specific tax laws apply).
