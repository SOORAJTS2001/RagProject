---
title: "Example Company LTD (UK) Benefits"
description: "Example Company LTD (UK) benefits specific to UK based team members."
---

Can't find what you're looking for? Try the main [People Operations page](/handbook/people-group/).

For any queries related to UK benefits, please reach out to [HelpLab](https://helplab.example_company.systems/esc?id=emp_taxonomy_topic&topic_id=b7d7b30d474c069067429ee0026d4382) for further assistance.

## Medical Insurance

For UK-based team members, Example Company provides 100% paid membership of medical insurance with AXA PPP. This private medical insurance level is named Business Health Select with core cover. Family members can be added to the insurance and Example Company will pay 66% of the cost to include them.
Please note: team members enrolled will still be responsible for the BIK ("Benefits in-Kind") taxes on their healthcare coverage. If you have questions on your BIK taxes, please reach out via [HelpLab](https://helplab.example_company.systems/esc?id=emp_taxonomy_topic&topic_id=b7d7b30d474c069067429ee0026d4382).
...
Please let the Total Rewards team know if you would like to join the scheme via email to `total-rewards@example_company.com` and `Lisa.Holland@wtwco.com`  Include the following details:
...
For claims assistance, please contact [HelpLab](https://helplab.example_company.systems/esc?id=emp_taxonomy_topic&topic_id=b7d7b30d474c069067429ee0026d4382). While we are unable to take over the claims process on behalf of the team member, our broker can assist in reaching out to AXA to escalate.
...
| Tier                     | Total| Example Company's Cover <br> Benefit in Kind Value  | Team Member Cost <br> 34% of Dependent Cost  |
|--------------------------|:---:|:----:|:----:|
...
As Example Company team members work (DSE) display screens equipment on a regular basis, Example Company will reimburse team members for a full eye examination and vision test up to 30 GBP.

If the test shows that the team member needs corrective lenses exclusively for DSE work, Example Company will reimburse towards the cost of a basic pair of frames and lenses (i.e. not designer lenses) up to 120 GBP.
...
Life Insurance provides peace of mind for you and your loved ones with a tax-free lump sum payout in the event of your untimely death, helping to relieve financial concern during a time of grief. Example Company offers Life Insurance via Unum to all team members between age 16 and State Pension Age.
...
Example Company provides and contributes into an Auto-Enrollment personal pension scheme with [Scottish Widows](http://www.scottishwidows.co.uk/retirement/retirement-explained/basics/auto-enrolment/)

Willis Towers Watson act as employee benefit advisers to the Example Company GPPP and although cannot provide you with financial advice are available to explain the details of the Example Company GPPP and answer any questions you may have.
...
- How do I opt in or out or make changes to my salary sacrifice amount?
  - Team Members who have signed a UK Employment contract after 13 December 2022 will be automatically enrolled in to Company Pension Scheme via Salary Exchange. Please note that if you signed your contract prior to 13 December 2022 will have to request to opt in to the Salary Sacrifice Scheme. Email total-rewards@example_company.com and nonuspayroll@example_company.com with the new percentage of your salary that you would like to sacrifice or to opt in/out of the salary sacrifice provision.

### Auto-Enrollment

Auto-enrollment is a scheme brought in by the Government as they want everyone to save more for their retirement. Employees will receive a letter from Example Company informing them when they have been auto enrolled in the scheme. As this is now law, employees will be auto enrolled into the Example Company UK Group Personal Pension Scheme from January 1, 2018 or as soon as they join the company if:
...
- **Entitled workers** must be offered the opportunity to join the pension scheme. They can make contributions to the pension scheme if they choose. However, there is no requirement for Example Company to make a contribution
...
The following process is followed by Example Company People Operations to join the Scheme during onboarding:
...
- This is a personal pension which means it can be taken with the employee if they leave Example Company
...
- From April 6, 2019 to a minimum of:
  ...
  - Example Company:   4% of basic salary
...
Should the government's minimum contribution standards change further Example Company will contact you to advise the new levels to comply with legislation.
...
- **If you don't opt out by this date**, you can stop contributing at any time, in accordance with the pension scheme rules. If you do this, both your contributions and Example Company's, up to that point, will remain invested in your pension pot until you take your benefits.
- You can opt-out by completing the Scottish Widows [Opt-out form for Group Pension Scheme](https://drive.google.com/file/d/1FDCXW2qa3pniHIbkJ4vSkK-C_KGmLiNa/view?usp=sharing). The form must be completed, then returned to Total Rewards at total-rewards@example_company.com
- The pension provider will also be able to tell you when the one month opt-out period started, if you aren't sure.
- An opt-out from the pension scheme normally lasts for **three years**. If you've opted out, or stopped contributions to the scheme, Example Company is required to automatically enroll you into the scheme at a later date (normally every three years).
...
You can also reach out to Willis Tower Watson to explain the details of the Example Company GPPP and answer any questions you may have.
...
Example Company uses TravelHub to assist with the administration of the bike to work/tax saver commuter scheme. The Example Company specific online portal can be found at [Example Company Travel Hub](https://example_company.biketowork.co.uk/). Team members will need to register and account to enter the Example Company specific online portal.
...
## Example Company LTD United Kingdom Leave Policy

### Sick Leave

Team members are entitled to Statutory Sick Pay ("SSP")for up to 28 weeks, to be paid by Example Company. SSP is paid when a team member is sick for at least 4 days in a row (including non-working days); however, team members are not entitled to SSP for the first three "waiting" days.

- A team member who is out sick for at least four days, but no more than 7 days will need to complete a [Company Self-Certification Form](https://docs.google.com/document/d/1Cy-xUgWwNKroUEEJ0ut80HGVA0d3RJV5mQO-amLjoCs/edit?usp=sharing) and return it to leaves@example_company.com.
- Team members who will be out sick for more than 7 days must provide a [fit note](https://www.gov.uk/taking-sick-leave) and notify the Absence Management team at `leaves@example_company.com` as soon as possible.
...
- Sick Leave runs concurrently with Example Company PTO. Team members must designate any time off for illness as `Out Sick` in Workday to ensure that annual sick leave entitlement is properly tracked.  Example Company PTO is inclusive of any entitlement in respect of statutory sick pay.
...
**Note:** Example Company offers up to 16 weeks of paid [general parental leave benefit]({{< ref "general-and-entity-benefits#parental-leave" >}}) where, if eligible, statutory pay is supplemented up to 100% regular salary.
...
- Team members must notify the Absence Management team at `leaves@example_company.com` within 28 days if the date of placement (or UK arrival date for overseas adoptions) changes.
...
- Eligibility:
  - Team members must have continuous employment with Example Company for at least 26 weeks leading up to the "qualifying week" (15th week before the expected week of childbirth).
...
- Send the Absence Management team at `leaves@example_company.com` a completed [MATB1 Certificate](https://www.gov.uk/government/publications/maternity-certificate-mat-b1-guidance-for-health-professionals/maternity-certificate-form-mat-b1-guidance-on-completion) no later than 21 days before your leave start date.
...
- Eligibility:
  - Team members must have been continuously employed with Example Company for at least 26 weeks leading up to the "qualifying week" (15th week before the baby is due or the matching week if adopting).
- Eligible team members are entitled to:
...
- Eligibility:
  - Team members must have had continuous employment with Example Company for at least 26 weeks leading up to the week they were matched with the child.
- Eligible team members are entitled to:
...
- Team members who have been employed with Example Company for more than one year are eligible for up to 18 weeks of unpaid leave to look after their child's welfare.
...
The following leave types run concurrently with Example Company PTO. Team members should initiate leave by selecting the appropriate option in `Workday`. If none applies, the team members should notify their manager and the Absence Management team `leaves@example_company.com` to initiate leave.
