...
description: A summary of Financial Wellness resources available to team members at Example Company.
---

## Introduction

Example Company has generated this handbook page to provide resources to team members relating to Financial Wellness. Please note that Example Company is not able to directly provide team members with any financial advice.
...
[Modern Health]({{< ref "modern-health" >}}) offers many self service resources to team members as part of the Employee Assistance benefit through Example Company.
...
- [**Modern Health Money Management Circle:**](#modern-health) Example Company hosted a **Money Management Circle** through Modern Health with an emphasis on the psychological component of Financial Wellness. **Link to [Recording](https://www.youtube.com/watch?v=YhoHMT94Mkg)**
...
Example Company offers all team members the ability to use the Financial Wellness Program through SageView. This program includes:

- 1:1 sessions for all Example Company team members globally to connect with a dedicated Wellness Specialist to discuss topics such as Investment Assets (including Stock Options), Asset Protection, Income Protection, Debt Management, and Estate Planning.
  - The main goal here is the commitment to help understanding how the Example Company equity plan works, and providing resources in what team members can consider in financial management. SageView won't provide tax, legal, or financial advice, but can help you to understand the pieces of information you will need to seek personal advise on to manage your own personal situation.
...
Example Company hosted a kickoff call with SageView to discuss an overview of the program's benefit offerings for team members.
...
Schwab can also assist with investment support as a complimentary service through Example Company.
...
- You can either select the linked document name to open a quick view of the Total Rewards Summary in Workday or select the download button that appears to the right of the letter. If you are a manager and are unable to see the Documents tab for your team member, please reach out to `total-rewards@ example_company` and we will review your access level.
...
- It's important for all team members to understand and consider all components of the Total Rewards Package. One key component being the value of our equity program (Options, RSU's & ESPP) as core to our Total Rewards (benefits, cash compensation, equity) at Example Company.
- Equity aligns team members with a long term incentive for the company. By delivering results, Example Company has the ability to contribute to company performance and drive long-term potential value.
...
- Example Company has recently adjusted the cliff for the RSU program by implementing an industry leading six month cliff for new hire grants and no cliff for promotion or refresh grants.
- Close by checking in on how your team member is doing beyond their financial position. A quick and simple method is to use  the "red, yellow, green" scale to ask your team members how they are feeling about their future at Example Company. The goal is to gain actionable feedback about how you can support them going forward.
...
- Remember, financial incentives are only one aspect of what keeps our team members excited about their role at Example Company. Career opportunity and ability to make meaningful contributions were highlighted as the 2 highest areas of impact for our team members during our last Engagement Survey. Take this opportunity to have a holistic conversation about your team members' future at Example Company in terms of their career and financial growth opportunity. Remember, we're only at Mile 3 of the marathon.
