---
title: "Example Company Ireland Ltd"
description: "Discover Example Company's benefits for team members in Ireland"
---

## Medical

Example Company offers a private medical plan through VHI which gives you access to cutting-edge medical treatments, health screenings and protection against the high medical costs of private care. Example Company covers 100% of the premiums for team members and eligible dependents.
...
Dependents eligible for the Example Company Medical subsidy are Spouse or Domestic Partner, and Children.
...
Example Company's VHI scheme will renew November 1. You can choose to enroll from this date or
...
When enrolling please enter your Example Company Employee ID as your "Employee Number" and
your Example Company Department listed in Workday as your "Cost Centre".

Example Company has selected [Company Plan Plus Level 1.3](https://www.vhi.ie/pdf/myvhi/TOBCPPL1.3%20V3901%20May23.pdf) company wide. If you feel that
...
Team members in Ireland are entitled to regular eye and eyesight exams under the [Safety, Health, and Welfare at Work Regulations 2007](https://www.irishstatutebook.ie/eli/2007/si/299/made/en/print#partii-chapv). Example Company will reimburse team members for the cost of the exams. If an eye exam determines that a team member needs glasses solely and exclusively for VDU (visual display unit i.e. computer screen) use, Example Company will reimburse towards the cost of a basic pair of frames and lenses (i.e. not designer frames) up to 140 Euro.
...
Example Company offers a private pension plan via a defined contribution scheme. Orca Financial is an Irish owned Financial Services company to help with the administration of the pension on behalf of Example Company. The pension provider is **Aviva**. Aviva allows for transfers into the plan and can set up an AVC pension for any members that wish to contribute above the minimum required contribution.
...
All full-time Example Company team members are eligible for disability cover in the amount of 66% of base salary less social welfare to age 65 (after 13 weeks deferred period). This benefit is administered through Aviva.

Please find the following documentation to assist you with the disability claim, and notify Total-Rewards@example_company.com should you need to file a claim.
...
## Example Company Ireland LTD Leave Policy
...
Ireland's statutory sick leave policy offers a floor level of protection and does not interfere with existing, more favorable, sick pay schemes such as Example Company's [Sick Time policy]({{< ref "paid-time-off#sick-time---taking-and-reporting" >}}). When allowed by law, Example Company's Sick Leave policy will run concurrently with this leave policy.

#### Statutory Sick Leave Pay Calculations

Example Company will be required to pay a minimum of 70% of an team member's gross wage, subject to a daily cap of €110, but will continue the team member's salary up to 100%. Team members must identify the absence as sickness-related (and comply with the notification requirements below) in order to receive the SSP.
...
- Worked for Example Company for more than 13 continuous weeks, and
...
#### Example Company Parental Leave Payment

- For team members who are eligible for Example Company Parental Leave and are eligible to receive State Maternity/Adoptive/Paternity/Parent's benefit from the Department of Social Protection (DSP), Example Company will supplement their pay so that they receive 100% of their salary for up to a total of 16 weeks of leave taken in the first year after the birth/adoption event. The 16-week balance is per birth or adoption event.
- If a team member is eligible for Example Company Parental Leave, but ineligible for State Maternity/Adoptive/Paternity/Parent's benefit from the DSP, they will receive 100% of their pay from Example Company for up to a total of 16 weeks of leave taken in the first year after the birth/adoption event. The 16-week balance is per birth or adoption event.
...
- To apply for State Maternity Benefit, please notify leaves@example_company.com of the start and end date of your leave.
...
- You may be eligible to receive State [Adoptive Benefit](https://www.citizensinformation.ie/en/social_welfare/social_welfare_payments/social_welfare_payments_to_families_and_children/adoptive_benefit.html) at €250 per week for up to 24 weeks subject to your PRSI contributions.
  - Effective 2023 the PRSI contributions will increase to €262/week.
- To apply for State Adoptive Benefit, please notify leaves@example_company.com of the start and end date of your leave.
...
- You may be eligible to receive State [Paternity Benefit](https://www.citizensinformation.ie/en/social_welfare/social_welfare_payments/social_welfare_payments_to_families_and_children/paternity_benefit.html#:~:text=Paternity%20Benefit%20is%20a%20payment,or%20after%201%20September%202016) at 250 EUR per week for up to 2 weeks subject to your PRSI contributions.
  - Effective 2023 the PRSI contributions will increase to €262/week.
- To apply for State Paternity Benefit, please notify leaves@example_company.com of your child's due date.
...
- Parent's Leave runs concurrently with [Example Company Parental Leave]({{< ref "general-and-entity-benefits#parental-leave" >}}).
...
To initiate your leave, submit your time off by selecting the `Parental Leave` category in Workday at least 30 days before your leave starts and contact total-rewards@example_company.com. Please familiarize yourself with [Example Company's Parental Leave policy]({{< ref "general-and-entity-benefits#parental-leave" >}}).
...
- You must submit written notice to the Absence Management team at `leaves@example_company.com` of your intention to take Carer's Leave at least 6 weeks before the leave begins. Written notice must include the following details:
...
- Once Carer's Leave has been approved, at least two weeks before the start of leave, the team member must complete a [confirmation document](https://docs.google.com/document/d/1uQ6EldAAxS0gvr9bQ7SXkrsWVh-Yccs5M9HZgvZMRMc/edit?usp=sharing). Example Company will retain a copy, and provide the team member with a copy.
...
- Carer's Leave runs concurrently with Example Company's Sick time policy. If you receive Carer's Benefit or Carer's Allowance from DSP, Example Company will supplement your payment so that you receive 100% of your salary for the first 25 working days.
...
- This leave runs concurrently with Example Company PTO.

**Jury Service**

- Team members are entitled to paid time off to attend jury selection/jury duty. This leave runs concurrently with Example Company PTO. Team members must select `Jury Duty` in Workday to ensure that statutory entitlements are properly tracked.
