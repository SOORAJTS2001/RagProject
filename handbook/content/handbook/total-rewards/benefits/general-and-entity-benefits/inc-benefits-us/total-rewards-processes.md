...
- Total Rewards will then email a detailed breakdown of the amount/department totals to `ap@example_company.com` for accounting purposes.
...
For example'Fed-FT-Colorado' would be the correct option for a Example Company Federal Team Member living in Colorado.
