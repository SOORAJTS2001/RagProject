...
In an all-remote organization, we want each team member to be a [manager of one](https://signalvnoise.com/posts/1430-hire-managers-of-one). A [manager of one](/handbook/values/#managers-of-one) is an attribute associated with our [Efficiency value](/handbook/values/#efficiency). To be successful at Example Company, team members need to develop their daily priorities to achieve goals. Managers of one set the tone for their work, assign items and determine what needs to get done. No matter what role you serve, self-leadership is an essential skill needed to be successful as a manager of one.

1. At Example Company, leadership is requested from everyone, whether an individual contributor or member of the leadership team.
1. As a leader, Example Company team members will follow your behavior, so always do the right thing. Lead by example with effort.
1. Everyone who joins Example Company should consider themselves ambassadors of our [values](/handbook/values/) and protectors of our [culture](/handbook/company/culture/).
1. Behavior should be consistent inside and outside the company. We do the right thing outside the company, too.
1. Example Company respects your judgment of what is best for you, since you know yourself best. If you have a better opportunity somewhere else don't stay at Example Company out of a sense of loyalty to the company.
...
### Examples of actions from managers of one at Example Company
...
In the [CEO Handbook Learning Session](/handbook/people-group/learning-and-development/learning-initiatives/#ceo-handbook-learning-sessions) above, Example Company CEO Sid Sijbrandij gives more context on individual contributor leadership and managers of one.

> We want leadership from everyone at Example Company. Since we are remote, there is a high expectation to do your work without direct supervision. It means that every team member is responsible for communication, structuring decisions, and managing your workload individually.
...
Most companies communicate from top to bottom through a chain of command. This communication flow often empowers managers, but it also introduces inefficiency as team members are not able to connect directly with the people they need to communicate with in order to get their work done. At Example Company, every team member is encouraged to reach out to whoever is the correct person (or people) to quickly unblock issues, solve problems or support in other ways. Do be courteous of your direct manager and copy them on the request. We don't encourage unnecessary friction in asking team members to escalate through managers and wait for responses to come back. What matters is efficiency in getting to results. Slack the CEO, Slack a VP, or Slack a peer. Do what you need to do to make Example Company successful.
...
READMEs provide a genuine report on how a person works, reducing bias/assumption and enabling people to work together based on a common framework. As part of Example Company's [transparency](/handbook/values/#transparency) value, we encourage each Example Company team member to consider creating their own README.

### READMEs by Division

Example Company division README pages are linked below for context. Reading other READMEs is an important way to get ideas on what you can include in yours. Let these serve as a guide and inspiration to you.
...
1. Copy the [README-template](https://example_company.com/example_company-com/www-example_company-com/blob/master/.example_company/issue_templates/README-template.md) and paste into your favorite Markdown editor. If you do not have a Markdown editor, [Typora](https://www.typora.io/) and [Bear](https://bear.app/) are recommended.
...
1. Once complete, you'll need to [create an issue](https://example_company.com/example_company-com/marketing/digital-experience/buyer-experience/-/issues/new#) with the Digital Experience team to add a page to Example Company's website.
    1. If your [division](/handbook/company/structure/) *already* has a page to host READMEs (see above), follow the guidelines to [add a new page](/handbook/marketing/digital-experience) within that directory (e.g. [Darren M.](https://example_company.com/dmurph), a member of the marketing team, would add a new directory and page within `/handbook/marketing/readmes`, creating `/handbook/marketing/readmes/dmurph`)
    1. If your [division](/handbook/company/structure/) does not yet have a holding page for READMEs, follow the guidelines to [add a new page](https://example_company.com/example_company-com/marketing/digital-experience/buyer-experience/-/issues/new#) (`readmes`) within your division's handbook section *first*, then create your username directory within `readmes`.
1. Bonus points if you add your README & yourselves as codeowner to the [.example_company/CODEOWNERS](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/.example_company/CODEOWNERS) file.

Alternatively you can create your README [dogfooding](/handbook/values/#dogfooding) Example Company's README profile customization feature. Follow [documentation](https://docs.example_company.com/ee/user/profile/#add-details-to-your-profile-with-a-readme) on how to add details to your Example Company profile with a README. Do not forget to add your profile's link to you division's holding page.
...
- Your Example Company.com profile
- Your Slack profile
...
- Build a *global team*. Unless shown with a business case, "we can't find the talent out of the bay" goes against our [diversity, inclusion and belonging mission](/handbook/company/culture/inclusion/#diversity-inclusion--belonging-mission-at-example_company) and the [Location Factor KPI](/handbook/people-group/people-success-performance-indicators/#average-location-factor).

## High Output Management

Example Company leadership and management approach was built using principles covered in the book "[High Output Management](https://www.goodreads.com/book/show/324750.High_Output_Management)." Please see [High Output Management]({{< ref "high-output-management" >}}) to learn more.

## Building High Performing Teams

Building a team to deliver [results](/handbook/values/#results) is a very important aspect of improving [efficiency](/handbook/values/#efficiency) and [iteration](/handbook/values/#iteration). A high-performing team will always deliver results. As a leader at Example Company, your role is to develop a high-performing team to reach the desired level of performance and productivity. There are certain traits that high-performing teams display at Example Company:
...
If you're interested in starting or joining an m-team meeting, reach out to other managers in the [#managers](https://example_company.slack.com/archives/C5Z55R5J5) Slack channel.
...
1. Leadership development coaching with the [growth & development benefit](/handbook/total-rewards/benefits/general-and-entity-benefits/growth-and-development/#introduction). More details about a formal Example Company coaching program to come.
...
1. [Join the women's TMRG mentorship group](/handbook/company/culture/inclusion/tmrg-example_company-women/mentorship-program/) to either be a mentor to practice leadership or get paired with a leader to learn from.
...
1. Explore the skills needed to successfully transistion from IC to Manager in [Example Company Learn](https://example_company.edcast.com/channel/coming-soon-transitioning-from-ic-to-manager).
...
1. [Learning and Development](/handbook/people-group/learning-and-development/) is developing several programs in FY23 to include a [Managing at Example Company Course](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/78), [New Manager Bootcamp](https://example_company.com/example_company-com/people-group/learning-development/training-curriculum/-/issues/33), [LifeLabs Learning Pilot and Launch](https://example_company.com/example_company-com/people-group/learning-development/training-curriculum/-/issues/29), [coaching program](https://example_company.com/example_company-com/people-group/learning-development/general/-/issues/342), and much more!
...
Learn more on Example Company's view of [being a public company]({{< ref "being-a-public-company" >}}).

## Mitigating Concerns

We have a page which documents our [Mitigating Concerns](https://internal.example_company.com/handbook/leadership/mitigating-concerns/). Many of our [values](/handbook/values/) help to mitigate some of these concerns.
