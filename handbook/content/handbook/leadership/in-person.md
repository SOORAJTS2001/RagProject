...
This page is an `onsite` planning resource for people managers at Example Company. Use these suggestions to guide the way you plan in-person time for your team. Our additional [considerations for in person time](/handbook/company/culture/all-remote/in-person/) advise the wider Example Company community on how to make the most of time spent at conferences, in person meetings, and other types of meetups.
...
The Example Company Talent Engagement team is here to support your onsite planning. We can help you plan activities and make suggestions on how you can best spend this time together in person. To request this custom support, please [open an issue here using the `onsite-support` template](https://example_company.com/example_company-com/people-group/learning-development/custom-ld-engagement/-/issues/new).
...
1. **Plan in advance:** Some functions and roles at Example Company are accustomed to work travel - others are not. Give time to plan and organize scheules to maximize attendance and presence.
...
The all-remote structure at Example Company is efficient and collaborative. It works really well for problem solving, independent work, and all forms of collaboration - not to mention things like getting up to date on Example Company to-dos and Slack messages.
...
Design thinking directly supports our Example Company values of Results, Collaboration, and  Efficiency. We balance being [ambitious](/handbook/values/#ambitious) along with a focus on [boring solutions]({{< ref "#boring-solutions" >}}) - both of which are solutions-oriented.
