...
In line with our [Collaboration](/handbook/values/#collaboration) value, **Turn & Share** sessions are a way for us to share our work with other analysts (or anyone at Example Company who is interested). These sessions began in October of 2023. More details on these sessions are outlined below:

**Overall Goal**: Encourage each of the analytic teams at Example Company to reach out to each other for data resources and ideas on how to solve reporting, statistical, and data science problems of various complexity levels.
...
- Open an issue in our [Functional Analytics Center of Excellence](https://example_company.com/example_company-data/functional-analytics-center-of-excellence/) project
