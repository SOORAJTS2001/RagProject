...
[Permifrost Project](https://example_company.com/example_company-data/permifrost/)
...
* For any additional question, contribution or ide, feel free to open a [**new issue**](https://example_company.com/example_company-data/permifrost/-/issues/new) in the Permifrost project and, if needed, tag `@example_company-data/permifrost_maintainers` _(the project maintainers)_
...
The release process is described in the template [Release process for Permifrost](https://example_company.com/example_company-data/permifrost/-/blob/master/RELEASE.md) with using [Release Permifrost](https://example_company.com/example_company-data/permifrost/-/blob/master/.example_company/issue_templates/Releasing%20update.md) template. For real life example, use [Release `0.15.1`](https://example_company.com/example_company-data/permifrost/-/issues/175) as a template.
...
Permifrost uses tags to create its artifacts. Pushing a new tag to the repository will publish it as docker images and a `PyPI` package. For details, refer to the [Release guideline](https://example_company.com/example_company-data/permifrost/-/blob/master/.example_company/issue_templates/Releasing%20update.md).
