...
|-------------------------------------------------------------------------------------------------------------------|----------------|--------------------------------------------------------------------|-----------|-----------------------|
| [analytics](https://example_company.com/example_company-data/analytics/-/blob/master)                                               | `3.10`         | `N\A`                                                              | `TBA`     | `Data Platform`       |
| [airflow-image](https://example_company.com/example_company-data/airflow-image/-/blob/main/src/Dockerfile?ref_type=heads)           | `3.8`          | `python:3.8`                                                       | `TBA`     | `Data Platform`       |
| [analyst-image](https://example_company.com/example_company-data/analyst-image/-/blob/main/src/Dockerfile?ref_type=heads)           | `3.8.8`        | `jupyter/tensorflow-notebook:python-3.8.8`                         | `TBA`     | `Analytics Engineers` |
| [ci-pyhton-image](https://example_company.com/example_company-data/ci-python-image/-/blob/main/src/Dockerfile) | `3.8`          | `python:3.8-slim-buster`                                           | `TBA`     | `Data Platform`       |
| [data-image](https://example_company.com/example_company-data/data-image/-/blob/master/data_image/Dockerfile?ref_type=heads)        | `3.10.3`          | `python:3.10.3`                                                       | `TBA`     | `Data Platform`       |
| [data-science](https://example_company.com/example_company-data/data-science/-/blob/main/docker-compose.yml?ref_type=heads)         | `3.8.8`        | `registry.example_company.com/example_company-data/data-image/analyst-image:v0.0.19` | `TBA`     | `Data Scientists`     |
| [dbt-image](https://example_company.com/example_company-data/dbt-image/-/blob/main/src/Dockerfile)             | `3.10.3`       | `python:3.10.3`                                                    | `TBA`     | `Data Platform`       |
| [example_company-data-meltano](https://example_company.com/example_company-data/example_company-data-meltano/-/blob/main/Dockerfile?ref_type=heads)   | `3.8`          | `meltano/meltano:v2.16.1-python3.8`                                | `TBA`     | `Data Platform`       |
| [mlfow-infra](https://example_company.com/example_company-data/mlflow-infra/-/blob/main/mlflow_image/Dockerfile?ref_type=heads)     | `3.8`          | `python:3.8`                                                       | `TBA`     | `Data Scientists`     |
...
flowchart LR
    ...
    pip --> dbt-image
    pip --> mlfow-infra
    pip --> example_company-data-meltano
    pip --> permifrost

    data-image      --Inherit--> example_company-data-utils
    ...
    subgraph Images
        ...
        data-science
        dbt-image
        example_company-data-utils
        mlfow-infra
        example_company-data-meltano
        permifrost
    end
...
> **Table 2:** List of tools Example Company Data team is using

| Tool name                                                                                                   | Version in use | Version supported timeline                                                                                                                                                                                                                                                                         | How to upgrade   | DRI       | Users                                                               | Upgrade Policy |
|-------------------------------------------------------------------------------------------------------------|----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|-----------|---------------------------------------------------------------------| ------------ |
| [dbt](/handbook/enterprise-data/platform/dbt-guide/)                  | `1.8.0`        | [link](https://docs.getdbt.com/docs/dbt-versions/core#latest-releases)| - [dbt best practices for upgrading](https://docs.getdbt.com/docs/dbt-versions/core#best-practices-for-upgrading)<br>- [Upgrading dbt version](https://example_company.com/example_company-data/runbooks/-/blob/main/infrastructure/upgrading_dbt_version.md)  | `TBA`     | - `Data Platform`<br>- `Analytics Engineers`<br>- `Data Scientists` | Not more than 2 versions behind (beta release excluded) and minimum support level `critical` |
| [airflow](/handbook/enterprise-data/platform/infrastructure/#airflow) | `2.5.3`        | [link](https://airflow.apache.org/docs/apache-airflow/stable/installation/supported-versions.html#version-life-cycle) | [Upgrade Plan for Airflow](https://example_company.com/example_company-data/analytics/-/issues/11804)                                                                                                                                                          | `TBA`     | `Data Platform`                                                     | Current version released > 1 year |
| [permifrost](/handbook/enterprise-data/platform/permifrost/)          | `0.15.4`       | [link](https://example_company.com/example_company-data/permifrost)                                                                     | [Upgrading permifrost version](https://example_company.com/example_company-data/permifrost/-/blob/master/RELEASE.md?ref_type=heads)                                                                                                                            | @rbacovic | `Data Platform`                                                     | Not more than 2 versions behind (beta release excluded) |
| [meltano](/handbook/enterprise-data/platform/Meltano-Gitlab/)         | `2.16.1`       | [link](https://github.com/meltano/meltano/releases)                                                                   | [Upgrade Meltano version](https://example_company.com/example_company-data/example_company-data-meltano/-/merge_requests/34)                                                                                                                                            | `TBA`     | `Data Platform`                                                     | Current version released > 1 year |

### dbt packages inventory

| package name                                                                                | Version in use |  DRI  | User                                   |
|---------------------------------------------------------------------------------------------|----------------|-------|----------------------------------------|
| [snowflake_spend](https://example_company.com/example_company-data/snowflake_spend)                           | `1.1`          | `N\A` |-Data Engineers<br>-Analytics Engineers |
| [data-tests](https://example_company.com/example_company-data/data-tests)                                     | `N\A`          | `N\A` |-Data Engineers<br>-Analytics Engineers |
...
To be able to run this program, checkout the `/package_inventory` [repo](https://example_company.com/example_company-data/package_inventory/-/tree/master/README.md) and run the following code:
...
For more details how the program if running, refer to the [**source code**](https://example_company.com/example_company-data/package_inventory/-/tree/master/README.md).

**Note:** Keep in mind that we are relying on [PyPi](pypi.org) and [Example Company Data](https://example_company.com/groups/example_company-data) group as a primary source of the latest version of the library.
...
- Do not use `non-trusted` sources. We prefer [PyPi](pypi.org) or packages from [Example Company Data](https://example_company.com/groups/example_company-data) group for the source of the installation
...
|-------------------------------------------------------|----------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|----------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| `FY24Q4`                                              | [#19248](https://example_company.com/example_company-data/analytics/-/issues/19248#package-version-inventory)        | `FY25Q1`                                                        |                                                                                                    |                                                                                                     | @rbacovic                                                                          |
| `FY25Q1`                                              | [#20233](https://example_company.com/example_company-data/analytics/-/issues/20233)                                                                                                  | `FY25Q2`                                                        |                                                                                                    |                                                                                                     |@rbacovic                                                                           |
| `FY25Q2`                                              | [#21082](https://example_company.com/example_company-data/analytics/-/issues/21082)                                                                                                   | `FY25Q3`                                                        |                                                                                                    |                                                                                                     |@rbacovic                                                                                    |
| `FY25Q3`                                              |                                                                                                    | `FY25Q4`                                                        |                                                                                                    |                                                                                                     |                                                                                    |
| `FY25Q4`                                              |                                                                                                    | `FY26Q1`                                                        |                                                                                                    |                                                                                                     |                                                                                    |
