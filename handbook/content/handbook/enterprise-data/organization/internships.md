...
description: "Example Company Data Team Internships"
---
...
Welcome to the **Data Team Internship Program** page. The Program is launching in 2022 and we are excited to help interested Example Company team members experience life in the fast-paced, results-oriented, and rapidly-evolving world of Data!

- **Slack Channel**: `#data`
- **[Internship for Learning](/handbook/people-group/learning-and-development/internship-for-learning/)**
- **[Data Onboarding Issue](https://example_company.com/example_company-data/analytics/-/blob/master/.example_company/issue_templates/Team%3A%20Data%20Onboarding.md)**

## <i class="far fa-newspaper" id="biz-tech-icons"></i> The 2022 Data Team Internship Program

The initial focus of the 2022 Program will be **Data Internship for Learning**, following the [Example Company Internship for Learning Program](/handbook/people-group/learning-and-development/internship-for-learning/) and focused on supporting career development for existing Example Company Team Members. Later in 2022 we will evaluate extending the program to support non-Example Company Team Members and traditional undergraduate internships.

### How Does Data Internship For Learning Work?

The Data Internship for Learning follows [Example Company Internship for Learning Program](/handbook/people-group/learning-and-development/internship-for-learning/) guidelines. In addition, given the rapid growth of the Data Team, we seek to partner every Intern with a current [individual contributor](/handbook/engineering/development/dev/training/ic-to-manager/) Data Team member who is interested in exploring their own career development towards a [Leadership](/handbook/people-group/learning-and-development/new-to-leadership/#new-to-leadership-and-management) role, such as a Team Lead specialization or [Data Management](/job-families/finance/manager-data/) role. In this model, both team members share a commitment to support each other's success.

At launch in January 2022, **Data Internship for Learning** will be structured as follows:

- Follows the [Example Company Internship for Learning Program](/handbook/people-group/learning-and-development/internship-for-learning/)
- Open to only current Example Company Team Members
...
Follow the [Example Company Internship for Learning Program](/handbook/people-group/learning-and-development/internship-for-learning/) instructions.
...
An internship gives you insight into a [Data Team role](/handbook/enterprise-data/organization/#data-roles-and-career-development) by providing you opportunities to learn and contribute to Example Company results. You will be fully integrated into the team through Data Onboarding and be assigned **real** projects that contribute to Quarterly Objectives and the [Data Team Roadmap](/handbook/enterprise-data/direction/). In the Example Company Data Team we believe in full end-to-end ownership of the work we do, ranging from requirements gathering all the way to production deployment and operations. During your internship you will be assigned a Senior team member as a mentor-manager, who will help you to navigate in daily tasks.  Examples of your tasks will include:
...
- Working in Example Company to manage projects (via epics and issues)
...
| :---: | :---:  | :---: | :---: |
| [FY23Q1](https://example_company.com/groups/example_company-data/-/epics/499) | 1 | 1 | 0 |
| [FY23Q2](https://example_company.com/groups/example_company-data/-/epics/427) | 2 | 2 | 0 |
| FY23Q3 | TBD | TBD | TBD |
| FY23Q4 | TBD | TBD | TBD |
...
| Quarter | Openings | Filled | Remaining Openings |
| :---: | :---:  | :---: | :---: |
| [FY23Q1](https://example_company.com/groups/example_company-data/-/epics/499) | 2 | 2 | 0 |
| [FY23Q2](https://example_company.com/groups/example_company-data/-/epics/427) | 2 | 2 | 0 |
| FY23Q3 | 2 | 2 | 0 |
| FY23Q4 | 3 | 3 | 0 |
| FY24Q1 | 1 | 1 | 0 |
...
| :---: | :---:  | :---: | :---: |
| FY23Q1 | 0 | 0 | 0 |
| [FY23Q2](https://example_company.com/groups/example_company-data/-/epics/427) | 0 | 0 | 0 |
| FY23Q3 | 0 | 0 | 0 |
| FY23Q4 | 1 | 1 | 0 |
| FY24Q1 | 0 | 0 | 0 |
| FY24Q2 | 0 | 0 | 0 |
