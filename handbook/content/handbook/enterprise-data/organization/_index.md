...
description: "Example Company Data Team Organization"
---
...
1. The need for **bespoke data solutions** unique to the Example Company business.
...
- a [Example Company Data Recruiting](https://youtu.be/4DlwsBIPxUw) video to say "Hi" and give you some insight into how we work and what we work on. Enjoy!
...
```mermaid
  ...
  click supe:de "https://handbook.example_company.com/job-families/finance/data-engineer#data-engineer";
  click supe:sde "https://handbook.example_company.com/job-families/finance/data-engineer#senior-data-engineer";
  click supe:fde "https://handbook.example_company.com/job-families/finance/data-management#staff-data-engineer";
```
...
```mermaid
  ...
  click supe:ida "https://handbook.example_company.com/job-families/finance/data-analyst#data-analyst-intern";
  click supe:jda "https://handbook.example_company.com/job-families/finance/data-analyst#junior-data-analyst";
  click supe:da "https://handbook.example_company.com/job-families/finance/data-analyst#data-analyst";
  click supe:sda "https://handbook.example_company.com/job-families/finance/data-analyst#senior-data-analyst";
  click supe:fda "https://handbook.example_company.com/job-families/finance/data-analyst#staff-data-analyst";
```
...
```mermaid
  ...
  click supe:ds "https://handbook.example_company.com/job-families/finance/data-science/#data-scientist-intermediate";
  click supe:sds "https://handbook.example_company.com/job-families/finance/data-science/#senior-data-scientist";
  click supe:stds "https://handbook.example_company.com/job-families/finance/data-science/#staff-data-scientist";
  click supe:pds "https://handbook.example_company.com/job-families/finance/data-science/#principal-data-scientist";
```
...
```mermaid
  ...
  click supe:ae "https://handbook.example_company.com/job-families/finance/analytics-engineer#analytics-engineer-intermediate";
  click supe:sae "https://handbook.example_company.com/job-families/finance/analytics-engineer#senior-analytics-engineer";
  click supe:fae "https://handbook.example_company.com/job-families/finance/analytics-engineer#staff-analytics-engineer";
  click supe:pae "https://handbook.example_company.com/job-families/finance/analytics-engineer#principal-analytics-engineer";
```
...
```mermaid
  ...
  click supe:md "https://handbook.example_company.com/job-families/finance/manager-data/#manager-data-intermediate";
  click supe:smd "https://handbook.example_company.com/job-families/finance/manager-data/#senior-manager-data";
  click supe:dd "https://handbook.example_company.com/job-families/finance/data-and-insights-executive/#director-data-and-analytics";
  click supe:sdd "https://handbook.example_company.com/job-families/finance/data-and-insights-executive/#senior-director-data-and-analytics";
```
...
A single TTT consists of minimum 2 and maximum 3 Example Company Team Members with different roles. There are no requirements in which team a Team Member is part  of(so this could be outside of the central Data Team as well) as long as the TTT meets the expectations described below.
