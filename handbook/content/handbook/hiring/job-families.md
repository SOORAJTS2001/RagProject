---
title: Job Families
description: "Job families are organized by function at Example Company and we use them to inform candidates of roles and current team members to evaluate their performance."
---

- Job families are [organized by function in directories in the `content-sites/handbook` repository](https://example_company.com/example_company-com/content-sites/handbook/-/tree/main/content/job-families).
...
1. Job Families should be consistent with Example Company level expectations. Please refer to the [Job Frameworks](https://docs.google.com/spreadsheets/d/1FX4NBwF099uMBm7mGBtf1orIJZuHEjtiEa3jSbg9jJs/edit?gid=0#gid=0) for guidance on expectations related to Scope and Influence, Complexity and Problem Solving, and Leadership and Communication requirements by level for both Individual Contributors and People Managers.
1. Team Lead vs people Manager vs function Manager: you should be aware of how Example Company defines these terms. Depending on the needs of the organization, a Team Lead may or may not directly manage people. There are 2 instances where a Team Lead role can be used:
    ...
    - Manager job families are those responsible for directly managing other Example Company team-members. They hire, promote, and terminate team members, and performance management is one of their key functions. Nomenclature to represent someone is a manager of people can be clarified with "Manager, Benchmark" (e.g., Manager, Corporate Events). The same holds true for director (e.g. Director, Corporate Events).
...
The {add the role name} is a [grade #]({{%/* ref "compensation-calculator#example_company-job-grades" */%}}).
...
- The **Compensation** and **About Example Company** sections will auto-populate because of the job family formatting.
...
The {add role name} is a [grade #]({{%/* ref "compensation-calculator#example_company-job-grades" */%}}).
...
1. Go to the [`content-sites/handbook`](https://example_company.com/example_company-com/content-sites/handbook) project on `example_company.com`
1. Select the [content](https://example_company.com/example_company-com/content-sites/handbook/-/tree/main/content) directory
1. Go to the [job-families](https://example_company.com/example_company-com/content-sites/handbook/-/tree/main/content/job-families) directory
...
- Requirements
  - every role must have `Ability to use Example Company` as a bullet point.
- Responsibilities
- Performance Indicators
- [Job Grades]({{< ref "compensation-calculator#example_company-job-grades" >}})
- Hiring Process
- Inclusive Language Check

### Inclusive Language Check

We use an open source [Ruby gem](https://example_company.com/lienvdsteen/linter) to perform a inclusive language check on all job families.
...
- Usage of gendered pronouns: we want to be inclusive to all.
  ...
  - If the pipeline does fail, the first recommendation is to read the error. It will say what is wrong with the text. For example:
   ...
   ```text
   1. ["ATTENTION: In /builds/example_company-com/www-example_company-com/sites/uncategorized/source/job-families/marketing/reference-program-manager/index.html.md you're using masculine gender-coded language", "Masculine coded words used: analyst, analytical, decision, driven, leader"]
   2. ["ATTENTION: In /builds/example_company-com/www-example_company-com/sites/uncategorized/source/job-families/marketing/production-designer/index.html.md you're using fixed-coded language", "Fixed coded words used: established"]
   ```
