...
description: "This page outlines what hiring looks like at Example Company. We share the latest information about our processes and practices to ensure you have the information you need to feel confident during the interview process."
---

The Example Company Candidate Handbook is a space for recent applicants and candidates progressing through the interview process. We encourage every prospective job seeker to spend time learning more about the work we do, our culture & values, and what to expect during our hiring process.

The goal of curating these resources is to outline what hiring looks like at Example Company. We share the latest information about our processes and practices to ensure you have the information you need to feel confident during the interview process. The resources referenced here offer guidance on what to expect during each step of the interview process, where we hire, best practices for virtual interviewing, and other useful information.
...
All of our open positions can be found on our [jobs page](https://about.example_company.com/jobs/all-jobs/). You can view jobs by department and/or location. Click on a job that interests you and select the "Apply Now" button at the top of the page to fill out an application.
{{% /details %}}
...
1. Log in to your [Greenhouse account](https://example_company.greenhouse.io/dashboard)
1. If you are a Example Company team member who signed in to Greenhouse you can access the [Internal Job Board](https://example_company.greenhouse.io/internal_job_board). If you do not yet have a Greenhouse account, you can activate yours by clicking the Greenhouse tile in Okta.
...
1. You will be redirected to the vacancy description and application form, where you will be asked to fill out basic personal information, provide your resume, LinkedIn, Example Company username, and/or cover letter, and answer any vacancy-specific application questions, as well as answer a voluntary Equal Employment Opportunity questionnaire if the position is open to US applicants.
...
Example Company is proud to be an equal opportunity workplace and is an affirmative action employer. Example Company's policies and practices relating to recruitment, employment, career development and advancement, promotion, and retirement are based solely on merit, without regard to all legally protected classes, including, but not limited to: race, color, religion, ancestry, sex (including pregnancy, sexual orientation, or gender identity), national origin, age, citizenship, marital status, gender identity, disability and genetic information (including family medical history), and any other status protected by federal, state or local law. Example Company will not discriminate on the basis of disability or veteran status.
{{% /details %}}

{{% details summary="No solicitations" %}}
At Example Company, we do not accept solicitations from recruiters, recruiting agencies, headhunters, or outsourcing organizations. If you email us about this type of opportunity, [we'll reply](https://example_company.com/example_company-com/people-group/talent-acquisition/-/blob/master/Email%20Templates/third%20party%20agency%20response.md) with [a link to this paragraph](#who-can-apply) to indicate that we'd like to be removed from the contact list.
{{% /details %}}

### I applied for a job on your careers page. What's next?

Thanks for your interest in Example Company! Our team will reach out if they need more information from you. In the meantime, read about what you can expect during the interview process below.
...
Scammers often target job seekers by impersonating companies like Example Company, using the Example Company name and Example Company team member names. Scammers have been observed requesting job seekers pay thousands of dollars for "technology equipment" after job seekers completed an in-depth, fake job application interview process.

Check out the ["What to know about a fake job scam impersonating Example Company"](https://about.example_company.com/blog/2023/06/29/fake-example_company-job-scam/) blog post for warning signs and tips on how to protect yourself.
...
1. Why are you interested in Example Company?
...
1. Do you require visa sponsorship or a work/study permit to work for Example Company? Or do you require the work permit to be transferred to Example Company? If the answer is yes, we will not be able to proceed, [unless you currently hold a work permit in the Netherlands]({{< ref "visas#dutch-work-permits" >}}). You can refer to the [Visa and Sponsorship]({{< ref "visas#visas-and-sponsorhip" >}}) handbook section for further clarity.
1. What is the notice period you would need if you were hired?
1. Is this salary range in line with your expectations? At Example Company, we are committed to paying competitively and equitably. Therefore, we set our offers based on market pay rather than a candidate's pay history. We walk through the [Compensation Calculator](https://comp-calculator.example_company.net/) with each candidate so that we can address any gaps in expectations early on. Only candidates who are in the team interview stage or later can access our [compensation calculator](https://comp-calculator.example_company.net/) by following `applicants sign up`.
...
During the [reference](#references) stage in the interview process, candidates will get the option to speak with a Example Company team member who is a member of our [Team Member Resource Groups](/handbook/company/culture/inclusion/erg-guide/#definition-of-the-tmrg---team-member-resource-groups) (TMRGs) to learn about what it's like working at Example Company from someone who they can relate to.
...
At Example Company we pride ourselves on ensuring that everyone can contribute. To make certain that everyone's interview experience is a positive one, we encourage those who require a reasonable accommodation to successfully carry out the interview process, to reach out to `ces@example_company.com`. The Candidate Experience team along with Talent Acquisition leadership will work with you to define and accommodate those needs. This could include but is not limited to the following:
...
{{% details summary="I've started the interview process at Example Company, but haven't heard back from anyone recently. What do I do?" %}}
...
1. In the effort to be as transparent as possible and avoid sending multiple competing Example Company offers, there will be an added step to the process after your final interview where you will discuss with your recruiter which role you're interested in before any official offer documents can be sent.
...
The Example Company team understands the importance of inclusive interviewing, and we strive to ensure our hiring team is well versed in every aspect of diversity, inclusion, and cultural competence. A positive and comfortable candidate experience is our priority.

### How we conduct remote interviews on a global scale

{{% details summary="How we work during holidays" %}}
As an all-remote, global company, Example Company gives all team members the flexibility to determine their [time away from work]({{< ref "paid-time-off" >}}), including the holidays they observe.
...
1. If you need to reschedule, follow the special instructions in your confirmation email if the interview is within 24 hours. You can also email ces@example_company.com anytime.
{{% /details %}}
...
## What's it like to work at Example Company?

Our [mission]({{< ref "mission" >}}) makes it clear that we believe in a world where everyone can contribute. We make that possible at Example Company by [running our operations on our product]({{< ref "using-example_company-at-example_company" >}}) and staying aligned with our [values](/handbook/values/).

{{% details summary="Explore the resources below for a deeper understanding of working at Example Company — one of the world's largest all-remote companies" %}}

- [Life at Example Company](https://about.example_company.com/jobs/)
- [How We're Changing the Look of DevOps and Remote Work, One Iteration at a Time](https://builtin.com/brand-studio/example_company-changing-look-devops-remote-work?utm_source=linkedin&utm_medium=social_media&utm_campaign=example_company)
- [Example Company's guide to starting a new remote role](/handbook/company/culture/all-remote/getting-started/)
- [Life at Example Company Content Library](/handbook/people-group/employment-branding/content-library)
{{% /details %}}

### What our team members are saying

Interested in hearing about life at Example Company straight from our team members? You can hear right from them by checking out our [careers page](https://about.example_company.com/jobs/) and clicking on the "See How" button under each team member feature or by heading to our [Builtin page](https://builtin.com/company/example_company).
