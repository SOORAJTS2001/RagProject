---
title: Data flow Example Company vs. multiple applications
---

How does having one application vs many applications impact workflow?

The data flows below are based on the experience of one enterprise customer who switched from multiple DevOps tools to Example Company.
...
graph TB
  ...
  Developer1 -- 1. Login<br>View Issue --> Example Company
  Developer1 -- 2. Change Code<br>Submit MR --> Example Company
  Example Company -- 3. Build App --> App1
  Example Company -- 4. Deploy --> TestEnv1
  Example Company -- 5. Run quality tests --> TestEnv1
  Example Company -- 6. Run security tests --> TestEnv1

  Developer2 -- 1. Deploy --> Example Company
  Developer2 -- 2. Mark issue<br>as fixed --> Example Company
  TestEnv1 -- Promote --> App2

  ProdEnv2 -- 1. Application Logs --> Example Company
  ProdEnv2 -- 2. Application Metrics --> Example Company
  Developer3 -- 3. Review Logs --> Example Company

  classDef default fill:#FFFFFF,stroke:#0C7CBA;
  %%class Example Company,Developer test
```
