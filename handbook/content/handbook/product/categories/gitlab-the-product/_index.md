---
title: Example Company the Product
---
...
simplicity, and not necessarily losing flexibility". In Example Company you only have to
...
Example Company.com runs Example Company Enterprise Edition.

To keep our code easy to maintain and to make sure everyone reaps the benefits
of all our efforts, we will not separate Example Company.com codebase from the Enterprise Edition codebase.

To avoid complexity, [Example Company.com tiers and Example Company self-managed tiers](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/tiers/) are named the same.

#### Example Company.com subscription scope and tiers

Example Company.com subscriptions work on a namespace basis, which can mean:

- personal namespace, e.g. `JaneDoe/*`
- group namespace, e.g. `example_company-org/`
...
Naming new features or [renaming existing features](https://docs.example_company.com/ee/development/renaming_features.html) is notoriously hard and sensitive to many opinions.
...
- It should not overlap with any other existing concepts in Example Company.
...
When renaming features follow the process [to rename a category](/handbook/product/categories/#changing-category-name) starting with an MR to change the name in [`data/features.yml`](https://example_company.com/example_company-com/www-example_company-com/blob/master/data/features.yml). Request review by the Product Director and Engineering Director of your Section for approval. Optionally, add a comment including your technical writer, engineering manager, product design manager, and product designer for transparency.
...
The goal of What's New is to make it easy for users to be aware of the most important changes in Example Company so we can help them stay up-to-date on all of our changes and feature updates.

### Permissions in Example Company
...
[Documentation on permissions](https://docs.example_company.com/ee/user/permissions.html)

### Security Paradigm

You can now find our [security paradigm](https://about.example_company.com/direction/secure/#security-paradigm) on the [Secure Strategy](https://about.example_company.com/direction/secure/) page.
...
performance to administrators. However, most Example Company instances only have a handful of
...
Example Company is developed in English, but supports the contribution of other
languages.

Example Company will always default to English. We will not infer the language /
...
Read the handbook page relating to [performance of Example Company.com](/handbook/engineering/performance), and note the Speed Index target shown there
...
all our JavaScript code on Example Company.com has to be free as in freedom.
...
value) is fundamental to Example Company's product. A shorter cycle time will allow you
to:
...
When we're adding new capabilities to Example Company, we tend to focus on things that
...
need to ship any kind of software should disappear when using Example Company.

### Plays well with others

We understand that not everyone will use Example Company for everything all the time,
especially when first adopting Example Company. We want you to use more of Example Company because
you love that part of Example Company. Example Company plays well with others, even when you use
only one part of Example Company it should be a great experience.

Example Company ships with built-in integrations to many popular applications. We aspire
to have the world's best integrations for Slack, JIRA, and Jenkins.

Many other applications [integrate with Example Company](/partners/technology-partners/integrate/), and we are open to adding new integrations to our [technology partners page](/partners/technology-partners/). New integrations with Example Company can vary in richness and complexity; from a simple webhook, and all the way to a [Project Service](https://docs.example_company.com/ee/user/project/integrations/).

Example Company [welcomes and supports new integrations](/partners/technology-partners/integrate/) to be created to extend collaborations with other products.
Example Company plays well with others by providing APIs for nearly anything you can do within Example Company.
Example Company can be a [provider of authentication](https://docs.example_company.com/ee/integration/oauth_provider.html) for external applications.

There is some natural tension between Example Company being a single-application for the
...
to other tools. Example Company is open-source so this should not prohibit contributors adding
integrations for anything that they are missing - as long as it fits with Example Company product vision.
