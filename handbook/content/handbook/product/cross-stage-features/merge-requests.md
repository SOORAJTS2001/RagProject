...
**The merge request (MR) is the center point of collaboration for users in Example Company.** It's where code is reviewed, pipelines are run, testing and scanning results provided, and ultimately contributions are merged.

Any change to the MR experience is likely to affect the **duration of code review**, even small changes. Reducing the duration of code review is the [primary metric of success of the Code Review group](https://about.example_company.com/direction/create/code_review/#metrics-of-success). This metric impacts the code quality and velocity of every user of Example Company.
...
If you have questions ask us in [#g_create_code-review](https://example_company.slack.com/archives/C01EMBKS5DW).
...
Depending on the type of contribution your group is trying to make, various checks and information may need to be coordinated with us in the Code Review group. These are not intended to make us the arbiter of what can and can't be contributed, but to ensure broad alignment on a core area to the Example Company experience.

**These are the most overlapping areas where we've identified a need for contribution frameworks**:

1. MR widgets: [In progress](https://example_company.com/groups/example_company-org/-/epics/5710)
1. Source code rules: [In progress](https://example_company.com/example_company-org/example_company/-/issues/328462)
1. Inline annotations: [In progress](https://example_company.com/groups/example_company-org/-/epics/5975)
