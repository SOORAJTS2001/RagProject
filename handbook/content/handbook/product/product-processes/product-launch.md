...
description: How to launch a product or service at Example Company.
---
...
We are actively iterating on the NPI process. You can use the [`#npi-process-working-group`](https://example_company.enterprise.slack.com/archives/C06H1SD6J56) Slack channel to follow along about the work as well as to share any feedback you may have. Since this is an active change to ongoing processes, we've left the original process instructions at the bottom of this page. This section will be removed once the revised NPI process is finalized.
...
1. What is required of Example Company to deliver the service
...
- Pricing team will conduct required research following our process, and [pricing principles](https://internal.example_company.com/handbook/product/pricing/principles-and-strategy/). Depending on the complexity of the offer, and potential market size this research could take a couple of weeks, up to a few months to complete.
...
- Premium Pricing [Execution](https://internal.example_company.com/handbook/product/pricing/archived-projects/matterhorn/) (Team member access only)
