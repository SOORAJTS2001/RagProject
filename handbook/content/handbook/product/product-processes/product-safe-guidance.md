...
This guide for Example Company Product Managers clarifies and expands on the [Regulation FD Training](https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/courses/recertify-example_company-regulation-fd-training).
...
Example Company Legal has put together a comprehensive framework to help team members determine which information is internal only and that which can be shared publicly. Following the [SAFE framework](/handbook/legal/safe-framework/) will help you comply with the requirements of Regulation Fair Disclosure.
...
Product managers often need access to MNPI to do their job. As Example Company is now a publicly-traded company, it is important we all understand what MNPI is so we manage information/data appropriately. Here are some examples of MNPI:
...
- significant developments regarding Example Company's technology or business operations;
...
- changes in Example Company's Board of Directors, E-group, or senior management;
...
| --- | --- | --- |
| [Publicly discussing a group's MAU in an issue](https://example_company.com/example_company-org/example_company-vscode-extension/-/issues/386)| Not SAFE | We should avoid publicly disclosing MAU numbers |
| [Publicly discussing new/potential product performance indicators](https://example_company.com/example_company-org/example_company/-/issues/238056)| SAFE | We can publicly discuss PIs as long as no actual data (numbers/values) is referenced or exposed |
...
The [Third-party Trademark Usage Guidelines](/handbook/legal/policies/product-third-party-trademarks-guidelines/) cover the use of third-party trademarks in Example Company (the product), and set out the process for adding new third-party logos to Example Company.

[This advice](https://example_company.com/groups/example_company-com/marketing/strategic-marketing/-/epics/321#note_558193816) covers the use of third-party trademarks in the context of comparative advertising.
