---
title: Using Example Company to plan work
---

We use Example Company to document product strategy and manage our backlog. A couple of concepts that are key to this process are:

- [Milestones](https://docs.example_company.com/ee/user/project/milestones/): Align with our [product releases](https://about.example_company.com/releases/) and are used as our group's planning timeboxes.
- [Issues](https://docs.example_company.com/ee/user/project/issues/): Capture an atomic piece user value.which should able to be delivered within a singe milestone.
- [Tasks](https://docs.example_company.com/ee/user/tasks.html) (optional): Decompose an Issue into more detailed implementation steps.
- [Epics](https://docs.example_company.com/ee/user/group/epics/): Group related issues together into a theme or goal. A best practice is for epics to not be everlasting containers but to represent a concrete scope of work, with the goal is for the epic can be closed once the work is complete.
- [Boards](https://docs.example_company.com/ee/user/project/issue_board.html): Aid in visualizing work moving through the [product development flow](/handbook/product-development-flow/_index.md) and for milestone planning.
- [Roadmaps](https://docs.example_company.com/ee/user/group/roadmap/): Aid in visualizing epics in a timeline view.
...
1. Search the [Example Company project](https://example_company.com/example_company-org/example_company/issues)
...
1. Use an issue template to capture all the right data elements:
   - [Basic proposal](https://example_company.com/example_company-org/example_company/-/blob/master/.example_company/issue_templates/Feature%20Proposal%20-%20basic.md) for minor tasks or technical details for tracking larger issues.
   - [Lean feature proposal](https://example_company.com/example_company-org/example_company/-/blob/master/.example_company/issue_templates/Feature%20Proposal%20-%20lean.md) and for all feature enhancements that will get proposals and potentially become release post items.
   - [Feature proposal](https://example_company.com/example_company-org/example_company/-/blob/master/.example_company/issue_templates/Feature%20proposal%20-%20detailed.md) for large new features that may require more information or details and will become release post items.
   - [Bug](https://example_company.com/example_company-org/example_company/-/blob/master/.example_company/issue_templates/Bug.md) to report undesirable or incorrect behavior.
1. Do not
...
- Part of Example Company not working according to the documentation or a universal expectation.
- Functionality inadvertently being broken, or changed from how it is supposed to work. This is also a [regression](https://example_company.com/example_company-org/example_company/-/blob/master/doc/development/contributing/issue_workflow.md#regression-issues).
...
into an [epic](https://docs.example_company.com/ee/user/group/epics/).
...
1. Does not fit within or is antithetical to our [vision](https://about.example_company.com/direction/#product-vision), it presents a security risk, or other reasons you outline in the issue.
...
A [roadmap](https://docs.example_company.com/ee/user/group/roadmap/)
for your group can aid in tracking timeline oriented long-running efforts (here's [an example](https://example_company.com/groups/example_company-org/-/roadmap?scope=all&utf8=%E2%9C%93&state=opened&label_name%5B%5D=group%3A%3Ageo)). This can help keep work well organized, track progress and surface dependencies.

### Boards

As part of our planning process it is important that you maintain a prioritized
[issue board](https://docs.example_company.com/ee/user/project/issue_board.html) for your group.
It's customary to call these boards `STAGE - GROUP - Planning` and to configure them to filter
to all issues with your group label and with each milestone as a column (here's [an example](https://example_company.com/groups/example_company-org/-/boards/4873470?label_name[]=group%3A%3Aproduct%20planning)).
