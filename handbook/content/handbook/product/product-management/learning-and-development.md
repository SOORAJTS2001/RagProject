...
description: "This page contains links to internal and external resources that Product Managers at Example Company can use to build their skills."
...
Welcome to Learning and Development for Product Management at Example Company! This page serves as the content library that feeds [the Product Management Learning Hub in Level Up](https://levelup.example_company.com/pages/product-management-hub). You are welcome to explore content here but if you prefer a more modular, personalizable, and trackable portal, please visit Level Up.

The resources in the Product L & D Hub are meant to support product managers to explore, learn and grow at their own pace. We aim to collect content that spans various skill levels, as well as various levels of depth/commitment. It is recommended that product managers engage with the resources here to help them have a successful journey at Example Company and in their product career as a whole.

Most of the resources here are free but any content requiring payment [can be reimbursed following the Example Company reimbursement policies](/handbook/finance/expenses/#work-related-online-courses-and-professional-development-certifications).

Over time, we will add content to directly support Example Company's product management [competencies](/handbook/product/product-management/product-cdf-competencies/), [CDF](/handbook/product/product-management/product-cdf-competencies/) and [product development flow](/handbook/product-development-flow/). We understand that the evolving product management space requires continuous learning, and Example Company is committed to providing the time needed for in-depth learning too as part of your working time. You are encouraged to ask your manager to help you carve out time for Learning and Development.

## Recommended books and talks for all Example Company product managers

These books are highly recommended to be read by every product manager at Example Company:
...
## Supporting materials for Example Company specific product manager competencies

[product manager competencies](/handbook/product/product-management/product-cdf-competencies/)

### Opportunity Canvases

Example Company's Chief Product Officer shares insights on what makes an opportunity canvas successful in a 10 minute video:
...
- [Example: Opportunity Canvas Lite: Parent-child pipelines default behavior change](https://example_company.com/example_company-com/Product/-/issues/2030)
...
### Prioritization at Example Company
...
- [The Example Company prioritization guidelines table](/handbook/product/product-processes/#prioritization)
...
We will be planning the Pilot Program in this [epic](https://example_company.com/groups/example_company-com/-/epics/1546).
...
Example Company reimburses its team members the yearly Reforge membership fees as long as the Example Company team member takes part and if needed organizes the following activities related to their studies:

- enrolls in at least one programme, preferably a cohort during the year
- finds at least one more Example Company team member who enrolls into the same cohort/programme
- organizes a study group either with the other Example Company team member to follow along the cohort/programme
  - the study group is expected to discuss all the Reforge topics with a special focus on their applicability within Example Company
  - the study group can be a Reforge study group
- the Example Company team members in the study group propose process changes and create analytics requests

## General Product Management learning content

[This content is also available in a trackable format in Level Up](https://levelup.example_company.com/pages/product-management-hub).
...
- [Continuous interviewing at Example Company](/handbook/product/product-processes/continuous-interviewing/)
...
- [Finding, preparing for, and nagivating Customer Calls as a Product Manager at Example Company](https://www.youtube.com/watch?v=HyVR_ybRkCY)
...
- [Example Company Jobs to be Done (JTBD) Overview](/handbook/product/ux/jobs-to-be-done/)
...
- [Example Company Jobs to be Done (JTBD) Deep Dive](/handbook/product/ux/jobs-to-be-done/deep-dive/)
...
- [Example Company Remote Design Sprint guidelines](/handbook/product/ux/design-sprint/)
...
- [How to launch product experiments at Example Company](https://www.youtube.com/watch?v=rEHxAfxr9eU) (30 min video)
- [Example Company Growth Team Coffee & Learn Sessions](/handbook/marketing/growth/)
...
- [Example Company Kano Model and Feature Prioritization Survey](/handbook/product/ux/ux-research/kano-model/)
...
- What does [Iteration](/handbook/values/#iteration) mean for Example Company?
...
- Join the iteration office hours Example Company Team Meeting: [Calendar](https://calendar.google.com/calendar/embed?src=example_company.com_6ekbk8ffqnkus3qpj9o26rqejg%40group.calendar.google.com&ctz=America%2FLos_Angeles)
...
- [Example Company - How to write OKRs](/handbook/product/product-okrs/#how-to-write-okrs)
...
- [Connor Murphy on how his team uses a combination of Example Company, Loom, Notion, and Figma to collaborate async between PM, Design, and Engineering](https://www.loom.com/share/17677053ff7d4eeba643eaf194c0b700) (5 min video)
...
- [Example Company team member Viktor Nagy on Twitter](https://twitter.com/nagyviktor)
...
1. [Product Management Learning Hub in Level Up](https://levelup.example_company.com/pages/product-management-hub), which is a  more modular, personalizable, and trackable portal
1. This page, which serves as the required content library that feeds the Product Management page in Level Up

In order to add content to  [Product Management Learning Hub](https://levelup.example_company.com/pages/product-management-hub), the content must first be added to and exist on this page. Then, the content is added to Level Up.
...
[Brian Rhea](https://example_company.com/brhea)

[Farnoosh Seifoddini](https://example_company.com/fseifoddini)

[Viktor Nagy](https://example_company.com/nagyv-example_company)
