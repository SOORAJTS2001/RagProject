...
Internships are a great way for a Example Company team member to learn about being a Product Manager at Example Company. Use this guide for planning and executing an internship under an IC PM who acts as the 'Intern Mentor'.
...
You can reach out on slack to the [#product](https://example_company.slack.com/archives/C0NFPSFA8) channel and express your interest in an internship and that you are looking for a mentor.
...
The [Product Development Flow](/handbook/product-development-flow/) at Example Company offers a systematic way to scope Product Internships for learning. While not mandatory, it is helpful to select one of the tracks to focus on for the internship. Available tracks:
...
1. Create an issue in the [Training project](https://example_company.com/example_company-com/people-group/Training) using the **Internship for learning** template. Check out this [issue](https://example_company.com/example_company-com/people-group/Training/-/issues/831) as an example.
...
1. Add the intern to the email groups, Example Company groups, relevant slack channels and recurring meetings.
...
| 2021-08-02 | 2021-10-29 | Plan | Project Management | @cbazan1 | Sr. Customer Success Manager | Conducted a joint webinar before the internship program on [How Example Company does Product Management](https://www.youtube.com/watch?v=kdstqjmcYgY). Learned the day-to-day of a product manager, including triaging issues and managing expectations with customers, UX, and other stakeholders. Learned how Product Managers use operational metrics and performance indicators to measure the success of feature adoption. And experienced the validation and build track for prioritizing and breaking down work. |
...
| 2021-01-18 | 2021-04-18 | Release | Release | @iganbaruch | Sr. Technical Product Marketing Manager  | During Example Company 13.9 planning and development I worked closly with the PM of the Release group, and learned all the main PM tasks around development of a milestone. Then I was acting as a PM and led the planning, development and release of Example Company 13.10 and Example Company 13.11 in the Release group.  |
| 2020-08-05 | 2020-11-01 | Monitor | Validation | @mmacfarlane | Team Lead, Enterprise Sales Development  | Created and presented opportunity canvas to VP and EVP or Product at Example Company. Conducted 8 interviews utilizing UX Research team, Respondent.io, and Dovetail. Create discussion guide for interviews. Learned Validation process from start to finish. |
| 2020-02-01 | 2020-04-30 | Monitor | Build | @williamchia | Sr. Product Marketing Manager | I got to PM the release of [Status Page](https://about.example_company.com/releases/2020/04/22/example_company-12-10-released/#status-page). |
