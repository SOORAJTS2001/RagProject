...
1. [ ] - Suggest handbook pages they may find useful
    ...
    - Pricing / tier related
        - https://about.example_company.com/company/pricing/#three-tiers
    ...
    - [Analytics Direction Page](https://about.example_company.com/direction/analytics/)
    - Helpful for research
        - [How/When to start a research project](/handbook/product/ux/ux-research/#conducting-ux-research-at-example_company)
        ...
        - Dovetail
            ...
            - [Example Company Dovetail projects](https://example_company.dovetailapp.com/projects)
...
1. [ ] - Tips / Tricks for sensing mechanisms
    ...
    - Go other places customers/user are like the [Example Company forum](https://forum.example_company.com/) and Discord, [Reddit](https://www.reddit.com/r/example_company/) and [HackerNews](https://news.ycombinator.com/news) are just a few.
...
1. [ ] - The flow of a milestone
    ...
    - Moving issues that do not finish in the milestone
        - This is an [https://handbook.example_company.com/handbook/engineering/infrastructure/engineering-productivity/triage-operations/#milestone-reschedule] to move issues that do not finish in amilestone but it's good to review issues that were not closed in a milestone as it does not move confidential issues.
    - Retrospectives
    ...
    - [Performance Indicators](https://internal.example_company.com/handbook/company/performance-indicators/product/) / [OKRs](/handbook/company/okrs/)
