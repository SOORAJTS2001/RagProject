...
order to track the current status of an issue on our [board](https://example_company.com/groups/example_company-data/-/boards/2973914).
...
iteration value to ensure we can track the issue on [the iteration board](https://example_company.com/groups/example_company-data/-/boards/2973914).
...
To request a review, [open an MR in the Product Data Insights project](https://example_company.com/example_company-data/product-analytics/-/merge_requests/new).
...
At Example Company, we use gearing ratios as [Business Drivers](/handbook/finance/financial-planning-and-analysis/#business-drivers-also-known-as-gearing-ratios)
