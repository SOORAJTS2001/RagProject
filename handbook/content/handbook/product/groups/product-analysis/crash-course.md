...
As a Product Analyst or other curious Example Company team member, it can be helpful to have a quick and easy reference for each product Stage to quickly understand high-level functionality, key objectives or a distilled product roadmap, and key data resources currently used under a specific Stage or Group within Example Company before jumping in to an analysis.
...
- [Internal handbook performance indicators (PIs)](https://internal.example_company.com/handbook/company/performance-indicators/) - This internal handbook page is a great place to understand the PIs for each Stage / Group to understand what results each team is trying to acheive.
...
- Need to quickly learn how a certain Stage/Group feature works? [Example Company Docs](https://docs.example_company.com/)

- [Metrics dictionary](https://metrics.example_company.com/) contains metrics and events collected in Service Ping and Snowplow. For more information visit the dedicated [Analytics Instrumentation Guide](/handbook/product/analytics-instrumentation-guide/#metrics-dictionary).
...
- [Centralized Metrics](https://10az.online.tableau.com/#/site/example_company/workbooks/2069845/views): Key reporting dashboard for Example Company product usage metrics.
...
- Example Company's Fiscal Year runs from February 1 to January 31. [Here](/handbook/finance/#fiscal-year) is a link to Example Company's Fiscal Quarter to Month map.

## Learn about analytics relevant product stage topics grouped by Section

Why are these groupings called 'Stages'? At Example Company, we build a product that supports every **stage** of the DevOps Lifecycle.
...
[Problems to Solve from Product Direction Page](https://about.example_company.com/direction/manage/#problems-to-solve)
...
[Metrics from Product Direction Page](https://about.example_company.com/direction/manage/#metrics)
...
[Manage Direction Page](https://about.example_company.com/direction/manage/)
...
- [Plan stage .com events](https://10az.online.tableau.com/#/site/example_company/workbooks/2325883/views)  Analyses dealing with Snowplow events tables

- [Fulfillment:Platform PIs Dashboard](https://10az.online.tableau.com/#/site/example_company/workbooks/2131145/views)

- [Growth Section Analytics Hub](https://10az.online.tableau.com/#/site/example_company/workbooks/2058563/views)

- [Code Suggestions](https://10az.online.tableau.com/#/site/example_company/workbooks/2260169/views)

- [Verify Performance Indicator Hub](https://10az.online.tableau.com/#/site/example_company/views/VerifyPerformanceIndicatorDashboard/VerifyPerformanceIndicatorHub)
...
[Link to 1 Year Plan](https://about.example_company.com/direction/plan/#1-year-plan)

A great handbook page to skim to understand the roadmap and focus for Plan

**Performance indicators**

[Link to performance indicators](https://internal.example_company.com/handbook/company/performance-indicators/product/dev-section/)
...
[Plan direction page](https://about.example_company.com/direction/plan/)
...
[Start on the Example Company website page](https://about.example_company.com/features/) dedicated to Create to get an understanding of features included in this Stage.
...
- [Performance indicators internal handbook page](https://internal.example_company.com/handbook/company/performance-indicators/product/dev-section/)  The Create : Gitaly Group primarily uses the Performance Indicators Internal Handbook Page to guide decisions
...
Must be logged into Example Company Unfiltered account
...
- [Verify Performance Indicator Dashboard](https://10az.online.tableau.com/#/site/example_company/views/VerifyPerformanceIndicatorDashboard/VerifyGitLab_comPerformanceIndicators)

- [Error Budget Dashboard](https://10az.online.tableau.com/#/site/example_company/workbooks/2270342/views)
...
[Section Direction: Verify Stage](https://about.example_company.com/direction/ops/#verify)
Resource to understand the long-term goals for the Verify team

**Performance indicators**

[Ops Section PI](https://internal.example_company.com/handbook/company/performance-indicators/product/ops-section/)
...
- [Package Performance Indicator Hub](https://10az.online.tableau.com/#/site/example_company/workbooks/2284774/views)

Primarily time series analyses for Package features on Example Company.com

- [Centralized Metrics](https://10az.online.tableau.com/#/site/example_company/workbooks/2069845/views): Key reporting dashboard for Example Company product usage metrics.

**Important data documentation**

- `wk_gitlab_dotcom_package_events` is a model you can use for all Snowplow events related to Package. This includes but is not limited to, package actions for all available Package types on Example Company.com
...
[Example Company Docs Package Page](https://docs.example_company.com/ee/administration/packages/)

Example Company Docs are awesome!
...
The Deploy team covers the deployment and release functionality of Example Company
...
- [Deploy Performance Indicator Dashboard](https://10az.online.tableau.com/#/site/example_company/workbooks/2280622/views): Primarily time series analyses for Deploy features on Example Company.com

**Product roadmap link**

[Product Direction - Delivery](https://about.example_company.com/direction/delivery/)
Resource to understand the long-term goals for this team

**Performance indicators**

[Link to performance indicators](https://internal.example_company.com/handbook/company/performance-indicators/product/ops-section/)
...
- [Dynamic Analysis Metrics](https://10az.online.tableau.com/#/site/example_company/views/PDSecDynamicAnalysisMetrics/DynamicAnalysisDashboard) Secure:Dynamic Analysis Group
...
- [Threat Management Metrics](https://10az.online.tableau.com/#/site/example_company/workbooks/2238072/views) Govern:Threat Insights Group
...
[Secure product direction page - 1 year plan](https://about.example_company.com/direction/secure/#1-year-plan)
...
- [PD: Sec: Govern Metrics](https://10az.online.tableau.com/#/site/example_company/workbooks/2200383/views)
...
[Govern product direction page - 1 Year Plan](https://about.example_company.com/direction/govern/#1-year-plan)

**Performance indicators**

[Internal handbook performance indicators for the Secure section](https://internal.example_company.com/handbook/company/performance-indicators/product/sec-section/)
...
Supports enterprise-grade operational experience of Example Company products from streamlined deployment and maintenance, disaster recovery, secure search and discoverability, to high availability, scalability, and performance. The Systems Stage includes Distribution, Gitaly and Geo Groups.

<details markdown="1"><summary>Click to expand</summary>

**Top dashboards referenced by this team**

- All Tableau Dashboards are organized in Collections, specifically [Core & SaaS Platforms General Collection](https://10az.online.tableau.com/#/site/example_company/collections/78d30546-2f24-4a4a-8378-c88711f479c4?:origin=card_share_link) and [Core & SaaS Platforms SAFE Collection](https://10az.online.tableau.com/#/site/example_company/collections/1c106c47-64b3-4cbf-b95d-c75fe2a0e9b4?:origin=card_share_link)

**Important data documentation**

There are no Enablement metrics currently collected in our Postgres Replica data for Example Company.com
...
Use the [metrics dictionary](https://metrics.example_company.com/) to determine the timeframe value for any service ping metric.
...
[Enablement Product Direction](https://about.example_company.com/direction/enablement/)
Includes Stage and Group level details

**Performance indicators**

[Enablement Section PI handbook page](https://internal.example_company.com/handbook/company/performance-indicators/product/enablement-section/)
...
Supports enterprise-grade operational experience of Example Company products from streamlined deployment and maintenance, disaster recovery, secure search and discoverability, to high availability, scalability, and performance. The Data Stores Stage includes Memory, Global Search, Database and Pods Groups.
...
- - All Tableau Dashboards are organized in Collections, specifically [Growth General Collection](https://10az.online.tableau.com/#/site/example_company/collections/9fce437d-d001-412a-a4c4-a327aeb882ff?:origin=card_share_link) and [Growth SAFE Collection](https://10az.online.tableau.com/#/site/example_company/collections/8740c9bc-6d9d-4e3e-af5a-11b48f48e925?:origin=card_share_link)

- [Growth Section Product Data Insights Hub in Tableau](https://10az.online.tableau.com/t/example_company/views/GrowthSectionProductDataInsightsHub/GrowthSectionProductDataInsightsHub)

- [Filterable Growth Experiment Analysis Dashboard](https://10az.online.tableau.com/#/site/example_company/views/USETHISFINALGLEX/GLEXExperimentAnalysisDashboard?:iid=1)

- [Growth Experiment Event Validation](https://10az.online.tableau.com/#/site/example_company/workbooks/2241316/views)

- [Snowplow Event Exploration L30D](https://10az.online.tableau.com/#/site/example_company/views/SnowplowEventExplorationLast30Days/SnowplowEventExplorationLast30D) - commonly sent to engineers for event validation.
...
- Both of the above metrics are monitored in [Growth Section Product Data Insights Hub in Tableau](https://10az.online.tableau.com/t/example_company/views/GrowthSectionProductDataInsightsHub/GrowthSectionProductDataInsightsHub)
