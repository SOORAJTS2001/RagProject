...
as a functional analytics team to support the Example Company Product division and product data-related
analysis across Example Company.

In addition to supporting the Product division, the Product Data Insights team is an active
contributor to the Example Company Data Program. As part of the [Research & Development (R&D) Data Fusion Team](/handbook/enterprise-data/#analytics-engineering-team),
...
along with other functional analytics groups across the Example Company Data Program.

Read more about what we do at Example Company on our [Direction](https://about.example_company.com/direction/product-analysis/) page.
...
| [Neil Raisinghani](/handbook/company/team/#nraisinghani) | [Senior Product Analyst](/job-families/product/product-analyst/#senior-product-analyst) | [Fulfillment](/handbook/product/categories/#fulfillment-section), [Pricing](https://internal.example_company.com/handbook/product/pricing/) |
...
You can see our current iteration [here](https://example_company.com/groups/example_company-data/-/boards/2973914).

### Issue intake

For all Product Data Insights requests, please create an issue in the
[Product Data Insights project](https://example_company.com/example_company-data/product-analytics/-/issues),
apply the `Team::PDI` and `product data insights` labels, and follow the guidelines below.

All data issues with the `Team::PDI` label will appear on the [Product Data Insights board](https://example_company.com/groups/example_company-data/-/boards/2959103).
...
| --- | --- |
| Ad hoc / Default request | [Ad Hoc Request](https://example_company.com/example_company-data/product-analytics/-/issues/new?issuable_template=Ad%20Hoc%20Request) |
| Create new or update existing PI chart | [PI Chart Help](https://example_company.com/example_company-data/product-analytics/-/issues/new?issuable_template=PI%20Chart%20Help) |
| Experimentation analysis | [Experiment Analysis Request](https://example_company.com/example_company-data/product-analytics/-/issues/new?issuable_template=Experiment%20Analysis%20Request) |
| Iteration planning | [Iteration Planning](https://example_company.com/example_company-data/product-analytics/-/issues/new?issuable_template=Iteration%20Planning) |
...
As Example Company team members, we are [encouraged to take PTO](/handbook/people-group/paid-time-off/) and observe public
...
requires a faster turn-around), please send a message in [#data](https://example_company.enterprise.slack.com/archives/C8D1LGC23)
...
addition to other product-related data needs across Example Company. As such, team capacity can be
...
However, limited capacity should not stop Example Company team members from [opening issues for Product Data Insights](https://example_company.com/example_company-data/product-analytics/-/issues/new?issuable_template=Ad%20Hoc%20Request),
...
In order to support more PMs across Example Company, the Product Data Insights team offers office hours.
...
are PMs across the organization, all Example Company team members are welcome to join.
...
work and will redirect you to [open an issue](https://example_company.com/example_company-data/product-analytics/-/issues/new?issuable_template=Ad%20Hoc%20Request).
...
Formal data requests and larger bodies of work are captured in issues in the [Product Data Insights project](https://example_company.com/example_company-data/product-analytics/-/issues/new?issuable_template=Ad%20Hoc%20Request).
...
Feel free to ask your analyst partner (if applicable) or in [#data](https://example_company.slack.com/messages/data/).
...
1. [#data](https://example_company.enterprise.slack.com/archives/C8D1LGC23) - For any type of data question, including
those related to product and/or the Product Data Insights team
1. [#data-tableau](https://example_company.enterprise.slack.com/archives/C03RMCEHVCP) - For any questions related to Tableau
1. [#g_product_data_insights_daily](https://example_company.enterprise.slack.com/archives/C0285NMCLBY) - For
...
analysts across the Example Company Data Program

### Example Company groups

1. `@example_company-data/product-analysts` - Notifies the entire Product Data Insights team
