...
The [Growth stage](/handbook/product/categories/#growth-stage) is responsible for scaling Example Company's business value. To accomplish this, Growth analyzes the entire customer journey from acquisition of
a customer to the flow across multiple Example Company features - and even reactivation of lost users. Several groups help with this mission:

- Activation, Conversion, Expansion, and Adoption connect users to the existing value that Example Company already delivers by
rapid experimentation.
- [Analytics Instrumentation](https://about.example_company.com/direction/analytics/analytics-instrumentation/) builds the backbone of data that other groups need to be successful, enabling a data-informed product
culture at Example Company.

Growth's ultimate goal is to connect Example Company's value as a Single DevOps Platform with our customers. In order to do that, we take a zoom in and zoom out approach. We break down the entire Example Company growth model, and identify the highest ROI lever at this moment to focus on. In the [Growth direction page](/handbook/marketing/growth/) we outline the Growth section's long term direction and near term focus areas.
...
Anyone is welcome to submit ideas to the [experiment idea backlog](https://example_company.com/groups/example_company-org/-/boards/2028884?&label_name[]=experiment%20idea) using the [experiment idea](https://example_company.com/example_company-org/example_company/-/issues/new?issuable_template=Experiment%20Idea) template.
...
- [Experiment guide for Product managers](https://example_company.com/example_company-org/growth/experimentation/-/issues/14)
- [Experiment ideation Process](https://example_company.com/example_company-org/growth/experiment-design-repo/-/issues/1)
- [Engineering guide for how to run experiment](https://docs.example_company.com/ee/development/experiment_guide/)
- [Growth Engieering Handbook page on running experiments](/handbook/engineering/development/growth/experimentation/)
- [A way for Example Company team members to view currently active experiments on Example Company.com](https://example_company.com/example_company-org/example_company/-/issues/262725)
...
Growth does not own areas of the product, but finds ways to help users discover and unlock value throughout the Example Company
...
management. This stage maintains a long-term vision on how users are created and maintained in Example Company, with a roadmap that
...
engineering team may ship smaller improvements independently of Manage's direct involvement during implementation (such as [soft email confirmation](https://example_company.com/example_company-org/growth/product/issues/7)), but may need to partner with Manage on larger efforts like a completely [new onboarding](https://example_company.com/example_company-org/example_company-ce/issues/57832) experience.
...
- we use the [workflow labels](https://example_company.com/groups/example_company-org/-/labels?utf8=%E2%9C%93&subscribed=&search=workflow%3A%3A) for regular issues and [experiment workflow labels](/handbook/engineering/development/growth/#experiment-workflow-labels) for experiment issues.
- we use **milestones** to aid in planning and prioritizing the four growth groups of Acquisition, Conversion, Expansion and Retention.
  - PMs provide an [ICE score for experiments](https://docs.google.com/spreadsheets/d/1yvLW0qM0FpvcBzvtnyFrH6O5kAlV1TEFn0TB8KM-Y1s/edit#gid=0) and by using [priority labels](https://docs.example_company.com/ee/development/labels/index.html#priority-labels) for other issues.
...
- Design spec has been added to the designs. Try to link to relevant components in example_company-ui
...
All of the planned, in progress and completed UX Scorecards for Growth can be found in this [epic](https://example_company.com/groups/example_company-org/-/epics/2015).
...
- [Easy to Trial Example Company](https://example_company.com/groups/example_company-org/-/issues?label_name%5B%5D=UX+Team%3A++Easy+to+Trial+Example Company+Theme)
- [Feature Discoverability](https://example_company.com/groups/example_company-org/-/issues?label_name%5B%5D=UX+Team%3A++Feature+Discoverability+Theme)
- [Onboarding New Users](https://example_company.com/groups/example_company-org/-/issues?label_name%5B%5D=UX+Team%3A+Easy+Onboarding+Theme)
- [Easy Upgrade Flows](https://example_company.com/groups/example_company-org/-/issues?label_name%5B%5D=UX+Team%3A+Easy+Upgrades+Theme)

### Collaboration process with other Product teams

We use this [process](https://example_company.com/example_company-org/growth/team-tasks/-/issues/233) to make sure growth and product teams are maximizing business impact while ensuring close collaboration.
...
1. Most growth experiments will be focused on UX/copy flow changes initially, and these will follow the typical Example Company code review process.
...
#### Contributing to the Learn Example Company project

The Learn Example Company project is utilized to onboard new users to Example Company and contains self-paced issues the user can complete to help set them and their team up for success within the Example Company platform. There are currently two separate Learn Example Company projects, one for new free SaaS signups and one for new SaaS trial signups. The growth team is still actively experimenting with improvements to this experience. If you'd like to contribute an improvement to one of the Learn Example Company projects, you can do so by following the steps outlined in this [issue](https://example_company.com/example_company-com/Product/-/issues/2239).

### Growth RADCIE and DRIs

In alignment with Example Company's [RADCIE](/handbook/people-group/directly-responsible-individuals/#radcie) approach, the DRIs for the following tasks would be:
