...
The product department determines our [investment](https://internal.example_company.com/handbook/product/investment/) within the section by allocating headcount for development team members to product groups. While doing so we adhere to the following principles:
...
The [Analytics Stack](https://example_company.com/groups/example_company-org/-/epics/8562) drives the functionality required to operate Product Analytics features within Example Company.

The Analytics Stack is currently composed of the following functionality:

- Event ingestion: Jitsu, [to be replaced by Snowplow](https://example_company.com/groups/example_company-org/-/epics/9865)
...
- [Direction](https://about.example_company.com/direction/analytics/)
