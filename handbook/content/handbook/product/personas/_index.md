...
Personas describe the ideal target for Example Company. They help us define our messaging and marketing delivery. They are theoretical people to target. By defining their concerns and where they go for information, we can best spend our marketing dollars and sales efforts by focusing on this ideal target.
...
Personas are a generalized way of talking about the ideal target we are aiming to communicate with and design for. They help us not only define our messaging and marketing delivery, but also our product. Keeping personas in mind allows us to use the correct language and make the best decisions to address their specific problems and pain points. Example Company has both [buyer](#buyer-personas) and [user](#user-personas) persona types.
...
User personas are people who actually use Example Company. They may or may not be the person in
the organization who has the authority and budget to purchase Example Company, but they
...
and make better-focused decisions during product development. [Learn more](/handbook/product/personas/organization-archetype/) about the organizational archetypes Example Company is addressing.
...
- **Tracking, documentation**: Example Company Issues
- **Communication**: Slack, Zoom, Example Company Issues
...
- [Relevant UX Research findings](https://example_company.com/groups/example_company-org/-/epics/7363)
...
- **Example Company Issues**: Tracking, documentation
- **PagerDuty**: Initiation standpoint, where pages are sent through
- **Slack, Zoom, Example Company Issues**: Communication
...
- [Relevant UX Research findings](https://example_company.com/groups/example_company-org/-/epics/2215)
...
Internal personas reflect the workflow, needs, and challenges faced by Example Company team members. These personas support and influence the work of Example Company groups that serve internal use cases.
