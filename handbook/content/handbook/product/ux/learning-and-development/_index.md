...
description: >-
  This page contains links to internal and external resources that members of the UX Department at Example Company can use to build their skills.
---

Welcome to Learning and Development for the UX Department at Example Company! You are welcome to explore content here for now. We'll update this page when we add this content to Example Company Learn.

The resources in this page are meant to support product designers, researchers, technical writers, and their managers to explore, learn and grow at their own pace. We aim to collect content that spans various skill levels, as well as various levels of depth/commitment. It is recommended that the UX Department engage with the resources here to help them have a successful journey at Example Company and in their career as a whole.

Most of the resources here are free but any content requiring payment [can be reimbursed following the Example Company reimbursement policies](/handbook/finance/spending-company-money/).

## Growth and Development

Example Company provides team members with the [growth and development benefit](/handbook/total-rewards/benefits/general-and-entity-benefits/growth-and-development/) to access external resources to develop their career. To take advantage of this benefit, review the company handbook page and follow the process.
...
- [Example Company-sponsored Tufts University Human Factors/Engineering Psychology Capstone Course](/handbook/product/ux/learning-and-development/tufts-university-capstone-course)
...
- [Small experiments, significant results and learnings](https://about.example_company.com/blog/2021/04/07/small-experiments-significant-results-and-learnings/)
- [Why iterative software development is critical](https://about.example_company.com/blog/2021/04/30/why-its-crucial-to-break-things-down-into-smallest-iterations/)
...
- [Example Company Growth experiment discussion: Adding the "Invite members" option in assignee dropdowns](https://www.youtube.com/watch?v=J5h_SNH3Nt8&list=PL05JrBw4t0Kr_-AowJmbhGk9yj_zIZySf&index=17)
...
- [UX Forum: An improved Trial Signup for Example Company.com](https://www.youtube.com/watch?v=5WWZsdJcr2k&list=PL05JrBw4t0Kq89nFXtkVviaIfYQPptwJz&index=149)
...
- [How to launch product experiments at Example Company](https://youtu.be/rEHxAfxr9eU)
- [UX collaboration on Growth experiments at Example Company](https://youtu.be/wnww8aBoqRY)
...
- [Leadership at Example Company: Recommended articles](/handbook/leadership/#articles)
- [Leadership at Example Company: Recommended books](/handbook/leadership/#books)

### Unfiltered Videos

- Example Company Design Talks: [Rayana Verissimo talks about career development and design leadership](https://youtu.be/Wgw8biVyay0)
- Example Company Design Talks: [Lorie Whitaker talks about the role of a Staff UX Researcher](https://youtu.be/GoriQSbQqNA)
- Example Company Design talks: [Marcel van Remmerden talks about career development and design leadership](https://youtu.be/B9SBZPeT6do)
- Example Company Design talks: [Pedro Moreira da Silva talks about navigating the IC career path in UX](https://youtu.be/wN_CFsPL08M)
...
## Other Example Company resources

### Handbook Links

- [Product Management Learning and Development](/handbook/product/product-management/learning-and-development/) - a comprehensive list of internal and external resources that Product Managers at Example Company can use to build their skills.
...
- [Example Company Book Clubs project](https://example_company.com/example_company-com/book-clubs)
