...
You will find everything you need to get started in the [Qualtrics template](https://example_company.eu.qualtrics.com/survey-builder/LS_2l5ektxWK1wFRuC/edit?ContextLibraryID=GR_6ziMa2ooJx4Y6SF). (Library/UX Research & Product/Templates/Opportunity Score Template)
...
💡 Note: Remember to recruit both Example Company and non-Example Company users.
