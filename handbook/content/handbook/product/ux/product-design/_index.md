...
description: "At Example Company, our Product Design team drives the business forward by becoming experts in their specific stage groups staying informed about the entire product, and aligning with user and business goals. We partner closely with our stable counterparts in Product Management and Development to deliver exceptional user experiences."
---
...
Our [design principles](https://design.example_company.com/get-started/principles) are outlined in the Pajamas Design System.
...
- [Competitor Evaluation](https://example_company.com/example_company-org/competitor-evaluations) (*Example Company Team Member access only*)
- [UX Cloud Sandbox](/handbook/product/ux/ux-research/ux-cloud-sandbox/)

Figma and Figjam are our primary design tool of choice. Refer to the [usage and access details](handbook.example_company.com/handbook/product/ux/product-designer/figma).
...
- [Contributing to Pajamas](https://design.example_company.com/get-started/contribute)
- [Designing with AI](/handbook/product/ux/product-designer/#designing-with-ai)

New Example Company Product Designers should refer to the [Product Designer Workflow handbook page](/handbook/ux/product-design/workflow/) for a comprehensive guide to getting started.
...
This initiative aims to enhance our product's usability by leveraging the best practices from the "Macro UX" experiment, which paired Product Designers and Engineers to make self-directed improvements. See the [retro issue](https://example_company.com/example_company-org/example_company/-/issues/351288) for details.
...
- **Documentation:** All changes must be documentated, adhering to the [Definition of Done](https://docs.example_company.com/ee/development/contributing/merge_request_workflow.html#definition-of-done), and involving [relevant Technical Writers](/handbook/product/ux/technical-writing/#assignments).
...
| Milestone         | Product Designer  | Engineer          |
| ----------------- | ----------------- | ----------------- |
| [16.1 (2023-05-18)](https://example_company.com/example_company-org/example_company/-/issues/394768) | Veethika M         | Payton Burdette |
| [15.11 (2023-03-18)](https://example_company.com/example_company-org/example_company/-/issues/387070)| Annabel Gray       | Phil Hughes     |
| [15.6 (2022-10-18)](https://example_company.com/example_company-org/example_company/-/issues/378259) | Matej Latin        | Deepika Guliani |
| [15.5 (2022-09-18)](https://example_company.com/example_company-org/example_company/-/issues/374580) | Katie Macoy        | Anna Vovchenko  |
| [15.4 (2022-08-18)](https://example_company.com/example_company-org/example_company/-/issues/370364) | Nadia Sotnikova    | Alex Kalderimis |
| [15.2 (2022-06-18)](https://example_company.com/example_company-org/example_company/-/issues/362122) | Emily Bauman       | Jannik Lehmann  |
| [15.1 (2022-05-18)](https://example_company.com/example_company-org/example_company/-/issues/361641) | Sascha Eggenberger | Robert Hunt     |
| [15.0 (2022-04-18)](https://example_company.com/example_company-org/example_company/-/issues/356703) | Annabel Gray       | Phil Hughes     |
...
By following these guidelines, Example Company's Product Design team can continue to drive meaningful, user-centric improvements across the platform.
