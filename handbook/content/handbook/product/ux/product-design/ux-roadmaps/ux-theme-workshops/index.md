...
1. Create an issue in the Example Company Design Project using the UX Theme Workshop Template.
...
> 💡 Tip: Keep the sticky notes in their respective color grouping unordered. Do not arrange them by any pre-existing method (existing epic, product roadmap, group: category,  etc.) The goal is to break down our existing organizational method used in Example Company for this exercise.
>
