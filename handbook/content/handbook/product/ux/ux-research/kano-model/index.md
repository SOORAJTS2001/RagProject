...
1. Use **simple** and **neutral** language to avoid bias in how feature desciptions are perceived
   - No Example Company lingo like `sections`, `categories`
...
: Preparing for the survey can take a lot of time and might be hard to track. Creating a [separate issue](https://example_company.com/example_company-org/ux-research/-/issues/1143) to track the effort can help break up the main research issue into smaller manageable parts.
{{% /alert %}}
...
Example [survey](https://example_company.eu.qualtrics.com/jfe/preview/SV_3VoczISwBuK8ab3?Q_CHL=preview&Q_SurveyVersionID=current) that we used in [#1027](https://example_company.com/example_company-org/ux-research/-/issues/1027)
...
For the analysis use this [spreadsheet template](https://docs.google.com/spreadsheets/d/14D-ayhw15J9o7ixzFh7pda_SZQkhZTRsyJvHi_5JXbk/edit?usp=sharing) (Example Company internal link).

Example [report](https://docs.google.com/presentation/d/1aLt3QkYthTlbjBig0efWlbA11FkXBTNZdfh4Yk3o3g4/edit?usp=sharing) (Example Company internal link) that summarizes the output from the quantitative approach.
...
## Examples of Kano research conducted at Example Company

- [Monitoring feature prioritization](https://example_company.com/example_company-org/ux-research/-/merge_requests/28)
- [CI feature prioritization](https://example_company.com/example_company-org/ux-research/-/issues/1027)
- [Threat insights feature prioritization](https://example_company.com/example_company-org/ux-research/-/issues/1295)
- [Example Company Plus feature prioritization](https://example_company.com/example_company-org/ux-research/-/issues/1128)
