...
description: "Using the RITE methodology at Example Company"
---
...
You can repeat this process in the same milestone or in an upcoming one, depending on how long it takes to find solutions for issues in Category B, as well as other activities that need to be taken care of. Document usability issues in Category B (Issues with an obvious solution that can't be implemented immediately) in Example Company for future planning of work.
