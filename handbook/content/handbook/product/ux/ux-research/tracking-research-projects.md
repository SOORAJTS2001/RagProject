...
The labels are used to generate [this dashboard (internal only)](https://app.periscopedata.com/app/example_company/1063612/UX-research-projects), which informs us of the following:
