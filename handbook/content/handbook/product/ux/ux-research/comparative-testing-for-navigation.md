...
(Give UMUX Lite survey first, before asking additional questions)
  ...
  - **At the end of each test session, comparing all designs:**
    ...
    - Considering the different designs you saw today, if you were to wake up tomorrow and see one of these designs integrated into your Example Company UI, which one would you like to see, and why?
