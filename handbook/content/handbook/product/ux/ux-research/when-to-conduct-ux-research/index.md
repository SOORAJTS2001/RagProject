...
The content in the following sections is covered in more depth in a 20 minute, self paced [LevelUp course (internal link)](https://levelup.example_company.com/learn/course/when-to-conduct-ux-research).
...
### Double Diamond model and Example Company's product development flow
...
- Does your design follow the design [guidelines](https://design.example_company.com/) and [tenets](/handbook/product/ux/product-designer/#product-design-process)? Have you reviewed the [design and UI changes checklist](https://docs.example_company.com/ee/development/contributing/design.html#checklist)?
...
flowchart TB
   ...
   node6 --> |No| node6no{{"`Look for existing research in Dovetail and the Example Company UX Research project.`"}}
