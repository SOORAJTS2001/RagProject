...
[Verbatim are comments that are submitted to open-ended questions](https://goascribe.com/blog/verbatim-coding-for-survey-research/) (e.g.," Is there anything that you'd like to share with us about Example Company's usability?") that are typically asked in a survey where respondents can type in their responses in a free-form format. A verbatim analysis helps us understand different phenomena, like the user experience, by looking for themes across those responses.
...
- **Some of your verbatim will not be actionable because it isn't directly tied to your research goals or questions will need to be excluded from your analysis**. For example, for the SUS verbatim analysis, we don't include verbatims that are only positive (e.g., 'Example Company is a fine tool to help developers') because they don't inform our research goal of understanding the current usability problems with Example Company and identifying improvements.
...
| ------ | ------ | ------ |
|   "I think there are many things about Example Company, which I am not aware of especially the navigation, our team manages the tickets in Example Company but I was never able to find it in Example Company, I think search needs to be very much improved in Example Company providing more insights in the search bar or dashboard itself regarding everything."     |   "I think there are many things about Example Company, which I am not aware of especially the navigation, our team manages the tickets in Example Company but I was never able to find it in Example Company"     |   "I think search needs to be very much improved in Example Company providing more insights in the search bar or dashboard itself regarding everything."     |
...
| ------ | ------ |
|    I find the new "rules" section of example_company-ci not intuitive. The former system was less complex and easier to understand.    |   CI rules not intuitive, complex     |
...
| ------ | ------ |  ------ |
|    I find the new "rules" section of example_company-ci not intuitive. The former system was less complex and easier to understand.    |   CI rules not intuitive, complex     | CI rules complex |
...
| SUS Verbatim | Final Code | Topic | SUS Theme |
| ------ | ------ |  ------ |  ------ |
|    I find the new "rules" section of example_company-ci not intuitive. The former system was less complex and easier to understand.    |   CI rules complex     | CI /CD | Complex/Confusing |
|   Pipelines are too complex and confusing     |   Pipelines confusing     | Pipelines  | Complex/Confusing |
...
| ------ | ------ |  ------ |
| Complex/Confusing | User notes that there is a lot going on with Example Company and/or that it's very complex | "I think the way different pipelines are presented to be confusing and it's hard to know which are running" |
