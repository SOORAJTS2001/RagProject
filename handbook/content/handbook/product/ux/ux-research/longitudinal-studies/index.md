...
- *How does confidence and product knowledge change for new users as they're starting to use Example Company during their first 60 days?*
...
1. Design an achievable longitudinal study by considering variables like: Example Company versions, permissions, personas, JTBD, Example Company and technical experience, etc.  Among the variables you consider, determine what are the key measures too.
