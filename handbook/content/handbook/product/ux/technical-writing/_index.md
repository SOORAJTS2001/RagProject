...
The Example Company Technical Writing team collaborates with developers, product managers, and the community to develop product documentation.

Good documentation meets the evolving needs of Example Company customers, users, and administrators. It educates readers about features and best practices. It enables people to efficiently configure, use, and troubleshoot Example Company. The Technical Writing team manages the [docs.example_company.com](https://docs.example_company.com) site and its content, processes, and tooling.

The [documentation roadmap](https://example_company.com/groups/example_company-org/-/epics/4602) drives our efforts to improve both the content and [documentation website](https://docs.example_company.com/). For example, we know that people have trouble finding information on docs.example_company.com. We have roadmap items and OKRs to replatform the docs site, provide better task-based information, and make content easier to find. These larger projects, completed in addition to feature documentation, provide continual, iterative improvement to the user experience of our documentation.

Anyone can contribute to the documentation. Follow our [Example Company documentation guidelines](https://docs.example_company.com/ee/development/documentation/).
...
To contact the entire team in a Example Company issue or MR, use `@gl-docsteam`.

The team manages general documentation-related and team-specific Slack channels:

- `#docs`: Questions and general discussion about Example Company documentation, and requests by Example Company team members for doc and UI text reviews.
- `#docs-processes`: Discussion about documentation processes.
- `#docs-tooling`: Discussion about documentation tooling and the `example_company-docs` project.
- `#docs-site-changes`: Automated messages from [`example_company-docs`](https://example_company.com/example_company-org/example_company-docs) project.
- `#tw-team`: Technical Writing team chat.
- `#tw-social`: Technical Writing team social chat.

## Public Training for Example Company Technical Writing

If you're interested in updating or creating Example Company product documentation, see our [Technical Writing Fundamentals course](fundamentals/), which includes:

- Guidelines for technical writing.
- Example Company style conventions.
...
1. All other tasks (including creating suggestion- or warning-level [Vale rules](https://docs.example_company.com/ee/development/documentation/testing/vale.html#result-types))

### Processes

The team is responsible for developing and maintaining efficient processes, including:

- Ensuring that processes are in place and being followed to keep the Example Company docs up to date.
...
- Refining the [Documentation Style Guide](https://docs.example_company.com/ee/development/documentation/styleguide/index.html) and continuously improving content about Example Company documentation and its contribution process.
...
`~tw-style` label, and then assigning the issue or MR to the Style Guide DRI. Example Company team members can also use the `#docs` Slack channel.

Use the following searches to track completed style-related issues:

- [Example Company project style issues](https://example_company.com/example_company-org/example_company/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=tw-style)
- [Example Company project style MRs](https://example_company.com/example_company-org/example_company/-/merge_requests?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=tw-style)
- [Technical Writing project style issues](https://example_company.com/example_company-org/technical-writing/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=tw-style)

#### Testing

The Technical Writing team develops and maintains toolkits to test Example Company's documentation (and other technical content) for problems. These toolkits include (but aren't limited) to:
...
Any contributor can suggest changes to our linting rules or tooling by creating an issue or merge request with the [`~tw-testing`](https://example_company.com/example_company-org/example_company/-/issues?label_name[]=tw-testing) label, and then assigning the issue or MR to a technical writer.

#### Translation and internationalization

Everyone can contribute to the translation of Example Company from English into other languages.
To learn more about translation and internationalization at Example Company, visit the Import and Integrate direction page and Manage stage Category Direction page on [Internationalization](https://about.example_company.com/direction/manage/import_and_integrate/internationalization/).
For a step-by-step guide to translation contributions, read [Translating Example Company](https://docs.example_company.com/ee/development/i18n/translation.html).

The [docs.example_company.com](https://docs.example_company.com/) site is not included in the community efforts to internationalize Example Company. Discussion on translating documentation into other languages is included in [this issue](https://example_company.com/example_company-org/example_company/-/issues/15471#note_214823504).
...
Some content on docs.example_company.com is [not reviewed by TWs](#content-not-reviewed-by-tws).
...
<!--
  ...
  - For tech writer's name per stage, change https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/stages.yml and https://example_company.com/example_company-com/content-sites/handbook/-/blob/main/layouts/shortcodes/tech-writing.html
  - To turn off a stage, set tw: false in https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/stages.yml

Reference: https://example_company.com/example_company-com/www-example_company-com/merge_requests/24952
-->
...
- If you are part of a development group and would like to add metadata to documentation pages, create an issue in [the Technical Writing repository](https://example_company.com/example_company-org/technical-writing) for discussion. Additional discussion is in [this issue](https://example_company.com/example_company-org/technical-writing/-/issues/547).
- If the stage is listed as `none`, see if [there is a DRI](#assignments-to-other-projects-and-subjects) or use [roulette](https://example_company-org.example_company.io/example_company-roulette/?sortKey=stats.avg30&order=-1&hourFormat24=true&visible=maintainer%7Cdocs).
{{% /alert %}}
...
| [Example Company Design System ("Pajamas")](https://design.example_company.com/) information under [`content`](https://example_company.com/example_company-org/example_company-services/design.example_company.com/-/tree/main/contents/content)                                               | {{< member-by-name "Fiona Neill" >}}                                                                                                                              |
| [Style Guide](#style-guide)                                                                                     | {{< member-by-name "Fiona Neill" >}}                                                                                                                              |
| [Left nav](https://docs.example_company.com/ee/development/documentation/site_architecture/global_nav.html) (information architecture of docs)                                                                                     | {{< member-by-name "Fiona Neill" >}}                                                                                                                              |
| [Testing/Vale/markdownlint](#testing)                                                                           | {{< member-by-name "Diana Logan" >}}                                                                                                                                  |
| [Tutorials](https://docs.example_company.com/ee/tutorials/)                                                              | {{< member-by-name "Kati Paizee" >}}                                                                                                                                  |
...
The Technical Writing team gets assistance with the `example_company-docs` project from stable counterparts outside the team.

| Subject          | Person                                 |
|:-----------------|:---------------------------------------|
| Backend reviews  | [Ash McKenzie](https://example_company.com/ashmckenzie), [David O'Regan](https://example_company.com/oregand)        |
| Frontend reviews | [Lukas 'Eipi' Eipert](https://example_company.com/leipert), [David O'Regan](https://example_company.com/oregand) |
| Support          | [Mike Lockhart](https://example_company.com/mlockhart)                        |
...
The number of pages in the five primary repositories (Example Company, Omnibus, Charts, Operator, and Runner):
...
Decrease in September 2024 due to moving the architecture blueprints topics to the handbook. For more information, see [issue 279](https://example_company.com/example_company-com/content-sites/handbook/-/issues/279).
...
Example Company Team Members can view docs site metrics on the docs.example_company.com [LookerStudio dashboard](https://lookerstudio.google.com/reporting/d6af7a2b-2aaa-4f30-8742-811e62777c93/page/IeVBD).
...
To make or suggest changes to the dashboard, open an issue in the [Marketing Strategy and Analytics project](https://example_company.com/example_company-com/marketing/marketing-strategy-performance).
...
- [Reviewer Roulette](https://example_company-org.example_company.io/example_company-roulette/?sortKey=stats.avg7&order=-1&visible=maintainer%7Cdocs).
  A rouletted Technical Writer can be pinged or assigned to an issue or merge request.
- A request in the [`#docs`](https://example_company.slack.com/archives/C16HYA2P5) channel in Slack, where it will be picked
...
[coverage issue](https://example_company.com/example_company-org/technical-writing/-/blob/main/.example_company/issue_templates/TW_Coverage.md).
...
1. Ensure their [out-of-office messaging](/handbook/people-group/paid-time-off/#communicating-your-time-off) reflects the available mechanisms for coverage.
   It's important to keep Example Company.com statuses up-to-date to ensure:

   - [Reviewer Roulette](https://example_company-org.example_company.io/example_company-roulette/?sortKey=stats.avg7&order=-1&visible=maintainer%7Cdocs) can make accurate suggestions.
...
1. Send a message in the group Slack channels indicating where to find the available mechanisms. For example:
   ...
   https://handbook.example_company.com/handbook/product/ux/technical-writing/#technical-writer-pto for ways to get help.
   For urgent _named time-sensitive task_ matters, ping _named TW_.
   ```

### Merge request queue checks

Before a Technical Writer goes on PTO, the writer or their manager should determine who will check the writer's MR queue. The assigned person should check the queue at least once each day in the [Example Company Review Workload Dashboard](https://example_company-org.example_company.io/example_company-roulette/?sortKey=stats.avg30&mode=show&order=-1&hourFormat24=true&visible=maintainer%7Cdocs).
...
Technical Writers are assigned to review merge requests that contain documentation changes authored by Example Company team members and community contributors. The reviews are assigned by subject matter according to the [Technical Writer assignments](#assignments) to [stage groups](../../product/product-categories/#devops-stages) or other specialties.
...
- Ensure the content meets the guidelines in the [Documentation Style Guide](https://docs.example_company.com/ee/development/documentation/styleguide/).
...
- Ensure the content is clear, discoverable, navigable, and written with the user's perspective in mind.
- Ensure the content meets the guidelines in the [Documentation Style Guide](https://docs.example_company.com/ee/development/documentation/styleguide/).
- Ensure the content conforms to the defined [topic types](https://docs.example_company.com/ee/development/documentation/topic_types/).
- Ensure the content fits well into the larger documentation set and does not duplicate information in other areas.
- For UI text, ensure the content meets the standards defined in the [Pajamas Design System](https://design.example_company.com/) and the [Technical Writer Word List](https://docs.example_company.com/ee/development/documentation/styleguide/word_list.html).
...
- In the Example Company repository, the Contribution guidelines (in the `/development` directory).
- In the Example Company repository, the `doc/solutions` directory. This information is owned by Solutions Architects.
- In the Example Company repository, the blueprint documentation (everything in the `architecture/blueprints` directory).

These items receive a **light** edit:

- Documentation outside of the five main Example Company repositories (Example Company, Charts, Operator, Omnibus, and Runner).
...
- Topic type restructuring efforts (["CTRT"](https://docs.example_company.com/ee/development/documentation/topic_types/))
- OKR work
- UI text
...
In most cases, Technical Writers should use the [Example Company Review Workload Dashboard](https://example_company-org.example_company.io/example_company-roulette/?sortKey=stats.avg7&order=-1&hourFormat24=true&visible=maintainer%7Cdocs) to identify someone for a technical writing review. Be sure the page's filter is set to show only Technical Writers and sort by **Assign events last 7 days**.
...
There are occasions when Technical Writers may be too busy for general team merge request reviews, and need to focus on their groups or other priorities. In those cases, Technical Writers can update their Example Company status by selecting the **Busy** checkbox and adding the 🔴 `:red_circle:`, which prevents their name from appearing in the reviewer roulette.
...
to Example Company projects as part of their role. Not all developers get Maintainer access. Technical
...
- Documentation-related tooling and configuration such as linters, and changes
  to the [`example_company-docs`](https://example_company.com/example_company-org/example_company-docs) project. Engineers
...
For more information about onboarding phases and tasks, see the [Technical Writer onboarding template](https://example_company.com/example_company-org/technical-writing/-/blob/main/.example_company/issue_templates/tw_onboarding.md).
...
We welcome [improvements to content](https://docs.example_company.com/ee/development/contributing/)
as well as to the development of our
documentation website, at https://docs.example_company.com.

For more information about community contributions, see:

- [List of available issues](https://example_company.com/example_company-org/example_company/-/issues/?sort=created_date&state=opened&label_name%5B%5D=documentation&label_name%5B%5D=docs-only&label_name%5B%5D=Seeking%20community%20contributions)
- [Example Company Docs repo](https://example_company.com/example_company-org/example_company-docs)
- [Example Company Docs README file](https://example_company.com/example_company-org/example_company-docs/-/blob/main/README.md)
...
- [Documentation workflows](https://docs.example_company.com/ee/development/documentation/workflow.html) in the contributor documentation.
- [Setting up a local environment](setup/) in the handbook.

### Make an urgent content update on docs.example_company.com

The documentation website is refreshed every hour. On rare occasions, we might have to publish documentation
updates a little faster. If you need an urgent update, follow the steps to [manually deploy the docs site](https://docs.example_company.com/ee/development/documentation/site_architecture/deployment_process.html#manually-deploy-to-production).

### Report a docs website problem or infrastructure issue

Report website bugs or feature requests in the [issue queue for the Docs website](https://example_company.com/example_company-org/example_company-docs/-/issues).

For outages or website availability issues, see [Docs site infrastructure](https://example_company.com/example_company-org/example_company-docs/-/blob/main/doc/infrastructure.md?ref_type=heads).
