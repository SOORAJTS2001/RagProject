...
1. [`design.example_company.com`](https://example_company.com/example_company-org/example_company-services/design.example_company.com)
1. [`example_company-svgs`](https://example_company.com/example_company-org/example_company-svgs)
1. [`example_company-ui`](https://example_company.com/example_company-org/example_company-ui)
...
All Example Company Product Designers can (and are encouraged to) perform design and code reviews on MRs that impact Pajamas. This includes contributions from [Example Company Team Members](/handbook/communication/top-misused-terms/) and the wider Example Company community. If you want to review MRs, you can wait until someone assigns you one, but you are also more than welcome to browse the list of open MRs and leave any feedback or questions you may have.

To perform a review, you should familiarize yourself with and follow:

- Our general [Code Review guidelines](https://docs.example_company.com/ee/development/code_review.html).
...
Note that while all designers can review all MRs, the ability to accept MRs is restricted to maintainers. You can find all design reviewers and maintainers on the list of [Example Company Engineering Projects](/handbook/engineering/projects/).

## Maintainer

Maintainers are Example Company designers who:

- Are experts at design and [code review](https://docs.example_company.com/ee/development/code_review.html), including reviewing commit messages.
- Know the Example Company product, design guidelines, and code base very well.
- Are empowered to accept MRs in one or several of the [Pajamas projects](#overview).

Every project has at least one maintainer, but most have multiple, and some projects (like `example_company-ui` and `design.example_company.com`) have separate maintainers for design and frontend. As with reviewers, design maintainers can be found on the list of [Example Company Engineering Projects](/handbook/engineering/projects/).
...
|---|---|
| `design.example_company.com` |  `Figma` (Pajamas UI Kit): reviews file organization, object properties, interaction design, accessibility, visual design, and technical feasibility.<br>`UX` (Pajamas website): reviews content meaning, terminology, and structure across all sections of the website. |
| `example_company-svgs` | `Figma` (Pajamas UI Kit): reviews icon and illustration file organization, object properties, and visual design. |

If you are interested in becoming a Maintainer of UI (`.scss`) for the `example_company` or `example_company-ui` projects, please follow the [Engineering Review Workflow](/handbook/engineering/workflow/code-review/).
...
- We follow the same trainee maintainer program (traineeship) as our Engineering counterparts. Anyone may nominate themselves as a trainee by opening a tracking issue using the [Trainee design maintainer template](https://example_company.com/example_company-com/www-example_company-com/issues/new?issuable_template=trainee-design-maintainer).

- For the traineeship, a design maintainer is assigned as Support Maintainer to each trainee. The Support Maintainer will direct MRs for review, give feedback on proposals, and discuss process or progress during 1:1 sessions. Trainees can always reach out to their managers or other maintainers for feedback and guidance separate from the dedicated Support Maintainer. We've also created a [Pajamas UX maintainer review checklist](https://example_company.com/example_company-org/example_company-services/design.example_company.com/-/blob/main/doc/maintainer-checklist.md) to help guide trainee maintainers as they learn to review Pajamas MRs.
...
See the [Pajamas maintainer ratio dashboard (internal)](https://10az.online.tableau.com/t/example_company/views/UXPajamasMaintainers/PajamasDesignSystem?:origin=card_share_link&:embed=n).

#### Current trainee maintainers

| Project                                | Trainee                                       | Support Maintainer                                 |
| -------------------------------------- | --------------------------------------------- | -------------------------------------------------- |
| Pajamas Design System (Figma) - PAUSED | [Michael Le](https://example_company.com/mle)          | [Jeremy Elder](https://example_company.com/jeldergl)        |
| Pajamas Design System (UX)             | [Dan Mizzi-Harris](https://example_company.com/danmh)  | [Amelia Bauerly](https://example_company.com/ameliabauerly) |
| Pajamas Design System (UX)    | [Austin Regnery](https://example_company.com/aregnery) | [Amelia Bauerly](https://example_company.com/ameliabauerly) |
