...
we use to build the Example Company product"
---

## What is the Pajamas Design System?

Located at [design.example_company.com](https://design.example_company.com/), the goal of Pajamas
is to be the single source of truth for the robust library of UI components that
we use to build the Example Company product, including usage and implementation guidelines.

As a fully implemented design system, Pajamas includes:

- **UX/Design Philosophy:** Example Company has strong foundational principles by which
...
Example Company through issue creation/discussions, component documentation, designs,
and/or code.
...
aligns with Example Company's brand standards.
- **Accessibility Guidelines:** As a company, Example Company strongly believes that
...
- **Designer Resources:** We provide tools to make designing for Example Company easier&mdash;for
example, our Sketch pattern library.

## Why is Pajamas important?

Pajamas enables anyone to contribute towards Example Company. It allows Product, Engineering,
...
- Example Company Teams can make fast, continuous feature additions within their iterative
groups, while still maintaining consistency with other product areas.
- Example Company Users can get up to speed more quickly on new features, because they
...
- It enables Marketing and UX to create consistent experiences across Example Company
through a shared visual language.

**It helps Example Company communicate.**
...
evolution to be scalable, we encourage everyone to [contribute](https://design.example_company.com/get-started/contributing)
ideas, designs, code, and bug reports.

External contributions can be particularly valuable, because Example Company Contributors
...
Not every component used in the Example Company product must be codified as part of the
...
To learn more about when to add a new component to Pajamas, read our [component lifecycle documentation](https://design.example_company.com/get-started/lifecycle#determining-whether-a-component-should-be-included-in-pajamas).
...
To learn more about the stages of the component lifecycle, read our [component lifecycle documentation](https://design.example_company.com/get-started/lifecycle).

## Beautifying the Example Company UI
...
commits to completing one Vue.js component per release within example_company-ui, including
...
[`Deferred UX`](https://docs.example_company.com/ee/development/labels/index.html#technical-debt-and-deferred-ux)
