...
- Please create a new Apple ID for Example Company using your @gitLab.com email address to keep your personal and work data separate. You can also reimburse apps using an Apple ID created with your Example Company account. Your Apple ID consists of an email address and a password. It's the account you use for everything you do with Apple—including using the App Store, Apple TV app, Apple Book Store, iCloud, Messages, and more.
...
MacBook: You are required to install Jamf on your MacBook for security and compliance reasons. Please check [this guide](https://internal.example_company.com/handbook/it/endpoint-tools/jamf/#enrolling-in-jamf) for assistance!
