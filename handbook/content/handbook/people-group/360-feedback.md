...
- **(optional)** We have a [Feedback Training enablement issue](https://example_company.com/example_company-com/people-group/Training/-/blob/master/.example_company/issue_templates/feedback_training.md) available for all team members interested in learning more about giving and providing feedback, in addition to our 360 feedback process. We recommend team members that are requesting feedback or providing feedback complete this training.
...
We utilize [Culture Amp](https://example_company.cultureamp.com/) to administer 360 Feedback. The 360 Feedback cycle in CultureAmp consists of a Self review, Manager review and Peer reviews.
...
The options shown align with [Example Company Competencies](/handbook/people-group/competencies/#list):
...
- Using Example Company: Uses Example Company effectively for day-to-day work, opening, commenting and moving issues, submitting merge requests, and leveraging epics when appropriate.
- Other.

#### Manager Feedback

Direct reports of managers that participate in the 360 feedback process will be asked to rate where their manager should better focus their efforts in order to support the team. Specific areas for rating are related to Example Company's [manager and leadership competencies](/handbook/people-group/competencies/#manager-and-leadership-competencies). The rating scale is a normalized, 5-point scale from "much less focus" to "much more focus," with an option for additional comment.
...
Reviewers can be managers, direct reports or co-workers(no participants outside of Example Company). Here are some best practices for selecting reviewers:
...
- Due to licensing, provisioning and security concerns we cannot include external stakeholders that are not Example Company team members in the 360 feedback process.
...
In addition to our [Guidance on Feedback]({{< ref "guidance-on-feedback" >}}) handbook page, we have a [Feedback Training issue available](https://example_company.com/example_company-com/people-group/Training/-/blob/master/.example_company/issue_templates/feedback_training_issue) for all team members interested in learning more about giving and receiving feedback, in addition to our 360 Feedback process.
...
- This should be a conversation - remember to be an active listener. As a manager, you can help your team member process and understand the feedback, helping to avoid over/under reactions or defensiveness. Ask questions such as:
    ...
    1. What are you hoping to achieve at Example Company this coming year?
...
1. Where can I give feedback about the 360 feedback process?
   1. Team members are encouraged to contribute to [this issue](https://example_company.com/example_company-com/people-group/people-operations/General/-/issues/1595) with feedback based on their experience in the 360 feedback process.
