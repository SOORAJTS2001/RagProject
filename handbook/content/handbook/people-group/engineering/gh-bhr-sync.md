...
description: "Information on the Greenhouse and BambooHR sync for Example Company team members and their profiles."
---
...
Whenever a candidate is marked as hired, a webhook is send to the [conservatory app](https://example_company.com/example_company-com/people-group/peopleops-eng/conservatory).
...
| Mapped by Greenhouse entity using [this file](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/entity_mapper.yml) | `customEmployeeCorptoCorp` |
...
| Mapped by Greenhouse entity using [this file](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/entity_mapper.yml) | `location` |
...
| Mapped by Greenhouse offer entity using [this file](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/entity_mapper.yml) | `customType` |
...
It follows the process that is outlined in the [handbook](https://internal.example_company.com/handbook/people-group/people-operations/people-connect/onboarding_process/#adding-a-new-team-member-to-bamboohr). When there are changes in probations, a
change should also be made to [this file](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/entity_mapper.yml).
...
Open issues can be found [here](https://example_company.com/groups/example_company-com/people-group/peopleops-eng/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name%5B%5D=p-hiring-exception-tool).
If you want to add another field to the sync, feel free to [create a new issue](https://example_company.com/example_company-com/people-group/peopleops-eng/people-group-engineering/-/issues/new?issuable_template=Engineering_Request).

### Missing Team Member

In case a hire wasn't synced an alert will be sent to the [`#peopleops-alerts`](https://example_company.slack.com/archives/CLTBQ9XC7) Slack channel, in which a People Group Engineer will be able to manually re-sync the new team member after correcting malformed fields.
