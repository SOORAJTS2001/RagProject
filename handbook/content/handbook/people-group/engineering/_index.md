...
description: "Information about Example Company's People Group Engineering team and its projects, workflow, and sources of data."
---

## Overview

As Example Company continues to scale, our need for tools and automation to manage our growth expands
...
- Manage the code that runs the [Employment Bot](https://example_company.com/employment-bot)
...
[creating an issue](https://example_company.com/example_company-com/people-group/peopleops-eng/people-group-engineering/-/issues/new)
in the People Group Engineering project. All issues are reviewed and prioritized to a specific team through our [kanban board](https://example_company.com/groups/example_company-com/people-group/peopleops-eng/-/boards/2641488). If you require general support with MR's, kindly collaborate with all of Example Company team members in [`#mr-buddies`](https://example_company.slack.com/archives/CLM8K5LF4) in slack.
...
If you are looking to bring the People Group Engineering team into a discussion/issue/merge request on Example Company, please utilize our group tag: `@gl-people-engineering` to ping the appropriate team members.

### Report bugs

If you want to report bugs about existing integrations, you can use any of the following templates:

- [Bug with a /pops command](https://example_company.com/example_company-com/people-group/peopleops-eng/employment-automation/-/issues/new?issuable_template=bug_pops_command)
- [Bug with the Greenhouse <> BambooHR sync](https://example_company.com/example_company-com/people-group/peopleops-eng/conservatory/-/issues/new?issuable_template=bug_with_sync)
- [Bug with Nominations](https://example_company.com/example_company-com/people-group/peopleops-eng/nominatorbot/-/issues/new?issuable_template=general_bug)

#### Urgent attention

We have monitoring setup in case some of our applications are no longer accessible. This is the case for **all** of our integrations. This will trigger notifications to the People Group Engineer(s). If you need our immediate attention, feel free to use our [`#peopleops-eng`](https://example_company.slack.com/archives/CNDBF4DFT) Slack channel. Avoid pinging people directly unless there is a real urgency to the matter.

### Our workflow

The [People Group Engineering board](https://example_company.com/groups/example_company-com/people-group/peopleops-eng/-/boards/2641488)
...
- determine the team label `PopsEng::Team::Tech`, `PopsEng::Team::Engineering`, etc). You can also find a Example Company board, with the issues sorted by team [here](https://example_company.com/groups/example_company-com/people-group/peopleops-eng/-/boards/3107533).
...
can be found [here](https://example_company.com/groups/example_company-com/people-group/peopleops-eng/-/boards/2641488). The column
...
- [Compensation Calculator](https://example_company.com/example_company-com/people-group/peopleops-eng/compensation-calculator/)
...
- Workday: their database acts as the single source of truth for everything related to the team member. We make use of a [custom middleware](https://example_company.com/example_company-com/people-group/peopleops-eng/connectors-gem/) from the [People Group Engineering Team](https://example_company.com/example_company-com/people-group/peopleops-eng/)'s Ruby gem, and interact with Workday using a bot user with limited access to employee details.
- Greenhouse: this is our single source of truth for everything related to candidates (so before
 they are hired). We make use of a [fork](https://example_company.com/example_company-com/people-group/peopleops-eng/greenhouse_io/) from the [Greenhouse](https://github.com/grnhse/greenhouse_io) Ruby gem, and interact with Greenhouse using a user with access to candidates details.
...
the public project to a private project on [ops.example_company.net](https://ops.example_company.net/).
...
to be invited to the [employment-automation](https://ops.example_company.net/example_company-people-engineering/employment-automation/)
...
first have to connect your Example Company account. You can click the provided URL and authorize. Now you are able to run
the `/pops` commands.
