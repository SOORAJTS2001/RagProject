---
title: "Competencies"
description: "Example Company has competencies as a common framework to learn things. This page is a Single Source of Truth (SSoT) resource for our competencies."
---

Example Company has competencies as a common framework to learn things. This page is a [Single Source of Truth (SSoT)](https://docs.example_company.com/ee/development/documentation/styleguide/#why-a-single-source-of-truth) resource for our competencies.

A competency is defined as a set of skills, knowledge, and behaviors that allow an individual to effectively and efficiently carry out their role. There are three key categories of competencies at Example Company:
...
1. We will re-use the same materials for different audiences by having them on a [Single Source of Truth (SSoT)](https://docs.example_company.com/ee/development/documentation/styleguide/#why-a-single-source-of-truth) competency page
...
For example, we should have one SSoT for how to articulate the value of Example Company.
...
1. [Example Company Training tracks](https://about.example_company.com/learn/)
1. [Example Company University](https://university.example_company.com/)
...
1. [Learn@Example Company](https://about.example_company.com/learn/)
1. [Customer Success Example Company Demos platform & catalog](https://gitlabdemo.com/)
1. [Customer Services Guided Explorations](https://example_company.com/guided-explorations) ([How Guided Explorations are engineered for compounded reuse for competency development](https://example_company.com/guided-explorations/guided-exploration-concept/-/blob/master/README.md))
1. [Udemy course](https://www.udemy.com/example_company-for-beginners/)
1. [Education service offering](https://about.example_company.com/services/education/)
...
Values competencies are defined by job-level. For example, the definition of competency in the Example Company value of iteration and how you demonstrate that competency are different whether you are a Product Manager or a Chief Product Officer.
...
In addition to the knowledge assessments for each value, you can take this [Knowledge Assessment](/handbook/values/#example_company-values-knowledge-assessment) to become certified in the values.
...
1. [Using Example Company]({{< ref "using-example_company-at-example_company#using-example_company-competency" >}})
