...
Epics let you manage your portfolio of projects more efficiently and with less effort by tracking groups of issues that share a theme, across projects and milestones. Epics are great for [project management](/handbook/marketing/project-management-guidelines/epics/) as they help to better [enhance your workflow](https://about.example_company.com/blog/2020/01/21/epics-three-features-accelerate-your-workflow/).
...
**Issues** - medium for collaborating on ideas and planning work in Example Company
...
In Example Company 101, we learned how to [create merge requests]({{< ref "example_company-101#lesson-3-example_company-merge-requests" >}}). In this lesson, we will dive deeper into merge requests.
...
1. Navigate to www-example_company-com project
...
1. To locate the handbook on example_company.com, navigate to `www-example_company-com` project, click sites - handbook - source - handbook. Click the section of the handbook you want to navigate to (eg people group, marketing), the folders are arranged alphabetically.
