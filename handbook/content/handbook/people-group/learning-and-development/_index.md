...
*Why we exist:* Example Company Talent Development (commonly referred to as "Learning & Development") exists to enhance team member performance, expand capabilities, and further develop skills that make Example Company team members the top talent in the industry. We strive to foster a culture of continous growth so that Example Company remains a great place to work. Positive impact on team member experience leads to a positive impact on results, which leads to a positive impact on Example Company customers.

### Vision

*Where are we going:* Example Company seeks to be recognized as a top organization for remote learning & development. We aim for a future where **everyone contributes** to a culture of curiosity.
...
1. **Values aligned.** Our learning solutions reinforce Example Company's [values](/handbook/values/) and foster continuous learning and curiosity.
...
We are a small team, but we've got a big role to play at Example Company!

- [Learning and Development Director](/job-families/people-group/learning-development#learning--development-manager): [Tre Ely]({{/handbook.example_company.com/handbook/company/team/#tely2}})
...
<div class="flex-row" markdown="0">
  <div>
    <a href="https://handbook.example_company.com/handbook/sales/field-manager-development" class="btn btn-primary" style="width:200px;margin:5px;">Field Manager Development</a>
...
### Partnerships at Example Company
...
1. Email Us: `learning@example_company.com`
1. [Request support/Collaborate on new learning content]({{< ref "work-with-us" >}})

### Work With Us

The [work with us]({{< ref "work-with-us" >}}) page outlines issue templates and processes that are managed on our [Learning and Development issue board](https://example_company.com/example_company-com/people-group/learning-and-development/-/issues). We review and classify requests based on the scalability and possible organizational impact. Learning solutions that can be applied and used company-wide take priority. Our process includes:
...
The L&D team uses Example Company issue boards to track priorities, organize collaboration, and set due dates based on three-week sprints.

- The L&D team uses [this sprint issue board](https://example_company.com/groups/example_company-com/people-group/learning-development/-/boards/1958538) to track priority issues each quarter.
...
Additional planning and notes around the sprint board can be found in [this issue.](https://example_company.com/example_company-com/people-group/learning-development/general/-/issues/111)
...
- Consider having Example Company team members vote on priority issues to determine need and interest in learning & development content.
...
The L&D team freqently uses the following tools for creating and communicating learning opportunities at Example Company.
...
In July 2024, Example Company published the first iteration of our [Learning Content Accessibility Guidelines](handbook/legal/ethics-compliance-program/learning-content-accessibility-guidelines/).
...
The launch of the Example Company Learn LXP was awarded a Silver Excellence in Learning by the [Brandon Hall Group](https://excellenceawards.brandonhall.com/) for the Best Launch of a Corporate Learning University.
