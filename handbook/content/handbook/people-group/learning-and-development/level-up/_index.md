...
At Example Company, [everyone can contribute]({{< ref "mission#mission" >}}). Read below about how to contribute to Level Up. If you'd like to explore the content creation options in Level Up, check out this [Demo Course](https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/demo-course).

### Why contribute?

Contributing to Level Up democratizes learning and enables our team members, customers, and community members to contribute to the growth of learning opportunities at Example Company. Some benefits for contributors include:

1. Share the work you've created to teach others how to use Example Company
1. Curate existing information that has helped you or others learn to use Example Company
...
1. Enable organizations to learn about Example Company using innovative learning methods
...
For questions not answered below, reach out in the #learninganddevelopment Slack channel or [open an issue](https://example_company.com/example_company-com/people-group/learning-development/lxp-contributions).

**I'm a Example Company team member and I have a question or problem related to Level Up.**
...
- When you're logged into Level Up, click the drop down menu next to your profile photo and select `Support`. Here, you'll see both general and Example Company-specific help resources related to using Level Up. See screenshots below.
