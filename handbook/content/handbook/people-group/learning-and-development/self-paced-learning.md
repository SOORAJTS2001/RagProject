...
description: "Details of third-party training providers utilised by various Example Company departments"
---

Teams around Example Company utilize other training providers for accessing role specific training courses and learning materials. This handbook page lists the different providers used, including details on access and licensing.
...
- If you are unable to log in from the Okta O'Reilly App, please contact [#it_help](https://example_company.slack.com/archives/CK4EQH50E) with the AR number you created using the link above.

#### Development

- If the O'Reilly App isn't listed on Okta, please contact [Tim Zallmann](https://example_company.com/timzallmann) or [John Hope](https://example_company.com/johnhope) via Slack or Email to be added to the corresponding Google Group.
...
Once you have an active license, we have a content integration set up in [Example Company Learn](https://example_company.edcast.com/), so you can find and filter O'Reilly content using the search function, alongside all our other self-paces learning materials.

You can also access via the [O'Reilly platform](https://www.oreilly.com/online-learning/) directly.

## Linux Foundation Courses

Example Company has access to the Linux Foundation [Course Catalog](https://training.linuxfoundation.org/full-catalog/) and certification programs. We have a 60 seat subscription that will be granted to team members who required related course offerings to achieve their career development goals at Example Company. Each license includes 2 free exams. After the exams are used, team members can use their Growth and Development benefit to purchase additional exams at a 25% off discount.
...
- For new accounts, check your email and validate your email address. Please use your `@example_company.com` email address-
...
**I'm not sure if I did something wrong but how do I actually access the courses? I signed up with my Example Company email address, used the redemption code - But when I go to view the catalog all the courses still show the full amount and the certification code only works for the exam itself and not the course.**

Please send an email to `mcampbell@linuxfoundation.org` with your name and email address, cc'd `jallen@example_company.com` for the email. This should not be the case but Linux can have a look at their ID and make sure their access was triggered properly.
...
> For a Example Company Linux Foundation licenses, your Access Request must mention [which career goal you'll work towards using your license]({{< ref "#sign-up" >}}). Please add this information to the AR and tag me for review upon completion.
...
> Your access to the Linux Foundation has been approved! Please follow these [instructions](#learning-portal-access) to set up your account using your Example Company email address. Your unique and case sensitive access code is `XXXX`. You only need this code for your initial login. Let me know if you have any questions.
...
As a GCP Partner, Example Company has *unlimited* seats to Google Cloud's [Skills Boost Platform for Partners](https://partner.cloudskillsboost.google/catalog). This portal includes a wide array of learning materials related to Google Cloud's offerings, ranging from introductory to advanced.
...
Any current Example Company team member can gain access to the learning platform by filling out [this form](https://inthecloud.withgoogle.com/partner-training/request-training-resources.html). Required information includes your first and last name, your Example Company email address, a phone number, and your location. While it asks you to identify areas of interest, this is optional, and you are not limited to just the area of interest you've indicated.
