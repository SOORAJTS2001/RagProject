...
The program was awarded a Gold Excellence in Leadership Development by the [Brandon Hall Group for the Best Unique and Innovative Leadership Development Program](https://brandonhall.com/brandon-hall-group-announces-winners-of-the-excellence-in-technology-awards-for-2021/). Brandon Hall operates the largest and longest running awards in Human Capital Management. The Example Company program was evaluated by a panel of learning and development veterans, senior industry experts, analysts, and executives. L&D is thrilled to have been recognized for this achievement!
...
- Apply and learn Example Company Leadership best practices into your management role
...
In addition, the program ties into Example Company's strategic priorities through the following:

1. Mitigating concerns associated with:
     1. [Lack of Performance Management](https://internal.example_company.com/handbook/leadership/mitigating-concerns/#underperformance)
     1. [Ineffective Management](https://internal.example_company.com/handbook/leadership/mitigating-concerns/#ineffective-management)
1. Achieving Example Company Strategy of:
...
The program is intended to build a set of baseline skills that complement our values to enable Managers to lead teams at Example Company.

**How will it help**

Learn the basic principles of what it means to be a manager using a whole-person approach to leadership. The curriculum was built using principles from the book High Output Management, interviews with senior leaders, and Example Company management practices.
...
See the video below for a quick overview of how we use Example Company to facilitate manager enablement
...
1. **Will I receive a certification?**
    - Yes! Once you complete all challenges, attend the live learning sessions, and complete the self-reflection activities, you will receive the "Example Company Managers Challenge" certificate.

### Manager Challenge Certification

Following the completion of the Example Company Manager Challenge program, participants will be [awarded a certification](https://about.example_company.com/learn/certifications/public/)! The certification will be sent to a team member who has completed at least 80% of the daily challenges. Once a team member receives a certification, they can post it on their LinkedIn Profile.

## Testimonials

What people leaders at Example Company learned during the program:
...
1. "I learned that there are so many amazing managers here at Example Company. Each of the days' comments were treasure troves into how to approach something differently or new techniques that others have found success with."
...
The Manager Challenge Pilot is set up within the Example Company Tool. We are using Epics, Sub Epics, and Issues. There is one main Epic for the whole program, a Sub Epic for each week, and then an Issue for each day.

**Example of Manager Challenge Pilot Set Up:**

[Manager Challenge Pilot - Epic](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/1)

[Week 1 - Manager Challenge Pilot - Sub Epic](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/2)

[Manager Challenge Project](https://example_company.com/example_company-com/people-group/learning-development/manager-challenge)

[Manager Challenge Program Pilot: Day 1 - Issue](https://example_company.com/example_company-com/people-group/learning-development/manager-challenge/-/issues/1)
...
- Daily
  - Create the Day's Issue in the [Manager Challenge Project](https://example_company.com/example_company-com/people-group/learning-development/manager-challenge) using the [manager-challenge-daily-template](https://example_company.com/example_company-com/people-group/learning-development/manager-challenge/-/blob/master/.example_company/issue_templates/manager-challenge-daily-template.md)
  - Monitor the issue comments to respond to questions as well as keep track of participation

### Communication

The modes of communication during the challenge include Slack and Example Company. Ensure that there is a specific channel in Slack set up for challenge members, as well as a group tag in Example Company.
...
In September 2020, the L&D team piloted the Manager Challenge to a group of People Leaders in People Success, Engineering, and Product. Learn more about the pilot content by [reviewing the pilot epic](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/1).
...
- [2021 October Manager Challenge](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/58)
- [2021 May Manager Challenge](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/38)
- [2021 January Manager Challenge](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/26)
- [2020 September Manager Challenge Pilot](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/1)
