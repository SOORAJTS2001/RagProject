...
Elevate: a live virtual leadership development program for Example Company managers, focused on understanding leadership competencies, building emotional intelligence, giving and recieving great feedback, coaching, and recognizing unconscious bias.

Managers at Example Company enable our mission that [everyone can contribute]({{< ref "mission" >}}). We need to equip our people leaders with the skills to lead globally dispersed, all-remote teams to support our business growth at scale.

The handbook provides guidance on Example Company [leadership competencies](/handbook/people-group/competencies/#manager-and-leadership-competencies) and principles. Bringing these practices to life requires training and practice. **Elevate**, Example Company's leadership development program, provides opportunity for people leaders to learn to lead at Example Company.
...
In FY24, 85% of people leaders will complete Elevate and earn the Example Company Elevate certification.
...
Elevate is a highly interactive, all-remote program where managers will learn with, and from, each other. The goal is to provide a common, well understood leadership framework which demonstrates Example Company [values](/handbook/values/), [leadership competencies](/handbook/people-group/competencies/#manager-and-leadership-competencies), and [mission]({{< ref "mission" >}}).

In Elevate, participants will:

1. Learn what it means to lead at Example Company
...
| Step 3 | Group Coaching | Cross-functional group coaching sessions with 10-12 other Example Company people leaders to practice module concepts | 80 minutes |
...
The certification for Elevate is not meant to be scary! It's a time to demonstrate everything you've learned and celebrate your new skills and self awareness as you continue to grow as a leader at Example Company.
...
Yes, this is a required training for all people leaders at Example Company.
...
The [Manager Challenge]({{< ref "manager-challenge" >}}) is a past iteration of leadership development at Example Company. We appreciate the time that past manager challenge participations have dedicated to their growth and development. Elevate is the next iteration in our Example Company manager journey, and is still required of manager challenge participants.

### When I complete this program will I earn a certificate?

Yes! Upon successful completion of the program, including attendance to all required live sessions, asynchronous learning, and assessments, participants will be awarded the Example Company Elevate certification.
...
In addition, there is a Level Up course available to all Example Company Team Members, to share the self-paced training content for each Elevate module. You can check it out here: [Elevate Learning Materials](https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/learning-path/elevate-learning-materials)
...
1. [Use the #new-elevate-cohort issue template](https://example_company.com/example_company-com/people-group/learning-development/general/-/tree/master/.example_company/issue_templates) whenever you start a new round of Elevate
