...
Example Company team members are eligible for a reimbursement of up to $10,000 USD per calendar year (January 1st - December 31st) for approved Growth & Development experiences. Utilizing the Growth & Development Fund does have requirements related to tenure, performance, identified skills, and available budget.
...
- Full time Example Company employee (with a minimum tenure of 3 months)
...
|------------------|----------------------|
|[Academic Study](https://example_company.com/example_company-com/people-group/learning-development/growth-and-development-requests/-/issues/new?issuable_template=g-and-d-academic-study)|30 days before the commencement date|
|[Conference](https://example_company.com/example_company-com/people-group/learning-development/growth-and-development-requests/-/issues/new?issuable_template=g-and-d-conference)|30 days before the commencement date|
|[Other G&D Types](https://example_company.com/example_company-com/people-group/learning-development/growth-and-development-requests/-/issues/new?issuable_template=g-and-d-other)|7 days before the commencement date|
|[Coaching Right Now (Example Company's coaching vendor of choice)](https://example_company.com/example_company-com/people-group/learning-development/growth-and-development-requests/-/issues/new?issuable_template=g-and-d-coaching) Learn more about Coaching Right Now below. | 30 days before the commencement date|
| Your 4th Trimester | For Your 4th Trimester applications, please notify Talent Development that you would like to participate in the program by sending an email to `growth-development@example_company.com`. |

The application process is visible internally. If there is any reason that you would like to keep your application confidential, please send `growth-development@example_company.com` an email with the details of your application (refer to the issue templates for the information required).
...
1. The team member can submit the proof of payment in a Navan expense request, and the approved Example Company issue, to receive a reimbursement of 50% of the total costs.  When submitting in Navan, please state explicitly in the `Description` section of your expense claim that this is for a 50% reimbursement, with a link to your approved G&D issue.
...
If you voluntarily terminate employment with Example Company prior to completing twelve consecutive months of active employment, academic study or tuition expenses of $1,000 USD and over will need to be refunded to Example Company.
...
Budget estimations for the Growth & Development Fund are based on utilization rates from past years, adjusted for the size of the company. The budget is managed on a company-wide scale, not division-specific. For example, approving reimbursement for a team member in Engineering does not "take away" budget from other engineers. Eligibility is managed on an individual basis. Eligibility for the fund is part of each Example Company team member's Total Rewards package.
...
For example, in the United States 2021 tax year, if Example Company pays over [$5,250 for educational benefits for you during the year, you must generally pay tax on the amount over $5,250](https://www.irs.gov/newsroom/tax-benefits-for-education-information-center). Example Company should include in your wages (Form W-2, box 1) the amount over $5,250 in income.

Please contact [Payroll](mailto:payroll@example_company.com) for any tax-related questions in your country.
...
Eligibility for Reimbursement: Team members returning from Parental Leave. The provider will invoice Example Company directly.
...
[Coaching Right Now](https://docs.google.com/document/d/188H3iuIY9JwE4kmAeoLobNz-e6j-rKie/edit?usp=sharing&ouid=113211236094818760555&rtpof=true&sd=true) connects team members with Example Company-vetted coaches - [read their coaching bios here](https://drive.google.com/file/d/1_5q7aq4diWsXq0O9csQF40skZV4f_L_L/view?usp=drive_link). Team members can book 4, 6, or 8hrs of coaching. Availability is first come, first served. Pairing with a coach via Coaching Right Now saves time and energy looking for a coach that is aligned to Example Company values and way of working.

> Hear what Example Company team members are saying about Coaching Right Now:

- `My coach was thoughtful and insightful. He took the time to learn about me, my wants and desires. He was able to provide actionable feedback and made the last 4 months of Example Company much better.`
...
Apply for a coach via Coaching Right Now by opening an issue using the [coaching template](https://example_company.com/example_company-com/people-group/learning-development/growth-and-development-requests/-/issues/new?issuable_template=g-and-d-coaching).

*The specifics of your coaching sessions will not be communicated to Example Company.* While not required, we encourage you to share your experience, learnings, reflections, and discoveries with your manager for further support.

**Eligibility for Reimbursement:** Managers or Individual Contributors job grade 8+. Coaching Right Now will invoice Example Company directly. If a team member is involved in a different, approved coaching engagement outside of CRN, then the standard G&D reimbursement workflow applies.

Coaching Right Now is our preferred and vetted coaching partner. If for some reason the coaches offered via Coaching Right Now do not fit your needs, please open an issue using the [Other G&D Types (Under $300 USD) template](https://example_company.com/example_company-com/people-group/total-rewards/-/issues/new?issuable_template=other-GD-under). After approvals, team members will provide a paid invoice to Example Company as proof for reimbursement.

### English Language Courses

**Description:** As Example Company expands globally, we want to support our team members where English may not be their first language. Managers are encouraged to recommend this to team members whose engagement as a part of Example Company and/or performance may be improved by further developing their English language skills.
...
We encourage people to be speakers in conferences. More information for people interested in speaking can be found on our [Example Company Speaker Resources](/handbook/marketing/corporate-communications/speaking-resources/).

**Eligibility for Reimbursement:** Before scheduling any travel or time off to attend a conference, please discuss your request with your manager. The manager will approve the request if the conference is work-related and the timing doesn't interfere with Example Company deliverables. After discussing with your manager, create a [Growth & Development issue](/handbook/total-rewards/benefits/general-and-entity-benefits/growth-and-development/#how-to-apply-for-growth-and-development-benefits). Once all required approvals are given on the issue, travel can be scheduled. Please review current [Example Company travel policy](/handbook/finance/travel/) for the most up-to-date information about booking and planning conference travel.
...
**Description:** Example Company supports team members who wish to continue their growth within their professional career. The course must be related to your career development goal, Individual Growth Plan (IGP), and/or serves the [mission]({{< ref "mission" >}}) of Example Company as a company.
...
**Description:** The company will pay for courses related to learning how to code (for example Learning Rails on Codecademy), and you may also allocate work time to take courses that interest you. If you are new to development, we encourage you to learn Git through Example Company, and feel free to ask any questions in the #git-help Slack channel.
...
In some instances, [mentorship resources provided by Example Company](/handbook/people-group/learning-and-development/mentor/) might not fit team member's needs. For example, a team member might be unable to find a mentor at Example Company with the specific experience, identity, or role they are looking for. In these cases, the Growth and Development fund can be used to cover the cost of meeting with a **paid, external mentor.**
