...
description: "Resources and direction for career development and mobility for all Example Company team members"
---

## What is Career Development

Career development is the non-linear, lifelong growth process integrating learning, work, leisure, and change. It happens in all directions, including subject matter expertise, lateral growth to new teams, and linear growth through a job family. Use the recources on this page to navigate your career growth at Example Company.

![infographic with examples of career growth at example_company](non-linear.png)

## Directory

Navigate to career development resources located throughout the Example Company handbook:
...
<div class="flex-row" markdown="0">
  <div>
    ...
    <a href="https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/igp" class="btn btn-primary" style="margin:5px;">How to use the IGP</a>
  </div>
</div>
...
<div class="flex-row" markdown="0">
  <div>
    ...
    <a href="https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/teamops" class="btn btn-primary" style="margin:5px;">TeamOps Certification</a>
    <a href="https://about.example_company.com/company/culture/inclusion/tmrg-example_company-women/" class="btn btn-primary" style="margin:5px;">#IamRemarkable Workshop</a>
    <a href="https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/igp" class="btn btn-primary" style="margin:5px;">Individual Growth Plan Course</a>
  </div>
</div>
...
<div class="flex-row" markdown="0">
  <div>
    ...
    <a href="https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/support-your-team-with-career-conversations" class="btn btn-primary" style="margin:5px;">Support your Team with Career Conversations Course</a>
    <a href="https://example_company.com/example_company-com/www-example_company-com/-/issues/13409" class="btn btn-primary" style="margin:5px;">Manager M Groups</a>
    <a href="https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/mitigating-risk" class="btn btn-primary" style="margin:5px;">Mitigating Risk Course</a>
    <a href="https://example_company.com/example_company-com/www-example_company-com/-/issues/13409" class="btn btn-primary" style="margin:5px;">Manager M-Team Groups</a>
    <a href="https://levelup.example_company.com/learn/course/getting-to-know-yourself-and-your-team" class="btn btn-primary" style="margin:5px;">Get to Know Yourself and your Team Course</a>
  </div>
</div>
...
<div class="flex-row" markdown="0">
  <div>
    ...
    <a href="https://handbook.example_company.com/handbook/finance/growth-and-development/cfo-shadow-program/" class="btn btn-primary" style="margin:5px;">CFO Shadow</a>
    <a href="https://handbook.example_company.com/handbook/marketing/cmo-shadow/" class="btn btn-primary" style="margin:5px;">CMO Shadow</a>
    <a href="https://handbook.example_company.com/handbook/engineering/fellow/shadow/" class="btn btn-primary" style="margin:5px;">Engineering Fellow</a>
    <a href="{{< ref "security-shadow" >}}" class="btn btn-primary" style="margin:5px;">Security Team Shadow</a>
    <a href="https://example_company.com/example_company-com/support/support-team-meta/-/blob/master/.example_company/issue_templates/Support%20Shadow%20Program.md" class="btn btn-primary" style="margin:5px;">Support Team Shadow</a>
  </div>
</div>
...
| Example Company Supported | - Communicate future direction and skills requirements <br/> - Provide information and tools when applicable <br/> - Communicate internal opportunities |
...
1. 10% of your development should come from training, including classes, seminars, webinars, podcasts, reading, conferences, etc. Example Company offers a [growth and development benefit](/handbook/total-rewards/benefits/general-and-entity-benefits/growth-and-development) to help with this.

### Career Development versus Career Mobility

Example Company team members [should not feel pressure to climb the career ladder]({{< ref "1-1#key-points" >}}). Skill development and promotion are not mutually exclusive. [Unique experience influences problem solving](/handbook/company/culture/inclusion/) and views of success.
...
<div class="flex-row" markdown="0">
  <div>
    <a href="https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/how-to-use-the-example_company-individual-growth-plan-igp" class="btn btn-primary" style="margin:5px;">Short Course: How to use the IGP</a>
    <a href="{{< ref "igp-guide" >}}" class="btn btn-primary" style="margin:5px;"> Handbook: The Example Company IGP Guide </a>
...
Watch: interview with a Example Company team member who's used the Individual Growth Plan to plan a career transition at Example Company.
...
1. Update progress against your development goals. The IGP and [development goals in Workday](https://docs.google.com/document/d/1qEqTHx_G1uIPQi8rIIbrHjJ6S0NYhKDoHeBOLXsjkNw/edit#heading=h.wje1pky1vhig) itself might work well for you, but if you need more structure, consider using [Example Company Epics + Issues]({{< ref "career-development#use-example_company-epics-to-track-your-career-development" >}}) or a [health tracker in Google Sheets]({{< ref "career-development#health-tracker-growth-plan" >}}).

### Tracking your Progress

#### Accomplishment Tracker

Some call it a "brag sheet". Some call it a CREDIT Tracker. Either way, it's a great place to collect your accomplishments and feedback. Utizlize the accomplishment tracker in conjunction with the IGP and Example Company Epics.
...
#### Use Example Company Epics to track your career development
...
1. Refer to [Example 1](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/43) and [Example 2](https://example_company.com/groups/example_company-com/people-group/learning-development/-/epics/47) for inspiration
...
*Watch the full conversation with Camilla Boyer at Example Company [here](https://youtu.be/3pZoNORrDjU)*
...
Team Members: Take the [Support your team with Career Conversations course in Level Up](https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/support-your-team-with-career-conversations) to review the material below!

<div class="flex-row" markdown="0">
  <div>
    <a href="https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/support-your-team-with-career-conversations" class="btn btn-primary" style="width:200px;margin:5px;">Take the Course</a>
  </div>
</div>
...
1. Encourage team members to create an [Individual Growth Plan]({{< ref "career-development#individual-growth-plan" >}}) or use [Example Company Epics to track their career development]({{< ref "career-development#use-example_company-epics-to-track-your-career-development" >}}).
...
1. [Checklist for career conversation prep - Example Company Issue](https://docs.google.com/document/d/11VYcT7vABhrEELNoguQ0XDQ3s1cZ0PNs6KzZw5K3LD0/edit)
...
<table>
  <tr>
    <th>Question</th>
    <th>Answers from the Example Company Team</th>
  </tr>
  <tr>
  ...
  <tr>
    <td>What fears do managers at Example Company have when it comes to having career conversations?</td>
...
- If you are new to Example Company the recommendation is that you start career conversations after your first 90 days.
...
The E-Group will follow a similar process to our Example Company team member process with the additional requirement of a [self review](https://docs.google.com/document/d/1pi-nv6NtMejosVOXlr1O4rZGxmGUzuN01OMnXn5dxKU/edit#).

**Compensation Reviews**

When conducting compensation reviews for the E-Group, Example Company will review two items:
