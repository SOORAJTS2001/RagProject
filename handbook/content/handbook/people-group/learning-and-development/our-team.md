...
The content should be accessible at no cost but anything requiring payment [can be reimbursed following the Example Company Growth and Development policy](/handbook/total-rewards/benefits/general-and-entity-benefits/growth-and-development).

## New Learning and Development Team Members

All new Learning and Development (L&D) team members complete our [team onboarding issue](https://example_company.com/example_company-com/people-group/learning-development/general/-/blob/master/.example_company/issue_templates/new-learning-and-development-team-member.md) in addition to the company onboarding issue to get more familiarized with our team and L&D at Example Company.
