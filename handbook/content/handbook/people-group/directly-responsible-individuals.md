...
description: "Directly Responsible Individuals (DRIs) at Example Company own particular projects, initiatives, or activity."
---
...
As part of a Harvard Business School case study [interview](https://youtu.be/jdN5mj5ieLk) (shown above), Example Company co-founder and CEO Sid Sijbrandij spoke with Professor Prithwiraj Choudhury on various elements of Example Company's all-remote structure, including a question on DRIs.
...
>
> Very explicitly, a DRI [at Example Company] does not have to explain why they're making a decision, and they absolutely do not have to convince other people.
>
...
At Example Company we communicate and work [asynchronously](/handbook/company/culture/all-remote/management/#asynchronous), you can read more about it on [this page]({{< ref "communication" >}}).
...
Giving or receiving feedback is tough and we have looked at this in our previous [Guidance on Feedback Training]({{< ref "guidance-on-feedback" >}}). See also Example Company's [guide to communicating effectively and responsibly through text](/handbook/company/culture/all-remote/effective-communication/).
...
Example Company's implementation of a DRI for decision-making means that we have evolved the RACI matrix to DCI (DRI, Consulted, Informed).
...
- A large cross-functional initiative that has significant reputational or financial implications for the Example Company and its users, such as a pricing initiative
...
1. [Example Company Handbook, Guidance on Feedback]({{< ref "guidance-on-feedback" >}})
