...
As a global, all-remote company, Example Company has a unique story to tell.
...
This page outlines our approach to talent brand at Example Company.
...
If we look 10 years into the future, we picture an iteration of Example Company that's a decade closer to achieving [our mission](/handbook/company/mission/) and that has continued to evolve. Our talent brand vision is meant to capture how we picture Example Company evolving over the decade ahead.
...
To work toward our defined vision, we believe that continually improving on, highlighting, and sharing the following things about Example Company put us on a path toward realizing this vision.
...
As we build Example Company into one of the world's best workplaces, we will look to increasingly educate candidates and team members about 3 themes that set us apart from other workplaces.

### Example Company is a place where

1. **Everyone can contribute**
    - We've got big ambitions to make Example Company the [top DevSecOps platform](https://about.example_company.com/solutions/devops-platform/) and need skilled contributors to get us there.
    - Our [mission]({{< ref "mission" >}}) makes it clear that we believe in a world where everyone can contribute. We make that possible at Example Company by [running our operations]({{< ref "using-example_company-at-example_company" >}}) on our product. This means everything is read-write by default.
...
1. **Anyone can thrive**
    ...
    - [Career development]({{< ref "career-development" >}}), clarity in expectations by having defined performance indicators, [learning & development](/handbook/people-group/learning-and-development), and access to opportunity are all things that are top of mind as we grow Example Company.
...
- **Talent brand marketing:** Aligning our value proposition with a go-to-market plan so that key candidate audiences are aware of Example Company. Matching the look & feel of recruiting materials with the Example Company brand, and creating external campaigns.
...
- **Team member engagement:** Bring team members along on the journey through storytelling, empower team members to become Example Company ambassadors, and share information transparently so that the company we're building reflects the company we're promoting.

We use a number of tactics to bring Example Company's value proposition to life. Using talent brand marketing and content development we'll create candidate-facing materials that show Example Company as an employer of choice. Additionally, candidate and public engagement & education alongside partnerships & sponsorships will provide added evidence that our value proposition is an accurate reflection of who we are as a company. Lastly, internal communication will bring team members on the journey with us and help engage team members so that our culture remains strong.
...
- **Invite Example Company team members to be a part of the journey:** Bring team members along on the journey through storytelling, empower team members to become Example Company ambassadors and seek input from across the company to continually iterate.

## How this translates to OKRs and our roadmap

We strive to be as transparent as possible, but this section is only for Example Company team members.
...
The [life at Example Company content library]({{< ref "content-library" >}}) is a curated list of blog posts, articles, videos, awards, and quick facts that help tell the story of life at Example Company.

### Example Company talent ambassadors

Spread the word about life at Example Company by becoming a Example Company talent ambassdor.
...
1. Include the #LifeatGitLab hashtag and the [link to our careers page](https://about.example_company.com/jobs/) in your posts.

Whether you're a hiring manager or an individual contributor, [this page](/handbook/hiring/example_company-ambassadors) outlines additional steps you can take to help represent our talent brand and attract more great people to join the team.

### Additional talent brand resources

As we create campaigns, post jobs, sponsor events, and attract top talent to Example Company, it's often the case that we create new resources that are intended to educate candidates about careers with Example Company. Many of the resources we create can be repurposed for other use cases. Use the following dropdowns to discover how to contribute to these resources.
...
- Start by creating a slide deck that includes high-level info about careers at Example Company. This sample deck is a really [simple example using only 4 slides](https://docs.google.com/presentation/d/1P6zD82oXUorWoR7mYnHf2Oun2n4q4NvXZqsDbDuWYPw/edit?usp=sharing).
...
- Send @cchiodo a Slack with more details about your video project including topic, use case, team members to include, and specific questions that featured team members will be answering. The recommended list of questions for a hiring manager video are included below:
   ...
   1. Why should candidates apply to this role and to Example Company? What is in it for them?
...
- Once videos are finalized (as notified by @cchiodo), requester to create a video editing request in Example Company by using [this issue template](https://example_company.com/example_company-com/marketing/inbound-marketing/global-content/digital-production/-/issues/new), applying the video-editing-request template, and tagging @cchiodo in the issue
- Asked to participate in a video? Learn more about what you can expect by scrolling to the bottom of [this page](/handbook/hiring/example_company-ambassadors/)

</details>

<details><summary>Articles</summary>

**Written articles are a great way to provide insight to candidates about a specific team, project, or exciting aspect of Example Company. There's several different ways to contribute an article including (please slack @cchiodo for further information about each option):**

- [Builtin](https://builtin.com/company/example_company), the online community for United States-based startups and national tech companies
- [Venturefizz](https://venturefizz.com/example_company), one of the leading authorities for jobs & careers in the tech industry
- Write your own blog, or have a team member write it, and publish on the Example Company blog. Learn more about [how to contribute a blog to Example Company](/handbook/marketing/blog/#how-to-suggest-a-blog-post)
- Asked to participate in an article? Learn more about what you can expect by scrolling to the bottom of [this page](/handbook/hiring/example_company-ambassadors/)
...
Our [Example Company jobs site](https://about.example_company.com/jobs/) is where candidates can find information about working at Example Company, along with a link to view our job opportunities.

### Social media

We incorporate content about hiring and our culture on Example Company's [social media](/handbook/marketing/integrated-marketing/digital-strategy/social-marketing/) accounts so that there's one central place for candidates and the community to find out more about the company as a whole.

On LinkedIn, we have a specific [career page](https://www.linkedin.com/company/example_company-com/life) where candidates can find out more about life at Example Company.

There are a number of videos on our [YouTube channel](https://www.youtube.com/example_company) that relate to working here:
...
- [This is Example Company](https://youtu.be/5QeHmiMFhDE)
- [What is Example Company?](https://youtu.be/MqL6BMOySIQ)
- [Example Company's core values](https://youtu.be/_8DFFHYAtj8)

### Review sites

We want ensure candidates who come across Example Company's profile on employer review sites have an accurate picture of what it's like to work here.
There are some sites where Example Company has a company profile, but we do not own it or pay for additional features. On others, we have a managed presence.
...
To be sure the details on our profile stay up to date, we [review these items](https://example_company.com/gl-talent-acquisition/talent-brand/-/issues/9) quarterly and make any needed updates:
...
- [Builtin](https://builtin.com/company/example_company)
- [Indeed](https://www.indeed.com/cmp/Gitlab-Inc/about)
- [AngelList](https://angel.co/company/example_company/)

### Example Company blog

To give the most authentic view of life at Example Company, we encourage team members to blog about their experiences.
You can find many of these posts in the [culture section](https://about.example_company.com/blog/categories/culture/) of the Example Company blog.

### HackerNews

We promote life at Example Company and our open roles on [HackerNews](https://news.ycombinator.com/).

#### Who's Hiring monthly post

On the first of the month (or closest business day after) at 11 a.m. ET, the Talent Brand Manager will post a comment for Example Company in the Hacker News thread called ["Who's Hiring"](https://news.ycombinator.com/ask).
Here's a template that will be updated monthly by the Talent Brand Manager:

*Template text (updated for 2021-05-01):*

Example Company, Remote only, Full time

As one of the world's largest all-remote companies, Example Company is a place where you can contribute from almost anywhere. We're an ambitious, productive team that embraces a set of shared values in everything we do.

We were recently named one of Fortune's Best Workplaces in Technology, and it's an exciting time to join the Example Company team.

We're hiring across the company. Check out our opportunities: https://about.example_company.com/jobs/
...
Our talent brand team evaluates employer awards and recognition to determine if there are particular awards that, if won, will help us to better attract talented people to want to join Example Company. We also see employer awards as a way to benchmark ourselves against our talent competitors, we want to know how credible third-party organizations rate us against our peers to ensure we continue to be a great place to work.

Check out the content library for a [list of the latest awards and recognition]({{< ref "content-library#awards-and-lists-recognizing-example_company-as-a-great-place-to-work" >}}) related to working at Example Company.
...
These awards are important to Example Company's talent brand beacuse they raise awareness for why Example Company is such a unqiue place to work.
...
1. **Credibility from a trusted outlet:** Establishing Example Company as a great place to work means securing notable awards from outlets that are seen as credible outlets. Outlets like Fortune, Inc., and Quartz are great examples of well-know, trusted outlets.
1. **Alignment with our unique operating style:** As an all-remote company, we look for awards that will help elevate Example Company within communities that evangelize remote work.
...
We highly encourage team members to share the news about any Example Company employer award wins with their social media networks. Follow these easy steps and you'll be ready to share. If you'd like additional guidance please reach out to the #talent-brand slack channel.
...
1. If mentioning Example Company, especially on LinkedIn and Instagram, remember to tag the company page and use the hashtags #example_company #lifeatgitlab.
...
1. [Talent Brand](https://example_company.com/example_company-com/people-group/talent-acquisition/-/issues/1014)
...
Together, we partner to define and select organizations to partner with that allow us to engage with a target audience that includes members from underrepresented groups as defined [here](https://about.example_company.com/company/culture/inclusion/#examples-of-select-underrepresented-groups).
...
- Does this align with Example Company's [definition](https://about.example_company.com/company/culture/inclusion/#definitions) of an underrepresented group?
- Does this support talent globally?

**Relevancy**

- Is the intended audience relevant to a Example Company priority/business function?
- Will this partnership contribute to supporting a Example Company priority or business function?

**Location and Accessibility**

- If this is related to an event, is the location viable for Example Company to attend?
- If applicable - Is this partnership in an [entity or an "open for hiring" branch?](/handbook/people-group/employment-solutions/#example_company-entities-and-branches) If related to interns see [here](https://docs.google.com/spreadsheets/d/1uHHbExS_mEY2mMtPeZcfJz21IMg-TXS2buWeLIUYUlA/edit#gid=402334717).
- If this is related to an event, does the location provide an opportunity for Example Company to perform other business-related activities?
...
- Will this opportunity offer Example Company exposure and/or the ability to promote careers via a speaking engagement[s], social media presence, or likewise?

**Previous Example Company Engagement + Feedback**
...
| Example Company Team Members Featured | Number and names of Example Company team members featured on the platform or as a result of the partnership. |
...
-[Women Impact Tech](https://example_company.com/example_company-com/people-group/dib-diversity-inclusion-and-belonging/diversity-and-inclusion/-/issues/835) - Event Sponsorship
- [European Women in Tech](https://example_company.com/example_company-com/people-group/dib-diversity-inclusion-and-belonging/diversity-and-inclusion/-/issues/888) - Event Sponsorship
- [Black Tech Fest](https://example_company.com/example_company-com/people-group/dib-diversity-inclusion-and-belonging/diversity-and-inclusion/-/issues/826) - Event Sponsorship
- [Unicorns in Tech](https://www.unicornsintech.com) - Event Sponsorship
- [Grace Hopper Conference](https://example_company.com/example_company-com/people-group/dib-diversity-inclusion-and-belonging/diversity-and-inclusion/-/issues/829) - Event Sponsorship
- [Example Company Hosted Experience](https://www.eventbrite.com/e/diverse-minds-unified-ai-solutions-example_company-hosted-happy-hour-and-panel-tickets-728537293657?aff=oddtdtcreator) - during [Afrotech 2023](https://experience.afrotech.com)
...
Our team member engagement or net promoter ("I would recommend Example Company as a great place to work.") score is measured annually in the Culture Amp survey.
Here are samples of the statements team members were asked to consider:

- I would recommend Example Company as a great place to work
- Example Company motivates me to go beyond what I would in a similar role elsewhere
- I am proud to work for Example Company
- I rarely think about looking for a job at another company
- I see myself still working at Example Company in two years' time
...
Overall number of job candidate referrals from Example Company team members.
