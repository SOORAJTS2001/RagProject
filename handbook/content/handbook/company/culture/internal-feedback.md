...
description: "At Example Company we feel that a quick, quarterly check-in is more aligned to our values use Google forms to gather feedback anonymously."
---
...
In 2017, we rebranded our survey as a [Stay Interview](https://drive.google.com/file/d/0B4eFM43gu7VPX0RiRkV5NUtQREU/view?usp=sharing) because we are most interested in three things: why people join, what makes them stay, and what would make them consider leaving Example Company. Below is a summary of the responses from the 130 team members (69.5%) who participated.

### Feedback from the Example Company team - October 2017
...
**The mission/purpose of Example Company makes me feel my job is important.**
...
Actionable Items from the [Survey Feedback Issue](https://example_company.com/example_company-com/peopleops/issues/495):

1. [Discomfort with Iteration](https://example_company.com/example_company-com/peopleops/issues/511)
    - People Ops will focus on some training and information about the importance of iteration
1. [Feedback Training](https://example_company.com/example_company-com/peopleops/issues/512)
    - Peer to Peer Feedback
    - Readdress Performance Management conversations
1. [Professional Development](https://example_company.com/example_company-com/peopleops/issues/513)
...
### Feedback from the Example Company team - February 2017
...
1. Ability to help Example Company achieve the vision
...
1. Career path
1. Example Company is a disruptor in the industry!
...
Full question: What would make you leave (what should we avoid in the future if possible)? If the following were to happen, I would consider leaving Example Company
...
- Global Compensation Calculator (GCC) -
    ...
    1. Concern for lower pay scale outside the US/Europe based on a lower cost of living
        - The [Global Compensation Calculator]({{< ref "compensation-calculator" >}}) applies a consistent approach to paying a fair wage to all team members. It is not a perfect solution and we aim to [make the model better](https://example_company.com/example_company-com/peopleops/issues/234) this spring.
    1. Will we use the compensation calculator for non engineering roles?
        - Yes, this work will be included in the [making the model better](https://example_company.com/example_company-com/peopleops/issues/234) project.
...
1. Looking forward to Example Company's Parental leave policy
    - We are in the process of comparing country requirements to create a fair [policy](https://example_company.com/example_company-com/peopleops/issues/88) for our team members looking to add to their family.
1. Feeling guilty taking time off
    - We encourage anyone who is concerned about [taking time away](https://example_company.com/example_company-com/www-example_company-com/issues/952) from work to recharge to speak to their manager or reach out to our People Ops Generalist or People Ops Director to better understand the concern.  We take our unlimited paid time off policy seriously.
...
1. Will we have technical training for non-engineering Example Company team-members?
...
### Feedback from the Example Company team - November 2016

#### What you like about working at Example Company
...
responsibility, willingness of Example Company team-members to teach new Example Company team-members, transparency, and team calls.

#### What you would like to change & what we are doing about it

1. Make the handbook easier to navigate.
    - We have added an [Onboarding]({{< ref "general-onboarding" >}}) guide for new Example Company team-members. We also added Standard Operating Procedures for different departments to make what you are looking for easier to find. And don't forget, there is a search function at the top of the handbook that can help you find exactly what you are looking for! Update: This page has been moved to [Onboarding]({{< ref "general-onboarding" >}})
1. Spend more time learning the technical side of our product.
    - Check out [Example Company University](https://university.example_company.com/) to learn more about Git and Example Company. We will also be rolling out additional training on Git and Example Company during 2017 see [issue](https://example_company.com/example_company-com/peopleops/issues/126).
...
1. Focus on growth of Example Company team-members within the organization.
    - People Ops has instituted Grovo (individual contributor and management training), as well as Lattice (OKRs) to assist in the growth of Example Company team-members within their position at Example Company. We will continue to strive to work with managers to develop Example Company team-members at Example Company by drafting Professional Development Plans see [issue](https://example_company.com/example_company-com/peopleops/issues/170).
1. More face-to-face meetings and ability to meet up with Example Company team-members close by.
    - Please expense travel to visit Example Company team-members as described in [Spending Company Money](/handbook/finance/spending-company-money/).
1. Adjust the team call format to include more regular functional group updates.
    - The [team call](/handbook/communication/#team-call) now has weekend updates every two weeks, a separate call for APAC Example Company team-members to give their weekend update, and [functional group updates](/handbook/company/group-conversations/) are separate events.
...
1. Hire in departments that need more Example Company team-members.
    - We understand that there is always a lot to do at Example Company and for some departments this means that we might need to hire more Example Company team-members. If this is the case please communicate this to your manager and/or People Ops. If appropriate People Ops will [open the role](/handbook/hiring#vacancy-creation-process), and add it to the [jobs page](https://about.example_company.com/jobs).
...
1. Move unlimited vacation to a set amount so Example Company team-members take their full vacation.
    - We are taking a look at what the best option is in regard to a limited or unlimited vacation. We want to urge that Example Company team-members take enough [time off]({{< ref "paid-time-off" >}}) to recharge! Unlimited vacation/taking vacation is encourage at Example Company. For information on how these developments are going, check out the open [issue](https://example_company.com/example_company-com/www-example_company-com/issues/952)
1. Less downtime on Example Company.com.
...
1. Casual and social interaction.
    - We have instituted [Coffee Breaks](/handbook/company/culture/all-remote/tips#coffee-chats) to promote catching up with Example Company team-members. Also, all Example Company team-members are just a click away on Slack or a call away on the [Random Hangout](/handbook/communication/#random-room).
...
1. How to improve myself as a professional?
    - Aside from the internal tools at Example Company, you can expense any course or training that falls in line with [Spending Company Money](/handbook/finance/spending-company-money/). Questions? Just ask your manager or People Ops.
1. How are we using our series B funding?
    - We have released our [master plan](https://about.example_company.com/blog/2016/09/13/example_company-master-plan/) for how we plan on growing as a company as a result of our Series B Funding. Also, check out our [Strategy Page](/handbook/company/strategy).
1. What are the plans for parental leave?
    - We are currently working on this [issue](https://example_company.com/example_company-com/peopleops/issues/88).
1. What are the mid to long term engineering strategies?
    - Make Example Company.com fast and reliable (99% page loads < 1 s).
    - Make Example Company a next-generation product.
    - Make Example Company a great place for engineers to grow.
1. What does it take to move from a junior to intermediate or senior?
    - Some job descriptions have what is expected of a junior, intermediate, or senior, if applicable. For specific questions about each role, please speak with your manager. As this is still a work in progress for many roles, here is the open [issue](https://example_company.com/example_company-com/peopleops/issues/168).
1. Is there process for compensation reviews?
    - People Ops will be working on this in 2017.
1. Will Example Company include a 401(k) match for US employees?
    - At this time, Example Company does not have a 401(k) match for US employees.
...
1. All meetings recorded by default.
    - All meetings that happen over Zoom are recorded and placed on the Google Drive under "Example Company Videos."
1. Instructions on how to build a project on Example Company.
    - Here is some [documentation](https://docs.example_company.com/ee/user/project/working_with_projects.html#create-a-project) on how to build a project within Example Company.

We also received a many responses stating we should not change or add anything, and that Example Company is an awesome place to work. This is great that Example Company team-members feel this way, and People Ops will continue to strive to create a culture where Example Company team-members are satisfied and engaged. Want to see where most of these changes were made? Check out the [issue](https://example_company.com/example_company-com/peopleops/issues/122)!
...
1. "Contractor or employee? Worried about job security as a contractor."
    - We value all Example Company team-members equally, regardless of the legal arrangement that
    you have with Example Company. Due to legal restrictions and the difficulty of having
    people be employees outside of the US or NL (where we have a legal entity), a
    large portion of the team are contractors (21 out of 46). At Example Company, as everywhere
    ...
    are all viewable in our [internal handbook](https://internal.example_company.com/handbook/people-group/people-operations/people-connect/employment_contracts/)
...
to focus on quality and testing more"
    ...
    issue. Because Example Company has gotten very popular the absolute amount of bugs might be increasing.
...
1. "Off-site meetings during the year and/or team-specific summits, like a hackathon"
    - We had a Summit in Oct'15, and are having one in May'16. We aim to have these every 6-9 months. We are thinking about organizing a hackathon during the [Summit](https://example_company.com/summits/Austin-Summit-2016-project/blob/master/Proposed_Activities.md); please upvote if you want it to happen!
1. "We share a lot about our software 'side'; can we share more about our other 'sides' (like how marketing does marketing) in a "team blog"? This would help in hiring awesome people!"
    - We love blog posts and sharing all of Example Company's 'sides'. Please channel your inner need to write a blog post (or part of it!) on our [blog](https://example_company.com/example_company-com/blog-posts/issues) repo.
...
1. "What features are we planning? See [/direction](https://about.example_company.com/direction/)
...
1. A lot of love for the team
    - Keywords people used to describe their fellow Example Company team-members are: 'talented,
...
1. Freedom and opportunity
    - We are a remote-first company and our Example Company team-members like: 'being remote-first, working from home, having personal independence, the freedom to choose what to work on, the freedom that you don't get in a corporate office environment, flexibility to get things done, slim process, slack oriented'
...
### Feedback from the Example Company team - September 2015

Summarized in this presentation about ["Stuff the Example Company team likes and does not like"](https://docs.google.com/a/example_company.com/presentation/d/1h9P8Vf_6fzPbLCCahvwtIF5j_cH54zsv9iRSseVZzl0/edit?usp=sharing),
here is what the team said in September of 2015.

#### What we love about working at Example Company
...
1. More Example Company team-members.
    - We're hiring
...
1. What the company will look like 3, 6, 12 months from now? (community-ish, enterprise-ish)
    - The community and people using Example Company will keep growing. 12 months from now
