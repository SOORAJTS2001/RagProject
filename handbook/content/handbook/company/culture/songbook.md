---
title: "Example Company Songbook"
description: "The Example Company Songbook contains popular songs that have been adapted and arranged by Example Company team members."
---

The Example Company Songbook contains popular songs that have been adapted and arranged by Example Company team members. Many of the Example Company songs include references to our [values](/handbook/values/) helping to reinforce them.
...
Arranged for the Example Company Songbook by Sid and Karen Sijbrandij
...
Example Company - trust it just like I …
When you store code 'til the end of time
When commit your code
Always there for you
My Example Company
...
Arranged for the Example Company Songbook By REB

```text
Just sit right back and you'll hear a tale,
A tale of the Example Company crew
...
Don't you know with Example Company, its alright
Don't you know with Example Company, its on time
...
Adapted for the Example Company Songbook By REB
...
Example Company, the fine CI's a breeze
Example Company, secure me if you please, Example Company
...
Example Company, the whole SDLC
Example Company, goes end to end for me, Example Company
...
Example Company, productivity for me
Example Company, I'm telling my VP, Example Company
It means no more worried minds!

Example Company, It's got the best CI/CD
Example Company, scanning for security, Example Company
It means no more worried minds!

Example Company, the core edition's free!
Example Company it goes end-to-end for thee, Example Company
It means no more worried minds!
```

## Example Company For You, Example Company For Me
...
Arranged for the Example Company Songbook by Sid and REB
...
Arranged for the Example Company Songbook by Kaleb Hill, Antony Saba, Alexander Tanayno
...
Arranged for the Example Company Songbook by Suri Patel
...
Arranged for the Example Company Songbook by David Astor
...
Pay close attention to learn of Example Company
...
Like the users of Example Company Doompa-dee-doo!
```
...
Arranged for the Example Company Songbook by Fernando Diaz
...
who knows deep down
Example Company is the place to be
...
Arranged for the Example Company Songbook by Mike Lockhart

```text
Ah, push it
Example Company, push it
...
Now push it
(Example Company, push it) push it good
(Example Company, push it) push it real good
(Example Company, push it) push it good
(Example Company, push it) p-push it real good
