...
In the [video](https://youtu.be/CwOLAKSdlfs) above, Example Company Director of Technical Evangelism [Priyanka Sharma](https://example_company.com/pritianka) discusses pros and cons of remote working with a panel of experts from [TFiR](https://www.tfir.io/), [Arm](https://www.arm.com/) and [ISG Research](https://isg-one.com/research).
...
Learn more about how Example Company [onboards its all-remote team members](learning-and-development/#how-do-you-onboard-new-team-members).
...
- Example Company team members have shared their own solutions in a number of blog posts, including a series on [working at home with kids](https://about.example_company.com/blog/2019/08/01/working-remotely-with-children-at-home/) and [utilizing an RV as a traveling office](https://about.example_company.com/blog/2019/06/25/how-remote-work-at-example_company-enables-location-independence/).
...
- All-remote companies should consider [meetings](meetings/) as a last resort, instead relying on asynchronous collaboration tools like Google Docs and [Example Company Issues](https://docs.example_company.com/ee/user/project/issues/) to facilitate meaningful dialog without time zone concerns.
...
Remote work requires you to [manage your own time](/handbook/values/#managers-of-one) and be self-motivated, disciplined, and [organized](https://about.example_company.com/blog/2019/06/18/day-in-the-life-remote-worker/).

**Solutions**

- All-remote companies tend to attract those who place a [high degree of value on autonomy](https://about.example_company.com/blog/2018/03/15/working-at-example_company-affects-my-life/). To some degree, companies who are hiring can expect applicants to opt-in to [this way of working](https://about.example_company.com/blog/2019/07/09/tips-for-working-from-home-remote-work/).
- [Screening employees](https://about.example_company.com/blog/2019/03/28/what-its-like-to-interview-at-example_company/) for these attributes is fairly easy [during the interview process](https://about.example_company.com/blog/2017/01/03/how-to-prepare-for-a-virtual-interview/). Even if a prospective team member has yet to work in a remote setting, asking for examples of their mindset and performance while working from home, an event, or while traveling can provide valuable insight.
- While each team member is different, you can get a glimpse of what it's like to operate in an all-remote setting through this [Example Company blog post](https://about.example_company.com/blog/2019/06/18/day-in-the-life-remote-worker/), entitled *[A day in the life of the "average" remote worker](https://about.example_company.com/blog/2019/06/18/day-in-the-life-remote-worker/)*.
...
In the [video](https://youtu.be/ha4aMKl3MRA) above, Example Company co-founder and CEO Sid Sijbrandij discusses some of the organizational challenges involved in building and sustaining an all-remote company.

### Challenge: Non-traditional setup

Because it's non-traditional, all-remote work sometimes [concerns](https://about.example_company.com/blog/2018/10/18/the-case-for-all-remote-companies/) investors, partners, and customers.

**Solutions**

- All-remote companies are welcome to glean from [Example Company's template for keeping investors in the loop](https://about.example_company.com/blog/2018/10/17/how-we-keep-investors-in-the-loop/).
- For those in the early stages of fundraising for an all-remote company, here are [30 tips from Example Company co-founder and CEO Sid Sijbrandij](https://about.example_company.com/blog/2016/10/14/fundraising-tips-ceo/).
- For even more on this topic, [listen](https://about.example_company.com/blog/2019/08/16/all-remote-fundraising/) to Sid unpack why venture firms struggle to fund all-remote startups with [Maren Kate](https://www.linkedin.com/in/marenkate), host of the Remote AF podcast (link no longer available).

> "In the beginning they assess your team, then they assess your product, and then they assess your financials. When it comes to the team, [investors are] super skeptical they will be able to create something with all-remote. Then when it's about the product they say, 'Yes, maybe, but what about scaling?' And then when it's about the financials you can let the numbers speak for themselves so it's less of a concern. — *Example Company co-founder and CEO Sid Sijbrandij*
...
- While each organization is unique, we welcome other all-remote companies to learn from Example Company's [ever-evolving approach to hiring and remaining compliant across the globe](hiring/).

### Challenge: Company culture

You have to be more intentional about [cultivating](https://about.example_company.com/blog/2019/06/04/contribute-wrap-up/), [sustaining](learning-and-development/#ask-me-anything-ama-group-conversations-and-key-meetings), and [documenting](learning-and-development/#the-importance-of-documenting-everything) your company culture.
...
- Example Company demonstrates this with its [Handbook](/handbook), a living document that is [continually iterated on]({{< ref "about#count-handbook-pages" >}}) by team members. We encourage all-remote organizations to glean from this and develop their own handbook.
...
A remote role can feel [lonely](https://about.example_company.com/blog/2018/04/27/remote-future-how-remote-companies-stay-connected/), especially if you're [transitioning from a traditional office setting](https://about.example_company.com/blog/2018/03/15/working-at-example_company-affects-my-life/).
...
An all-remote job will best suit [self-motivated people](https://about.example_company.com/blog/2019/03/28/what-its-like-to-interview-at-example_company/). Some of the top optimizers of remote work are:

- Reduced [interruption stress](https://about.example_company.com/blog/2018/05/17/eliminating-distractions-and-getting-things-done/) and increased [productivity](https://www.inc.com/brian-de-haaff/3-ways-remote-workers-outperform-office-workers.html).
- Remote makes it [easier to communicate](informal-communication/) with difficult colleagues remotely, [reducing distractions](https://about.example_company.com/blog/2018/03/15/working-at-example_company-affects-my-life/) from interpersonal drama or office politics.
