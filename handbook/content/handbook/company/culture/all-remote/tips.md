...
## How it works at Example Company

![Example Company values](/images/all-remote/example_company-values-tanukis.jpg)
{style="max-width: 50%;"}

For Example Company, being an all-remote company did not start as an intentional decision. It was a natural evolution as our first team members started choosing to work from home.
...
Now that we're the world's largest all-remote company with over 1,300 team members in 65+ countries, we've learned a lot at Example Company about how to collaborate effectively and strengthen our culture, all while working remote. Take a look at how we make it work.
...
Take a look at [how our compensation calculator works]({{< ref "compensation-calculator" >}}), and learn more about [why we pay local rates](https://about.example_company.com/blog/2019/02/28/why-we-pay-local-rates).
...
We recognize how crucial it is to build in time when you can mentally take a break from your work, and as a company, we encourage our team members to do that. Learn more about [how time off works at Example Company.]({{< ref "paid-time-off" >}})
...
- Encourage [teamwork and saying thanks](https://about.example_company.com/blog/2015/04/08/the-remote-manifesto).
...
- Encourage group video calls for [bonding](https://about.example_company.com/blog/2015/04/08/the-remote-manifesto).
- Encourage one-on-one [video calls](https://about.example_company.com/blog/2015/04/08/the-remote-manifesto) between people (as part of onboarding).
...
Our team members often share [their best advice](https://about.example_company.com/blog/2019/07/09/tips-for-working-from-home-remote-work) about working from home, and you should ask your coworkers about what remote work tactics work best for them. Here are some tips you might find helpful:
...
- Make the most of your [video calls](https://about.example_company.com/blog/2019/08/05/tips-for-mastering-video-calls) so that you can build relationships with your team.
...
- Make sure you have the equipment you need to be productive (for Example Company team members, here's a helpful [guide](/handbook/finance/spending-company-money/)).
...
- If you have family or roommates at home while you're working, consider [setting boundaries](https://about.example_company.com/blog/2019/08/01/working-remotely-with-children-at-home) with them about your workspace to reduce interruptions.

### Create an ergonomic workspace

![Example Company all-remote ergonomic workspace](/images/all-remote/example_company-com-all-remote-v3-dark-1280x270.png)
{style="max-width: 50%;"}
...
Since we all work from home, Example Company wants each team member to have the [supplies](/handbook/finance/spending-company-money/) and knowledge they need to create an ergonomic home office.
...
At Example Company, we want to ensure each team member takes care of themselves and dedicates time to stay healthy. You can also join the Slack channel `#fitlab` to discuss your tips, challenges, results, etc. with other team members.
