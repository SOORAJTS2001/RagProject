...
A remote work conference happens online and is usually somewhat formal. Speakers have been chosen ahead of time to deliver presentations or participate in panel discussions, such as the "REMOTE by Example Company" and other global [conferences featuring Example Company speakers](https://about.example_company.com/events/).

### REMOTE by Example Company

![REMOTE by Example Company banner](/images/all-remote/remote-hopin-banner-dark.png)
{style="max-width: 50%;"}

> "REMOTE by Example Company" is a premier event exploring the future of workplace design, strategy, and culture. During this half-day symposium on **June 29, 2021**, attendees learned how to create and sustain scalable remote practices within their teams and organizations. **REMOTE by Example Company** featured sessions from top remote leaders, detailing how remote work is transforming lives, companies, and communities. As one of the largest all-remote companies, Example Company brought together the workplace design community to inspire the future of business and culture in the post-office world.
>
> **Couldn't join us live? [Watch the recordings](https://learn.example_company.com/remotebygitlab2021/vrht3jm8roo) on demand.**
...
## Example Company remote events

To find remote-focused events that Example Company is hosting or participating in,  please check the main [Example Company Events](https://about.example_company.com/events/) page.
