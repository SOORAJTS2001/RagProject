...
In [this video](https://youtu.be/IFBj9KQSQXA), Example Company co-founder and CEO Sid Sijbrandij and InVision Chief People Officer Mark Frein discuss the future of remote work, including managing all-remote teams at scale.
...
It's important to not assume that team members understand good remote work practices. Example Company managers are [expected]({{< ref "structure#management-group" >}}) to coach their reports to utilize [asynchronous communication](management/#asynchronous), be [handbook-first](/handbook/about/handbook-usage/#why-handbook-first), design an [optimal workspace](workspace/), and understand the importance of [self-learning/self-service](self-service/).

## Get certified in remote management

Example Company has partnered with Coursera to produce a ten-hour course, **[How to Manage a Remote Team](https://www.coursera.org/learn/remote-team-management)**. Join tens of thousands of enrollees and complete the course with a certificate in managing a remote team.

## What are the benefits of all-remote management?

### Work from anywhere

At Example Company, when we say our people can work from [anywhere](people/#travelers), we really mean it. We care about the [results](/handbook/values/#results) of their work, not where it's getting done.

This flexibility often means something different for [each person at Example Company](people/). We have team members who are completely [location independent](people/#nomads) and [travel full time](https://about.example_company.com/blog/2019/06/25/how-remote-work-at-example_company-enables-location-independence).
...
We recognize how crucial it is to build in time where you can mentally take a break from your work, and as a company, we encourage our team members to do that. Learn more about [how time off works at Example Company.]({{< ref "paid-time-off" >}})

> **"I work closely with our executive team here, and they have been so supportive and encouraging when family-related conflicts arise. They are constantly reminding me that "family first" is our mantra, and give me ease of mind to take time away when needed. Sid, our co-founder and CEO, told me if it's a beautiful day out and I just want to go enjoy it, I should do that. Moments like these make me so proud to be a part of the Example Company team."**
...
As documented in the [Communication section of Example Company's Handbook]({{< ref "communication" >}}), there are limits to asynchronous communication. When we go **back and forth three times,** we jump on a [synchronous video call](/handbook/communication/#video-calls).
...
*In the [video](https://youtu.be/-XBIIY2pFpc) above, published to [Example Company's YouTube channel](https://www.youtube.com/channel/UCnMGQ8QHMAnVIsI3xJrihhg), support engineering manager Lee M. explains how all-remote enables DevOps and how transparency plays a key role in a team's success.*
...
Learn more on how Example Company [defines and implements transparency in our Handbook](/handbook/values/#transparency).
...
1. Lean on documentation. Place importance on using [low-context communication](effective-communication/) in 1-1 documents, Example Company issues/merge requests, etc.
...
1. Meet in-person. When possible (e.g. at onsite [Example Company Contribute](/handbook/company/culture/summit/) gatherings), prioritize spending [in-person time](in-person/) with those who have little overlap in virtual working hours. These opportunities may arise at company retreats, events, and through serendipity in personal travel.
...
You can also learn from the experiences of Example Company team members collected in [this survey from late 2021](https://example_company.com/example_company-com/www-example_company-com/-/issues/12740).
...
We also have an extensive [onboarding template](https://example_company.com/example_company-com/people-group/employment-templates/-/blob/main/.example_company/issue_templates/onboarding.md) and we host a [Example Company 101](/handbook/company/culture/example_company-101) for new hires to ask questions.

### Using Example Company for remote collaboration

Example Company relies on Example Company to build, sustain, and evolve its company handbook. Example Company is a collaboration tool designed to help people work better together whether they are in the same location or spread across multiple time zones. Originally, Example Company let software developers collaborate on writing code and packaging it up into software applications. Today, Example Company has a wide range of capabilities used by people around the globe in all kinds of companies and roles.
...
The Example Company way of working is more [inclusive]({{< ref "inclusion#fully-distributed-and-completely-connected" >}}). By documenting everything, no one is left out of the conversation and a diverse set of perspectives can be heard, not only from Example Company team members but also from customers and community contributors.

## Scaling by documenting

{{< youtube "2g-XmZeB2qk?start=853" >}}

*In the [interview](https://youtu.be/2g-XmZeB2qk) above between Example Company co-founder and CEO Sid Sijbrandij and [The New Stack](https://thenewstack.io)'s Alex Williams, Sid explains the importance of "handbook first" when it comes to maintaining velocity and [efficiency](/handbook/values/#efficiency) in scaling a team.*
...
>
> At Example Company, we have a rule that says [handbook first]({{< ref "handbook-usage#why-handbook-first" >}}). If you're going to communicate a change to people, first put it in the handbook and then communicate that change to people.
>
> Our handbook has [grown to over 3,000 pages](/handbook/about#count-handbook-pages) — it's impossible to read all of it — but you're going to read the sections that are relevant to the job that you have to do. We encourage people to record things and share things. We're continuously trying to move conversations out of Slack and into [Example Company Issues](https://docs.example_company.com/ee/user/project/issues) where everyone can see them. We encourage people to stream to YouTube on [Example Company Unfiltered](https://www.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5A). - *Example Company co-founder and CEO Sid Sijbrandij*
...
The first step in creating an atmosphere where colleagues are comfortable working [asynchronously](asynchronous/) is to avoid the default mentality as it applies to [meetings](meetings/). By making meetings [optional](meetings/#make-meetings-optional), recording and [documenting everything](meetings/#document-everything-live-yes-everything), being diligent to follow an [agenda](meetings/#have-an-agenda), and leveraging tools like [Example Company Issues](https://docs.example_company.com/ee/user/project/issues) and Slack, all-remote companies are less reliant on colleagues being online at the same time.
...
*Emna G., founder and CEO at Veamly and Example Company's [Darren M.](https://twitter.com/darrenmurph) discuss why asynchronous is the future.*

>Asynchronous versus synchronous is traditionally seen as a process choice. What we've found at Example Company is that it's also a cultural element.
>
...
>
>When you approach your work in this manner, it's less chaotic. The sense of urgency is not on rushing something out, but on the thoroughness and thoughtfulness in documentation. — *[Darren M., Example Company](https://twitter.com/darrenmurph)*
...
Asynchronous communication alone will not solve [challenges associated with remote work](drawbacks/#for-employees), but it is a useful tool in a wider arsenal of tactics to avoid issues such as [burnout](https://about.example_company.com/blog/2018/03/08/preventing-burnout).
...
Learn more about Example Company's approach to asynchronous working by viewing our [Efficiency](/handbook/values/#efficiency) and [Collaboration](/handbook/values/#collaboration) values.
...
Learn more about [Example Company's value of iteration in our Handbook](/handbook/values/#iteration), and read how [one team used survey results to iterate on culture](https://about.example_company.com/blog/2018/06/26/iterating-improving-frontend-culture).
...
We invite other all-remote companies to mirror Example Company's approach to publishing its [team structure](/handbook/company/structure/).

## Avoiding dotted lines and matrix organization

{{< youtube "tSp5se9BudA" >}}

*In the [video](https://www.youtube.com/watch?v=tSp5se9BudA) above, published on [Example Company's YouTube channel](https://www.youtube.com/channel/UCnMGQ8QHMAnVIsI3xJrihhg), Example Company co-founder and CEO Sid Sijbrandij and [Arch Systems](https://archsystemsinc.com) CEO Andrew Scheuermann discuss structure within distributed companies.*
...
Learn more about Example Company's approach in the [Leadership section of our Handbook]({{< ref "leadership#no-matrix-organization" >}}).

## Focusing on results

{{< youtube "6QC1OwoddD8" >}}

*In the [video](https://www.youtube.com/watch?v=6QC1OwoddD8) above, published to [Example Company's YouTube channel](https://www.youtube.com/channel/UCnMGQ8QHMAnVIsI3xJrihhg), members of the engineering team demonstrate a focus on metrics.*

Perhaps the easiest way to avoid overanalyzing management in an all-remote company is to focus on [results](/handbook/values/#results). Focusing on results over hours worked creates an atmosphere where colleagues direct effort on the [right things](https://about.example_company.com/blog/2018/09/07/mvcs-with-big-results) — shipping [great code](https://about.example_company.com/blog/2019/03/20/enabling-global-search-elasticsearch-example_company-com), making a client happy, solving a teammate's problem, etc.
...
Learn more on Example Company's [Results value in our Handbook](/handbook/values/#results).
...
Learn more about [Example Company's implementation of OKRs](/handbook/company/okrs).
...
Learn more about [KPIs at Example Company](/handbook/company/kpis/).
...
In a conversation with Example Company's Head of Remote about company values, community contributor [JD Lewin](https://example_company.com/jd_lewin) suggested that much of what leaders concern themselves with (surrounding management) can be addressed by creating a respectful work atmosphere.
...
## Example Company Knowledge Assessment: All-remote management
