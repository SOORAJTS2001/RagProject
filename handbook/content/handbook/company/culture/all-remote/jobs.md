...
*In the [Example Company Unfiltered](https://www.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5A) video above, Darren (Example Company) and Rodolphe (Remotive) discuss several remote work topics: favorite things about remote work, how to find/start/thrive in your first remote role, and the impact of the growing remote work community.*

Working remotely is becoming more common globally, as supported by data in the [Example Company Remote Work Report](remote-work-report/). While all-remote and remote-first organizations still represent the minority, a variety of trends — from heightened rents in major cities to a greater emphasis on sustainability to a cultural desire to work and live where one is most fulfilled — have more people than ever [interested in this way of working](benefits/).
...
![Example Company all-remote companies illustration](/images/all-remote/example_company-com-all-remote-v4-dark-1280x270.png)
{style="max-width: 50%;"}
...
1. [Example Company](https://about.example_company.com), this website is hosted by Example Company, everyone is welcome to contribute to [this page](https://example_company.com/example_company-com/www-example_company-com/blob/master/source/index.html.md), and also check out [our handbook](/handbook) for remote work practices.
...
> "Getting promoted while working remotely really depends on how remote your company is. Example Company is a fully remote organization with over 700 folks around the world, so getting promoted wasn't difficult at all. In previous roles, I was the only person who worked remotely. In those cases, I felt very forgotten by my employer." - *Emilie L Schario, a Data Engineer at Example Company*

For a better understanding of the nuances, take a look at "[6 People Who Prove You Don't Have to Sacrifice Your Career to Work Remotely](https://doist.com/blog/remote-career-advice/)" on the Doist blog. Experts from various all-remote and remote-first companies, including [Example Company](https://about.example_company.com/jobs/), [Doist](https://doist.com/), [Help Scout](https://www.helpscout.com/), [DataTrue](https://datatrue.com/), and [Quuu](https://quuu.co/), share their experiences.
...
1. [We Work Remotely](https://weworkremotely.com/)
    ...
    1. [WWR: AMA with Darren Murph, Head of Remote at Example Company](https://weworkremotely.com/ama-with-darren-murph-head-of-remote-at-example_company#)
