...
For deep-dives on how Example Company's UX and design teams collaborate remotely, visit the [UX Team Playlist](https://www.youtube.com/playlist?list=PL05JrBw4t0KqkW0oPW3n0HqVgKcONVnO5) on Example Company Unfiltered and read the series of Example Company blog posts below.

1. [Designing in an all-remote company](https://about.example_company.com/blog/2020/03/27/designing-in-an-all-remote-company/)
1. [Improving iteration and collaboration with user stories](https://about.example_company.com/blog/2020/03/27/how-we-utilize-user-stories-as-a-collaborative-design-tool/)
1. [Running an asynchronous sketch workshop for UX](https://about.example_company.com/blog/2020/03/27/async-sketching/)
1. [Synchronous collaboration as a remote designer at Example Company](https://about.example_company.com/blog/2020/04/01/synchronous-collaboration-as-a-remote-designer-at-example_company/)
...
[MURAL](https://app.mural.co/signin?returnUrl=%2Ft%2Fgitlab2474%2Ftemplate%2F08b992c6-1863-4f6b-8305-a584b57d3c98) is the number one sketch tool used by product designers. Mural comes preloaded with a ton of templates. It takes skill and a willingness to experiment to start to utilize them in productive ways, but it is encouraged by PMs at Example Company. The UX Research and Product Design rooms in Mural have several examples of designers doing all sorts of amazing work in Mural.
...
![Example Company all-remote team](/images/all-remote/example_company-com-all-remote-1280x270.png)
{style="max-width: 50%"}
...
*In the [Example Company Unfiltered](https://www.youtube.com/playlist?list=PL05JrBw4t0Kq7QUX-Ux5fOunQotqJbECc) video above, Example Company Head of Remote Darren M. discusses remote team collaboration with Till P. creator of remote collaboration platform [CoScreen](https://www.coscreen.co/).*
...
> "Without the principles and an understanding of which decision-making framework to use and when, people could apply the wrong tool to the job," — *Mike Long, UX Manager, Example Company*
...
> "Pinging someone on slack is like bumping into them in the hallway," — *Alexis Ginsberg, Senior Product Designer at Example Company*

## Synchronous collaboration

Synchronous work within a standard organization makes sense. Work starts and ends when people enter and leave the office. Meetings happen all together in some version of a boardroom. However, when co-workers are spread throughout the world, [sync collaboration](https://about.example_company.com/blog/2020/04/01/synchronous-collaboration-as-a-remote-designer-at-example_company/) can be a bit more challenging. Here are some ways that Example Company has been able to establish a level of normalcy regardless of what time zone people are in.

### Meeting in pairs

![Example Company all-remote team](/images/all-remote/example_company-com-all-remote-v4-dark-1280x270.png)
{style="max-width:50%;"}
...
>
> The most exciting part of this to me is getting to really dive into a space that I don't get as much exposure to – also getting to know another designer and having that dedicated time just for us." — *Alexis Ginsberg, Senior Product Designer at Example Company*

### Group syncs

Meet with your group to get a better idea of what everyone is working on, where the status of a project is, and get a general sense of who you're working with. At Example Company, the plan designers have a dedicated time to meet and discuss what they are working on and are able to collaborate on anything they want feedback on. Some projects overlap, so this is especially helpful for all involved to stay in sync. Team members appreciate having these designer syncs on some cadence where it feels less formal (more like huddling at a desk together looking at designs) than scheduling time ad hoc.
...
![Example Company all-remote team](/images/all-remote/example_company-com-all-remote-v3-dark-1280x270.png)
{style="max-width:50%;"}
...
>
> One of the many positive outcomes from this approach is that even team members who have only been minimally involved are now empowered to provide feedback, add their own ideas, or provide us with additional information about the amount of work our ideas will require." — *[Christie Lenneville](/handbook/company/team/#clenneville), Director of UX, Example Company*

### Sketch workshops

At Example Company, [Async sketch workshops](https://about.example_company.com/blog/2020/03/27/async-sketching/) are another way to collaborate with peers. The process is similar to an in-person whiteboard workshop, only collaborators are using Mural instead. Guidelines are set for individual workshops, leaders are in place, and contributors have a general familiarity with the product.

### Example Company Issues and merge requests (MR)

Example Company's policy is to [dogfood everything](https://about.example_company.com/blog/2020/01/30/insights/). Issues and merge requests are where the majority of collaboration occur. Example Company design issues are works in progress, feedback is welcome and expected, and everyone is encouraged to contribute. The platform's transparency helps remote teams interface to produce better products faster.

> "I really enjoy reviewing MRs and being able to check out branches on my own instead of relying on others to walk me through things at their desk or sending me to an app like I may have had to do in the past. I can be reviewing something for someone while they sleep...it feels like we are better able to support and collaborate with each other and work on efforts together." — *[Alexis Ginsberg](https://example_company.com/uhlexsis), Senior Product Designer, Example Company*

## Example Company Knowledge Assessment: Remote collaboration and whiteboarding

Complete all knowledge assessments in the [Remote Work Foundation certification]({{< ref "remote-certification" >}}) to receive the [Remote Foundations Badge in Example Company Learn](https://example_company.edcast.com/pathways/copy-of-remote-foundations-badge). If you have questions, please reach out to our [Learning & Development team](/handbook/people-group/learning-and-development) at `learning@example_company.com`.
