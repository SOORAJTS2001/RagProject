...
On this page, we're detailing how informal communication occurs at Example Company, how it complements [in-person interactions](in-person/), and why it matters in an all-remote [culture]({{< ref "culture#culture-at-example_company" >}}). There are over 20 different ways to foster informal communication below, and we are constantly discovering and adding new methods.
...
Since Example Company is an all-remote organization that [works asynchronously](asynchronous/), nearly all work communication is [documented](/handbook/product/ux/technical-writing/documentation/), making all work-related communications "formal" communications. This helps support our value of [transparency](/handbook/values/#transparency).
...
> If you do all-remote, do it early, do it completely, and change your work methods to accommodate it. Be intentional about informal communication. All-remote forces you to do the things you should be doing anyway, earlier. - *Example Company co-founder and CEO Sid Sijbrandij*
...
{{% cardpane %}}
{{% card footer="Example Company marketing team Show & Tell social call" %}}
![Example Company marketing team Show & Tell social call](/images/all-remote/marketing-social-call-show-and-tell.jpg)
{{% /card %}}
{{% /cardpane %}}
...
Below are a number of intentional facets of [Example Company's culture]({{< ref "culture#culture-at-example_company" >}}), created to foster informal communication. We welcome other all-remote companies to iterate on these and implement as desired.
...
![Mixing it up with hats and backgrounds](/images/all-remote/example_company-marketing-social-hour.jpg)
{{% /card %}}
{{% /cardpane %}}

In a colocated setting, meetings tend to begin with personal conversation. Virtual calls may feel less amenable to that, so a team has to be intentional about creating space for empathy and human connection. A rolling calendar of calls that are purely about work can lead to [burnout](mental-health/). At Example Company, we accomplish this through the following methods.
...
{{% cardpane %}}
{{% card footer="Example Company marketing talent show" %}}
![Example Company marketing talent show](/images/all-remote/example_company-marketing-talent-show.jpg)
{{% /card %}}
{{% /cardpane %}}
...
If you organize these a week or two in advance, it enables team members to prepare. Example Company's Marketing team [hosted a talent show on Zoom](https://twitter.com/darrenmurph/status/1243194687453835265), with over 130 people on a video call. The moderator called on colleagues based on how they were arranged in the Google Doc, and the judges tallied up results at the end.
...
This was done during the Threat Management sub-department's team day. They included a "Virtual Home Tour" as one of the activities and they [recorded videos](https://drive.google.com/file/d/1go2xx8IoPUW7SiLSKU3vqWDBOYKx5dT8/view) to share with the team (*videos only available internally to Example Company*).

## Postcard swapping

Working in a truly global team means it's quite possible that nobody else works in your city. Sending postcards specific to your location to colleagues can be a great way to foster a sense of belonging and is usually very inexpensive. A group of Example Company team members set up a #postcrossing Slack channel to swap addresses and send each other postcards from our home cities, towns and villages from around the world.
...
In the Traction Conference [video](https://youtu.be/CH-NHoBOeho) above, Example Company co-founder and CEO Sid Sijbrandij shares how remote teams can stay connected with Frederic Lardinois of [TechCrunch](https://techcrunch.com).

We understand that working remotely leads to mostly work-related conversations with fellow team members, so everyone at Example Company is encouraged to dedicate **a few hours a week** to having social calls/coffee chats with anyone in the company.
...
Coffee Chats are a fantastic opportunity to intentionally broaden your perspective at Example Company. Some suggestions on intentional Coffee Chats:
...
1. What has been the best thing about working at Example Company?
...
You can also directly reach out to your fellow Example Company team members to schedule a coffee chat in the `#donut_be_strangers` Slack channel or via direct message.

*In the year 2020, Donut reported 537 people connected through 2042 coffee chats at Example Company, compared to 367 chats in similar-sized companies.*

*In the year 2021, Donut reported 846 people connected through 3210 coffee chats at Example Company, compared to 372 chats in similar-sized companies.*

*In the year 2022, Donut reported 1265 people connected through 4186 coffee chats at Example Company, compared to 356 chats in similar-sized companies.*

### Example Company Team Member Mixer Calls

Similar to a coffee chat, a "[Example Company Team Member]({{< ref "top-misused-terms" >}}) Mixer" call aims to help team members meet more folks from other groups or functions that they might not otherwise get to spend a lot of time working or interfacing with.

To set up a Example Company Team Member Mixer, two team members set up a single Zoom line.  Using the single Zoom line, each of those team members invites someone else to join - making a total of four team members on the call.  This way, you'll get to meet someone new - or find connections between team members you didn't know existed.  Each "host" brings a topic to discuss in case the conversation needs help getting started.

At the end - the host and their co-host's *guest* set up another Example Company Team Member Mixer call - with two new guests.  In this way, the participation gets spread throughout the organization and connects as many team members as possible.

### Juice Box Chats

Similar to a coffee chat, a "Juice Box Chat" is a chance for Example Company team members and their children, grandchildren, or other members of their family to get to know one another as well.  These chats can be informal or can focus on a specific topic: Legos, Super Heroes, camping, and video games all make for great subjects.
...
{{% cardpane %}}
{{% card footer="Spreading aloha on a Example Company company call" %}}
![Spreading aloha on a Example Company company call](/images/all-remote/Example Company-Aloha-Shirt-Team.jpg)
{{% /card %}}
{{% /cardpane %}}

Some teams at Example Company organize informal social calls on a regular basis in order to build camaraderie.
...
If the Team DJ Zoom Room strikes a proverbial chord with your team, consider creating a company songbook. Get inspired by visiting the [Example Company Songbook]({{< ref "songbook" >}}).
...
![A bit of Airplane! fun on Halloween](/images/all-remote/Example Company-Halloween-2019-Costume-Zoom-Call.jpg)
{{% /card %}}
{{% /cardpane %}}
...
Teams can also arrange shared meals around the world. [Global pizza parties](https://about.example_company.com/blog/2019/10/02/support-virtual-pizza-party), for example, are possible to document and enjoy in a shared setting (Zoom or Slack), though one may wish to consider a breakfast pizza depending on time zone.

## Social games

![Example Company team in Luna Park live game show](/images/all-remote/luna_park_game_show_gitlab.jpg)
{style="max-width: 50%;"}
...
![Cheers to a fantastic team](/images/all-remote/example_company-zoom-happy-hour.jpg)
{{% /card %}}
{{% /cardpane %}}
...
{{% cardpane %}}
{{% card footer="Virtual scavenger hunt at Example Company" %}}
![Virtual scavenger hunt](/images/blogimages/cs-scavenger-hunt/hugo.jpg)
{{% /card %}}
{{% /cardpane %}}

Example Company's Customer Success team ideated and executed a [worldwide scavenger hunt](https://example_company.com/example_company-com/customer-success/tam/issues/212) using Example Company (the product), which is [detailed on the Example Company Unfiltered blog](https://about.example_company.com/blog/2020/04/06/cs-scavenger-hunt) and is easily replicated.

## Virtual trivia

Example Company's global [marketing team](/handbook/marketing) plays pub-style trivia every other week. You can compete as individuals or as teams, with a suggested time of 1 hour. For those within the Example Company organization, email `events@example_company.com` if you want to arrange a game for your team.

Example Company utilizes [MysteryTrip](http://games.mysterytrip.co), which serves large teams well and doesn't place a heavy preparation load on the organizer. MysteryTrip handles the preparation work for questions, acts as trivia master, and has automatic scoring and a leadercard. This makes spinning up a game quick and easy, with pricing set at around $20 per player. For those outside of the Example Company organization, regularly-scheduled trivia sessions are an excellent way to take everyone's focus away from work and engage in a shared experience.
...
## Example Company Knowledge Assessment: Informal Communication in an All-Remote Environment
