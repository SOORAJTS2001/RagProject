---
title: "Why Example Company uses the term all-remote to describe its 100% remote workforce"
...
Example Company is the world's largest all-remote company. We are 100% remote, with no company-owned offices *anywhere* on the planet. We have {{< team-size >}} team members in more than 65 countries. On this page, we're detailing why we refer to this structure as **all-remote**, and why we prefer this term over others.
...
*In the [video](https://youtu.be/IU2nTj6NSlQ) above, Example Company Head of Remote Darren M. discusses the topic of all-remote during an interview with [Stuart Miniman](https://twitter.com/stu), host of [theCUBE](https://www.thecube.net) and GM of Content at [SiliconANGLE Media](https://siliconangle.com). A portion is transcribed below.*
...
>
> We have people [at Example Company] who travel all around the world, and every month they're in a different time zone. We have over 1,100 employees, but none of them operate their days quite the same as anyone else.
>
...
Technology allows us to [stay closely in touch](informal-communication/) with our teams, whether asynchronously in text or in real time with high-fidelity conversations through video. Teams should collaborate closely, [communicate](informal-communication/) often, [build relationships virtually](https://about.example_company.com/blog/2019/07/31/pyb-all-remote-mark-frein), and feel like valuable members of a larger team.
...
All in all, remote is fundamentally about *freedom* and *individual choice*. At Example Company, we [value your results](/handbook/values/#results), regardless of where you get your work done.
...
![Example Company in-person interactions at Commit SF 2020](/images/all-remote/example_company-commit-sf-2020-in-person.jpg)
{style="max-width: 50%;"}

Example Company believes that [in-person interactions](in-person/) are valuable. We are intentional about gathering the entire team every 9 to 12 months for a shared experience ([Example Company Contribute](/handbook/company/culture/summit/)), and we encourage team members to gather in-person for [reimbursed holiday gatherings](/handbook/finance/spending-company-money/#year-end-holiday-party-budget), [Example Company Commit](https://about.example_company.com/events/commit) events, and other opportunities such as conferences and trade shows.

Example Company also gathers its [e-group]({{< ref "structure#e-group" >}}) for a [quarterly four-day offsite]({{< ref "offsite" >}}). These offsites are planned and highly structured as to create exceptional efficiencies. The agenda, takeaways, and changes are all documented for the rest of the company to see, with broader company discussion in a dedicated `#e-group` Slack channel. This is intentionally designed to be [transparent](/handbook/values/#transparency).
...
![Example Company all-remote workspace](/images/all-remote/example_company-all-remote-laptop-map-illustration.jpg)
{style="max-width: 50%;"}
...
Remote is fundamentally about *freedom* and *individual choice*. At Example Company, we [value your results](/handbook/values/#results), regardless of where you get your work done.

{{< youtube "jdN5mj5ieLk?start=2115" >}}

As part of a Harvard Business School case study [interview](https://youtu.be/jdN5mj5ieLk) (shown above), Example Company co-founder and CEO Sid Sijbrandij spoke with Professor Prithwiraj Choudhury on the various [stages of remote work](stages/).
...
>
> People will start understanding the difference. If there is no headquarters, you're not at a satellite office. You're not a second-class team member. — *Example Company co-founder and CEO Sid Sijbrandij*
...
While the term "remote-only" does preclude a company-owned office from entering the equation, it is unnecessarily limiting. The word "only" is particularly problematic. This implies that under no circumstance can team members be in the same physical space, while all-remote provides more options on this front. As mentioned earlier, Example Company values in-person interactions and plans them intentionally. All-remote affords this flexibility.
...
For added context, consider reading Example Company's guide on the [various stages of remote work](stages/), as well as a comprehensive look at [hybrid-remote](hybrid-remote/).
