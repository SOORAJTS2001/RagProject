...
On this page you will be provided an overview of what is needed to start and sustain a Example Company TMRG (Team Member **Resource** Group) or a Team Member **Advocacy** Group.

## Definition of the TMRG - Team Member Resource Groups

TMRGs are voluntary, team member-led groups focused on fostering diversity, inclusion and belonging within Example Company. These groups help team members build stronger internal and external connections; offer social, educational, and outreach activities; create development opportunities for future leaders; and increase engagement among team members.

Team Member **Resource Group** provide support for an underrepresented group

- The purpose for this type of TMRG is to develop and elevate that underrepresented group within Example Company. To provide a voice and a safe space for people who identify as a part of that group and their allies. With aim of increasing and developing the sense of belonging.
...
### What is not an TMRG at Example Company

There are many types of groups and not all of them meet the criteria of being a Example Company supported TMRG. Here are some examples of those that would not be considered TMRGs here at Example Company:
...
**NOTE:** "Example Company supported TMRG" means the group is formally recognized by the company as a Example Company TMRG.

## How to Join Current TMRGs and TMAGs Slack Channels

The following groups have completed the process to be an TMRG and received formal support as part of the [DIB framework]({{< ref "inclusion#tmrgs---team-member-resource-groups" >}}). Click the signup link (Example Company team members only) to join:
...
| ------ | ------ | ------ | ------ | ------ |------ |
| [Example Company API - Asia Pacific Islander]({{< ref "tmrg-example_company-api" >}}) | [Christopher Wang](https://example_company.com/cs.wang), [Steve Xu](https://example_company.com/steve_xu), [Sheela Viswanathan](https://example_company.com/sheelaviswanathan) | #api-tmrg | [Sign up for future meetings (Google group)](https://groups.google.com/a/example_company.com/g/api-tmrg) | [API Agenda](https://docs.google.com/document/d/17zJuZlWVg40mPjcybnGlj_mK2f4SEpRdrjq3s3Cseow/edit?usp=sharing) | David Sakamoto |
| [Example Company Disability and Neurodivergence]({{< ref "erg-example_company-diversability" >}}) | [Kaitlyn Chappell](https://example_company.com/kchappell), [James Hebden](https://example_company.com/jhebden), [Dominique Top](https://example_company.com.dlectronique) | #disability-and-neurodivergence-tmrg | [Sign up for future meetings (google form)](https://forms.gle/5g2wVB577Lr7M3CH7) | [DiversABILITY Agenda](https://docs.google.com/document/d/130LH9QPewms025z4OFxNNUYnjcQ53D1049EZOL2WdWc/edit?usp=sharing) | Rob Allen |
| [Career Enablement](https://groups.google.com/a/example_company.com/g/careerenablementtmag) | [Kristi Piechnik](https://example_company.com/kpdoespr) and [Amruta Kulkarni](https://example_company.com/akulks) | #career-enablement-tmag | [Sign up for future meetings with Google Group](https://groups.google.com/a/example_company.com/g/careerenablementtmag) | TBD | Craig Mestel |
| [Example Company Generational Understanding]({{< ref "tmag-example_company-generational-understanding" >}}) | Miles Russell, Terri Chu | #generational_understanding | [Sign up for future meetings (Google group)](https://groups.google.com/a/example_company.com/g/Generational_Differences_ERG) | [Generational Understanding Agenda](https://docs.google.com/document/d/1h81q60KnCJFsATKjZKOFglBmgkv8TlGrKY8punX2SEg/edit?usp=sharing) | TBC |
| [Global Voices]({{< ref "tmrg-global-voices" >}}) | [Eliran Mesika](https://example_company.com/eliran.mesika), [Charlie Ablett](https://example_company.com/cablet) | #global-voices-tmrg | [Sign up for future meetings (Google group)](https://groups.google.com/a/example_company.com/g/globalvoices/) | TBD | [Sabrina Farmer](https://example_company.com/sabrinafarmer) |
| [Example Company Gente]({{< ref "tmrg-example_company-gente" >}}) | [Pilar Mejia](https://example_company.com/pmejia), [Romer Gonzalez](https://example_company.com/romerg), [Samara Souza](https://example_company.com/samarasouza), [Giuliana Lucchesi](https://example_company.com/glucchesi)  | #gente | [Sign up for future meetings (Google group)](https://groups.google.com/a/example_company.com/g/latinxtmrg) | [Gente Agenda](https://docs.google.com/document/d/12dYSDjiVvFt-c6UO9y350pFbrrK5Iq2o/edit) | [Josh Lemos](https://example_company.com/joshlemos) |
| [Black @ Example Company]({{< ref "tmrg-example_company-black" >}}) | [Darren Eastman](https://example_company.com/DarrenEastman), [Erran Carey](https://example_company.com/erran), [Madou Coulibaly](https://example_company.com/madou) | #black-at-example_company |  [Sign up for future meetings (Google group)](https://groups.google.com/a/example_company.com/g/black-tmrg) | [Black @ Example Company Agenda](https://docs.google.com/document/d/1G9Be3e3hjj3gexLmrmR1bqzaEErP-4BfDgJR4q_jUTw/edit#heading=h.vf9sdppkn4e0) | [David DeSanto](https://example_company.com/david) |
| [Example Company Pride]({{< ref "tmrg-example_company-pride" >}}) | [Alex Hanselka](https://example_company.com/ahanselka) and [Andrew Chapman](https://example_company.com/AndrwChapman) | #lgbtq | [Sign up for future meetings (Google group)](https://groups.google.com/a/example_company.com/g/pride-tmrg) | [Pride Agenda](https://docs.google.com/document/d/11D-Izm5mbopEUCY036Qr0bHx6UePMyfkzhUfNDE-mnk/edit?usp=sharing) | Robin Schulman |
| [Example Company Women]({{< ref "tmrg-example_company-women" >}}) | [Kyla Gradin Dahl](https://example_company.com/kyla), [Winnie Chan](https://example_company.com/wyychan), [Gosia Ksionek](/handbook/company/team/#mksionek) | #women | [Sign up for future meetings (google group)](https://groups.google.com/a/example_company.com/g/womenstmrg) | [Women Agenda](https://docs.google.com/document/d/1bJ3Y8IVjnssPpRa3IUafdzC0wsJUU6rYCGf-YEiDHeg/edit) | Robin Schulman |
| [Example Company Caregivers](tmrg-caregivers.md) | Jackie Porter, Gena Schwam | #caregivers-tmrg | TBA | [Caregivers Agenda](https://docs.google.com/document/d/1taPLNLkVvTayEzySFUU5XKZeSK9tmsK-WELu_Pp14m8/edit?usp=sharing)| Wendy Barnes|

## Executive Sponsorship

An Executive Sponsor can be any leader at Example Company who is at VP level or above. The role of an executive sponsor is to support the development of the TMRG, provide advocacy at the leadership level, connect the TMRG to Example Company's mission & goals and provide mentorship to TMRG leaders.
...
- Have taken the [psychological safety course](https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/courses/psychological-safety-understanding-empowerment-and-self-reflection)
...
- That TMRG leaders feel valued and that they are at the height of belonging at Example Company.
...
- Advocate for the TMRGs needs at throughout Example Company
...
- Provide key insights into Example Company
...
### Example Company Benefits of TMRGs

- Grow Example Company's business and the company from DIB branding as it's top value which will appeal to customers and attract new team members.
- Support Example Company values and business goals, including the Company's commitment to foster an inclusive work environment.
- Support Example Company's diversity initiatives, aspirations and goals.
- Foster communications between Example Company and its team members.
- Provide mentoring and educational and professional development opportunities for Example Company team members

### Team Member Benefits of TMRGs and TMAGs

- TMRGs introduce new and current team members to Example Company's culture and helps to build and maintain engagement.
- TMRGs offer team members togetherness, camaraderie and connections to Example Company giving them a sense of belonging.
- You will have the opportunity to develop your professional and leadership skills, build relationships across the company and regions, connect with possible mentors/mentees, raise awareness for underrepresented groups at Example Company and make a difference at work and in your communities.
- TMRGs provide team members with opportunities for development, showcasing their skills and developing their own brand within Example Company.
...
TMRGs support our diversity, inclusion and belonging framework, maintain an open forum for the exchange of ideas, and serve as a source of educational and professional development opportunities for Example Company team members. It is expected that all Example Company supported TMRGs will participate in initiatives that focus on the following group elements:
...
1. **Outreach/Business Development:** Connecting with groups beyond Example Company
   - Establishing internal and external business partnerships
   - Representing Example Company at industry events
   - Working with external communities to help Example Company achieve market presence and leadership brand
1. **Awareness and Education:** Raising awareness and educating all team members.
   ...
   - Engagement of Allies and Example Company team members with the TMRG
...
## How to suggest a new TMRG and TMAG at Example Company?

- To suggest a new TMRG or TMAG at Example Company please use the [TMRG Request Issue Template](https://example_company.com/example_company-com/diversity-and-inclusion/-/blob/master/.example_company/issue_templates/TMRG-request-template.md).
...
- Provide a detailed explanation of why Example Company should support the TMRG
...
All names, because they are visible externally and could compete with other projects, products and or not be a good representation of Example Company must be approved by Legal and Brand.  You should work with the DIB Manager (Liam McNally lmcnally@example_company.com) to gain a consensus on ideas.  Keep in mind that names chosen by the TMRG may not meet Example Company's naming and branding standards and may need to be changed.
...
As with all Example Company business, we want to dogfood our own product. As such, you should consider creating a Example Company project to manage discussions in issue and
update the repo with mission statement, events, and the like. You should create the repo in the [`example_company-com`](https://example_company.com/example_company-com) group. To see
a project in action, you can check out the [Example Company Pride project](https://example_company.com/example_company-com/pride-tmrg).
...
requesting a new group. There is a template you can use and you can [view an example](https://example_company.com/example_company-com/team-member-epics/access-requests/-/issues/3547)
...
look at the [pride-erg](https://groups.google.com/a/example_company.com/forum/#!forum/erg-pride) for an example of what that might look like.

## TMRG and TMAG Members

Membership in an TMRG at Example Company is open to everyone, including full-time and part-time team members, interns, and contractors.
...
- [Allyship at Example Company]({{< ref "ally-resources" >}})
- [Live Learning Ally Training at Example Company](https://ctb.ku.edu/en/table-of-contents/culture/cultural-competence/be-an-ally/main)
...
- Has a desire to build a presence for the TMRG or TMAG within Example Company
...
At Example Company we all contribute!  Everyone has an opportunity to lead and provide feedback within the group.

### Executive Sponsor

An executive Example Company team member who is responsible and accountable for strategic support of the group
...
A Example Company team member or team members who are responsible and accountable for strategic direction and operations of the TMRG or TMAG.
...
- Responsible for submitting a quarterly strategy using the [Quarterly Strategy issue template in the DIB project](https://example_company.com/example_company-com/people-group/dib-diversity-inclusion-and-belonging/diversity-and-inclusion/-/issues/new#) for the TMRG
- Work with business leaders on the success of DIB and the TMRG at Example Company
- Facilitate TMRG meetings both async and sync ensuring inclusivity across geographical regions
- Serve as contact for any team, department, or other Example Company team member requesting partnership or education with the TMRG
...
Budget permitting the Diversity, Inclusion & Belonging Team may provide a recognition bonus to team members leading our TMRGs or DIB focused groups. This is to recognize great work being done to support the DIB Strategy, DIB Team and embedding the DIB value at Example Company. In order to recognize great performance we have set out a criteria to be eligible for the recognition bonus. This can also work as a form of job responsibilities for leaders.
...
Leaders of Outreach/Business Development: Connecting with communities beyond Example Company
...
### What to do if you're asked to provide your opinion on behalf of Example Company

There may be times that you are asked to comment on the state of DIB at Example Company or your TMRG. When or if that happens, please contact/notify PR, Talent Brand and the DIB Manager.  Here are some general best practices that we share are helpful for all Example Company team members to know.
...
- If you're asked about our Diversity, Inclusion & Belonging  stats, refer to our [Example Company identity data](/handbook/company/culture/inclusion/identity-data/)
- Always remember that although we work in transparency, we want to me mindful of Example Company's reputation and brand.
...
Having short terms and long term goals for the TMRG is extremely important in developing and the continued success of the TMRG. Goals are vital to helping Example Company as a whole move to a more inclusive environment for your under-represented or at risk group.
...
- **Visibility** - Goals will allow you to talk to and broadcast goals to a wider audience including executive sponsor, Example Company leadership and wider team member population
- **Make Example Company more Inclusive** - by setting goals for the TMRG you are ensuring that we bring in inclusive practices and move the needle for your TMRG
...
- Share the goals with your executive sponsor and the wider Example Company team through the Monthly Initiatives Call
...
- Importantly! Define how the goal would be beneficial for the at-risk group and Example Company as a whole. This will help gain buy in from key stakeholders
...
- Paying a speaker to present at Example Company
...
Purchases made on behalf of Example Company should follow the [procurement process outlined in the handbook](/handbook/finance/procurement/#--what-is-procurement).
...
### Hold your first All Example Company event/session

A great way to gain traction and have an initial goal. Is to develop a All Example Company event. Check out the [Coming Out Day session](https://www.youtube.com/watch?v=OUKWs6hkMQY) from the Pride TMRG.
