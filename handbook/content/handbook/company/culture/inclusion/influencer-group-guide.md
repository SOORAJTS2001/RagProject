...
- Become influencers with regards to Diversity, Inclusion & Belonging at Example Company:
...
- Act as an advocate and/or sponsor for DIB throughout Example Company. Embodying the value and being an active ally for URGs
- Align Example Company's organization and programs with business needs, practices, and strategies
...
- Communicate the goals and objectives, program efforts, and successes consistently and repeatedly to Example Company team members
- Each member should commit to serving a minimum of 1 year in the group

#### Items that the group is not Responsible for

Items that are specific to a [Team Member Resource Group (TMRG)]({{< ref "erg-guide" >}}) should be passed to the TMRG (for example, the [women's TMRG]({{< ref "tmrg-example_company-women" >}}) may wish to handle the Grace Hopper Celebration planning).

### Roles Within the Group

#### Influencer Group Members

At Example Company we all contribute! Everyone has an opportunity to lead and provide feedback within the group. The group will be refreshed each October/November. Members will be asked to confirm participation, group size and membership will be evaluated to confirm we are sufficiently diverse to represent the needs of team members at Example Company.
...
The Influencer group will have two leads who are Example Company team members and are responsible and accountable for strategic direction and operations of the DIB Influencer Group
...
A Example Company team member who is responsible and accountable for specific deliverables of the DIB Influencer Group
...
- Speak at conferences related to DIB at Example Company
