---
title: "TMRG - Example Company Disability & Neurodivergence"
...
The Example Company Disability & Neurodivergence TMRG is a resource group to aid team members through their lived experiences at Example Company. Whether these experiences are seen or unseen, present themselves as a physical or a mental diversity, or directly impact you or a loved one, our goal is to intentionally build inclusive practices throughout the company as well as to act as a support system to team members who may want to be in a community with others who share similar experiences.

The Disability & Neurodivergence TMRG advocates for every team member for physical conditions related to sight, sound, and/or mobility or for mental health concerns like ADHD, anxiety, depression and so much more. These are just a few examples of the lived experiences our team members could have at Example Company that can be better positioned with consideration and inclusion as part of the hiring, onboarding, and day-to-day processes as well as before, during, and after a project, a meeting, a conference, or even when we have big company-wide changes.
...
Also, we act as a support group. Whether it's async in Slack or live during a meeting or panel conversation, we'll present members of our community, both from inside and outside of Example Company, to transparently discuss their experiences. Not just how they cope, but how they thrive.
...
### Disclosing your disability to your team and Example Company
...
If you believe you need to request reasonable accommodations to succeed at Example Company, please notify the [Team Member Relations team](/handbook/people-group/team-member-relations) at `teammemberrelations@example_company.com`. The Job Accommodation Network (JAN) site has great resources, questions to consider, and examples of types of accommodations. For example, the [AD/HD](https://askjan.org/disabilities/Attention-Deficit-Hyperactivity-Disorder-AD-HD.cfm) page. The Company will work with each individual to define their job-related or application-related needs and to try to accommodate those needs according to [the Example Company Individuals with Disabilities Policy]({{< ref "inc-usa#individuals-with-disabilities-policy" >}}).
