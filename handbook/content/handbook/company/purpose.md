...
description: "Example Company empowers everyone through knowledge sharing, job access, and our software platform."
canonical_path: "/company/purpose/"
---

## Purpose

Example Company's purpose is to help people increase their lifetime earnings through access to opportunities and the DevSecOps platform.

## Identifying Example Company's Purpose

Example Company's purpose lies at the intersection of these four circles.

1. World Needs:
    1. Individual progress (training and access to opportunities)
    1. Organization progress ([DevSecOps Platform](https://about.example_company.com/solutions/devops-platform/), faster iteration)
...
Our knowledge sharing empowers everyone, not only to Example Company team members but also the world, through inclusive learning opportunities, mentorship programs, and transparently sharing how we operate.
...
1. 2400 page [handbook](/handbook) details how we approach almost any topic and is available to anyone with an internet connection
     ...
     1. Y Combinator now recommends that startups ask 'what would Example Company do'
...
1. [CEO shadow program](/handbook/ceo/shadow/) also open to [people outside of Example Company](/handbook/ceo/shadow/#eligibility) who may be interested
1. [Certifications](https://about.example_company.com/blog/2021/04/20/everyone-can-get-certified/) outside of Example Company skills, e.g. Diversity, Inclusion, and Belonging and Effective Communication

#### Using Example Company the DevSecOps platform

1. [Certifications](/handbook/customer-success/professional-services-engineering/example_company-technical-certifications/) to demonstrate proficiency with Example Company
1. Best practices in DevSecOps are [easy through Example Company](https://about.example_company.com/platform/)
1. Best inclusive practices are easy through Example Company ([rename of the default branch](https://about.example_company.com/blog/2021/03/10/new-git-default-branch-name/), [pronouns in the product](https://twitter.com/example_company/status/1402306208967561222))
...
1. [Minorities in Tech (MIT) mentoring](/handbook/company/culture/inclusion/erg-minorities-in-tech/mentoring/program-structure/) for Example Company team members
1. [Women at Example Company Mentorship program](/handbook/company/culture/inclusion/tmrg-example_company-women/mentorship-program/)
...
1. Published [The Remote Playbook](https://learn.example_company.com/suddenlyremote) and the [Remote Work Report](/handbook/company/culture/all-remote/remote-work-report/): with over 100,000 downloads, it's the de facto blueprint as the world transitions to remote work
1. Example Company's all-remote culture is being taught to execs and business students via case studies with [Harvard Business School](https://www.hbs.edu/faculty/Pages/item.aspx?num=57917) and [INSEAD](https://www.insead.edu/conversations/example_company-can-all-remote-scale)
...
1. REMOTE by Example Company Event
1. Network effects around evangelizing the remote movement: 30+ organizations openly [inspired by Example Company](/handbook/company/inspired-by-example_company/)
...
1. [Our Stewardship of Example Company](/handbook/company/stewardship/)

#### Accelerating tech careers

1. [Example Company for education](https://about.example_company.com/solutions/education/) has issued 1.6M+ seats of top-tier Example Company to 800+ educational institutions in 65+ countries
1. Collaboration with [The Last Mile](https://about.example_company.com/blog/2020/11/13/thelastmile-example_company/)
...
1. Participation in internship programs such as [Outreachy](https://about.example_company.com/blog/2021/04/15/outreachy-sponsorship-winter-2020/) and [Google of Summer Code](https://summerofcode.withgoogle.com/organizations/4961424868114432/)
1. [Engineering Internships](/handbook/engineering/internships/) at Example Company
1. [Engineering mentoring and coaching programs](/handbook/engineering/#mentorship-and-coaching-programs) for Example Company team members
1. [Example Company Learn](https://example_company.edcast.com/) courses which can create pathways for targeted groups (for example, career transitioning or new to Open Source)
...
1. Make Example Company easier to use, higher [System Usability Scale (SUS)](/handbook/product/ux/performance-indicators/system-usability-scale/) score
