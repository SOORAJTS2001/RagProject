...
| Epic - Primary                 | [Primary](https://example_company.com/groups/example_company-data/-/epics/1083)|
| Epic - Security                | [Security](https://example_company.com/example_company-data/analytics/-/issues/18848) |
| Epic - Compliance              | [Compliance](https://example_company.com/example_company-data/analytics/-/issues/18849) |
| Board                          | [Lighthouse Metric Definitions Board](https://example_company.com/example_company-data/analytics/-/boards/7148077?label_name%5B%5D=WorkingGroup%3A%3ALighthouseMetric) |
...
- Apply the appropriate [Working Group status labels](https://example_company.com/groups/example_company-com/-/labels?subscribed=&search=wg-status) for issues or epics
  ...
  - `wg-status::Complete`
  - `wg-status::Cancelled`
- Formalize "asks" of the Working Group by filing an issue against the [EPIC](https://example_company.com/groups/example_company-data/-/epics/1083) to enable cross-functional visibility, collaboration, and prioritization
