...
description: "The Example Company Learning Restructure Working Group aims to create a plan and processes for ensuring a high quality learning experience for users "
---
...
| Related Epics and Issues | [Learning Restructure Issue](https://example_company.com/example_company-com/office-of-the-ceo/cos-team/-/issues/147) and [Example Company Education Content Management Epic](https://example_company.com/groups/example_company-com/customer-success/professional-services-group/-/epics/1277)         |
...
1. Inventory existing training programs to establish a SSoT ==> Complete, established in [Example Company Learn](https://about.example_company.com/learn/)
1. Update <https://about.example_company.com/learn/> to capture SSoT and provide more clarity on which training is for what ==> Complete

### Create future coordination processes and plan

1. Document in the Handbook a process that DRIs working on learning content will follow to keep [Example Company Learn](https://about.example_company.com/learn/)up-to-date, to ensure it remains the SSOT of Example Company-produced learning content. This will include existing content and planned content. ==> Complete, documented and established #example_company-learn-updates Slack channel for reminders to update and x-team communications.
