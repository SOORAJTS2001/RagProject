...
[FY 25 Yearlies](https://internal.example_company.com/handbook/company/yearlies/) have specific goals around both CI and Security & Compliance adoption, and this working group is re-aligning to support and service both use cases.
...
| Slack                          | [#wg_customer-use-case-adoption](https://example_company.slack.com/archives/C0584NEKSRJ) |
...
| Epic - Primary                 | [Use Case Adoption Measurement & Improvement](https://example_company.com/groups/example_company-com/-/epics/2190) |
...
Included in our [FY 25 Yearlies](https://internal.example_company.com/handbook/company/yearlies/) is a goal to `Accelerate visibility into usage and drive value by driving CI, Compliance and Security adoption`.  Supporting this Yearly are two (2) objectives:
...
CI Adoption Initiatives
  - FY24-Q4: [CI Adoption - Acceleration Proposals to drive CI ARR to 50% by FY24-Q4](https://example_company.com/groups/example_company-com/-/epics/2250)
  - FY24-Q3: [CI Adoption - Acceleration Proposals to drive CI ARR to 50% by FY24-Q3](https://example_company.com/groups/example_company-com/-/epics/2225)
...
- Apply the appropriate [Working Group status labels](https://example_company.com/groups/example_company-com/-/labels?subscribed=&search=wg-status) for issues or epics
  ...
  - `wg-status::Complete`
  - `wg-status::Cancelled`
- Formalize "asks" of the Working Group by filing an issue against the [Use Case Adoption - Working Group Asks](https://example_company.com/groups/example_company-com/-/epics/2232) epic to enable cross-functional visibility, collaboration, and prioritization
