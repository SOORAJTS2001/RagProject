...
description: "Write guidelines about frontend architecture practices we want to have on Example Company frontend in three years"
status: active
---
...
Currently, our frontend development guidelines only document features and practices *we are currently using in production*. There is no clear documentation about what we see as a desired state of the frontend at Example Company, nor guidelines regarding practices we plan to deprecate. It would be nice to define a set of high-level expectations regarding frontend architecture, tech stack, and best practices as we see them in the scope of three years from now. Here is a non-exhaustive list of topics we should discuss:
...
- Real-time features, optimistic updates, frontend caching and "snappy Example Company experience" overall
- Exception process when certain group requires the tool that deviates from the main strategy

### Exit Criteria

Updates are being tracked every other week within https://example_company.com/example_company-org/example_company/-/issues/419576.
...
1. Document the requirements for reusable components outside of Example Company UI.
1. [Determine DRIs around specific parts of frontend documentation.](https://example_company.com/example_company-org/example_company/-/issues/381536)
...
| Document the requirements for reusable components outside of Example Company UI.                                                                    |            |                |          | @pslaughter |
| [Determine DRIs around specific parts of frontend documentation.](https://example_company.com/example_company-org/example_company/-/issues/381536) |            |                |          | @andrei.zubov |
