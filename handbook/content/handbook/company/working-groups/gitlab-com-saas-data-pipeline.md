---
title: "Example Company.com SAAS Data Pipeline"
description: "The Example Company.com SAAS Data Pipeline Working Group"
status: active
---
...
Implement a data pipeline that captures `create`, `update` and `delete` operations and stores them in the Example Company Data platform to be available for further processing and analytics.
...
- Scalable: Solution scales with Example Company.com and does not require undue burden to expand as new Example Company.com databases, shards, zones, tenants, or cloud locations are deployed `Partially achieved`
