...
| Target End Date | TBD                                                                                                                                    |
| Slack           | [#wg_automotive_development](https://example_company.slack.com/archives/C057WU9SK61) (only accessible from within the company)   |
...
- Establish Example Company as the leading platform for automotive software development
...
| Functional Lead Alliances | @DarwinJS | Darwin Sanoy | Principal Solutions Architect, Example Company Alliances |
| Working Group DRI             | @mbruemmer | Martin Brümmer | Customer Success Engineer |
| Facilitator                  | @bmarnane  | Bartek Marnane | VP of Incubation Engineering at Example Company |
