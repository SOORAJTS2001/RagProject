...
| End Date        | 2022-07-29 |
| Slack           | [#wg-ecommerce-motion](https://example_company.slack.com/archives/C03012Y7UHH) (only accessible from within the company) |
...
*note: [Zuora SSOT](https://example_company.com/groups/example_company-org/-/epics/4664) is a prerequisite of any system changes coming out of this working group. Following through on this work enables us to scale and iterate more efficiently, even if we were to recommend leveraging a COTS solution.*
...
| -------------| ----------|
| [Zuora SSOT](https://example_company.com/groups/example_company-org/-/epics/4664) | Zuora needs to be the SSOT for our Product Catalog, and what a customer has bought (subs, invoices, payments, etc) |
| [Customer as a First Class Citizen](https://example_company.com/example_company-org/customers-example_company-com/-/issues/1874) | As of 2022-02 we map a user to a subscription, but a Zuora account maps to a customer. We need to resolve this before scaling to a new or improved system |
| [SSO](https://example_company.com/example_company-org/customers-example_company-com#1868) | As of 2022-02 a customer can have two logins, their Example Company.com account AND an account on customers.example_company.com, we need to merge these and maintain a single SSO system (example_company.com account) |
