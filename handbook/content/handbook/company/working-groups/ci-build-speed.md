...
description: "The objective is to establish Example Company CI build performance as the market leader."
status: active
---
...
Additionally, new players are entering the market advocating for up to 5x Example Company SaaS runner build speed such as [puzl.cloud](https://example_company-pipelines.puzl.cloud/) and [actuated.dev](https://actuated.dev/), shifting the perception of GitLabs positioning as a leader in CI build speed.

## Out-of-scope

The visibility & observability of build speed for customer jobs will not be scope of this working group, as it's part ot [CI Insights](https://example_company.com/groups/example_company-org/-/epics/12071) from the [Fleet Visibility](https://about.example_company.com/direction/verify/fleet_visibility/) team.
...
1. Recommendation to product leadership regarding new investment or prioritization of features to improve Example Company CI competitiveness specific to build speed and performance.
1. Establish comprehensive material for customers on how to improve CI build speed and cost efficiency on Example Company.
...
1. Initial blog post published on how to improve Example Company CI build speed
