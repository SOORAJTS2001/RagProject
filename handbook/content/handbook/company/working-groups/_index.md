...
You may also want to use an [issue board](https://docs.example_company.com/ee/user/project/issue_board.html) as an overview of progress.
...
1. [Example Company Administration]({{< ref "administration" >}})
