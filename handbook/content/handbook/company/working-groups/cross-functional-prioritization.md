...
1. **Achieve an optimal balance** of new features, security fixes, availability work, performance improvements, bug fixes, etc. via a framework that helps drive conversations and alignment. Balance across these categories will allow Example Company to operate in a way that will allow us to meet revenue goals and maintain the stability of our platform.
...
| Slack           | [#wg_cross-functional-prioritization](https://example_company.slack.com/archives/C03AWM7780G) |
...
| Issue board    | [Issue board](https://example_company.com/groups/example_company-com/-/boards/4199535?not[label_name][]=wg-cross-functional-prioritization-adoption&label_name[]=wg-crossfunctional-prioritization) |
| Open merge requests for the working group | [MR list](https://example_company.com/example_company-com/www-example_company-com/-/merge_requests?label_name%5B%5D=wg-cross-functional-prioritization) |
...
- [x] Name the new process (DONE "cross-functional prioritization) [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13274)
- [x] All groups have dashboards that they can use to analyze merged MR ratio of features, maintenance, bugs and undefined. [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13294), [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13448)
- [ ] Type:Undefined Issues are driven down to 0% [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13760)
- [ ] Type:Undefined MRs are driven down to 0% [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13759)
- [ ] Subtypes label are defined and implemented [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13650)
- [ ] Add dashboards to trend and identify issues and merge requests without a subtype [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13781)
...
- [x] All groups are reviewing the dashboards and discussing it periodically (monthly) in a way where stakeholders can influence decisions. [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13304)
- [x] Development engineering managers are providing their maintenance priorities to PM [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13304)
- [x] Quality leads are providing their bug priorities to PM [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13304)
- [x] The quad stable counterparts (PM, Development EM, Quality Engineering Manager, UX Design Manager) collaborate to determine which issues which will be planned for which milestone [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13304)
- [x] Automation exists to streamline the process. [Issue](https://example_company.com/example_company-com/quality/engineering-productivity/-/issues/5), [Issue](https://example_company.com/example_company-com/quality/engineering-productivity/-/issues/6)
- [ ] Framework for autoscheduling initial iterations of S1/S2 bugs is merged, and we've documented a process for expanding the automation to more groups and severities over time. [issue](https://example_company.com/example_company-org/example_company/-/issues/368641)
...
- [ ] Feedback is gathered, considered, and incorporated as appropriate by the DRI for each respective area [Issue](https://example_company.com/example_company-com/www-example_company-com/-/issues/13694)
