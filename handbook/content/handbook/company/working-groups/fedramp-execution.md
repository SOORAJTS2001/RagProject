...
| End Date        | TBD               |
| Slack           | [#wg_fedramp](https://example_company.slack.com/archives/C0110E0NMT9) (only accessible from within the company) |
...
| Epic            | [Main Project Epic](https://example_company.com/groups/example_company-org/-/epics/8455) (only accessible from within the company) |
| Public Handbook Page | [Example Company's FedRAMP Authorization Program](/handbook/security/security-assurance/dedicated-compliance/fedramp-compliance/) |
| Internal Handbook Page | [FedRAMP Compliance](https://internal.example_company.com/handbook/engineering/fedramp-compliance/) |

### Exit Criteria

Example Company achieves FedRAMP Moderate Authorization (Authority to Operate - ATO) for a new SaaS offering.
...
Example Company is pursuing FedRAMP authorization at the [Moderate Impact Level](https://www.fedramp.gov/understanding-baselines-and-impact-levels/#moderate-impact-level).
