...
description: "The Example Company Logging Working Group will have multiple business purposes that you can read about on this page. Learn more!"
---
...
| Date Ended   | TBD |
| Slack        | [wg-glsecurity-logging](https://example_company.slack.com/archives/C03JXV6KMFA) |
...
1. Increase [efficiency](/handbook/values/#efficiency) by having a highly available simplified logging structure used by Example Company security to monitor, manage, detect, alert, respond, and audit events.
1. Increase [collaboration](/handbook/values/#collaboration) by having a simplified logging system for Example Company security to share and collaborate on events.
1. Increase [results](/handbook/values/#results) by having relevant and actionable data for Example Company Security to make more accurate and informed decisions to threats to Example Company
...
[Moved Here](https://example_company.com/example_company-com/gl-security/security-operations/infrastructure-security/projects/security-logging/-/issues/3)
...
- As a Example Company team member, I know there is a single team I can talk to about all things being logged at Example Company.
- As a Example Company team member, I can find who is on the logging team by visiting a single handbook page.
- As a Example Company team member, I can contact the logging team via dedicated slack channel.
- As a Example Company team member, I can label Example Company issues for the logging team.
...
- As an IT Engineer, I can configure basic downtime or high activity threshhold alerts that send to different notification services (email, Slack, Example Company issue, etc.)
