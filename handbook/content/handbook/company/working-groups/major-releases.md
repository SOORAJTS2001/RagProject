...
| End Date       | 2023-07-01                                                   |
| Slack          | [#wg_major-releases](https://example_company.enterprise.slack.com/archives/C073MV570F7) (only accessible from within the company) |
...
| Epic           | [Future Major Release Coordination & Improvements](https://example_company.com/groups/example_company-com/-/epics/2363) |
| Overview & Status | Open |

## Purpose

The `Major Releases Working Group aims to minimise any negative customer impact related to the major release and breaking change across SaaS and self manged Example Company users.
...
- [Go through product deprecations and separate the high impact ones for further analysis](https://example_company.com/groups/example_company-com/-/epics/2293#specific-asks-for-pms).
...
- Understand whether deprecation policy and Example Company's working interpretation are aligned / need to be changed.
- Put a plan in place to improve conditions for next major release and remove need for this working group next iteration.

### Exit Criteria

Exit Criteria are avaialable in the [Future Major Release Coordination & Improvements Epic](https://example_company.com/groups/example_company-com/-/epics/2363#exit-criteria).
