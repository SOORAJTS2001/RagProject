...
| Slack           | [#wg_product_development_flow](https://example_company.slack.com/archives/C019KM43H4K) (only accessible by Example Company team members) |
| Google Doc      | [Working Group Agenda](https://docs.google.com/document/d/10pCsqXVXakRKYVKPmouX7C5g7T_1kBsufLRcN6nGZQI/edit#) (only accessible by Example Company team members) |
| Docs            | TBD |
| Epics/Issues    | [Main Epic](https://example_company.com/groups/example_company-com/-/epics/938/) / [Issue Board](https://example_company.com/example_company-com/www-example_company-com/-/boards/2012861?label_name[]=wg-product-development-flow) |
| Label           | `~wg-product-development-flow` |
| Associated KPIs/OKRs | TBD |
| Example Company group for working group reviewers | `@wg-product-development-flow` |
| Example Company group for working group contributors (MR authors) | `@wg-contributors-pd-flow` |
...
To propose an idea or solution that addresses one of the [defined problems](https://example_company.com/groups/example_company-com/-/epics/938#problems-to-solve) - follow the below steps to ensure effective asynchronous collaboration:

1. Create an issue to address your proposal and add it to [Product Development Flow as a Framework epic](https://example_company.com/groups/example_company-com/-/epics/938)
1. We use [this issue board](https://example_company.com/example_company-com/www-example_company-com/-/boards/2012861?label_name[]=wg-product-development-flow) as a single source of truth. Issues should be moved through the board from left to right
...
- Our goal is to minimize noise for Reviewers (inclusive of Executive Sponsors) and focus feedback efforts to move forward efficiently. If you want to follow every issue/MR, you're welcome to do so via our [WG board](https://example_company.com/example_company-com/www-example_company-com/-/boards/2012861?label_name[]=wg-product-development-flow)
...
- Identify any downstream process changes that might need review.
  - [Quad Planning process](https://example_company.com/example_company-com/www-example_company-com/-/issues/9130)
