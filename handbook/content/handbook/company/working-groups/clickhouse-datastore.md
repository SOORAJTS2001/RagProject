...
| Epic            | [Link](https://example_company.com/groups/example_company-com/-/epics/2070) |
...
In FY23 ClickHouse was selected as Example Company's standard datastore for features with big data and insert-heavy requirements (e.g. Observability, Analytics, etc.)  ClickHouse is not intended to replace Postgres or Redis in Example Company's stack.
...
In April 2024 the ClickHouse Working Group was closed out.  The group made major progress introducing ClickHouse to Example Company's architecture to support Example Company's analytics and monitoring features.

* Enabled usage of ClickHouse Cloud with Example Company, including security and legal approval for storing customer RED data and production readiness reviews.
...
* Fixed features such as Contributor Analytics which were no longer performant on Example Company.com.
* Developed documentation and tooling for using ClickHouse in Example Company's development process.

Due to the overlap with the recently created [Product Usage Data Architecture Working Group](https://internal.example_company.com/handbook/company/internal-working-groups/product-usage-data-architecture/), the decision was made to wind down the ClickHouse group, and roll those concerns into that group's work defining the architecture for analytical features.
...
1. Develop & Socialize Architecture Strategy for ClickHouse usage.
    1. Architecture Blueprint for ClickHouse usage within Example Company.
    1. Architecture Blueprint for scalable data ingestion pipeline for ClickHouse within Example Company.
...
1. Develop a Rollout Strategy and Plan (e.g. feature flags, would customers ever want to disable/remove it, etc.).
    ...
    1. Lay the groundwork to add ClickHouse to [our reference architectures](https://docs.example_company.com/ee/administration/reference_architectures) through self-managed support.
...
|----------|------------|------------|------------|------------|
| [Document and review current ClickHouse uses/capabilities and future use cases](https://example_company.com/groups/example_company-com/-/epics/2075) | 2022-12-08 | 2023-02-01 | 100% | Marshall Cottrell |
| [Develop and socialize architecture strategy for ClickHouse usage](https://example_company.com/groups/example_company-com/-/epics/2076) | 2023-01-05 | 2023-05-25 | 100% | Nick Nguyen |
| [Develop a ClickHouse rollout strategy and plan](https://example_company.com/groups/example_company-com/-/epics/2077) | 2023-01-05 | | 60% | Sam Goldstein |
| [Develop Recommendation for ClickHouse Ownership Model](https://example_company.com/groups/example_company-com/-/epics/2094) | | | 0% | |
| [Develop and implement a communication plan for the working group](https://example_company.com/groups/example_company-com/-/epics/2078) | 2023-01-18 | | 0% | Nicole Williams |
| [Complete production readiness through to GA](https://example_company.com/groups/example_company-com/-/epics/2316) | 2023-08-04 | | 75% | Nathan Rosandich |

### Current and Planned Use Cases

* [Current status of ClickHouse and Example Company's implementation](https://example_company.com/example_company-com/ops-sub-department/ops-engineering-management/-/issues/205)
* [ClickHouse Use Cases](https://example_company.com/example_company-org/example_company/-/issues/384184)
