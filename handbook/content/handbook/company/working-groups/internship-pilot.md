...
| Slack           | [#wg_internship-pilot](https://example_company.slack.com/archives/CNLLV1NEN/) (only accessible from within the company) |
...
| Issue Board     | [Issue board](https://example_company.com/groups/example_company-com/-/boards/1360344?&label_name[]=wg-internship-pilot)             |
...
1. [Define budget](https://example_company.com/example_company-com/www-example_company-com/issues/5526) => `100%`
    1. Determine number of internship positions available ✅
    1. Determine compensation ✅
    1. Determine budget for co-location ✅
1. [Communication plan](https://example_company.com/example_company-com/www-example_company-com/issues/5527) => `100%`
    1. Choose the internship program name ✅️
        1. "Example Company All-Remote internship"
...
1. [Recruitment plan](https://example_company.com/example_company-com/www-example_company-com/issues/5528) => `100%`
    1. Define candidate qualification criteria ✅
        ...
        1. Interested in fulltime employment after the internship (either immediately, or "next semester") - no upfront commitment to Example Company required
...
1. [Internship program structure](https://example_company.com/example_company-com/www-example_company-com/issues/5529) => `100%`
    ...
    1. Define expected day-to-day activities for interns (skeleton outline) ✅
        ...
        1. For weeks 2-15 an intern's daily schedule will generally reflect how Example Company team members work, which is to say we will not impose a rigid schedule.
...
1. [Interviewing](https://example_company.com/example_company-com/www-example_company-com/issues/5530) => `100%`
    1. Define interview process and technical assessments ️️✅
        ...
        1. Behavioral/Values interview panel (Candidates must score a strong yes to move on to the panel interview stage.)
            ...
            - Recruiter/HR
            - Misc Interviewer
1. [Measurements of success](https://example_company.com/example_company-com/www-example_company-com/issues/5532) => `100%`
...
1. [Onboarding/offboarding](https://example_company.com/example_company-com/www-example_company-com/issues/5531) => `100%`
...
1. Measuring program success => `100%`
    ...
    1. [Create feedback questionnaire for teams](https://example_company.com/example_company-com/engineering-internships/blob/master/.example_company/issue_templates/Retrospective.md) ✅
1. Promote the internship => `100%`
    1. Blog post ✅
1. [Flesh out program details](https://example_company.com/example_company-com/engineering-internships/issues/3) => `100%`
    1. [Define "Week 1: Intern Fast Boot" program details](https://example_company.com/example_company-com/www-example_company-com/-/merge_requests/39198) ✅
    1. [Define "Week 16: Intern send-off" program details](https://example_company.com/example_company-com/www-example_company-com/-/merge_requests/39588) ✅
