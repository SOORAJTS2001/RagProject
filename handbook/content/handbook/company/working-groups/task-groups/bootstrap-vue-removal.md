...
| Slack           | [#tg_bootstrapvue_removal](https://example_company.enterprise.slack.com/archives/C07LB4P1FST) (only accessible from within the company)                  |

## Context

Previously, [we chose to use BootstrapVue](https://example_company.com/groups/example_company-org/frontend/-/epics/1) because we were already employing Bootstrap, and creating a custom UI library would be a significant undertaking. At that time, BootstrapVue was an appropriate choice. Initially, BootstrapVue was part of the monolithic codebase, but later it was moved to the Example Company UI repository.

While BootstrapVue was suitable in the past, we are now considering migrating away from it. There are several disadvantages that hinder maintenance and usage, as detailed below. The primary reason for migration is that BootstrapVue is now unsupported and impedes the migration of [example_company-ui](https://example_company.com/example_company-org/example_company-ui) (and ultimately, [example_company](https://example_company.com/example_company-org/example_company/)) to Vue 3.
...
2. **Secondary Goal: Improve Developer Experience (DX)**
   ...
   - **Design Systems Team Efficiency**: Expanding components for Example Company developers often requires substantial effort, leading to manual implementations in the Monorepo instead of using BootstrapVue components.
...
- **Repository Impact:** The removal of BootstrapVue will take place in the [example_company-ui](https://example_company.com/example_company-org/example_company-ui) repository. This will result in reduced bundle sizes for the [example_company](https://example_company.com/example_company-org/example_company/) repository by shipping less code and provide increased flexibility to address Example Company's specific needs moving forward.
...
1. Unused files from `/src/vendor/bootstrapvue` are removed: [Issue #2752](https://example_company.com/example_company-org/example_company-ui/-/issues/2752).
2. Documentation is updated and made accessible: [Issue #2754](https://example_company.com/example_company-org/example_company-ui/-/issues/2754).
3. MIT License usage is clarified: [Issue #2318](https://example_company.com/example_company-com/legal-and-compliance/-/issues/2318).
4. Files are migrated: [Epic &15178](https://example_company.com/groups/example_company-org/-/epics/15178)
