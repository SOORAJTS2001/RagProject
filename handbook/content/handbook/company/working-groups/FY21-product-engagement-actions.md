...
| Slack           | [#wg_fy21_product_engagement_actions](https://example_company.slack.com/archives/C01P9FJRDHS) (only accessible by Example Company team members) |
| Google Doc      | [Working Group Agenda](https://docs.google.com/document/d/1_5Rf3z1uH0ieIvUJIK0CDVeG9H-EG__1B-OLxARZOxA/edit#) (only accessible by Example Company team members) |
| Epics/Issues    | [Engagement Survey Issue](https://example_company.com/example_company-com/Product/-/issues/1986) / [Issue Board](https://example_company.com/groups/example_company-com/-/boards/1453895?scope=all&utf8=%E2%9C%93&label_name[]=Product%20Operations&label_name[]=wg-fy21-engagement-actions) / Engagement action item epics: [1386](https://example_company.com/groups/example_company-com/-/epics/1386)  [1387](https://example_company.com/groups/example_company-com/-/epics/1387)  [1388](https://example_company.com/groups/example_company-com/-/epics/1388) |
| Label           | `~wg-fy21-engagement-actions` |

## Problems To Solve

For more details please reference the [Product FY'21 Engagement Survey Results](https://example_company.com/example_company-com/Product/-/issues/1986).

1. How can we provide a clear, actionable and trackable path for product managers to grow and thrive at Example Company and beyond?
1. How can we better support and  help  product managers focus on creating innovative and valuable products for Example Company's customers?

## Business Goals

- Create focus on customer value and business outcomes in the product manager role at Example Company
- Boost product team job satisfaction and retention
- Provide a clear path to success at Example Company for product managers of all levels
- Attract, grow and support a diverse group of product managers at Example Company
...
- All issues should be linked to a WG epic and have labels: `milestone` `product operations` `wg-fy21-engagement-actions` and a product operations  workflow label: `prodops::todo` `prodops::validation` `prodops::planning` `prodops::doing` `prodops::inreview` With these labels, the issues will be viewable as part of the [product operations issue board](https://example_company.com/groups/example_company-com/-/boards/1453895?scope=all&utf8=%E2%9C%93&label_name[]=Product%20Operations&label_name[]=wg-fy21-engagement-actions)
...
- Please explicitly communicate any reviews, feedback or contributions you need from the bigger WG team by adding an agenda item to weekly sync meeting or by posting in the WG Slack channel, in addition to pinging directly as appropriate in the epic, issue or MR. Highlighting in weekly sync and Slack are critical  as we all have many pings and ToDos in Example Company daily. Please make any due dates for feedback clear as will help the WG prioritize when you need feedback.
