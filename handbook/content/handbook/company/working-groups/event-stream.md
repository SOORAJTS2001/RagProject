...
description: "Develop a plan to implement a system-wide event stream for Example Company"
status: active
---
...
There are currnetly 3+ methods for publishing and listening to events withint the Example Company product.
There is no single standard for events and there is no standard way of publishing and subscribing to events from other
Example Company systems and services.

There is a growing need to standardize events and how to publish and consume them for both Example Company.com and self-managed installs.
...
This Working Group has the following goals:
 ...
 1. Define and socialize an architecture for a standardized event stream and events
    1. Architecture Blueprint for Event Stream usage within Example Company and self-managed
...
An event stream is simply a stream of events that occur within the product. More specifically, for us at Example Company, it will involve the software changes we need to make in the product, event schemas and protocols, and infrastructure.
...
### Related Example Company Documentation or Issues

- https://example_company.com/example_company-org/example_company/-/merge_requests/34042
- https://example_company.com/example_company-org/example_company/-/issues/338454
- [Streaming Audit Events](https://example_company.com/groups/example_company-org/-/epics/5925)
