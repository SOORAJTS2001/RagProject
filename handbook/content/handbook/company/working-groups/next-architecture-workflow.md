...
| Slack           | [#architecture](https://example_company.slack.com/archives/CJ4DB7517) (internal)     |
...
1. [Cross-functional prioritization](/handbook/product/cross-functional-prioritization/) framework allocates
   ...
   defined by [architecture evolution blueprints](https://example_company.com/example_company-org/example_company/-/tree/master/doc/architecture/blueprints).
...
- Take inventory of current and historical [Engineering Allocation](/handbook/engineering/#engineering-allocation)
  ...
  [blueprints](https://example_company.com/example_company-org/example_company/-/tree/master/doc/architecture/blueprints), following the [Architecture Evolution Workflow](/handbook/engineering/architecture/workflow/).
...
- The [Architecture Evolution Workflow](/handbook/engineering/architecture/workflow/) is complex, spans
  ...
  participate in.
- [Architecture Blueprints](https://example_company.com/example_company-org/example_company/-/tree/master/doc/architecture/blueprints) provide great context and detail, but
...
(see [`example_company-com/www-example_company-com!104378`](https://example_company.com/example_company-com/www-example_company-com/-/merge_requests/104378)),
