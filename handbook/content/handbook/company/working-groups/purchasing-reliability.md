...
| Slack           | [#wg_purchasing_reliability](https://example_company.slack.com/app_redirect?channel=C02PQ4U0E7K) (only accessible from within the company) |
...
At Example Company, "fulfillment" generally refers to the [Fulfillment Sub-department](/handbook/engineering/development/fulfillment/) of Engineering.
...
- [#s_fulfillment](https://example_company.slack.com/app_redirect?channel=CMJ8JR0RH)
- [#s_fulfillment_engineering](https://example_company.slack.com/app_redirect?channel=C029YFPUA6M)
- [#enterprise-apps](https://example_company.slack.com/app_redirect?channel=CCPG8P3K4)
- [#bt-integrations](https://example_company.slack.com/app_redirect?channel=C015U7R5XJ8)
...
- [CustomersDot](https://example_company.com/example_company-org/customers-example_company-com)
- [example_company-org&3602](https://example_company.com/groups/example_company-org/-/epics/3602): Example Company <> Customers, License, Zuora Integration

### Enterprise Apps

- [Quote to Cash](/handbook/business-technology/enterprise-applications/quote-to-cash/)
- [Platypus](https://example_company.com/example_company-com/business-technology/enterprise-apps/integrations/platypus)
- [example_company-com/business-technology/enterprise-apps&293](https://example_company.com/groups/example_company-com/business-technology/enterprise-apps/-/epics/293): Distributor e-Marketplace
