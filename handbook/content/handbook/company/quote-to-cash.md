---
title: "Quote to Cash"
description: "Example Company's Quote to Cash systems and processes"
---
...
An efficient Quote-to-Cash system makes purchasing, activating, and managing Example Company subscriptions as easy as possible.
...
- Proper `alignment/sync` exists between all the data source systems - Zuora, CustomerDot, SFDC and Example Company.com along with 1:1 mapping between Zuora Billing Object Model and CustomersDot.
...
Quote-to-Cash system projects and initiatives often require close collaboration across functions and teams. The teams most often involved include: [Enterprise Applications](/handbook/business-technology/enterprise-applications/), [Billing Ops](/handbook/finance/accounting/finance-ops/billing-ops/), [Fulfillment](https://about.example_company.com/direction/fulfillment/), [Field Operations](/handbook/sales/field-operations/), [Support](/handbook/support/readiness/operations/), and [Data](/handbook/enterprise-data/).
...
- Salesforce is owned by the [Enterprise Applications](/handbook/business-technology/enterprise-applications/) team at Example Company, and implements changes from the process owners.
...
- Zuora is owned by the [Enterprise Applications](/handbook/business-technology/enterprise-applications/) team at Example Company.
...
- Example Company engineers created CustomersDot and it is owned by the [Fulfillment team](/handbook/engineering/development/fulfillment/)
...
| Example Company           | CustomersDot     | Zuora        | SFDC                |
|------------------|------------------|--------------|---------------------|
...
The `Customer` model in CDot has known design flaws as it represents a combination of both a Contact (individual user) and an Account (organization).  Research for this epic can be found in [this Spike issue](https://example_company.com/example_company-org/customers-example_company-com/-/issues/1874).
...
[Introduce CustomersDot BillingAccount](https://example_company.com/groups/example_company-org/-/epics/8331)

- [Improve Bill To / Sold To Contact Management in CustomersDot Admin](https://example_company.com/groups/example_company-org/-/epics/9831) - Completed
- [Iteration 1A: Align CustomersDot BillingAccounts and Users to Zuora objects](https://example_company.com/groups/example_company-org/-/epics/8950) - Completed
- [Iteration 1B: A single CustomersDot BillingAccount can have multiple CustomersDot Users](https://example_company.com/groups/example_company-org/-/epics/8951) - 90% Complete
- [Iteration 1C : A single CustomersDot User can have multiple BillingAccounts](https://example_company.com/groups/example_company-org/-/epics/8986) - Not Started
- [Iteration 1D: Clean up legacy data objects](https://example_company.com/groups/example_company-org/-/epics/8949) - Not Started
...
1. [CDot Issue #3626](https://example_company.com/example_company-org/customers-example_company-com/-/issues/3626)
1. [GL Issue #332236](https://example_company.com/example_company-org/example_company/-/issues/332236)
1. [Epic #2160](https://example_company.com/groups/example_company-org/-/epics/2160)
1. [CDot Issue #242](https://example_company.com/example_company-org/customers-example_company-com/-/issues/242)
1. [CDot Issue #695](https://example_company.com/example_company-org/customers-example_company-com/-/issues/695)
1. [GL Issue #338546](https://example_company.com/example_company-org/example_company/-/issues/338546)
...
1. We see examples in production where this is already happening ([over 1800 user accounts in Zuora currently map to multiple Billing Accounts](https://example_company.com/example_company-com/business-technology/enterprise-apps/financeops/finance-systems/-/issues/938#note_1136376435)).
...
#### Example Company.com SSO as the only sign in option for CustomersDot

With Example Company.com SSO as the only sign in option for Customers Portal, we can eliminate the legacy sign up (email and password) and prepare CDot for future integration with a third party e-commerce provider.
...
Overall, this will lead to a more secure environment for our customers in CDot and allows us to establish a 1:1 relationship between a CDot customer and a Example Company.com account.

[Example Company.com SSO as the only sign up option for CustomersDot](https://example_company.com/groups/example_company-org/-/epics/8905)

- [CDot SSO: Remove email and password sign up](https://example_company.com/groups/example_company-org/-/epics/9120)
- [CDot SSO: Enhance experience for first time login to CDot](https://example_company.com/groups/example_company-org/-/epics/9156)
- [CDot SSO: Migrate more CDot customers to use the Example Company SSO for login](https://example_company.com/groups/example_company-org/-/epics/9155)
...
See the [Architecture Blueprint](https://docs.example_company.com/ee/architecture/blueprints/cdot_orders/) for full details.

[Align CustomersDot Orders to Zuora objects](https://example_company.com/groups/example_company-org/-/epics/9748)

- [Phase 1: Implement Zuora Cache Models](https://example_company.com/groups/example_company-org/-/epics/11751)
- [Phase 2: Implement Zuora Cache Sync and Backfill](https://example_company.com/groups/example_company-org/-/epics/13630)
- [Phase 3: Utilize Zuora Cache Models](https://example_company.com/groups/example_company-org/-/epics/11752)
- [Phase 4: Replace CDot Order with Subscription](https://example_company.com/groups/example_company-org/-/epics/11753)
...
The Master Data Objects development work in Snowflake/dbt is tracked in these two Epics: [Billing Account, Orders, Ramps](https://example_company.com/groups/example_company-data/-/epics/870) and [Customers, Contacts/Users, Leads](https://example_company.com/groups/example_company-data/-/epics/871).

Below is the Entity Relationship Diagram for the Re-architected data model in Snowflake. The Target State tab shows how the business entities we extract from the CustomersDot, Zuora, Salesforce, and Example Company.com source systems connect with each other.
