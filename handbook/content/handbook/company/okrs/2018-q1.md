...
- CEO: Make sure that 70% of salespeople are at 70% of quota
  ...
  - CMO: Further develop thought leadership platforms for Example Company around topics including forecasting the future of development, redefining cultural excellence, and helping to make security an actionable priority for developers.

## Objective 2: Popular next generation product

- CEO: Example Company.com ready for mission critical workloads
  - VPE: Move Example Company.com to GKE => Did not happen
    - Geo: Make Geo performant to work at Example Company.com scale
    - Distribution: TBD?
    - Gitaly: TBD?
    - CI/CD: TBD?
  - VPE: Example Company.com available 99.95% and monthly disaster recovery exercises => Hit 99.5% according to inferior monitoring on Pingdom, did not conduct monthly DR (but did do plenty of geo testing)
  - VPE: Example Company.com speed index < 1.5s for all tested pages => Did not focus on this
  - VP Product
    - Product: Ship group-level authentication
- CEO: On track to deliver all features of [complete DevOps](https://about.example_company.com/blog/2017/10/11/from-dev-to-devops/)
  ...
  - VPE: [One codebase with /ee subdirectory](https://example_company.com/example_company-org/example_company-ee/issues/2952) => 40% done
- CEO: Make it popular
  - CMO
  ...
  - VPE: Use all of Example Company ourselves (monitoring, release management) => Did not make progress here due to focus on GCP migration
    - Director of Backend
      - Ensure SP1/SP2 issues for top tier customer get fixed
    - UX
      - UX: [Reduce the installation time of DevOps for Kubernetes by 50%](https://example_company.com/groups/example_company-org/-/epics/33) => 33%
      - UX: [Establish Operation Engineers as a first class citizen. Create a roadmap for Operations to use example_company as part of their core stack on a day to day basis.](https://example_company.com/groups/example_company-org/-/epics/47) => 100%
      - UX: [Complete design pattern library, setting usability standards and solutions for design, development, and product management to implement and follow.](https://example_company.com/groups/example_company-org/-/epics/29) => 64%
    - Geo
      - Geo: Make [Geo Disaster Recovery](https://example_company.com/example_company-org/example_company-ee/issues/846) Generally Available
        - 100% (Done in 10.5)
      - Geo: Squash 15+ bugs/month
        - [27 open bugs](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Geo&label_name[]=type::bug)
        - 10.4: [7 closed bugs](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Geo&label_name[]=type::bug&milestone_title=10.4)
        - 10.5: [14 closed bugs](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Geo&label_name[]=type::bug&milestone_title=10.5)
        - 10.6: [16 closed bugs](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Geo&label_name[]=type::bug&milestone_title=10.6)
        - 10.7: [8 closed bugs](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Geo&label_name[]=type::bug&milestone_title=10.7)
      - Geo: Bring `ee/app/workers` and `ee/db/migrate` directories up to 95% coverage
        - Geo-related files [show 95% coverage](http://example_company-org.example_company.io/example_company-ee/coverage-ruby/#_AllFiles)
    ...
    - Distribution
      - Distribution: Upgrade omnibus and internal omnibus-example_company Chef => 100% ([Epic](https://example_company.com/groups/example_company-org/-/epics/35))
      - Distribution: Measure upgrade/installation time between two Example Company versions => 100% ([Epic](https://example_company.com/groups/example_company-org/-/epics/36))
      - Distribution: Establish a roadmap for automated vulnerability reporting of shipped libraries => 100% ([Epic](https://example_company.com/groups/example_company-org/-/epics/37))
      - Distribution: Cloud Native Helm charts in Alpha => 100% ([Issue](https://example_company.com/charts/example_company/issues/187))
      - Distribution: Support for generating LE certificates from the omnibus-example_company package => 100% ([Issue](https://example_company.com/example_company-org/omnibus-example_company/issues/2620))
      - Distribution: Ship 100% of committed deliverables issues each release
        - 10.5: 87.5% (One undelivered issue was
        caused by [the change in direction](https://example_company.com/example_company-org/omnibus-example_company/issues/3002#note_57574482))
        - 10.6: 70% (Did not ship LE on by default, did not make significant progress on the backup/restore task fix)
        - 10.7: 87.5% ([Did not make a significant progress on password/configuration separation](https://example_company.com/example_company-org/omnibus-example_company/issues/2183)) - NOTE: This can go down to 75% if we do not ship LE autorenew.
    - Platform
      - Platform: Ship 100% of committed [deliverable issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Platform&label_name[]=backend&label_name[]=Deliverable) each release
        - 10.5: [75% (24/32)](https://example_company.com/example_company-com/www-example_company-com/merge_requests/9935)
        - 10.6 [68% (21/31](https://example_company.com/example_company-com/www-example_company-com/merge_requests/10460)
        - 10.7 69% (25/36
        - Overall: 71% (70/99)
      - Platform: Resolve all [Security SL1](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Platform&label_name[]=backend&label_name[]=SL1), [Support SP1](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Platform&label_name[]=backend&label_name[]=SP1), and [Availability AP1](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Platform&label_name[]=backend&label_name[]=AP1) issues
        - SL1: 100% (3/3)
        - SP1: 71% (5/7)
        - AP1: 75% (3/4)
        - Overall: 79% (11/14)
      - Platform: Close 45 [Platform backend bug](https://example_company.com/groups/example_company-org/-/issues?label_name%5B%5D=Platform&label_name%5B%5D=backend&label_name[]=type::bug&scope=all&sort=updated_desc&state=opened) issues. Afterwards, we should verify that the backlog went *down* from the 400 we started with, because otherwise bugs are getting reported faster than we can fix them, and we are not making a dent.
        - 10.5: [14 bugs closed](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Platform&label_name[]=backend&label_name[]=type::bug&milestone_title=10.5)
        - 10.6: [11 bugs closed](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Platform&label_name[]=backend&label_name[]=type::bug&milestone_title=10.6)
        - 10.7: [5 bugs closed](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Platform&label_name[]=backend&label_name[]=type::bug&milestone_title=10.7)
        - Overall: 67% (30/45)
        - Ending backlog: 417
      - Platform: Add [backup/restore integration tests](https://example_company.com/example_company-org/example_company-qa/issues/22) to Example Company QA
        - 10% (a start was made, but no significant progress)
      - Platform: Make sure all [Platform backend community contributions](https://example_company.com/groups/example_company-org/-/merge_requests?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Community%20Contribution&label_name[]=Platform) created before January 1st, 2018 are merged, closed, labeled "awaiting feedback", or taken over by us and in active development
        - 77% (36/47)
    - Discussion
      - Discussion: Ship 100% of committed
        [deliverable issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Discussion&label_name[]=backend&label_name[]=Deliverable) each release.
        - 81%.
        - [10.5: 70% (7/10)](https://example_company.com/example_company-com/www-example_company-com/merge_requests/9934).
        - [10.6: 77% (7/9)](https://example_company.com/example_company-com/www-example_company-com/merge_requests/10446).
        - 10.7: 100% (8/8).
        - Try: break large performance Deliverables into smaller issues.
      - Discussion: Make it possible to run Example Company as a Rails 5 app from the
        master branch.
        - 10% (from community contributions).
      - Discussion: Resolve all [Security SL1](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Discussion&label_name[]=backend&label_name[]=SL1),
        [Support SP1](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Discussion&label_name[]=backend&label_name[]=SP1), and [Availability AP1](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Discussion&label_name[]=backend&label_name[]=AP1)
        issues.
        - 100%.
      - Discussion: Close 36 [Discussion backend bug](https://example_company.com/groups/example_company-org/-/issues?label_name%5B%5D=Discussion&label_name%5B%5D=backend&label_name[]=type::bug&scope=all&sort=updated_desc&state=opened)
        ...
        making a dent.
        - 100%.
        - 10.5: [18 bugs closed](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Discussion&label_name[]=backend&label_name[]=type::bug&milestone_title=10.5).
        - 10.6: [15 bugs closed](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Discussion&label_name[]=backend&label_name[]=type::bug&milestone_title=10.6).
        - 10.7: [8 bugs closed](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Discussion&label_name[]=backend&label_name[]=type::bug&milestone_title=10.7).
        - Ending backlog: 269.
      - Discussion: Make sure all of the 17
        [Discussion backend community contributions](https://example_company.com/groups/example_company-org/-/merge_requests?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Community%20Contribution&label_name[]=Discussion)
    ...
    - CI/CD
      - CI/CD: Ship 100% of committed deliverables issues each release:
        - 10.5: [(25 / 40): 63%](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=CI%2FCD&label_name[]=Deliverable&milestone_title=10.5)
        - 10.6: [(21 / 33): 63%](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=CI%2FCD&label_name[]=Deliverable&milestone_title=10.6)
        - 10.7: [(29 / 38): 76%](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=CI%2FCD&label_name[]=Deliverable&milestone_title=10.7)
      - CI/CD: Scalability: Make all CI/CD related data to be stored on Object Storage
        - 10.5: [Traces on Object Storage](https://example_company.com/example_company-org/example_company-ee/issues/4171)
        - 10.6: [Rake task for migrating traces](https://example_company.com/example_company-org/example_company-ee/issues/4170)
        - 10.6: [Workhorse direct uploader for artifacts](https://example_company.com/example_company-org/example_company-workhorse/merge_requests/238)
        - 10.6: [LFS direct upload](https://example_company.com/example_company-org/example_company-ee/merge_requests/4794)
        - 10.7: [Archive traces on Object Storage by default](https://example_company.com/example_company-org/example_company-ee/issues/5540)
        - 10.7: [Workhorse direct upload to Object Storage (GKE-only)](https://example_company.com/example_company-org/example_company-ee/issues/4183)
      ...
      - CI/CD: Quality: Test CI workflow with Runner by Example Company QA
        - 10.5: [End-to-end testing with Example Company QA](https://example_company.com/example_company-org/example_company-ce/merge_requests/16619)
    - Monitoring
      - Monitoring: Bundle Alertmanager for proactive customer alerting notifications => 75%
        - 10.6 [In Review](https://example_company.com/example_company-org/omnibus-example_company/merge_requests/2205)
        - 10.7 [TODO](https://example_company.com/example_company-org/example_company-ee/issues/5158)
      - Monitoring: Prometheus deploy for customer apps feature => 100%
        - 10.5 [Done](https://example_company.com/example_company-org/example_company-ce/issues/41053)
      - Monitoring: Ship 10 new alerts for monitoring Example Company => 0%, dropped due to scheduling of GCP required features.
      - Monitoring: Instrument example_company-shell => 50%, Instrumentation in production complete, but not packaged with Omnibus yet.
        - OmniBus: [TODO](https://example_company.com/example_company-org/omnibus-example_company/issues/3117)
    ...
    - Security
      - Security: GDPR: Complete data [breach notification policy](https://example_company.com/example_company-com/security/issues/12) and [data mapping](https://example_company.com/example_company-com/security/issues/15) requirements (Compliance-KW) => 100%
      - Security: FIPS 140-2: Research requirements and [provide guidance](https://example_company.com/example_company-org/example_company-ce/issues/41463) to development team to implement (Compliance-KW) => 60%
      ...
      - Security: Conduct 2 [product application](https://example_company.com/example_company-com/security/issues/20) [security reviews](https://example_company.com/example_company-com/security/issues/21) (AppSec-JR) => 100%
      - Security: Manage [Advance Notification Program](https://example_company.com/example_company-com/marketing/general/issues/1996) for security releases (SecOps-KW/JT/JR) => 100%
      - Security: All parts of security active (AppSec-JR, Automation-JT, SecOps-KW/JT/JR, Abuse-KW/JT/JR, Compliance-KW) => 100%
    - Database
      - Database: [Make it more difficult for database performance issues to occur](https://example_company.com/example_company-com/infrastructure/issues/3474) => Done
      - Database: [Improve workflow / structure of the database team](https://example_company.com/example_company-com/infrastructure/issues/3475) => 60%
      - Database: [Improve database performance](https://example_company.com/example_company-com/infrastructure/issues/3476) => 65%
    - Gitaly
      - Gitaly: Deliver 100% of committed scope for GCP migration milestone [#2](https://example_company.com/example_company-com/migration/milestones/2) by Jan 15 => Done
    ...
    - Quality
      - Quality: Complete the work to [make Example Company QA production-ready](https://example_company.com/example_company-org/example_company-qa/issues/126) => 100%
      - Quality: [Define the architecture of and produce an end-to-end prototype for a self-service metrics generator](https://example_company.com/example_company-org/example_company-insights/issues/2) => 5%, discussion is just starting off with a prototype still in the works.
      - Quality: Define and schedule high-value issues for [improving the staging test environment](https://example_company.com/example_company-com/infrastructure/issues/3177) => 10%, meaningful discussions => closer to defining then schedule will follow suit.
      - Quality: [Write 2 Example Company QA tests related to creating and managing Issues](https://example_company.com/groups/example_company-org/-/epics/44) => 50%, creation scenario done still needs edit.
      - Quality: [Write 2 Example Company QA tests related to CI/CD](https://example_company.com/groups/example_company-org/-/epics/45) => 100%
    - Edge
      - Edge: [Work with backend teams to move 100% of EE-specific **files** and 50% of EE-specific **lines of code** to the top-level `/ee` directory](https://example_company.com/groups/example_company-org/-/epics/27) => 70%, For EE files, we started at 1085 files to move, we still have 132 files to move (excluding doc and qa), or 476 (only excluding qa) LoCs has proven to be more challenging than files.
      - Edge: [Investigate how to extract EE-specific files/lines of code for JavaScript, CSS, and Grape API](https://example_company.com/example_company-org/example_company-ee/issues/4643) => 33%, made progress on JS, CSS and Grape API, no updates on routes and initializers.
      - Edge: [Reduce average CE pipeline duration to 30 minutes](https://example_company.com/example_company-org/example_company-ce/issues/41726) => 70%, We made great progress at the beginning of the year, pipelines were running at or below 30 minutes but then it started rising up again. It's now around 40 minutes, we suspect auto-retry of failed job could be a plausible cause. Rake task cleanup and rubocop cache done.
      - Edge: Solve at least 1 [outstanding performance issues](https://example_company.com/example_company-org/example_company-ce/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=performance&milestone_title=No+Milestone) => 100%
    - Frontend
      ...
      - Frontend: Make sure all [Frontend community contributions](https://example_company.com/groups/example_company-org/-/merge_requests?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Community%20Contribution&label_name[]=frontend) are merged, closed, labeled "awaiting feedback", or taken over by us an in active development - Not complete
  ...
  - CMO: Generate more company and product awareness including increasing lead over [Bitbucket in Google Trends](https://trends.google.com/trends/explore?q=bitbucket,example_company).
    - MSD: Implement SEO/PPC program to drive increase in number of free trials by 20% compared to last quarter, increase number of contact sales requests by 22% compared to last quarter, increase amount of traffic to about.example_company.com by 9% compared to last quarter.
...
- Handbook first (no presentations about evergreen content)
  ...
  - VPE: Record an on-boarding video of how to do a local build and contribute to the Example Company handbook => 0%, didn't get to it
    ...
    - UX
      - UX: [Deprecate outdated UX Guide and replace with design.example_company.com to communicate current UX standards and solutions across teams.](https://example_company.com/groups/example_company-org/-/epics/30) => 63%
      - UX: [Write 3 public blog posts about Example Company UX and visual design case studies, best practices, anecdotes, or events](https://example_company.com/groups/example_company-org/-/epics/33) => 100%
  ...
  - CCO: Launch training for making employment decisions based on the Example Company Values.
  ...
  - CCO: Analyze and make recommendations based off of New Hire Survey and Pulse surveys which will drive future KRs. Have at least 3 areas to improve each quarter. Ideally, we will also have 3 areas to celebrate.
    - [Issue](https://example_company.com/example_company-com/people-ops/Training/issues/8)
    - [Issue](https://example_company.com/example_company-com/people-ops/Training/issues/7)
  ...
  - CCO: Align recruiting to Functional Groups with Focus on Low Rent Regions. At least 50% of Example Company team-members should be hired from a Rent Index location that less than 0.7.
  ...
  - CCO: Identify the right LMS for Example Company.
...
- GOOD
  ...
  - Q1 Example Company.com availability/stability was good (although not as good as monitoring indicates)
- BAD
  - OKRs we tweaked mid-quarter and Sid and I never syncd on the changes, so some things never got attention
  - Example Company.com did not move to GCP
...
- GOOD
  ...
  - Successfully drove Example Company's new pages domain verification mechanism.
...
- TRY
  ...
  - Better monitoring of Example Company.com for SLA
...
- GOOD
  - Example Company.com availability in Q1 was better than 2017 average
- BAD
  - Team attrition
  - Did not move to GCP
  - Did not hire a production engineer
- TRY
  - Better Example Company.com monitoring for uptime
...
- GOOD
  - We migrated most projects, attachments, LFS objects, etc. from Example Company.com to Google using Geo.
  ...
  - Geo appears to be keeping up with the new data pushed to Example Company.com.
  - Customers appear to be using Geo more, helping us find additional issues.
- BAD
  - We have yet to do a thorough project-by-project verification of data mirrored from Example Company.com.
...
- BAD
  - Each change in the jobs definition means updating docs everywhere, our `.example_company-ci.yml`, and possibly introducing break changes. This process is long and error prone.
  ...
  - We hit the limitations of our own features (using subgroups, .example_company-ci.yml include, unprotected container registry, etc.).
...
- TRY
  ...
  - Improve accessibility to our tools (includes in example_company-ci.yml)
