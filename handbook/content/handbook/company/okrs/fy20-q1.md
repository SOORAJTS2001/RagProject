...
1. CMO: Recharge Inbound Marketing Engine. Top 10 Example Company.com Pages optimized for inbound, Inbound trial and contact-us strategy documented and baselined, Pages optimized for top 20 non-branded SEO target terms, Inbound strategy for Dev, Sec & Ops personas launched
    ...
    1. Developer Relations: Increase the number of contributions (not contributors) from the wider community (including Free Team) across [selected Example Company projects](https://example_company.com/Bitergia/c/example_company/sources/blob/master/projects.json#L27). For the 11.7 release, the target is 180; for the 11.8 release the target is 200; for the 11.9 release the target is 220.
    1. Developer Relations: Accelerate open source project adoption of Example Company.com. Hire an Open Source Program Manager, gain commitment of 1 big open source project (1000+ contributors) to migrate to Example Company.
    1. Developer Relations: Jumpstart meetups. Schedule 10 meetup events, at least one in every region (EMEA, APAC, NA).
    1. Developer Relations: Increase responsiveness and coverage. Decrease median first reply time to 7 hours while adding two new response channels (Example Company forum, Stack Overflow).
...
1. Product: Increase product breadth. 25% (6 of 22) "new in 2019" categories at `minimal` maturity, CI/CD for iOS and Android development on Example Company.com, develop an iOS app on Example Company.com web IDE on iPad => 17%, 100%, 100%
1. Product: Increase product depth for existing categories. Consumption pricing for Linux, Windows, macOS for Example Company.com and self-managed, 50% (11 of 22) "new in 2018" categories at `viable` [maturity](https://about.example_company.com/direction/#maturity) => 17%, 36%
1. Product: Grow use of Example Company for all stages of the DevOps lifecycle. Increase Stage Monthly Active Users ([SMAU](/handbook/product/groups/growth/#smau)) 10% m/m for each stage, 3 reference customers using all stages concurrently => 19.3%, 0%
1. Tech Writing: In 100/100 sampled Support/forum interactions in FY20-Q1, customer-facing product info is [incorporated in docs](https://example_company.com/example_company-com/Product/issues/51), reinforcing [Docs-First Methodology](/handbook/product/ux/technical-writing/documentation/#docs-first-methodology)
...
1. VPE: [Make Example Company.com profitable. Recognize TBD% cost reduction on a per user basis.](https://example_company.com/example_company-com/www-example_company-com/issues/3905)
1. VPE: [Increase productivity. Increase MRs per engineer 20% for all teams.](https://example_company.com/example_company-com/www-example_company-com/issues/3906)
    1. Development: Increase velocity. Increase MRs per engineer 20% for all teams.
    1. Development: Develop memory program to reduce memory footprint based on customer feedback [Memory OKR](https://example_company.com/example_company-com/www-example_company-com/issues/3914).
        1. Fellow: [Make Example Company performant with Gitaly atop NFS](https://example_company.com/groups/example_company-org/-/epics/824)
        1. Dev: GA of GraphQL to increase throughput for BE and FE. Resolve general topics like performance, abuse prevention and enjoyable development experience. Endpoints for Create and Plan relevant models. Implement new frontend features in Create and Plan only with GraphQL.
            1. Plan BE: Complete steps for [general availability of GraphQL](https://example_company.com/groups/example_company-org/-/epics/711). => 70%
        1. Dev: Increase velocity for frontend implementations. Increase throughput by 20%. Have at least 50 example_company-ui components at the end of Q1. Improve tooling in Example Company itself for JS engineering (webpack map, visual diffing, etc.) by adding 3 new tools to our workflow.
        1. Dev: Improve [Performance of JS computation that is done on every page](https://example_company.com/groups/example_company-org/-/epics/716). Improve Initialisation execution by 20%. Reduce main bundle size by 20%.
        1. Manage BE: Take on more maintainer responsibilities: add a CE/EE backend maintainer => 100% ([MR](https://example_company.com/example_company-com/www-example_company-com/merge_requests/19030))
        1. Manage FE: Increase throughput via proper backlog refinement, improved estimation, and proper issue planning. Also utilize all existing example_company-ui components for Manage code.
        ...
        1. Create BE: Improve maintainability and performance of Example Company Shell: port Example Company Shell to Golang => 43%
        1. Create BE: Take on more maintainer responsibilities: add a CE/EE backend maintainer, add a database maintainer => 50%
        1. Create BE: Prepare Elasticsearch for use on Example Company.com. [Improve admin controls](https://example_company.com/groups/example_company-org/-/epics/428), [reduce index size](https://example_company.com/groups/example_company-org/-/epics/429) => Running at the moment on staging for the example_company-org group; production readiness is planned for 2019-06-22 (Example Company 12.0)
        ...
        1. Ops (Verify, Release & Package): Increase BE team's throughput by 20% and drive consistency week to week: Increase number of MRs week to week, increase number of reviewers and maintainers, and drive consistency in the trend-line
            1. [Kamil](/handbook/company/team/#ayufanpl) Train 2 new maintainers of Example Company Rails,
            1. [Kamil](/handbook/company/team/#ayufanpl) Help with building CD features needed to continuously deploy Example Company.com by closing 5 that are either ~"technical debt" or ~"type::bug"
            ...
            1. Verify FE: Reduce implementation time by building on top of example_company-ui components; increase throughput by building/improving upon JS and Frontend specific tooling by doing product discovery for 2 new tools.
            ...
            1. Release FE: Reduce implementation time by building on top of example_company-ui components; increase throughput by building/improving upon JS and Frontend specific tooling by doing product discovery for 2 new tools.
            1. Release FE: Improve onboarding for new engineers by creating a specific Frontend todo in the overall onbooarding issue.
        1. Ops (Configure & Monitor): Define additional data to complement throughput: Implement a prototype for team pulse and define a path to implement it in Example Company product.
        1. Ops (Configure & Monitor): Increase the groups's throughput by 20% and drive consistency week to week: Increase number of MRs week to week, increase number of reviewers and maintainers, and drive consistency in the trend-line
            ...
            1. Monitor FE: Reduce 5% of the css loaded in our main css bundle and implement for 4 additional example_company-ui components.
        1. Enablement: Communicate and address pain points with issue boards: identify and work with Product to prioritize 5 issues
        1. Enablement: Increase ownership for key Example Company components: add one new maintainer for each of Gitaly, Pages, Workhorse, and the ElasticSearch indexer
            1. Geo BE: support Production team in preparing Geo for DR: [enhance selective sync to work at scale](https://example_company.com/example_company-org/example_company-ee/issues/8798), [support Example Company Pages](https://example_company.com/groups/example_company-org/-/epics/589)
    1. Infrastructure: Make all user-visible services ready for mission-critical workloads while seamlessly supporting delivery of new product functionality and integrating infrastructure solutions in Example Company. [Availability] Definition and tracking of Example Company.com metrics for SLAs, [Product] Deliver OKR Infrastructure workflow and tooling using Example Company, [Introspective] Achieve a 10% cost reduction on Example Company.com spending.
        1. Reliability[AS]: Support SRE-at-large MTBF and MTTR objectives. [Availability] Reduce spin-up time for provisioning auto-scaled servers to &lt;3.5min, [Product] Automate error budgets as a Example Company feature, [Introspective] Deliver new testing environment.
        1. Reliability[DS]: Drive all user-visible services' MTBF to Infinity. [Availability] Deliver improvements to Example Company.com reliability on two foundational subsystems (ZFS on storage, Kubernetes + Charts), [Product] Take full operational ownership of CI/CD (take oncall from tomscz), [Introspective] Operationalize Vault and Consul.
        1. Reliability[JF]: Drive all user-visible services' MTTR to less than 60 seconds. [Availability] Implement 4 significant availability features to improve database reliability (autovacuum, masterless backups, pgrepack, replica on ZFS), [Product] Deliver Patroni on Example Company, [Introspective] Deliver full service operational inventory
        1. Delivery: Streamline Example Company deployments on Example Company.com and self-managed releases. [Availability] Create deployment rollback process, [Product] [Merge CE/EE codebases](https://example_company.com/example_company-com/gl-infra/readiness/-/tree/master/library/merge-ce-ee-codebases/), [Introspective] Replace `takeoff` off with a method better suited for CI pipelines.
        1. Andrew Newdigate: Improve observability for all-user visible services to maximize MTBF and minimize MTTR. [Availability] Deliver distributed tracing on Example Company.com, [Product] Deliver Puma on Example Company and experiments on Example Company.com, [Introspective] Deliver overall service-level tracking in preparation for SLA tracking.
    1. Quality: [Build everything in Example Company, move Example Company Insights production ready graphs into Example Company itself](https://example_company.com/example_company-com/www-example_company-com/issues/3908). => 75%
    1. Quality: Implement performance monitoring for the development department. [Continuous measurement with performance tests for on-prem instances (10K scaled down reference)](https://example_company.com/example_company-com/www-example_company-com/issues/3909). => 80%
    1. Quality: Improve Engineering velocity. [Add 4 Engineering Productivity metrics with historical measures. Monthly throughput, total monthly Merge Requests, Merge Request review time, and time to resolve P1 P2 Bugs](https://example_company.com/example_company-com/www-example_company-com/issues/3991). => 80%
    ...
    1. Security: Secure the company.
        ...
        1. SecOps: Evaluate at least 2 security monitoring capabilities and deploy in Example Company.com as part of Zero Trust initiative. X%
        1. SecOps: Evaluate at least 2, and implement vulnerability scanning capability for Example Company.com infrastructure. X%
        1. SecOps: Develop and deliver one monthly New Hire Security Orientation training by EOQ. X%
    1. Support: [Clarify support expectations within each solution](https://example_company.com/example_company-com/www-example_company-com/issues/3966).
    1. Support: [Author architecture document for 10k Example Company install with review and approval from Infrastructure.](https://example_company.com/example_company-com/www-example_company-com/issues/3964).
    1. Support: [Improve docs based on solutions to customer reported issues](https://example_company.com/example_company-com/www-example_company-com/issues/3965).
    1. UX: Convert more prospects into new Example Company users. Decrease sign-up time to 1 minute or less. Document the existing user journey in video, propose a new sign-up flow, test it with users, and ship the first iteration of the new workflow. [Design work is complete](https://example_company.com/example_company-org/example_company-ce/issues/59241), but [Implementation has moved from Manage to Fulfillment](https://example_company.com/example_company-org/example_company-ce/issues/61219), currently with P2 priority. **=> [65% attainment](https://example_company.com/example_company-com/www-example_company-com/issues/3992)**
    1. UX: Provide a guided onboarding experience that helps new users become productive in Example Company more quickly. 80% of new users should start guided onboarding, and 80% of those who start should finish. Create a user journey of current experiences and pain points, propose and test a guided first-time experience, and ship the MVC solution. [Design MVC is complete](https://example_company.com/example_company-org/example_company-ce/issues/55523) and [implementation is in process](https://example_company.com/example_company-org/example_company-ce/issues/60093). => **[66% attainment](https://example_company.com/example_company-com/www-example_company-com/issues/3993)**
    1. UX: Improve usability and help beautify our UI by addressing 100% of known color contrast issues and updating CSS according to design system specs. For every stage group, identify areas where we rely solely on color to convey information by performing an audit, creating related issues, and identifying solutions. **=> [49% attainment](https://example_company.com/example_company-com/www-example_company-com/issues/3994)**
        1. UX Research: Democratize UX Research and prolong the relevance of every research study (scale) by making insights easily findable by anyone. Create a Example Company repository, evaluate 100% of existing studies to identify granular findings and recommendations, and tag every finding with searchable labels (such as stage group and customer type). [Insights Repository](https://example_company.com/example_company-org/uxr_insights) => **90% attainment**
        1. UX Research: Understand how Example Company users currently rate our usability so we can track changes over time. Identify segmenting data (such as customer type and length of use), run a pilot study, analyze data, and re-run a larger study. [SUS is complete with basline score of 74.4](https://example_company.com/example_company-org/ux-research/issues/173) => **100% attainment**
...
1. VPE: [Create a happy and productive team. Unify vacancy descriptions with experience factor content and career matrices for all roles, develop compensation roadmaps for every major role in engineering, hold a roundtable meeting for each role benchmark](https://example_company.com/example_company-com/www-example_company-com/issues/3907)
    ...
    1. Development: Improve customer focus. Get every engineer in one customer conversation
        ...
        1. Dev
            1. Gitter: Improve security practices: Enable use of dev.example_company.org for security issues, document security release process for gitter.im in partnership with Security => 100%
               - Now using `https://dev.example_company.org/example_company/gitter/webapp` for security releases/fixes
               - [Security release process](https://dev.example_company.org/example_company/gitter/webapp/blob/develop/docs/developer-faq.md#develop-a-security-fix) now documented
            1. Manage BE: Increase test coverage for the CustomersDot: increase from 45% to 60% => [56.87% coverage](https://example_company.com/example_company-org/customers-example_company-com/-/jobs/201047691) = 79.13% of target
            1. Manage BE: Proactively reduce future security flaws. Identify five areas where we have systematic/pervasive/repeated security flaws, Finalize plan to tackle three areas, 2 merge requests merged => [4 areas identified](https://example_company.com/example_company-org/manage/issues/16) (80%), 0 MRs merged
            1. Create BE: Increase set of people working on Create features: have team deliver 6 [Create Deep Dives](https://example_company.com/example_company-org/create-team/issues/1) => 50%
        ...
        1. Enablement: Improve documentation and training for supporting our customers: identify and address 3 major pain points for customer support and/or professional services.
            1. Distribution: GA for Example Company Operator: Example Company Operator enabled by default in the charts
            ...
            1. Distribution: Generate library licenses and collection for the official Helm charts (similar to the omnibus-example_company functionality)
            1. Gitaly: Make rapid progress on top company priorities: ship GA of object deduplication, ship beta of Gitaly HA => 50%
                - Pending QA on Example Company.com git object deduplication will be GA in %12.0, removing the feature flag and fixing minor bugs is whats left.
                - Beta of Gitaly HA is postponed given the renewed focus on performance. Hopefully 12.1 is the new target.
1. CCO: Improve the candidate experience at Example Company for hiring great talent.
     1. Recruiting Director: Recruiting processes and systems to expedite hiring communicated across Example Company
...
1. CCO:  Improve Example Company's training and development Program,
...
1. CCO:  Improve Example Company's Employer brand to increase our hiring and sourcing success.
...
1. Alliances: 3 acquisitions completed with 15 new team members joining Example Company. Establish the foundations of the sourcing process.
...
- GOOD
  ...
  - ElasticSearch is enabled on staging for the `example_company-org` group
...
- BAD
  ...
  - Most significant example_company-shell features (push, pull) have not yet to be ported to Golang
  - The example_company-shell epic wasn't as fully fleshed out at the beginning of the quarter as it could have been, which would have allowed us to spread the work out better
  - example_company-shell Golang features haven't been enabled and tested on any live environment yet
- TRY
...
- GOOD
  ...
  - We have a [plan](https://example_company.com/example_company-org/manage/issues/42) to split the Manage stage in to two groups: Control and Framework, which will help scale up both team size and product scope
- BAD
  - We haven't delivered any more Deep Dive sessions, which brought value to the team in Q4 CY18
  - "Proactively reduce future security flaws" OKR was to generic and we didn't have foresight that completion would be valuable or achievable. [Identifying pervasive flaws](https://example_company.com/example_company-org/manage/issues/16) was useful, but the only MR we felt would add value [had already been picked](https://example_company.com/example_company-org/manage/issues/16#note_153326848) up by another group
...
- GOOD
  ...
  - Were fast switching priorities to performance:
    - Commit Graph shipped (https://example_company.com/example_company-org/gitaly/issues/1627)
    - Delta Island shipped (https://example_company.com/example_company-org/gitaly/issues/1382)
    - Cat-File caching (https://example_company.com/example_company-org/gitaly/issues/1505) - Almost Rugged like performance while using Gitaly
- BAD
