        ...
        1. **VP, Field Ops: Instrument systems and programs to intended targets.**
            ...
            1. VP Field Ops KR: Target 90%+ completion of certification programs.
                1. **Director of Sales Enablement: Develop certification ROE and processes.**
                    ...
                    1. Director of Sales Enablement KR: Defined certification strategy heading into FY21 => Meeting with CRO on Jan 27 to review [proposed sales certification strategy for FY21+](https://example_company.com/example_company-com/sales-team/field-operations/enablement/issues/140)
                1. **Director of Sales Enablement: Improve operational excellence around Command of the Message and strategic opportunity management with MEDDPICC.**
                    1. Director of Sales Enablement KR: Successfully execute strategic opportunity consult engagement with Force Management => 7 of 8 [opportunity consults](https://example_company.com/example_company-com/www-example_company-com/issues/5743) (8th decided to push to Q1)
                    1. Director of Sales Enablement KR: Effectively deliver 2-day CoM & MEDDPICC workshop to sales team members who did not participate in the Aug training => Done. Delivered [2-day CoM & MEDDPICC workshop on Jan 16-17](https://example_company.com/example_company-com/sales-team/field-operations/enablement/issues/135) to ~80 sales team members who did not participate in the Aug training
                ...
                1. **Director of Sales Enablement: Reduce rep ramp time and optimize onboarding.**
                    1. Director of Sales Enablement KR: Identify key measurements and reporting cadence => In progress. Key measurements and reporting cadence identified but not delivered by Data Analytics team due to competing priorities ([issue](https://example_company.com/example_company-data/analytics/issues/2120) has now been open for 5 months).
                ...
                1. **Director of Sales Enablement: Ensure FY20 Sales Kick Off effectively supports to FY21 sales strategy.**
                    1. Director of Sales Enablement KR: Effective, collaborative SKO planning and communication leading up to the early Feb 2020 event => [In progress](https://example_company.com/groups/example_company-com/-/epics/126). On track to deliver against these results in early Q1.
                    1. Director of Sales Enablement KR: Development of interactive, role-based training sessions to support FY21 pipeline development and acceleration => [In progress](https://example_company.com/example_company-com/marketing/sales-kick-off/fy21/issues/19). On track to deliver against these results in early Q1.
        1. **VP Alliances: Broaden addressable user base through user personas (OPS and Security).**
            1. VP Alliances KR: AWS Re:invent Example Company visibility (5 sessions). => 80% (4 AWS sessions and 6 with other partners)
            1. VP Alliances KR: Kubecon 14 Top Kubernetes partners with Example Company demos for 400 customers each. => 100%
            1. VP Alliances KR: Launch partner marketing campaign. => 20%
        1. **VP Alliances: Deliver Example Company as part of our partner's sales processes.**
            ...
            1. VP Alliances KR: Deliver first Example Company session at Dreamforce. => done
        1. **VP Alliances: Build tighter partner integrations with Example Company for Kubernetes, Marketplace and Authentication.**
...
1. **CRO: Ensure public company readiness.**
        ...
        1. **VP Field Ops: Optimize Month End Close.**
            1. VP Field Ops KR: Target < 1 day EOM close.
                1. **Sr Director of Sales Operations: Optimize EOM close.**
                    ...
                    1. Sr Director of Sales Operations KR: Automation > 50% of EOM close processes. => Moved to weekly cadence. New [closing stage](https://example_company.com/example_company-com/sales-team/field-operations/sales-operations/issues/397) speeds up processing time. Monthly Closed now captured in [issue](https://example_company.com/example_company-com/sales-team/field-operations/sales-operations/issues/574) for transparent communication and an audit trail..
                ...
                1. **Sr Manager of Sales Systems: Timely and accurate iACV calculation.**
                    1. Sr Manager of Sales Systems KR: 95% of non-custom deals have correct iACV calc after deal configuration => [In Progress](https://example_company.com/groups/example_company-com/-/epics/147). Technical discovery lead to the [iACV Assessment](https://docs.google.com/presentation/d/1cADVcQRLdpaJYghMMJ_HQXI-QATLGi2uPPCKOLED8QM/edit)
    ...
    1. **Customer Success: Restructure handbook to align Example Company organization to the customer journey.** => 0% complete. Lacking resource to drive. Will carry-forward when we identify a resource to drive.
        ...
        1. **TAM: Improve engagement approaches for key processes (EBR, TAM account reviews, Example Company days).**
            1. TAM KR: Processes for each 3. => [Complete](https://example_company.com/example_company-com/customer-success/okrs/issues/21)
            1. TAM KR: 2 Templates (EBR and reviews). => [Complete](https://example_company.com/example_company-com/customer-success/okrs/issues/21)
            1. TAM KR: Enablement for 90% of CSMs. => [Complete](https://example_company.com/example_company-com/customer-success/okrs/issues/21)
        ...
        1. **Comm SA: Define systematic Commercial presales technical buyers journey.**
            1. Comm SA KR: [Formalized tech eval process for 3 segments Tier 1 MM, MM, SMB](https://example_company.com/example_company-com/customer-success/okrs/issues/17) => First iteration completed via new [Handbook page](/handbook/customer-success/comm-sales/customer-buyer-journey.html)
            1. Comm SA KR: [Tech eval and handoff processes updated](https://example_company.com/example_company-com/customer-success/okrs/issues/17) => Next iteration completed via [this Merge Request](https://example_company.com/example_company-com/www-example_company-com/merge_requests/37506/diffs) and [this Handbook page](/handbook/customer-success/csm/account-handoff/)
        ...
        1. **PS Solutions: Develop plans for future operational and strategic service offerings.** => 75% complete
            1. PS Solutions KR: [Revenue model created with finance](https://example_company.com/example_company-com/customer-success/professional-services-group/product/solutions-management-issues/issues/13). => 75% complete.
            1. PS Solutions KR: Customer survey and feedback reports created for 100% of customers (Q3 and Q4) => 100% complete.
            1. PS Solutions KR: [New service offering plan created for 1 year outlook](https://example_company.com/example_company-com/customer-success/professional-services-group/product/solutions-management-issues/issues/9). 50% complete
        1. **PS Solutions: Develop services onboarding for 2 partners for training capacity.** => Partner program pushed to FY21.
            1. PS Solutions KR: [Training plan](https://example_company.com/example_company-com/customer-success/professional-services-group/product/solutions-management-issues/issues/7).
            1. PS Solutions KR: [Management plan](https://example_company.com/example_company-com/customer-success/professional-services-group/product/solutions-management-issues/issues/7).
            1. PS Solutions KR: [2 partners MSAs signed](https://example_company.com/example_company-com/customer-success/professional-services-group/product/solutions-management-issues/issues/8).
        1. **PS Solutions: Complete end-to-end process to streamline sales process.** => 65% complete
            1. PS Solutions KR: [End-to-end process streamlined](https://example_company.com/example_company-com/customer-success/professional-services-group/product/solutions-management-issues/issues/5). => 100%
            1. PS Solutions KR: [Control models updated](https://example_company.com/example_company-com/customer-success/professional-services-group/product/solutions-management-issues/issues/6). 50% complete
            1. PS Solutions KR: [100% of process steps and approvals documented](https://example_company.com/example_company-com/customer-success/professional-services-group/product/solutions-management-issues/issues/5). 100% complete
        ...
        1. **PS Education: Develop modular "Example Company Total Product Training."** => 100% complete
...
1. **VP of Engineering: [Enterprise-grade Example Company.com](https://example_company.com/example_company-com/www-example_company-com/issues/5566)**
    ...
    1. Sr Director of Development
        1. **Director of Engineering, Enablement: [Iteratively re-architect our queue implementation to create 10x headroom](https://example_company.com/example_company-com/www-example_company-com/issues/4951)**
        1. **Director of Engineering, Enablement: [Meet enterprise customer expectations around timely feature delivery](https://example_company.com/example_company-com/www-example_company-com/issues/5569)**
            ...
            1. Director of Engineering, Enablement KR: Track all [planning priority issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=planning%20priority) and make sure they are being completed on time.
        ...
        1. **Interim Director of Engineering, CI/CD: [Get CI queue times (p95) under 1 min](https://example_company.com/example_company-com/www-example_company-com/issues/5341)** => 100%
        1. **Interim Director of Engineering, CI/CD: [Meet enterprise customer expectations around timely feature delivery](https://example_company.com/example_company-com/www-example_company-com/issues/5605)**
            ...
            1. Interim Director of Engineering, CI/CD KR: Track all [planning priority issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=planning%20priority) and make sure they are being completed on time. => 66%
        ...
        1. **Director of Engineering, Dev: [Meet enterprise customer expectations around timely feature delivery](https://example_company.com/example_company-com/www-example_company-com/issues/5686)**
            1. Director of Engineering, Dev KR: Track all [planning priority issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=planning%20priority) and make sure they are being completed on time.
        1. **Interim Director of Engineering, Ops: [Meet enterprise customer expectations around timely feature delivery](https://example_company.com/example_company-com/www-example_company-com/issues/5612)** => 50% MR Rate improved but is still below department goals
            ...
            1. Interim Director of Engineering, Ops KR: Track all [planning priority issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=planning%20priority) and make sure they are being completed on time. => 100%
        ...
        1. **Director of Engineering, Defend: [Meet enterprise customer expectations around timely feature delivery](https://example_company.com/example_company-com/www-example_company-com/issues/5626)**
            1. Director of Engineering, Defend KR: 3 new Defend MVC features are released
            1. Director of Engineering, Defend KR: Track all [planning priority issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=planning%20priority) and make sure they are being completed on time.
        1. **Director of Engineering, Secure: [Meet enterprise customer expectations around timely feature delivery](https://example_company.com/example_company-com/www-example_company-com/issues/5611)**
            ...
            1. Director of Engineering, Secure KR: Track all [planning priority issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=planning%20priority) and make sure they are being completed on time. => N/A
        ...
        1. **Director of Engineering, Growth: [Meet enterprise customer expectations around timely feature delivery](https://example_company.com/example_company-com/www-example_company-com/issues/5687)**
            1. Director of Engineering, Growth KR: Track all [planning priority issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=planning%20priority) and make sure they are being completed on time.
            1. **[Growth stage: Perform weekly iterations](https://example_company.com/example_company-com/www-example_company-com/issues/5692)**
                1. Growth stage KR: Weekly iterations for growth
        1. *Fellow*: Identify and deliver 3 key improvements to [observability](https://example_company.com/example_company-org/example_company/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Observability) and [scalability](https://example_company.com/example_company-org/example_company/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Infrastructure%20Scalability) => 100%
    1. **Director of Infrastructure: [Drive Example Company.com Availability to 99.95%](https://example_company.com/example_company-com/www-example_company-com/issues/5623)**
    ...
    1. **Director of Quality: [Improve Example Company Enterprise features robustness by improving functional and performance test coverage](https://example_company.com/example_company-com/www-example_company-com/issues/5607)** => 94%
        1. Director of Quality KR: Finish all planned enterprise test gaps => 82%
        1. Director of Quality KR: Perform upgrade tests with no downtime and performance benchmark tests for all Example Company releases in FY20Q4 => 100%
        1. Director of Quality KR: [Certify 2K reference architecture](https://example_company.com/example_company-org/quality/performance/issues/58) => 100%
    1. **Interim Director of Security: [Improve Example Company Security resilience and availability by creating independent Example Company Security environments](https://example_company.com/example_company-com/www-example_company-com/issues/5660)**
        1. Interim Director of Security KR: Migrate all existing Example Company Security tooling and infrastructure to the new environments  and [document in envs list](/handbook/engineering/infrastructure/environments/)
        1. Interim Director of Security KR: Create `Sec-prod` and `Sec-pre-prod` environments.
        1. Interim Director of Security KR: Full adoption of a dedicated Example Company instance for tracking of security issues within the new environments.
    1. **Director of Support: [Create sustainable process to achieve 85% performance to Next Response Time SLA](https://example_company.com/example_company-com/www-example_company-com/issues/5589)**
...
1. **CMO: Cost-effective IACV pipeline growth**
    1. **Community: Showcase activity generated by Example Company Heroes.**
        1. Community KR: 10 Example Company use-case videos or blogs published.
        1. Community KR: 5 Example Company talks given by Heroes.
    1. **Corp Mkt: Increase in awareness around Example Company CI/CD in response to competitor GA announcement.**
    ...
    1. **Corp Mkt: Increase awareness of Example Company in public relations efforts.**
...
1. **CFO: Improve financial planning processes to support growth and increased transparency.**
    1. Finance: [Single source of truth for hiring process designed and implemented](https://example_company.com/example_company-com/finance/issues/629) => 50% [Talent Acquisition Working Group](/handbook/company/working-groups/recruiting-ssot/)
    1. Finance: [Complete financial model from top of funnel through closed won](https://example_company.com/example_company-com/finance/issues/1233) => 100%
    1. Finance: [Version control for financial model that allows for real time analysis without impacting production model](https://example_company.com/example_company-com/finance/issues/964) => 0% Moving to a financial planning tool
    1. Finance: [Automate 100% of Investor Metrics in Periscope](https://example_company.com/example_company-com/finance/issues/594) => 85%

<p class="h3">2. CEO: Popular next generation product</p>

1. **VP of Product Strategy: Get strategic thinking into the org.**
    1. VP of Product Strategy KR: Secure [section strategy review](https://example_company.com/example_company-com/Product/issues/381) => 200%.
    1. VP of Product Strategy KR: Produce [strategy visuals](https://example_company.com/example_company-com/Product/issues/512) => 0%.
1. **VP of Product Strategy: Get acquisitions into shape; build a well-oiled machine.**
    1. VP of Product Strategy KR: Build [soft-landing identification software](https://example_company.com/example_company-com/corporate-development/issues/1) => 10%
    1. VP of Product Strategy KR: Identify 1000 [acquisition targets](https://internal.example_company.com/handbook/company/performance-indicators/product/) => 1500%.
...
1. VP of Product Management: Deliver on product roadmap.  Achieve 100% of our [category maturity](https://about.example_company.com/direction/#maturity) plans.
...
1. Director of Product, Growth: Improve the quality of product usage data. Deliver accurate [SMAU](https://internal.example_company.com/handbook/company/performance-indicators/product/) dashboards for each stage, including both .com and self-managed customer usage data.
...
1. **VP of Engineering: [Raise productivity thru iteration without jeopardizing availability](https://example_company.com/example_company-com/www-example_company-com/issues/5564)**
    1. VP of Engineering KR: Raise MR Rate from 8 to 10
    1. **Sr Director of Development: [Deliver on our product vision by being more iterative](https://example_company.com/example_company-com/www-example_company-com/issues/5648)** => 100%
    ...
    1. **Director of Infrastructure: [Achieve daily deployment velocity](https://example_company.com/example_company-com/www-example_company-com/issues/5630).**
        1. Director of Infrastructure KR: Lower MTTP from days to single digit hours.
    1. **Director of Quality: [Increase Engineering efficiency and productivity by speeding up test and pipeline duration](https://example_company.com/example_company-com/www-example_company-com/issues/5608)** => 77%
        1. Director of Quality KR: Increase Example Company review app success rate from 29% to 70% => 100%
    ...
    1. **Interim Director of Security: [Improve the Example Company product by dogfooding Secure & Defend features department-wide](https://example_company.com/example_company-com/www-example_company-com/issues/5661)**
    ...
    1. **Director of UX: [Make the Example Company UI more beautiful by burning down remaining UI Beautification issues.](https://example_company.com/example_company-com/www-example_company-com/issues/5573)**
        1. Director of UX KR: Burn down remaining open issues in epic https://example_company.com/groups/example_company-org/-/epics/989
    1. **Director of UX: [Help make the Example Company product more loveable by sharing UX work broadly and frequently to reinforce our overall vision.](https://example_company.com/example_company-com/www-example_company-com/issues/5571)**
    ...
    1. **Fellow**: Finish documenting architecture and [identify 3 most significant areas for architecture improvement](https://example_company.com/example_company-org/example_company/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=wg-isolation) => 60%
1. **CMO: Building scalable future capabilities**
    ...
    1. **Community: Pilot Example Company "Hackathon-in-a-box."**
    ...
    1. **Strategic Mkt: Roll out Example Company ROI framework.**
    ...
    1. **Strategic Mkt: Pilot Learn@example_company web experience for finding & featuring how-to technical content.**
...
1. **VP of Engineering: [Provide mentorship/coaching at every level](https://example_company.com/example_company-com/www-example_company-com/issues/5565)**
    1. VP of Engineering KR: Scalable Mentorship/coaching program
    1. VP of Engineering KR: Launch internship program
    1. Sr Director of Development
        1. **Director of Engineering, Dev: [Improve the development productivity and experience](https://example_company.com/example_company-com/www-example_company-com/issues/5688)**
        ...
        1. **Director of Engineering, Defend: [Improve the development productivity and experience](https://example_company.com/example_company-com/www-example_company-com/issues/5624)**
        ...
        1. **Director of Engineering, Enablement: [Improve the development productivity and experience](https://example_company.com/example_company-com/www-example_company-com/issues/5569)**
            1. Director of Engineering, Enablement KR: Overall section monthly throughput (MRs/Engineer/Month) increases to 10 by the end of January, which projects to 250 ~ 290 MRs/Month depending on the hiring progress.
            1. Director of Engineering, Enablement KR: Track all [planning priority issues](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=planning%20priority) and make sure they are being completed on time.
            1. Director of Engineering, Enablement KR: Maintain current developers to maintainers ratio - Add 1 BE maintainer (Backend from 8 to 9)
        1. **Director of Engineering, Growth: [Improve the development productivity and experience](https://example_company.com/example_company-com/www-example_company-com/issues/5689)**
    ...
    1. **Director of Infrastructure: [Hire key Infrastructure Management vacancies](https://example_company.com/example_company-com/www-example_company-com/issues/5631)**
    ...
    1. **Director of Quality: [Scale Quality Engineering to all product stages by growing to plan](https://example_company.com/example_company-com/www-example_company-com/issues/5609)** => 67%
    ...
    1. **Interim Director of Security: [Develop FY21 Security strategy and organisational structure](https://example_company.com/example_company-com/www-example_company-com/issues/5662)**
    ...
    1. **Director of Support: [Develop FY21 Support strategy and supporting organizational direction](https://example_company.com/example_company-com/www-example_company-com/issues/5591)**
    ...
    1. **Director of Support: [Rebase interlock with Customer Success](https://example_company.com/example_company-com/www-example_company-com/issues/5592)**
    ...
    1. **Director of UX: [Scale UX Research by building out Research Training materials that Product Managers and Product Designers can use to consistently deliver results.](https://example_company.com/example_company-com/www-example_company-com/issues/5572)**
...
1. **CFO: Build a scalable data infrastructure that ensures completeness of data, quality and ability for anyone in the organization to access data and perform analysis.**
    1. Data Team: [Embedded/Central analyst/engineer model implemented so each function has at least one embedded data analyst.](https://example_company.com/example_company-data/analytics/issues/3023)
    1. Data Team: Sensitive data [is identified](https://example_company.com/groups/example_company-data/-/epics/74) in 66% of [data sources](/handbook/enterprise-data/platform/#extract-and-load) at the database object level (columns, tables, etc.) [in a file in our repository for use in automated and dynamic modeling, administering, and auditing of the warehouse.](https://example_company.com/groups/example_company-data/-/epics/65)
    1. Data Team: [66% of data sources of Data quality measures and tests documented and implemented for data sources.](https://example_company.com/groups/example_company-data/-/epics/63)
...
1. **CFO: Improve purchasing function to streamline process while saving money.**
    1. Procurement: Public RFP issued to replace Zuora as Example Company's Subscription Management and CPQ solution.
...
1. **CMO: Increase marketing team operational efficiency**
    ...
    1. **Community: Increase response coverage and improve responsiveness on high priority channels.**
        ...
        1. Community KR: Add YouTube Example Company channels and LinkedIn to ZenDesk integration and response workflow.
