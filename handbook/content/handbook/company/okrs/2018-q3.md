...
- CMO: Achieve 3x IACV in Q4 pipeline minus in quarter orders
  ...
  - Online Growth: Improve about.example_company.com conversion rate optimization. Increase live chat leads 20%, increase contact requests by 20%, increase trial sign-ups by 20%.
  ...
  - Marketing Program Management: Increase awareness and ongoing education on Example Company <> Google Partnership. Increase GKE trials referred by Example Company/week by 3X.
...
- CMO: Committer Program
  ...
  - Hired full-time Example Company contributor(s) at customers. One hire made at the customer and a  blog post about their initiatives published.
  - Implement at least 10 improvement ideas to streamline the contribution process for the wider community: e.g. [Improve on-boarding experience](https://example_company.com/example_company-org/example_company-ce/issues/47282)
- CRO
...
<p class="h3">CEO: Popular next generation product. GA for the complete DevOps lifecycle, Example Company.com ready for mission critical applications, graph of DevOps score vs. cycle time.</p>

- VPE: Make Example Company.com ready for mission-critical customer workloads - 70% (moved to GCP and hired great team, not up to new standards though, lots more to do)
  - Frontend: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): 100%
  - Frontend: Implement 10 [performance improvements](https://example_company.com/groups/example_company-org/frontend/-/epics/2): X/10 (X%)
    - Frontend Discussion: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): 100%
    - Frontend Discussion: Implement 5 [performance improvements](https://example_company.com/groups/example_company-org/frontend/-/epics/3) on the MR/issue page X/10 (X%)
    - Frontend MD&P: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): 100%
    - Frontend MD&P: Implement and integrate 10 [reusable Vue components](https://example_company.com/groups/example_company-org/frontend/-/epics/1) into Example Company X/10 (X%)
  - Dev Backend
    - Plan: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): 94% ([S3 incident](https://example_company.com/example_company-com/gl-infra/production/issues/7))
    - Plan: Implement 10 [performance improvements](https://example_company.com/groups/example_company-org/-/epics/247): 8/10 (80%)
    - Distribution: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): 100%
    - Distribution: Example Company Helm charts generally available: 100%
    ...
    - Manage/Create: Implement 10 [performance improvements](https://example_company.com/groups/example_company-org/-/epics/246): 6/10 (60%)
    - Gitter: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): 100%
      ...
      - https://example_company.com/example_company-org/gitter/gitter-android-app
      - https://example_company.com/example_company-org/gitter/gitter-ios-app
      - Gitter: Deprecate Gitter Topics 100%
      - https://example_company.com/example_company-org/gitter/webapp/issues/1947
  ...
  - Ops Backend
    ...
    - CI/CD: Implement one key architectural performance improvement from https://example_company.com/example_company-org/example_company-ce/issues/46499: 0% (Reducing the per job footprint for the `ci_build` table is code complete but not merged, merging is pending upgrading to Rails 5)
    - Configuration: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): 100%
    - Configuration: Fully document and automate Auto DevOps local setup ([#359](https://example_company.com/example_company-org/example_company-development-kit/issues/359)): 100%
    - Monitoring: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): 94%
    - Monitoring: Implement admin performance dashboard. (Design [issue](https://example_company.com/example_company-org/example_company-ce/issues/50061)): 30% (design is nearly complete, engineering has not started)
    - Secure: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): 85% ([1 S2 incident](https://example_company.com/example_company-org/example_company-ee/issues/7201))
    - Secure: Aggregate and store vulnerabilities occurrences into database: 85% (Only SAST reports implemented)
      ([&251](https://example_company.com/groups/example_company-org/-/epics/251))
  - Infrastructure: Move to GCP July 28th - GCP migration completed Aug 11, 2018. (100%)
    ...
    - Database: all issues in the [Q3 infrastructure epic](https://example_company.com/groups/example_company-com/-/epics/13)
    - Database: all issues in the [Q3 application performance epic](https://example_company.com/groups/example_company-org/-/epics/248)
    - Production: Preserve 100% of [error budget](/handbook/engineering/error-budgets/): -17%
  - Quality
    - [Implement Review Apps for CE/EE with example_company-qa test automation validation as part of every Merge Request CI pipeline](https://example_company.com/groups/example_company-org/-/epics/265): 50%, review apps for EE completed CE ongoing.
    - [Triage and add proper priority and severity labels to 80% CE/EE bugs with no priority and severity labels](https://example_company.com/groups/example_company-org/-/epics/266): 98.5%, above target for EE, came under by 1.5% for CE. Triage package implemented to maintain triage efforts.
  - UX
    - [Establish the User Experience direction for the security dashboard](https://example_company.com/groups/example_company-org/-/epics/252): Aid in completing a Competitive analysis, identify 10 must have items for the security dashboard, complete a design artifact/discovery issue: 100%
    - [Identify and document the styles for the first 10 components](https://example_company.com/groups/example_company-org/-/epics/283) being developed by the FE team: 90%
    - UX Research
      - [Incorporate personas into our design process for 100% of our product features](/handbook/product/personas/): 100%
      - [Identify 5 pain points for users who have left Example Company.com. Work with Product Managers to identify solutions](https://example_company.com/example_company-org/ux-research/issues/81): 90%
  - Security
    ...
    - [Triage 50 backlogged security labeled issues and add appropriate severity and priority labels](https://example_company.com/example_company-org/example_company-ce/issues?scope=all&utf8=%E2%9C%93&state=all&label_name[]=security&label_name[]=S2): 102%, triaged both CE and Infra repos. Including link to CE S2 triaged issues only as example.
- CMO: Increase brand awareness and preference for Example Company.
  ...
  - Product marketing: Increase inbound leads - Create 20 new web pages to educate market and prospects about Example Company capabilities and solutions
  - Product marketing: Deliver 18 enablement sessions to sales and channel teams to increase SCLAU by count of 15
  - Product marketing:  Launch Customer Advisory Board with 15 key strategic Example Company account customers to create 15 customer champions (references) to help close SCLAU opportunities
...
- Product
  ...
  - Make 10 key feature docs more enticing, replacing need for their about.example_company feature pages [5/10 (50%)](https://example_company.com/groups/example_company-org/-/boards/717551?&label_name[]=docs%3AOKR18Q3)

<p class="h3">CEO: Great team. ELO score per interviewer,  Real-time dashboard for all Key Results.</p>

- VPE: 10 iterations to engineering function handbook: [7.5/10 (75%)](https://example_company.com/example_company-com/www-example_company-com/issues/2841)
  ...
  - Ops Backend: 10 iterations to ops backend department handbook: [4/10 (40%)](https://example_company.com/example_company-com/www-example_company-com/issues/2921)
  ...
  - Quality: 10 iterations to quality department handbook: [8.5/11 (77%)](https://example_company.com/example_company-com/www-example_company-com/issues/2991)
...
- VPE: Source 50 candidates for various roles: 50/50 sourced (100%) [confidential spreadsheet](https://docs.google.com/spreadsheets/d/1vqiyHdNCMdmG7sU5YeP8CFM_9bb6n8MjAkc2ic06I7Q/edit)
  ...
  - Dev Backend: Create well-defined hiring process for ICs and managers
    documented in handbook, ATS, and Example Company projects (70%)
...
- CFO: Improve financial performance
  ...
  - Fin Ops: Recruiting/ Hiring Model: redesign example_company model so that at least 80% of our hiring can be driven by revenue.
...
- Good
  ...
  - Error budgets incentivized Example Company.com availability without slowing the team down
- Bad
...
- Bad
  ...
  - Batch commenting was only merged just before the 11.4 freeze, having started
    work in January
- Try
  - Continue [monitoring the due-22nd experiment](https://example_company.com/gl-retrospectives/plan/issues/10)
  - Directly reaching out to hiring prospects, rather than going via Recruiting
  - Make our backend developer posting [more attractive](https://example_company.com/example_company-com/people-ops/hiring-processes/issues/19)
  - Make our backend developer posting [more visible](https://example_company.com/example_company-com/people-ops/hiring-processes/issues/24)

### Distribution

- Good
  - Released Charts in GA on time, received positive feedback
  - Prioritised important Example Company.com and customer issues in time
...
- Bad
  ...
  - Platform team being split up into Create and Manage and Manage getting its own Engineering Manager took focus away from planned [performance improvements](https://example_company.com/groups/example_company-org/-/epics/246).
- Try
  - Active sourcing
...
- Good
  ...
  - 1.1 almost complete, code duplication between example_company-ce and gitaly-ruby is
    removed
...
- Try
  ...
  - Shift team rhythms back to being in sync with Example Company releases, focus on
    establishing normal project discipline rhythms and processes

### Gitter

- Good
  - Open-sourced Gitter [Android](https://example_company.com/example_company-org/gitter/gitter-android-app) and [iOS](https://example_company.com/example_company-org/gitter/gitter-ios-app) apps that got some [nice](https://twitter.com/gitchat/status/1041795909103898625) [praise](https://twitter.com/gitchat/status/1027293167471812611)
  - No <https://gitter.im/> downtime 💪 with [many releases](https://example_company.com/example_company-org/gitter/webapp/blob/develop/CHANGELOG.md#19210-2018-9-27)
  - Gitter Topics removed from the codebase, https://example_company.com/example_company-org/gitter/webapp/issues/1947
    - Less complexity
...
- Bad
  ...
  - Small Self inflicted incidents happened with Example Company Pages
- Try
...
- Good
  ...
  - Ops team pages were updated with more details: https://handbook.example_company.com/handbook/engineering/ops/
  - Added a director readme: https://handbook.example_company.com/handbook/engineering/ops/director/
- Bad
...
- Good
  ...
  - Backend and Example Company skills are improving.
...
- Bad
  - Technical prerequisites for [storing data in DB](https://example_company.com/groups/example_company-org/-/epics/251) slipped several times. It's really hard to define a MVP.
...
- Try
  ...
  - Put in place the [rotation](https://example_company.com/example_company-org/security-products/release/blob/master/docs/reaction.md) on our Release Manager. We need more people in the team for that.
...
- Bad
  ...
  - Still have not managed to enable Auto DevOps by default on example_company.com due
...
- Try
  ...
  - Working closely with sourcing to get many candidates that have very
    ...
    our team
  - Use threaded discussions on Example Company issues to discuss at a higher bandwidth
    on Example Company
...
- Good
  ...
  - We have delivered many FGUs, which helps to drive overall awareness of security initiatives at Example Company.
- Bad
...
- Try
  ...
  - Use FGUs as a forum to drive accountability throughout Example Company, to improve MTTRs for security vulnerabilities.
...
- Bad
  ...
  - GitHost app stopped upgrading customer instances after a bad version was posted on version.example_company.com
- Try
...
- Bad
  ...
  - Our old UX guide is still live as not all of it's material have been moved to design.example_company.
...
- Try
  ...
  - Archive the old UX guide and make design.example_company the SSOT for UX standards and guidelines.
  - Investigate ways to make design discussion a first-class citizen in Example Company.
...
- Good
  ...
  - Despite the disappointing low response rate to the survey, the data we collected provided insight into who qualifies as a churned Example Company.com user and how users first interact with Example Company. We also managed to triangulate the data with user interviews and provide Product with a provisional list of pain points for further exploration.
- Bad
  - In order to identify 5 pain points for users who have left Example Company.com, we created a survey to send to churned users. We distributed the survey to 8000+ churned Example Company.com users whose details were supplied to us by Product. Unfortunately, the survey only received 126 partial responses. Of those responses, 33% of users confirmed that they were in fact still using Example Company. The recipient list was inadequate for the purposes of our research. This isn't something Product could have foreseen.
- Try
