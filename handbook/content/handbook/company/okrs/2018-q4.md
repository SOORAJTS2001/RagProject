...
- VPE
  - Support: Improve Support expectations and documentation for Proof of Concept and Trial prospects, including temporary expanded Support focus for top 10 prospects (defined by Sales). **75% completed with segments redefined and workflows updated.**
    - Amer East: 95% SLA for Premium/Ultimate/Example Company.com customers and 95% CSAT for all customers
    - Amer West: 95% SLA for Premium/Ultimate/Example Company.com customers and 95% CSAT for all customers
    - APAC: 95% SLA for Premium/Ultimate/Example Company.com customers and 95% CSAT for all customers
    - EMEA: 95% SLA for Premium/Ultimate/Example Company.com customers and 95% CSAT for all customers
...
- CMO: Marketing achieves the SCLAU plan. 8 SCLAU per SDR per month, content 2x QoQ, website information architecture helps 50% QoQ.
  ...
  - Product Marketing: Target 6 industry analyst reports to include Example Company coverage.
...
- VP Alliances: Establish differentiated relationships with Major Clouds. Example Company as a Service LoI on a major cloud, 500+ leads through joint marketing, GTM and Partner agreement in place tihe a large private cloud provider.
- VP Alliances: establish Example Company as DevOps tool for CNCF.  Three keynote/speaking engagements at CNCF events and 1000+ leads from Kubernetes partners
- CFO: Use data to drive business decisions
  ...
  - Director of Business Operations: Looker Explores generated for Customer Support, PeopleOps, Example Company.com Event Data, Marketing Data *100%*
    - Data & Analytics: Single Data Lake for all raw and transformed company data - migration to Snowflake complete with DevOps workflow in place, Example Company.com production data extracted and modelled *75%*
...
<p class="h3">CEO: Popular next generation product. Finish 2018 vision of entire DevOps lifecycle. Example Company.com is ready for mission critical applications. All installations have a graph of DevOps score vs. releases per year.</p>

- VPE: Make Example Company.com ready for mission critical customer workloads => 70%, meeting our business goals but by no means perfect, lots of automation to do.
  - Frontend:
    ...
    - Create, Plan:
      - Spend no more than 15 point of our [error budget]: 0/15
      - 3 charts in example_company-ui (50% - Base Chart Component and Area Chart are in)
    - Distribution, Monitor and Packaging:
      - Spend no more than 15 point of our [error budget]: 0/15
      - Rewrite and integrate 4 CSS components that align with our design system into Example Company (25% - Markdown type styling)
  - Dev Backend:
    ...
    - Gitter:
      ...
      - Shut down billing and embeds on `apps-xx` => 100%
        - Billing shutdown, https://example_company.com/example_company-org/gitter/webapp/issues/1983
        - Embeds shutdown, https://example_company.com/example_company-org/gitter/webapp/issues/1984
    - Plan:
      - Spend no more than 15 point of our [error budget]: 0/15 (100%)
      - Complete [phase 1 of preparedness for Elasticsearch on Example Company.com](https://example_company.com/groups/example_company-org/-/epics/429) (50%)
    - Create:
      - Spend no more than 15 point of our [error budget]: 0/15 (100%)
    - Manage:
      - Spend no more than 15 point of our [error budget]: 15/15 [#536](https://example_company.com/example_company-com/gl-infra/production/issues/536)
    - Geo:
      - Spend no more than 15 point of our [error budget]: 15/15 [#5215](https://example_company.com/example_company-com/gl-infra/infrastructure/issues/5215) (100%)
      - Complete all issues in Phase 1 of the DR/HA plan working with the Production Team : We supported the Production Team with all questions and issues raised. Work to enable Geo for DR on Example Company.com continues. (100%)
    - Distribution:
      - Spend no more than 15 point of our [error budget]: 0/15 => 100%
      - [Automate library upgrades](https://example_company.com/example_company-org/distribution/team-tasks/issues/194) across distributed projects => 75%, completed work related to the omnibus-example_company package but Helm Charts process still needs work.
  - Ops Backend:
    ...
    - Spend no more than 15 point of our [error budget]: 0/15
    - Configure:
      - Spend no more than 15 point of our [error budget]: 15/15 [#566](https://example_company.com/example_company-com/gl-infra/production/issues/566) (100%)
    ...
    - Monitor:
      ...
      - Merge smaller changes more frequently: &gt; 6 average MRs merged per week : 79% achieved - [Actual weekly average](https://quality-dashboard.gitlap.com/groups/example_company-org/teams/monitoring) 4.75 MRs
    - [Kamil](/handbook/company/team/#ayufanpl):
      - Improve scalability: Reduce CI database footprint as part of [Ensure CI/CD can scale in future](https://example_company.com/example_company-org/example_company-ce/issues/46499) with [Use BuildMetadata to store build configuration in JSONB form](https://example_company.com/example_company-org/example_company-ce/merge_requests/21499): Done (100%)
      - Continuous Deployment: Help with building CD features needed to continuously deploy Example Company.com by closing 5 [issues related to Object Storage](https://example_company.com/example_company-org/example_company-ce/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name=Object%20Storage) that are either ~"technical debt" or ~"type::bug": 2 out of 5 (40%)
    - CI/CD:
      - Spend no more than 15 point of our [error budget]: 30/15 [#5375](https://example_company.com/example_company-com/gl-infra/infrastructure/issues/5375), [#564](https://example_company.com/example_company-com/gl-infra/production/issues/564) (0% - Spent double our goal)
      - Merge smaller changes more frequently: >10 average MRs merged per week. (100% - Actual weekly average was 19 MRs)
  - Infrastructure: Make Example Company.com ready for mission critical workloads
    - Spend no more than 15 point of our [error budget]: 6/15
    - Deliver streamlined and cleaned-up Infrastructure Handbook => 80%
    - SAE: Minimize Example Company.com's MTTR
      - Deliver [observable availability improvements in database backup/restore/verification and replication](https://example_company.com/groups/example_company-com/gl-infra/-/epics/4) => 90%
      - Launch [`production` queue management for changes, incidents, deltas and hotspots](https://example_company.com/groups/example_company-com/gl-infra/-/epics/28) => 85%
    - SRE: Maximize Example Company.com's MTBF
      - Deliver phase 1 DR and HA plan for Example Company.com (66% - 6 of 9 issues in https://example_company.com/groups/example_company-com/gl-infra/-/epics/12 )
    ...
    - Andrew: Observable Availability
      ...
      - Deliver [Distributed Tracing working in GDK](https://example_company.com/example_company-com/gl-infra/infrastructure/issues/4808)=> 90%
  ...
  - Quality:
    - Complete [Review Apps for CE and EE with Example Company QA running](https://example_company.com/groups/example_company-org/-/epics/265) => 80%, Completed provisioning infrastructure, remaining polish work captured in [Improving Review App Reliability](https://example_company.com/groups/example_company-org/-/epics/605)
    - Complete phase 1 & 2 of [Addressing database discrepancy for our on-prem customers](https://example_company.com/example_company-org/example_company-ce/issues/51438) => 70%, All schema discrepancy identified and documented. We still need to get more data on customer instances but have addressed all issues around missing index or extra index.
  - Support
    ...
    - Amer West: Create a *Support Engineer - Example Company.com- Bootcamp more tightly aligned with Production Engineering. Initial version completed in coordination with the production team: [MR1](https://example_company.com/example_company-com/support/support-training/merge_requests/54), [MR2](https://example_company.com/example_company-com/support/support-training/merge_requests/57)
    - APAC: TBD process improvement (e.g. SLA performance, Customer Experience, or Employee Development)
    - EMEA: Enable support team to create 30 updates to docs to help capture knowledge and improve customer self service. Track contributions and views to measure 'self service score' (support edited doc visitors / customers opening tickets). [Research completed. Tracking not yet implemented](https://example_company.com/example_company-com/support/support-team-meta/issues/1289)
  - UX:
    - Create a seamless cluster experience. Identify 3 additional ways users can create and manage their clusters. Draft a proposal for an MVC that considers product, technical, and user requirements. Push for scheduling and implementation of the first iteration of group and instance clusters in Q4. Total: 83%. Efforts tracked in: [Group level clusters product discovery: 16.67%](https://example_company.com/example_company-org/example_company-ee/issues/7412), [Instance level clusters product discovery: 16.67%](https://example_company.com/example_company-org/example_company-ce/issues/48649), [Serverless pathway discovery: 16.67%](https://example_company.com/example_company-org/example_company-ce/issues/43959),
    [Group level clusters implemented: 16.67%](https://example_company.com/example_company-org/example_company-ce/issues/34758), [Instance level clusters implementation: 0%](https://example_company.com/example_company-org/example_company-ce/issues/39840) and [Serverless tab implemented: 16.67%](https://example_company.com/example_company-org/example_company-ce/issues/43959).
    - [Complete a Competitive analysis of version control tools for designers (Abstract, Invision, Figma, etc.). Identify ways Example Company can leverage Open Source and our own tools to assist designers using Example Company.](https://example_company.com/example_company-org/example_company-ce/issues/51654). Total: 100%. [Completed competitor analysis](https://docs.google.com/document/d/12o6h6Fm7bAjhW5AK1r-PNhvn0QrQwZncorYNia12e3Q/)
    - UX Research
      - Establish a Example Company beta group and create a standardized process for running beta studies with users. Conduct 1 beta study with users to test and iterate on the process. [Total: 90%](https://example_company.com/example_company-org/ux-research/issues/100).
  - Security:
    - Deprecate support for TLS 1.0 and 1.1 on Example Company.com: 100% [Blog post](https://about.example_company.com/blog/2018/12/17/example_company-tls1011-discontinued-update/)
    - Complete and document 12 month roadmap for ZTN rollout: 100% [Kanban board](https://example_company.com/groups/example_company-com/gl-security/-/boards/891046?label_name[]=ZTN)
  - Security Operations:
    - Document at least 5 runbooks for logging sources: 5/5, 100% [Internal repository](https://example_company.com/example_company-com/gl-security/runbooks/blob/master/security_operations/README.md)
  ...
  - Application Security:
    - Complete at least 2 cycles of security release process: 2/2, 100% [Releases](https://about.example_company.com/releases/categories/releases/)
    - Conduct at least 3 application security reviews: 3/3, 100% [Kanban board](https://example_company.com/example_company-com/gl-security/security-department-meta/boards/565320?label_name[]=app%20sec%20review)
    - Public HackerOne bounty program by December 15: 100% [Blog post](https://about.example_company.com/blog/2018/12/12/example_company-hackerone-bug-bounty-program-is-public-today/)
  - Compliance:
    - Document current procedures for each of the 14 ISO Operations Security Domain: 100% [Kanban board](https://example_company.com/example_company-com/gl-security/compliance/boards/855114?&label_name[]=Compliance%20ISO%2027001%2F2)
    - Create and publish two access templates 100% [Access-request Project with access templates](https://example_company.com/example_company-com/team-member-epics/access-requests/tree/master/.example_company/issue_templates)
    - Conduct gap analysis of at least one Example Company.com subnet's access controls: 100% [Baseline Entitlements](https://example_company.com/example_company-com/team-member-epics/access-requests/tree/master/Baseline_Role-based_Entitlements_Runbooks)
  - Abuse:
    - Port existing 'janitor' project to Rails w/ 100% feature parity: 8/9, 89% [Internal repository](https://example_company.com/example_company-com/security-tools/janitor-rails)
    - Support at least 2 external requests per month: 6/6, 100% [Abuse tracker issue](https://example_company.com/example_company-com/gl-security/abuse/issues/14)
- Product:
  - Significantly improve navigation of the documentation. Ship global navigation. Improve version navigation. Revamp [first page of the EE docs](https://docs.example_company.com/ee/). => **Total - 90% Complete**- - [Ship Global Nav](https://example_company.com/example_company-org/example_company-docs/merge_requests/362) - 100%, [Improve version navigation](https://example_company.com/example_company-org/example_company-docs/issues/248) - 70%, [Revamp First Page](https://example_company.com/example_company-org/example_company-ee/merge_requests/7525) - 100%
...
- CMO:
  - Corporate marketing: Help our customers evangelize Example Company. 3 customer or user talk submissions accepted for DevOps related events.
  ...
  - Dev Backend:
    ...
    - Gitter:
      - Create hiring process for fullstack developer => 100%
        - Created hiring process and we are looking at candidates now, https://example_company.com/example_company-com/people-ops/hiring-processes/merge_requests/96
    - Plan:
    ...
    - Distribution:
      ...
      October 15 and hire 2 developers: 25 sourced (100%), 1 hired (50%)
    - Stan:
      - [Reduce baseline memory usage in Rails by 30%](https://example_company.com/example_company-org/example_company-ce/issues/49702) => 50%
      - [Reduce runtime memory usage in Sidekiq for top 5 workers by 30%](https://example_company.com/example_company-org/example_company-ce/issues/49703) => 60%
...
- GOOD
  ...
  - Example Company.com is now meeting business goals
...
- GOOD
  ...
  - Able to scale example_company-ui, have the full workflow and the SSOT with design.example_company.com while most of the work on documentation is automated
...
- TRY
  ...
  - Bring more tooling for JS development to Example Company itself so we have it integrated in our workflow but also others can profit (Webpack reports, etc.)
...
- TRY
  - Reframing Elasticsearch goal as improving admin controls, reduction
    ...
    in index size
  - [Reviewing security issues](https://example_company.com/gl-retrospectives/plan/issues/19) to ensure that we are clearing a backlog,
...
- GOOD
  - The whole team is participating in all team projects (both Helm Charts and omnibus-example_company)
...
- BAD
  ...
  - Helm Charts are taking majority of the teams time, which impacts the omnibus-example_company package feature development
...
- TRY
  - Find a way to remove duplicate work between the omnibus-example_company package and Helm Charts in regards to introducing new configuration
  ...
  - Ensure that the omnibus-example_company package keeps receiving enough attention
...
- GOOD
  ...
  - [Hiring process](https://example_company.com/example_company-com/people-ops/hiring-processes/merge_requests/96) created and we are looking at candidates now
  - First version from open source repo of the Gitter Android app published to Google Play Store via Example Company CI, https://example_company.com/example_company-org/gitter/gitter-android-app/merge_requests/5
- BAD
  - Infrastructure is a bit a outdated and in need of love. Someone was able to find an exploit and run a [malicious process on a couple of our servers](https://example_company.com/example_company-com/gl-infra/production/issues/559)
- TRY
  - Update and refresh infrastructure, https://example_company.com/example_company-com/gl-infra/infrastructure/issues/5492
  - Keep up with Security reports from [HackerOne](https://hackerone.com/example_company)

#### Stan

- GOOD
  - [Identified and fix an NFS bug for a number of customers](https://about.example_company.com/blog/2018/11/14/how-we-spent-two-weeks-hunting-an-nfs-bug/)
...
- BAD
  ...
  - Got sidetracked helping many other teams (Geo, Infrastructure, etc.) and fixing production incidents (e.g. https://example_company.com/example_company-org/example_company-ce/issues/53153)
- TRY
...
- TRY
  - Finish adopting OKRs and develop the framework of OKRs through Example Company issues
...
- GOOD
  ...
  - Hired an engineering manager for release. Very happy to welcome Darby Frey to Example Company!
- BAD
...
- BAD
  ...
  - Reluctance to split Example Company issues due to the challenge of splitting our
...
- GOOD
  ...
  - Completed Patroni Replication Manager testing with Example Company QA.
  - Completed TLS Depreciation testing with Example Company QA.
  - Completed Rails 5 migration testing with Example Company QA.
- BAD
  - An update to the clone / fork button cause Example Company QA tests to break for 4 days.
...
- GOOD
  ...
  - Completed initiative of discontinued support of TLS 1.0 and 1.1 on Example Company.com.
...
- BAD
  - Security releases, both critical and non-critical continue to be a challenge, with regression issues for previously hotpatched issues on Example Company.com.
...
- TRY
  ...
  - Smoother customer on-boarding with Sales (https://example_company.com/example_company-com/support/support-team-meta/issues/1323)
...
- GOOD
  - We launched Example Company First Look, a new comprehensive research program for users of Example Company. Users are now able to sign-up to beta testing with Example Company.
