...
1. CPO
1. CMO:
    1. Open a communication channel with Example Company.com users. Implement a growth analytics and user communication tool in Example Company (self-managed & example_company.com), Test an in-app message and hyperlink in Example Company.com as an iteration, Redesign the example_company.com/explore page.
       1. Digital Marketing Programs: Redesign example_company.com/explore page, create better in-product linking to about.example_company.com, and create a strategy for in-app messaging to increase traffic from product to about.example_company.com by 10K users.
       1. Marketing Operations: Open up communication channel with CE users. Re-implement [health check](https://example_company.com/example_company-com/marketing/marketing-operations/issues/532).
    1. Re-focus on technical & how-to content.  Hire technical content re-mixer, publish 15 pieces of blog and social technical content, SEO analysis of docs.
       ...
       1. Digital Marketing Programs: Drive traffic to docs and from docs to about.example_company.com via on-page optimization, improved cookie-ing, remarketing, and ABM to increase new user traffic to docs by 10% QoQ.
    ...
    1. Attract net-new developers and DevOps practitioners.  Deploy paid digital campaign focused on technical audience, enable retargeting of deeper technical content to docs visitors, launch Example Company "heroes" program, sign-up 1,500 users to 3 user conferences (500 each).
       ...
       1. Corporate Marketing: Prominent presence at strategic industry events (KubeCon EU, DOES EMEA, OSCON). Capturing over 15% of an engaged audience (through talks, social, booth scans, giveaways, dinners and meetings)
          1. Technical Evangelism: Reach 10,000 people through technical evangelism efforts (such as talks, onboarding CNCF projects on Example Company CI), create 5 technical blog posts and social technical content from show content within 2 weeks of event.
          ...
          1. Events: Announce user conferences. Drive 600 sign ups to the events, align Example Company "heros" program with the user conferences, recruit 5 well-known speakers to be part of the event to drive sign ups.
       ...
       1. Corporate Marketing: Create Example Company brand swell. Launch Onion Labs video and reach 100,000 page visits, Example Company included in 15% of Atlassian and Azure DevOps news moving forward, and increase coverage in EMEA by 10%.
       ...
       1. Developer Relations: Increase response coverage and improve responsiveness on high priority channels. Decrease median first reply time to 5 hours  for Hacker News and website comments, Monitoring with ZenDesk integration and response workflow in the handbook available for all Youtube Example Company channels.
       1. Developer Relations: Increase strategic Open Source projects engagement. At least 1 net new successful POC with a strategic open source project (e.g. a project in CNCF) to migrate to Example Company. PR/Blog post featuring an open source project on Example Company.
1. VP Eng: [Ensure self-managed Example Company scales for large enterprise customers](https://example_company.com/example_company-com/www-example_company-com/issues/4334).
    1. Development
        ...
        1. Enablement: [Kickstart Memory project](https://example_company.com/example_company-com/www-example_company-com/issues/4292). Determine first iteration scope, hire team members, build dev and testing framework, establish and collect performance metrics, complete 1 low hanging fruit enhancement.
        1. Fellow: Work across teams to ensure Gitaly I/O and other performance issues resolved with 10K reference test. => 40%
        1. Fellow: Solve 3 priority customer issues that may impede significant Example Company adoption. => 100%
...
1. CMO: Publish visual proof of benefits of single application. Benchmark toolchain clicks, handoffs and integrations, create methodology for comparing to Example Company. Identify 2 customers to work with and create internal business case justification for Example Company purchase based on single application benefits.
1. VP Product: [Become data-informed](https://example_company.com/example_company-com/Product/issues/166) and [more customer driven](https://example_company.com/example_company-com/Product/issues/142). [Build all product KPI dashboards](https://example_company.com/example_company-com/Product/issues/39) (with Business Ops), 40% of direction items are provably successful, each PM conduct three [customer discovery conversations](/handbook/product/product-processes/#customer-meetings) per quarter. => 27%, 0%, 227%
    1. Director of Product, Dev: [Make Example Company the most usable DevOps platform on the market](https://example_company.com/example_company-com/www-example_company-com/issues/4302). Prioritize issues to raise SUS score from 74.4 to 76.2. => -1.2%
    1. Director of Product, Dev: Grow use of Example Company. Increase [SMAU](/handbook/product/groups/growth/#smau) 10% m/m for Manage, Plan, Create. => 28%
        1. PM, Create: Ensure self-managed Example Company scales for large enterprise customers. Prioritize Gitaly N+1 query issues. => 55%
    1. Director of Product, CI/CD: Grow use of Example Company. Increase [SMAU](/handbook/product/groups/growth/#smau) 10% m/m for Verify, Package, Release, drive MAU for Verify by 8% through [Grand Unified Theory of CI/CD (high ROI primitives)](https://about.example_company.com/direction/ops/#powerful-integrated-primitives), drive MAU for Release by 8% through establishing [Progressive Delivery](https://about.example_company.com/direction/ops/#progressive-delivery) leadership in marketplace and making associated deliverables. => 33%
    1. Director of Product, Ops: Grow use of Example Company. Increase [SMAU](/handbook/product/groups/growth/#smau) 10% m/m for Monitor, Configure.
    1. Director of Product, Secure: Grow use of Example Company. Increase [SMAU](/handbook/product/groups/growth/#smau) 10% m/m for Secure.
    1. Director of Product, Growth: Improve key growth metrics for both self-managed and Example Company.com. Create MAU and SMAU dashboards, execute and analyze 4 growth experiments, increase SMAU 10% m/m. => 0%, 25%, 27.5%
    1. Director of Product, Enablement: Become data-informed. Implement telemetry (usage and events) suitable for entire company, track all events across Example Company.com and (non-opted-out) self-managed instances, track usage more robustly. => 100%, 33%, 0%.
        1. PM, Memory: Ensure self-managed Example Company scales for large enterprise customers. Prioritize memory issues. => 100%
...
1. VP Eng: [Build our product vision](https://example_company.com/example_company-com/www-example_company-com/issues/4335).
    1. Development: [Increase productivity](https://example_company.com/example_company-com/www-example_company-com/issues/4307). => 85%
    1. Development:
        1. Secure:
            1. [Philippe Lafoucrière](/handbook/company/team/#plafoucriere): [Enable Secure Stage Third Party Integrations](https://example_company.com/groups/example_company-org/-/epics/1252) with 3 official integrations. => 25% (Detectify and SonarQube still ongoing, 3rd integration not started)
        1. Gitter: [Add automatic npm dependency updates](https://example_company.com/example_company-org/gitter/webapp/issues/1880) to reduce technical debt and keep on top of security fixes => 100%
    1. Infrastructure: Make all user-visible services ready for mission critical workloads.
        1. Dev and Ops: Drive all user-services MTTR to less than 60 seconds. Move writes from NFS (shared01) to object storage, implement ElasticSearch on Example Company.com, migrate repos to ZFS storage.
        ...
        1. Secure and Defend: Secure Example Company.com. Deploy Camo proxy server, deploy Vault to provide a solution for secrets management and use, Upgrade Postgres to version 11 with log centralization and reporting.
        1. Delivery:
          - Streamline Example Company deployments on Example Company.com and self-managed releases => 100%
          - Migrate Example Company.com registry to Kubernetes and have it autodeployed as part of release process => 50%
          - Complete Example Company codebase merge => 80%
          - Implement storage limits => 40%
          - Implement single object storage => 5%
    1. Infrastructure: Control example_company.com cost. Decrease cost per user from X to Y, Lower total target spend from X to Y.
    1. Quality: [Make self-managed mission critical](https://example_company.com/example_company-com/www-example_company-com/issues/4343). => 94%
    1. Quality: [Increase Engineering Productivity](https://example_company.com/example_company-com/www-example_company-com/issues/4344). => 87%
    ...
    1. Security: Continue rollout of Zero Trust model.
        ...
        1. Compliance: Develop and publish Information Security Compliance Roadmap. 100% [Security - Trust Center](https://about.example_company.com/security/)
        1. Compliance: Complete information security controls gap analysis. 100% [Example Company Control Framework Gap Analysis Results 2019-07-31](https://example_company.com/example_company-com/gl-security/security-assurance/sec-compliance/compliance/issues/584)
        1. Red Team: Conduct and document  at least 5 threat modeling exercises.
        1. Red Team: Identify 5 risks to customer data in Example Company.com and/or Example Company CE.
        1. Security Operations: Reduce Example Company.com cloud spend through Abuse activity mitigations.
        1. Security Operations: Automate end-to-end vulnerability management process.
    1. Support: [Improve the Customer Experience.](https://example_company.com/example_company-com/www-example_company-com/issues/4321) => 50%
        1. AMER-W: [Improve the customer experience by decreasing the time to resolution (TTR) of tickets and reported issues.](https://example_company.com/example_company-com/support/support-team-meta/issues/1606) => 85%
        1. Support Operations Specialist: [Clean up SFDC -> Zendesk data sync to ensure proper SLA workflows.](https://example_company.com/example_company-com/support/support-team-meta/issues/1706) => 80%
        1. Support Operations Specialist: [Create plan to evolve our Customer Satisfaction survey process.](https://example_company.com/example_company-com/support/support-team-meta/issues/1705) => 95%
        1. AMER-C: [Strengthen Support's Skill Base.](https://example_company.com/example_company-com/www-example_company-com/issues/4944) => 33%
        1. EMEA: [Initiate a weekly CSAT feedback review process.](https://example_company.com/example_company-com/support/support-team-meta/issues/1613) => 50%
        1. EMEA: [Add doc and issue search to Support portal and improve ticket deflection by enabling customers to find solutions by searching before submitting tickets.](https://example_company.com/example_company-com/support/support-team-meta/issues/1612) => 30%.

    1. Support: [Establish consistent escalation path of customers issues.](https://example_company.com/example_company-com/www-example_company-com/issues/4014) => 80%
        1. AMER-E: [Define roles & responsibilities between tech support and customer success based on Denver Customer Success Workshop.](https://example_company.com/example_company-com/support/support-team-meta/issues/1615) => 90%
        1. AMER-W: [Rollout Support Stable Counterparts.](https://example_company.com/example_company-com/support/support-team-meta/issues/1607) => 90%
        1. Support Operations Specialist:[Complete Federal support instance process and implementation.](https://example_company.com/example_company-com/support/support-team-meta/issues/1707) => 90%
        1. APAC: [Establish consistent escalation path of customers issues.](https://example_company.com/example_company-com/support/support-team-meta/issues/1605) => 20%
        1. APAC: [Iterate on Incident Management for self-managed customers.](https://example_company.com/example_company-com/support/support-team-meta/issues/1663) => 20%
        1. APAC: APAC: [Improve quality of non-English ticket support.](https://example_company.com/example_company-com/support/support-team-meta/issues/1664) => 30%
        1. AMER-C: [Revamp Support Onboarding.](https://example_company.com/example_company-com/www-example_company-com/issues/4945) => 60%
        1. AMER-C: [Establish Americas Central team.](https://example_company.com/example_company-com/www-example_company-com/issues/4946) => 100%
    1. UX Director: [Make Example Company the most usable DevOps platform on the market.](https://example_company.com/example_company-com/www-example_company-com/issues/4302) => -1.2%
    1. UX Director: [Make Example Company UX more strategic by basing more of our experience decisions on feedback from the wider Example Company community.](https://example_company.com/example_company-com/www-example_company-com/issues/4304) => 65%
        1. CI/CD UX Team: [Elevate UX from reactive to strategic.](https://example_company.com/example_company-com/www-example_company-com/issues/4354)
            1. Staff Designer: [Improve the quality and consistency of our UI.](https://example_company.com/example_company-com/www-example_company-com/issues/4355) => 47%
        1. Ops UX Team: [Elevate UX from reactive to strategic by proactively identifying, defining, prioritizing, and tracking experience improvements.](https://example_company.com/example_company-com/www-example_company-com/issues/4354) => 88%
        1. Dev UX Team: [Elevate UX from reactive to strategic by proactively identifying, defining, prioritizing, and tracking experience improvements.](https://example_company.com/example_company-com/www-example_company-com/issues/4354) => 88%
        1. Secure UX Team: [Elevate UX from reactive to strategic by proactively identifying, defining, prioritizing, and tracking experience improvements.](https://example_company.com/example_company-com/www-example_company-com/issues/4354) => 88%
        1. Growth UX Team: [Elevate UX from reactive to strategic by proactively identifying, defining, prioritizing, and tracking experience improvements.](https://example_company.com/example_company-com/www-example_company-com/issues/4354) => 88%
        1. Technical Writing Team: [Make Example Company docs more complete, findable, and easy to update, using 'single source of truth' standards.](https://example_company.com/example_company-org/example_company-design/issues/388) => 92%
        1. Technical Writing Team: [Make sure we're proactively addressing the most valuable doc improvements and corrections in every stage group.](https://example_company.com/example_company-org/example_company-design/issues/387) => 80%
...
1. CFO: Improve financial planning  processes to support growth and increased transparency.
    ...
    1. Dir. of Bus Ops: Data Quality Process (DQP) completed for ARR, Net and Gross Retention and Customer counts. Third party review completed for same metrics. [Example Company Metrics at IPO - Google Sheet](https://docs.google.com/spreadsheets/d/1qcFD5UkOoG1P2pTfSEUvOkc9zk_vhqCDQR-oVkcB2zY/edit?usp=sharing).
    ...
    1. Finance Business Partner:
        1. Example Company.com allocation model signed off by CFO and VP Engineering with handbook updated for methodology.
...
1. CFO: Create scalable infrastructure for achieving efficient growth
    ...
    1. Director of Business Operations: Example Company Team Members are securely online Day 1
    1. Director of Business Operations: 100% Example Company team-member Adoption of OKTA
    ...
    1. Director of Business Operations: Evaluate and Install Client side security and provisioning on 50% of Example Company owned laptop fleet.
1. CPO:
    ...
    1. Compensation: Continue the evolution of our Compensation Model
        1. Ramp new Analyst successfully to understand our compensation model, working transparently in Example Company, and ensure proficiency in all related tools.
    ...
    1. Employment Brand: Evolve GitLabs Employment Brand
        1. Collaborate with Marketing to create and publish a new Example Company recruiting video to promote working at Example Company and what it's like to work at Example Company.
        1. Define and publish Example Company's employer value proposition.
...
1. CMO:
    1. Launch All-Remote web destination. Digest existing all-remote content, create an all-remote landing page for recruiting support, at least 2 all-remote related press articles in mainstream press (defined as non-tech press).
        1. Corporate Marketing: Launch all remote thought leadership platform. Increase coverage of Example Company being all remote by 20% in the media, secure 2 mainstream media articles, increase speaking opportunities on all remote by 20%.
           1. Events: Help support all-remote thought-leadership.  Work cross-functionally with peopleops to create and implement collateral at events, commit to 2 all-remote events, and put together a strategy/proposal around an all-remote Example Company event.
           ...
           1. Content: Develop all remote editorial strategy. Create "all remote" content section on Example Company's digital publication. Increase new users on all remote blog content and increase views of all remote YouTube content by 10%. Publish 5 videos from Contribute.
    ...
    1. 100% real-time funnel metrics. All funnel marketing metrics in periscope available to anyone at Example Company.
...
1. VP Eng: [Scale processes to accommodate a 500 person organization](https://example_company.com/example_company-com/www-example_company-com/issues/4336)
    1. Development: [Achieve Level 3/4 Maturity for KPIs](https://example_company.com/example_company-com/www-example_company-com/issues/4313) => 74%
        1. Ops: Roll out the pulse survey to FE team.
        1. Secure: Roll out the pulse survey across the section teams.
    1. Development: [Hire to plan](https://example_company.com/example_company-com/www-example_company-com/issues/4308) => 100%
    1. Development:
        1. Secure:
            1. [Philippe Lafoucrière](/handbook/company/team/#plafoucriere): [Evaluate OWASP Sponsorship](https://example_company.com/example_company-com/www-example_company-com/issues/4382) to improve Example Company visibility on the Security market. => 100%
    1. Infrastructure: Get all KPIs built.
    1. Quality: [Increase maturity of Quality Department KPIs](https://example_company.com/example_company-com/www-example_company-com/issues/4351). => 80%
    ...
    1. Support: [Adopt capacity model with finance, and update vacancies in team.yml](https://example_company.com/example_company-com/www-example_company-com/issues/4081) => 100%
        1. AMER-W:[Develop blended team model.](https://example_company.com/example_company-com/support/support-team-meta/issues/1608) => 60%
        1. AMER-E: [Convert all current metrics to use FY designation & Explore Periscope or Zendesk Explore as the next iteration platform.](https://example_company.com/example_company-com/support/support-team-meta/issues/1616) => 10%
        1. AMER-E: [Review Support Engineering Onboarding and redesign to align with product stages and define post-onboarding stages.](https://example_company.com/example_company-com/support/support-team-meta/issues/1617) => 10%
...
- BAD
  ...
  1. Availability suffered on Example Company.com and we had to punt on cost initiatives in the last month of the quarter
- TRY
...
- TRY
  1. Try to use more of Example Company features at the cost of missing deadlines. Communicating the challenges while dogfooding is ultimately more valuable than delivering under deadline
  1. Leverage use of demos more for larger projects
  1. Better project planning when tackling architectural changes in Example Company codebase
