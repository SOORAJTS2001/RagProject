...
1. CEO KR: End Q1 with Q2 New business IACV Stage 3+ [Pipeline](/handbook/marketing/revenue-marketing/#revenue-marketing-kpi-definitions) and Growth business IACV Stage 3+ Pipeline both ahead of plan.
    1. **CRO: Build strong FY21 pipeline.**
        ...
        1. CRO KR: FY21-Q3 stage 3+ pipeline at 1.2X target and total pipeline at 1.7x
            1. **VP Field Ops: Instrument systems and programs to intended targets.**
                1. VP Field Ops KR: Factor pipeine targets to relevant tools.
                    ...
                    1. **Director of Field Enablement: Prepare for Example Company Field Certification Program**
                        ...
                        1. Director of Field Enablement KR: Complete job task analysis for in-scope field roles => 90% complete for [Sales](https://example_company.com/example_company-com/sales-team/field-operations/sales-operations/-/issues/876) and [CS](https://example_company.com/example_company-com/sales-team/sales-onboarding/-/issues/101) roles
                    1. **Director of Field Enablement: [Reduce the dependence of SAEs & AEs on SAs](https://example_company.com/example_company-com/sales-team/field-operations/enablement/-/issues/156)**
            ...
            1. **VP Alliances: increase Example Company content as part of our partner's sales and marketing to scale pipeline and speed to close.**
                ...
                1. VP Alliances KR: Execute first joint marketing campaign --> [WIP](https://example_company.com/example_company-com/marketing/product-marketing/-/issues/2181)
    1. **CRO: Launch New Channel Program**
       1. CRO KR: New tiers, terms and agreement complete, published on partner portal and handbook for all partners
           1. **VP, Global Channels: Develop and release new Example Company Channel Program.**
               1. VP, Global Channels KR: Channel Program details released and promoted on handbook and partner portal => [DONE](https://example_company.com/example_company-com/channels/issues/22)
           1. **Director of Field Enablement: Partner with Channel team to build enablement program to support channel launch.**
               1. Director of Field Enablement KR: Launch [Channel Sales and SE Accreditation MVP](https://example_company.com/example_company-com/channels/issues/21) with assessments by 2020-04-02. => DONE
       ...
       1. CRO KR: Automated deal reg launched and available in SFDC Partner Portal.
           1. **Sr Manager Sales Systems: Build and release SFDC Communities Parter Portal.**
               1. Sr Manager Sales Systems KR: 100% of partner deal registrations received via Partner Portal. => [DONE](https://example_company.com/groups/example_company-com/-/epics/294)
       1. CRO KR: Deliver at least one new PIO in every region through Partner Portal.
           1. **VP, Global Channels: Deliver at least one new PIO in every region.**
               1. VP, Global Channels KR: Deliver at least one new PIO in every region. => [DONE](https://example_company.com/example_company-com/channels/-/issues/24)
           1. **VP Alliances: use strong Alliance partners to help scale Channel**
                ...
                1. VP Alliances KR: Announced Example Company practices with 3 of the top SI's, recruited from our top Alliance partners.
1. CEO KR: Maintain quota capacity at least 5% ahead of plan for FY21. Exceed Q1 [NQR](/handbook/sales/commissions/#quotas-overview) hiring by at least 5% quota coverage.
    1. **CRO: Exceed hiring plan for NQR hires for Q1** [example_company-org&412](https://example_company.com/example_company-com/people-group/talent-acquisition/-/issues/412)
    ...
    1. **CRO: At or above plan for OQR hires for Q1** [example_company-org&413](https://example_company.com/example_company-com/people-group/talent-acquisition/-/issues/413)
        1. CRO KR: develop agreed upon quarterly targets and developed reporting on QTD performance.=> 50% completed. Quarterly targets completed with finalizing hiring plan. Develop reporting on QTD performance still in progress.
        1. CRO KR: establish SLA's for Hiring Teams around interview and feedback turnaround. Assign DRI's for vacant leadership roles to ensure minimal pause of hiring to plan.=> Done
    1. **CRO: Implement Phase 2 of the 5C Sales talent Model to allow for raising the bar with hiring talent for NQR and OQR roles.**
        1. CRO KR: Initiate phase 2 of the 5C Sales Talent Model and expand to all NQR and OQR roles.=> 20% full revamp and iterations taking place to align with [Sales Enablement Field Competencies](https://example_company.com/example_company-com/people-group/talent-acquisition/-/issues/414).
...
1. CEO KR: Renewal process satisfaction, as measured by [SSAT](/handbook/company/kpis/#satisfaction) for tickets about renewals, is greater than 95%.
    1. **Director of Product, Growth: Improve the customer experience with billing related workflows.** [example_company-com&263](https://example_company.com/groups/example_company-com/-/epics/263)
        1. Director of Product, Growth KR: Make material improvements to direct signup, trial, seat true-up, upgrade, and renewal workflows, both for .com and self-managed customers. [example_company-com/Product#725](https://example_company.com/example_company-com/Product/issues/725)
        1. Director of Product, Growth KR: Drive [Support Satisfaction](/handbook/support/performance-indicators/#support-satisfaction-ssat) scores, filtered for billing, to >95%. [example_company-com/Product#726](https://example_company.com/example_company-com/Product/issues/726)
        1. Director of Product, Growth KR: Drive [$561k in incremental IACV](https://example_company.com/example_company-org/growth/product/issues/805). [example_company-com/Product#727](https://example_company.com/example_company-com/Product/issues/727)
    1. **Chief Product Officer: Complete pricing analysis and, if required, roll out related updates to Example Company's pricing and packaging.** [example_company-com&264](https://example_company.com/groups/example_company-com/-/epics/264)
        1. Chief Product Officer KR: Complete pricing analysis project and, if required, implement at least the first phase of any recommended changes. [example_company-com/Product#728](https://example_company.com/example_company-com/Product/issues/728)
    1. **Chief Technology Officer: [Enterprise-grade dot com](https://example_company.com/example_company-com/www-example_company-com/issues/6375).**
    ...
    1. **Sr Director of Development: [Support incremental IACV](https://example_company.com/example_company-com/www-example_company-com/issues/6237).**
        1. Sr Director of Development KR: Deliver the top 10 customer requested features as prioritized by Product Management
        1. **Director of Engineering, Dev:** [Support incremental IACV](https://example_company.com/example_company-com/www-example_company-com/issues/6243)
        ...
        1. **Director of Engineering, Enablement:** [Continue efforts to build enterprise-grade SaaS](https://example_company.com/example_company-com/www-example_company-com/issues/6205)
            1. Director of Engineering, Enablement KR: Complete dogfooding Geo on Example Company.com staging environment [example_company-org&575](https://example_company.com/groups/example_company-org/-/epics/575)
            1. Director of Engineering, Enablement KR: Enable ElasticSearch for paid groups on Example Company.com [example_company-org&1736](https://example_company.com/groups/example_company-org/-/epics/1736)
            1. Director of Engineering, Enablement KR: Scope and start MVC of database partitioning, related epic [example_company-org&2023](https://example_company.com/groups/example_company-org/-/epics/2023), completion of MVC may extend into Q2 due to dependency of PostgreSQL 11 upgrade.\
            1. **Distinguished Engineer**: [Continue efforts to improve application performance and scaling](https://example_company.com/example_company-com/www-example_company-com/issues/6636)
                1. Distinguished Engineer KR: Create and merge 3 additions to [Definition of Done](https://example_company.com/example_company-com/www-example_company-com/issues/6489) => [33%](https://example_company.com/example_company-com/www-example_company-com/-/issues/6636#note_332930707)
                1. Distinguished Engineer KR: Finish and upstream [Puma development changes](https://example_company.com/groups/example_company-org/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Multithreaded%20App%20Server) => [100%](https://example_company.com/example_company-com/www-example_company-com/-/issues/6636#note_332927548)
                1. Distinguished Engineer KR: Review 50 merge requests with an eye on performance, reliability, and availability => [100%](https://example_company.com/example_company-com/www-example_company-com/-/issues/6636#note_332934690)
        1. **Director of Engineering, Defend:** [3 new Defend features go from planned to minimal](https://example_company.com/example_company-com/www-example_company-com/issues/6192)
        ...
        1. **Director of Engineering, Growth:** [Deliver Improved product usage data](https://example_company.com/example_company-com/www-example_company-com/issues/6240)
            1. Director of Engineering, Growth KR: Implement Telemetry Strategy
            1. Director of Engineering, Growth KR: Support repeatable experiments across example_company.com and the CustomersDot
            1. Director of Engineering, Growth KR: Track all planning priority issues and make sure they are being completed on time
        1. **Engineering Fellow**: [Continue efforts to build enterprise-grade SaaS](https://example_company.com/example_company-com/www-example_company-com/issues/6577)
    ...
    1. **Director of Quality: [Ensure enterprise grade readiness by improving test coverage, reference architectures and test stability](https://example_company.com/example_company-com/www-example_company-com/issues/6330).** => 81%
        ...
        1. **Enablement QE:** [Produce AWS equivalent reference architectures and increase performance test coverage](https://example_company.com/example_company-com/www-example_company-com/issues/6289) => 100%
        ...
        1. **Dev QE:** [Create a reliable end-to-end test suite to guard every deploy in the release process](https://example_company.com/example_company-com/www-example_company-com/issues/6331) => 91%
    ...
    1. **Director of Customer Support: [Develop, educate and rollout ticket deflection approach](https://example_company.com/example_company-com/www-example_company-com/issues/6227).**
        ...
        1. Director of Customer Support KR: Training developed and delivered to all Support and available to relevant teams in Example Company.
    ...
    1. **VP of Security: [Gearing ratio for H1 bounties](https://example_company.com/example_company-com/www-example_company-com/issues/5903).**
    ...
    1. **Interim VP of Infrastructure: [Enterprise-grade dot com](https://example_company.com/example_company-com/www-example_company-com/issues/6219).**
        ...
        1. **CMO:** Increase inbound marketing efficiency to grow inbound IACV pipeline to plan
            ...
            1. **Director of Brand and Digital Design:** Increase digital funnel conversions:
                1. Director of Brand and Digital Design KR: Increase a [Value-driver content landing page](https://about.example_company.com/blog/2019/03/27/application-modernization-best-practices/)  organic landing page conversion rate by 33%
                1. Director of Brand and Digital Design KR: Increase a [Value-driver content landing page](https://about.example_company.com/blog/2019/03/27/application-modernization-best-practices/)  paid landing page conversion rate by 60%
                1. Director of Brand and Digital Design KR: Increase [Self-managed free trial landing page](https://about.example_company.com/free-trial/)  conversion rate by 20%.
                1. Director of Brand and Digital Design KR: Increase [Demo landing page](https://about.example_company.com/demo/)  conversion rate by 50%.
                1. Director of Brand and Digital Design KR: Increase a [Webcast landing page](https://about.example_company.com/webcast/cicd-in-your-organization/)  conversion rate by 40%.
            ...
            1. **Senior Director of Revenue Marketing Revenue Marketing:** Deploy Drift across entire SDR org
                ...
                1. Senior Director of Revenue Marketing KR: 100% of relevant lead-generating pages enabled with chat on about.example_company.com
...
1. **CFO: Build a scalable data infrastructure that ensures completeness of data, quality and ability for anyone in the organization to access data and perform analysis.**
    1. VP, IT KR: Enable Data pipeline monitoring using Prometheus for proactive notification to all stakeholders. [example_company-data epic #60](https://example_company.com/groups/example_company-data/-/epics/60)
...
1. **CFO: Create an IT organization that prepares the company for growth over next 18 months.**
    1. VP, IT KR: Complete Okta integrations for Slack, Google Workspace, Zoom, and Example Company.
    1. VP, IT KR: Complete endpoint tracking and management of new US Macbooks and define a target for existing hardware.
    1. VP, IT KR: Adopt a formalized change management process that satisfies all Example Company security controls for prioritized Enterprise tools.
...
1. CEO KR: [SMAU](https://internal.example_company.com/handbook/company/performance-indicators/product/) is being measured and reported in 100% of Sales and Product [Key Reviews](/handbook/company/key-review/).
    1. **Director of Product, Growth:  Ensure accurate data collection and reporting of AMAU and SMAU metrics.** [example_company-com&265](https://example_company.com/groups/example_company-com/-/epics/265)
        1. Director of Product, Growth KR: Deliver AMAU and SMAU tracking with less than 2% uncertainty. [example_company-com/Product#729](https://example_company.com/example_company-com/Product/issues/729)
1. CEO KR: [SPU](https://internal.example_company.com/handbook/company/performance-indicators/product/) increases by 0.25 stages from EOQ4 to EOQ1.
    1. **CRO: Increase stage usage for 10 of top 50 accounts with only 1-2 stages in use as measured by [Stages per User](https://internal.example_company.com/handbook/company/performance-indicators/product/) <= 2.** [example_company-com&254](https://example_company.com/groups/example_company-com/-/epics/254)
        1. CRO KR: Targeted account based plan to offer services and support to utilize a new stage at each of the 50 targeted accounts. => Transitioned priority to support Efficiency improvement project [Executive Sponsor Program](https://example_company.com/example_company-com/sales-team/field-operations/sales-operations/-/issues/715)
        1. CRO KR: 10 accounts add at least one stage with SMAU moving from <5% to >25% in a specific stage.
            ...
            1. **Sr Director of Sales Operations: Collect and analyze customer stage usage data.**
                1. Sr Director of Sales Operations KR: Identify key technologies used by stage via 3rd party tool or Sales Rep discovery for 50%+ of customers ==> [DONE](https://example_company.com/example_company-com/sales-team/field-operations/sales-operations/issues/684)
    1. **VP of Customer Success (CS): Develop our customer journey to improve customer experience and establish repeatable processes, providing leading indicators of customer health, improving predictability, and supporting IACV growth.**
       1. **CS: Refine SA Strategic Account Planning Process to align to Example Company customer journey [example_company-com/Customer-Success#18](https://example_company.com/example_company-com/customer-success/okrs/issues/18).** [DONE - MM Segment] [Carried forward at 50% for [Enterprise](https://example_company.com/example_company-com/customer-success/okrs/-/issues/38) and [Public Sector](https://example_company.com/example_company-com/customer-success/okrs/-/issues/39) segments]
          1. CS KR: Enablement for SA Team on key activities with record keeping in SFDC as [SSOT](https://example_company.com/groups/example_company-com/-/epics/274)
          1. CS KR: Standardize and document two key playbooks in handbook
       1. **CS: Begin deploying CSM tool. [example_company-com/&273](https://example_company.com/groups/example_company-com/-/epics/273).**
       ...
       1. **CS: Establish a quantitative feedback loop between the GTM Team and Product Team [example_company-com/Customer-Success#23](https://example_company.com/example_company-com/customer-success/okrs/issues/23).**
       ...
       1. **CS: Prepare for Example Company Customer Success internal Certification Program. [example_company-com/Customer-Success#3](https://example_company.com/example_company-com/sales-team/customer-success/issues/3).**
       ...
       1. **CS: Improve and enable Customer Success on the different engagement approaches to support our Enterprise and Commercial customers [example_company-com/Customer-Success#21](https://example_company.com/example_company-com/customer-success/okrs/issues/21).**
          1. CS KR: Create a playbook and provide training to help customers move from SCM to CI => 100%
          1. CS KR: Create a playbook and provide training to help customers augment their security with Example Company. => 100%
       ...
       1. **CS: Improve Commercial customer onboarding and transition to post-sales [example_company-com/Customer-Success#26](https://example_company.com/example_company-com/customer-success/okrs/issues/26).**
    ...
    1. **VP of Customer Success (CS): Improve repeatability and delivery quality of professional services, delivering improved services-enabled onboarding and Professional Services revenue predictability. Expand service offerings to accelerate Example Company adoption.**
        1. **CS: Improve service delivery quality through a repeatable methodology [example_company-com/Customer-Success#34](https://example_company.com/example_company-com/customer-success/okrs/issues/34).**
        ...
        1. **CS: Develop strategy for current product consultancy and future expert services offerings [example_company-com/Customer-Success#27](https://example_company.com/example_company-com/customer-success/okrs/issues/27).**
        ...
        1. **CS: Establish Salesforce as the single source of truth for Customer Success. [example_company-com/&274](https://example_company.com/groups/example_company-com/-/epics/274).**
        ...
        1. **CS: Add Value Prop for both Services Engagements and Services Lef Education to Example Company Value Framework [example_company-com/Customer-Success#28](https://example_company.com/example_company-com/customer-success/okrs/issues/28).**
        ...
        1. **CS: Soft launch Example Company certification [example_company-com/Customer-Success#29](https://example_company.com/example_company-com/customer-success/okrs/issues/29).**
        ...
        1. **CS: Develop services partner onboarding program to accelerate ability to deliver Product Consultancy services [example_company-com/Customer-Success#30](https://example_company.com/example_company-com/customer-success/okrs/issues/30).**
        ...
        1. **CS: Develop Commercial focused CI Enablement digital campaign to help customers reduce learning curve and adopt CI in 30 days [example_company-com/Customer-Success#25](https://example_company.com/example_company-com/customer-success/okrs/issues/25).**
           ...
           1. CS KR: Send a survey at end of the campaign to capture customer feedback, satisfaction with the material, and adoption of relevant product categories => [BLOCKED](https://example_company.com/example_company-com/customer-success/okrs/-/issues/25#note_330516295)
        1. **CS: Provide adoption support for our Commercial/Enterprise customers, leveraging digital assets [example_company-com/Customer-Success#24](https://example_company.com/example_company-com/customer-success/okrs/issues/24).**
           1. CS KR: Deliver Example Company CI and Example Company 101 webinar series for Commercial Customers => DONE
...
1. CEO KR: [MAU](https://internal.example_company.com/handbook/company/performance-indicators/product/) increases 5% from EOQ4 to EOQ1.
1. **Chief Product Officer: Proactively validate problems and solutions with customers.** [example_company-com&266](https://example_company.com/groups/example_company-com/-/epics/266)
    1. Chief Product Officer KR: At least 2 validation cycles completed per Product Manager. [example_company-com/Product#730](https://example_company.com/example_company-com/Product/issues/730)
1. **Chief Product Officer: Create [walk-throughs](/handbook/product/product-processes/#communication#recording-videos-to-showcase-features) of the top competitor in each stage to compare against our own demos completed in Q4 or Q1.** [example_company-com&267](https://example_company.com/groups/example_company-com/-/epics/267)
    1. Chief Product Officer KR: Deliver one recorded walk-through for each stage. [example_company-com/Product#731](https://example_company.com/example_company-com/Product/issues/731)
1. **Principal Product Manager, Product Operations: Roll out [Net Promoter Score (NPS)](https://internal.example_company.com/handbook/company/performance-indicators/product/) tracking.** [example_company-com&268](https://example_company.com/groups/example_company-com/-/epics/268)
    1. Principal Product Manager, Product Operations KR: Survey at least 25% of Example Company's paid customer base, with a reponse rate of >4%. [example_company-com/Product#732](https://example_company.com/example_company-com/Product/issues/732)
1. **Director, Product, Ops:  Work with Example Company's infrastructure team to dogfood our APM metrics.** [example_company-com&269](https://example_company.com/groups/example_company-com/-/epics/269)
    1. Director, Product, Ops KR:  Ensure APM metric dogfooding is properly prioritized. [example_company-com/Product#733](https://example_company.com/example_company-com/Product/issues/733)
1. **[VP of Product Strategy: Get strategic thinking into the org](https://example_company.com/groups/example_company-com/-/epics/287).**
    1. VP of Product Strategy KR: 5 [group strategy review](https://example_company.com/example_company-com/Product/issues/842).
1. **[Director of Corp Dev: Get acquisitions into shape; build a well-oiled machine](https://example_company.com/groups/example_company-com/-/epics/289).**
    1. Director of Corp Dev KR: [Create system for ongoing monitoring of at least 1000 potential acquisition targets](https://example_company.com/example_company-com/Product/issues/754)
    1. Director of Corp Dev KR: [Intro calls with 20 prioritized acquisition targets](https://example_company.com/example_company-com/Product/issues/755).
    1. Director of Corp Dev KR: [Prepare pipeline of and evaluate prioritized strategic opportunities with feedback from each Product Director](https://example_company.com/example_company-com/Product/issues/756).
1. **Chief Technology Officer: [Efficiently build our product vision](https://example_company.com/example_company-com/www-example_company-com/issues/6376).**
    ...
    1. **Director of UX: [Increase the value of category maturity ratings by validating them with users](https://example_company.com/example_company-com/www-example_company-com/issues/6201).**
    ...
    1. **Director of UX: [Empower Product Managers and Designers to independently conduct UX Scorecard validation](https://example_company.com/example_company-com/www-example_company-com/issues/6203).**
    ...
    1. **Sr Director of Development: [Deliver on our product vision by being more iterative](https://example_company.com/example_company-com/www-example_company-com/issues/6230).**
        ...
        1. **Director of Engineering, Dev:** [Improve section productivity](https://example_company.com/example_company-com/www-example_company-com/issues/6241)
        ...
        1. **Director of Engineering, Defend:** [Accelerate defend productivity](https://example_company.com/example_company-com/www-example_company-com/issues/6193)
        ...
        1. **Director of Engineering, Secure:** [Increase Productivity](https://example_company.com/example_company-com/www-example_company-com/issues/6198)
            1. Director of Engineering, Secure KR: Increase rolling 6 month average by >=10%
        1. **Director of Engineering, CI/CD:** [Improve monthly MR Rate](https://example_company.com/example_company-com/www-example_company-com/issues/6234)
        ...
        1. **Director of Engineering, Ops:** [Dogfood Monitoring](https://example_company.com/example_company-com/www-example_company-com/issues/6207)
        ...
        1. **Director of Engineering, Ops:** [Increase Section MR Rate](https://example_company.com/example_company-com/www-example_company-com/issues/6208)
            1. Director of Engineering, Ops KR: Section MR Rate increases 20% month over month through April.
        1. **Director of Engineering, Enablement:** [Improve monthly MR Rate](https://example_company.com/example_company-com/www-example_company-com/issues/6204)
        ...
        1. **Director of Engineering, Growth:** [Improve section productivity](https://example_company.com/example_company-com/www-example_company-com/issues/6239)
    ...
    1. **Director of Quality: [Improve engineering efficiency and productivity by maturing pipeline performance and department metrics](https://example_company.com/example_company-com/www-example_company-com/issues/6328).** => 80%
       ...
       1. Director of Quality KR: Create performance indicator to measure test planning across all product stages, capture [Quad Planning](https://example_company.com/example_company-com/www-example_company-com/issues/6318) effort in 12 stages.
       1. **Engineering Productivity: [Increase efficiency and productivity by increasing the performance and stability of our CI pipeline](https://example_company.com/example_company-com/www-example_company-com/issues/6326).** => 77%
    ...
    1. **VP of Security: [Improve Example Company Security resilience and availability by creating independent Example Company Security environments](https://example_company.com/example_company-com/www-example_company-com/issues/6217).**
        1. VP of Security KR: Migrate all existing Example Company Security tooling and infrastructure to the new environments.
        1. VP of Security KR: Full adoption of a dedicated Example Company instance for tracking of security issues within the new environments.
    1. **Interim VP of Infrastructure: [Dogfood ops stage features](https://example_company.com/example_company-com/www-example_company-com/issues/6377).**
        1. Interim VP of Infrastructure KR: Dogfood Example Company.com uptime as part of the product (i.e., ops.example_company.net/uptime/)
        1. Interim VP of Infrastructure KR: Monitor our monitoring: SLOs and SLAs.
1. **CMO: Expand Example Company brand awareness.**
    1. CMO KR: Identify 1 new brand activation platform opportunity to broaden Example Company brand reach
1. **Director of Brand and Digital Design:  Next-generation Example Company brand strategy, identity and guidelines.**
...
1. **Director of Developer Relations: Improve scalability and capacity of the Evangelist Programs.**
    1. Director of Developer Relations KR: Launch streamlined swag ordering and delivery via Printfection for meetup organizers and Example Company Heroes
    1. Director of Developer Relations KR: Create new applications and workflows for Example Company Meetups and Example Company Heroes that allow us to capture all necessary information in the application, automate email responses, and reduce response times.
    1. Director of Developer Relations KR: Create email mailing lists for both Meetups program participants and Example Company Heroes to allow for more efficient communication and better tracking.
...
1. **Director of Developer Relations: Scale Community Advocates team.**
    1. Director of Developer Relations KR: Plan for 24/7 coverage on Example Company mentions.
    ...
    1. Director of Developer Relations KR: A set of Live Learning sessions scheduled to raise awareness on involving experts to address wider community mentions and train Example Company members to interact with our community as domain knowledge experts.
...
1. **Sr. Director of Product Marketing: Pilot Learn@example_company web experience for finding & featuring how-to technical content.**
...
1. CEO KR: There are 200 certifications completed by [middle managers](/handbook/company/structure/#middle-management) at Example Company.
1. **Director of People Operations: [Support an environment where all team members feel they belong, are valued, and can contribute; understand the key drivers for team member engagement and continuously improve.](https://example_company.com/groups/example_company-com/people-group/-/epics/10)**
    1. Director of People Operations KR: Roll out [first iteration of Manager Toolkit](https://example_company.com/example_company-com/people-group/people-group-senior-leader-priorities/issues/2)
...
1. **Director of People Operations: [Team members understand the value of their compensation, benefits, and perks.](https://example_company.com/groups/example_company-com/people-group/-/epics/11)**
...
1. **Director of People Operations: [Improve onboarding to ensure optimal levels of new team member experience and productivity.](https://example_company.com/groups/example_company-com/people-group/-/epics/12)**
    ...
    1. Director of People Operations KR: Revamp [buddy program](https://example_company.com/example_company-com/people-group/General/issues/588#note_277801283)
    1. Director of People Operations KR: 100% of People Ops team trained to effectively handle team member questions
1. **Director of People Operations: [All People Ops requirements for external audit are met.](https://example_company.com/groups/example_company-com/people-group/-/epics/23)**
    1. Director of People Operations KR: All Example Company team-members have acceptanced the Code of Conduct within the last 12 months
    1. Director of People Operations KR: All Example Company team-members have completed a Security Awareness Training within the last 12 months
    1. VP of Recruiting KR: All Example Company team-members hired in FY21 Q1 have a completed background check on file
1. **VP of Recruiting: [Continue to drive towards the target](https://example_company.com/groups/example_company-com/people-group/-/epics/13) of [Candidates Sourced by Recruiting Department vs. Candidates Hired](/#candidates-sourced-by-talent-acquisition-department-vs-candidates-hired) with focus on [diversity](/handbook/company/culture/inclusion/), location factor and speed.**
...
1. **VP of Recruiting: [Deliver on the ambitious hiring plan, in partnership with leaders, while ensuring a unique and exceptional candidate experience for candidate pools that are diverse and representative of our communities.](https://example_company.com/groups/example_company-com/people-group/-/epics/14)**
...
1. **Chief Technology Officer:** [Lower average location factor and enable entry-level hiring](https://example_company.com/example_company-com/www-example_company-com/issues/6374)
    ...
    1. **Director of UX:** [Provide clear career paths for everyone in UX](https://example_company.com/example_company-com/www-example_company-com/issues/6081)
    ...
    1. **Sr Director of Development:** [Build a world class software team](https://example_company.com/example_company-com/www-example_company-com/issues/6231)
        ...
        1. **Director of Engineering, Dev:** [Hire and Scale section to target](https://example_company.com/example_company-com/www-example_company-com/issues/6242)
        ...
        1. **Director of Engineering, Secure:** [Hiring to Target](https://example_company.com/example_company-com/www-example_company-com/issues/6197)
        1. **Director of Engineering, Defend:** [Hiring to Target](https://example_company.com/example_company-com/www-example_company-com/issues/6191)
            1. Director of Engineering, Defend KR: Fill remaining open positions for defend team (7 new hires)
        1. **Director of Engineering, CI/CD:** [Accomplish Q1 hiring goals](https://example_company.com/example_company-com/www-example_company-com/issues/6235)
        1. **Director of Engineering, Ops:** [Accomplish Q1 hiring goals](https://example_company.com/example_company-com/www-example_company-com/issues/6206)
        1. **Director of Engineering, Enablement:** [Accomplish Q1 hiring goals](https://example_company.com/example_company-com/www-example_company-com/issues/6202)
        ...
        1. **Director of Engineering, Growth:** [Accomplish Q1 hiring goals](https://example_company.com/example_company-com/www-example_company-com/issues/6238)
    1. **Director of Quality:** [Hire to plan and develop career matrix for ICs and Managers in the department](https://example_company.com/example_company-com/www-example_company-com/issues/6329) => 68%
    ...
    1. **Director of Customer Support:** [Incorporate new manager layer and Support Operations team into organization](https://example_company.com/example_company-com/www-example_company-com/issues/6210)
    ...
    1. **Director of Customer Support:** [Make License & Renewal workflow seamless for customers](https://example_company.com/example_company-com/www-example_company-com/issues/6209)
    ...
    1. **VP of Security:** [Implement new structure, introduce new director management layer](https://example_company.com/example_company-com/www-example_company-com/issues/6216)
    ...
    1. **Interim VP of Infrastructure:** [Add layer of management due to headcount and ship stable counterparts to Engineering](https://example_company.com/example_company-com/www-example_company-com/issues/6378)
...
1. **VP of Customer Success: Develop new approaches to remote working to improve collaboration, employee satisfaction and/or health and wellness of the team.** => [DONE 100%](https://example_company.com/example_company-com/team-member-epics/employment/-/issues/1908)
...
1. **CMO: Build Example Company's All-Remote and Diversity, Inclusion & Belonging  brand stories**
    ...
    1. **Senior Director of Corporate Marketing: Drive awareness about All Remote Message.**
       1. Senior Director of Corporate Marketing KR: Establish 2020 Example Company Remote Work Survey
    ...
    1. **Director of Developer Relations: Improve diversity of Heroes program as defined on Example Company's Diversity, Inclusion and Belonging page.**
       ...
       1. Director of Developer Relations KR: Accept 5 new Example Company Heroes who are gender minorities and 5 new Example Company Heroes from other underrepresented groups
...
1. **CLO: Create plan for materials to be delivered for enablement and training to ensure Example Company Employees understand legal and compliance requirements related to their role (i.e., FCPA, Reg FD, GDPR, CCPA, etc.). Update and create policies where needed with an eye toward PCR.**
    ...
    1. CLO KR: Develop clear guidelines for the global Example Company workforce as needed to participate in trainings and system for tracking training completion
