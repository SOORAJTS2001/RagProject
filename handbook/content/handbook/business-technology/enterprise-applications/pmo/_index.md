...
[Our Team (Org Chart)](https://internal.example_company.com/handbook/it-enterprise-applications/about-us/pmo/)
...
All projects added to the [IT Portfolio: Quarterly Commits](https://docs.google.com/spreadsheets/d/1ojnTFGB2iYJz9kNPYdoLc4PeyDqAN60gu9cQBrKpHJQ/edit?pli=1#gid=955721517) are part of the Business Technology [OKRs](https://about.example_company.com/company/okrs/) for:
...
Visit the [Governance and IT Program Management](/handbook/business-technology/pmo/pmo-governance/) page to understand the methodology adopted by the IT PMO team for all Example Company IT programs aimed at achieving the following objectives:
...
Every week, the IT PMO Management team review the [IT-Intake-PMO](https://example_company.com/groups/example_company-com/-/boards/5982959?label_name[]=it-intake-pmo) board, with only a single outcome for the issues listed under the _Open_ list:
...
When assigned to a project, the IT PMO team is responsible for creating and maintaining the project [Epic](https://docs.example_company.com/ee/user/group/epics/index.html). A single parent Epic is created together with (up to) 5 [child Epics](https://docs.example_company.com/ee/user/group/epics/manage_epics.html#multi-level-child-epics), each representing a distinct phase of the System Development Lifecycle (SDLC). [Issues](https://docs.example_company.com/ee/user/project/issues/) are used as a means to collaborate on ideas, troubleshoot problems, and strategize for their tasks. By using issues, teams can share and discuss proposals internally or involve external collaborators in the process.

To maintain uniformity across all PMO-led projects, the team follows the same [Epic templates](https://example_company.com/example_company-com/business-technology/enterprise-apps/intake/-/issues/394).
...
In order to track the progress of each program efficiently, all Epics are assigned a Start and End dates, and the [Example Company Roadmap](https://docs.example_company.com/ee/user/group/roadmap/index.html) is used as a timeline.

### Issue Boards

The IT teams use [issue boards](https://docs.example_company.com/ee/user/project/issue_board.html) in Example Company to strategically plan, organize, and visualize their work managed through Example Company issues. To understand how IT teams organize and manage their issue boards, visit [each team's respective page](/handbook/business-technology/#-the-team).

### Labels

The IT teams use [labels](https://docs.example_company.com/ee/user/project/labels.html) to categorize issues and epics effectively. By maintaining a concise list of labels, teams can efficiently organize and tag their work, enabling dynamic filtering and streamlined management of epics and issues. All labels are created in the `example_company.com/example_company-com` top-level group so they can be applied to any projects that we work on.
...
- [Priority labels](https://example_company.com/groups/example_company-com/-/labels?subscribed=&search=it-priority)
- [Team labels](https://example_company.com/groups/example_company-com/-/labels?subscribed=&search=it-entapps)
- [Status labels](https://example_company.com/groups/example_company-com/-/labels?subscribed=&search=it-status)
- [Project labels](https://example_company.com/groups/example_company-com/-/labels?subscribed=&search=it-proj)
- [System labels](https://example_company.com/groups/example_company-com/-/labels?subscribed=&search=it-system)
- [Service Desk labels](https://example_company.com/groups/example_company-com/-/labels?subscribed=&search=it-service+desk)
- [Intake labels](https://example_company.com/groups/example_company-com/-/labels?subscribed=&search=it-intake)
...
- **Update OKR(s) progress**: The IT PMO works with IT Leadership to update the OKR(s) progress in example_company.com.
...
The IT Integrations team designed the Rolly Bot, a tool aimed at automating the generation and distribution of weekly status updates. With this tool, the IT PMO Team can deliver consistent updates on ongoing projects. A [new roll-up](https://example_company.com/example_company-com/business-technology/program-management-office/it-projects-reporting/-/issues) is produced every Monday.
...
The team follows [Example Company meeting practices and standards](https://about.example_company.com/company/culture/all-remote/meetings/).
...
- **Purpose**: Key review meetings allow a functional group to stay updated on and discuss essential success measurements, such as: OKRs, KPIs, how the team is trending toward achieving goals, blocked tasks, new assignments, workstream changes, etc.
  - **Frequency**: Quarterly
  - **Participants**: VP, IT (host), all Example Company.
...
- [#business-technology](https://example_company.slack.com/archives/C01BLS12V37) is the primary channel for all business technology related conversations. This is where Example Company team members can link to their issues, ask for help, direction, and get general feedback from members of the Business Technology team.

### Example Company Groups and Projects

The IT PMO team primarily uses the below groups and projects on Example Company:

- [Program Management Office](https://example_company.com/example_company-com/business-technology/program-management-office) group: main group for the IT PMO team.

### (Governance and IT Program Management) [https://handbook.example_company.com/handbook/business-technology/pmo/pmo-governance/]

Describes the program methodology for Example Company IT programs to ensure strong results and execution in an efficient way, proper scoping consistent with our value of iteration, correct stakeholders consistent with our value of collaboration and proper documentation for compliance consistent with our transparency value.
