...
- [Payroll (US & Non-US)](https://internal.example_company.com/handbook/finance/payroll/)
...
1. Log in to HelpLab via Okta. If you have a ServiceNow Fulfiller license, to open requests for other teams you will need to go to the [main dashboard](https://helplab.example_company.systems/esc?id=ec_pro_dashboard), as by default you will see your team's requests only.
