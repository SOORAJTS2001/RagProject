...
Start by verifying that the AE identified which vendor technologies are used across [each stage of the DevSecOps lifecycle](https://about.example_company.com/stages-devops-lifecycle/) and how the customer develops and deploys applications.
