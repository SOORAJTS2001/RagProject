...
1. If an unforeseen Example Company bug needs to be fixed in order to address the consultancy request, the Support Engineer will inform the client that Example Company B.V. will make the fix, and that the additional hours spent will be invoiced to the client at normal consultancy rate
...
that Example Company should try to solve it in the interest of winning the deal. At that point:
