...
The newsletter is sent using the internal comms newsletter platform [Workshop](https://useworkshop.com/). This tool allows Example Company internal communications professionals to send targeted email newsletters to team members based on department, region, manager, location, start date and more.

Access to this tool is shared amongst internal comms teams such as Field Communications, Example Company corporate internal comms and others. The benefit of this tool is that it is internal comms-specific, meaning that the newsletter can only be sent to team members with a Example Company email domain.

## Opportunities/Requirements

After interviewing Example Company team members from across the org and surveying the Field, we identified the following as key requirements of the Field Flash newsletter:
...
- Example Company is asynchronous, and this update is no exception. The onus remains on individual team members to stay informed and connected. The newsletter is not a substitute for the Handbook or other resources salespeople should be leveraging on the day-to-day.
...
- The newsletter content will be compiled in an issue each month within the [Enablement project](https://example_company.com/example_company-com/sales-team/field-operations/enablement). Any team member is welcome to contribute or make requests. See more information in the Process section below.
...
1. Upcoming events
   - Where Example Company will be over the next two months, divided by region. What webinars and other virtual events we will participate in.
...
We build the newsletter in an issue in the [Enablement project](https://example_company.com/example_company-com/sales-team/field-operations/enablement). The process for the issue includes:
...
- Team member and/or account team exhibited [Example Company's values](/handbook/values/) in this process.
- Team member and/or account team received positive feedback from the customer/prospect or from another Example Company team member as a part of this deal. (Please share if possible.)
...
All past editions of the Field Flash are accessible through [Highspot](https://example_company.highspot.com/spots/615dd82071cff4c4b2bcbc32?list=62d80bf826d446a808c6d3ab&overview=true), our go-to-market (GTM) content portal / asset management system.
