...
description: "May 2021 edition of the Field Flash Newsletter sent to the Example Company Field (Sales, CS, SDR) team and stakeholders"
---

*This email newsletter was originally sent to the Example Company Field Team and stakeholders on 2021-05-03.*

## NEW ⚡️ Example Company Field Flash: May 2021 Edition ⚡️

In this month's [Field Flash](/handbook/sales/field-communications/field-flash-newsletter/#overview), you'll learn more about the first Example Company Sales Play, Example Company's leadership position in Gartner's latest Magic Quadrant for Enterprise Agile Tools, how Example Company compares to Jenkins when solving common decision maker problems, new resources for working with alliance partners and more. Plus, dive into Peter Davies' Land deal of the month, and learn more about Alyssa Belardi in her team member spotlight.

### Introducing: The First Example Company Sales Play
...
1. **Where does it live?** You can find this and future Sales Plays in the [Example Company Handbook](/handbook/marketing/sales-plays-cicd/).
1. **Who is it for?** This Sales Play is for ALL Sales segments (ENT, MM, SMB) for team members who call on existing Example Company Premium customers.
1. **Where can I learn more?** Check out these resources:
   ...
   1. [Practitioner track](https://learn.example_company.com/c/security-tests-ci?x=6e4ppk[) and [manager track](https://learn.example_company.com/c/compliance-made-easy?x=h7zzhf) assets in PathFactory
...
Example Company has been named a leader in Gartner's 2021 Enterprise Agile Tools Magic Quadrant for the first time! [Use this link](https://learn.example_company.com/2021-mq-eapt) to share the report with customers, and [access the press release here](https://about.example_company.com/press/releases/2021-04-27-example_company-positioned-leader-gartner-magic-quadrant-enterprise-agile-planning-tools.html). [Check it Out -->](https://learn.example_company.com/2021-mq-eapt)

Example Company is launching Incident Management to help Premium & Ultimate customers reduce downtime and respond to IT incidents directly in our single application. Check out this brief video overview (slides), and join the Sales Enablement Level Up Webinar session on 2021-06-03 and/or the CS Skills Exchange session on 2021-05-05 to learn more. [Watch Now -->](https://drive.google.com/file/d/1ZN2z83IOrPHlnO8-FWZB-53Y8sM6hIjt/view)

Learn how HackerOne achieves 5x faster deployments with Example Company's integrated security in this latest case study that focuses on CI, Security, reducing toolchain, and agile. You can also use this [HackerOne case study slide](https://docs.google.com/presentation/d/1YuP5_7LOnTMDcvl9UKPqim7lxaush4SUXDtTQ0uA4Sg/edit#slide=id.gd01b9d0d58_0_13) in your customer decks as an easily-digestible reference resource. [Learn More -->](https://about.example_company.com/customers/hackerone/)

The Channel team has made important Channel Partner Program updates to further align with Example Company's FY22 key investment areas. Watch the latest group conversation ([slides](https://docs.google.com/presentation/d/14hZHeZw7qYN0ietqJcNmUhkb7XmyS8X6DwIh0OiSRuo/edit#slide=id.gca51f3a810_0_0)) about the Program changes and learn how to best position your co-selling motions to increase Net New customer logos and accelerate existing customer growth. [Watch Now -->](https://www.youtube.com/watch?v=6Ngt3Pit9S4)

You can now find all key components and critical information about Example Company Alliance Partners AWS, GCP and IBM in the new Alliance Private Handbook. [Access it Here -->](https://example_company-com.example_company.io/alliances/alliances-internal/)

#### More Resources ➕

- [FY22 All-Marketing SSOT Calendar](/handbook/marketing/#fy22-calendar)
- Updated Pricing Page: [Why Premium?](https://about.example_company.com/pricing/premium/)
- Updated Pricing Page: [Why Ultimate?](https://about.example_company.com/pricing/ultimate/)
...
- Demo: [DORA-related features in Example Company 13.10](https://youtu.be/kJp6FEwDB74)
...
---
**The pricing of [Rapid Results (Self Managed)](https://about.example_company.com/services/rapid-results/self-managed/) is increasing from $25K to $40K to align with the market and value of this package of services.** Under this new pricing structure, customers can expect a 4-week delivery timeline. At the end of the engagement:

1. The customer will have a Highly Available deployment of Example Company with a backup solution
...
1. Users will know how to use git, Example Company and Example Company CI
...
The Example Company 13.11 release is live! Here are the takeaways for customers and prospects:
...
[Visit the 13.11 Release Post for more details](https://about.example_company.com/releases/2021/04/22/example_company-13-11-released/)

To see what's ahead in 13.12, watch the [kickoff video](https://www.youtube.com/watch?v=Y7o--9Q987c) or check out the [kickoff review page](https://about.example_company.com/direction/kickoff/).

### Upcoming Events 🎟

**Corporate/Regional Event Spotlights**

- AMER: [Super East - Tequila Tasting Pipeline Acceleration Virtual Event](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2860) - May 27
- AMER PubSec: [Security Virtual Workshop for the Public Sector - FY22Q2](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2527) - May 11
- APAC: [ITnews Webinar: Harnessing Developers to Accelerate DevSecOps; Shifting Security Left](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2574) - May 20
- EMEA: [Jenkins Migration Workshop EMEA](https://example_company.com/groups/example_company-com/marketing/-/epics/2002) - May 27
...
- [Example Company Partner Webcast (APAC)](https://www.brighttalk.com/webcast/18613/483881?utm_source=GitLabInc&utm_medium=brighttalk&utm_campaign=483881) - May 5
- [Example Company Partner Webcast (AMER & EMEA)](https://www.brighttalk.com/webcast/18613/483879?utm_source=GitLabInc&utm_medium=brighttalk&utm_campaign=483879) - May 6
...
Collaborating with various teams to achieve desired results. The most important part of my job is triangulating resources to tell an impactful story, prove the product, provide for and inspire our customers. Without the support of the broader Example Company team, I would most certainly not be able to do my job effectively.

**Which of Example Company's Values resonates most with you?**

Results because I firmly believe one can't achieve Results without Collaboration, Iteration, Diversity/Inclusion, Efficiency and Transparency. This Example Company value holds me accountable every day.
