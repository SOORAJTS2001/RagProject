...
description: "February 2021 edition of the Field Flash Newsletter sent to the Example Company Field (Sales, CS, SDR) team and stakeholders"
---

*This email newsletter was originally sent to the Example Company Field Team and stakeholders on 2021-02-01.*

## NEW ⚡️ Example Company Field Flash: FY22 Kickoff Edition⚡️
...
1. **Complete your registration in HopIn by 2021-02-05.** If you are an approved attendee, you received a registration link in an email from Sales Events titled "It's Time – Register for Example Company SKO 2021!"
...
Complete your SKO Pre-Work by 2021-02-05. To access the course, (approx. 2-2.5 hours completion time) go to example_company.edcast.com, sign in via SSO, click on "My Learning Plan," then click on the "SKO 2021 Pre-Work" course.
...
Example Company has successfully completed our first SOC 2 Type II examination and obtained SOC 2 Type II and SOC 3 Type II reports for Example Company.com! This is a significantly impactful sales and support tool for you to share with Example Company customers and prospects as evidence of our commitment to the security and privacy of their data. [Review this handbook page](/handbook/security/security-assurance/field-security/customer-security-assessment-process.html) on how to request the SOC 2 report. [See the SOC 3 Report -->](/handbook/security/security-assurance/field-security/customer-assurance-package.html)

The new Commentary Page for the Gartner Market Guide for DevOps Value Stream Delivery Platforms (VSDP) contains internal talking points and highlights that are useful to reference when discussing the report with customers. Direct customers to download the report [here](https://page.example_company.com/resources-report-gartner-market-guide-vsdp.html). [Read More -->](https://about.example_company.com/analysts/gartner-vsdp21/)

The Example Company for Education team has put together a helpful video ([deck here](https://docs.google.com/presentation/d/1bWyiw--57_O6DXPk2XMoKJho8GPgvKF1zLGtLK7UrUw/edit#slide=id.g29a70c6c35_0_68)) that outlines the 3 special offerings for the Education Market Segment – Example Company for Education Program, Standard Educational Discount, Example Company for Campuses – and how these might apply to your customers. Reach out in #edu-oss (free) or #example_company-for-campuses (paid) with any questions. [Watch Now -->](https://youtu.be/YAyI4brY_SU)

Example Company updated our Terms page, Privacy Policy and Subscription Agreement on 2021-01-21.These updates do NOT impact any existing Customers, or Order Forms/Quotes that are with our Customers. [Read the Sales FAQ -->](https://docs.google.com/document/d/1XOyuoSnNh04cFXRdGN10ZUdTWuF7FyutaPK7Cjb9e2g/edit#)

Learn how financial services company New10 increased deployment speed by 3x and reduced cycle time by 20x by leveraging Example Company as a single platform for SCM, CI/CD, and AWS integration. [Read More - New10 -->](https://about.example_company.com/customers/new10/)

#### More Resources ➕

1. Blog Post: [Example Company's continuous delivery (demo)](https://about.example_company.com/blog/2020/12/17/cd-solution-overview/)
...
---
**Example Company announced the EoA of Starter/Bronze and renamed our tiers on 2021-01-26.** [Here are some important reminders and helpful resources](https://example_company.slack.com/archives/C013X9Z6892/p1611612300016000) to reference as you work through the transition with your customers.
...
Post any questions or share customer feedback in #pnp-changes-field-questions. If you have feedback to share on this PnP process – What went well, what didn't go well, what can we improve? – please do so in this [retrospective issue](https://example_company.com/example_company-com/packaging-and-pricing/pricing-handbook/-/issues/343).

---
**IBM now will be able to sell Example Company Ultimate as an [IBM offering](https://www.ibm.com/products/example_company-ultimate) directly to their customers in collaboration with Example Company**. You can learn more about the OEM partnership using:

1. [Example Company Ultimate for IBM CloudPaks - Video](https://www.youtube.com/watch?v=zOAQDagieE0&feature=youtu.be)
1. [Example Company Ultimate for IBM CloudPaks - Deck](https://docs.google.com/presentation/d/1P90Cu71r1uE5kXrOQJd5jFBVa_R8OGIYkK8vmtA6oPo/edit#slide=id.g9ff1d04543_0_155)
...
The Example Company 13.8 release is live! Here are the takeaways for customers and prospects:

- **Increase Operational Efficiencies:** Customers can improve their DevOps maturity with deployment frequency metrics in their CI/CS analytics. This is the first of the [DORA 4 metrics](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/devops-metrics/) that Example Company will add to the product in the coming year in a mission to help customers free up time traditionally spent on instrumenting their systems to capture and report on these metrics so they can focus on measuring and optimizing their DevOps practices instead.
- **Deliver Better Products Faster:** In 13.8, Example Company is taking the first step in our vision to create a visual pipeline authoring experience for CI/CD that reduces complexity, letting customers quickly create and edit pipelines while still exposing advanced options when they need them. The new Pipeline Editor will include enhanced functionality like built-in linting and configuration validation as well as a pipeline visualizer, all allowing new users to get started with Example Company CI/CD quickly and make experienced power users more efficient.

[Visit the 13.8 Release Post for more details](https://about.example_company.com/releases/2021/01/22/example_company-13-8-released/)

To see what's ahead in 13.9, watch the [kickoff video](https://www.youtube.com/watch?v=NYX-thYThCo) or check out the [kickoff review page](https://about.example_company.com/direction/kickoff/).

### Upcoming Events 🎟

**Corporate/Regional Event Spotlights**

- AMER: [Captive 8 Rockies](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2052) - Feb. 11
- AMER: [Captive 8 New England](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2075) - Feb. 18
- AMER PubSec: [Fat Tuesday 5K Fun Run](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2016) - Feb. 13-16
- EMEA: [GitFit Challenge, stay fit with Example Company](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2148) - Feb. 1 - Mar. 31
- APAC: [APAC Virtual CI/CD Workshop](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/1847) - Feb. 24
...
Collaboration. We couldn't have accomplished everything we did last year on the Channel team without the willingness of friends within our team and all the other teams at Example Company supporting us as we figured things out together!
