...
---
We are moving [group-level IP restriction](https://docs.example_company.com/ee/user/group/#ip-access-restriction) from Ultimate to Premium. This move is tentatively scheduled for the 13.1 release.
