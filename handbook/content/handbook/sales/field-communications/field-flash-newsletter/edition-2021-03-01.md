...
description: "March 2021 edition of the Field Flash Newsletter sent to the Example Company Field (Sales, CS, SDR) team and stakeholders"
---

*This email newsletter was originally sent to the Example Company Field Team and stakeholders on 2021-03-01.*

## NEW ⚡️ Example Company Field Flash: March 2021 Edition⚡️
...
### Example Company SKO 2021 – Watch it Again
...
1. **Watch it Again:** You can now relive some of the best moments from SKO! All keynote and breakout recordings are [available in Example Company Learn](https://example_company.edcast.com/channel/sales-kickoff-sko-2021).
1. **Dig Into the Slides:** You can find links to the slides for each presentation in its video description in [Example Company Learn](https://example_company.edcast.com/channel/sales-kickoff-sko-2021). (You can also find links to the videos and slides on the [SKO Handbook page](/handbook/sales/training/SKO/2021).)
...
Watch this short video from Mike Pyle (VP, Enterprise Sales) for insights into proactively countering GitHub/Microsoft – framing your customer's decision, preempting this competitive threat, and enabling your champions to advocate for Example Company. (Unable to view the video? [Click here](/handbook/marketing/marketing-operations/youtube/#unable-to-view-a-video-on-youtube).) [Watch Now -->](https://www.youtube.com/watch?v=Al8oPwyLHJA&feature=youtu.be)

Example Company Free has more features and functions than GitHub Team, and the Competitive Intelligence team has updated the Decision Kit with more details. Point your customers to this page during your conversations. Check it Out -->
...
You can quickly and easily find customer case studies by using the Case Study Board, which is updated each time we publish a new Case Study. Search by Use Case, Value Driver, Product Replaced, Integrations, and more. [Use it Today -->](https://example_company.com/example_company-com/marketing/strategic-marketing/customer-reference-content/case-study-content/-/boards/1804878)

Learn how the British Geological Survey revolutionized its software development lifecycle by removing barriers with Example Company's intuitive, single platform for improved efficiency, source code management, and CI/CD. [Read More - BGS -->](https://about.example_company.com/customers/bgs/)

We have released our first iteration of our Diversity, Inclusion and Belonging (DIB) certification and have made it available to the wider community. Also, in celebration of International Women's Day, be sure to check out the [Panel Conversations](https://example_company.com/example_company-com/people-group/dib-diversity-inclusion-and-belonging/diversity-and-inclusion/-/issues/587) on March 4 and 5 featuring some of our Field team members! [Get DIB Certified -->](https://example_company.edcast.com/journey/dib-training-certification)

IBM and Example Company are helping customers accelerate their DevOps adoption. In this video message, hear from Evaristus Mainsah, GM at IBM, on how we will grow the Example Company Ultimate for IBM Cloud Paks business together in FY22 and beyond. [Watch Now -->](https://www.youtube.com/watch?v=7XPeammuyx8&feature=youtu.be)

Learn about how the power of Example Company Auto DevOps can help increase productivity and speed up releases. [Read More -->](https://about.example_company.com/blog/2021/01/22/cd-automated-integrated/)
...
---
**As we shift to ARR, we will start forecasting in Clari accordingly**. Below are high-level details, expectations and changes you'll see in Clari. [See the full details and workback plan here](https://example_company.com/example_company-com/sales-team/field-operations/sales-operations/-/issues/1945). Reach out with questions in the #clari-users Slack channel.
...
The Example Company 13.9 release is live! Here are the takeaways for customers and prospects:
...
[Visit the 13.9 Release Post for more details](https://about.example_company.com/releases/2021/02/22/example_company-13-9-released/)

To see what's ahead in 13.10, watch the [kickoff video](https://www.youtube.com/watch?v=NYX-thYThCo) or check out the [kickoff review page](https://about.example_company.com/direction/kickoff/).

### Upcoming Events 🎟

**Corporate/Regional Event Spotlights**

- EMEA: [EMEA Example Company Connect](https://example_company.com/groups/example_company-com/marketing/-/epics/1829) - March 25
  - Example Company Connect EMEA is a virtual event that will cover all elements of a successful DevOps transformation. Attendees will get access to custom tracks depending on the role they play in the DevOps journey.
  - Share the [registration link](https://hopin.com/events/example_company-connect-emea-25th-march-2021?ref=3f207287f274) with customers!
- AMER: [GitShamRocked Whisky Tasting Virtual Event](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2185) - March 11
- AMER PubSec: [Advanced CI/CD Workshop](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2100) - March 18
- APAC: DevSecOps Virtual Roundtables - [SEA Ent](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2490), [SEA MM](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2491), [ANZ Ent](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/2492) - March 2020
...
- [Example Company Partner Webcast](https://www.brighttalk.com/webcast/18613/472331?utm_source=Example Company+Inc.&utm_medium=brighttalk&utm_campaign=472331) - APAC - March 11
- [Example Company Partner Webcast](https://www.brighttalk.com/webcast/18613/472327?utm_source=Example Company+Inc.&utm_medium=brighttalk&utm_campaign=472327) - AMER/EMEA - March 11
...
Example Company has great competitive content publicly available on our [DevOps Tools page](https://about.example_company.com/competition/) that can help you improve your posture in competitive deals.  Use it with customers and feel free to share your feedback with us in the #competition Slack channel!
