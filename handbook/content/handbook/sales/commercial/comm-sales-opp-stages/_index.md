...
*This is the initial stage once an opportunity is created. The Sales Development team will scope business need/ challenge and validate commitment from prospect/customer to have a discovery conversation with the Example Company Team.
...
- SDR schedules call, sends invites, creates an event on the account object, names the event: Example Company Introductory Meeting - {{Account Name}}. -
...
*Uncover as much intelligence about the project as you can, which will be confirmed at later stages throughout the sales cycle. Identify a business need or challenge the customer/prospect is trying to address and the potential for Example Company to solve.*
...
- Deliver the [Example Company single app pitch](/handbook/sales/commercial/#custom-deck-requirements) and gather feedback from customer on vision
- Customers' [near and long term priorities](https://example_company.edcast.com/journey/introduction-to-the-required-introduction/cards/1342269) identified
...
*Validate the pain points & determine how these pain points attach to the Customer/Prospect's top business challenges, the required capabilities to achieve the desired future state, and determine how Example Company is uniquely positioned to solve the challenge.*
...
- Review how Example Company will be implemented and by who, opening a discussion about Example Company and/or partner [professional services](/handbook/customer-success/professional-services-engineering/selling/#selling-example_company-professional-services) where appropriate
...
- [Competitive differentiation](https://internal.example_company.com/handbook/sales/command-of-the-message/#example_company-differentiators)
- Provide [proof points](/handbook/sales/command-of-the-message/proof-points/), [case studies](https://example_company.com/example_company-com/marketing/strategic-marketing/customer-reference-content/case-study-content/-/boards/1804878?scope=all&utf8=%E2%9C%93), and [competitive info](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/competitive-intelligence/#competitive-intelligence-at-example_company) (defensible differentiators)
- Create a [Example Company maturity/adoption](/handbook/product/product-principles/#multi-feature-usage-adoption-journey) roadmap with customer
...
- [Custom deck](/handbook/sales/commercial/#opportunity-specific-slide-deck) is shared with Example Company internal team members to ensure the SA that picks up the opportunity has immediate access to the custom deck
...
*Business and technical challenges and been uncovered and resolved. The goal is to meet with the customer, review & collaboratively fine-tune an ROI/justification. Prepare with the champion to meet with Economic Buyer on proposal OR enable champion to sell internally on Example Company's behalf. Prepare deck or pricing doc that will be presented to Economic Buyer.*
...
- Negotiate pricing
- Negotiate [legal terms](https://about.example_company.com/terms/#subscription/)
...
- Agreement on business terms (All proposals should include the standard [Example Company Terms](https://about.example_company.com/terms/#subscription/))
...
*An opportunity was lost and the prospect/customer has decided not to pursue the purchase of Example Company*
