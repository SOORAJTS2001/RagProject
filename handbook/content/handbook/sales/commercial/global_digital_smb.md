...
[FY25 Global Digital SMB Highspot Page](https://example_company.highspot.com/items/65c2b953cdfb65754adda353?lfrm=shp.0)
...
Inbound Request - These occur when a customer hand raises, and requests assistance from Example Company. 
...
If a Example Company team member needs to loop in the Advocate team on a customer Account, they must create a case.  (Chatter messages sent to the AMER/ APAC/ EMEA Sales Users are not monitored).
...
- If a case has not been actioned as per the stated SLA, please chatter the regions [ASM](https://example_company.my.salesforce.com/00OPL000000rpxF2AQ) on the case to escalate.
...
[FY25 - Cases created by Department X](https://example_company.my.salesforce.com/00OPL000000toc5)
...
- Note: when picking up a case created by a Example Company stakeholder e.g the Support Team, it is crucial that the Advocate updates **Next Steps** as soon as the case has been actioned.
...
Account: Example Company Admin added
...
The Advocate is advised to build relationships with these customers, understand their journey with Example Company, and identify what we can do to grow the account (Ultimate or Add On licenses) or promote adoption and churn prevention.
...
[FO Opp Case Example](https://example_company.my.salesforce.com/500PL000005qmX7)

[SDR Created Case Example](https://example_company.my.salesforce.com/500PL000005Qb2gYAC)
...
- [SMB AMER Case Queue](https://example_company.lightning.force.com/lightning/r/Report/00OPL000000LaDN2A0/view?queryScope=userFolders)
- [SMB EMEA Case Queue](https://example_company.lightning.force.com/one/one.app#/sObject/00OPL000000LaRt2AK/view)
- [SMB AMER Team Dash](https://example_company.lightning.force.com/lightning/r/Dashboard/01ZPL000000UbBp2AK/view?queryScope=userFolders)
- [SMB EMEA Team Dash](https://example_company.lightning.force.com/lightning/r/Dashboard/01ZPL000000WJU92AO/view?queryScope=userFolders)
- SMB Advocate Scorecard ([AMER](https://example_company.lightning.force.com/lightning/r/Dashboard/01ZPL0000013pi92AA/view?queryScope=userFolders)/ [EMEA](https://example_company.lightning.force.com/lightning/r/Dashboard/01ZPL000001E2PZ2A0/view?queryScope=userFolders))
...
- Q. As an Example Company Team Member who is not part of the SMB Team, how do I engage with the team?
...
- A. First check the account to see if there is an In Progress SMB Sales Case owned by a different Advocate.  If there is, add the nature of the customers request to the Description field, and chatter the Advocate on the case. If no case is present, and this enquiry represents a nARR opportunity, follow the above process (*Working with the Global Digital SMB Account Team*.), and assign the case directly to yourself. Note: for general enquiries, you should direct customers to smallbusiness@example_company.com
...
Loop in supportteam@example_company.com, and set the Resolution Action of the current open case to Transferred to Support.
...
- [Propensity to Purchase - Deck](https://example_company.highspot.com/items/6565e315ec1191ac7d8a26c0)
- [Propensity to Purchase - Training](https://example_company.highspot.com/items/65046a91a7f7915154f1ba95)
- [Doing a great discovery call](https://example_company.highspot.com/items/65365f760c1cf20725653853)

#### Expansion/Upgrade

- [Propensity to Expand](https://example_company.highspot.com/items/6565e314ec1191ac7d8a26b4#1)
- [PTE & PTC Scores Walkthrough Video](https://example_company.highspot.com/items/65365570bdabc0e8c24015b2)
- [Creating a great Ultimate Pitch - INTERNAL ONLY](https://example_company.highspot.com/items/65365dced498b9134400a185)

#### Churn/Contraction Mitigation

- [Propensity to Contract/Churn](https://example_company.highspot.com/items/6565e314ec1191ac7d8a26b4#1)
- [PTE & PTC Scores Walkthrough Video](https://example_company.highspot.com/items/65365570bdabc0e8c24015b2)

#### Renewal and TRX Support

- [Overview of Renewals at Example Company (internal handbook, log in via SSO)](https://internal.example_company.com/handbook/sales/go-to-market/renewals/)
