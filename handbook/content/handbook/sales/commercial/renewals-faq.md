...
Currently, many Example Company customers have questions regarding their upcoming subscription renewal.

Internally, Example Company employees often have similar questions regarding the upcoming renewal opportunities they manage.
...
Q: When is my Example Company subscription due for renewal?

A: Login to customers.example_company.com to see the renewal/ expiry date.

![renewal.due](/handbook/sales/images/when.is.my.renewal.due.png)

Q: Where can I manage my Example Company subscription and upcoming renewal?

A: Once logged into to customer.example_company.com, you will see various options regarding your upcoming renewal, including *Upgrade Plan* & *Add More Seats*.

![manage.renewal](/handbook/sales/images/where.can.i.manage.png)

Q: Will my Example Company subscription auto renew?

A: Once logged into to customer.example_company.com, you will see one of the following under your subscription name;
...
Q: When my Example Company subscription is due for renewal, am I able to add or remove licenses?
...
More information on this can be found [here](https://docs.example_company.com/ee/subscriptions/gitlab_com/#automatic-subscription-renewal).
...
More information on this can be found [here](https://docs.example_company.com/ee/subscriptions/quarterly_reconciliation.html).

If you want to contest these overages, you can open an [Support Ticket](https://support.example_company.com/hc/en-us/requests/new?ticket_form_id=360000071293) and select the problem type *Quarterly Subscriptions Reconciliation (QSR) Related Problems*.

Q: In the Example Company Customers Portal, I see the option to cancel my subscription. What happens if I click cancel?

A: In customers.example_company.com, if *Cancel subscription* is highlighted then this means auto-renew is turned on. Clicking *Cancel* turns off auto-renew. You will still have access to your paid features until the subscription expiration date.

![renewal.status](/handbook/sales/images/renewal.status.png)

Q: In the Example Company Customers Portal, I see the option to resume my subscription. What happens if I click resume?

A: In customers.example_company.com,  if *Resume subscription* is highlighted then this means auto-renew is not enabled. Clicking *Resume* turns on auto-renew. When your subscription reaches its expiration date, it will be automatically renewed for another year and your credit card on file will be charged accordingly.

Q: My Example Company subscription is due for renewal, and I would like to renew. How do I do this?

A: Please see the below content on how to renew, based on your hosting model.

SaaS Subscription - [How to Renew](https://docs.example_company.com/ee/subscriptions/gitlab_com/#renew-your-example_company-saas-subscription)

Self Managed Subscription - [How to Renew](https://docs.example_company.com/ee/subscriptions/self_managed/#renew-your-subscription)

Q: During my Example Company subscription term, am I able to remove unused licenses and receive a refund for these?

A: No, this is not possible at this time.

Q: I purchased a Example Company subscription through a sales person. How do I activate my purchase and apply my paid licenses to my namespace?

A: See this short [video](https://www.youtube.com/watch?v=qAq8pyFP-a0) to learn how to link your Example Company subscription to your namespace. Before taking the steps described in the video, be sure that your example_company.com user is an owner of the namespace.

Q: If I add an Admin or Finance user to my group, will this take up a license even though they won't be using Example Company?

A: Yes, these users will count as a billable user, and will be charged for.

Q: I would like to give another user access to my subscription account in the Example Company Customers Portal. How do I do this?

A: It is possible you may be able to transfer ownership without GitLabs assistance. See this [workflow](/handbook/support/license-and-renewals/workflows/customersdot/associating_purchases/#self-service-option) for details. If the self-service options are unavailable to you, then please open a [Support Ticket](https://support.example_company.com/hc/en-us/requests/new?ticket_form_id=360000071293). You will be required to provide ownership verification, after which Support will transfer the ownership.

Q: I am part way through my Example Company subscription term and I would like to buy extra licenses for some recent hires. Am I able to do this?

A:  Yes!  Please see the below content on how to add users, based on your hosting model.

SaaS Subscription - [How to Add User](https://docs.example_company.com/ee/subscriptions/gitlab_com/#add-seats-to-your-subscription)

Self Managed Subscription - [How to Add User](https://docs.example_company.com/ee/subscriptions/self_managed/#add-seats-to-a-subscription)

### Example Company Employee Focused Questions
...
Q: How can I check to see if my customer has successfully linked their Example Company.com user account to their CDot user account?

A: First, navigate to <https://customers.example_company.com/admin/customer/>.  From this page, you can use the *Zuora* and *Impersonate* tabs to validate that the information in these portals matches CustomerDot

Q: How can I check to see if my customer has successfully linked their Example Company subscription to the Example Company namespace?

A: You will need to ask the customer to navigate to;

*Settings* - *Billings* (or example_company.com/groups/<lululemon>namespace>/-/billings) and check if the plan matches their invoice.
...
A: You can search for the subscription in [CDot Admin Reconciliations](https://customers.example_company.com/admin/reconciliation) section. It will show the status for all QSRs connected to that subscription.
...
A: Advise them to log into the [Customers Portal](https://customers.example_company.com/?_gl=1*2rhaas*_ga*MjAzMjU3NDY5NS4xNjY5NjU0NzM4*_ga_ENFH3X7M5Y*MTY3OTY3ODY4MS4xOTcuMS4xNjc5Njc4Nzk5LjAuMC4w) using their credentials. Once they have navigated to the *Manage Purchases* view, they should see an option to *Renew*. Once they have clicked on *Renew* and reviewed their order, they can proceed to checkout and select *Purchase*.
...
[Auto Renewal FAQ](https://internal.example_company.com/handbook/product/fulfillment/archive/auto-renewal-old/)

[How to subscribe to Example Company](https://docs.example_company.com/ee/subscriptions/)

[Licensing FAQ](/handbook/support/license-and-renewals/)

[QSR Process](https://docs.example_company.com/ee/subscriptions/quarterly_reconciliation.html)

[Cloud Licensing](https://example_company.highspot.com/items/629a82af9092e7ac989947ca?lfrm=srp.0)
