---
title: "Example Company Field QBRs"
description: "Overview of Example Company's Quarterly Business Review process"
---
...
1. Prepare CRO and Example Company E-Group for Example Company's quarterly earnings report
...
Field Manager QBRs are held in the following months and *typically* are a mix of in-person and virtual formats. This is subject to change based on any outside conditions that make it unsafe for the team to travel (i.e. COVID-19) and [Example Company's travel policy](/handbook/finance/travel/).
...
1. The DRI for each ask is responsible for creating a new issue related to the QBRR ask OR identifying and updating an existing issue.
   ...
   1. NOTE: Reps can/should make asks of Field Ops at any time outside of QBRs using [this template](https://example_company.com/example_company-com/sales-team/field-operations/sales-operations/-/issues/new?issuable_template=FieldOpsQBR).
