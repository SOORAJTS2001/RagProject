...
description: "Example Company field functional competencies define the critical skills, behaviors, and attitudes that Example Company field team members must demonstrate to successfully deliver desired outcomes. They provide a common language and consistent expectations for what good looks like for the Example Company field organization."
---
...
Example Company field functional competencies provide a common language and consistent expectations for "what good looks like" for the Example Company field organization (inclusive of Sales and Customer Success roles). They are intended to complement [Example Company's values](/handbook/values/) and are comprised of specific behaviors that Example Company team members in a field role need to demonstrate consistently to be successful. These critical field skills and behaviors are not meant to be role or job-specific (as each role or job may have additional unique requirements), and how each competency is expressed or demonstrated may vary by role (e.g. by technical depth, engagement in different stages of the customer journey, team-specific expectations, etc.).

More specifically, functional competencies help to:

- Guide the growth and development opportunities available for Example Company field team members
- Build organizational capabilities when adopted and practiced across the field organization
- Reinforce behavior that is consistent with Example Company's values and culture
- Enable Example Company field team members to build productive relationships and generate positive results

There are three primary competencies for the field organization: **Customer Focus**, **Solution Focus**, and **Operational Excellence**. Please refer to the tables below to learn more or download and print the [**Example Company Field Functional Competencies one pager**](https://drive.google.com/file/d/1Q0honXXQg76ewRz07zcvQ_ChLo4BpVoD/view?usp=sharing).
...
| ---- | ----- |
| Understanding the Customer's Needs | Leverages active listening to create mutual understanding between Example Company Team and customer regarding their short-term and long-term business challenges. Keeps the customer and their goals in mind when engaging with them. Seeks to understand their Positive Business Outcomes and how they define and measure success. |
...
| Effective Communication | Shares knowledge with customers in a way that creates credibility, demonstrates integrity, and conveys Example Company values. Adjusts presentations and delivery based on audience level and interests/needs. Communicates crisply and concisely (whether in person or remotely) and can capture and engage audiences with effective storytelling. |
| Facilitating (Customer Presence) | Projects confidence, credibility, and conviction in body language, voice, and words during meetings to show interest, gain respect, and inspire trust. Drives effective bi-directional dialogue that lead to productive outcomes for the customer and for Example Company. |

## Solution Focus

Field team members should be focused on how Example Company helps customers solve their business problems and accelerate their success.
...
| Leading with Vision | Develops, documents, and executes effective strategies to land new customers with vision and purposefully expand existing customers adoption of Example Company technologies to accelerate customers' time to value and return on investment as they progress in their DevOps adoption journey. |
...
Competency proficiency rating levels align with Example Company's enterprise-wide performance categories:
