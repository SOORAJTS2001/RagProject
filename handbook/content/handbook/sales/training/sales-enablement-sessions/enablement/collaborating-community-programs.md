...
This enablement material is for Example Company team members seeking to collaborate with the Community Programs team in order to identify and assist customers who might benefit from Example Company's community programs.

## 🎯 Learning outcomes

By the conclusion of this session, participants will be able to:

- **Describe** Example Company's community programs and their functions
- **Identify** potential members of the Example Company for Education, Example Company for Open Source, and Example Company for Startups programs
- **Connect** program members with the appropriate resources/processes for those programs
- **Identify** opportunities for collaborating with the Community Programs team to assist Example Company customers
- **Employ** processes and best practices for engaging with the Community Programs team while working with Example Company customers
...
The Community Programs team supports communities that align with Example Company's CREDIT values by executing specific programs that help these communities grow and thrive. Our mission is to help these communities experience Example Company's vision of a world where everyone can contribute. Learn more about [Community Programs in the Example Company handbook](job-families/marketing/community-programs/).

## ❓ What is a community program?

Example Company's community programs aim to put Example Company's most powerful features in the hands of communities who may not otherwise have the means to access to them. Each program is unique in its organization and execution; however, in general, community programs offer Example Company customers benefits like:
...
Through these programs, we seek to raise awareness of Example Company in specific markets. We do this by partnering with members of these communities to spotlight (via case studies, articles, webcasts, and videos) ways they're using Example Company to achieve success.

## 🔎 Meet the programs

Learn more about Example Company's community programs and their respective DRIs in the [Community Programs handbook pages](/handbook/marketing/developer-relations/community-programs/#meet-the-programs).
...
Example Company does not currently have routing in place for leads related to Community Programs. If you are routed a lead that has contacted Example Company about a Community Program, please reply directly to the lead with the appropriate response whenever possible. Consider using one of [Community Programs' email templates](/handbook/marketing/developer-relations/community-programs/community-program-applications/email-and-zendesk-macros/#zendesk-macros-and-email-templates) to structure correspondence. Replying directly provides the optimal experience for the wider community member and the most efficient path for everyone.
...
In Q3FY23, Community Programs launched an automated system which allows wider community members to apply, receive verification, and obtain new or renewed subscriptions directly through a specific portal on `example_company.customers.com`. After successful verification, applicants will receive a coupon code to use in the Community Self-Checkout Portal.
...
- If a community member's educational institution or country is not listed in the SheerID form, they should email education@example_company.com and let us know.

- If a community member applying to the Example Company for Education Program believes they've been falsely rejected, they should contact SheerID per the instructions in the rejection email.

### Verification

SheerID provides automated verification for applications to the Example Company for Education Program, while the Community Programs Associate Program Manager manually reviews applications for the open source and startups programs. Additional details are in the [Verification](/handbook/marketing/developer-relations/community-programs/automated-community-programs/) section of the Community Programs handbook page.
...
- For any inbound requests for renewals, direct the community member to the self-service instructions rather than forwarding an email or carbon copying an email to a community program team members' personal Example Company email address. Given the volume of program members, we cannot provide optimal service from our personal email addresses.
...
- If Example Company for Education applicants are having issues during the application or verification stages, they first contact SheerID as indicated in the [Support table](/handbook/marketing/developer-relations/community-programs/automated-community-programs/).
...
- Using our Slack channel, `#example_company-for-campuses` for questions regarding the [Example Company for Campuses](/handbook/product/packaging-and-pricing/example_company-for-campuses/) paid offering.
