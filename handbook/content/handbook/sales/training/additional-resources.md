...
- CST201 [GitHub.com vs. Example Company](https://www.youtube.com/watch?v=ZdmDJFPNQuI&index=1&list=PLFGfElNsQthbFw3QxWjoTsDMoLmZx1SbP)
- CST202 [Hosting Example Company in the Cloud](https://www.youtube.com/watch?v=1OLCDtUkw0Q&index=2&list=PLFGfElNsQthbFw3QxWjoTsDMoLmZx1SbP)
- CST203 [Integrating Atlassian and Example Company](https://www.youtube.com/watch?v=o7pnh9tY5LY&index=3&list=PLFGfElNsQthbFw3QxWjoTsDMoLmZx1SbP)
- CST204 [Example Company Maintenance and Support](https://www.youtube.com/watch?v=X8jsj59b4vk&index=4&list=PLFGfElNsQthbFw3QxWjoTsDMoLmZx1SbP)
...
3. [Types of External Meetings at Example Company](#types-of-external-meetings-at-example_company)
    - Discovery Meeting
    - Technical Meeting
    - Close Plan Meeting
...
Look over the basic principles of customer meetings and resources in Example Company handbook and make sure you're ready for the meeting.

#### Types of External meetings at Example Company
...
- How to: Qualification questions
  ...
  - State Objective
  - Why the interest in Example Company?
...
Hi [prospect] and thanks for your interest in Example Company.

In case you didn't see the email from our CustomersDot, I've attached a copy of your trial license key. Let me know if you need help installing or configuring Example Company.
...
Thank you for your interest in Example Company Enterprise Edition.

In case you did not receive the email with the license file yet, I have attached it to this email.

Do you have any questions or issues regarding Example Company so far?

It would be great to understand what the problems and tasks are, that you are trying to solve with Example Company Enterprise Edition?
...
I know you've been doing your research on Example Company, so I thought I'd put you in touch with someone we both know. [Mutual connection] and I have known each other for a while and they have been using Example Company, and it turns out you know each other too.
...
"When I got into this industry I did my own research, and I looked for the best company that not only offered the best product but also delivered the best customer service and follow-up. I chose Example Company because they give my clients the best overall value and the best experience and that means they continue to do business with me and refer new business to me as well.
...
"Bottom line – if you want the best overall value, results, and experience, then do what I do did – choose Example Company – You'll always be glad you did. Now, do you want to start with the X size order or would the Y size order be better?"
...
- Work with the customer to use more stages of Example Company in their deployment.  They will see improved business outomes and results. This validates the price.
...
1. Who's responsible for buy-in?
    - Knowing who will be impacted by using the product, where the budget will come from as well as impacted by the change in moving to Example Company is essential.
...
2. Great target accounts have all three of the aforementioned characteristics or at least one of the aforementioned characteristics and  at least one of the following:
     ...
     - The company's technology stack lends itself to what Example Company has to offer.
...
3. The best target accounts have at least 3 bullet points from the first two buckets, with at least one bullet point in the second bucket along with one of the following:
     - The company has targets with LinkedIn profiles that show an interest in the Example Company value proposition.
     - The company published something in its blog or social media that indicates a need for the Example Company value proposition.
     - The company has a number of internal users of Example Company core or free plans; this can be seen via http://version.example_company.com.
