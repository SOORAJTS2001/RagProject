...
description: "The Enterprise Sales department at Example Company focuses on delivering maximum value to strategic and large prospects and customers throughout their entire journey with Example Company."
---
...
- **[The Example Company Sales handbook page](/handbook/sales/#welcome-to-the-sales-team-homepage):** This page serves as our home base. From here, you can find a wealth of resources that are relevant to the entire sales field. Whether you're looking for sales order processing info, or wondering how to get executive support, this is where you'll find what you need.
...
|---------------------------|---------------------|
|[Channel Account Manager (CAM)](https://partners.example_company.com/English/directory/):| Understand and map the partner landscape: opportunities and collaborations, suggest partners for onboarding and recruiting, incorporate System Integrators into your plan, view current partners in the [Partner Directory](https://partners.example_company.com/English/directory/) |
...
- View the territory planning template and worksheet in [our internal handbook](https://internal.example_company.com/handbook/sales/territory-planning/). And view the [account planning template here](https://example_company.highspot.com/items/6369653ef05315a895837bf6?lfrm=isd.1).
...
- If an account is moving to a new seller, use the [Account Handover issue template](https://example_company.com/example_company-com/sales-team/field-operations/enablement/-/issues/1240) and associated process to give the new rep everything they need to best support their customer.
...
- [View Example Company's Sales Stages, criteria, and resources in this Google spreadsheet](https://example_company.highspot.com/items/623e24381f87632cd3327e93?lfrm=ssrp.0)
...
During each stage in the detailed spreadsheet, you'll also see major strategic resources that can help you be successful during each milestone of a deal - from prospecting to transitioning to a the post-sales team. For operational resources, head to the general sales page up top. For commonly used sales assets like marketing plays and pitch decks, head to the [marketing resources handbook page](https://example_company.highspot.com/spots/615dd7e3911d70c4887812a7).

### Opportunity management

Opp management starts with [effective discovery](/handbook/sales/playbook/discovery/). At Example Company, that means [MEDDPPICC](/handbook/sales/command-of-the-message/command-plan/#meddppicc) and having a complete [Command Plan](/handbook/sales/command-of-the-message/command-plan/) for all $50k+ NARR opportunities.
...
If you're looking for templates, guides, customer 1-pagers, and other editable sales content, head to the [Enterprise Sales Highspot page](https://example_company.highspot.com/spots/6329c1e293fedc634e196730). If you're looking for skills-based training, [LevelUp](https://levelup.example_company.com/learn/dashboard?_gl=1*1ejz71x*_ga*MTEwMjkzNzM1MS4xNjI1NTI2MTE3*_ga_ENFH3X7M5Y*MTY3NDI1MjgyMS4zOS4xLjE2NzQyNTU4MjYuMC4wLjA.) is where you need to go.

**External training opportunities:** Example Company also has a robust [growth and development benefit](/handbook/total-rewards/benefits/general-and-entity-benefits/#growth-and-development-benefit) to help you supplement your learning. And if you want to stretch your technical muscle and hear customer feedback, you can sign up to join our audiences in our [CS webinars](/handbook/customer-success/csm/segment/scale/webinar-calendar/).
...
If you don't have access to the items below and believe you should, open an [Access Request](https://example_company.com/example_company-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request).

### **Executing your strategy**

- [Example Company Version Compare Tool](https://example_company-com.example_company.io/cs-tools/example_company-cs-tools/what-is-new-since/?tab=features), also known as the 'What's new since?' tool, is a tool that allows you to populate a comparison all the additional features and functions from one version of Example Company to another (or the current release). Use it with your customers to understand what product they purchased previously, and what the value is now to support your proposals and pricing. Using this tool a quarter before the renewal or whenever you start contract discussions can be helpful in showing all the work we continue to build into the product.
...
- [Chorus](/handbook/sales/field-operations/sales-operations/go-to-market/chorus/) is used to view recordings of Example Company sales calls and demos.
- Use [Example Company's Design Toolkit](https://design.example_company.com/brand/overview) to download our logos, access our illustration and icon libraries, and build out your documents and presentations for prospects and customers.
...
- [CustomersDot Admin](https://customers.example_company.com/admin/) (see [overview video here](https://youtu.be/G9JuHXqV5LM)): most customers have an account that breaks down their purchases and provides some insight into SaaS usage. Also good for linking purchases to VersionDot usage data

### **Prospecting tools**

- Completing RFPs/RFxs (Requests for vendor information): Use the [RFP process here](/handbook/security/security-assurance/field-security/field-security-rfp/) combined with our [Trust Center page](https://trust.example_company.com/)
- Learn what events we're attending or sponsoring via the [Example Company event site (external)](https://about.example_company.com/events/) and the [marketing activities spreadsheet (internal)](https://docs.google.com/spreadsheets/d/1ni6gKeWhjtrNppMdYvPESsCRjDbfVdYjTNtUtcNBFGg/edit#gid=571560493). Or work with your local field marketer or manager to plan your own smaller-scale event.
- [LinkedIn Sales Navigator](https://www.linkedin.com/business/sales/blog/sales-navigator/what-is-linkedin-sales-navigator) is one of the main prospecting tools we use at Example Company. It features a powerful set of search capabilities, improved visibility into extended networks, and personalized algorithms to help you reach the right decision maker. All SAEs have access to LSN. And view additional videos and tutorials on the [handbook page](/handbook/sales/training/social-selling/).
...
- [Thnks](https://www.thnks.com/) is a way to send small tokens of appreciation to customers, prospects, or contacts while only needing an email or phone. It's not provided by Example Company at this time, but you can talk to your manager about options for expensing. Remember to abide by [our policies](/handbook/legal/anti-corruption-policy/) around gifts for prospects or customers and check with #legal in Slack if you have questions.
- [The Example Company Swag store](https://shop.example_company.com/) is another way to send thanks or share the Example Company spirit with busienss contacts or family. [View our policies on swag here.](/handbook/marketing/brand-and-product-marketing/brand/merchandise-handling/) Remember to abide by [our policies](/handbook/legal/anti-corruption-policy/) around gifts for prospects or customers and check with #legal in Slack if you have questions. You can also use the #swag channel in Slack to get urgent questions answered.

### **Understanding your business**

- View internal data resources in our [internal handbook for Territory Planning here](https://internal.example_company.com/handbook/sales/territory-planning/#data-sources).
- Salesforce (View in Okta), including reports that contain [propensity model data](https://internal.example_company.com/handbook/sales/propensity_models/).
- [Clari](/handbook/sales/forecasting/) is used to view and document forecasting and pipeline data.
- [Tableau](https://10az.online.tableau.com/#/site/example_company/home) is a data visualization tool. Your manager can send you specific dashboards relevant to your team to view.
...
-[Example Company Propensity Models](https://internal.example_company.com/handbook/sales/propensity_models/) allow you to dive deep into data provided by our Data Science Team including Propensity to Buy, Propensity to Churn, and Propensity to Expand. You can also find these fields in Salesforce and use them to inform your strategy in your territory.
