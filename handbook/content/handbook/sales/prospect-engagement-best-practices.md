...
Attaching emails to a Lead, Account, Contact, or Opportunity record are vital for transparency, as any number of team members can review the correspondence between Example Company and the customer/prospect account.
...
1. Go to My Acceptable Email Addresses and make sure your Example Company email address is there.
