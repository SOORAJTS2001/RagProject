...
3. **You're the expert on Example Company, they're the expert on their business.** You know what they say about assumptions? It's important to keep in mind that no one knows your customer's business better than they do. It's your job to keep them in the loop on what solutions we offer that could help them be more effective now or down the line - but don't assume it's what's best for them. In every prospecting call or message, it should be clear that you're offering to advise them, not tell them what's best for them.
...
- **Account data:** Target accounts that have new leadership, show recent Merger & Acquisition activity, or have contacts who are posting relevant content on social media. Reach out to Example Company advocates and champions when they transition to new target accounts.
- **Engagement data:** Target prospects that have recently engaged with Example Company marketing activity or website content multiple times.
...
**Work with partners:** Work with your Channel Account Manager (CAM), talk to your peers, or use the [Partner Directory](https://partners.example_company.com/English/directory/) to identify if there is a partner that supports specific accounts and can provide insight into target contacts or stakeholders.
...
View the below YouTube video hosted on Example Company Unfiltered to see how AEs typically work with their sales development team member to get results. Remember that to view these, you have to switch your YouTube account to the Example Company Unfiltered account first. [View instructions for this on the YouTube handbook page here.](/handbook/marketing/marketing-operations/youtube/#unable-to-view-a-video-on-youtube)
...
- [Pipeline Generation at Example Company](https://example_company.edcast.com/pathways/pipeline-generation-at-example_company) (Example Company Learn - EdCast, 35 minutes)
- [Effective discovery course](https://example_company.edcast.com/insights/ECL-c0a6e34d-a997-4200-b0d9-65e3305e3761) (Example Company Learn - EdCast, 40 minutes)
...
- [Pipeline Generation - Leading with Insights](https://www.youtube.com/watch?v=fNiGq5uOxgo) (Example Company Unfiltered, Nov 2019, 10 minutes)

### Support

- [Field Marketing events and support](/handbook/marketing/field-marketing/#types-of-programs-field-marketing-runs)
- [Compete support](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/competitive-intelligence/#account-specific-support) and [Competition Slack channel](https://example_company.slack.com/archives/C1BBL1V3K)
...
**Partner support:** [#channel-sales Slack channel](https://example_company.slack.com/archives/CT9KKE5RR) is a great place to get help from a Channel Account Manager that can share partner contacts with you

- Find a partner in the [Example Company Partner Directory](https://partners.example_company.com/English/directory/)
