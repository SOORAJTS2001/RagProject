...
Listen to the needs of Example Company teams, partners, and customers, and respond with innovative and streamlined processes, tools, and resources to operate a scalable and highly profitable business for Example Company and our partners.

### Key Tenets

**Efficiency and Productivity:**
Streamline partner systems, processes, and workflows to improve ease of doing business and drive mutual profitability and positive experience for Example Company and our Partners.
...
**Advisory:**
Trusted subject matter experts for Example Company's internal and partner teams, providing daily operational support and guiding best practices and business decisions regarding our partner models.
...
If you are reporting a problem or have suggestions, changes, or similar, please open an issue on the [Ecosystem Operations Issue Board](https://example_company.com/groups/example_company-com/-/boards/2552402?label_name[]=Partner%20Ops) for operational issues, or the [Channel Team's Issue Board](https://example_company.com/groups/example_company-com/-/boards/1508300?label_name[]=Channel) for program issues.

### The Ecosystem Operations Issue Board

On the [Ecosystem Operations Issue Board](https://example_company.com/groups/example_company-com/-/boards/2552402?&label_name[]=Channel%20Ops), each column represents a type of request (feature request, alliances, data & reporting, etc.). When you submit a request to the Ecosystem Operations board, the team will assign the issue and add the corresponding tags. The Ecosystem Operations Board also uses progress tags on issues to show the status of open issues. Each issue is updated regularly with notes and progress tags and should be checked before reaching out to the team for status updates.

To open an issue with Ecosystem Operations and select [New Issue](https://example_company.com/example_company-com/sales-team/field-operations/channel-operations/-/issues).
...
| partner-program-ops | Questions and comments about channel programs and operations | https://handbook.example_company.com/handbook/resellers/ and https://handbook.example_company.com/handbook/sales/field-operations/channel-operations/ | any | any |
...
| #cloud-aws and #cloud-gcp| A channel for collaboration with the alliances Team | https://handbook.example_company.com/handbook/alliances/ | any | any |
| ~~~alliance_sales_ops~~~ | Questions and comments about alliance operations | https://handbook.example_company.com/handbook/alliances/ and https://handbook.example_company.com/handbook/sales/field-operations/channel-operations/ | any | any |

## Standard Channel Practices

For detailed information on Example Company's Channel Partner Program, visit the [Channel Partner Handbook](/handbook/resellers/). Partners must be an Authorized Example Company Partner _and have completed one sales certification_ to transact any Example Company products or services. To achieve authorization, partners must have an executed agreement and meet the requirements of the Example Company Partner Program. Only Example Company partners in good standing may sell Example Company products and services unless specifically approved on a case-by-case basis by the Example Company partner program team. Partners must [sign up](https://partners.example_company.com/) to be authorized.

### Policy and Process

All [**Partner Co-Sell**](/handbook/sales/field-operations/channel-operations/#partner-co-sell) opportunities require an authorized Example Company Partner(s) to transact the deal. Deal Registration is not applicable for Partner Co-Sell opportunities.
[**Partner Sourced Deal Registration**](/handbook/sales/field-operations/channel-operations/#partner-sourced-deal-registration) opportunities also require an authorized Example Company Partner to transact, and must also be found/created and registered in the [Example Company Partner Portal](https://partners.example_company.com/) (excludes Alliances and GSIs). The applicable Example Company Channel Managers must approve the registered opportunity to qualify for partner program discounts and incentives. Partner Sourced Deal Registration opportunities are either:

1. Net-new to Example Company
2. An upsell/add-on for an existing Example Company customer

An approved Partner Sourced Deal Registration results in `Sales Qualified Source = Partner Generated` on the opportunity.

For more information: [Deal Registration Program Overview](/handbook/resellers/channel-working-with-example_company/#deal-registration-program-overview).

### Billing Account and Billing Account Contact on Partner Account Record

#### Partner Billing Record Creation

Billing Account and billing account Contact records must be created when onboarding a new partner that will be purchasing directly from Example Company. The Partner Manager should take the following action when a new partner has signed the click-through agreement or agreed to a customer MPA:
...
**Distributors** - Example Company sellers can access the Billing Account and billing account Contact records [for our distributors here](https://docs.google.com/document/d/1GdXiBtOJm3Kt3aVXRPliEQiZlN0X_uIqU0YNMHZo-VU/edit?usp=sharing).
...
**Resellers and MSPs** - To find Billing Account and billing account Contact records in SFDC for partners that transact directly with Example Company, first navigate to the Partner Account record.
...
When a deal is being transacted via a Partner, and a discount other than the defined Program discount is being offered, a Example Company quote is **required**. At a minimum, a [Draft Proposal](/handbook/sales/field-operations/sales-operations/deal-desk/#how-to-create-a-draft-proposal) needs to be created and provided to the Partner. Discounted quotes not in SFDC and sent to a Partner are not permitted within any GEO or Sales Segment. This includes providing product and discounted pricing quote details in an email.

#### Partner Quoting Responsibilities

Sales Reps and/or Renewal Managers are [responsible for quoting](/handbook/sales/field-operations/order-processing/#what-quotes-can-deal-desk-assist-me-with) and [PO remittance](/handbook/sales/field-operations/order-processing/#po-remittance) on all standard Example Company direct and partner opportunities.
...
Refer to the [Quote Studio Highspot page](https://example_company.highspot.com/items/63c04679ce74a0ae63ca5e49) for quoting walkthroughs, including the following step-by-step guides specific to partner deals:

- [Quoting Reseller and Distributor Deals](https://example_company.highspot.com/items/6412421bfb9e0fdf947cc90a)
- [Quoting MSP Deals](https://example_company.highspot.com/items/641241c62d511fd525a390e1)
...
- Open Partners located in regions/countries with active Authorized Example Company Distributors must purchase Example Company via those distributors
...
- In EMEA: Partners transact with [Amazic](https://distribution.amazic.com/) via `example_company@amazic.com`

- In APAC (several countries):  Partners transact with [Tech Data/TD Synnex](https://www.techdata.com/apac/en/partner-with-us/become-a-partner.html) via `Example Company.APJ@techdata.com`
  - In India: Partners may also choose to transact with Redington via `example_company@redington.co.in`
  - In Japan: Partners may also choose to transact with [Networld](https://www.networld.co.jp/product/example_company/) via `example_company-info@networld.co.jp`
  - In Thailand: Partners may also choose to transact with [Get On Technology](https://www.got.co.th/contact) via `example_company@got.co.th`

Example Company sellers can also refer to the [partner billing section](/handbook/sales/field-operations/channel-operations/#how-to-find-partner-billing-records-in-sfdc-and-use-for-quoting) of this handbook for a link to our distributor billing records and guidance on how these records are used in the quoting process.

**For US PubSec:**

- Partners transact with Carahsoft via `example_company@carahsoft.com`

#### Rules of Engagement for Distributor Quotes and Orders

Distributors work directly with Example Company Sellers on the quoting and ordering process. Example Company Sellers can leverage the [partner quoting resources](/handbook/sales/field-operations/channel-operations/#partner-quoting-overview-and-resources), [distributor contact information](/handbook/sales/field-operations/channel-operations/#distributor-requirements-and-coverage-by-geo-and-market), and [Example Company Sales FAQ - Selling with Partners](/handbook/sales/field-operations/channel-operations/sales-faq/) to aid in the quote and order process.

If a reseller requests a quote directly from a distributor via the aliases above, any non-PubSec distributors may contact `partnersupport@example_company.com` to request an official quote. Partner Support will forward the request to the Example Company Sales Rep that owns the customer account/opportunity for Sales to work the opportunity with the distributor, including creating and providing the quote.

If a Example Company Sales Rep is working directly with a reseller and needs to quote that reseller via a distributor (e.g., they are an Open partner), Sales can leverage the resources linked in this section above to create the quote and send to distribution.

**Important to note for Example Company Sellers:**

- Our pricing on a two-tier distribution deal is between Example Company and Distributor only. We should **never** include the reseller or customer when sending a distribution quote or discussing distributor pricing.
- Distributors have their own pricelist and are equipped to self-quote and order new business or other order types from it without receiving an official Example Company quote, as long as pricing is at standard programmatic discounts. There may be times, especially in multiple bid scenarios, where you may not be aware of the partner(s) bidding on an opportunity until we receive a PO.

#### Distributor e-Marketplaces

Example Company is activating Distributor e-Marketplaces for customers to transact via Example Company authorized resellers. There are specific requirements for partners prior to activating their e-Marketplace capability, including:

- Partner is an authorized Example Company Open or Select partner in good standing.
- Example Company e-Marketplace page that includes an overview of the partner's technical expertise and/or services offerings.
- Example Company review of the draft page, and Example Company's written (email) approval provided to the Distributor.

Example Company reserves the right to pause or deactivate a partner's e-Marketplace offering if issues arise.
For more information about Distributor e-Marketplaces, partners should [contact their distributor](/handbook/sales/field-operations/channel-operations/#transacting-through-distribution), or their Example Company Channel Manager.

### Partner Sales FAQ

Partners and Example Company Sellers frequently ask questions on how to collaborate with one another throughout the Example Company sales process. Refer to the following resources which document these FAQs and answers from both a Partner and Example Company Seller perspective:

- [Partner FAQ - Selling with Example Company](/handbook/sales/field-operations/channel-operations/partner-faq/)
- [Example Company Sales FAQ - Selling with Partners](/handbook/sales/field-operations/channel-operations/sales-faq/)

## SFDC Field Definitions

### Section I: Partner Sourced Deal Registration

- **DR - Partner**: The reseller partner that 'submitted' the Partner Sourced Deal Registration that the Example Company Sales Team subsequently 'approved' in the system
- **DR - Partner Deal Type**:
  ...
  - _Referral_: The partner is bringing us the lead/opportunity but will either transact directly with Example Company or through another partner
- **DR - Status**: Dictates whether the Partner Sourced Deal Registration is Pending, Approved or Denied
- **DR - Distributor**: The Example Company-authorized distributor from which the DR - Partner is buying, when applicable
...
- **Distributor**: The Example Company-authorized distributor that transacts according to the primary quote
...
- **Platform Partner**:  Customer's platform that Example Company is being deployed
...
- Partners can earn a program discount for reselling Example Company Professional Services
...
- Example Company Sales must work with incumbent channel partners on renewals unless the customer documents in writing that they no longer want to work with the partner.  Example Company cannot offer a direct renewal quote if there is an incumbent partner.
...
- For partners to transact according to program discounts, they must agree to the Example Company Partner Agreement.
...
- An authorized partner is a partner that has signed a contract to transact with Example Company. In SFDC, the "Partner Status" will say "Authorized," there will be a date in the "Signed Contract Date" field, and _either_ the "Click-Through Agreement" box will be checked, or a manual contract will be listed in the Google docs or Contract section of the account record.
- A key goal of the Example Company Channel Program is the success of our authorized partners, which means whenever possible, we should work deals with them. We are developing our channel to provide coverage across geos, customer segments and vertical markets. However, there are some situations where customer requires a deal be transacted by a partner that is not willing to join the Example Company Partner Program. Only in those situations should we transact with an unauthorized partner, and only with the explicit approval of the programs team.
- Unauthorized partners have not signed a Example Company Partner Agreement.
- If an unauthorized partner would like to transact Example Company products or services, please have them visit the [Partner Portal](https://partners.example_company.com/) to sign up. Someone who has authority to accept the Agreement is required.
- Unauthorized partners cannot transact Example Company products and/or services, unless rare but explicit approval is granted by the programs team. Please reach out to the #partner-programs-ops Slack channel.
...
- **Number 4**
  - Deal is transacting thru the partner but was sourced by either a Example Company AE or SDR
...
- **Initial Source** - _Partner Qualified Lead (PQL)_: Partner created and/or qualified the Lead whether they sourced it themselves or Example Company provided the inquiry to them to work.
- **Sales Qualified Source**: - _Partner Generated_:
  ...
  - Partner submits Partner Sourced Deal Reg which (i) creates a new opportunity or (ii) is attached to an existing opportunity and approved by Example Company
...
In order to transact with Example Company, a partner must both be authorized by Example Company, and have completed at least one sales training.

### Partner Co-Sell

All Channel deals are considered Partner Co-Sell opportunities unless there is an approved Partner Sourced Deal Registration or the Opportunities Sales Qualified Source = Partner Generated. These opportunities are not sourced solely by a partner, but highlight the relationship between Example Company and partners in the selling process. Partner Co-Sell deals do not require the partner to submit a deal registration, and should be processed according to standard Partner Co-Sell discounts as identified in the [Example Company Partner Program](/handbook/resellers/).
...
Further enablement for Example Company Team Members is available. For further information, contact the #partner-programs-ops slack channel.

### Guidelines for approving US Public Sector Co-Sell Partner Submissions

The following are explicit guidelines for approved US Public Sector Partners to receive preferred pricing on Example Company-sourced opportunities.

Partner Requirements:

- Must be an approved US Public Sector Partner, [authorized to transact with Example Company](/handbook/sales/field-operations/channel-operations/#standard-channel-practices)
...
The Partner Sourced Deal Registration program rewards partners for bringing net-new business to Example Company. There are three types of Partner Sourced Deal Registrations within the Example Company Partner Program:
...
3. Registration of partner sourced Referral opportunities (partner does not transact the business they bring to Example Company)
...
Example Company's Ecosystem Sales Managers, Sales Reps, and Area Sales Managers collaborate to review and action Partner Sourced Deal Registration submissions. Refer to the [Partner Sourced Deal Registration: How it Works](/handbook/sales/field-operations/channel-operations/#partner-sourced-deal-registration-how-it-works) section for details on the review and approval process.

**The SLA for Example Company to communicate with partners on a Partner Sourced Deal Registration is two business days. There must be contact with the registering partner within two business days, whether it be initial outreach to discuss the registration, a request for more information, approval, or rejection.**
...
**Example Company Ecosystem Sales Manager**

The Ecosystem Sales Manager receives an email notification to review the Partner Sourced Deal Registration once the Ecosystem Operations Team has actioned the registration and submitted it for approval (`DR-Status` = "Pending Sales Review"). Ecosystem Sales Managers can also view registrations in their list view within the SFDC Registration tab. The Ecosystem Sales Manager is responsible for reviewing the registration and communicating with the applicable Example Company Sales Rep and ASM during this process. The Ecosystem Sales Manager must either approve, reject, or return the registration for additional information after completing their review. If they approve, it will automatically be sent to the appropriate ASM for final review.

**Example Company Area Sales Manager (ASM)**

The Example Company ASM for the opportunity is responsible for final review of any Partner Sourced Deal Registration approved by a Ecosystem Sales Manager, and must either approve, reject, or return the registration for additional information. The ASM receives an email notification to review the registration only if/when the Ecosystem Sales Manager approves (`DR-Status` = "Pending ASM Review"). ASMs can also view registrations in their list view within the SFDC Registration tab.

****Alliance and GSI Partners**

Alliance marketplace and OEM partners, and GSI partners do source opportunities for Example Company; however, they do not submit their own Partner Sourced Deal Registrations for these opportunities. The Registration process for these partners is instead initiated by the Example Company Ecosystem Sales Manager on behalf of the partner.
...
1. The Example Company Ecosystem Sales Manager opens the [Alliance and GSI Partner Sourced Deal Registration](https://docs.google.com/document/d/16wTiDbwBoomUmnu2y4OmAAdC4VpvMIUGL1k4vdSrl2Y/edit?usp=sharing) document and follows the instructions to submit a Registration via the google form.
...
- **Partner Sourced Discount**
  - To receive a quote with a Partner Sourced discount, the partner must submit a Partner Sourced Deal Registration for the opportunity which must be approved by Example Company.
...
- **Approval Criteria**
  ...
  - The Example Company Ecosystem Sales Manager should communicate and align with the Example Company Sales Rep and ASM prior to approving or rejecting the Deal Registration.
  - The Example Company ASM should communicate and align with the Example Company Ecosystem Sales Manager and Sales Rep prior to approving or rejecting the Deal Registration.
- **Example Company SLAs**
  - The SLA for Example Company to communicate with partners on a Partner Sourced Deal Registration is two business days. There must be contact with the registering partner within two business days, whether it be initial outreach to discuss the registration, a request for more information, approval, or rejection.
  - The Example Company ASM has one business day to either approve or reject the Registration, which begins when the Registration hits their queue for approval. The ASM _must_ communicate with the Example Company Ecosystem Sales Manager if their approval is anticipated to push beyond the one business day SLA.
- _Identify and Notify Backup Approvers_

  - Example Company Ecosystem Sales Managers and ASMs should _always_ identify a backup approver prior to being out of office. This ensures approval requests can be actioned in your absence, and is crucial to meeting our SLAs (see **Example Company SLAs** above).
...
- **Standard Term and Extension**
  ...
  - Deal Registration extensions beyond the initial 90-day approval are at the sole discretion of Example Company. To grant a standard 30-day extension, Example Company Partner and/or Field Sales can click the `Extend DR 30 Days` button on the Registration. For non-standard extensions beyond 30 days, please chatter `@Partner Operations` on the registration record and provide the new date that the registration should expire.
- **Example Company and Partner Collaboration in the Sales Process**
  - _Resale and MSP opportunities_ - Example Company collaborates with the partner holding the approved Partner Sourced Deal Registration and is available to support the partner throughout the entire sales process.
  - _Referral opportunities_ - The partner refers Example Company to the appropriate customer contact(s) which results in a qualified opportunity for Example Company. Example Company generally then leads the sales process to completion.
- **Closed Lost Registered Opportunity**
  - The Example Company Sales Rep will generally notify the partner by phone or email that the opportunity is not moving forward and then update the SFDC opportunity to Closed Lost.
...
- Deal Registration Views by Role
  - [Ecosystem Sales Manager](https://example_company.my.salesforce.com/a9W?fcf=00B4M000004toX7)
  - [Sales Rep](https://example_company.my.salesforce.com/a9W?fcf=00B4M000004tokk)
  - [ASM](https://example_company.my.salesforce.com/a9W?fcf=00B8X00000AmOeS)
...
- [Partner Facing Deal Registration instructions](/handbook/resellers/channel-working-with-example_company/#deal-registration-instructions)

### Partner Sourced Deal Registration: Resale Opportunities

Partner Sourced Deal Registrations for resale opportunities reward partners for bringing net-new business to Example Company. An approved Partner Sourced Deal Registration generally provides the partner a deeper discount than the Co-Sell rate, as outlined in the [Example Company Partner Program](/handbook/resellers/channel-working-with-example_company/#definitions-and-qualifications).
...
1. Click the link in either your email or [Deal Registration View](https://example_company.my.salesforce.com/a9W?fcf=00B4M000004toX7) to open the registration record in Salesforce.
...
1. Discuss the opportunity with the Example Company Sales Rep and ASM and decide to either approve or reject the registration.
...
1. You will receive an approval request email when a registration has entered your queue for review and approval. Click the link in your email or [Deal Registration View](https://example_company.my.salesforce.com/a9W?fcf=00B8X00000AmOeS) to open the registration record in SFDC.
2. Confirm alignment with the Ecosystem Sales Manager and Example Company Sales Rep prior to providing final approval or rejection on the registration.
...
_The deal registration form is not a quoting tool and will not have all the information needed to create a quote. The Example Company Sales Rep must connect with the partner to request any necessary information prior to creating a quote._
...
1. If you created a new opportunity during this process (see step 6 above), update `Opportunity Owner` on the opportunity to the Sales Rep who owns the MSP End User (i.e., customer) account using the `Change Opportunity Owner` button.
   ![19-Change_Opp_Owner_Button](/handbook/sales/field-operations/channel-operations/images/19-Change_Opp_Owner_Button.png)
1. Connect the Example Company Sales Rep to the MSP Partner Rep so they can discuss and align on opportunity and quote details.
1. Provide [Deal Desk MSP quoting](/handbook/sales/field-operations/sales-operations/deal-desk/#msp-quotes) and [Internal Partner Program discounting](https://docs.google.com/document/d/1qiT_2EsnL20c4w0hyZ_CGaJQIzj8CSCsHERoR80cwws/edit?usp=sharing) links to the Example Company Sales Rep so they have the process details necessary to manage the opportunity and create a quote.
...
Partner Sourced Deal Registrations for referral opportunities reward partners for bringing net-new business to Example Company, even if that partner does not transact the deal. An approved Partner Sourced Deal Registration for a referral opportunity provides the partner a **back-end rebate** upon Example Company successfully closing the deal as won (processed quarterly), as outlined in the [Example Company Partner Program](/handbook/resellers/channel-working-with-example_company/#definitions-and-qualifications).
...
Example Company incentivizes partners that sell their own professional services into a customer environment. The customer could have purchased licenses from the services partner, but that is not required to qualify for Service Attach. They could have purchased licenses directly from Example Company or from another partner. An approved Service Attached Registration makes the partner eligible for a **back-end rebate** (processed quarterly) once (i) Example Company successfully closes the related software deal as won and (ii) the partner completes their services and provides Proof of Execution, as outlined in the [Example Company Partner Program](/handbook/resellers/channel-working-with-example_company/#definitions-and-qualifications). This is separate from the Partner Sourced Deal Registration for the license sale.

To track the Partner Services, the partner must register the deal on the [Partner Portal](/handbook/resellers/#example_company-partner-portal).

Follow the steps below to process a Service Attached Registration for an applicable Example Company software sale opportunity:
...
1. Confirm the `Program Name` is "Service Attached Registration", `Services Attach Type` is populated with the relevant service, and that the partner provided sufficient detail to proceed with the registration. If registration details are _accurate and complete_, proceed to the next step. If registration details are _inaccurate and/or incomplete_, return the registration to request more information from the partner. Select "Returned" in the `PM Approval Status` field, add your information request for the partner in the `PM Comments` field, then click the `Save` button to complete the return process. **Important to note:**
   ...
   - There should already be an existing license sale opportunity in the system prior to processing approvals on a Service Attached Registration. If there is no existing license opportunity, the Ecosystem Sales Manager should request that the partner submit a Partner Sourced Deal Registration for the license sale. Once the Ecosystem Sales Manager has processed the Partner Sourced Deal Registration, they can attach the Service Attached Registration to the existing opportunity and proceed with approvals.
    ![16-Returned_Reg](/handbook/sales/field-operations/channel-operations/images/16-Returned_Reg.png)
1. Discuss the Service Attached registration with the Example Company Sales Rep and ASM and decide to either approve or reject.
1. Click `Link/Create Opportunity`.
...
1. The Partner provides Proof of Execution (POE) to `partnersupport@example_company.com` which can include customer signed statement of work (SOW) or other customer-verified POE.
...
1. After the close of quarter in which the software deal is closed-won (rebate payouts are reported and paid after each Example Company quarter close), Ecosystem Operations will pull a report of Closed-Won Service Attached Registrations for rebate payments.
...
Rebate payouts will be reported and paid after each Example Company quarter close.

### Additional Information

- The resale discount will be administered as an upfront discount from the Example Company license price on the most recent product sale net license price. The Service Attach incentive will be paid out at the end of each Example Company fiscal quarter.
- Partner Service Attach incentives are outlined in the [Example Company Channel Partner Program Discounts and Incentive Guide](https://example_company.highspot.com/items/626018776705c7e7d2df0bce?lfrm=rhp.0)
...
- Discounts are off list price.  If Example Company is deeply discounting a large ARR customer engagement, the partner can reasonably expect to share in that with a discount reduction.  The Partner, Example Company Sales, Ecosystem Sales Manager must agree on the negotiated discount amount.
...
- [Channel Discount Matrices for Example Company Team Members](https://docs.google.com/document/d/1qiT_2EsnL20c4w0hyZ_CGaJQIzj8CSCsHERoR80cwws/edit?usp=sharing).

### Partner Rebate Exception Review Process

While rebates are generally intended for Partner Sourced business only, there may be corner cases where Example Company wants to provide the partner a rebate for Sourced-like activities that resulted in a different outcome. The following `Partner Rebate Exception Review Process` can be used to requset a rebate exception.
...
Partners can influence Example Company opportunities without transacting the deal. The Partner Team (ESM, Cloud ESM, or SA) can submit an internal Partner Influence record to track their partner's influence activities.

Partner influence activities include customer executive engagement and advocacy and/or working side by side with Example Company on the customer pursuit in the following ways:

- Intro to customer decision maker/C-Suite
- Host/participate in Exec briefing, advocating for Example Company
- Trusted exec or technical advisor proactively advocating for Example Company
- Intro and/or position Example Company as part of a better together software sale
- Deliver presentation, demo, POC, or RFP response
- Deliver customer strategy that recommends Example Company
- Advise Example Company acct. Team on customer strategy/use case/pain points
...
1. Select the applicable `Influence Type`:
    ...
    - Working side by side with Example Company on customer pursuit.
1. Select one or more applicable partner influence activities using `Influence Details`:
   ...
   - Host or participate in exec briefing advocating for Example Company
   - Trusted exec or technical advisor proactively advocating for Example Company
   - Introduce and/or position Example Company as part of better together software sale
   - Deliver presentation demo, POC, or RFP response
   - Develop customer strategy that recommends Example Company
   - Advise Example Company account team on customer strategy/use case/pain points
...
The partner will be prompted to input basic company information that will auto-fill the LOA. Upon submission, the LOA will automatically be sent to the Ecosystem Operations team for review and confirmation that the entity requesting the LOA is a valid and authorized partner. Once appproved by Ecosystem Operations, the LOA will automatically be sent to the legal team who will approve and initial the LOA before sending it to Example Company's PAO for signature. Once signed, the LOA will be sent directly to the partner via email. The letter is good for one calendar year from the date on the letter.

## Partner Support and Communication

 Please see the [Partner Support](/handbook/resellers/partner-support/) page.

**External Communication:** Email partnersupport@example_company.com to include a partner or other external stakeholder for help with partner-related requests. PHD team members monitor the queue and email inbox throughout the day in all time zones.
...
- The Example Company Ecosystem Program provides partners with set discounts based on their program status and whether or not there is an active deal registration.
- At least one partner employee must complete the Example Company Foundations for Partners training for the partner to qualify for deal registration and program discounts.
- Example Company employees can access the [partner discount guidance here](https://docs.google.com/document/d/1qiT_2EsnL20c4w0hyZ_CGaJQIzj8CSCsHERoR80cwws/edit?usp=sharing)
- Partners can find the discount table in the Asset Library on the [Example Company Partner Portal](https://partners.example_company.com/).
...
Distributor and Reseller partners can access the [Partner Portal](https://partners.example_company.com/English/) for the current Example Company Price File. If you have any issues accessing the Partner Portal, please contact the Ecosystem Operations team at [partnersupport@gmail.com](mailto:partnersupport@gmail.com).

### How to Access and Share the Price Files (Example Company Team Member, Internal Use Only)
...
*Exceptions can be made for updates to core Example Company products (Ultimate and Premium)
...
The Channel Managers use a [tracking system](https://docs.google.com/presentation/d/1fPJutBp85WPNqf3ErQEk7Xp2042UPupTjmSLUMOmXnE/edit?usp=sharing) in Salesforce to record their sales and marketing activities. This tracker allows them to extract data for sales analysis and goal setting (QBRs, OKRs, [Business Plans](https://docs.google.com/presentation/d/1lSXI1cnJQkv5RFwTEO2-J1FNTs0ykp25WA-orJj-Fok/edit#slide=id.g29a70c6c35_0_68), 1:1s). In addition, it enables the creation of [activity frameworks](https://docs.google.com/presentation/d/15rCXjsOj6r6BFYqWMgST5WB6R_XWJiIqYq2eppUoeDw/edit?usp=sharing) to set engagement standards and further develop relationships with Example Company's partners. This activity tracker is available to all Channel Managers.

## Example Company Ecosystem Certification Dashboard

The [Example Company Ecosystem Certification Dashboard](https://docs.google.com/spreadsheets/d/1qdEpjeYEl1MWOmaCiumTSNM2pIjTxXrdtCbtHsllAQY/edit?gid=1542659641#gid=1542659641) is an interactive scorecard that provides a comprehensive outline of certification and accreditation journeys by partner and region.

Dashboard Features:

- The `Partner Scorecard` provides a holistic view of Example Company partner certification totals. You can drill down by quarter and badge.
...
If you need assistance with accessing the spreadsheet or PowerPoint step-by-step guide, please contact us at [#partner-program-ops](https://example_company.slack.com/archives/CTM4T5BPF) in Slack. If you have a customized reporting request that's not on the self-service spreadsheet, [please open an issue on the Ecosystem Operations board](/handbook/sales/field-operations/channel-operations/#the-channel-operations-issue-board).

## Partner Award Program

The Example Company Partner Awards are awarded on an annual basis. No submissions or applications are solicited; partners are assessed on our published award criteria outlined below.

Results are evaluated on the previous Example Company's fiscal year, which runs February through January - i.e. FY25 Awards will be evaluated on FY24 data.  All awards must be approved by regional Channel directors and VP of Global Channels and Alliances prior to announcement.

Winners receive a physical award, virtual badge for use on the partner's website and social media, and online promotion by Example Company, which may include a blog post and social media announcements.
...
Example Company will announce the Partner Award winners at a Global-level event within their Q1 timeframe. Awards will be shipped to the winners 4-6 weeks post-announcement. Award celebrations will be held at Partner Leadership Summit or other similar event.

**Awards Criteria (taken from previous FY):**
The Example Company Ecosystem Operations team is responsible for compiling the reports outlined in the criteria below from our SSOT data in SFDC.  Channel Sales Directors and the VP of Global Channel and Alliances will review, assess and evaluate these reports based on the criteria outlined below.
...
- [Regional] Services Partner of the Year
  - Professional Services subcontracting delivery - Example Company Services revenue impact
  - Service attach deal registrations
  - Example Company service offers - number of offers, quality of offers, level of Example Company sales engagement with the offers
...
- [Global](https://example_company.lightning.force.com/lightning/r/Dashboard/01ZPL000001JF612AG/view?queryScope=userFolders)
- [AMER](https://example_company.lightning.force.com/lightning/r/Dashboard/01ZPL000001KUHV2A4/view)
- [APJ](https://example_company.lightning.force.com/lightning/r/Dashboard/01ZPL000001Jwir2AC/view?queryScope=userFolders)
- [EMEA](https://example_company.lightning.force.com/lightning/r/Dashboard/01ZPL000001KZlp2AG/view)
- [PubSec](https://example_company.lightning.force.com/lightning/r/Dashboard/01ZPL000001KNG12AO/view?queryScope=userFolders)

## Alliances and OEMs

Please visit the [Alliances Handbook](/handbook/alliances/) for an overview of the Example Company Alliance Team. If you are a Example Company employee, the [Private Alliance Handbook](https://internal.example_company.com/handbook/alliances/) is another available resource. The [Alliances Salesforce Dashboard](https://example_company.my.salesforce.com/01Z4M000000oYAp) is also available.
...
- **Resale Partner** = [GCP](https://example_company.my.salesforce.com/0014M00001nJhks)_or [AWS](https://example_company.my.salesforce.com/0014M00001ldTdt)_
...
If GCP or AWS brought us a lead/referred Example Company a deal, but will not be transacting on Marketplace, then the following fields should be filled out on the opportunity:

- **DR - Partner** should be filled out using [GCP](https://example_company.my.salesforce.com/0014M00001nJhks) or [AWS](https://example_company.my.salesforce.com/0014M00001ldTdt) account
- **DR - Partner Deal Type** = Referral

_**Use Case 3: Partner Sourced Deal Registration (Marketplace transaction)**_
If GCP or AWS brought us a lead/referred Example Company a deal, and will be transacting on Marketplace, then the following fields should be filled out on the opportunity:
...
If GCP or AWS support a deal and help drive the customer to buy Example Company, but were not the original source of the opportunity nor are they transacting the deal, then the following field should be filled out on the Opportunity:

- **Influence Partner** should be filled out using [GCP](https://example_company.my.salesforce.com/0014M00001nJhks) or [AWS](https://example_company.my.salesforce.com/0014M00001ldTdt) account
...
Just as our partners register opportunities with Example Company, Ecosystem Sales Managers should register their marketplace opportunities with the prospective cloud provider. Instructions for submitting registrations to AWS and GCP are shown below.
...
GCP registrations are submitted on Example Company's behalf by the GCP team. To register a new opportunity with GCP, please click the following link and fill out the form.

[New Example Company Opportunity Registration for GCP](https://docs.google.com/forms/d/e/1FAIpQLScEsVcfRBILkrSs73vUeqkzfi_nTuK4Tluv-HBUw230pWuRXw/viewform)
...
[Sales Commissions Internal Handbook](https://internal.example_company.com/handbook/sales/sales-commission/)

[FY25 Partner Comp Exception Process](https://internal.example_company.com/handbook/sales/sales-commission/#request-for-splits-additional-credits-new-logo-exception-lam-dev-count-override-or-churn-exception)
