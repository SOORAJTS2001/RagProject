...
description: "The purpose of this page is to document configuration of our instance of Salesforce at Example Company. This will serve as the go-to place to check in regards to questions on our general Salesforce configuration."
---
...
This has moved to the [Internal Handbook](https://internal.example_company.com/handbook/sales/sales-systems/#sfdc-installed-packages)
...
- Create a new certificate by searching for `Certificate and Key Management` in setup. From there create a self-signed certificate and ensure that the options match the certificat you are replaceing. Please note that the information in the `Certificate` field will be slightly differnt between the old an new certificate. Then update the certificate in the following locations
  - [SAML Single Sign-On Settings](https://example_company.my.salesforce.com/0LE4M0000004J63)
  ...
  - [Identity Provider](https://example_company.my.salesforce.com/setup/secur/idp/IdpPage.apexp)
...
| Manage Users          | Yes                   | Yes              | No                 | [Yes](https://example_company.my.salesforce.com/005?id=0PS4M00000113lT&isUserEntityOverride=1&SetupNode=PermSets) - Sales Comp Team|
