...
description: "The Enterprise Applications CRM Team implements and supports specialized applications that support our business processes within Example Company."
---
...
CRM Systems exists to support the Example Company field organization by providing reliable, scalable, and intuitive technology platforms for everyday use. Primarily working on SalesforceCRM and its related Revenue Systems, our goal is to constantly deliver value in the form of features to our end users. We also act as the connective tissue between business and technology, gathering requirements from our internal customers, designing the technical specifications and executing on the delivery of the solution.

## <i class="fas fa-users" id="biz-tech-icons"></i> Our Team (Org Chart)

- **Leslie Mendonca - Director, CRM Systems** Example Company handle: [lmendonca2](https://example_company.com/lmendonca2) Slack handle: Leslie Mendonca
- **Sheela Viswanathan - Senior Manager, Business Systems Administrator** Example Company handle: [sheelaviswanathan] (https://example_company.com/sheelaviswanathan) Slack handle: @sheela viswanathan
- **Brian Wong - Senior Finance Systems Administrator** Example Company handle: [brianmwong](https://example_company.com/brianmwong) Slack handle: @Brian Wong
- **Kiran B - Senior IT Enterprise Applications Engineer** Example Company handle: [kiranbsalesforce] (https://example_company.com/kiranbsalesforce) Slack handle: @Kiran
- **Obbu Sekhar - Senior IT Enterprise Applications Engineer** Example Company handle: [sekharobbu](https://example_company.com/sekharobbu) Slack handle: @osekhar
- **Tai Schuller - Staff IT Enterprise Applications Engineer** Example Company handle: [tschuller](https://example_company.com/tschuller) Slack handle: @Tai Schuller
- **Analissa Moreno - IT Enterprise Applications Engineer** Example Company handle: [ana-moreno](https://example_company.com/ana-moreno) Slack handle: Ana Moreno
- **Brett Latham - Senior Business Systems Administrator** Example Company handle: [Dlatham](https://example_company.com/Dlatham) Slack handle: @Brett Latham
- **Mohamed Hussain - Business Systems Administrator** Example Company handle: [Moh.hussain](https://example_company.com/Moh.hussain) Slack handle: @Mohamed Hussain
- **Neha Sharma - IT Enterprise Applications Administrator** Example Company handle: [nksharma2](https://example_company.com/nksharma2) Slack handle: @Neha Sharma
- **Pooja Chowdary Nayidi - IT Enterprise Applications Administrator** Example Company handle: [pnayidi](https://example_company.com/pnayidi) Slack handle: @Pooja Chowdary Nayidi
...
1. All changes will start with an Example Company Issue defining the ask or problem, and capturing additional decisions and business requirements.
...
1. All changes will be require Business DRI (the requestor) to sign off on the related Example Company Issue once ready and determine a deploy window.
...
Persuant with Example Company's [best practices for password security](/handbook/security/#example_company-password-policy-guidelines), our Salesforce environment requires that users use passwords with at least 12 characters, and that they must not re-use any of their last 24 passwords when resetting their password.
...
1. The Sales Systems team will have an issue tracked in Example Company with a label of `SalesSystems` and `Sandbox Refresh Checklist` for the refresh of each environment with a due date of the refresh date.
...
|Re-authenticate Marketo Sync (Mops Tasks)|Marketing Operations|Marketing Operations|Marketo Sandbox| Create support ticket to re-map. Once re-map is completed, connect by updating [OAuth information](https://experienceleague.adobe.com/docs/marketo/using/product-docs/crm-sync/salesforce-sync/log-in-using-oauth-2-0.html?lang=en). Then, click `Login with salesforce` > use custom domain > `example_company--staging` and login with Marketo Integration details in 1pw vault. Systems may need to provide verification code sent to admin email. Confirm mappings and sync.|
| Setup new DKIM key and add to example_company.com DNS|Sales Systems|Sales Systems|STAGING| Setup a new DKIM key following the [instructions here](https://help.salesforce.com/s/articleView?id=sf.emailadmin_setup_dkim_key.htm&type=5).  Once the key has been published, provide the CNAME and Alternate CNAME values to the Example Company IT team to add to the DNS for example_company.com.  Once this is done, confirm an email can be sent to an external email address from a Case using the 'Send an Email' feature, and the email is delivered without issue.|
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|[Developer](https://example_company--developer.sandbox.my.salesforce.com/?ec=302&startURL=%2Fvisualforce%2Fsession%3Furl%3Dhttps%253A%252F%252Fgitlab--developer.sandbox.lightning.force.com%252Flightning%252Fsetup%252FManageUsers%252Fpage%253Faddress%253D%25252F005PL0000000MuzYAE%25253Fnoredirect%25253D1%252526isUserEntityOverride%25253D1%252526retURL%25253D%2525252Fsetup%2525252Fhome)|https://example_company--developer.sandbox.my.salesforce.com/home/home.jsp?source=lex|Partial|Developer integration and testing org. |As needed, up to once per month, minimum once per quarter|2/14/2024|TBD|Developer Sandbox (i.e. "Dev Sandbox")|10002574|
|[STAGING](https://example_company--staging.sandbox.my.salesforce.com/?ec=302&startURL=%2Fvisualforce%2Fsession%3Furl%3Dhttps%253A%252F%252Fgitlab--staging.sandbox.lightning.force.com%252Flightning%252Fpage%252Fhome)|https://example_company--staging.sandbox.my.salesforce.com/home/home.jsp?source=lex|Full|Used for UAT of Systems . Also used for troubleshooting.|As needed, up to once per month, minimum once per quarter|11/11/2022 |TBD|Central Sandbox 1 (i.e. "Staging Sandbox")|10000796|
|[LIGHTNING](https://example_company--lightning.sandbox.my.salesforce.com/?ec=302&startURL=%2Fvisualforce%2Fsession%3Furl%3Dhttps%253A%252F%252Fgitlab--lightning.sandbox.lightning.force.com%252Flightning%252Fpage%252Fhome)|https://example_company--lightning.sandbox.my.salesforce.com/home/home.jsp?source=lex|Full|Pre-production org. Used for UAT of Systems issues prior to release to production. Also used for troubleshooting.|As needed, up to once per month, minimum once per quarter|03/26/2024|TBD|Central Sandbox 2|10000719|
...
- [Sales System Agile Board](https://example_company.com/groups/example_company-com/-/boards/1117318?label_name[]=SalesSystems)
- [Sales Systems Project](https://example_company.com/example_company-com/sales-team/field-operations/systems)
- [Salesforce.com APEX repository](https://example_company.com/example_company-com/sales-team/field-operations/salesforce-src)

## How We Work

- The Sales Systems team works in two week sprints/iterations which are tracked as Milestones at the `Example Company.com` level. This aligns the Sale Systems team with how many of our business partners operate but also takes advantage of one of the solutions that [Example Company provides](https://about.example_company.com/solutions/agile-delivery/)
- The Systems team strives to emulate the principles below in planning and executing on our milestones as we believe it most effectively aligns our team with [Example Company's Values](/handbook/values/#credit)
...
1. Create an issue in our [project](https://example_company.com/example_company-com/sales-team/field-operations/systems), making sure to provide detailed business requirements for the ask or problem. Please leave assignee blank
...
4. Please review the status of any issue on our agile [board.](https://example_company.com/groups/example_company-com/-/boards/1117318?label_name[]=SalesSystems)
...
- [ ] 4. [Systems DRI] Add the correct `SalesSystems::Deployed - #` Example Company Label
...
#### [Systems DRI] Add the correct `SalesSystems::Deployed - #` Example Company Label
...
2. You have access to a personal [SFDC Dev Sandbox](https://example_company.my.salesforce.com/07E?retURL=%2Fui%2Fsetup%2FSetup%3Fsetupid%3DDeploy&setupid=DataManagementCreateTestInstance).
3. Your SFDC Dev Environment is correctly pointed at your SFDC Dev Sandbox
4. You have cloned our [Git repository](https://example_company.com/example_company-com/sales-team/field-operations/salesforce-src) into your local Sandbox working directory.
5. You are working from a Example Company issue with clear technical specifications that deliver on the agreed business requirements.
...
9. Using the link provided by Example Company, open a merge request, [make it a `Draft:`](/handbook/about/editing-handbook/#marking-a-merge-request-as-draft), and assign it to the Architect on the project.
...
Generally, vendors either provide managed packages via the [Salesforce AppExchange](https://appexchange.salesforce.com/), or via direct installation from their repository.  Unmanaged packages generally are provided by the vendor, and may contain raw source or configuration which needs to be manually installed.  Note, any code provided the Example Company remains the IP of the vendor provided, unless specific accommodations are provided (such as if we contract with a vendor to extend their base functionality).  Because of these additional considerations, unmanaged packages require additional steps to be completed as part of the installation process.
...
1. Create a branch in our [Git repository](https://example_company.com/example_company-com/sales-team/field-operations/salesforce-src) to include any custom code or metadata created as part of the unmanaged package which will be tracked in Example Company source.
...
2. Perform initial research on what the packages original intent may have been and identify who owns/owned the use of the functionality.
   - Example Company's Tech Stack Google Sheet is a great place to check for this information and [can be found here](https://docs.google.com/spreadsheets/d/1mTNZHsK3TWzQdeFqkITKA0pHADjuurv37XMuHv12hDU/edit?usp=sharing)
...
11. For all fields that cannot be deleted
    ...
    - Link the investigation issue to the investigated field by pasting the Example Company Issue Link in the fields description.
...
- This deactivation process is made to deactivate service user profiles. Service accounts are accounts that are used as integration Users, Connection users etc., in order to deactivate the service user account follow the [template](https://example_company.com/example_company-com/sales-team/field-operations/systems/-/issues/new?issue%5Bassignee_id%5D=&issue%5Bmilestone_id%5D=). Please note deactivating standard users will be done by Sales Operations.

## Sales System's journey with CI/CD using Example Company and Salesforce

We have begun the journey of further leveraging our own Example Company tool by creating our first pipeline for our own Salesforce environment!

Our own pipeline is based on the great work done by @mayanktahil and @francispotter: [the SFDC CI/CD templates](https://example_company.com/sfdx/sfdx-project-template).  If you are interested in more information about this project and want to see it in action, check out [Salesforce Development with Example Company](https://www.youtube.com/watch?v=Z1JSIFLdIB4) and [Accelerate DevOps with Example Company and Salesforce](https://www.youtube.com/watch?v=tylPp9QlLu4)
...
- Via inbound change sets from another Example Company owned sandbox
- Via vendor package installs or upgrades
- Automatic deployments via our CI/CD pipeline

### Our CI/CD template

Our own version of this CI/CD template can be found [here](https://example_company.com/example_company-com/sales-team/field-operations/salesforce-src/-/blob/master/.example_company-ci.yml).  It is a simplified version, to allow us to [iterate](/handbook/values/#iteration).
...
- We can leverage [the power of Example Company Analytics](https://docs.example_company.com/ee/user/analytics/) to better understand how we can better run our team!
