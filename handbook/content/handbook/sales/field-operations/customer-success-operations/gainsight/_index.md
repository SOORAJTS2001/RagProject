...
- [Duplicate records in `Instance Data` table](https://example_company.com/example_company-com/sales-team/field-operations/customer-success-operations/-/issues/255)
- [Snowflake > Gainsight connector - known data issues](https://example_company.com/example_company-com/sales-team/field-operations/customer-success-operations/-/issues/98)
...
- [Issue #276: GS Documentation - Review Data Designer designs and add descriptions](https://example_company.com/example_company-com/sales-team/field-operations/customer-success-operations/-/issues/276)
...
- Users
  - User object contains data on both internal (Example Company agents) as well as external requester data (who submitted the ticket.)
- Closed Date
...
| Company                          | Collaboration Project URL  | Account                    | Example Company Customer Success Project    |
...
| Company Person                   | Example Company Role                | Contact                    | Role                               |
...
We have a team email address cs-ops@example_company.com that we use for rule failure emails in Gainsight.
...
| Templates                          | For any templates used in Email Assist or Programs start all templates with                                                                                                                                                                                                                                                                                                                                                       | Email Assist: {Insert Template Name} or Email Program: {insert Template Name} Email # - subject Example: Email Onboarding Program: Email 1 - Intro to Example Company             |
...
See more about labeling in [this issue](https://example_company.com/example_company-com/sales-team/field-operations/customer-success-operations/-/issues/42).
...
- Link to the Example Company issue in the description: [Issue #275: GS Documentation - Review rule descriptions and titles](https://example_company.com/example_company-com/sales-team/field-operations/customer-success-operations/-/issues/275)
...
The data team does not use Snowplow as a source for the new Automated Service Ping processes. Instead, they use clones of Example Company.com postgres and Example Company.com Redis counters.
...
The namespaces list used by SaaS Namespace Service Ping is driven by a clone of the Example Company namespaces table.
...
- [UUID](https://docs.example_company.com/ee/api/usage_data.html#export-service-ping-sql-queries): originally intended as unique identifier
- `Hostname`: the url for the company's on-prem server (e.g., example_company.gainsight.com)
- `Namespace id`: the Example Company-defined ID for namespaces (SaaS)
- `Namespace name`: the customer-defined name for their namespace. Note: many are listed as "BLOCKED" because of PII
- Metric definitions: https://metrics.example_company.com/
...
Example Company customers will have an account and may have multiple subscriptions. Each subscription may have multiple instances, such as production or staging.
...
1. Issue # - Related issue number from the Customer Success Operations Example Company Project.
