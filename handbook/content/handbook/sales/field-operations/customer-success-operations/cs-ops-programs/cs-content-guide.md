...
Creating new content, or adapting existing content from elsewhere at Example Company, requires review outside of the Digital Customer Programs team. Content must be reviewed for correctness, adherence to Example Company style, and readability. Expect at least 10 working days, or about one milestone, to complete the entire process.
...
| 2    | Identify existing content                   | Does the email content already exist in the Example Company handbook or other documentation?             | Example Company Team Member SME                    | 3 - 5 Days |
| 3    | Define call to action                                | Answer: What are the intended actions of each individual email?                                      | Program Manager                           | 1 - 2 Days |
| 4    | Create email copy                                   | Write new email content or adapt existing content into one or several emails.                                 | Program Manager or Example Company Team Member SME | 3 - 5 Days |
...
| 6    | Peer review from marketing or subject matter expert | SME review of email copy for correctness and adherence to Example Company style.                        | Example Company Team Member SME                   | 5 Days     |
...
- We use the [Example Company Writing Style Guidelines](/handbook/communication/#writing-style-guidelines) for emails to retain consistency with the Handbook and other Example Company communications.
...
Our email programs go to many different customers, including paid and free, self-managed and SaaS, AMER and APAC. We strive to create a consistent look and feel that is similar to other communications from Example Company, but remains unique to our team and its goals.
...
We also use the [Pajamas Design System](https://design.example_company.com/brand/overview) to guide our own brand principles and tone.

Additionally we use guidance from the [Documentation Style Guide](https://docs.example_company.com/ee/development/documentation/styleguide/) to avoid non-inclusive language, and avoid regional phrases or words that may be confusing to a wider audience.
...
A good rule to consider is whether the email is coming from a specific person or from a team. For example, if the email is sent by "Joe Example Company, CSM," and is meant to be personal, we would most likely use "I" or "my" throughout the email. If the email is sent from the Customer Success Team, "we" and "our" would be the better option.
