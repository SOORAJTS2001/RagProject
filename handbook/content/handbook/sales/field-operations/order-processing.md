...
- **Salesforce Reports and Dashboards**
  ...
  - [Current Quarter WW Sales Dashboard](https://example_company.my.salesforce.com/01Z4M0000007H7W)
  - [Monthly Bookings Report](https://example_company.my.salesforce.com/00O61000004Ik27)
  - [Deal Desk Pending Opportunity Approvals Report](https://example_company.my.salesforce.com/00O4M000004e0Dp)
...
- **Frequently Used Handbook Pages**
  ...
  - [Useful Company Information](https://example_company.com/example_company-com/finance/wikis/company-information)
  ...
  - [Licensing FAQ](https://about.example_company.com/pricing/licensing-faq/)
...
- **Other Resources**
  ...
  - [Billing FAQs and Useful Tips](https://example_company.com/example_company-com/finance/-/wikis/Billing-Team-FAQs-&-Useful-Tips)
...
6. If the account is a `Partner` account, it should be created via the partner creating an account in Impartner or manually via Partner Operations. Sales should not create Partner accounts and should Slack [#partner-programs-ops](https://example_company.slack.com/archives/CTM4T5BPF).
...
Example Company uses 5 quote templates to support each type of transaction. The following quote templates are available on all quotes (New Subscription, Amendment, Renewal). The correct quote template must be used for the deal as there is acceptance language specific to each route to market.
...
1. Tax/VAT ID field - adding a valid VAT ID is required for tax compliance of cross-country transactions to European Union countries. These are when we bill from Example Company Inc to any EU country, from Example Company BV to any other EU country except the Netherlands, from Example Company Ltd to any other EU country except the UK, from Example Company GmbH to any other EU country except Germany. **Note there is an [automation rule](https://example_company.my.salesforce.com/01Q4M000000oVDi) in Salesforce that automatically populates the contents of a Quotes `VAT ID` from a quotes `VAT/Tax ID` - If you attempt to update the VAT ID and it is overwritten please [chatter for support](/handbook/sales/field-operations/sales-operations/) on the related opportunity**
...
Example Company's Cloud Licensing experience allows for the activation and provisioning of Quarterly Subscription Reconciliation and Auto-Renewals, which apply to both SaaS and Self-Managed Subscription plans. In addition, the Cloud Licensing experience introduces Operational Data.

#### Auto-Renewal, Quarterly Subscription Reconciliation, and Operational Data: Eligibility

The SuperSonics Billing and Subscription Management Experience applies to all eligible new customers and any eligible existing customers at their next renewal, assuming they are running Example Company 14.1 and have opted into the new terms. To determine whether your customer is eligible for Auto-Renewal, Quarterly Subcription Reconciliation, and Operational Data, review the [Availability Matrix](https://internal.example_company.com/handbook/product/fulfillment/#feature-availability-matrix) and read the [Customer Availability Summary Table](https://docs.google.com/document/d/1XmaIDggCYespisg1MTXHMVDUnWtdRsDw_brz-ir9RrI/edit#bookmark=id.jb012t7kd93k) section of the [Field Team FAQ](https://docs.google.com/document/d/1XmaIDggCYespisg1MTXHMVDUnWtdRsDw_brz-ir9RrI/edit#). Please direct any questions regarding SuperSonics eligibility to the #pnp-changes-field-questions Slack channel.
...
For customers who are not exempt, the default values will be "Yes" for all fields. For customers who are exempt based on the [Availability Matrix](https://internal.example_company.com/handbook/product/fulfillment/#feature-availability-matrix), the default values will be "No" for all fields.

- Note: If a customer is exempt from SuperSonics, or has opted out, Legal Language will populate on the Order Form noting that SuperSonics does not apply. In these cases, such language can only be removed or edited by the Example Company Legal Team.
...
Note: there is no contractual field for Cloud Licensing as sending Cloud License [Subscription Data](/handbook/legal/privacy/customer-product-usage-information/#subscription-data) is part of the standard Example Company's standard Subscription Agreement.
...
- [Availability Matrix](https://internal.example_company.com/handbook/product/fulfillment/#feature-availability-matrix)
- [Licensing Private Handbook](https://example_company-com.example_company.io/licensing/)
...
- From time to time a Customer may request that Example Company complete a Vendor Setup document. This is generally required for procurement groups to add a new vendor to their system(s).
- The Sales Team member is responsible for completing such forms by following the below steps:

1. Complete as much of the form as possible. Much of this information is publicly available in the Example Company handbook. Helpful information can be found on the [Company Information](https://example_company.com/example_company-com/finance/wikis/company-information) page and on the final page of any direct order form generated via a Zuora quote;
1. Engage deal desk (via chatter in SFDC) only for any information that is not available in the Example Company handbook. The Deal Desk team can help point you to the relevant handbook information or team who can assist with the question, but please note that it is the sales rep's responsibility to populate and manage these forms from end to end.
...
Note: Example Company will not agree to any additional terms in a Vendor Setup Form. The parties will have all the applicable terms related to the products and services we offer in, (a) the Order Form agreed to between the parties, and/or (b) a definitive agreement that is executed by Example Company and the prospect/customer.
...
All contracts / Agreements that require Example Company countersignature will be digitally stamped by a Example Company Contract Manager or legal representative. This is done to ensure and signify that the document has been reviewed and vetted by Example Company legal, and may be signed.

**Receiving a stamped contract / Agreement**

- Once Example Company and the customer / prospect reach executable terms, the Contract Manager or legal representative will provide a final "Clean" version. This will be in PDF format and include a digital stamp below the Example Company signature line/block which indicates, (i) the name of the Example Company legal member that approved, and (ii) the date of approval.
...
- Contracts / Agreement without a digital stamp indicating approval by a Example Company Contract Manager or legal representative will be rejected and not signed.

NOTE: In very few circumstances, a Customer may refuse to use a PDF with Example Company Legal stamp for signature, due to their electronic signature tool(s). If this is the case, please supply the Agreement to be signed, and notify the individual(s) with signatory authority with the following information: (I) Overview that the Customer toolset prohibits the use of our Example Company Legal stamp, and (II) A link to the SFDC Case where the Contract / Agreement was negotiated. With this information, the Example Company individuals with signatory authority will be able to compare the requested version for execution, and the latest version approved by Legal in the case.
...
1. Why is Trade Compliance (Export / Import) important
    1. Not complying could be detrimental to the United States and other countries Example Company operates in
    1. IT'S THE LAW!
    1. Not complying could result in fines or penalties for Example Company and/or Example Company team members
...
1. For more information see the [Trade Compliance](/handbook/legal/trade-compliance/) handbook page and the [Code of Business Conduct & Ethics](https://ir.example_company.com/static-files/7d8c7eb3-cb17-4d68-a607-1b7a1fa1c95d) page.
1. Example Company uses a third party tool called "Visual Compliance" that is connected to our Example Company SalesForce account
1. This tool checks Account information against various databases to ensure no matches, Accounts are checked repeatedly to ensure Example Company's continued compliance
...
1. VISUAL COMPLIANCE STEPS
    ...
    1. If the Account information provides a 'hit', meaning it matches some element of information from a regulation or restriction, a Example Company legal member will manually review the Account
        *NOTE: Example Company legal reviews these accounts at 09:00, 12:00, 5:00 (CENTRAL TIME)
    1. If the Account is approved, the Example Company legal member will CLEAR the Account, and Visual Compliance will update (every 15 minutes)
        *NOTE: If Example Company legal finds an issue with the Account they will alert the Sales Team to the Account being 'locked' and will work to verify next steps.
...
- Greater than $25,000 ARR (USD) Opportunity to review edits on Example Company Agreement template(s)
- Greater than $100,000 ARR (USD) Opportunity to review Customer template / agreement version(s)

The Sales Team Member will follow the below workflows to make requests for, (i) editable version(s) of Example Company Templates, (ii) engagement of contract negotiations, and (iii) assistance on general questions related to a Customer / Opportunity.

A presentation overview of the process to engage Example Company Legal can be found [**HERE**](https://docs.google.com/presentation/d/1lesWNvPAFd1B3RuCgKsqQlE85ZEwLuE01QpVAKPhQKw/edit#slide=id.g5d6196cc9d_2_0)
...
#### Request editable version of Example Company Template

Within the Customer Opportunity:

1. Click "Legal Request" (located at the top of the Opportunity SFDC layout)
1. For "**Type of Legal Request**" select "**Request for Example Company Agreement Template**"
1. For "**Type of Contract**" select the Template desired. For example, for a Non-Dislclosure Agreement request, select "NDA"
1. For "**Contract Source**" select "**Example Company Contract Template**"
1. Add any additional notes that may be helpful for Example Company Contract Manager / Legal and hit "SAVE"
1. The information provided will open a "Case", which will automatically be assigned to a Contract Manager / Legal Member
...
1. The Sales Team Member will take the template version and provide to the Customer
   ...
   - NOTE: Sales Team Members are responsible for communication(s) with Customers. This includes providing back Example Company templates and negotiated terms.
...
#### Request for Example Company review of Customer edits to Example Company Template, OR, Review of Customer Agreement Template
...
1. For "**Contract Source**" select the applicable Agreement / Template Source
   ...
   - For edits to a Example Company Agreement / Template select "**Example Company Contract Template**". NOTE: Be sure the Opportunity size is above $25,000 (USD)
   - To request Example Company to edit a Customer Agreement / Template select "**Customer Contract Template**". NOTE: Be sure the Opportunity size is above $100,000 (USD)
...
#### Request Example Company Partner Agreement
...
1. The Sales Team Member should send (AS A PDF) the Agreement to the Partner. If they require an editable version, they may send the "WORD" form originally provided.
   ...
   - NOTE: Sales Team Members are responsible for communication(s) with Partners. This includes providing back Example Company templates and negotiated terms.
...
1. The steps to do so are highlighted below, and also found in the recording located [here](https://example_company.zoom.us/rec/share/--dWJbirp39Lf8_fyU7lY_E4D7zvX6a823IY8vtYyk4ReS25B7mI3HrdLUM8PXat)
...
<details>
<summary markdown="span"><b>Custom Agreements and Negotiating Example Company's Standard Agreement</b></summary>

#### Using Customer Form Agreements and Negotiating Example Company's Standard Agreement
...
Despite the overwhelming arguments in favor of using the Example Company form some prospects insist on using their form agreement. Example Company will accommodate such requests with the following assumptions:

1. Example Company must have been selected as the solution of choice by the customer.
...
Example Company will not accommodate changes to our standard forms for deals under $25,000.

#### Referencing Customized Customer Agreements in Quote

If Example Company agrees to customized subscription terms with a customer, all quotes, SOWs, POs, etc. must reference those customized terms and *not* the Example Company standard terms listed on our website.

To update the terms of a quote, follow these steps:

1. Delete the reference in the quote to Example Company's URL terms.
1. Replace the reference with the following language - "By accepting this Quote, you and the entity that you represent (collectively, "Customer") unconditionally agree to be bound by and a party to the Example Company Subscription Agreement signed by Customer and Example Company with an effective date of mm/dd/yyyy."
...
If a discount has been applied to a quote pursuant to a signed agreement between Example Company and the customer, additional approvals are not required. Tag Sales-Support in chatter with a link to the signed agreement to request that the quote approvals be overridden.

#### Channel Quote Approval

Under the [**Example Company Partner Program**](/handbook/resellers/#example_company-partner-program-overview), signed Channel Partners are granted specific, contractual discounts depending on the product, Partner Deal Type, and the Partner Engagement type. This information is automatically captured at the opportunity level. For more information, review the [SFDC Field Definitions](/handbook/sales/field-operations/channel-operations/#sfdc-field-definitions) and the [Partner Program Discount Tables](/handbook/sales/field-operations/channel-operations/#partner-program-discounts).

**Only Example Company-authorized partners who have completed one sales certification may transact a Example Company order.**

**Quote Approvals:** The Quote Approval module identifies channel deals (subscription deals only) and manages the necessary approvals automatically. If the discount applied to the quote is *less* than the Example Company Partner Program discount, discount approval is required by the regional Channel Approver listed in the [Approval Matrix](https://docs.google.com/document/d/1-CH-uH_zr0qaVaV1QbmVZ1rF669DsaUeq9w-q1QiKPE/edit#bookmark=kix.y33malxy9ex9). If the discount applied is *more* than the Example Company Partner Program discount, the added discount portion is subject to standard approvals listed in the [Approval Matrix](https://docs.google.com/document/d/1-CH-uH_zr0qaVaV1QbmVZ1rF669DsaUeq9w-q1QiKPE/edit#bookmark=kix.7goasfb500q2). Effective FY24 Q2, only the portion of the discount that *exceeds* the Example Company Partner Program discount will be subject to approvals.
...
1. Include at least qty 12 Example Company Certification Exam Voucher
...
1. Like all Example Company deals, waived true up orders must meet booking requirements as described [here](/handbook/sales/field-operations/order-processing/#opportunity-booking-requirements). In most cases, that means that the customer must sign a $0 Order Form, or issue a $0 PO.
...
- To review how you can approve or reject quotes via email or directly in Salesforce, sign into the Example Company Unfiltered YouTube account and watch this [video](https://youtu.be/T47h4VNTRWU).
...
Additional resources are available in Highspot. Review the [Slack Approvals slide deck](https://example_company.highspot.com/items/6644d40fe832298666f32013) for step-by-step instructions, or check out this [video announcement](https://example_company.highspot.com/items/6644cf1179be967698ca92e2) to see Slack Approvals in action!
...
2. On the next screen, login to your DocuSign account. Enter your Example Company email address and click continue. This will automatically log you in with OKTA.
...
- **If you are sending the document to one signer:** Review the document to ensure the Signer 1 signature tags are visible on the signature block. These tags are automatically applied to any Order Form PDF generated from the SFDC quote (generated on or after 2021-06-03). When ready, click "Send.
  ...
  - For each signer, Example Company requires:
    - Signature
    - Date Signed
    - Full Name
    - Title
...
1. From the Opportunity level in our Salesforce instance, you can view the status of a document by hovering over the "DocuSign Envelope Status.
    ...
    - You will receive email notifications to your Example Company email address when the document has been viewed, and when it has been signed.
...
- For a visual demo of Example Company's DocuSign instance, review this [LevelUP Webinar from 2021-05-13](https://youtu.be/Dch4zaUQOeg)
- Note: If you cannot view the video, make sure you are logged in to Example Company Unfiltered. [You can learn more about how to log in or request access to Example Company Unfiltered here!](/handbook/marketing/marketing-operations/youtube/#unable-to-view-a-video-on-youtube)
...
There are unique requirements for different methods of selling Example Company.
...
1. Prospect/Client paid via Credit Card through the web portal- In this scenario the applicbale Example Company terms are agreed upon at the time of the purchase.
...
1. An Order Form (which includes a Quote No.) is required in order to confirm products purchased, # of seats, term, and pricing. An Order Form is also needed to confirm the Prospect/Client agrees to the terms and conditions referenced in the Order Form.
   ...
   - If the parties agreed to non-standard, negotiated terms, the URL to our standard terms and privacy policy should be deleted and replaced with the following: "This Order Form is governed by the terms and conditions of the [NAME OF AGREEMENT] dated [MM/DD/YYYY] between the parties ("Agreement"). Customer has been deemed to have "Accepted" the terms of this Agreement upon the earlier of, (i) executing this Order Form, (ii) reference of this Order Form Quote No within a purchase order or similar document, or (iii) the use of any Example Company software.

   - If an Order Form is executed by the Customer, Example Company review of a submitted purchase order will be minimal, the purchase order must include: a) the correct Example Company entity, b) the Quote No. found within the applicable Order Form, c) payment terms matching the Order Form, and d) line item descriptions that match the Order Form.
...
1. If the Customer's purchase order **DOES NOT** include any legal or finance terms, as determined and approved by Example Company finance and legal, and includes a) the correct Example Company entity, b) the Quote No. found within the applicable Order Form, c) payment terms matching the Order Form, and d) line item descriptions that match the Order Form (without signature block), Example Company may accept the Order Form and purchase order without changes.

1. If the Customer's purchase order **DOES** include any legal or finance terms, as determined and approved by Example Company finance and legal, the Sales Team Member will be guided to direct the customer to either:

   - Remove all references to such terms found within the purchase order; and/or

   - Insert the following language into the supplied PO: "Notwithstanding any of purchaser's standard terms and conditions set forth or referenced herein, this PO is governed by the Example Company Subscription Agreement, Example Company Professional Services Terms (as applicable) or other such software license and/or services agreement negotiated by the parties"

   - The purchase order in either instance (3&4) must also include: a) the correct Example Company entity, b) the Quote No. found within the applicable Order Form, c) payment terms matching the Order Form, d) line item descriptions that match the Order Form (without signature block)
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0lax"><span style="font-weight:400;font-style:normal;text-decoration:none">If the reseller won't provide a signed Order Form, the </span><br><span style="font-weight:700;font-style:normal;text-decoration:none">PO document in pdf </span><span style="font-weight:400;font-style:normal;text-decoration:none">must contain the following details and we need to generate a reseller Order Form without signature block:</span><br><span style="font-weight:400;font-style:normal;text-decoration:none"> - correct Example Company entity, </span><br><span style="font-weight:400;font-style:normal;text-decoration:none"> - the Quote No. found within the applicable Order Form, </span><br><span style="font-weight:400;font-style:normal;text-decoration:none"> - currency: USD,</span><br><span style="font-weight:400;font-style:normal;text-decoration:none"> - payment terms matching the Order Form, </span><br><span style="font-weight:400;font-style:normal;text-decoration:none"> - line item descriptions that match the Order Form (without signature block),</span><br><span style="font-weight:400;font-style:normal;text-decoration:none"> - matching subscription term,</span><br><span style="font-weight:400;font-style:normal;text-decoration:none"> - visible PO number</span></td>
  </tr>
</tbody>
</table>

An Authorized Reseller, Distributor, or MSP is an approved partner with an active contract with Example Company in place. For opportunities where an any of these partners will purchase and resell to an End User:

1. Authorized Reseller or Distributor must issue a PO that references the Example Company Order Form Quote No. The Authorized Reseller Order Form template OR the Distributor Order Form template must be attached to the opportunity and DOES NOT require Signature from the reseller.  The template includes reference to the executed Agreement between the parties, and in the event there is no executed Agreement, then the [Fulfillment Reseller Agreement](https://about.example_company.com/terms/#reseller) will govern.
1. Example Company will accept the Authorized Reseller or Distributor Order Form without signature, and the Reseller PO, PROVIDED THAT:
   ...
   - The PO received is issued to the correct Example Company entity and references the applicable Order Form Quote No. which includes, Quote ID, products, # of users, term, and pricing of the subscription(s).
...
1. Order form need not be signed by the customer for AWS deals. By accepting the private offer customer agrees to Example Company's subscription terms.
...
1. A Private Offer must have been created, accepted by the customer,and must match the deal elements as approved on the SFDC quote object / Order Form. The Private Offer will include the AWS Private Offer Order Form and the standard Example Company Subscription Agreement (as provided by Legal). Note that the Order Form's purpose is to highlight what is being sold, and will not be signed by the end customer.
...
1. The Order Form's purpose is to highlight what is being sold, and will not be signed by the end customer. The Private Offer must match the deal elements as approved on the SFDC quote object / Order Form. Customer's acceptance of the Private Offer signifies their acceptance of Example Company's subscription terms.
...
[Example Opportunity](https://example_company.my.salesforce.com/0064M00000ZFzVI)

**Notification, Quoting, and Requirements to Close Deal (DRI = Alliance Operations):**

1. When IBM have closed the deal, an IBM contact will send order confirmation and details to Partnersupport@example_company. The Alliance Operations team monitors this email alias.
...
A copy of the Distributor PO to Example Company must be attached to the opportunity. The Account Manager or ISR will confirm that all details on the PO match the Quote before submitting the Opportunity for approval.
...
After the ISR or Account manager confirms the Distributor PO is correct, a quote object will be created on the opportunity to match the Distributor PO to Example Company.

1. A quote object will be created to match the Distributor PO to Example Company. Most public sector quotes will follow the [standard quote creation process](/handbook/sales/field-operations/sales-operations/deal-desk/#zuora-quote-configuration-guide---standard-quotes).
2. The Distibutor PO Number must be entered on the Quote Object Prior to submitting for approval.
3. The Sold To and Bill To Contact on the quote object must have a complete address that matches the address used on the Distributor PO to Example Company.
4. The Distributor PO to Example Company must be within $1.00 (USD) of the Quote object in order to be accepted.
...
1. If a Professional Services Opportunity will include a custom Statement of Work (SOW) or Change Order (CO) with unique deliverables
   - Note: Professional Services must be sold on standalone opportunity with the ***Opportunity Record Type*** set to ***Professional Services Only***. They must not be sold on the same opportunity as subscription products. The opportunity should be created by going to the Open or Closed Won license opportunity and clicking on the New PS Opportunity button. This will generate a related PS opp.
   - A fully signed copy of the SOW or CO is **required**. Please review the process on obtaining signatures, as the SOW will also need to be counter-signed by an authorized signer at Example Company.
   ...
   - A quote needs to be generated, but only for backend billing automation purpsoes. **Do not share quote with customer or reselling partner!**
     - For Time and Material (T&M) services, the **Example Company Service Package** must be added with the T&M Value from the SOW match the value in the quote line item.
     ...
     - If the SOW contains T&M and FP services, two quotes need to be created. T&M should use the **Example Company Service Package** SKU and match the T&M value in the SOW. The FP Quote should use the matching SKUs in the catalog.
...
- Note: Client/Prospect Form means that the signed document (whether Order Form or MSA) is on the customer's paper rather than a standard Example Company Order Form or Subscription Agreement template.
...
To view the status of an opportunity after it has been submitted for approval, **review the [7-Closing Stage Dashboard](https://example_company.my.salesforce.com/01Z4M000000xeww).**
...
- **Renewal opportunities must be Closed Lost if the renewal is not achieved within 15 days after the Subscription Renewal Date (Renewal Date).**
  - See the [Late Renewal Notification & Auto Close Processes](https://internal.example_company.com/handbook/sales/go-to-market/renewals/#late-renewal-notification--auto-close-process) section of the handbook for details on how the system automatidally supports the 30 day late renewal policy.
...
- Once all of the above have been documented in Chatter, please tag @sales-support on the associated opportunity so that [Sales Operations can take the appropriate actions](https://internal.example_company.com/handbook/sales/sales-operations/#late-renewal-exception-process) to exclude the opportunity from auto closure.

- See the [Late Renewal Notification & Auto Close Processes](https://internal.example_company.com/handbook/sales/go-to-market/renewals/#steps-to-request-an-exception) section of the handbook for details on how the system automatidally supports late renewal exceptions.
...
If there is a PO document and customer wants Example Company to add the PO nr to the invoice, we cannot do that without reviewing the PO document (unless there is no PO document issued)

Customer POs should be remitted to `PO @ example_company.com` (Direct Deals Only)
...
**How does Example Company know that a customer requires POs?**
...
If "PO Required" = "YES" and the customer's PO will be provided to Example Company at a future date, the opportunity will be held for booking until the PO is provided by the customer. Exceptions will only be made at quarter end (see below).
...
If "PO Required" = "YES" and the customer's PO will be provided to Example Company at a future date, exceptions will be considered at quarter end if the following requirements are met:
...
2. The customer provides written confirmation that the PO will be issued to Example Company within 10 days. This written confirmation is attached to the opportunity.
...
Look for Task title: `Email: Your Example Company License File` of `Email: Your Example Company Activation Code`
...
The customer support team is here to resolve technical errors related to the customers subscription. [**DO NOT GO TO CUSTOMER SUPPORT** for License issues until you have read this page](/handbook/support/internal-support/#should-i-contact-example_company-support)

Please check out the support page[/handbook/support/#example_company-support-service-levels] for indepth information on how to contact the team. Spoiler alert, you will need to open an issue or the customer needs to open a Support ticket.
