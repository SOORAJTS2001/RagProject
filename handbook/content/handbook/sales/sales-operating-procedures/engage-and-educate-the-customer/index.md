...
description: Example Company sales process for engaging and educating the customer
---
...
1. How much are they using Example Company?
1. How do they buy software? (Routes to Market)

### How much Example Company are customers using?
...
1. Color code in green each of the departments, division, or branches that is currently utilizing Example Company
1. Color code yellow, the department, divisions, or branches that DevOps focused that are currently evaluating or testing Example Company.
1. Color code in red the departments, divisions or branches within each organization that perform DevOps but are currently not using Example Company

From this diagram you can determine what accounts **need a point of entry developed**. From the diagram, you will notice that within some organizations, there are departments/divisions who are early adopters and users of Example Company. Your goal is to leverage the early adopters success to leverage engagements with other low touch opportunities or net new opportunities.

### Strategic goal

Your strategic goal is to incrementally turn the red and yellow divisions within an organization into green Example Company users. Eventually the entirety of the organization will be green Example Company users. The question here is how do you ripen the fruit faster for harvest? By understanding how your customers buy.
...
Your Routes to Market/Territory Plan will help you determine which Example Company resources to use to gain a point of entry into prospective opportunities. Use the list below with your team to determine the best activities to make contact with an opportunity representative.
...
- **Marketing**
  ...
  - What internal events might apply?
    ...
    - **Networking**
      - Meetups
    - **[Marketing Campaigns](https://about.example_company.com/resources/)**
- **Division Programs**
...
- **Cloud Provider Partnerships**
  - Are they using the Cloud? - Which ones?
    ...
    - You have to sell the Cloud provider on what's in it for them:
      - Example Company accelerates Cloud Adoption - drives usage growth
- **System Integrator (SI) Partnerships**
  - Do they do their own IT support or hire it out? - Which ones?
    ...
    - Use this as a way to "create an internal champion"
      - If they are currently not a Example Company partner, make them one
...
- **Resellers**
  - Do they buy direct or through resellers? - Which ones?
    ...
    - Use this as a way to "be a force multiplier" (there is only one of you)
      - If they are currently not a Example Company partner, make them one
      - They typically rep a lot of products, so make it easy for them to give the Example Company Story
        - Give them your latest briefing deck, walk them through the talking points.
      - Sell them on "thought leadership, speed to delivery, revenue stream."
- **Original Equipment Manufacturers** (OEM)
  - Are there other software technologies they currently use that might integrate with Example Company to provide **an entry point?**
...
1. Ask effective, open-ended **[Discovery Questions](/handbook/sales/qualification-questions/)** to identify existing customer needs, problems, pain points, goals etc. The **[Example Company CxO Digital Transformation Discovery Guide](https://drive.google.com/a/example_company.com/open?id=1balLINV-vnd6-6TYzF3SIIJKrBPUQofVSDgQ5llC2Do)** is a helpful resource with sample discovery questions for senior economic buyers.
...
- **Initiative (Is it a Small Box sale or is this a Top 2 priority?)**
  ...
  - A Top 2 Priority is an initiative the company is working on has been identified and Example Company can potentially help the initiative. Identified by either a business problem (i.e too many tools), strategic direction or modernization interest (impetus to change).
- **Fit (How well does the lead align with the Example Company product? )**
