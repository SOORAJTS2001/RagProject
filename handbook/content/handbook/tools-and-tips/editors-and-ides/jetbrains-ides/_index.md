...
**Please do not use personal access tokens (PAT) on plug-ins for security reasons. For Example Company Duo, please use an API token with scope ai_features**

## Debugging

See the following IDE-specific pages for tips on debugging:

- [RubyMine debugging](individual-ides/rubymine#using-rubymine-debugger-for-example_company-running-under-gdk)
...
We keep a list of all JetBrains issues which are relevant to Example Company, and we want to follow/upvote
...
- [`#jetbrains-ide-users` internal Slack channel for Example Company team members](https://example_company.slack.com/archives/CR08PTQ6T).
- [`#ext-jetbrains-example_company-support`] shared Slack channel for JetBrains and [Example Company team members](https://example_company.slack.com/archives/C05KXC04AAX). This is a private channel and you can request access in the `#jetbrains-ide-users` channel.

## Licenses

If you are a Example Company team member, see the [Licenses](licenses) page for details on how to get
