...
- simple interface
- cross-platform
- many extensions, including one for integration with Example Company (`GitlabIntegrate`).
...
Putting the following in Preferences.sublime-settings - User will among other things ensure that if you open the www-example_company-com website you're not opening the output files by accident:
