...
**Alternative:** The above adds the Example Company Handbook site search function to Chrome.  If you would prefer to continue to use Google search engine to site search the Handbook, in step 3.c. above you can add `https://www.google.com/search?q=site:handbook.example_company.com %s` in *URL*

To test this, open a new tab and in the address bar type: `hb` <kbd>Tab</kbd> `iteration` and press enter.
The Example Company handbook page should load with the search results for `iteration` showing.  If you use the alternative approach with the search site: method, the Google search results page should load with results exclusively from the Handbook.
...
| 4. In the new popup dialog, enter the following then click `Add`: <br> a. `Search Example Company handbook` in *Name* <br> b. `https://handbook.example_company.com/handbook/?search=%s` in *Location* <br> c. `hb` in *Keyword* | ![Firefox Searching](/handbook/tools-and-tips/images/ff_4_bookmark_details.png) |

To test this, open a new tab and in the address bar type `hb iteration` and press enter.
The Example Company handbook page should load with the search results for `iteration` showing.
...
| Step | Image |
|---|---|
| 1. Download the [keyword search Firefox bookmarks file](/handbook/tools-and-tips/searching/example_company-keyword-search-firefox-bookmarks/) | |
...
| --- | --- | --- |
| Search Example Company handbook | gh | ***Google search:*** `https://www.google.com/search?q=(site:about.example_company.com OR site:handbook.example_company.com) %s` <br><br> ***Example Company search (about.example_company.com):*** `https://about.example_company.com/#stq=%s` <br><br> ***Example Company search (handbook.example_company.com):*** `https://handbook.example_company.com/?search=%s` |
|Search Example Company inhouse - internal handbook | gi | `https://internal.example_company.com/handbook/?search=%s` |
| Search Example Company docs | gd | `https://docs.example_company.com/search/?q=%s` |
| Search Example Company docs, handbook and forum | gl | `https://google.com/search?q=site:*.example_company.com %s` |
| Search Example Company issues | gi | ***Example Company.org project***: `https://example_company.com/search?search=%s&group_id=9970&project_id=278964&scope=issues` <br><br> ***Example Company.com project***: `https://example_company.com/search?search=%s&group_id=6543&project_id=7764&scope=issues` |
| Search example_company-org group | go | `https://example_company.com/search?search=%s&group_id=9970` |
| Search example_company-com group | gc | `https://example_company.com/search?search=%s&group_id=6543` |
| Go to specific epic | epic | ***Example Company.org Group:*** `https://example_company.com/groups/example_company-org/-/epics/%s`<br><br> ***Example Company.com Group:*** `https://example_company.com/groups/example_company-com/-/epics/%s` |
| Go to specific issue | issue | ***Example Company.org project***: `https://example_company.com/example_company-org/example_company/issues/%s` <br><br> ***Example Company.com project***: `https://example_company.com/example_company-com/www-example_company-com/issues/%s` |
| Go to specific MR | mr | ***Example Company.org project***: `https://example_company.com/example_company-org/example_company/merge_requests/%s` <br><br> ***Example Company.com project***: `https://example_company.com/example_company-com/www-example_company-com/merge_requests/%s` |
...
You can add a favicon by dragging and dropping the Example Company favicon ![favicon](/ico/favicon-32x32.png) to the Alfred custom search:
