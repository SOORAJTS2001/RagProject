...
and [Reminders](/handbook/support/readiness/operations/docs/zendesk/apps/#example_company-reminders-app)
...
do not promise that it will be. See more in our [documentation style-guide](https://docs.example_company.com/ee/development/documentation/versions#promising-features-in-future-versions).
...
- Admin
- Example Company Staff
- Example Company Staff - Explore
- Security Staff
- Support Managers
- Support Staff
- Support Staff - CMOC
...
## Handling tickets created by Example Company team members

Every now and then, a Example Company team member will forward a support request from a
...
[General::Closing Summary](https://example_company.com/example_company-com/support/support-ops/zendesk-global/macros/-/blob/master/macros/active/General/Closing%20Summary.yaml) macro, which adds a template as an internal note
