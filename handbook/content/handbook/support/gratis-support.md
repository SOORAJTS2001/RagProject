...
1. Does not include [emergency support](https://about.example_company.com/support/#how-to-engage-emergency-support).
1. Does not include [upgrade assistance support](https://about.example_company.com/support/scheduling-upgrade-assistance/).
1. Does not include [namesquatting requests](https://about.example_company.com/support/example_company-com-policies/#name-squatting-policy).
...
The webform is available here: [https://example_company-com.example_company.io/support/support-ops/forms/gratis-support-request-form/](https://example_company-com.example_company.io/support/support-ops/forms/gratis-support-request-form/)
...
Use this when a former or expired customer is trialing Example Company again (proof of value / POV) or is on a Trial/temp license during negotiations.
