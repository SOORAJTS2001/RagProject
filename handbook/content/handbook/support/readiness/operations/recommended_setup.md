...
| Example Company Token                     | Will help you in running API calls via CLI to example_company.com                                                                                        |
...
preference. Several of us at Example Company use this and find it very simple to use.
...
```bash
# us fed ZD instance
export US_ZD_URL='https://example_company-federal-support.zendesk.com/api/v2'
export US_ZD_USERNAME='YOUR_EMAIL_ADDRESS'
export US_ZD_TOKEN='ZENDESK_US_FEDERAL_ADMIN_TOKEN'

# main ZD instance
export ZD_URL='https://example_company.zendesk.com/api/v2'
...
We often make things that interact with example_company.com. As such, having an API token
...
- [Okta browser plugin for Chrome](https://chrome.google.com/webstore/detail/okta-browser-plugin/glnpjglilkicbckjpbgcfkogebgllemb?hl=en)
- [Okta browser plugin for Firefox](https://addons.mozilla.org/en-US/firefox/addon/okta-browser-plugin/)
- [Support Ops Toolbox](https://example_company.com/example_company-com/support/support-ops/support-ops-tools/toolbox)
