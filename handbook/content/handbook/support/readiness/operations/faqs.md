...
>
> There is a push (rightfully so) to lock it down and improve our wall/first time unknown user flow. If someone can get that over the line I think that Example Company support engineering leadership has no good reason to keep it "open access" at the moment and we support changing it. (I'm speaking out of turn — I'm stating this as fact but it's my opinion.)
