...
[support ops issue tracker](https://example_company.com/example_company-com/support/support-ops/support-ops-project/-/issues/new)
...
[ticket processor](https://example_company.com/example_company-support-readiness/zendesk-global/tickets/processor)
(on ops.example_company.net). This then combines the Support Operations and Support Team
...
sync integration has hit an issue. Luckily, we have the Example Company built sync script
that runs every hour to rectify such issues.

In your due diligence, you would want to create an issue via the
[Zendesk Organization Repo](https://example_company.com/example_company-com/support/zendesk-global/organizations/-/issues/new)
