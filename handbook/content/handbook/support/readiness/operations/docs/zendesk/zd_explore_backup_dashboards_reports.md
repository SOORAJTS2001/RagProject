...
- Filters used:
    1. Created By Example Company Bot Agent*
    1. Ticket Form
- Custom Settings:
    1. (*) represents standard calculated metrics.
    1. Ticket Form filter should exclude `Example Company Incidents`, `Professional Services`, `Security`, `Billing`, `Accounts Receiveable/Refunds`, `Security Issue`.
    1. Created By Example Company Bot Agent is a custom attribute and should have included `Regular Ticket`.
...
- Columns:
    ...
    1. SLA Update - Month
- Filters used:
    1. Example Company Plan
    1. Ticket Form
    1. Has Plan - Ticket Tags
- Custom Settings:
    1. Example Company Plan filter should include `Basic`, `Bronze`, `Gold`, `Premium`, `Silver`, `Ultimate`.
    1. Ticket Form filter should include `SaaS`, `SaaS Acocunt`, `Self-Managed`.
    1. Has Plan - Ticket Tags is a custom attribute and setting of Includes have `Has Plan` checked.
    1. SLA Update - Year filter was used and it use Advanced Date Range settings i.e. "From beginning of" should have `13 months in the past` to "The end of" should have `1 month in the past`.
    1. Make sure report should have "Sort" type `A-Z` and Percentage is shown inside every bar in Result Manipulation.
...
- Custom Settings:
    ...
    1. Update Name filter excludes `Example Company Support`, `Example Company SupportOps Bot`, `SupportOps`.
    1. Has Plan - Ticket Tags is a custom attribute and includes should have `Has Plan`.
...
- Columns:
    1. Ticket Form
        (Includes `Example Company Dedicated`, `L&R`, `SaaS`, `SaaS Account`, `Self-Managed` only.)
- Filters used:
    1. Updater Tags
    1. Update - Month
- Custom Settings:
...
1. Created By Example Company Bot Agent:
    ...
    ```Text
    IF (INCLUDES_ANY([Ticket tags],"example_company-361112","com_gitlab_354791"))
    THEN "Created By Example Company Bot Agent"
    ELSE "Regular Ticket"
    ENDIF
    ```
...
1. SM Ticket Count:
    ...
    "Self-Managed",
    "Other Request",
    "Example Company Community Edition (CE)")
...
1. .com Ticket Count
    ...
    IF IN([Ticket form], ARRAY(
    "SaaS",
    "Example Company Hosted (GitHost.io)",
