...
- `gitlab_username` - An agent's Example Company.com username
- `gitlab_user_id` - An agent's Example Company.com user ID

As an example, to find one where the Example Company.com username is jcolyer, you would
do:
