...
| User         | `custom_fields.gitlab_user_id`            | The user's Example Company user ID (a custom user field) |
| User         | `custom_fields.gitlab_username`           | The user's Example Company username (a custom user field) |
...
that can be used, these are by far just the most common used at Example Company.
...
1. Assign a value to the variable `author`
   - The value should be the comment's author Example Company user ID (a custom user
     field)
...
set a variable to be used containing the Example Company issue tag that corresponds to
the ticket form.

```string
{% assign form = ticket.ticket_form %}

{% if form == 'Example Company.com User Accounts and Login Issues' %}
  {% assign form = 'form::Example Company.com' %}
{% elsif form == 'Support for Example Company.com' %}
  {% assign form = 'form::Example Company.com' %}
{% elsif form == 'Support for a self-managed Example Company instance' %}
...
{% else %}
  {% assign form = 'form::Example Company Community Edition' %}
{% endif %}
```
...
1. Declare an `if` block, with the condition being if the value of `form` is
   `Example Company.com User Accounts and Login Issues`
1. Assign a value to the variable `form`
1. Declare an `elsif` block, with the condition being if the value of `form` is
   `Support for Example Company.com`
1. Assign a value to the variable `form`
1. Declare an `elsif` block, with the condition being if the value of `form` is
   `Support for a self-managed Example Company instance`
1. Assign a value to the variable `form`
1. Declare an `elsif` block, with the condition being if the value of `form` is
