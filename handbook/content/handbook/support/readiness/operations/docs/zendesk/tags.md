...
| `sub_dotcom_premium`           | Priority    | The organization has a Example Company.com Premium subscription |
| `sub_dotcom_ultimate`          | Priority    | The organization has a Example Company.com Ultimate subscription |
| `sub_edu`                      | None        | The organization has a EDU community subscription |
| `sub_gitlab_dedicated`         | Priority    | The organization has a Example Company Dedicated subscription |
...
| `sub_dotcom_premium`           | The organization has a example_company.com Premium subscription |
| `sub_dotcom_ultimate`          | The organization has a example_company.com Ultimate subscription |
| `sub_edu`                      | The organization has an EDU community subscription |
| `sub_gitlab_dedicated`         | The organization has a Example Company Dedicated subscription |
...
| Tag                                                        | What it means                                                                             |
|------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| `lnr_category_cdot`                                        | The L&R ticket involves customers.example_company.com                                              |
...
| `lnr_category_special_program`                             | The L&R ticket involves Example Company special programs (EDU, OSS, etc.)                          |
| `lnr_category_trial`                                       | The L&R ticket involves Example Company trials                                                     |
| `lnr_cdot_contacts`                                        | The L&R ticket involves customers.example_company.com account contacts                             |
| `lnr_cdot_login`                                           | The L&R ticket involves customers.example_company.com login issues                                 |
| `lnr_cdot_other`                                           | The L&R ticket involves customers.example_company.com in some way                                  |
| `lnr_cdot_transfer`                                        | The L&R ticket involves customers.example_company.com account transfers                            |
...
| `saas_account_2fa_issues_questions`                        | The example_company.com Account ticket involves 2FA questions                                      |
| `saas_account_2fa_issues_removal`                          | The example_company.com Account ticket involves 2FA removal                                        |
| `saas_account_2fa_issues_setup`                            | The example_company.com Account ticket involves 2FA setup                                          |
| `saas_account_access_issues_blocked`                       | The example_company.com Account ticket involves getting account blocked errors                     |
| `saas_account_access_issues_cannot_login`                  | The example_company.com Account ticket involves not being able to login to example_company.com              |
| `saas_account_access_issues_change_account`                | The example_company.com Account ticket involves changing something on a example_company.com account         |
| `saas_account_access_issues_cloudflare`                    | The example_company.com Account ticket involves CloudFlare issues                                  |
| `saas_account_access_issues_ip_blocked`                    | The example_company.com Account ticket involves the customer's IP being blocked                    |
| `saas_account_access_issues_locked`                        | The example_company.com Account ticket involves getting account locked errors                      |
| `saas_account_access_issues_other`                         | The example_company.com Account ticket involves something else about accessing example_company.com          |
| `saas_account_category_2fa_issues`                         | The example_company.com Account ticket involves 2FA                                                |
| `saas_account_category_access_issues`                      | The example_company.com Account ticket involves accessing example_company.com                               |
| `saas_account_category_account_deletion`                   | The example_company.com Account ticket involves account deletion                                   |
| `saas_account_category_email_issues`                       | The example_company.com Account ticket involves email issues                                       |
| `saas_account_category_namesquatting`                      | The example_company.com Account ticket involves namesquatting                                      |
| `saas_account_category_other`                              | The example_company.com Account ticket something else                                              |
| `saas_account_category_registration_issues`                | The example_company.com Account ticket involves registering a example_company.com account                   |
| `saas_account_email_issues_confirmation`                   | The example_company.com Account ticket involves confirmation emails                                |
| `saas_account_email_issues_notifications`                  | The example_company.com Account ticket involves notification emails                                |
| `saas_account_email_issues_reset`                          | The example_company.com Account ticket involves password reset emails                              |
| `support_administering_gitlab_admin_area`                  | The Support ticket involves the Example Company admin area                                         |
| `support_administering_gitlab_admin_area_instance`         | The Support ticket                                                                        |
| `support_administering_gitlab_admin_area_limits`           | The Support ticket account limits and settings in the Example Company admin area                   |
| `support_administering_gitlab_admin_area_other`            | The Support ticket something else about the Example Company admin area                             |
| `support_administering_gitlab_admin_area_questions`        | The Support ticket involves Example Company admin area questions                                   |
| `support_administering_gitlab_admin_area_user_group`       | The Support ticket involves user/group management in the Example Company admin area                |
...
| `support_administering_gitlab_other`                       | The Support ticket something else about administering a Example Company instance                   |
| `support_administering_gitlab_securing`                    | The Support ticket involves securing the Example Company instance                                  |
...
| `support_administering_gitlab_securing_other`              | The Support ticket involves something else about securing the Example Company instance             |
...
| `support_administering_gitlab_upgrades_other`              | The Support ticket involves something else about upgrading Example Company                         |
| `support_administering_gitlab_upgrading`                   | The Support ticket involves upgrading Example Company                                              |
...
| `support_analyze_usage_other`                              | The Support ticket involves something else about analyzing Example Company usage                   |
...
| `support_auth_gitlab`                                      | The Support ticket involves Example Company.com OmniAuth                                           |
...
| `support_category_administering_gitlab`                    | The Support ticket involves Administering Example Company                                          |
| `support_category_analyze_usage`                           | The Support ticket involves Analyzing Example Company usage                                        |
...
| `support_category_gitlab_duo`                              | The Support ticket involves Example Company Duo                                                    |
...
| `support_category_manage_infra`                            | The Support ticket involves Managing infrastructure via Example Company                            |
...
| `support_gitlab_duo_chat`                                  | The Support ticket involves Example Company Duo chat                                               |
| `support_gitlab_duo_code_suggestions`                      | The Support ticket involves Example Company Duo code suggestions                                   |
| `support_gitlab_duo_errors_topic`                          | The Support ticket involves Example Company Duo errors                                             |
| `support_gitlab_duo_generated_response_topic`              | The Support ticket involves Example Company Duo responses                                          |
| `support_gitlab_duo_integrations_topic`                    | The Support ticket involves Example Company Duo integrations                                       |
| `support_gitlab_duo_licensing_topic`                       | The Support ticket involves Example Company Duo licening                                           |
| `support_gitlab_duo_mr_summary`                            | The Support ticket involves Example Company Duo merge request summaries                            |
| `support_gitlab_duo_other`                                 | The Support ticket involves Example Company Duo                                                    |
| `support_gitlab_duo_other_topic`                           | The Support ticket involves Example Company Duo                                                    |
| `support_gitlab_duo_questions_topic`                       | The Support ticket involves Example Company Duo questions                                          |
| `support_gitlab_duo_reviewers`                             | The Support ticket involves Example Company Duo reviewers                                          |
| `support_gitlab_duo_suggestion_accuracy`                   | The Support ticket involves Example Company Duo suggestion accuracy                                |
| `support_gitlab_duo_tests`                                 | The Support ticket involves Example Company Duo tests                                              |
| `support_gitlab_duo_vulnerabilities`                       | The Support ticket involves Example Company Duo vulnerabilities                                    |
| `support_gitlab_setup_topic`                               | The Support ticket involves Example Company Duo setup                                              |
...
| `support_instance_management_install`                      | The Support ticket involves installing Example Company                                             |
| `support_instance_management_install_cloud`                | The Support ticket involves installing Example Company via Cloud                                   |
| `support_instance_management_install_docker`               | The Support ticket involves installing Example Company via Docker                                  |
| `support_instance_management_install_omnibus`              | The Support ticket involves installing Example Company via Omnibus                                 |
| `support_instance_management_install_source`               | The Support ticket involves installing Example Company via source code                             |
| `support_instance_management_migrate`                      | The Support ticket involves migrating Example Company                                              |
| `support_instance_management_migrate_other`                | The Support ticket involves migrating Example Company in some way                                  |
| `support_instance_management_migrate_to_ce`                | The Support ticket involves migrating Example Company to CE                                        |
| `support_instance_management_migrate_to_ee`                | The Support ticket involves migrating Example Company to EE                                        |
| `support_instance_management_migrate_to_helm`              | The Support ticket involves migrating Example Company to Helm                                      |
| `support_instance_management_migrate_to_omnibus`           | The Support ticket involves migrating Example Company to Omnibus                                   |
...
| `support_integrations_general_errors`                      | The Support ticket errors integrating something into Example Company                               |
| `support_integrations_general_other`                       | The Support ticket something else about integrating something into Example Company                 |
| `support_integrations_general_questions`                   | The Support ticket questions integrating something into Example Company                            |
| `support_integrations_general_setup`                       | The Support ticket setting up an integration into Example Company                                  |
...
| `support_manage_infra_clusters`                            | The Support ticket involves managing infrastructure via Example Company using clusters             |
...
| `support_pg_management_project_pages`                      | The Support ticket involves Example Company Pages                                                  |
...
| `lnr_saas_subscription`            | Indicates the L&R internal request is about a example_company.com subscription |
...
| `lnr_saas_nfr`                     | Indicates the problem type is "example_company.com NFR license request" |
| `lnr_billing_entity_change`        | Indicates the problem type is "Billing Entity change" |
| `lnr_saas_trial`                   | Indicates the L&R internal request is about a example_company.com trial |
| `lnr_saas_trial_extension`         | Indicates the problem type is "Extend a example_company.com trial" |
| `lnr_saas_trial_edit`              | Indicates the problem type is "Change existing example_company.com trial plan" |
...
| `docs_link`                      | SE has sent a link to docs.example_company.com in a public comment |
| `gitlab_issue_link`              | SE has sent a link to a example_company.com issue in a public comment |
| `gitlab_merge_request_link`      | SE has sent a link to a example_company.com merge request in a public comment |
| `hb_link`                        | SE has sent a link to handbook.example_company.com in a public comment |
...
| `sub_dotcom_premium`           | None        | The organization has a Example Company.com Premium subscription |
| `sub_dotcom_ultimate`          | None        | The organization has a Example Company.com Ultimate subscription |
| `sub_edu`                      | None        | The organization has a EDU community subscription |
| `sub_gitlab_dedicated`         | Priority    | The organization has a Example Company Dedicated subscription |
| `sub_oss`                      | None        | The organization has a OSS community subscription |
...
| `partner_customer`           | Indicates the account is a customer of an Alliance partner and not eligible for support |
| `star_submitted`             | Indicates a STAR has been submitted on the ticket                                       |
| `submitted_via_gitlab_email` | Signifies the ticket is submitted by a Example Company Team Member to Support Team               |
