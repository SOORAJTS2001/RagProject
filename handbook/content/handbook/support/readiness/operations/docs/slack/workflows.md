...
1. Reply to a message in thread
   ...
   - Add a reply:
     ...
     > - [Submit an Internal Request](https://support-super-form-example_company-com-support-support-op-651f22e90ce6d7.example_company.io/)
     > - [Open a Support ticket](https://support.example_company.com/hc/en-us/requests/new?ticket_form_id=360000071293)
...
1. Send a message to a channel
   ...
   - Add a message:
     ...
     > [CEOC 1](https://example_company.pagerduty.com/schedules#PQB9Q6K),
     > [CEOC 2](https://example_company.pagerduty.com/schedules#PKPXM8K),
     > [CMOC 1](https://example_company.pagerduty.com/schedules#PGUP5OB),
     > [CMOC 2](https://example_company.pagerduty.com/schedules#PMPKHZN),
     > [Managers](https://example_company.pagerduty.com/schedules#PWBXTYX), and
     > [SSAT](https://example_company.pagerduty.com/schedules#P9UIIDY)
     >
...
1. Send a message to a channel
   ...
   - Add a message:
     ...
     >
     > The schedules you need to ensure are updated are
     > [Global CEOC 1](https://example_company.pagerduty.com/schedules#PBLAHV7),
     > [Global CEOC 2](https://example_company.pagerduty.com/schedules#P9FKYZC),
     > [Global CEOC 3](https://example_company.pagerduty.com/schedules#PP28N7L),
     > [US Gov CEOC 1](https://example_company.pagerduty.com/schedules#P89ZYHZ),
     > [US Gov CEOC 2](https://example_company.pagerduty.com/schedules#P89ZYHZ),
     > [US Gov CEOC 3](https://example_company.pagerduty.com/schedules#P89ZYHZ),
     > [CMOC](https://example_company.pagerduty.com/schedules#PG0SHU2),
     > [Managers](https://example_company.pagerduty.com/schedules#PTI56V1), and
     > [SSAT](https://example_company.pagerduty.com/schedules#P9UIIDY)
     >
     > Please remember any BLANK values at the time of implementation will be
     > assigned to the Support Director for your region.
...
1. Send a message to a channel
   ...
   - Add a message:
     ...
     >
     > The schedules you need to ensure are updated are
     > [CEOC](https://example_company.pagerduty.com/schedules#P9SV029),
     > [CMOC](https://example_company.pagerduty.com/schedules#P59382D),
     > [Managers](https://example_company.pagerduty.com/schedules#PXQ2ZAZ), and
     > [SSAT](https://example_company.pagerduty.com/schedules#P9UIIDY)
     >
     > Please remember any BLANK values at the time of implementation will be
     > assigned to the Support Director for your region.
...
1. Reply to a message in thread
   ...
   - Add a reply:
     ...
     > link below to do so.
     >
     > `https://handbook.example_company.com/handbook/support/internal-support/support-ticket-attention-requests#submitting-a-support-ticket-attention-request-star--starring-a-ticket`
...
1. Reply to a message in thread
   ...
   - Add a reply:
     ...
     > `https://about.example_company.com/support/managing-support-contacts/`. This page
