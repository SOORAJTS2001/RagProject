...
canonical_path: "/handbook/support/readiness/operations/docs/example_company/contact_management_projects"
---

<sup>*Introduced via [support-team-meta#4531](https://example_company.com/example_company-com/support/support-team-meta/-/issues/4531)*</sup>

## What is a contact management project?

Contact management projects are projects on Example Company.com that allows a customer to
manage their support contacts on Zendesk Global.

## How does it work

When commits are made on the project in question, a webhook triggers with
specific variables to trigger a pipline on ops.example_company.net that is using the code
from the
[contacts project](https://example_company.com/example_company-com/support/support-ops/zendesk-global/contacts).
...
**NOTE** If the customer is using a example_company.com subscription, we should only
...
[Advanced search](https://example_company.zendesk.com/agent/apps/advanced-search). When
...
[zd-global-orgs group](https://example_company.com/groups/support/zd-global-orgs).
...
- Project files
  - CONTACTS.md
    - Verify the contents match what is detailed
      [here](https://example_company.com/support/zd-global-orgs/project-templates/contact-management-project-template/-/blob/master/CONTACTS.md)
  - contacts.yaml
    - Verify the contents match what is detailed
      [here](https://example_company.com/support/zd-global-orgs/project-templates/contact-management-project-template/-/blob/master/contacts.yaml)
...
- URL:
  `https://example_company.com/api/v4/projects/39250741/ref/master/trigger/pipeline?token=TOKEN&variables[PROJECT_ID]=PROJECT_ID`
...
- Click the bubble next to `Mask portions of URL`
  ...
  - Verify the URL preview value now looks like:
    - `https://example_company.com/api/v4/projects/39250741/ref/master/trigger/pipeline?token={TOKEN}&variables[PROJECT_ID]=123456789`
...
- You can, if you want to, set the `CMP Developers` field to have the developers
  ...
  [CMP Dev Sync project](https://example_company.com/example_company-support-readiness/zendesk-global/cmp-dev-sync/)
...
[here](https://example_company.com/support/zd-global-orgs/aaa-jason-test-setup-zzz/-/blob/master/contacts.yaml).
...
sync pipeline on ops.example_company.net).
