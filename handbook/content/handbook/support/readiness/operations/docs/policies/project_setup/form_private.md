---
title: Form (internal)
description: Support Operations policies page for project setup for forms open to Example Company team members only
canonical_path: "/handbook/support/readiness/operations/docs/policies/project_setup/form_private"
---

For forms intended only for internal submissions (i.e. Example Company team members
only), the end-location of the form needs to be within the example_company-com parent
namespace. To facilitate this, we utilize the
[support-ops/forms group](https://example_company.com/example_company-com/support/support-ops/forms)
as the end-location.
...
[example_company-support-readiness/forms](https://example_company.com/example_company-support-readiness/forms)
...
end-location. In the case of forms open to Example Company team members only, that is the
[support-ops/forms group](https://example_company.com/example_company-com/support/support-ops/forms).
