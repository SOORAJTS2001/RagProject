...
1. Locate the user in question (either via the `Users` tab on the organization
   ...
   - If the user in question was one mentioned in an organization note
     ...
     [organizations project](https://example_company.com/example_company-com/support/zendesk-global/organizations).
...
1. You should first use the macro
   ...
   1. Go to the
      [Advanced Search app](https://example_company.zendesk.com/agent/apps/advanced-search),
...
This information is publicly available on https://about.example_company.com/support/portal/
...
- For Example Company.com Users:
  - The Example Company.com account associated to the requester's email address should
    have listed the secondary email as verified. You can check this via the User
    Lookup app. To add secondary email to Example Company.com account, they can follow this
    [documentation](https://docs.example_company.com/ee/user/profile/#add-emails-to-your-user-profile)
- For Self Managed and Example Company Dedicated Users:
...
- For Partners:
  - Most Partners do not have paid subscription. If they have a paid
    ...
    Example Company.com or Self Managed.
...
1. If you determine the ticket is from a free or community user, make sure to set the `Example Company Plan` to `Free`
