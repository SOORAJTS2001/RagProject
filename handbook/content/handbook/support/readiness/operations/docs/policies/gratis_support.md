...
<sup>*Introduced via [support-team-meta#2408](https://example_company.com/example_company-com/support/support-team-meta/-/issues/2408)*</sup>
...
```bash
curl -ss https://example_company.zendesk.com/api/v2/tickets/TICKET_ID \
   -H "Content-Type: application/json" \
   -u support-ops@example_company.com/token:YOUR_ZD_ADMIN_TOKEN \
   -X PUT \
...
| Example Company Plan            | See below                    |
| ARR                    | 0                            |
...
For `Example Company Plan`, you need to review the opportunity to determine if this is
a example_company.com or Self-Managed opportunity. If you cannot determine it, please ask
the requester on the issue to clarify that.

If it is example_company.com, use `Prospect Dotcom`. If it is Self-Managed, use
`Prospect SM`.
...
>
> - All example_company,com related tickets should be submitted via
>   [this form](https://support.example_company.com/hc/en-us/requests/new?ticket_form_id=334447&tf_360005241679=saas_prospect_customer)
>   unless it is specifically about example_company,com Account related matters
> - All example_company,com Account related matters should be submitted via
>   [this form](https://support.example_company.com/hc/en-us/requests/new?ticket_form_id=360000803379&tf_360005241679=saas_prospect_customer)
> - All Self-Managed related tickets should be submitted via
>   [this form](https://support.example_company.com/hc/en-us/requests/new?ticket_form_id=426148&tf_360005182220=sm_prospect_customer)
> - Every ticket should ensure the "Tell us about your Example Company subscription"
...
> - example_company.com tag(s): DOTCOM_TAG
>
...
| DOTCOM_TAG        | The example_company.com tag the organization is using   | `silver`, `gold`                 |
