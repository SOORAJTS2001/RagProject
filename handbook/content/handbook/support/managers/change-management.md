---
title: Change Management in Example Company Support
description: Decision Making and Change Management in the Example Company Support Leadership Team
---

## Decision Making and Change Management in the Example Company Support Leadership Team

The Example Company Support Team may very well be unique among the many teams within the
...
### This process is not limited to the Example Company Support Leadership Team
...
exclusively handled by the Example Company Support Leadership Team. For that reason, this
...
- [Slack groups per region](https://example_company.com/example_company-com/support/support-team-meta/-/issues/4618#example_company-support-process-change-rollout-plan)
- [Limit PagerDuty Notifications in `#support_self-managed` to Triggered Events](https://example_company.com/example_company-com/support/support-team-meta/-/issues/5090)
...
with the [Request for Comments](https://example_company.com/example_company-com/support/support-team-meta/-/issues/new?issuable_template=Request%20for%20Comments)
...
[create a Requested Change issue](https://example_company.com/example_company-com/support/support-team-meta/-/issues/new?issuable_template=Requested%20Change)
in the [support-team-meta project](https://example_company.com/example_company-com/support/support-team-meta).
...
- As an additional guardrail also add the group `@example_company-com/support/managers` to the issue to ensure that the support management team are informed about the proposed change
...
- Add the label ~"Manager Attention" to ensure that the support management team are informed about the proposed change
- As an additional guardrail also add the group `@example_company-com/support/managers` to ensure that the support management team are informed about the proposed change
...
[Process Change Rollout Plan issue](https://example_company.com/example_company-com/support/support-team-meta/-/issues/new?issuable_template=support-change-rollout).
