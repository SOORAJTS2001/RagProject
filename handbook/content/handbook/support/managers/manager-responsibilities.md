...
## Support Leadership at Example Company

Leadership at Example Company is a unique opportunity to embody and model the Example Company Values. The responsibilities of Support Managers can be grouped into two broad categories:

| Responsibilities | Example Company Values |
| ---------------- | ------------- |
...
Our primary responsibility in the Support Leadership team is to ensure high quality Customer Support for Example Company customers. To fulfill this responsibility we set and achieve goals (aligned with Example Company Strategy and Engineering [OKRs](/handbook/company/okrs/)), and ensure Support Engineers can achieve *their* goals.

| SSAT Responsibility | Sub-responsibility |
| ------------------- | ------------------ |
| Help support engineers to resolve tickets accurately and efficiently | Understand Example Company [Support Service Levels](https://about.example_company.com/support/#example_company-support-service-levels) and [KPIs](/handbook/support/#how-we-measure-our-performance) |
|  | Know how we use Zendesk, [Slack](#working-in-slack), and Example Company for ticket management |
...
|  | Work with Example Company Sales, Pricing, Product, and other teams when company initiatives change Support requirements |
...
|  | Propose, develop, and evaluate improvements to Support processes by acting as DRI for [issues in the Support Meta project](https://example_company.com/example_company-com/support/support-team-meta/-/issues) |
| Stay up-to-date on Example Company Product, Strategy, Pricing, etc. | Contribute to and read the [Support Week in Review](/handbook/support/#support-week-in-review) document every week |
...
We are equally responsible to ensure our team members are supported in their Example Company journey, and are able to bring their best selves to work every day.
...
|  | Review, approve, and merge Example Company Issues and MRs from direct reports |
...
|  | Train Support Engineers via the [Interview Training module](https://example_company.com/example_company-com/support/support-training/-/issues/new?issue%5Bassignee_id%5D=&issue%5Bmilestone_id%5D=#) to prepare them for grading technical assessments and performing technical interviews |
...
Weekly 1:1 meetings are a crucial part of Remote Culture at Example Company. Refer to the [Support Engineer Responsibilities page](/handbook/support/support-engineer-responsibilities) to understand what your team members are aiming to achieve.
...
We are committed to helping you develop your skills through continuous learning. The Example Company [Learning and Development team](/handbook/people-group/learning-and-development/) provides opportunities for exploration and training.
...
Consider participating in, creating, or publicizing a [Example Company Book Club](/handbook/leadership/book-clubs/).
