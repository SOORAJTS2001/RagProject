...
At Example Company we have [weekly 1-1s](/handbook/leadership/1-1/).
...
You may choose to use the 1:1 Issue Generator for your 1:1s.  See the project [Readme](https://example_company.com/example_company-com/support/1-1s/1-1-issue-generator/-/blob/master/README.md) for more details.
...
Questions like these help open the conversation and put the work-related aspects in context. (Credit for the idea from [this Example Company conversation](https://twitter.com/example_company/status/1244728191069171716).)
...
1. Assigned tickets: `https://example_company.zendesk.com/agent/users/{USER_ID}/assigned_tickets` Replace `{USER_ID}` with the engineer's ZenDesk userid (shown in the address bar when viewing their profile).
1. All tickets commented on: `https://example_company.zendesk.com/agent/search/1?q=commenter%3A{USER_ID}%20order_by%3Aupdated_at%20sort%3Adesc` Replace `{USER_ID}` with the engineer's ZenDesk userid
1. Pairings completed - [Link to the pairings summary page](https://example_company-com.example_company.io/support/support-pairing/)
...
1. Bug fixes - [Link example](/handbook/support/support-engineer-responsibilities#8-fix-example_company-bugs-and-create-features-occasionally)
