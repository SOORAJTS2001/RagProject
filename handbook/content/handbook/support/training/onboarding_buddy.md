...
These responsibilities of the Support onboarding buddy are an extension of [the Example Company Onboarding Buddy responsibilities](/handbook/people-group/general-onboarding/onboarding-buddies/#buddy-responsibilities), so please review that page first.
...
| |Call to help them update the team page, Example Company Sandbox Cloud for GCP, the GDK, or anything else they may have questions about or trouble with. |
...
- Explain the SWIR and options for staying informed, like [digest issues](https://example_company.com/example_company-com/support/readiness/support-week-in-review/-/issues/?sort=created_date&state=all&label_name%5B%5D=SWIR%3A%3ADigest&first_page_size=50) (and [label subscriptions](https://docs.example_company.com/ee/user/project/labels.html#receive-notifications-when-a-label-is-used) for a "newsletter experience"), the [#spt_swir](https://example_company.enterprise.slack.com/archives/C05VDJX6KSR) Slack channel, or the [audio edition](https://drive.google.com/drive/u/0/folders/1qkKVAHg-kvtDrxWYmegNwmxc1MwuUn4D)
- Show them some helpful handbook pages to read during onboarding
- Show them the Example Company [architecture diagrams](/handbook/customer-success/professional-services-engineering/workflows/artifacts/arch-diagram.html)
- Show them some product or [support-team-meta](https://example_company.com/example_company-com/support/support-team-meta) issues and clarify that they can contribute to anything
...
- Show them our [Testing Environments](/handbook/support/workflows/test_env), and introduce them to Example Company Sandbox Cloud for GCP (which replaced [support-resources](https://example_company.com/example_company-com/support/support-resources))
- Help them update the [Example Company team page](/handbook/company/team/) with their info (one of their Onboarding Issue checklist items)
...
- Introduction to Zendesk and how we use it:
  ...
  - Talk about [setting salutations in signature](https://example_company.com/example_company-support-readiness/support-team/-/wikis/Support-team-entry/Zendesk#zendesk-hash-object)
...
- Pair on tickets:
  ...
  - Reproduce problems whenever you can. Show them how to quickly spin up an instance using your preferred method (Docker, Example Company Sandbox Cloud for GCP, etc.)
