...
This will allow everyone to gain more knowledge regarding the various Example Company integrations and an easier location to share the knowledge across regions.

## Current objectives

- Collaborate on tickets related to:
  - Import/Export of projects
  - The various Example Company Integrations we have (as owned by the [Manage::Integrations group](https://about.example_company.com/direction/manage/integrations/#integration-ownership))
...
- Slack channel: [#spt_pod_import_and_integrate](https://example_company.slack.com/archives/C052K0Z1F8T)
