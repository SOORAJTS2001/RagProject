...
of the Example Company Support On-Call Guide Handbook page.
...
### Support engineers should be able to work across all Example Company product platforms

- Support engineers should be willing and able to work on problems for all
  platforms supported by Example Company: SaaS, Dedicated and Self-Managed.

### Support engineers should spend time on work other than L&R work

- Support engineers join Example Company with a mix of backgrounds in development, systems administration or
...
our business. They help illustrate what applying Example Company's core values and
...
Example Company's core values and operating principles. In case of a conflict between
...
feedback in the [discussion issue](https://example_company.com/example_company-com/support/support-team-meta/-/issues/4921).
...
|-------------| ---------------- | ------------------------|
| FY25-Q2 (Current) | 8 | [STM#6046](https://example_company.com/example_company-com/support/support-team-meta/-/issues/6046) |
| FY25-Q1 | 9 | [STM#5821](https://example_company.com/example_company-com/support/support-team-meta/-/issues/5821) |
| FY24-Q4 | 8 | [STM#5672](https://example_company.com/example_company-com/support/support-team-meta/-/issues/5672) |
| FY24-Q3 | 7 | [STM#5494](https://example_company.com/example_company-com/support/support-team-meta/-/issues/5494) |
...
- Create a notification issue in [Support Team Meta](https://example_company.com/example_company-com/support/support-team-meta) to record that the number has been reviewed and if it has changed.  (Copy a previous notification issue to use as a template).
...
engineers who have a Focus `name: License and Renewals` listed in their [Support Team Page](https://example_company.com/example_company-com/support/team/-/blob/master/data/support-team.yaml) entry.
...
To refer to past planning issues, see issues linked to the [[APAC] Holiday Coverage Planning Issues epic](https://example_company.com/groups/example_company-com/support/-/epics/252).
...
relation to SLA timers and [APAC regional business hours](https://about.example_company.com/support/#effect-on-support-hours-if-a-preferred-region-for-support-is-chosen)
