...
Generally, we do not support mixed license or multiple subscriptions for a single Example Company instance or Example Company.com group. Only one license can be used on a Example Company instance at a time; similarly, only one subscription can be associated to a Example Company.com group namespace at a time. If customers have multiple subscriptions and they wish to use the subscription on a Example Company instance/Example Company.com group, the latest subscription needs to be submitted as add-on to the existing subscription.
...
Example case: [ZD ticket: #162478](https://example_company.zendesk.com/agent/tickets/162478) (internal)
...
This is being actively discussed in [Route to Market Mid-Term Change Alignment](https://example_company.com/example_company-com/Finance-Division/finance/-/issues/3334). For now, we should generate a new license that will include seats from both existing and new subscription for customer.
...
This is quite similar but reverse to merging the subscriptions. If customer purchase multiples seats and wish to use those seats in a subscription to multiple Example Company instances or multiple Example Company.com groups, they would need two different subscriptions.

Example case: [ZD ticket: #126634](https://example_company.zendesk.com/agent/tickets/126634) (internal)
More context: [Internal Request #450](https://example_company.com/example_company-com/support/internal-requests/-/issues/450#note_192403894)
...
1. Ping the Opportunity Owner in [#support_sales_escalation](https://example_company.slack.com/archives/C011JT165J5) and let them know that the new subscription opps should be credited and a new opps should be submitted as an add-on to the existing one as mentioned in the [example case: ZD ticket #162478](https://example_company.zendesk.com/agent/tickets/162478)
