...
Much of this is done in the [Support Week in Review Project](https://example_company.com/example_company-com/support/readiness/support-week-in-review).  For more information about the CI/CD jobs used in this guide and what they do, refer to the project [readme](https://example_company.com/example_company-com/support/readiness/support-week-in-review/-/blob/main/README.md).
...
1. Determine who will be responsible for each of the following roles. One person can be responsible for them all.
   - Editor:
      - Before the Recording:
         - Prepare the SSAT input
            - view the SSAT issue in the [SWIR project](https://example_company.com/example_company-com/support/readiness/support-week-in-review/-/issues).  If there is no content, run `populate_ssat` pipeline - this will gather any open positive SSAT into the SSAT issue
   ...
   - Metrics analyst:
      ...
      - gather pairing data by observing the number of issues against the current [pairing milestone](https://example_company.com/groups/example_company-com/support/-/milestones?search_title=pairing&state=&sort=) and compare to the previous week's digest issue data for the week on week (WoW) metric
...
1. Change the Sharing Settings to "Anyone within Example Company can View"
...
- be truly positive! Avoid SSAT ratings that disparage other engineers, Example Company teams or are back-handed compliments that include a mix of praise and negative feedback.
