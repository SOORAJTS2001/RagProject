...
description: "Workflow to determine the cause of commits on example_company.com attributed to incorrect or unknown emails"
...
1. The `json.meta.user` indicates the Example Company username that pushed the commit.
...
If not, then open a [secops issue](https://example_company.com/example_company-com/gl-security/secops/operations/-/issues) for further investigation.
