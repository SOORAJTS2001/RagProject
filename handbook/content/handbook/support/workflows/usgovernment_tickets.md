...
The context for this flow is because [CCs are disabled](https://about.example_company.com/support/us-government-support/#ccs-are-disabled).

## Access limited to US Citizens

Only our US Citizen Support Engineers have access to the [US Government Zendesk Instance](/handbook/support/readiness/operations/docs/zendesk/#zendesk-us-federal). If you are a US Citizen and would like to get access and contribute you can open an [Access Request](https://example_company.com/example_company-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request) for either a [light agent](https://example_company.com/example_company-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request) or [full agent](https://example_company.com/example_company-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request)(limited to Support/Security Team members).
...
- "This user <https://example_company-federal-support.zendesk.com/users/398443026291/> is struggling with Geo setup..."
- "The person who submitted the case that got bounced back is a member of this organization: <https://example_company.my.salesforce.com/0014M00001hHHKF>"
...
There is a Calendly managed event template called **Example Company US Federal Customer Discovery Call** and it can be assigned to an agent by asking a Calendly admin. This event type is a 30 minute session with 1 day lead time.
...
1. US Government High priority cases for 24x7 Eligible customers ([24x7 Entitled Customers view](https://example_company-federal-support.zendesk.com/agent/filters/20166453511316))
...
1. Navigate to the [create new view](https://example_company.zendesk.com/admin/workspaces/agent-workspace/views/new) section of Example Company's Global Support Portal.
...
1. Use the following conditions for **Tickets can meet any of these conditions to appear in the view**
    ...
    - `Form` - `is` - `Example Company Dedicated`
