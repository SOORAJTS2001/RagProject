...
and want to migrate to Example Company.com, and they only have an active Self-managed
...
1. Open a Support Ops issue in
   [this project](https://example_company.com/example_company-com/support/support-ops/zendesk-organizations):
