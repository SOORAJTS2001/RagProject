...
additional context -- a `example_company.rb` file, an architectural diagram, or anything
...
([Ticket::Internal Comment::Organization Info](https://example_company.com/example_company-com/support/support-ops/zendesk-global/triggers/-/blob/master/triggers/active/Automation%20Stage/Post%20internal%20note%20about%20Organization%20info.yaml))
...
[within Example Company.com](#within-gitlabcom) describe below.
...
which may get you the information you want. Try `"example_company.rb"` or `gitlabsos`
for your search!
...
### Within Example Company.com

One other place to check for customer technical details is the
[Account Management group](https://example_company.com/example_company-com/account-management) on
Example Company.com. Just search by customer name and in the parent group and you should
