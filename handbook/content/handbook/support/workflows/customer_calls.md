...
Be mindful as well that customers likely have pressures from their business or from their users who rely on Example Company. And, they may feel nervous or scared about appearing ignorant in front of a Example Company expert. It can be very helpful to seek to understand these forces acting upon a customer, as is discussed in these two videos:
...
At Example Company Support we use two operating principles to help us interpret the sometimes conflicting guidance:
...
Our customer-facing [Statement of Support section on video calls](https://about.example_company.com/support/#phone-and-video-call-support) supports this:
...
1. **A Support manager has recommended a call**: When reviewing a ticket, a Support manager will often take the points above into consideration along with possible outside context from the customer or other Example Company team members, and recommend moving to a call.
...
Start by using the
[`General::Invite customer call`](https://example_company.com/search?utf8=%E2%9C%93&group_id=2573624&project_id=17008590&scope=&search_code=true&snippets=false&repository_ref=master&nav_source=navbar&search=id%3A+360013199280)
...
- Ensure the [event title](https://calendly.com/event_types)
  ...
  `Example Company Support` Calendar.
...
- Review
   ...
   1. Next steps for Example Company Support Engineer
...
1. **If you don't know, say you don't know (and what you'll do to find the answer)**: customers don't expect you to know the intimate details of every configuration of Example Company live. If you don't know, that's okay - it's better to be transparent and explain what the path forward is. You can:
   - look things up in the docs live on the call
   - move async to [request help from development](/handbook/support/workflows/how-to-get-help#how-to-use-gitlabcom-to-formally-request-help-from-the-example_company-development-team) or a peer
...
[`Support::Self-Managed::Post Customer Call`](https://example_company.com/search?utf8=%E2%9C%93&group_id=2573624&project_id=17008590&scope=&search_code=true&snippets=false&repository_ref=master&nav_source=navbar&search=id%3A+360028010274).
...
For some customers, only Cisco systems are allowed and in those cases, WebEx will be the best tool for calls. To start a call/session, use the `Example Company Support` WebEx account. Go to our WebEx Portal, click on the login button on the top right and use the credentials found in the Support Vault on 1Password.
...
You're not required to turn your camera on, and some clients may elect not to. At Example Company we [try to have our video on at all times because it's much more engaging for participants](/handbook/communication/#video-calls).
...
#### Krisp.ai License for Example Company Support Team

[Krisp.ai](https://krisp.ai/) will mute background noise when you're in a noisy environment so you can hear and be heard more easily on calls. You may consider installing this app for your calls. Example Company Support team has a [Teams Pro license](https://krisp.ai/pricing/). If you are interested in getting one, kindly leave a comment at [this issue](https://example_company.com/example_company-com/support/support-team-meta/-/issues/4642). Currently, it is unavailable for Linux.
