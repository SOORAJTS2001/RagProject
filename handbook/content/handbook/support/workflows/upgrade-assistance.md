...
As a part of our [Priority Support](https://about.example_company.com/support/index.html#priority-support),
Example Company Support offers [Upgrade Assistance](https://about.example_company.com/support/scheduling-upgrade-assistance/).
...
In addition to the upgrade assistance, it is important for Example Company Support to ensure
the customer's plan for the upgrade is accurate and fully supported by Example Company in
advance of the production upgrade.

If the customer has not provided a plan, or it lacks the detail we need to support them in their upgrade, feel free to ask for a plan. We have [guidance to assist customers in planning their upgrade](https://docs.example_company.com/ee/update/plan_your_upgrade.html).

#### Initiating The Process

1. The end user initiating the request will open a new Support Request using the Support for Self managed Instance form with the problem type set to "Upgrade Assistance Request" or for eligible users, the [US Government Upgrade Planning Assistance Request](https://federal-support.example_company.com/hc/en-us/requests/new?ticket_form_id=360001434131) form in the respective Support Portal. This will generate a high priority ticket in the instance.
...
1. The user provided information must include all of the [required information](https://about.example_company.com/support/scheduling-upgrade-assistance/#what-information-do-i-need-to-schedule-upgrade-assistance).
...
1. (Optional) When the required information has been collected, the assignee can reach out to any of the folks with an `Upgrade` or `Upgrade Assistance` focus on the [Skills by Subject](https://example_company-support-readiness.example_company.io/support-team/skills-by-subject.html) page to pair or offer insight asynchronously.
1. If the customer requests to have the optional 30-minute call for a final review, send a personal one time use Calendly link for a 30 minute meeting at least 2-3 days in advance of when the customer plans to upgrade their Example Company instance.
