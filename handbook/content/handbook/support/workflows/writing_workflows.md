...
Creating, updating, and improving workflows fits with [Example Company values]/handbook/values/) and emphasizes many of our operating principles and approaches including:
...
This very page came [out of a discussion on increasing support efficiency](https://example_company.com/example_company-com/support/support-team-meta/-/issues/2927).
...
1. visual aids, such as flowcharts, whenever helpful.
    - Consider adding a [mermaid chart](https://docs.example_company.com/ee/user/markdown.html#mermaid) or image to help visual learners.

For general writing practices including inclusive language and use of markdown, consider following the [Example Company documentation guidelines](https://docs.example_company.com/ee/development/documentation/styleguide/).
...
The [original version](https://example_company.com/example_company-com/www-example_company-com/-/blob/7d9466ea0400d3e7739f280c7568b3f030fa2562/sites/handbook/source/handbook/support/support-time-off.html.md#taking-off-less-than-half-a-day) organized the information by using number of days off as the "divider".
...
In [a revision](https://example_company.com/example_company-com/www-example_company-com/-/blob/7d9466ea0400d3e7739f280c7568b3f030fa2562/sites/handbook/source/handbook/support/support-time-off.html.md#taking-off-less-than-half-a-day), the page was reorganized to focus on responsibilities so that team members could skip sections that are not relevant to them.
...
1. Use the [Example Company documentation structure and template](https://docs.example_company.com/ee/development/documentation/site_architecture/folder_structure.html).
