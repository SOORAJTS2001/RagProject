...
| Name | Purpose |
|------|---------|
| [My Assigned Tickets](https://example_company.zendesk.com/agent/filters/360062369834) | Tickets assigned to you that are not `Solved` or `Closed`. |
...
- Regularly review your `open`, `pending`, and `on-hold` tickets under
      [My Assigned Tickets](https://example_company.zendesk.com/agent/filters/360062369834)
...
Example Company Support defines two different types of ticket transfers:
...
Example Company Support uses a single view for all unassigned
...
Since we aim in Example Company Support to align tickets to an accountable region, we use
...
1. Use the Zendesk [Zendesk `Handover Ticket Summary` macro](https://example_company.com/example_company-com/support/zendesk-global/macros/-/blob/master/active/Support/Out%20of%20Region/Handover%20Ticket%20Summary.md)
...
As detailed in [Support General Policies](https://about.example_company.com/support/general-policies/#we-handle-each-incident-within-a-single-support-ticket)
it is Example Company's policy to handle each unique issue or incident within a single
support ticket.

### How can I open a new ticket on behalf of a customer?

As detailed in the [Support General Policies](https://about.example_company.com/support/general-policies/#we-handle-each-incident-within-a-single-support-ticket)
it is Example Company policy to handle each individual incident, problem or issue within
