...
description: "Overview of aggregated information which Example Company Support may provide to customers, from the example_company.com logs. Details beyond a summary require a Security request."
category: Example Company.com
subcategory: Security
---

## Log requests for Example Company.com

Users often ask for access to Example Company.com logs, typically, due to [IP blocks](/handbook/support/workflows/ip-blocks), a possible security issue, or for internal auditing purposes.

Always include a link to the log as an internal note, with additional information if needed.

A standard response is available in ZenDesk as a macro [`Support::SaaS::Gitlab.com::Audit logs access request`](https://example_company.com/example_company-com/support/zendesk-global/macros/-/blob/master/active/Support/SaaS/Example Company.com/Audit%20logs%20access%20request.md?ref_type=heads).
...
- Must [verify](/handbook/support/workflows/account_verification/) that this is who is making the request and should be in alignment with support for [Enterprise Users]({{< ref "example_company-com_overview.md#enterprise-users" >}})

> NOTE: A user cannot upgrade to a paid subscription to gain access to logging requests.

#### Free Users

Free users should reference [Example Company.com rate limits documentation](https://docs.example_company.com/ee/user/gitlab_com/#gitlabcom-specific-rate-limits). Support will provide information [when Example Company initiates contact due to an incident](https://about.example_company.com/support/statement-of-support/#free-users).

### What we can provide

We can provide the following information:

- Information found in the [Audit Events Features](https://docs.example_company.com/ee/administration/audit_events.html)
...
- Any information that would disclose Example Company confidential information or processes.
...
If the log files are too large to attach to the ticket in ZenDesk, refer to the [Provide large files to Example Company support](https://about.example_company.com/support/providing-large-files/) page.
...
From ticket: [129594](https://example_company.zendesk.com/agent/tickets/129594)
...
Example ticket: [132652](https://example_company.zendesk.com/agent/tickets/132652)

Also see ["Identifying the Cause of IP Blocks on Example Company.com"](/handbook/support/workflows/ip-blocks).

#### Example 3: Example Company requests action due to high load

Example Company reached out to the owners of a project that was causing concern for the production team, who asked Support to reach out. The user wanted to know where the requests were originating from.
...
Example ticket: [130153](https://example_company.zendesk.com/agent/tickets/130153)
