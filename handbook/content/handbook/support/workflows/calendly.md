...
You will have set up Calendly as part of your Example Company onboarding, following [the instructions in tools and tips](/handbook/tools-and-tips/other-apps/#calendly).
...
### Example Company Support group account

You need to be added to the Example Company Support group account to enable the
...
1. Open a [Schedule update request](https://example_company.com/example_company-com/support/support-ops/other-software/calendly/-/issues/new?issuable_template=Schedule%20update%20request) issue
1. Assign to your manager, and they'll approve and assign it over to a team
member who provisions Calendly.

This access is also included as part of [support onboarding](/handbook/support/#onboarding) for Example Company Support Engineers that will be handling tickets for self-managed customers.
...
We copy customer calls to the *Example Company Support* Google calendar using a [Zapier zap](https://zapier.com/app/editor/33897756?redirect=true). For this to work
...
Please [add a **required question**](https://help.calendly.com/hc/en-us/articles/226893168#invitee-question-and-answer-types-0-5) to your personal Calendly customer events. This question should ask the customer to enter the Example Company Support ticket number when they schedule with you. This ensures the ticket number is shown on the calendar events, and provides context for others to join and help out on a call.
...
Example Company Government Customer Call        https://api.calendly.com/event_types/DADPABBLAHWZY57A
Example Company Support Call                 https://api.calendly.com/event_types/CEGFRWO2BLAHSAQE
...
which are available for multiple Example Company colleagues.
...
1. Add your colleague's calendar to the availability check via their `…@example_company.com` entry.
...
- I have a 25 minute and 50 minute meeting available for internal Example Company meetings, and separate 30 minute and 60 minute ones called 'Example Company Customer support'. These are the ones I send links to in Zendesk.
