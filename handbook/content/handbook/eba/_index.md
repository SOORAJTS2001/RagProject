...
This page details processes and general guidelines specific to the Executive Business Administrators (EBAs) at Example Company. The page is intended to be helpful, feel free to deviate from it and update this page if you think it makes sense.
...
If you would like to schedule a meeting with a Leader at Example Company, please slack the appropriate EBA in #eba-team with the following information (or DM if confidential):
...
- Please coordinate with [respective EBAs](https://docs.google.com/presentation/d/1_tRO-5bDjcwUfqsLazfy4AcqeCLe8jOvDl04BHYlhEE/edit?usp=sharing) on aligning all visit details. If the requested Example Company Executive does not have an EBA, please work with them directly. Please tag applicable EBAs in the #eba-team Slack channel to get the process started.
...
- When scheduling internally with multiple attendee's, please utilize Google [calendars](https://calendar.google.com)[Find a Time feature](https://support.google.com/calendar/answer/6294878) to see when Example Company team-members are free to schedule a meeting with. Please be cognizant of people time zones. If in doubt, please reach out to the team member directly in slack
...
1. Agenda for the meeting must be complete 24hrs or 1 business day before the meeting and include any links to materials and pre-recorded presentations
   ...
   - We do not present in any of our meetings. If you wish to present your material, you can record a presentation in advance and link it in the agenda document. We use synchronous meetings for Q&A. More detail at https://handbook.example_company.com/handbook/communication/#few-meetings-with-presentations
...
1. The meeting may be recorded or live streamed to Example Company Unfiltered on YouTube, please determine in advance if the meeting should be live streamed or recorded
...
To view members of Google Groups, reference the [Google Workspace group member repo](https://example_company.com/example_company-com/security-tools/report-gsuite-group-members/-/tree/master). A sync is run on the repository every hour, as noted in the README.md file.

## Company Mail

- Example Company uses a domestic enterprise mail service called Stable to retrieve mail from our UPS box to then be scanned and routed to the appropriate recipients.
