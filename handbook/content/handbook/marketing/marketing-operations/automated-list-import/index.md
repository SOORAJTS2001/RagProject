...
| Preferred Language | No | Must be written exactly: French, German, Japanese, Italian, Korean, Spanish, Portuguese. Other languages available [here](https://example_company.com/example_company-com/marketing/marketing-operations/-/issues/8945). | Leave blank if value is English or unknown |
