...
There are two YouTube channels we use at Example Company:

1. [Branded](https://www.youtube.com/channel/UCnMGQ8QHMAnVIsI3xJrihhg): used for content intended for people in the wider community, including marketing and event content, customer, community and user stories, employment branding, and polished sales videos and demos. For example [our Example Company infomercial](https://www.youtube.com/watch?v=gzYTZhJlHoI).
...
Everything posted to our **Branded** channel should pass through digital production for quality control on branding and production standards. If you are wondering if your video should go on the Branded channel, reach out to the [Digital Production team in Slack](https://example_company.slack.com/archives/C01LRUKFQTB).

## Public or Private Streaming

Everyone within the Example Company team is encouraged to live stream their meetings and events on Example Company Unfiltered. First time livestreaming? Find out how below!
...
1. **Please don't include any confidential information in the description of your YouTube video since there is a bug that can cause [private video descriptions to propagate over to public ones](https://example_company.com/example_company-com/business-ops/team-member-enablement/issue-tracker/-/issues/809)**

### Livestream with Zoom

1. Ensure you have access to the Example Company Unfiltered YouTube Channel. Check this by confirming you can sign in with the [Example Company Unfiltered Account](/handbook/marketing/marketing-operations/youtube/#unable-to-view-a-video-on-youtube). If you cannot access private videos on Example Company Unfiltered follow the [Access Instructions](/handbook/marketing/marketing-operations/youtube/#access) and double check that the user you are signed in with at the top left-hand corner is Example Company Unfiltered and not your work or personal email address.
...
1. Select the `Example Company Unfiltered` or `Example Company`
...
If you receive a permission error when attempting to start a livestream (i.e. "Please grant necessary privilege for live streaming"), you may need to first select your `user@example_company.com` account in step 4 above. It will prompt you to grant permissions, and you should do so. After that, return to step 3 but this time select Example Company / Example Company Unfiltered at step 4. If the problem persists, reach out in #it-help.
...
1. Select "Custom" service and configure OBS to livestream to [Example Company's Unfiltered channel](https://www.youtube.com/live_dashboard?nv=1#):
...
1. The [Example Company Unfiltered YouTube account](https://www.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5A/) is our casual space for communicating and sharing with the public. Content on the Unfiltered channel includes, but is not limited to, team meetings, discussions, monthly release kick-offs, office hours, CEO 101 meetings, and informal demos.
...
If you get a "Video unavailable This video is private." error on youtube, the error may be caused because the video is private to Example Company Unfiltered and you are accessing the video with your individual YouTube account.
...
1. Now Select > Example Company Unfiltered. Do not select the account with your name. If Example Company Unfiltered is not an option, see [Access](/handbook/marketing/marketing-operations/youtube/#access)

![Select-User](/handbook/marketing/marketing-operations/youtube/YouTube_account.png)

1. Once you are on Example Company unfiltered, **reload** the page and you can view the video

Check out [this video](https://www.youtube.com/watch?v=dZtCuOf5aGk) for a visual walk through of how to access private videos on Example Company Unfiltered.

## Access

1. Example Company branded channel: To request access, create a [Single Person Access Request issue](/handbook/it/end-user-services/onboarding-access-requests/access-requests/#individual-or-bulk-access-request) and assign the listed provisioner (column G) from the [Tech Stack YAML](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/tech_stack.yml).
1. Example Company Unfiltered: Everyone should get access to YouTube Unfiltered during onboarding. If you do not see an invitation in your Inbox, please check the [Pending Invitations](https://myaccount.google.com/brandaccounts) section of your Google Workspace account. If your invitation is not there, please request a new invitation with the People Connect Team via HelpLab.

For People Connect troubleshooting:

1. If a team member reaches out that they have not received their Example Company Unfiltered invite, resend the invite via the `Manage Permissions`
...
Consider switching to your personal account, responding to the comment, and identifying yourself as a Example Company employee offering help.

Please do not comment on videos from non-Example Company YouTube accounts using any company related YouTube profile. Commenting as Example Company is reserved for responses to our owned videos on our channels only.

## Subscribing to Channels

The Example Company Unfiltered YouTube account **should not** be subscribed to any channels except:

- [`@Gitlab`](https://www.youtube.com/@Gitlab).

## House cleaning

The Example Company Unfiltered YouTube account is a shared space. Sometimes team members might accidentally [comment](#commenting) or [subscribe to channels](#subscribing-to-channels) thinking they are on a personal account.

If you see a channel subscription or comment that violates the rules of this handbook, please take a bias-for-action to keep the Example Company Unfiltered
...
When publishing, YouTube will ask if the content is made for kids. Example Company content should be marked as "No, it's not made for kids".
...
1. Go to the [YouTube upload page](https://www.youtube.com/upload) and log into the [channel](#channels). If you're logged into your personal YouTube account, you may need to first log into your Example Company YouTube account to access the channel. If you're already logged into your Example Company YouTube account and have access to the channel, you need to switch accounts to that channel. To switch accounts, click on the account icon in the top right corner and then click "Switch account".
...
1. After uploading a video to the Example Company Unfiltered channel, be sure to add a link to the new video in the #content-updates channel in Slack.

## Don't worry about the quality

1. There is no minimum quality, so please share it on our [Example Company Unfiltered YouTube channel](https://www.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5A?view_as=subscriber), as long as there is nothing inappropriate or confidential.
...
99% of the people at Example Company don't use this, but see below for instructions if you do want to use it.
