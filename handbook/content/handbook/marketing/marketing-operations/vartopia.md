...
We allow Carahsoft access to the Prospects module through the `Partner Placeholder Pubsec` partner account, which will allow them to receive leads from joint Example Company - Partner marketing campaigns.
...
The first phase of the recall process is live in the "Prospects" module in the [Example Company Partner Portal](https://partners.example_company.com/). The recall process is built to be able to pull back leads that are not being actioned.

Only partner leads acquired from fully paid initiatives generated by Example Company Inc. through joint campaigns are subject to recall. **We will not recall leads from Partner sponsored, and MDF funded  campaigns.**
...
In the final phase, Example Company Inc. will allow Channel Partners a period of 5 days, starting from the day the lead is assigned in the Prospect module, to accept the lead by updating the `Prospect Share Status`. After accepting, Channel Partners will have a period of 10 days starting from the date the lead was accepted to revise the `Partner Prospect Status` before the lead is re-routed back to Example Company Inc for follow up.
...
The recall process allows for Example Company Inc. to pull back leads from joint campaigns that aren't actioned by Channel Partners. This will also encourage Channel Partners to work on the leads as they come in. Only partner leads acquired from fully paid initiatives generated by Example Company Inc. through joint campaigns are subject to recall. **We will not recall leads from Partner sponsored and MDF funded campaigns.**
</details>

<details><summary>Who does the partner recall process affect impact?</summary>

The partner recall process affect Channel Partners as their leads will be removed from Vartopia, more specifically resellers who participate in joint-marketing campaign with Example Company Inc. This should not be a surprise to Channel Partners as this process is mentioned in their SLAs. Remind your Channel Partner to review their leads and update their `Prospect Share Status` should they wish to keep the leads in their own possession.
</details>
...
Upon deal registration creation, when Vartopia recognizes that a lead is matched to a campaign, a field called `Example Company Marketing Campaign` will be prompted and the partner must select the campaign that influenced that deal registration.
...
## Add Example Company Marketing Campaign on the DR Form

There are two path that partners can access the `Example Company Marketing Campaign` field, through the Prospects or New Registration tab. See [slides](https://docs.google.com/presentation/d/1A9huMA3uJZDvoe3tgdVHLMKjNMqClTI63YuqJ1G122Y/edit#slide=id.g1d24c3e4ddd_5_52) for more instructional details.
...
1. In the second step of the form, select the Example Company marketing campaign that drove the deal reg.
   1. `Example Company Marketing Campaign` is a required field
...
1. Create a new deal registration if POP has not be sent to Example Company
...
In the scenario where the `Example Company Marketing Campaign` needs to be added, updated or removed, the marketing team will need to create a Marketing Ops issue using the [pntr_dr_campaign_request](https://example_company.com/example_company-com/marketing/marketing-operations/-/issues/new?issuable_template=ptnr_dr_campaign_request) template.
...
4. Marketing Ops to add Example Company Marketing Campaign
...
Then, they will no longer need to use the Example Company Marketing Campaign on the deal registration form.
...
This process is still a work in progress, follow along in this [epic](https://example_company.com/groups/example_company-com/-/epics/2249) for the next iteration.
...
### Example Company Marketing Campaign

`Example Company Marketing Campaign` previously MDF campaign, is a lookup field to the campaign on the registration object. This field will be visible when an account is linked to a campaign upon deal registration creation.
...
- [Partner Lead Status](https://10az.online.tableau.com/#/site/example_company/views/DraftPartnerMarketingv2/PartnerLeadsContacts?:iid=2)
