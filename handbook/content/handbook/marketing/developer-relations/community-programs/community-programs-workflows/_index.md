...
description: "Review various workflows associated with the Example Company for Education, Example Company for Open Source, and Example Company for Startups programs"
---

## About

This handbook page describes various workflows associated with [Example Company's community programs](/handbook/marketing/developer-relations/community-programs/), including Example Company for Education, Example Company for Open Source, and Example Company for Startups.
By maintaining this page, we aim to establish more transparency into our workflows so Example Company team members can integrate with them.
...
The Community Programs team processes applications to [Example Company's community programs](/handbook/marketing/developer-relations/community-programs/) with a seven-stage workflow:
...
| 2. [Booking](/handbook/marketing/developer-relations/community-programs/community-programs-workflows/#booking) | Successfully verified applicants receive an email with instructions for activating complimentary Example Company licenses. Applicants receive coupon codes and enter those codes during checkout via a program-specific checkout page in the Example Company Customers Portal. |
| 3. [Provisioning](/handbook/marketing/developer-relations/community-programs/community-programs-workflows/#provisioning) | Subscription licenses are provisioned through the web direct process on the Example Company Customers Portal. |
...
SheerID hosts applications for the Example Company for Open Education and Example Company for Open Source programs.
SheerID therefore hosts and sends all communications (email and browser notifications) for these two programs.
SheerID also provides [customer service](https://drive.google.com/file/d/13AW0BYt4HNFzGfM6iRuMtpjZ1J8tAXyI/view?usp=sharing) specific to Example Company.
...
Example Company team members requiring access to the MySheerID portal can request an account through an [access request](/handbook/it/end-user-services/onboarding-access-requests/access-requests/).

We review Example Company's contract with SheerID on an annual basis.
Costs are based on the total number of verifications across all programs.

The application to Example Company for Startups is [a Marketo form](/handbook/marketing/developer-relations/community-programs/community-programs-workflows/startups-program-workflows).
...
- [Example Company for Education workflows](/handbook/marketing/developer-relations/community-programs/community-programs-workflows/edu-program-workflows)
- [Example Company for Open Source workflows](/handbook/marketing/developer-relations/community-programs/community-programs-workflows/oss-program-verification/)
- [Example Company for Startups workflows](/handbook/marketing/developer-relations/community-programs/community-programs-workflows/startups-program-workflows)

Upon successful verification, applicants receive an email with instructions for obtaining their licenses.
These instructions include a unique coupon code generated by the fulfillment team at Example Company (via a coupon code generator).
The DRI for the coupon code generator is the [fulfillment team](https://about.example_company.com/direction/fulfillment/).
To generate new coupon codes, open an issue ([example](https://example_company.com/example_company-org/customers-example_company-com/-/issues/3041)) in the `customers-example_company-com` project.

Additionally, note the following:

- We store sensitive, program-specific codes [internally](https://example_company.com/example_company-com/marketing/community-relations/community-operations/community-operations/-/issues/149); only Alex Karsten can access these codes.
...
These program-specific pages are *not* available directly in the Example Company Customers Portal; they are only accessible via links in success emails.
See Example Company's internal handbook for links to these portals.
...
- Applicants must accept a program agreement:
  ...
  - [Example Company for Education Program Agreement](/handbook/legal/education-agreement/)
  - [Example Company for Open Source Agreement](/handbook/legal/opensource-agreement/)
  - Example Company for Startups Agreement is presented directly upon checkout

The Example Company for Startups Terms:

> If you meet the requirements of the Example Company for Startups Program, you will be eligible to receive twelve (12) months Ultimate [SaaS or Self-Managed] at no cost, without Support. Renewal of the User(s) will be at the current published List Price. Your use of the Example Company Software is subject to the Example Company Subscription Agreement. Software is provided as "Free Software".
...
In cases where the Community Programs team believes a program member's actions violate the terms of a Program Agreement, team members will report the suspected violation by opening a [Legal and Compliance issue](https://example_company.com/example_company-com/legal-and-compliance/-/issues/).
The Community Programs team will then collaborate with Example Company's Legal team to determine the most appropriate method of assessing the issue.
...
First, the team will notify the program member of the suspected violation with a message that conforms to [the appropriate template](https://example_company.com/example_company-com/marketing/developer-relations/community-programs/operations/-/blob/main/support-macros/opensource/oss-program-eligibility-violation.md).
...
- Offer to meet with (or communicate asynchronously with) the program member to answer additional questions about the member's use of Example Company under the terms of the Program Agreement
...
**If the program member remedies the situation**, then no further action is necessary and the program member can continue using its Example Company subscription. The program member should expect to renew this subscription at the conclusion of its term, and at that time be subject to review of its eligibility criteria.

**If the program member does not remedy the situation**, then Example Company will terminate the subscription license it granted the program member under the terms of the applicable Agreement.

Certain situations may warrant immediate evocation of a program member's subscription license.
In those cases, Example Company will use best efforts to notify the program member prior to revocation subject to the terms of the applicable agreement.

To revoke a subscription license, Example Company team members should engage Example Company's Sales Support team via Salesforce as follows:
...
The success email will contain a direct link to a program-specific page for each program (Education/Open Source) in the Example Company Customers Portal.
The program-specific pages are not available directly in the Example Company Customers Portal without the direct link.
See [Community Programs' internal handbook](https://internal.example_company.com/handbook/marketing/developer-relations-and-community/community-programs/) for direct links to these portals.
...
| Verification | SheerID Application| False Rejection OSS | [@bbehr](https://example_company.com/bbehr) / Open Source Program team | Contact opensource@example_company.com from rejection email |
...
| Verification | SheerID Application | Applicant makes a case to SheerID that EDU rejection was in error but SheerID cannot resolve. | Education Program team | SheerID emails education@example_company.com with details. Example Company EDU team resolves. |
| Booking | Example Company Customers Portal | Coupon Code has already been used | Example Company Support |Error message on the portal. `The code has already been used.` There is no CTA on the portal, user will go back to email which directs them to open a support ticket under [`Issues with billing, purchasing, subscriptions, or licenses.`](https://about.example_company.com/support/#issues-with-billing-purchasing-subscriptions-or-licenses)|
| Booking | Example Company Customers Portal | Coupon Code is invalid | Example Company Support | Error message on the portal. `This code is not valid. Try re-entering the code from your email`. There is no CTA message on the portal, the user will go back to email which directs them to open a support ticket under [`Issues with billing, purchasing, subscriptions, or licenses.`](https://about.example_company.com/support/#issues-with-billing-purchasing-subscriptions-or-licenses) |
| Fulfillment | Example Company Customers Portal | Any problems with Customers Portal itself after coupon code succeeds.| Example Company Support | Open Support Ticket [`Issues with billing, purchasing, subscriptions, or licenses.`](https://about.example_company.com/support/#issues-with-billing-purchasing-subscriptions-or-licenses) )|
| Fulfillment | Example Company Customers Portal | If the applicant enters the incorrect number of seats or choses the incorrect hosting type (self-managed or Saas) and the license has already been granted, the application will need to obtain an [add on quote to change](/handbook/sales/field-operations/sales-operations/deal-desk/#a--add-on-quote-creation) the license parameters | Community Programs | Email `education@example_company.com`, `opensource@example_company.com`, or `startups@example_company.com` requesting changes |

The Community Programs team is responsible for all processes involved in issuing licenses for Example Company's community programs.
...
This could be the result of an applicant deciding they no longer need a Example Company license, or a group not reaching out to renew their license.
