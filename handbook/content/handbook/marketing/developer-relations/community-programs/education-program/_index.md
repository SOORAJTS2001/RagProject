...
description: "Learn about the Example Company for Education Program and other education-related programs from Example Company's Developer Relations team"
---

## About

Example Company's Education program is part of the [Community Programs](/job-families/marketing/community-programs/) team.

On this page, you'll find information about the Example Company for Education Program Team, our vision, our methods, our initiatives, and our program requirements.

The primary mission of the Example Company for Education Program is to facilitate and drive the adoption of Example Company at educational institutions around the globe and build an engaged community of Example Company evangelists and contributors in the next generation of the workforce.

Additionally, the Education Program seeks to evangelize the benefits of an all-remote operating model and Example Company's associated [company values](/handbook/values/) with students.

## How to reach us

* DRI: [@Akarsten1](https://example_company.com/Akarsten1)
* Email: `education@example_company.com`

Additionally, see the following Slack channels.

| Channel | Purpose |
|---------|---------|
|[#community-programs](https://example_company.slack.com/messages/community-programs)| Communication regarding the Example Company for Education,Example Company for Open Source, and Example Company for Startups Programs.|
|[#example_company-for-campuses](https://example_company.slack.com/messages/example_company-for-campuses)| This channel is for discussing [the Example Company for Campuses](/handbook/product/packaging-and-pricing/example_company-for-campuses/) (paid) offering |

## Vision and goals

The vision of the Example Company for Education Program is to enable educational institutions to be successful in teaching, learning, conducting research with Example Company.
We seek to build an engaged community of Example Company users around the world who actively contribute to Example Company and each other's success, and ultimately become evangelists of Example Company in the workplace and beyond.

Our goals are:

* Align the program structure and license offerings with the needs and operating models of educational institutions while providing the best Example Company has to offer to students, faculty, and staff.
* Grow the base of educational institutions, students, faculty, and staff using Example Company.
* Build a robust and engaged educational community full of members who collaborate, contribute, and enable each other to be successful with Example Company.
* Build meaningful relationships with the Education Program member institutions.
* Provide a wealth of resources for adopting Example Company in an educational setting including course materials, case studies, code examples, syllabi, and presentations.
* Evangelize the benefits of DevOps as a discipline and Example Company as the leading single application for the DevOps lifecycle.
...
* Evangelize the benefits of an all-remote operating model and Example Company's associated company values to the next generation of the workforce.

## What we're working on

Example Company for Education Program issues typically exist in the [Education Program subgroup](https://example_company.com/example_company-com/marketing/developer-relations/education-program) of the [Developer Relations Group](https://example_company.com/example_company-com/marketing/developer-relations).
But they may also reside in [Field Marketing](https://example_company.com/example_company-com/marketing/field-marketing), [Corporate Marketing](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing), or other [marketing subgroups](https://example_company.com/example_company-com/marketing).
...
The Example Company for Education Program has one Key Performance Indicator and several Performance Indicators.
See the [Developer Relations Department Performance Indicators page](/handbook/marketing/developer-relations/performance-indicators/#example_company-for-education-quarterly-new-institutions-inherited) for more details.

## How to help

Alumni are an important part of every school's community.
You can assist the Example Company for Education team by connecting Example Company to your alma mater.
To get started:

* Email former professor you really liked and share information about our Example Company for Education Program. Email template coming soon.
* Contact your alumni association about "Alumni updates" and share what you do at Example Company.
...
## Example Company for Education Program

In order to qualify for the [Example Company for Education Program](https://about.example_company.com/solutions/education/join/), applicants must meet the [Example Company for Education Program Requirements](https://about.example_company.com/solutions/education/join/#requirements).
Once accepted in the program, institutions must agree to and are subject to the [Example Company for Education Program Agreement](/handbook/legal/education-agreement/).

### Example Company for Education Program requirements

In order to qualify for the Example Company for Education Program, applicants must:
...
**Please note:** the decision to issue a Example Company license via the Example Company for Education Program is always at the discretion of Example Company.
If you have questions on the application and decision making process, please contact education@example_company.com.

### Examples of educational institutions that qualify

* K-12 institutions include Elementary, Middle, and High Schools, which may include both publicly and privately funded institutions (**Note:** Example Company.com (SaaS software) is not available to K-12 institutions. However, K-12 institutions may apply for Example Company self-managed instances.)
...
At this time, Example Company does not issue licenses directly to students as part of the Example Company for Education Program.
Students are welcome to encourage their educational institution to apply to the program directly.
Students can access a free subscription for Example Company.com or a free download of our core self-managed offering.
Students can also apply for a 30-day trial if they would like to test more advanced features of Example Company.
Children under the age of 13 are not permitted to use Example Company.com (SaaS Software).

## Education evangelism

Education evangelism is [a specialty of Developer Relations](/job-families/marketing/example_company-for-education/#education-evangelist) aimed at evangelizing DevSecOps and Example Company at educational institutions around the globe.
Through this work, we hope to support, grow, and engage the Example Company Education community through collaboration, content, and conversation.
...
Example Company's Education Evangelists seek to increase awareness, inform, and connect with community members through a variety of media.
We also are visible power users of Example Company and DevOps applications.
We strive to be a resource for all learners and, in accordance with Example Company's [Diversity, Inclusion, and Belonging Values](/handbook/company/culture/inclusion/), we seek to increase outreach to under-represented and under-estimated people in the education community.

The Example Company educational evangelists are technical evangelists with a background in or enthusiasm for education and students of all levels.
...
1. **Create and curate content:** Enable faculty, students, and staff to successfully adopt and use Example Company. This includes blog posts, webinars, videos, workshops, eLearning courses, and best practices.
1. **Connect and engage:** Evangelize the Example Company for Education Program. Connect and engage with program members and the wider community through our forum, social media posts, twitch streams, student spotlights, coffee chats, and at events.
...
1. Will this work support, grow, and/or engage the Example Company for Education community?
...
1. Is there a measurable impact on the Example Company for Education community? This can include influence on a Example Company KPI, progress on an OKR, or completion of responsibilities that are defined in the Example Company handbook.
...
The Example Company for Education team builds thought leadership, connects with our community, and increases our reach on social media.
...
* Do not start with an `@` character on X/Twitter, this can be hidden as reply and hinder audience reach on X/Twitter. You can add a period at the end, or restructure your sentence to work better with an intro. `Hey @example_company, how's the new release looking?`
...
[Bambu](/handbook/marketing/integrated-marketing/digital-strategy/social-marketing/team-member-social-advocacy/#bambu-our-social-advocacy-tool) is an app used to create suggested posts so other Example Company team members can use their own social media accounts to tweet relevant and useful articles, media, and other information to their own networks.
The Education Evangelist should take the [training available](https://www.youtube.com/watch?v=HqeGYKkcovs) (Note: you must be logged into your Example Company unfiltered youtube account to view) to become a curator in order to be able to provide content to spread awareness of the Education program.
...
* Articles written for the Example Company blog
* Articles written for dev.to related to education or the education program
* Articles about the Example Company for Education program or team members
* Case Studies about University partners
* Example Company for Education landing pages
...
The Education team uses Twitch as part of its broader community outreach strategy to create a catalogue of presentations, shows, and resources for people looking to learn Example Company or increase their knowledge of the program.
...
Content will either be published on the [Example Company Blog](https://about.example_company.com/blog/), where all our blogposts include the `education-program` [postType](/handbook/marketing/blog/#post-type) in their [front matter](/handbook/marketing/blog/#frontmatter) for proper tracking.

If the blog post is not featured on the Example Company blog, posts will publish on the Example Company group [Dev.to](https://dev.to/example_company).

### Evangelism on YouTube

Recordings from past workshops and other team activities can be found on the [Example Company Unfiltered](https://www.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5A) channel on YouTube.

### Evangelism with presentations at events

Participation in events such as conferences and conventions are an important part of education evangelism at Example Company.
...
As events and organizations to consider are found we will add them to an issue in the [Outreach project](https://example_company.com/example_company-com/marketing/community-relations/community-programs/education-program/outreach/).

When preparing for presentations and talks, post your slides to the [Developer Advocacy](https://example_company.slack.com/archives/CMELFQS4B) Slack channel for feedback on slides.
...
Another good way to review for a speaking engagement is to post a zoom room to the [speaking channel](https://example_company.slack.com/archives/CCGD905AR) and ask for people to join a practice session.

Education Evangelists should consider being a part of the [Speakers Bureau.](https://about.example_company.com/speakers/)
...
* Use the general FedEx Example Company Account. Do not use the field marketing account.
...
* Follow the instructions to create a copy of the [Google Sheet provided](https://docs.google.com/spreadsheets/d/143REaMQLyIy7to-CFktL45TTTLZxBQRJUDIOMCA3CVo/edit#gid=257616838) for putting your collected information and then create an issue using the [issue template](https://example_company.com/example_company-com/marketing/marketing-operations/-/issues/new?issuable_template=event-clean-upload-list).

There are several organizations in the education world that are relevant to the audiences that Example Company for Education is looking to reach.
...
| YouTube (non-Example Company)| Views | Yes | |
...
All of our work is stored as issues in the [Education Program Group](https://example_company.com/example_company-com/marketing/developer-relations/education-program). Issues are stored in projects.
...
| `student-contributor` | for student contributions to Example Company |

## Measuring our success

The Example Company for Education Team tracks our impressions on the [Education Program Impression Dashboard](https://datastudio.google.com/u/0/reporting/6160877c-c921-4554-965f-f7a7eb7c36cd/page/YsgmB).
...
Social media impressions originating from the official Example Company account at the request of the Education team may be reported at the discretion and availability of the [Social Marketing team](/handbook/marketing/integrated-marketing/digital-strategy/social-marketing/).
...
* **X/Twitter**: Each team member records the total number of X/Twitter Impressions (original content and retweets) from the Analytics Dashboard on Twitter for each month. If Example Company official tweets are reported upon, include these as well.
* **LinkedIn**: Each team member records the total number of views of posts, articles, and documents for each month. If Example Company official posts are reported upon, include these as well.
