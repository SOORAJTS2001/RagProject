---
title: "Pricing and Packaging - Example Company for Campuses"
canonical_path: "/handbook/product/packaging-and-pricing/example_company-for-campuses/"
---

---

## Example Company for Campuses

## Overview

Example Company provides qualified educational institutions with three different options for using Example Company on their campus:

1. **Example Company for Education**: The Example Company for Education Program provides free, unlimited, licenses of Example Company's top-tiers, either self-managed or SaaS, to [qualified educational institutions](/handbook/marketing/developer-relations/community-programs/education-program/#example_company-for-education-program-requirements) for the **purposes of teaching, learning or non-commercial research only**. Use in Professional Information Technology or for *any* administrative purposes is **strictly prohibited** under the Example Company for Education license. Please see the [Example Company for Education handbook](/handbook/marketing/developer-relations/community-programs/education-program/) and [marketing pages](https://about.example_company.com/solutions/education/) for more details. Universities must [apply here](https://about.example_company.com/solutions/education/join/) to be accepted into the program.
2. [**Academic Discount**](/handbook/product/packaging-and-pricing/example_company-for-campuses/#academic-discount): Example Company licenses are available at a 20% Academic Discount off list price for any qualifying educational institution. There are no use-case restrictions on these licenses.
3. [**Example Company for Campuses**](/handbook/product/packaging-and-pricing/example_company-for-campuses/#example_company-for-campuses-enterprise-offering): Qualifying educational institutions may purchase an enterprise campus-wide license. The campus-wide license offers unlimited seats (up to the last published enrollment of the institution) of Example Company's top-tiers, either self-managed or SaaS. This offering permits all use cases to occur within one license for the campus. *NOTE:* The ability to participate in any of the Education options (stated herein) is subject to Example Company's sole discretion. Please follow the applicable steps regarding qualification. **Purchases or requests shall not be considered accepted (or legally binding) unless and until executed between the parties in writing.**

## Academic Discount

Qualifying educational institutions may receive an Academic Discount of 20% off the current Example Company list price for each tier, either self-managed or SaaS. The discount will be applied at the discretion of the account owner and their regional sales leadership where applicable.
...
- The academic discount is not currently available to be purchased directly in the Example Company Customers Portal.

## Example Company for Campuses: Enterprise Offering

Qualifying educational institutions may purchase a campus-wide enterprise license.

### Details

- Only the top-tier of self-managed and SaaS Example Company are available in the campus-wide offering. Lower tiers are not available. The primary goal of this offering is to provide all of campus with the best Example Company has to offer and incentivize students, faculty, and staff to adopt Example Company's highest tier features.
...
- The institution will provide documentation to the Example Company account owner for the most recent published student enrollment numbers (graduate and undergraduate) for within one year of the date of deal closing.
...
- The Example Company for Campuses enterprise offering is not currently available through the Customers Portal. Universities must work with their regional sales account owner to obtain a license.
...
- The named contacts must be provided to Example Company and included in the support database. The account owner has the primary discretion to include or not include provided named support contacts based on the definitions below.
- Individual students, faculty, and staff outside of the named single point of contact for each primary division cannot directly contact Example Company support.
- Please refer customers to the Example Company Support process for [Managing Support contacts and handling details](https://about.example_company.com/support/managing-support-contacts/) in order to seed a list of named support contacts.

### Tiers

The Example Company for Campuses enterprise offering is available at the following tiers:
...
## Steps for Building a Example Company for Campuses Quote

The steps for building a Example Company for Campuses quote vary slightly from standard quotes.
...
### Example Company for Campuses Order Form

The Example Company for Campuses Order form must be used for all Example Company for Campuses quotes because it contains specific language regarding the size of the institution.

#### Resellers

Example Company for Campuses can be sold through Example Company resellers. The specific language regarding the size of the institution from the Example Company for Campuses Order Form must be added to the Reseller Order Form.

### Example Company for Campuses Agreeement

The standard [Example Company Subscription Agreement](/handbook/legal/subscription-agreement/) is applicable to the Example Company for Campuses offering.
...
**For-Profit Units**: Individual non-profit institutions may have directly affiliated entities that are managed and operated by a for-profit entity or mechanism with a separate tax status than the parent University. This may include online program managers (for-profit online programs), endowment money managers, startup incubators, etc. For-profit units are excluded from the enterprise education offering unless specifically agreed upon by Example Company and indicated on the order form.

**Educationally Related Entities**: any entity that does not meet the qualifying criteria, such as code academies, massive open online course providers, bootcamps, and professional training centers, do not qualify for the Example Company for Campuses enterprise offering.
...
The following are **not** eligible for the Example Company for Campuses enterprise offering:
