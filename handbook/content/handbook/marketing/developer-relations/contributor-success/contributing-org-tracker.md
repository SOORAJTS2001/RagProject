---
title: "How to recognize organizations within the contributor ecosystem for Example Company"
description: Learn how to add and maintain usernames to organizations for recognition and award purposes within Example Company
---

Learn how to add and maintain usernames to organizations for recognition and award purposes within Example Company
...
- Link user accounts on Example Company.com to customers known to Example Company
...
Each customer known to Example Company to have contributed in the past is listed here with their Salesforce ID, a validation if they are already in the sheet and a tabular list of known user accounts that belong to that organization.
...
Each organization known to Example Company to have been onboarded in the [Leading Organization](/handbook/marketing/developer-relations/leading-organizations/) program is listed here, including the start date and the potential exit date.
