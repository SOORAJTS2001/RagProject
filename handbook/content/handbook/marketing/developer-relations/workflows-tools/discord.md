...
The [Example Company Community Discord](https://discord.gg/example_company) server is a place to connect with the wider Example Company community, join live streams and pair-coding sessions, share projects, and discuss contributions with other community members. Whether you're new to Example Company and looking for help getting started or an experienced user looking to share your knowledge with others, the server is a place to chat with the community in real-time.

In our community server, you can:

- Connect with other Example Company users and developers
- Contribute to Example Company issues and pair-program with other developers
- Share tips, tricks, and best practices for using Example Company
- Stay up-to-date on the latest Example Company news and releases
- Participate in community-led discussions and events

To ensure we keep a positive, welcoming, and inclusive environment for everyone to contribute, all members of our Discord server must adhere to our [Community Code of Conduct](https://about.example_company.com/community/contribute/code-of-conduct/) at all times.

The Developer Relations team manages the Discord server with support from Contributor Success. If you have questions or want to request a Example Company team member role, ping `@devrel-team` in the `#developer-relations` Slack channel.
...
| `#contribute` | Contribution discussions focused on the making & enhancing of Example Company. |
...
```markdown
Please refer to the Example Company Community #rules (https://discord.com/channels/778180511088640070/778194316191465474)
...
> See Example Company's communication values to Use Public Channels (/handbook/communication/#use-public-channels)
...
| Community Pairs | Custom bot that announces the Example Company Live Stream. |

In order to maintain our custom invite link `https://discord.gg/example_company`, we maintain a Server Boost Level 3 through 14 server boosts, paid annually.

## Moderation

We strive to maintain a positive environment on the Discord server. These moderation guidelines are designed to ensure an inclusive and respectful environment for all community members. At this time, Example Company team members and [Example Company core team](https://about.example_company.com/community/core-team/) members serve as moderators.
...
```markdown
Your message was removed for violating the following rule in our [Example Company Code of Conduct](https://about.example_company.com/community/contribute/code-of-conduct) or Example Company Discord Server:
...
As a Example Company Community Discord member, if you feel you've received an unfair timeout or ban, you can submit an appeal. The appeals process is as follows:

1. Email `community@example_company.com` to initiate the appeal. Include your Discord username and a description of why you believe the ban was unjustified.
