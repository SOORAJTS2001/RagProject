...
We use Zapier to automate the task of forwarding mentions of Example Company, swag store orders, etc.

The Zapier subscription runs on the [Team plan](https://zapier.com/app/billing/plans), and is shared with the Example Company team.
...
| --- | --- | --- |
| [Post new Blogs to the Example Company forum](https://zapier.com/app/editor/148450001) | Example Company blog post is posted as [a new forum topic](/handbook/marketing/developer-relations/workflows-tools/#example_company-blog-forum-bot) | about.example_company.com/blog, Discourse |
...
| Zap | Description | Involved Tools |
| --- | --- | --- |
| [New blog posts - Example Company](https://zapier.com/editor/183958722) | Reads Example Company blog RSS feed and posts to `#developer-advocacy-updates` channel. | Example Company Blog, Slack |
...
| Zap | Description | Involved Tools |
| --- | --- | --- |
| [New forum topics with `catalog` or `component`](https://zapier.com/editor/219212925/) | Reads Discourse forum RSS feed `https://forum.example_company.com/latest.rss` and posts to `#f_ci_catalog` channel. | Discourse forum, Slack |
| [New forum topics in the Example Company Duo category](https://zapier.com/editor/219218779) | Reads Discourse forum RSS feed `https://forum.example_company.com/c/example_company-duo.rss` and posts to `#example_company-duo-forum-posts` channel. | Discourse forum, Slack |
...
| [Hackernews: Slack Notifications for mentions: Example Company](https://zapier.com/app/editor/52810208) | Hackernews: `Example Company` mentions to `#hn-mentions` Slack channel |  HackerNews, Slack |
...
- Front page: https://hn.algolia.com/api/v1/search?&query=example_company&tags=front_page
- Mentions: http://hn.algolia.com/api/v1/search_by_date?query="devops+platform"

#### example_company-blog Forum Bot

The [`example_company-blog`](https://forum.example_company.com/u/example_company-blog/summary) user is used to automatically post new [Example Company blogs](https://about.example_company.com/blog/) as a new topic to the [Community](https://forum.example_company.com/c/community/39) category.  This process is controlled through [Zapier](https://zapier.com/app/editor/148450001).  Zapier reads the blog RSS feed at `https://about.example_company.com/atom.xml` and posts a new topic using the admin API key and `example_company-blog` user for each new entry there.

The `example_company-blog` credentials and admin API key are stored in the 1Password Marketing vault. Admins can directly edit the user in Discourse without login.
