...
|-------------|-------------|-----------|
| Crowdin | [Crowdin](https://translate.example_company.com/) is the platform for the wider community to collaboratively contribute translations for Example Company | [How we use Crowdin](https://docs.example_company.com/ee/development/i18n/translation.html) |
| Discourse | [Discourse](https://www.discourse.org) is the platform on which the [Example Company forum](https://forum.example_company.com) is run. | [How we use Discourse](/handbook/marketing/developer-relations/workflows-tools/forum/#administration)|
| Discord | [Discord](https://discord.gg/example_company) is the instant messaging platform the Example Company community communicates on (in addition to Example Company.com itself) | popular channels are #contribute, #general and the support channels |
| Meetup | [Meetup.com](https://www.meetup.com/pro/example_company/) is the platform we use and offer to our community to organize meetups | [How we use Meetup.com](/handbook/marketing/developer-relations/evangelist-program/#meetups) |
...
| Tool Name       | Description                                                                                                                                                                                                                               | How We Use                                                                                                                                                                                                                                                                             |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Customer Portal | [CustomersDot](https://example_company.com/example_company-org/customers-example_company-com/-/tree/staging/doc/architecture#customersdot) - Web portal where customers can manage their subscriptions and account information, generate and manage Example Company licenses. | To help troubleshoot issues with community program applications. To create and manage licenses for community program applications and for [Example Company EE contributors](/handbook/marketing/developer-relations/contributor-success/community-contributors-workflows.html#contributing-to-the-example_company-enterprise-edition-ee) |
| Marketo         | [Marketo](/handbook/marketing/marketing-operations/marketo/)                                                                                                                                                                              | Powers each intake form for our ([Education](https://about.example_company.com/solutions/education/), [Open Source](https://about.example_company.com/solutions/open-source/), and [Startups](https://about.example_company.com/solutions/startups/)) programs. It is an integration which inserts the application record into Salesforce.                                                |
...
| Canva           | [Canva](https://www.canva.com/) is the tool we use to create a lot of our Example Company-branded materials.                                                                                                                                       | Community team members should creat an account using their `@example_company.com` email and [request access](/handbook/it/end-user-services/onboarding-access-requests/access-requests/) to Canva Enterprise from the Design team.                                        |

### Adding a new tool to the Developer Relations tool stack

1. Please follow the procurement process as you would for [adding any new tool to Example Company's tech stack](/handbook/business-technology/tech-stack-applications/#add-new-system-to-the-tech-stack).
