...
Every year, developer advocacy prioritizes key events in our ecosystem for which we run the conference proposal (CFP) process. The event engagement with lightning talks, CFP submissions, etc. is organized in issues which are linked and summarized in a [yearly strategy epic](https://example_company.com/groups/example_company-com/marketing/developer-relations/-/epics?state=opened&page=2&sort=start_date_desc&label_name[]=DevRel-Events&label_name[]=Events). You can also find a calendar view of our events below:
...
1. [Open a new issue](https://example_company.com/example_company-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/new?issuable_template=developer-advocate-request)
...
For every CFP process we are participating in, a [CFP issue](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=CFP-Meta) is created with details about the event, requirements for CFP submissions and any other relevant information that might be useful to potential speakers. The issue template contains guide on the necessary steps needed to ensure we keep track of all the submissions for each CFP.
...
All issues with the `CFP` label appear on the dedicated [CFP Issue board](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/boards/2415569?&label_name[]=CFP).
