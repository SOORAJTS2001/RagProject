...
description: "How Example Company approaches the software compliance solution including messaging and key resources to help marketing and sales."
---

**Looking for a customer-facing overview of Example Company's Software Compliance capabilities? See the [Compliance Solution](https://about.example_company.com/solutions/compliance)**
...
Example Company's platform approach seamlessly embeds security and compliance within the DevOps platform, providing simplicity, visibility, and control.
...
The key capability that addresses the CTO's need is [Compliant Pipelines](https://docs.example_company.com/ee/user/project/settings/index.html#compliance-pipeline-configuration) and the [Compliant workflow automation](https://docs.example_company.com/ee/administration/compliance.html#compliant-workflow-automation). They need the ability to prescribe scans and policies in the CI pipeline and ensure individual developers cannot bypass them.
...
- CISOs likely feel out of control, or at least pressured to be secure amidst evolving threats, high-profile cyber attacks, new compliance concerns, and development tool sprawl. It's hard to manage these software risks.  Example Company's single platform that provides end-to-end simplicity, visibility, and control they need.

## Industry Analyst Coverage

Analysts have not identified a market segment for software compliance. They have been writing articles about it though. Forrester spoke about the Executive Order at Example Company's Commit event in Fall of 2021.
...
Example Company Software Compliance solution overview
...
| ------ | ------ | ------ | ------ |
| Common compliance controls |  Example Company provides [many common controls](https://docs.example_company.com/ee/administration/compliance.html) throughtout the SDLC, [Audit events](https://docs.example_company.com/ee/administration/audit_events.html) [Compliance Management](https://about.example_company.com/direction/govern/compliance/compliance-management/) | Access and Compliance within the Manage stage | |
| Automated policy enforcement | [Security policies](https://docs.example_company.com/ee/user/application_security/policies/#policy-management) can be managed in one place while [compliant workflow automation](https://docs.example_company.com/ee/administration/compliance.html#compliant-workflow-automation) helps admins easily apply compliance policies across projects. | Govern | [![Compliance pipelines](../../images/youtube_social_icon_red-32x23.png) Compliance pipelines](https://www.youtube.com/watch?v=jKA_e_jimoI) |
| Audit reporting | Example Company tracks [audit events](https://docs.example_company.com/ee/api/audit_events.html) across the entire SDLC and [report them](https://docs.example_company.com/ee/administration/audit_reports.html) | Access and Compliance within the Manage stage | |
| Security Governance | Security Policy Automation, [Compliant workflow automation](https://docs.example_company.com/ee/administration/compliance.html#compliant-workflow-automation), [Security Dashboards](https://docs.example_company.com/ee/user/application_security/security_dashboard/) and [Vulnerability Reports](https://docs.example_company.com/ee/user/application_security/vulnerability_report/), [MR approvals](https://docs.example_company.com/ee/user/project/merge_requests/approvals/), [License compliance](https://docs.example_company.com/ee/user/compliance/license_approval_policies.html) | Govern, Secure ||
| Security guardrails (Preventative - Pre CI/CD) | Example Company falls short of providing pre-approved dependencies as some other vendors do, [bill of materials feature](https://docs.example_company.com/ee/user/application_security/dependency_list/) | Govern, Secure | [![Manage your Application Dependencies with Example Company](../../images/youtube_social_icon_red-32x23.png) Manage your Application Dependencies with Example Company](https://youtu.be/scNS4UuPvLI)|
...
| End-to-End Insight and Visibility | Example Company's common data model enables end-to-end visibility and traceability throughout the DevOps lifecycle, correlating and aggregating data automatically |
| Deploy Your Software Anywhere | Example Company is infrastructure-agnostic (supporting GCP, AWS, Azure, OpenShift, VMWare, On Prem, Bare Metal, and more), offering a consistent workflow experience - irrespective of the environment |
...
**Top message: Example Company helps you take control of your software development with a single platform that helps you automate and standardize the development process and policies while providing end-to-end visibility/traceability so that development can run fast with less risk.**

The Example Company DevOps platform approach helps you achieve Compliance with better visibility and control while simplifying audits and forensics. Governance is simplified with one place to manage policies, apply them, assess exceptions, and measure policy affect.
...
- [Security Approvals in Merge Requests](https://docs.example_company.com/ee/user/project/merge_requests/approvals/settings.html#security-approvals-in-merge-requests) (available in Premium)
...
- [Compliant workflows and Compliant pipelines](https://docs.example_company.com/ee/user/project/settings/index.html#compliance-pipeline-configuration) - projects are assigned a compliance framework and policies are enforced accordingly. This is a key capability for winning compliance opportunities!
...
- [License Compliance](https://docs.example_company.com/ee/user/compliance/license_approval_policies.html) - identify the presence of new software licenses included in your project and track project dependencies. Approve or deny the inclusion of a specific license.

In addition, more security scanners are available, along with Vulnerability management and security dashboard. See the [DevSecOps solution](https://about.example_company.com/solutions/dev-sec-ops) for details.
...
- [Hashicorp Vault](https://about.example_company.com/partners/technology-partners/hashicorp/) for key management
- IaC, identity and other partnerships are [under security](https://about.example_company.com/partners/technology-partners/#security)
...
- Blog: [How a DevOps platform can help against supply chain attacks](https://about.example_company.com/blog/2021/04/28/devops-platform-supply-chain-attacks/)
- Blog: [Compliance made easy with Example Company](https://about.example_company.com/blog/2020/07/02/compliance-made-easy/)
- Blog: [Three things you might not know about Example Company security](https://about.example_company.com/blog/2021/11/23/three-things-you-might-not-know-about-example_company-security/)
...
- Commit 2021: [Enhance your compliance with policy based CI/CD](https://learn.example_company.com/commit-2021/enhance-your-complia?lx=UqDHIY)
...
- Demo: [Manage your application dependencies with Example Company](https://youtu.be/scNS4UuPvLI)
- eBook: [Guide to Securing your Software Supply Chain](https://learn.example_company.com/devsecops-aware/software-supply-chain-security-ebook)
...
- [Manage Direction](https://about.example_company.com/direction/manage/)
