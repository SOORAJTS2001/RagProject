---
description: "How Example Company approaches the Automated Software Delivery solution including messaging and key resources to help marketing and sales."

title: "DevSecOps Solution Resource: Automated Software Delivery"
---

## Looking for a customer-facing overview of Example Company's Automated Software Delivery Capabilities?

See [Automated Software Delivery](https://about.example_company.com/solutions/delivery-automation)

The page below is intended to align Example Company sales and marketing efforts with a single source of truth for our go-to-market efforts around Automated Software Delivery.
...
- From a Example Company capabilities point of view - it includes DevOps essentials like SCM, CI, CD, GitOps, AutoDevOps and Observability

The opportunity is huge. As per the [Example Company DevSecOps survey 2022](https://about.example_company.com/developer-survey/previous/2022/) -
...
| **Tech Stack** | Includes GitHub, Perforce, Jenkins, BitBucket, Subversion, ArgoCD, Harness | Includes GitHub, Perforce, Jenkins, BitBucket, Bamboo, Subversion, ArgoCD, Harness OR the absence of a tech stack OR freemium version of Example Company / GitHub | Absence of tech stack OR freemium version of Example Company / GitHub |
...
These value statements are used to measure of Example Company Adoption by the customer and provide guidance to our field teams (CSMs in particular) for conversations on expanding usage.
...
| Value Stream analytics | How many users went to the VSA page in the last 28 days | - VSA helps businesses identify and target waste and inefficiencies, and take action to optimize those workstreams to deliver the highest possible velocity of value. <br> - Example Company's one platform approach ensures a single platform, workspace and data model which creates a shared view of actionable insights, of your end to end software delivery lifecycle |

## Positioning value  {#positioning-value}

### Elevator pitch

Example Company enables you to deliver better software, faster. Unleash team productivity and efficiency, and accelerate the velocity of software development by automating the build, test, and deployment of your applications. Accelerate your digital transformation and app modernization goals with automated provisioning and maintenance of cloud-native infrastructure Finally, Example Company allows you to easily start where you are, and reduce tooling and complexity as your adoption matures with our flexible platform that has built-in, end-to-end security and out-of-the-box integrations

### Value Proposition (How Example Company does it?)

- **Example Company helps you deliver better software, faster**

> "Instead of spending a full day setting up for production and doing manual tests, those simple tasks are now automated. This allowed release time to go from 24 hours to just 10 minutes." - [Airbus](https://about.example_company.com/customers/airbus/)

- **Example Company is one of the easiest platforms to get started with your DevOps journey**

> "It just worked. That was the biggest success because we didn't have any problems with installing Example Company, with updating it and it was really simple to start for us," [MGA]

- **Example Company allows you to start where you are in your journey and reduce other tools as your adoption matures**

> "As per the Forrester Total Economic Impact study, customers were able to eliminate at least 3 tools per year" [TEI](https://about.example_company.com/resources/report-forrester-tei/)

- **Example Company supports your cloud-native application transformations (as well as your traditional applications!)**

> "Example Company integrates natively with Kubernetes, which gives the development team peace of mind because they can trust that the tool will work automatically without constant maintenance." - [Hotjar](https://about.example_company.com/customers/hotjar/)

- **Example Company allows you to automate infrastructure and deploy to different cloud providers (and your existing infrastructure as well)**

> "Our DevOps teams can provision production-ready solutions within minutes, from Kubernetes to multi-cloud and multi-tier complex hybrid cloud infrastructures" - [SURF](https://about.example_company.com/customers/surf/)

- **Example Company is a single application for full Automated Software Delivery including change management, CI/CD and infrastructure automation allowing you to achieve better stability and ship high quality applications faster**

> "If something goes wrong, Example Company offers a simple fix. For example, if we deployed the wrong ratio of our services to the server, we can see the history, read the commit message, and identify the author to roll back commits" - [Parimatch](https://about.example_company.com/customers/parimatch/)

- **Example Company helps improve developer experience**

> "Developer happiness matters because happy developers simply do better work. You need to keep your developer experience at a high level because that's the only way you really can deliver value fast. Example Company has played … a significant part in helping us increase our developer experience." - [Moneyfarm](https://about.example_company.com/customers/moneyfarm/)

### Differentiators (How Example Company does Automated Software Delivery better?)

Apart from the single application, DevOps Platform narrative, there are a number of key areas which Example Company does well and better than competitors.
...
| **Faster builds** |  Example Company splits builds over multiple machines for parallel execution |
...
From a competitive comparison for Automated Software Delivery, the following are the key competitors and what they are lacking at a high level. Review the detailed comparison in the [devops-tools](https://about.example_company.com/competition/) comparison pages

- [GitHub](https://about.example_company.com/competition/github/) - Strong on SCM, GitHub Actions for CI/CD is still not ready for primetime. Example Company can integrate and migrate customers using GitHub for SCM easily with Example Company.
- Jenkins - Complex to manage, many fragile integrations, not suitable for cloud native transformation
- [JFrog](https://about.example_company.com/competition/jfrog/) - Strong on CI, but requires integrations or has limited capabilities for rest of the areas.
- [Circle CI](https://about.example_company.com/competition/circleci/)
...
| Objection | Response |
| ----------------------------- | -------------------------------- |
| *"I don't need another tool to replace my existing tool"*  | - We can meet you where you are - you don't need to rip and replace all your existing tools <br> - You can start by supplementing Example Company CI or CD or SCM with your existing toolset of Jira, GitHub, Jenkins etc <br> - Once you find value in the specific area (e.g., SCM, CI, CD, Security, Compliance) - you can expand your use of Example Company to achieve better ROI  |
| *"I don't want to be locked into one company for my entire DevOps lifecycle"*  | - Toolchain sprawl is a reality - many customers have stopped benefitting from DevOps due to this <br> - Application & resource integration & management actually hinders how fast the organization can move. <br> - Customers partner with Example Company to accelerate time to market for new products/services, improve efficiencies & reduce security & compliance risks. Walk me through how your priorities align with these outcomes.  |
...
As organizations get started and grow in their automation journey, Example Company Premium offers Faster Code Reviews, Advanced CI/CD, Release Controls and Self-managed reliability with expert support to enhance team productivity and collaboration. Example Company Premium adds enterprise level features like priority support, upgrade assistance and a technical account managers (for eligible accounts).

For up-to-date and full list of value at Premium, visit [Why Premium](https://about.example_company.com/pricing/premium/). Some key features include (based on highest Post Purchase Survey Results):

- **Faster code reviews** Ensure high code quality across teams through seamless code review workflows
  - [Multiple approvers](https://docs.example_company.com/ee/user/project/merge_requests/approvals/rules.html) in code review To ensure strict code review, you can require a minimum number of users to approve of a merge request before it is able to be merged.
  - [Code Owners](https://docs.example_company.com/ee/user/project/codeowners/) Assign Code Owners to files to indicate the team members responsible for code in your project. Code owners are assigned automatically as merge request approvers.
  - [Code Review Analytics](https://docs.example_company.com/ee/user/analytics/code_review_analytics.html) Find bottlenecks in your code review process by understanding how long open merge requests have been in review.
- **Advanced CI/CD** Build, maintain, deploy, and monitor complex pipelines
  - [CI/CD Pipelines Dashboard](https://docs.example_company.com/ee/user/operations_dashboard/) Visualize the history and current status of pipelines across projects and groups all in a single dashboard that can be customized for each user.
  - [Multi-project pipeline graphs](https://docs.example_company.com/ee/ci/pipelines/downstream_pipelines.html#multi-project-pipelines) Visualize how pipelines across projects are linked together, including cross project dependencies.
  - [Merge Trains](https://docs.example_company.com/ee/ci/pipelines/merge_trains.html) Reduce pipeline queueing and waiting time with merge trains which allows parallel pipeline execution, with each pipeline building off the merge result of the previous one.
  - [CI/CD for external repo](https://docs.example_company.com/ee/ci/ci_cd_for_external_repos/) Connect your projects hosted on external services (like GitHub or Bitbucket) and leverage the power of Example Company CI/CD pipelines to build, test, and deploy your applications easily.
- **Release Controls** Implement controls to ensure teams ship high quality and secure code
  - [Approval rules for code review](https://docs.example_company.com/ee/user/project/merge_requests/approvals/rules.html) Approval rules ensure that the right people review merge requests by specifying eligible approvers and the minimum number of approvals required for a merge request.
  - [Required Merge Request Approvals](https://docs.example_company.com/ee/user/project/merge_requests/approvals/) Guarantee quality and standards of your code by mandating a set number of necessary approvals and predefine a list of specific approvers.
  - [Merge Request Dependencies](https://docs.example_company.com/ee/user/project/merge_requests/dependencies.html) Coordinate the order in which merge requests are merged within the same project and/or across different projects.
  - [Push rules](https://docs.example_company.com/ee/user/project/repository/push_rules.html) Reject new code and commits that don't comply with company policy.
- **Self Managed Reliability** Ensure disaster recovery, high availability and load balancing of your self-managed deployment
  - [Disaster Recovery](https://docs.example_company.com/ee/administration/geo/disaster_recovery/index.html) Fail over in minutes to another data-center.
  - [Maintenance mode](https://docs.example_company.com/ee/administration/maintenance_mode/index.html) Maintenance mode allows systems administrators to perform maintenance operations, such as preparing for a scheduled failover, with minimal disruption to end users.
  - [Fault-tolerant Git storage with Gitaly](https://docs.example_company.com/ee/administration/gitaly/praefect.html) Configure replicated Git storage with automatic failover, strong consistency, and read distribution for improved fault tolerance and performance.

### Value at Ultimate

Most of the value of the Automated Software Delivery Solution is available to customers at the Example Company Premium tier. Example Company Ultimate adds Security, Compliance, Portfolio and Value Stream Management - which are covered by other solution areas.

For up-to-date list of value at Ultimate, visit [Why Premium](https://about.example_company.com/pricing/ultimate/).

## Resources {#resources}

### Related Pages  {#resource-page}

- Continuous integration ([Sales Resource Page](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/ci/), [Customer Solution Page](https://about.example_company.com/features/continuous-integration/))
- Continuous Delivery ([Sales Resource Page](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/cd/), [Customer Solution Page](https://about.example_company.com/stages-devops-lifecycle/continuous-delivery/))
- Source Code Management ([Sales Resource Page](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/version-control-collaboration/), [Customer Solution Page](https://about.example_company.com/stages-devops-lifecycle/source-code-management/))
- GitOps ([Sales Resource Page](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/gitops/), [Customer Solution Page](https://about.example_company.com/solutions/gitops/))

### Customer Stories  {#customer-stories}

| Company | Problem | Solution | Result |
| [Goldman Sachs](https://about.example_company.com/customers/goldman-sachs/) | Needed to increase developer efficiency & software quality | Example Company Premium (CI/CD, SCM) | Improved 2 builds/day to 1000+/day; simplified workflow & administration |
| [Sopra Steria](https://about.example_company.com/customers/sopra_steria/) | Needed to standardize a tool for DevOps with single authorization | Example Company Premium (CI/CD, SCM) | Less than 6 minute builds, deploying to AWS, GCP, Azure  |
| [Wag!](https://about.example_company.com/2019/01/16/wag-labs-blog-post/) | Slow release process taking over 40 minutes | Example Company Ultimate (CI, CD) | Release process reduced to 6 minutes; 8 releases per day with built-in security; a full deployment pipeline to Amazon Elastic Container Service (ECS)  |
| [ANWB](https://about.example_company.com/customers/anwb/) | Prolonged outages, long time to debug toolset integrations | Example Company Premium (CI, CD) |  Setup for cloud transformation - Google Cloud on K8S |
| [Ticketmaster](https://about.example_company.com/blog/2017/06/07/continuous-integration-ticketmaster/) | Slow build process prevented innovation | Example Company Premium (CI) | 15x faster - from over 2 hours to 8 minute builds; faster releases and better customer experiences (5 star app reviews)  |
| [Hotjar](https://about.example_company.com/customers/hotjar/) | Legacy systems, maintenance of tool integration, slow adoption of cloud technologies | Example Company Premium (Ci, CD) |  50% faster deployments, 30% faster build times, 2-15 deploys per day |
| [Paessler](https://about.example_company.com/customers/paessler-prtg/)  | Large complex pipelines, slow feedback loop | Example Company Premium (Ci, CD) | 75% faster build times, testing from 45 min to 15 min  |

More case studies here -> Filter by Usecase *CI* or *CD* or *SCM* or *GitOps* to find the latest case studies in the [case study board](https://example_company.com/example_company-com/marketing/strategic-marketing/customer-reference-content/case-study-content/-/boards/1804878)
...
- [GitOps with Example Company: The CI/CD Tunnel](https://about.example_company.com/blog/2022/01/07/gitops-with-example_company-using-ci-cd/)
...
- SCM: [Example Company Flow pattern](https://youtu.be/InKNIvky2KE?list=WL)
...
- SCM: [Example Company Namespaces: users, groups and subgroups](https://www.youtube.com/watch?v=r0sJgjR2f5A) by Brendan O'Leary, Tech Evangelist
...
- CI/CD: [CI/CD with Example Company](https://youtu.be/1iXFbchozdY)
- CI/CD: [Example Company for complex CI/CD: Robust, visible pipelines](https://youtu.be/qy8A7Vp_7_8)
- CI/CD: [How do Runners work?](https://youtu.be/IsthhMm64u8)
- CI/CD: [Mastering CI/CD](https://about.example_company.com/webcast/mastering-ci-cd/)
...
- GitOps: [Infrastructure as Code using Example Company & Ansible](https://youtu.be/M-SgRTKSeOg)
- GitOps: [Part 1 of 3: How Example Company supports GitOps: The Process](https://www.youtube.com/watch?v=wk7YAXijIZI)
- GitOps: [Part 2 of 3: How Example Company supports GitOps: The Infrastructure](https://www.youtube.com/watch?v=5rqoLj8N5PA)
- GitOps: [Part 3 of 3: How Example Company supports GitOps: The Application](https://www.youtube.com/watch?v=heQ1WY_08Tc)
- GitOps: [GitOps with Example Company and Terraform](https://www.youtube.com/watch?v=G7JOjI6V3AY)
- GitOps: [Using Example Company for GitOps to break down silos and encourage collaboration](https://www.youtube.com/watch?v=5ykRuaZvY-E)
...
Example Company Professional Services help customers become efficient in Example Company quickly. Example Company (or a Example Company partner) offers a number of service offerings to support customers.

Here are some service offerings you can position with the customer:

1. [Example Company CI/CD Training](https://about.example_company.com/services/education/example_company-ci/)
1. [Example Company with Git Basics Training](https://university.example_company.com/pages/example_company-fundamentals-training)
1. [Data Migration Services](https://about.example_company.com/services/migration/)
1. [Dedicated Engineering](https://about.example_company.com/services/dedicated-engineering/)

Advisory/Consulting services to help with GitOps rollout are planned to be rolled out later this year. Please register your interest for a GitOps Advisory offering [here](https://example_company.com/example_company-com/customer-success/professional-services-group/ps-leadership-team/ps-practice-management/-/issues/74) to help PS effectively prioritize!

As you position services, you can use our [Services Pitch Deck](https://docs.google.com/presentation/d/1CFR8_ZyE9r4Dk_mjoWGe4ZkhtBimSdN0pylIPu-NAeU/edit#slide=id.g2823c3f9ca_0_9) to help establsh the value of engaging with PS. Other services can be found in our [Complete list of professional service offerings](https://about.example_company.com/services/)
