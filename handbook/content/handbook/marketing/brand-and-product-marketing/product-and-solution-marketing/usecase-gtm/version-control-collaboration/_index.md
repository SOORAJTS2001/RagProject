...
| **Enterprise Ready** | The solution is robust enough to make critical functionality available at large scale, widely distributed teams in highly regulated markets.  It supports multiple project structures from monorepos to [service-oriented architectures such as microservices](https://about.example_company.com/topics/microservices/).  | [Geo](https://docs.example_company.com/ee/administration/geo/index.html), Geo [High Availability](https://docs.example_company.com/ee/administration/reference_architectures/), [Disaster Recovery](https://about.example_company.com/direction/geo/disaster_recovery/), Git protocol v2 support, Deduplicate Git objects for forked repositories, Download single repository files, fast and responsive application, project templates, file templates, access controls, and traceability.  | Prevents outages and disruptions of development team work. Enables traceability to authors of changes to address defects or bugs in the product and auditability throughout |
...
**[Worldline](https://about.example_company.com/customers/worldline/)**
