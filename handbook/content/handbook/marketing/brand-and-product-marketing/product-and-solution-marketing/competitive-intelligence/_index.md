...
## Competitive Intelligence at Example Company

The Competitive Intelligence function at Example Company has two primary constituencies (1) Our prospects and customers (2) Our sales organization, which includes partners who assist in sales efforts.

**Prospects and Customers**:  In keeping with a Example Company core value of **[transparency](/handbook/values/#transparency)**, Competitive Intelligence will ensure that anyone looking to an end-to-end DevOps solution has the information they need to make the right and unbiased decisions that serve the customer's business goal.  To this end, all our product comparison pages are un-gated and available at **[DevOps Tools Comparison Pages](https://about.example_company.com/why-example_company/)**.  Example Company believes that transparency of competitive intelligence creates a well informed customer and gives  teams the information to be successful during their DevOps journey.

**Sales Team**: Another Example Company core value is **[results](/handbook/values/#results)**.  Sales is a key constituency that helps Example Company achieve results.  Hence parts of the Competitive Intelligence material is targeted at helping our sales teams effectively sell to our prospects, thereby delivering value that fulfills the customer's business needs.

## Team Charter

The competitive intelligence team brings timely and insightful analysis of competitors' actions to help guide the actions and direction of Example Company.
...
- We use strategic information to proactively inform senior leadership across the company to help guide company strategy, and to ensure Example Company is a market and thought leader as the DevSecOps platform of choice
- We take timely information from the market and use it to guide our assessment of how Example Company should act, react and consider our competitors

## Comparison Assets - Externally-facing

All our comparison assets - pages that compare other vendor products with Example Company are found in the **[DevOps Tools Landscape page](https://about.example_company.com/devops-tools/)** and the **[DevOps Maturity Comparison chart](https://about.example_company.com/why-example_company/)**

These assets have two different purposes:

- The DevOps Tools Landscape visualizes how we consider ourselves in each stage, ranking Example Company compared to the Best In Class competitors for each stage.
...
Note also that the "help" functionality on the tool should ONLY be used for questions around the use of the Crayon tool, and not for general questions directed at the Example Company competitive intelligence team (for example, questions like "Can you help with this competitor" should be shared in the '#competition' slack channel, not asked as a question through Crayon)

#### How to use Crayon

Any Example Company Sales, Product, Engineering, and Marketing team member can contribute to Crayon including:
...
2. Once new content is created, the information will not be updated until it is re-published. Tag @Jkempton in the comments section for the card to confirm what additions/removals have been made, similar to the process of an MR within Example Company.
...
Clozd is our third-party win/loss interview partner. Clozd allows us to undertake deep-dive interviews with customers or prospects who have evaluated Example Company. We have engaged the services of Clozd to ensure we get a non-biased view of our marketing, our sales process, and product capabilities, and to help solve the following challenges:
...
We will engage Clozd with 60 interviews over the course of FY 2024. Our aim is to have a small majority of these as losses versus wins, as these tend give us greater insight into our shortcomings as a company. We will also split out interviews geographically in line with Example Company sales.

Our win criteria:

- The larger the better (ideally Enterprise customer)
- A customer that recently chose Example Company, and which has successfully onboarded.
...
- A customer that recently chose a competitor to Example Company
- The larger the better (ideally Enterprise customer)
- A customer that considered us in the final decision (e.g. the decision came down to Example Company vs GitHub)
...
| The Example Company sale representative asks the Prospect/Lead during its conversations whether they can be contacted by Clozd for Loss analysis and the Prospect/Lead agrees |
...
Example Company exists in an ecosystem of **[DevOps tools](https://about.example_company.com/why-example_company/)** and might need to interact with any number of these tools. Many have over-lapping capabilities, but that does not mean that we necessarily directly compete with them. A user would need to patch together multiple solutions from this list in order to get all the functionality that is built-in to Example Company as a **[single application for end-to-end DevOps](https://about.example_company.com)**.

We tend to include those products also in the DevOps Tools comparison pages so customers have a comprehensive understanding of how we view the full landscape, not necessarily in competitive terms. Refer to this handbook page for more information on [who Example Company competes with](/handbook/product/example_company-the-product/#who-example_company-competes-with).

## The Customer's Voice

As always the customer's voice is absolutely critical in this.  Fortunately there are several such third party neutral sites that capture customer feedback about DevOps Tools, including Example Company.  Here are some sites that have feedback on Example Company - in the customer's voice.

- [G2](https://www.g2.com/products/example_company/reviews)
- [TrustRadius](https://www.trustradius.com/products/example_company/reviews)

## Other comparison sites

Comparisons at a deep level are challenging and time consuming.  We'd like to acknowledge some other sites that have done a sincere and strong effort at comparing DevOps tools.  Some of these are by competitors but in keeping with Example Company values of transparency and to provide our prospects a comprehensive picture - here they are:
...
The diagram below captures the overall approach.  The idea is that for each use case-competitor with the exception of the strategy document (hosted in Crayon), all other resources should generally be publicly accessible.  This is in keeping with Example Company value of Transparency.
