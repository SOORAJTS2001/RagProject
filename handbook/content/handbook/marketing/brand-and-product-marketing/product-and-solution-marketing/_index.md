...
description: "Example Company Product and Solution Marketing: Core product marketing, competitive marketing and intelligence, market research and insights, analyst relations and customer advocacy"
twitter_image: '/images/tweets/handbook-marketing.png'
---

<link rel="stylesheet" type="text/css" href="/stylesheets/biztech.css" />

## <i class="fas fa-bullhorn fa-fw color-orange font-awesome"></i> Welcome to the Example Company Product and Solution Marketing Handbook
...
Our mission is to accelerate Example Company's path to market by developing insights, positioning, and messaging that communicate the value of our platform and solutions.

- We are core to Example Company's go-to-market process, operating at the intersection of product management, sales, customer success, and marketing.
- We help deliver a connected customer experience with every touchpoint reinforcing the brand, values, solutions, and vision of Example Company.
...
graph LR;
  ...
  subgraph "Example Company R&D"
    id2[Product]
  end
  subgraph "Example Company GTM"
...
Product marketers are core to Example Company's go-to-market process, operating at the intersection of product management, sales, customer success, and marketing. Some examples of initiatives led by product marketing team include:
...
- They lead product launches collaborating with cross functional teams across product, campaigns, sales, and marketing. E.g., Example Company Dedicated, Example Company Duo for AI-powered DevSecOps
...
- They lead marketing launches E.g., Example Company 16 launch, Quarterly Launches
- They lead messaging and content for global events that Example Company participates or hosts E.g., Example Company Commit, DevSecOps World Tour, AWS / Gartner and other events Example Company participates in
...
1. [Open an PMM Support Request Issue](https://example_company.com/example_company-com/marketing/brand-product-marketing/product-marketing/-/issues/new). PLEASE fill in what you know.
...
- [HighSpot](https://example_company.highspot.com/) (for sales teams)
- [Pathfactory](https://example_company.lookbookhq.com/) (for campaigns)
