...
1. Click on the [Create Product and Solution Marketing QBR Action Issue](https://example_company.com/example_company-com/marketing/product-marketing/issues/new?issuable_template=QBR-Action-Item) link
...
1. Update the `QBR-Action-Item` [issue template](https://example_company.com/example_company-com/marketing/product-marketing/blob/master/.example_company/issue_templates/QBR-Action-Item.md) in the **Product Marketing** Project
