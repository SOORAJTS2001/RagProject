...
DORA metrics are available in Example Company [Group-level value stream analytics (VSA)](https://docs.example_company.com/ee/user/analytics/#devops-research-and-assessment-dora-key-metrics) and in the [CI/CD analytics](https://docs.example_company.com/ee/user/analytics/ci_cd_analytics.html). APIs are also available for all four DORA metrics. To learn more check out the [DORA API documentation](https://docs.example_company.com/ee/api/dora/metrics.html#get-project-level-dora-metrics)
