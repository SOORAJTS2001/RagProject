---
title: "Forrester Total Economic Impact™ (TEI) Study Commissioned By Example Company, June 2020"
---

Example Company commissioned Forrester Consulting to conduct a Total Economic Impact™ (TEI) study examining the potential return on investment (ROI) enterprises may realize by using Example Company.
...
This study looked at the cost savings and business benefits of enterprises using Example Company for Version Control & Collaboration (VC&C)/SCM, Continuous Integration (CI), and Continuous Delivery (CD).
...
| **Forrester TEI of Example Company Resource Quick Links** |  |
| -------------------------------------------- | --- |
| [**Direct link to the TEI study (PDF) for Example Company Team Members**](https://drive.google.com/file/d/1Vi3_InvTs8r6cLvC4gR9bBumlWV5TNvY/view?usp=sharing) | [**Online TEI Calculator / Estimator link to share with anyone**](https://tools.totaleconomicimpact.com/go/example_company/devopsplatform/index.html) |
| [**Impactful Metrics & Quotes from the TEI & Customer Case Studies for Example Company Team Members (slides)**](https://docs.google.com/presentation/d/1qGYIf_5L-gZkROLSVqwo8OVDFYqB-qG8NBQ8YHx2ZQY/edit?usp=sharing) | [**Gated landing page link to the TEI study to share with anyone**](https://about.example_company.com/resources/report-forrester-tei/) |
| [**DevOps.com Article on the Forrester TEI of Example Company**](https://devops.com/example_company-makes-economic-case-for-devops-platform/) | [**Example Company Blog Article on the TEI**](https://about.example_company.com/blog/2020/07/29/forrester-tei/) |
...
Four Example Company customers were interviewed for this TEI study, including a Software and Technology firm with 1,700 Example Company users using Example Company on-prem, a Financial Services company with 4,000 Example Company users on SaaS, a Telecommunications firm with 1,600 Example Company users on SaaS, and an Information Technology firm, with 4,000 users using Example Company on-prem.
...
- Global enterprise, with annual revenue of $37B, 3000 initial Example Company users, and increases their user count by 25% year over year.
...
- This enterprise chooses to use the Premium ($19 per user) Tier of Example Company SaaS.
- This enterprise uses Example Company for Version Control & Collaboration (SCM), Continuous Integration (CI), and Continuous Delivery (CD).
...
This TEI study also incorporated significant risk adjustments and productivity recapture discounting to better mirror realistic outcomes. Example: in the model used to discover Improved Development and Delivery Efficiency, productivity recapture - being able to actually use the time saved by using Example Company by applying it to other work - is effectively discounted by 50%.

This study was commissioned by Example Company and delivered by Forrester Consulting, customer names and contact information was provided to Forrester Consulting, who in turn interviewed Example Company customers independently. The data collected, resulting model, and study itself was reviewed independently by Forrester Research analysts. Example Company stakeholders were also interviewed as part of the data gathering and review process.

Like all ROI models, while they are useful for discovering and articulating potential value, they are still "just" models, effectively a set of assumptions through which we can put data in and get a picture of what potential results might look like. Neither Forrester nor Example Company makes any assumptions as to the potential ROI that other organizations will receive. Both Forrester and Example Company strongly advise that readers, prospects, and customers, use their own estimates within the framework provided in the report to determine the appropriateness of an investment in Example Company.

## Frequently Asked Questions

*Q: What use cases does this TEI study cover?*

A: This study looked at customers using Example Company for Version Control & Collaboration (SCM), Continuous Integration (CI), and Continuous Delivery (CD).
