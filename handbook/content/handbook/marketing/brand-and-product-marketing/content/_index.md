---
title: Example Company Content Strategy & Ops
description: >-
...
## <i class="fas fa-bullhorn fa-fw color-orange font-awesome"></i>  Welcome to the Example Company Content Strategy & Ops Handbook

### Meet the Example Company Content Strategy & Ops team. 👋

[**Grace Madlinger**](https://example_company.com/gmadlinger)

* **Title**: Director, Global Content

* **Example Company handle**: @gmadlinger
...
[**Sandra Gittlen**](https://example_company.com/Sgittlen)

* **Title**: Managing Editor, Example Company blog

* **Example Company handle**: @sgittlen

* **Slack handle**: @Sandra Gittlen

**Our team mandate:** Create _world-class_ content that expands our audience, drives conversions, and tells Example Company's story—while enabling everyone in the organization to contribute.
...
* [Example Company blog handbook](/handbook/marketing/blog/)

* [Gated content process](/handbook/marketing/demand-generation/campaigns/content-in-campaigns/)

* [Example Company Content Style Guide](/handbook/marketing/brand-and-product-marketing/brand/content-style-guide/#brand-voice)
...
In Content Strategy & Ops, we work on all things content—aka, digital collateral that informs and educates our audience, and motivates them to take action. Most importantly, content has a purpose and measurable impact on Example Company goals and/or OKRs.

Our work is all about the words, translating Example Company's message into external collateral like…

* Blog posts

* Feature and solution pages, conversion pages, and SEO topic pages on about.example_company.com
...
* Industry/Example Company reports (Global DevSecOps Survey)
...
To create this content, **our team operates as both an editorial newsroom and internal agency.** As a **newsroom**, we create content around regular "beats" or topics, and independently lead our own projects. As an **internal agency**, we support everyone at Example Company in mainly external-facing content projects. Those projects might look like:
...
While the Content Strategy & Ops team produces a large amount of content, we are by no means the only content creators at Example Company. If you would like to collaborate with us on a content project, read more below!
...
[**Content Strategy** projects](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/content-strategy) include bespoke or high impact/high visibility content work, requiring planning, multiple stakeholders, and often VP-level or above engagement.
...
### The Example Company Blog

The Content Strategy & Ops team is also responsible for the Example Company Blog. [Check out the blog handbook to learn more.](/handbook/marketing/blog/)

### Requesting support

Whether you have a Content Strategy or Content Ops request, work begins with a conversation as the default. Collaboration ensures your projects have the best outcome and largest positive impact on Example Company's goals.

If you know your request falls into either Content Strategy or Content Ops, open a new request in the [Content Strategy project](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/content-strategy)  or the [Content Ops project](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/content-ops) and fill out the corresponding template.

Not sure which bucket your request falls into? [Open a general request in Content Ops and we'll advise.](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/content-ops/-/blob/master/.example_company/issue_templates/new-content-request.md)
...
A post on the Example Company blog can educate, entertain, tell a story, take an opinionated stance, etc. A blog post is dated, so it only reflects thoughts, ideas, and processes from a specific period of time. For communicating long-term/evergreen ideas or processes, consider using a topic page or SEO page instead. A blog also can and should be repurposed as a web article/cluster page
...
Any technical Example Company team member is welcome to write a whitepaper and collaborate with the content team. If you're interested in writing a whitepaper, open an issue in the [Content Strategy project](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/content-strategy) and describe your idea, or post in the [#content](https://example_company.slack.com/archives/C2R1NED61) Slack channel. Whitepapers should be related to specific use cases and support campaigns, when possible.

**Examples:**

1. [A seismic shift in application security](/resources/whitepaper-seismic-shift-application-security/)

2. [How to deploy on AWS from Example Company](/resources/whitepaper-deploy-aws-example_company/)
...
**For other Example Company team members:** To request an ebook from the content team, feel free to open a [Content Strategy issue.](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/content-strategy)

**Examples:**

1. [Guide to a DevOps platform migration](https://page.example_company.com/migrate-to-devops-guide.html)

2. [How to drive business success with DevSecOps](https://page.example_company.com/resources-ebook-devsecops-success.html)

#### One pager

An infographic is an illustrated overview of a topic or process, and is typically an ungated asset. Infographics should tell a story using data, diagrams, and text. It can be used to discuss industry trends, relate insights, or explain different stages of a project. [Open a Content Ops issue to get started.](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/content-ops)

**Example:**

1. [DevSecOps platform 1-pager](https://example_company.highspot.com/items/637c610e7fdd49cb264924ea?lfrm=srp.8)

2. [Forrester TEI infographic](https://example_company.highspot.com/items/63728bd5d5e577b476270022?lfrm=srp.2)
...
1. [What is CI/CD?](https://about.example_company.com/topics/ci-cd/)
...
1. [CARFAX improves security, cuts pipeline management and costs with Example Company](https://about.example_company.com/customers/carfax/)

2. [Lockheed Martin saves time, money, and tech muscle with Example Company](https://about.example_company.com/customers/lockheed-martin/)

3. [Online travel giant Agoda boosts developer productivity with Example Company](https://about.example_company.com/customers/agoda/)
