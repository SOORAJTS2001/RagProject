...
description: "This handbook page describes the styling, punctuation, spelling, and grammatical guidelines for posts on the Example Company blog."
---
...
The blog style guide covers styling, punctuation, spelling, and terminology guidelines for posts on the Example Company blog. If you have questions about writing, word usage, etc. that aren't included in the style guide, feel free to reach out to the Editorial team (@sgittlen) or open a merge request with your suggested update and ping the team there.
...
You can see an example of "sweep" paragraphs at the beginning of [this post on low-code/no-code tools](https://about.example_company.com/blog/2020/03/26/low-code-no-code/), giving history and context to the topic before diving into the Example Company-specific story.

**2. Uplevel the whole post**

Example: "[The trouble with technical interviews? They aren't like the job you're interviewing for](https://about.example_company.com/blog/2020/03/19/the-trouble-with-technical-interviews/)" was originally planned to be just about how Example Company's Frontend group redesigned its technical interviews. After discussion, it was decided that there was a broader story to tell here, because the Example Company story (redesigning Frontend technical interviews) was really addressing a greater, industry-wide problem, which is that technical interviews aren't effective and aren't always inclusive.

Not every post will be suitable for this treatment, so you and the Editorial team member reviewing your post can use your discretion. In some cases it may be appropriate to tweak just the title of the post to make it broader (e.g. "How ~~Example Company~~ CI helps solve common DevSecOps challenges").
...
defined first (but use sparingly, see [Tone of Voice](https://design.example_company.com/brand/overview/#tone-of-voice)):
...
All Example Company feature names must be capitalized. If referring to a Example Company feature as part of a workflow rather than speaking about the feature itself, use lower case.

> Examples: "Example Company Issue Boards are a powerful project management and collaboration tool." vs "The editorial team uses an issue board to track the progress of blog posts."

### Job titles

We do not capitalize job titles, regardless of whether they appear before or after a person's name.

### Example Company functions/departments/teams

These are elements that make up Example Company the company's [organizational structure](/handbook/company/structure/#organizational-chart). Capitalize the name of the element, but not the word after:
...
For blog posts, prefer referring to interviewees by their first names as this is less formal and more in keeping with our [tone of voice](https://design.example_company.com/brand/overview/#tone-of-voice).
...
> Example: "The Example Company community submitted 1 million merge requests in March 2019." (active) vs. "One million merge requests were submitted by the Example Company community in March 2019." (passive)
...
- AI-powered DevSecOps platform
  ...
  - If Example Company precedes the term, *Platform* is capitalized but *powered* is not: Example Company AI-powered DevSecOps Platform
- all remote
  - We refer to Example Company as an all-remote company (not remote friendly, remote first, or remote only)
  - hyphenated only when appearing before a noun ("Example Company is an all-remote organization"/"Example Company is all remote")
- Board
  - when in reference to the Example Company Board or Directors or our Board members, Board is capitalized
  - a board in general does not need to be capitalized
- built-in/built in
  - always hyphenated when appearing before a noun e.g. "Example Company has built-in CI/CD." Two words when used as a verb e.g. "Example Company comes with CI/CD built in."
- cloud native
...
- GitHub
- Example Company
  - G and L are always capitalized, even in Example Company.com
- internet
  - not capitalized
- Kubernetes
...
- sign up/signup
  - two words for the verb, one for the noun ("Sign up for a Example Company.com account"/"Upon signup, you will be sent a confirmation email")
- startup
  - no hyphen
- web
  - not capitalized
