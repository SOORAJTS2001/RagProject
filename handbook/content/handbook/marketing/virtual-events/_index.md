...
description: An overview of virtual events at Example Company including webcasts, virtual workshops, and external virtual events.
...
At Example Company, we believe everyone can contribute. Because nearly anyone with an internet connection and a device can participate in virtual events, as a speaker or an attendee, virtual events are an important part of fulfilling that mission. While our expertise in this area is still developing, this page documents the best practices we have studied and established for virtual events at Example Company.
...
We have 3 separate Google calendars to manage different types and platforms of virtual events in Example Company:

* [Example Company-Hosted On24 Webcasts/Workshops](https://calendar.google.com/calendar?cid=Z2l0bGFiLmNvbV8xcXZlNmc4MWRwOTFyOWhldnRrZmQ5cjA5OEBncm91cC5jYWxlbmRhci5nb29nbGUuY29t)
* [Example Company-Hosted Zoom Webcasts/Workshops](https://calendar.google.com/calendar?cid=Z2l0bGFiLmNvbV8xcXZlNmc4MWRwOTFyOWhldnRrZmQ5cjA5OEBncm91cC5jYWxlbmRhci5nb29nbGUuY29t)
...
All 3 calendars are consolidated into a single Example Company virtual events calendar view (above - calendars are not public because they contain secure login for presenters). **The purpose of the consolidated view is to help event organizer(s) minimize topic overlap with other Example Company virtual events happening around the same time and to provide executive visibility into ALL virtual events that Example Company is running/participating in.**

### Glossary of calendar event naming convention {#calendar-glossary}

* `[Hold WC Hosted] Webcast title` - Example Company hosted webcast still in planning
* `[WC Hosted] Webcast title` - Confirmed Example Company hosted webcast
* `[DR WC Hosted] Webcast title` - Dry run for Example Company hosted webcast
...
The [external virtual events](https://calendar.google.com/calendar?cid=Z2l0bGFiLmNvbV8xOGVqOHN0NmlxajZpYXB1NTNrajUzNHBsa0Bncm91cC5jYWxlbmRhci5nb29nbGUuY29t) calendar will be used to log all planned and scheduled sponsored webcasts and virtual conferences. **The purpose of this calendar is to provide visibility and help the sponsoring team minimize topic overlap with other Example Company virtual events happening around the same time and to provide executive visibility into all Example Company external virtual events.**
...
* For sponsored webcast please use the following naming convention `[Hold WC sponsored] Event title` (e.g: `[Hold WC sponsored] Securing your pipeline with Example Company and WhiteSource`).
...
We have developed a [decision tree on FigJam](https://www.figma.com/file/Imb5xNnRryAPs59A79fseu/Virtual-Events-Decision-Tree_2023-09-14_18-05-13?type=whiteboard&node-id=0%3A331&t=jxFHr7UTeRBDPXq7-1)to help you determine what type of Example Company-hosted virtual event is the best fit for you.

## Virtual event types {#types}

### Webcast {#webcast}

This is a Example Company-hosted virtual event with `Webcast` type configuration, which **requires registration** to enable Marketo sync. There are two tech platforms used for webcasts (based on the audience/goal):
...
Note: these events are not included in the above decision tree as they are not Example Company-hosted events. [External virtual events handbook](/handbook/marketing/virtual-events/external-virtual-events/)
...
### Example Company-hosted Virtual events details by type {#detail-by-type}
...
* **Paid Ads:** n/a, -21 days prior to live event, DRI = DMP (requires Example Company owned pages - about.example_company or pages.example_company)
...
When scheduling an event, this table can help guide you towards the right event type to select based on the features you would like to use during the event. Example Company hosted virtual events will need to fit into either: Zoom Webcast type or Zoom Meeting type.
...
* Password protect sheets for lists (use under Example Company ID only, Example Company only access)
...
>By registering for this event, you agree that Example Company may email you about its products, services and events. You may opt-out at anytime by unsubscribing in emails or visit our [communication preference center](/handbook/company/preference-center/).
...
>By registering for this Example Company and `[partner name]` event, you agree that Example Company and `[Partner name]` may email you about their products, services and events. You may opt-out at anytime by unsubscribing in emails or visiting the relevant company's preference center.
...
Currently, we do not use Zoom's landing page for webcast registration as MPMs manage the webcast registration process by creating an about.example_company landing page and integrating form fills to Zoom via Marketo. The Zoom integration tracks sources that drove the registration using UTM parameters. See [full documentation on when and how to use utms](/handbook/marketing/integrated-marketing/digital-strategy/digital-strategy-management/#utms-for-url-tagging-and-tracking).

### Live streaming {#live-streaming}

Due to current security concerns, live streaming to YouTube from Zoom has been [temporarily shut down](https://example_company.com/example_company-com/gl-security/secops/operations/-/issues/871). There is also a security concern regarding Zoom meetings that are [recorded to the cloud](https://example_company.com/example_company-com/gl-security/secops/operations/-/issues/833). If you wish to record your virtual event and upload to YouTube later, record to your local machine (not to the cloud) and open an issue in the [digital production project](https://example_company.com/example_company-com/marketing/growth-marketing/global-content/digital-production) to have the digital production team review your recording prior to being uploaded to YouTube.

## Virtual Event Best Practices {#best-practices}

You may also want to review the [Example Company Video Playbook](/handbook/communication/video-playbook/), which offers guidance on creating engaging video content, much of which also applies to virtual events.
...
* Have a plan for content use and distribution post-event. Be sure to communicate to the audience if they will receive the slides/recording and also a timeframe in which they will receive the content.
  * For both Example Company-owned and external events, speakers and content DRIs should build in steps for legal approvals from necessary parties on pubic-facing presentations before materials are due.
...
* Create a list of sessions/tracks relevant to Example Company and encourage staff to attend.
...
* If you are the event planner, you may want to create an event profile as "Example Company Moderator" so you can create more brand awareness and manage more aspects of the event without being tied to yourself. It also gives another opportunity for people to interact with the brand if they don't know where to start.
...
* Remember your background: this will be recorded and published online.
  * Recommend using [Example Company branded virtual backgrounds](https://about.example_company.com/press/press-kit/).
...
* If someone will be introducing you, ensure they know how to pronounce your name, title, and Example Company correctly.
...
* If there is a chat function on the speaking session:
  ...
  * Have staff post in the chat that they are a representative of Example Company and happy to answer any questions.
...
* Add "- Example Company" and the end of your name or "- your title" to your event profile depending on what is displayed in the event when in chat rooms or other interactive areas. If the event platform accepts emoji (often possible if there is a mobile app) feel free to use the fox emoji or something else that shows your personality.
