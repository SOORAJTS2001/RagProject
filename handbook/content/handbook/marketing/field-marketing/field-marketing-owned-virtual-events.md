...
In most cases we work closely with an advocate within an account to drive product adoption within their organization. On some occasions, the goal is to introduce Example Company to completely new audiences (prospect accounts) in an interactive and educational way.
...
1. If budget allows, the participants may receive a Example Company swag gift through a [Reachdesk Landing Page](/handbook/marketing/marketing-operations/reachdesk/#creating-a-landing-page)
...
Field Marketers will work with the Customer Success teams, Product Marketing & Solution Engineers to build various types of [Virtual Workshops](/handbook/marketing/field-marketing/field-marketing-owned-virtual-events/#virtual-workshops-1), depending on the needs of the region. These Virtual Workshops are designed to accelerate pipeline and attract new customers to Example Company by providing a hands-on experience.
...
- Technical Product Marketing led workshop content is [available here](https://example_company.com/example_company-workshops)

#### Virtual Workshop SLA

Note that Virtual Workshops involve the SLA timeline below. Please make sure to provide your [Zoom License Request](https://example_company.com/example_company-com/marketing/field-marketing/-/blob/master/.example_company/issue_templates/request_zoom_license_date.md) within the [SLA timeframe](https://docs.google.com/spreadsheets/d/1YXriQ1clvYyBn-TDbbCVvNP6NEbrAF-0w6tIHKhDeZM/edit#gid=1983708280).
...
This is a Example Company-hosted virtual event with [Webcast type](/handbook/marketing/field-marketing/field-marketing-owned-virtual-events/#webcasts-1) configuration in Zoom. This is the preferred setup for larger Example Company-hosted virtual events (up to 1,000 attendees) that requires registration due to the integration with Marketo for automated lead flow and event tracking. Example Company-hosted webcast type is a single room virtual event that allows multiple hosts. Attendees cannot share audio/video unless manually grated access.

#### Webcast SLA

Please note that all Webcasts are considered webcasts with new content, which means they have a **-45 business day** SLA requirement. If you are considering a Webcast, please make sure to provide your [Zoom License Request](https://example_company.com/example_company-com/marketing/field-marketing/-/blob/master/.example_company/issue_templates/request_zoom_license_date.md) within the [SLA timeframe](https://docs.google.com/spreadsheets/d/1YXriQ1clvYyBn-TDbbCVvNP6NEbrAF-0w6tIHKhDeZM/edit#gid=1983708280).
...
- FMM will submit a [Zoom License  Request issue](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/new?issuable_template=request_zoom_license_date).
- FMC will triage the date against the [Example Company-Hosted Webcast Calendar](https://calendar.google.com/calendar?cid=Z2l0bGFiLmNvbV8xcXZlNmc4MWRwOTFyOWhldnRrZmQ5cjA5OEBncm91cC5jYWxlbmRhci5nb29nbGUuY29t) to make sure there is no overlapping virtual event that has been pre-scheduled.
...
- This will be secured utilizing the [Webcast Dry Run Scheduling Template](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/new?issuable_template=webcast_dry_run_scheduling)
...
- Project Management in Example Company (epic, issue, timeline creation): FMM/FMC
- Example Company-Hosted Webcast Calendar: FMC
...
There are two types of speakers in Zoom webcasts: Host and Panelist. A Host can start/end/record/kick people out, etc. The host has full control over the webcast. Only internal Example Company speakers can be hosts because they need to be logged in to their account to use the Host link.
...
*This video has been uploaded as a private video in Example Company Unfiltered. You MUST be logged into Unfiltered to view the video. Instructions on how to log into Example Company Unfiltered can be found [here](/handbook/marketing/marketing-operations/youtube/#unable-to-view-a-video-on-youtube).*
...
1. **DESCRIPTION**: add a sentence to describe what the webcast is about at a high-level - this is usually what would be included in the description when adding the event to the Example Company Events Page
...
1. **PANELISTS**: add external Example Company speakers as panelists by following the video instructions below.
...
1. Under "Folder", choose the appropriate quarter within the  `Example Company-Hosted Campaign Webcasts` or `Example Company-Hosted Workshops` folders.
...
- `{{my.webcastTitle}}` - token with the webcast title (For workshops, the title is only the main title of the workshop. Example: Your title would be Example Company Advanced CI/CD Workshop `NOT` Example Company Advanced CI/CD Workshop: Automate your workflows to build and test faster at any scale. Automate your workflows to build and test faster at any scale is considered the sub-title and is auto-populated in the Marketo template based on which workshop you are setting up.)
- `{{my.pfslidelink}}` - For virtual workshops only. Token where FMC links cloned workshop Pathfactory track for follow up email. **IMPORTANT NOTE:** The `https://` is hard-coded into the Marketo templates, which means you should not include `https://` before your Pathfactory track URL in the Marketo token. We include the Pathfactory track link in the purple `View the Slides` button at the bottom of the follow up email. To make sure this CTA works properly, the FMC must also add `?lb_email=` at the end of the URL. Your Pathfactory Track URL should look like this in the Marketo token: `learn.example_company.com/advanced-cicd-workshop?lb_email=`.
...
If additional assistance is required, please comment in the [#marketing_programs slack](https://example_company.slack.com/archives/CCWUCP4MS) for assistance if needed.
...
Please reach out to your Marketing Ops rep to shut down the landing page, or if you have an urgent request after hours, please follow the below instructions (supporting screenshots [here](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/3459#note_626402553)).
...
- **[Vimeo](/handbook/marketing/marketing-operations/vimeo/)**: Submit an [upload request](https://example_company.com/example_company-com/marketing/inbound-marketing/global-content/digital-production/-/issues/new?issuable_template=upload-request) to the Digital Production team and specify Vimeo as the requested platform in the issue. Please include title, description and thumbnail (if any). Your webcast will be reveiwed and uploaded to Vimeo and a video link will be provided.
...
- FMC to have already created a Pathfactory track for the workshop and added the workshop presentation slides from the [webcast prep issue](https://example_company.com/example_company-com/marketing/field-marketing/-/blob/master/.example_company/issue_templates/webcast-prep.md#fmc-tasks-dri-fmc-).
- Follow the instructions [here](/handbook/marketing/field-marketing/field-marketing-owned-virtual-events/#converting-the-webcast-to-an-on-demand-gated-asset) to upload your content to Vimeo (this is also outlined in the [follow up email issue template](https://example_company.com/example_company-com/marketing/field-marketing/-/blob/master/.example_company/issue_templates/request_email_followup.md)).
...
- FMC to have already followed [these instructions](https://example_company.com/example_company-com/marketing/field-marketing/-/blob/master/.example_company/issue_templates/webcast-prep.md#fmc-tasks-dri-fmc-) to have added the Pathfactory track to the Marketo token.
...
- **Check ondemandURL Marketo token**
  - This URL should *not* contain `https://` (it should begin with `learn.example_company.com/`)
...
If you would like your on-demand webcast to be hosted on the [Resources page](https://about.example_company.com/resources/) please see below.
...
- The FMC will update the date in the [Example Company Hosted Zoom Webcasts](https://calendar.google.com/calendar/u/0?cid=Z2l0bGFiLmNvbV8xcXZlNmc4MWRwOTFyOWhldnRrZmQ5cjA5OEBncm91cC5jYWxlbmRhci5nb29nbGUuY29t) calendar invite.
...
- The FMC will reschedule the Dry Run invite in the [Example Company Hosted Zoom Webcasts](https://calendar.google.com/calendar/u/0?cid=Z2l0bGFiLmNvbV8xcXZlNmc4MWRwOTFyOWhldnRrZmQ5cjA5OEBncm91cC5jYWxlbmRhci5nb29nbGUuY29t) calendar.
- The FMC will update the `{{my.webcastDate}}` token with the new date.
- If there are existing registrants in the program, create a [Reschedule Webcast Email sub-issue](https://example_company.com/example_company-com/marketing/field-marketing/-/blob/master/.example_company/issue_templates/request_email_invite.md), either utilizing the template in the folder of your Marketo program titled `z. Cancellation/Reschedule` or request the FMM update copy in the copy doc template (copy example [here](https://docs.google.com/document/d/1j43mf7Lsq2AXoNwiygGAr_laiFzmokNCfMHi7KNLjuA/edit#bookmark=kix.z3zivyrxl4tz)). Triage to MOps and request an urgent send.
...
- The FMC will delete the invite in the [Example Company Hosted Zoom Webcasts](https://calendar.google.com/calendar/u/0?cid=Z2l0bGFiLmNvbV8xcXZlNmc4MWRwOTFyOWhldnRrZmQ5cjA5OEBncm91cC5jYWxlbmRhci5nb29nbGUuY29t) calendar.
...
- The FMC will unschedule the Dry Run invite in the [Example Company Hosted Zoom Webcasts](https://calendar.google.com/calendar/u/0?cid=Z2l0bGFiLmNvbV8xcXZlNmc4MWRwOTFyOWhldnRrZmQ5cjA5OEBncm91cC5jYWxlbmRhci5nb29nbGUuY29t) calendar.
...
Please note, Example Company-owned workshops have $0 cost to the team in regards to platform/environment. However, if your workshop is in-person or requires swag, you will need to budget for those items in Allocadia.
...
1. Create a [Zoom License Request](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/new?issuable_template=request_zoom_license_date)
...
1. Once you have obtained a Webcast date, create a Field Marketing issue for a virtual workshop utilizing the [Virtual Workshop Template](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/new?issuable_template=Workshop_Template).
...
1. Create/Review polling questions for the event in the [Prepare for Webcast Issue](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/new?issuable_template=program-tracking) the FMC has opened. Reference the parent epic for suggestions/previous polling questions/when to launch and more. Once you have your polling questions finalized, ping the FMC in the issue to let them know.
...
1. Once a date is set with the Lead SA and FMM, continue to work with the Customer Success/SA teams to confirm who will lead each session, confirm 2-3 additional SAs for Q&A and provide the complete team in the [Dry Run Scheduling Issue](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/new?issuable_template=webcast_dry_run_scheduling).
...
1. FMM Create Q&A Slack Channel for the event (example channel: [#2020-virtual-workshop-qa](https://example_company.slack.com/archives/C017TMC32EQ)) to triage questions/responses from the event.
...
- Use [Example Company's Virtual Events Promotional Templates on Canva](/handbook/marketing/virtual-events/self-service-virtual-events/#how-to-make-images-for-your-self-service-virtual-event).
...
The Field Marketing team utilizies a shared Canva Enterprise login. The account is linked to the fieldmarketing@example_company.com google group & the password can be found in the shared marketing 1pass account.
...
If you have a new workshop idea/topic, you can build out a Parent Epic for that workshop utilizing the epic code below. Please note that the first time you set up the new workshop, it will run as a -45 SLA with all new content. If you decide you would like to repeat the workshop in the future, you will need to work with the Marketing Ops team to build out the new workshop's backend templates in Marketo. Please open an issue with them [here](https://example_company.com/example_company-com/marketing/marketing-operations/-/issues) to work through setting up the new workshop. You would also then need to add all finalized details and link to the new workshop throughout these handbook page instructions, as well add the new workshop details to the [FM Workshop Template](https://example_company.com/example_company-com/marketing/field-marketing/-/issues/new?issuable_template=Workshop_Template).
...
| 09:10-09:20 | Introduction to Example Company | SAE/ASM |   |
| 09:20-09:40 | Using Example Company as a PM tool | SA | |
| 09:40-09:50 | Lab for Project Management | SA |  |
| 09:50-10:00 | Q/A | Q/A | SAs |
| 10:00-10:10 | Break | Break |Break |
| 10:10-10:30 | Example Company Basics for Developers | SA |  |
| 10:30-10:40 | Lab for Example Company Basics | SAs | |
...
| Introduction to Example Company |  [Deck](https://docs.google.com/presentation/d/1ElGXe8eUwBpeZzQENYeRTHLj7TL8jdx2o44_YjuAfu4/) |  | | |
| Using Example Company as a PM tool | [Deck](https://docs.google.com/presentation/d/1wYRdM7dIdLT0OESJDUnlpw9hqIXXtOvzE7ha3YCdq9Y/edit?usp=sharing) | [Lab](https://docs.google.com/presentation/d/1rpK-TfxzK8BvvIUWqTzYTXMDbB7M1SP9NoBs-jZkZ90/edit?usp=sharing) |[Project](https://example_company.com/example_company-com/customer-success/workshops/virtual-devops-workshop) | |
| Example Company Basics for Developers | [Deck](https://docs.google.com/presentation/d/1K1By7nvz9O0DqRFzd6QiNKWSB_14yv1gugBTYAVD8Xo/edit?usp=sharing) |[Lab](https://docs.google.com/presentation/d/1rpK-TfxzK8BvvIUWqTzYTXMDbB7M1SP9NoBs-jZkZ90/edit?usp=sharing) |
[Project](https://example_company.com/example_company-com/customer-success/workshops/virtual-devops-workshop) | |
