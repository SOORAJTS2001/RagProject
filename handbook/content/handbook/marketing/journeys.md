...
A contributor is someone who contributed to Example Company with code, documentation, a blog article, a tweet, a talk, a meetup, and/or helping on the issue tracker/forum/irc.

1. Find Example Company (technical blog post)
1. Reach out to Example Company on social media (social media response)
...
| Stage                    | Measured By     | Example Company Owner          |
|--------------------------|-----------------|-----------------------|
| Aware                    | ?               | Marketing             |
...
Our customers get the most value out of the Example Company product when they use multiple stages. The [user adoption journey](/handbook/product/product-principles/#multi-feature-usage-adoption-journey) covers the most common path our users follow to adopt Example Company's product stages.

## Buyer journey

| Stage              | Measured By                                                                                            | Example Company Owner          | Activities                                        |
|--------------------|--------------------------------------------------------------------------------------------------------|-----------------------|---------------------------------------------------|
...
| Contribute         | More than a reference, the customer contributes to the Example Company project or community                     | Community Advocates   | Code; feature requests; Customer Advisory Boards  |
...
The focus is on **positioning Example Company as a viable and compelling solution to a potential buyer's specific problem**.
...
The focus is on key information that a buyer needs to **justify Example Company as their chosen solution**.
