...
Inbound Marketing exists to build, grow, and protect the business value created at the top of Example Company's marketing funnel. Through organic engagement with our content, both on the Example Company website and through other channels, we work to establish mindshare and relationships with existing and potential Example Company customers.

## Measuring Progress

### Website Pageviews

Cumulatively increase pageviews on the Example Company Marketing Website by 20% year-over-year.
...
Example Company team members can view the [internal dashboard](https://docs.google.com/spreadsheets/d/1HHiHzRu45yl_PZtNQ-pYaGbCU52HAUulLToVgcfUNcU/edit#gid=1049621665)
...
SSoT: Example Company team members can view the [live internal dashboard for inquiries](https://app.periscopedata.com/app/example_company/431555/Marketing-Metrics?widget=6091408&udv=1021195) and [trials](https://app.periscopedata.com/app/example_company/761665/TD:-Sales-Funnel---Target-vs.-Actual?widget=10895616&udv=1244465)
...
- From one of the following Sisense sources:
  - Trial - Enterprise
  - Trial - Example Company.com
  - Inbound

## Planning

Inbound Marketing planning activities are organized in [this epic](https://example_company.com/groups/example_company-com/marketing/inbound-marketing/-/epics/30). We currently plan on an annual and quarterly cadence, and are moving toward [planning two quarters in advance for H2 FY22](https://example_company.com/groups/example_company-com/marketing/inbound-marketing/-/epics/362).

## Objectives & Key Results

Inbound Marketing sets quarterly OKRs, and also maintains a backlog of future OKR candidates for consideration.

[Q2 FY22 Inbound Marketing OKRs](https://example_company.com/groups/example_company-com/marketing/inbound-marketing/-/epics/318)

### Past OKRs

- [Q1FY22 OKRs](https://example_company.com/groups/example_company-com/marketing/inbound-marketing/-/epics/227)
- [CANDIDATES Q2FY22](https://example_company.com/groups/example_company-com/marketing/inbound-marketing/-/epics/226)
...
- [Request a redirect](https://example_company.com/example_company-com/marketing/inbound-marketing/growth/issues/new?issuable_template=set-up-a-new-redirect)
- [Request keyword research](https://example_company.com/example_company-com/marketing/inbound-marketing/growth/issues/new?issuable_template=keyword-research-request)

#### Video Issue Templates

- [Requesting a new video](https://example_company.com/example_company-com/marketing/inbound-marketing/global-content/digital-production/-/issues/new?issuable_template=new-video-request)
  - Use this template only for requesting new videos that haven't been produced yet
  - If you are looking for edits to existing content that has been filmed, use the [video editing request](https://example_company.com/example_company-com/marketing/inbound-marketing/global-content/digital-production/-/issues/new?issuable_template=video-editing-request)
  - Process documentation link placeholder
- [Requesting a video edit](https://example_company.com/example_company-com/marketing/inbound-marketing/global-content/digital-production/-/issues/new?issuable_template=video-editing-request)
  - Use this template for editing existing content that has been filmed
  - DO NOT use this template for new videos
  - Process documentation link placeholder
- [Requesting a video upload](https://example_company.com/example_company-com/marketing/inbound-marketing/global-content/digital-production/-/issues/new?issuable_template=upload-request)
  - Process documetation link placeholder

## How we use Example Company
...
[Triage Board](https://example_company.com/groups/example_company-com/-/boards/1761578?&label_name%5B%5D=mktg-inbound&label_name%5B%5D=mktg-status%3A%3Atriage)
...
[Sprint Board](https://example_company.com/groups/example_company-com/-/boards/1761580?label_name%5B%5D=mktg-inbound&label_name%5B%5D=mktg-status%3A%3Awip)
...
[Inbound Marketing Leads Overview](https://example_company.com/groups/example_company-com/-/boards/1787553?milestone_title=%23started&&label_name%5B%5D=mktg-inbound&label_name%5B%5D=mktg-status%3A%3Awip)
...
- **Top Level Epic**
  - Quarterly OKRs
    - [OKR structure iteration](https://example_company.com/example_company-com/marketing/inbound-marketing/growth/-/issues/914)
...
1. Manager creates [Access Request issue](https://example_company.com/example_company-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request) for relevant Example Company projects and Slack channels
1. Manager creates Intro to Example Company issue
...
1. Vendor completes Intro to Example Company issue, including standard and design and or dev on-boarding tasks (depending on vendor type).
...
1. Questions about on-boarding, please see handbook, your manager, and or thge [#marketing_brand_contractor_onboarding](https://example_company.slack.com/archives/C0114QFK8M6) channel.
...
- **Assigning Issues to Vendors**
  ...
  - Confirm the issue appears on the [vendor board](https://example_company.com/groups/example_company-com/-/boards/1511334?scope=all&utf8=%E2%9C%93&state=opened&label_name%5B%5D=mktg-inbound&label_name%5B%5D=outsource).
  - Capture opportunities to improve vendor management in the [vendor management epic](https://example_company.com/example_company-com/marketing/inbound-marketing/brand-and-digital/brand-and-digital/-/issues/248).
...
- **Managing Vendor Work**
  ...
  - Ensure projects to which you're assigned are maintained on the [vendor board](https://example_company.com/groups/example_company-com/-/boards/1511334?scope=all&utf8=%E2%9C%93&state=opened&label_name%5B%5D=mktg-inbound&label_name%5B%5D=outsource), just as you maintain your own projects.
  - Communicate with vendor in issues and or the vendor-contract slack channel, [#brand-contractors](https://example_company.slack.com/archives/C011PDBLWLC), per Example Company's async communication best practices. Also be aware Example Company's async model may be new to contractors. Be open to synchronous meetings as vendors acclimate to async work.
  - Meet standard Example Company and Brand and Digital work practices, including open and inclusive design and **weekly status updates**.
...
- **Invoicing** - Ensure vendors:
  ...
  - Adhere to Example Company's invoicing standards
