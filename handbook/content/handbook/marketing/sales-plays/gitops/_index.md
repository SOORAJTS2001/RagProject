...
- The [GitOps Marketing campaign](https://example_company.com/example_company-com/marketing/demand-generation/campaigns/-/issues/1183) has produced the highest amount of linear SAOs across all segments since launch in April 2020
- Over 45% of our [survey respondents at Kubecon EU](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/4792) highlighted that GitOps is a priority for their organization in the short term.
...
- GitOps helps you target a completely new persona and usecase - opening up [new land and expand opportunities](https://example_company.com/example_company-com/marketing/demand-generation/campaigns/-/issues/1183#sample-deals-from-fy21) for you
...
Have you faced infrastructure downtime and have not been able to trace it back to who made the changes, what changes were made and who approved it? Infrastructure automation with Example Company helps you bring Application DevOps best practices of collaboration, version control, CI/CD & Compliance to Infrastructure.

### Value Proposition (How Example Company does it?)

Unlike other vendors, GitOps with Example Company helps you manage physical, virtual and cloud native infrastructures. We use a tight integration with industry-leading infrastructure automation tools like Terraform, AWS Cloud Formation, and the like to meet you where you are - all with a single application.

Detailed section on How Example Company meets the market requirements [here](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/gitops/#market-requirements)

### Differentiators (How Example Company does it better?)

- Most competitive solutions require 5-6 integrations to achieve the GitOps workflow. Example Company offers version control, CI/CD and container registry & out of the box integration for config management, orchestration & infra provisioning.
- Better traceability across the workflow - Example Company can tie an infrastructure deployment all the way back to the change that was made - which is difficult in a workflow that is tied together with multiple solutions.
- Most competitors support predominantly cloud native - Example Company meets customers where they are supporting On-premise & cloud, physical, virtual, cloud native infrastructures
...
1. [Show how we are different](#differentiators-how-example_company-does-it-better)
1. Share the Forrester TEI report from the [pathfactory track for GitOps](https://learn.example_company.com/l/gitops-gtm-content)
1. Use the [ROI calculator](https://about.example_company.com/calculator/) to showcase the value of using Example Company as a single application over other solutions
...
1. As you hear their pains, challenges, business objectives and priorities, start using their own terms when explaining to them how GitOps with Example Company can help them.
...
1. Prepare your own GitOps environment for demo purposes by following the steps from the [GitOps lab](https://example_company.com/tech-marketing/workshops/cicd/cd-labs-instructions/-/blob/master/11.%20GitOps%20with%20GitLab.md) of the SA CD Workshop. This lab covers AWS as a cloud provider. If you'd like to add Google and/or Azure, you can extend your environment by leveraring our public-facing [GitOps demo](https://example_company.com/gitops-demo).
1. Share technical demos, webinars that are path of the [pathfactory track for GitOps](https://learn.example_company.com/l/gitops-gtm-content)
...
1. Use the content from the [GitOps Pathfactory track](https://learn.example_company.com/l/gitops-gtm-content) to share with your lead. You can get the content links (including tracking) directly from Pathfactory for Sales through SFDC. They are categorized by the stage in the customer's journey.
...
For the GitOps sales play, consider asking your customer about their workforce's proficiency with git, Example Company, and Example Company CI as they are foundational elements to GitOps. If they are not strong in all of these topics, consider positioning [Example Company with git Basics training](https://university.example_company.com/pages/example_company-fundamentals-training) and/or [Example Company CI/CD training](https://about.example_company.com/services/education/example_company-ci/).
...
- [Pathfactory track for GitOps](https://learn.example_company.com/l/gitops-gtm-content) to share with customers
...
- [BI Worldwide](https://learn.example_company.com/gitops-gtm-all/bi-worldwide-example_company?lx=AZeFEd)
- [Wag](https://learn.example_company.com/gitops-gtm-all/wag-labs-blog-post?lx=AZeFEd)
- [Nebulaworks](https://learn.example_company.com/gitops-gtm-all/nebulaworks?lx=AZeFEd)
- [SURF](https://learn.example_company.com/gitops-gtm-all/surf?lx=AZeFEd)
- [kiwi.com](https://learn.example_company.com/gitops-gtm-all/flying-base-native-clouds?lx=AZeFEd)
- [VMWare](https://learn.example_company.com/gitops-gtm-all/infrastructure-code-iac-terraform-cloud?lx=AZeFEd)
- [ValidaTek](https://learn.example_company.com/gitops-gtm-all/valida-tek-iac?lx=AZeFEd)
And many more [here](https://learn.example_company.com/l/gitops-gtm-content)
