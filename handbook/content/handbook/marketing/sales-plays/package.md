...
* Primary: SAEs and AEs who call on one or more existing Example Company Premium/Ultimate customers
* Secondary: SAs and CSMs who support one or more existing Example Company Premium/Ultimate customers

## Who to meet

**Ideal Customer Profile**  - Example Company customers looking to consolidate on Example Company and migrate away from JFrog's Artifactory or Sonatype's Nexus.
...
* Does the customer have any strategic initiative or priority to which consolidating on Example Company and removing an additional tool/license?
...
* Are the capabilities that are enabled by Example Company Package important to the customer? Why or why not? How do you know?

## Value Discovery

### Common Pains

Example Company Premium/Ultimate customers may be experiencing one or more of the below challenges:
...
By consolidating on Example Company for package management, customers may experience one or more of the below benefits:
...
| Use Example Company metadata to validate artifacts         | Dependency metadata is required to validate you are using the correct one.       |
...
| Required capabilities   | 1. Could Example Company help you get there?<br>2. What if you had one, known cost that enabled ALL your artifact management? <br>3. What if you could cache upstream packages to improve reliability and speed up your builds? |
