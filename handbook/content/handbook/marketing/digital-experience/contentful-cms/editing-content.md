...
2. For creating a *brand new* section of content that doesn't exist on the marketing site, you may need Digital Experience assistance, but you can start by creating the Entry.
   ...
   3. Create an [issue](https://example_company.com/example_company-com/marketing/digital-experience/buyer-experience/-/issues/new#) with the Digital Experience team to make sure that the code on that page can handle your new Entry.
...
4. To create a *net new page*, please fill out an [issue with the Digital Experience team](https://example_company.com/example_company-com/marketing/digital-experience/buyer-experience/-/issues/new#). We will likely need resources from the content team, design team, and engineering team to set up a new page.
...
1. To create a custom page, filter by the content type Custom Page, and select Add Entry in the top right corner
   ...
   - Has Next Step: Select yes if you'd like the "Take Example Company For a Spin" CTA.
