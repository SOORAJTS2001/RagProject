...
This page offers insights into incidents occurring on the Example Company marketing site, delineates methods to assess severity levels, and outlines avenues for obtaining support.
...
1. The Marketing site is composed of multiple repositories: the [blog](https://example_company.com/example_company-com/marketing/digital-experience/example_company-blog), [www](https://example_company.com/example_company-com/www-example_company-com), [navigation](https://example_company.com/example_company-com/marketing/digital-experience/navigation), [slippers](https://example_company.com/example_company-com/marketing/digital-experience/slippers-ui) and [buyer experience](https://example_company.com/example_company-com/marketing/digital-experience/buyer-experience).

1. www-example_company-com, Buyer Experience, and the Blog generate pages during the build process and upload these artifacts to a single GCP bucket. Upon pipeline execution, all artifacts are consolidated within the `/public` directory on our GCP bucket.
...
1. Are [vital business pages](https://example_company-com.example_company.io/content-sites/handbook/mr5699/handbook/marketing/digital-experience/contentful-cms/#for-top-10-most-visitedimpactful-pages) currently accessible?
...
**Point person:** [Nathan Dubord](https://example_company.enterprise.slack.com/archives/D021YDB4FM4) - Working hours: 9am - 6pm Eastern
...
1. If there is no response within five minutes, please text or phone the following people:
    1. Eastern Timezone (UTC−5):
        1. [Nathan Dubord](https://example_company.enterprise.slack.com/archives/D021YDB4FM4)
        2. [Laura Duggan](https://example_company.enterprise.slack.com/archives/D01H18BBUTW)
    2. Central Timezone (UTC−6):
        1. [Megan Filo](https://example_company.enterprise.slack.com/archives/D02SNEUHZ3L)
    3. Pacific Timezone (UTC−8):
        1. [Lauren Barker](https://example_company.enterprise.slack.com/archives/D0168EQ62EP)

_Call on the phone if no response within 15 minutes_

## PagerDuty

In the case of an emergency, Digital Expereince Engineers have the ability to create a pager duty incident and trigger alerts on each others mobile devices. These pager duty incidents can also be triggered by Example Company team members with access to Pager Duty (IT Security, Reliability, SIRT, ect)
...
2. Select `about.example_company.com` as the impacted service
