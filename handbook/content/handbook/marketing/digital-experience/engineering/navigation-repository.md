...
1. Create a new issue titled `Navigation release: Version x.x.xx` and include links to the MRs and Issues included in this release. This navigation issue should be added to the quarterly navigation release epic (ex. [FY23Q3 epic](https://example_company.com/groups/example_company-com/marketing/digital-experience/-/epics/155)). If this has been assigned to you already, you can skip this step.
...
To update the navigation in the repositorys that consume it, for example www-example_company-com, or buyer-experience:
...
_Note: You will have to visit pages built by that repository in order to see your navigation changes. For example, the website [homepage](https://about.example_company.com) is built in `Buyer Experience`, so you can visit the homepage in your review app to see your navigation changes. However the [handbook](/handbook/) is built by `www-example_company-com`, so you'll need to go to a handbook page in order to test your navigation changes in the `www` review app._
...
- There were some minor changes that can be viewed [here](https://example_company.com/example_company-com/marketing/digital-experience/navigation/-/issues/167)
...
- From this version onward, we **will no longer support the nav project in the www-repo anymore.** This means that www-example_company-com **must stay pinned to major version 4**. You will need to move your page over to [Buyer Experience by opening an issue](https://example_company.com/example_company-com/marketing/digital-experience/buyer-experience/-/issues/new#) if having the most up-to-date navigation is a concern for your content.
- In the `Buyer Experience` repository the nav updates will follow the current instructions.

## How to update the navigation on the www-example_company-com repository

In order to update www and Buyer Experience separately we created a [new main branch](https://example_company.com/example_company-com/marketing/digital-experience/navigation/-/tree/legacy-navigation-main) in the navigation repository.
...
- Open a new MR on [www repository](https://example_company.com/example_company-com/www-example_company-com) updating the navigation version on the `package.lock`
...
You may need to add click events on elements in the navigation, depending on the data you're looking for. Questions about this can be directed to the #digital-experience-team slack channel. We are not set up to run tests in the `www-example_company-com` repository at this time.
