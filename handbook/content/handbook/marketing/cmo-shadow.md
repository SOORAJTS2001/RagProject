...
description: "Example Company Marketing Handbook: CMO Shadow"
...
At Example Company, being a CMO shadow is not a job title, but a temporary assignment to shadow the CMO.
The shadows will be present at all meetings of the CMO during their rotation.
Example Company is an [all-remote](/handbook/company/culture/all-remote/) company, so the shadow will be attending virtual meetings hosted on Zoom.
...
| ---------- | -------- | ------- |
| 2021-05-17 | 2021-05-28 | [Michael Preuss](https://example_company.com/mpreuss22) - Director, Digital Experience |
...
- In Example Company: This can be seen on the CMO's [Example Company activity log](https://example_company.com/users/tbarr/activity).
