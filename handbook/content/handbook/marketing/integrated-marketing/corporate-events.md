---
title: Corporate Event Marketing at Example Company
description: For corporate event marketing at Example Company
twitter_image: null
twitter_image_alt: Example Company's Corporate Marketing Team Handbook
...
* The mission of the Corporate Events Team is to:
  * Tell the Example Company story through engaging events
  * Make customers the hero
  * Build lasting and trusting vendor and internal relationships
  * Help elevate the attendee/customer's Example Company experience during events
...
* Owned events
  * [Example Company DevSecOps World Tour](https://about.example_company.com/events/commit/), our User & Customer Conference
* Internal events
  * [Example Company Summit](https://about.example_company.com/events/summit-las-vegas/), our internal company and core community event
  * Please review our events decision tree to ensure Corporate Marketing is the appropriate owner for an event. If it is not clear who should own an event based on the [decision tree](https://docs.google.com/spreadsheets/d/1aWsmsksPfOlX1t6TeqPkh5EQXergt7qjHAjGTxU27as/edit?usp=sharing), please email events@example_company.com.
...
General Questions: [events at example_company dot com](mailto:events@example_company.com)

Summit-related Questions: [summit at example_company dot com](mailto:summit@example_company.com)

DevSecOps World Tour-related Questions: [events at example_company dot com](mailto:events@example_company.com)

## How We Evaluate and Build Potential Events

All Example Company events must check at least  three or more of the goals of our events below to be considered.

1. Brand awareness- we want to be a household name!
2. Build community
3. Evangelize a remote-first culture
4. Gain contributors
5. Share Example Company thought leadership
...
**If you are looking to request a new Corporate Event, please use the following [issue template](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=Event_Request)
...
* Will there be a Example Company speaker? We do not require a speaker slot in return for sponsorship but we do prioritize events where the audience will be hearing about Example Company - either from a Example Company team-member or a member of the wider Example Company community.
...
* Where will the event be held? We aim to have a presence at events around the globe with a particular focus on areas with large Example Company communities and large populations of support.
...
* **Brand**
  * For Sponsored Events: Get the Example Company brand in front of 15% of the event audience. 40,000 person event we would hope to get 4,000+ leads (10%) and 5% general awareness and visibility with additional branding and activities surrounding participation.
...
* [FY25 Sponsored Events & Epics](https://example_company.com/groups/example_company-com/marketing/-/epics/4775)
* [FY25 Dev Evangelism Event Strategy](https://example_company.com/groups/example_company-com/marketing/developer-relations/-/epics/326/)
...
**Goal:** ensure that Example Company's presence is widely recognized at all sponsored events.
...
If our sponsorship does not include a speaking session, the ECM will ensure that our Developer Advocate team has it on their radar via the [FY24 Dev Evangelism Event Strategy](https://example_company.com/groups/example_company-com/marketing/developer-relations/-/epics/326/) to submit during the event's open CFP.
...
If the event we are sponsoring is not on the Developer Advocate team's radar to submit the CFP the ECM will start the conversation with the DE team via a comment on the [strategy issue](https://example_company.com/groups/example_company-com/marketing/developer-relations/-/epics/326/).

### Lightning Talks at Example Company Booth for Third party events
...
* Overall Content DRI: Senior Management in Product Marketing or otherwise assigned by senior management, could be vary based on event
  ...
  * Example Company Lightning Talk DRI: Senior Management in Product Marketing, could be vary based on event
...
3. Once content is confirmed and the lightning talk schedule is finalized, content creation can begin. The Corporate Events Content Manager will create an issue for each lightning talk.
    * For each Example Company lightning talk the Corporate Events Content Manager will provide a Example Company branded slide template for each session. For Partner lightning talks, the partner can create their lightning talk on their own company's branded template.
    * [Issue template for Example Company Lightning Talks](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=event-lightningtalk-example_company-speaker)
    * [Issue template for Partner Lightning Talks](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=event-lightningtalk-partner-speaker)
4. Once Example Company content is created, it will then go through the review process which will entail: Overall Content DRI Review, Brand Compliance DRI Review, and Legal Review (only if necessary). Reviewers will leave feedback as comments in the slide presentation to be addressed.
...
## Example Company DevSecOps World Tour

* DevSecOps World Tour - Planning Epic _coming soon_
* Example Company DevSecOps World Tour, Example Company's user conference, is an event that connects you to the ideas, technologies, and people that are driving DevSecOps transformation and is for the technology champions responsible for building, operating and securing applications.
...
For both Example Company-owned and external events, speakers and content DRIs should build in steps for legal approvals from necessary parties on public-facing presentations before materials are due.
...
<table>
  ...
  <tr>
   ...
   <td>For all Example Company events
   </td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=Event_DRI_Template">Event DRI Template</a>
   </td>
  </tr>
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=Event_Travel_Staffing_Template">Event Travel Staffing Template</a>
   </td>
  </tr>
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=Event_Ancillary_Template">Event_Ancillary_Template</a>
   </td>
  </tr>
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/marketing-operations/-/issues/new?issuable_template=promotional_games_legal_template">Promotional Game Rules Template</a>
   </td>
  </tr>
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=Event_Sponsored_Corporate_Template">Sponsored Corporate Event Template</a>
   </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/field-marketing/-/issues/new?issuable_template=ISR_SDR_FMTemplate">FM Event SDR Support Issue Template</a>
   </td>
  </tr>
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=social-event-request">Social Media Event Promotion Issue Template</a>
   </td>
  </tr>
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=PR_Media_Podcast_Involvement_Request">PR Media Podcast Involvement Issue Template</a>
   </td>
  </tr>
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=request-design-general">Brand Asset Design Requests Issue Template</a>
   </td>
  </tr>
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/marketing-operations/-/issues/new?issuable_template=event-clean-upload-list">Upload Clean Lead List Post Event Issue Template</a>
   </td>
  </tr>
  <tr>
   <td><a href="https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/issues/new?issuable_template=Event_Post-Event_Video_Upload">Post Event Video Upload Issue Template</a>
   </td>
  </tr>
   <td><a href="https://example_company.com/example_company-com/marketing/demand-generation/campaigns/-/issues/new?issuable_template=request-corp-conference-email">Pre & Post event outbound email Issue Template</a>
   </td>
  </tr>
</table>

### Best Practices on site at a Example Company event
...
## Accessibility at Example Company Hosted Events
...
* For all Example Company hosted events of 300+ we hire security that is also certified in first aid.
...
## Virtual Events at Example Company

At Example Company, the Corporate Events team owns events that meet specific criteria (link), including those events that have a global hybrid or virtual element. By design, virtual events at Example Company are not a simple video call nor are they a static playlist. Example Company virtual events aim to retain the same [brand personality](/handbook/marketing/brand-and-product-marketing/brand/brand-activation/brand-standards/), engagement, inclusivity, and fun as our in-person events.

### Lead time

A Example Company virtual event requires **16+ weeks of lead time** in order to accommodate the successful planning, scripting, set-up, recording, editing, and executing of a program.

### What does a virtual Example Company event entail?
...
* **Support:** Example Company speaker support and content development, as outlined in the Commit Speaker page
...
* **Approval** : Ensuring all speakers and content undergo rigorous review and necessary approvals, as dictated by both Example Company Legal and speaker or partner requirements
...
#### Why Does Example Company Pre-Record Content?
...
* A minimum of 2+ weeks for editing and captioning of content: Because Example Company's content is technical and its community is so passionate, Events is committed to ensuring precise captioning so that all attendees can contribute
...
Having run several global-focused virtual events, the Example Company team has some [best practices and recommendations to share](https://docs.google.com/document/d/1rPvewsTWm8uqGv-6Wr4-_j4ZmBVjL75fU5_YGV98d24/edit?usp=sharing) with prospective speakers.

## Corporate Events' Diversity, Inclusion, and Belonging Initiatives

As part of the event planning and execution process at Example Company, the event lead will ensure that diversity, inclusion, and belonging initiatives are taken into consideration throughout the entire event process.

### Content Creation

The planning committee will ensure that there is an inclusive environment when selecting CFP/keynote/speakers which aligns with [Example Company's event requirements for speaking](/handbook/marketing/corporate-communications/speaking-resources/#event-requirements).
...
When working with a vendor or supplier, the team will ensure that the selected venue/vendor/supplier is supportive of Example Company's DIB values. These may include, but are not limited to the following:
...
### Example Company Hosted Events Best Practices
...
At Example Company, the Corporate Events team wants to continue to play our part and operate with integrity when we are making decisions. The team is consciously making decisions that help align with the company's social and environmental efforts.
