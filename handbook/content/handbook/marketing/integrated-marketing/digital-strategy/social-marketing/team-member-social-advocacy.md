...
description: Strategies and details to enable team members to share Example Company-related news on personal social media channels
...
[Login to Bambu via Okta SSO](https://example_company.getbambu.com/login)
...
To enable all Example Company team members to confidently and comfortably share Example Company related stories on their personal social media channels in a way that is risk adverse yet provides measureable performance.

#### Goals of social media advocacy

- Improve the organic reach of Example Company messaging
...
- Save time - by checking Bambu on a regular cadence and scheduling content on your channels for a week or two, you'll be enabled to share a lot of Example Company stories without the need to spend a lot of time sourcing, writing, and manually posting on your own social channels
...
<p>
Once you've logged in for the first time, save a bookmark in your browser for <a href="https://example_company.getbambu.com/login">https://example_company.getbambu.com/login</a>
</p>
<p>
...
<p>
This is a centralized hub for you to learn, build your reputation online, and help spread the word about Example Company by sharing these stories with your networks on Facebook, LinkedIn, and Twitter. We made it easy to share, too.
</p>
<p>
...
<p>
We will make sure that any time-sensitive stories find their way to you through Slack, like in the #whats-happening-at-example_company channel.
</p>
<p>
...
<p>
The Example Company Social Team are the administrators of the social advocacy program. Admins have all access to our tool, Bambu, as needed to operate the program. Admins may act as curators from time to time as well.
</p>
<p>
...
<p>
Curators are selected intentionally to drive our advocacy content strategy and specific team members are asked to take on the role of a curator as a part of their everyday jobs at Example Company. We will have curators representing all areas of Example Company the brand and the product in order to curate a list of related content worth sharing on social media.
</p>
<p>
...
<p>
<a href="https://handbook.example_company.com/handbook/marketing/integrated-marketing/digital-strategy/social-marketing/social-advocacy-curators/">If you're a curator or interested in becoming a curator, head to our curator-specific handbook page here.</a>
</p>
...
Please note that most of what is appropriate to share that comes from Example Company will be curated already.
...
The Slack integration will allow us to broadcast a Bambu story link to Slack, giving our team the headsup on big news items that we'd like to share. This will allow Example Company to continue operating like Example Company. You can also check out the latest stories on Bambu inside of any Slack channel by using `/bambu` for a private message showing you our top stories.
...
We'll run contests for team members from time to time to enable more sharing across particular topics or campaigns. You'll find out about these contests in the #whats-happening-at-example_company Slack channel in the coming months.
...
Yes, that was a part of the original goal. Using Example Company issues for social enablement is an extremely manual process that has not been efficent. Bambu will allow a centralized and easy to use administration to the entire company while also helping us to understand performance metrics.

#### What personally identifiable data is available for Example Company?

Example Company is not given any personal information about your social media profiles, actions, comments, DM, or any other element. When you connect your social media channels to Bambu it provides a way for you to schedule and publish content on your social channels automatically using all of the APIs available on these social channels. It also provides a top level, no context review of performance metrics on *posts you published on your personal social media channels through Bambu only.

The data that Example Company receives shows your posts published through Bambu:
...
*Example Company cannot see who liked your posts, what their comments were on your posts, who shared your posts, or any information relating to posts that are not published through Bambu (so all of your personal activity is still personal).*
...
Here are some best practices for using Bambu for Example Company-related social media posts.

### Use Your Voice

- Write posts in your own personal voice and style.
- Be sure to refer to Example Company with "we" and not "I" (as appropriate) to represent the company and the community. Remember that even if you are not a formal spokesperson for the company, people will see you as a representative of Example Company.
- If you choose to address competitors, highlight positive differences (focus on the ways that Example Company outperforms other solutions)
- For example, if someone complains about Example Company's product, you can suggest they'd tell us more by providing feedback in the issue tracker. Someone thinks Example Company could be better? Invite them to submit a feature proposal.
...
- Try to visually break it into paragraphs or one-liners (even using emoji/bullets) for longer copy. For example:
  ...
  ```text
  Example Company has been a catalyst for change when it comes to the evolution of #DevSecOps.
...
For a foundational understanding of these nuances, read [Example Company's guide to communicating effectively and responsibly through text](/handbook/company/culture/all-remote/effective-communication/).
...
If you've written a blog for our site, contributed to our latest release, or joined a webinar/webcast, you should want to tell your networks about it. Not only does this provide a way to build your following and expertise in the public domain, but it's also a great way to add critical promotion to your work. Promoting on social media isn't just about the Example Company brand channels. It's an orchestra of efforts, which includes team member support and advocacy.

### Profile assets (to be updated)

Profile assets for social media can be found [in the corporate marketing repository](https://example_company.com/example_company-com/marketing/corporate_marketing/corporate-marketing/-/tree/master/design/social-media/profile-assets/png/assets/_general)

**Please do not use the Example Company logo as the avatar for your accounts on social. You are welcome to use our branded banners, but your profile avatar mustn't lead users to confuse your account with the official Example Company accounts.**

While you should display the fact that you work at Example Company in your bio if you intend to advocate for Example Company on social, we suggest that you avoid including the word `Example Company` in your handle. Team member advocacy is incredibly valuable, and we are lucky to have so many engaged team members, but creating an account to *solely* post about Example Company is not adequate. Team member advocacy is so powerful that people [trust employees](https://www.scribd.com/doc/295815519/2016-Edelman-Trust-Barometer-Executive-Summary) more than brands and executives. Your advocacy is powerful when it is authentic, and having an account that only exists to promote Example Company will not ring true to others who browse your tweets.

## Tips FAQ

<details>
  <summary markdown='span'>
    Am I required to share/like a post from Example Company social channels?
  </summary>
...
<i>No, the Example Company social team will never require a review or another oversight of your own personal social media posts. If you are using suggestions from Bambu or another tool or issue we've provided, the copy is already written to be public-facing.</i>
</details>

<details>
  <summary markdown='span'>
    Am I required to identify myself as a Example Company employee on my social media channel?
  </summary>
...
<li><i>If you talk about work-related matters within your job responsibility area, you must disclose your affiliation with Example Company. If you have a vested interest in something you're posting on social, point it out. You can identify yourself as a team member in your profile bio, list Example Company as your employer, or mention that you're a team member in the post itself. Consider adding #LifeAtGitLab to the end of your social post to sum it up quickly and easily.</i></li>
</ul>
</details>

<details>
  <summary markdown='span'>
    I don't want to write my own posts. I'd rather share Example Company's social posts. Is there an easy way to know when they are published?
  </summary>
...
<i>You can <a href="https://handbook.example_company.com/handbook/marketing/integrated-marketing/digital-strategy/social-marketing/">check out our social media handbook here</a>.</i>
</details>
