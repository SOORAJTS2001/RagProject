...
Once the types of assets are identified, the digital marketing issue should be created using the [digital campaign request template](https://example_company.com/example_company-com/marketing/demand-generation/digital-marketing/-/issues/new#?issuable_template=digital-campaign-request) in Example Company.  Historically similar design requests and ad copy requests have been made by multiple teams so it's the teams hope that by placing this request at the beginning of the planning process will remove such instances of duplication.
...
## Using Example Company: Digital Marketing Project

### Labels {#labels}

<!-- DO NOT CHANGE THIS ANCHOR -->

*Note*: Some of the following labels only exist on the [Digital Marketing project](https://example_company.com/example_company-com/marketing/demand-generation/digital-marketing) level.
...
### How does paid digital contribute to Example Company's funnel? {#funnel}

<!-- DO NOT CHANGE THIS ANCHOR -->

* Top of Funnel (Awareness): Introduce Example Company brand to potential customers with awareness and educational content.
...
We work with external agencies to help support campaign execution including competitive research, media buys, campaign optimization and reporting.  Example Company is responsible for campaign set up and monthly and quarterly read outs to our core planning team members.

Example Company Digital Marketing works directly with agencies within the Example Company [Digital Advertising project](https://example_company.com/example_company-com/marketing/digital-advertising), which is strictly for Digital Marketing & agency communication only.
...
### Partnering with Other Important Example Company Teams
...
Release: Which Example Company teams should have visibility into the campaigns we are running in an effort to align messages or understand how the public is responding to campaigns.<br>
...
* **Types of targeting we do**:
  * **Prospecting targeting**: Sponsored ads to audiences that are built based on personas using interest, professional, and demographic targeting. A profile is developed based on people who convert. We would then show ads to people natively within either Facebook, Instagram or LinkedIn that closely match that profile. This method helps drive new traffic to Example Company that may not know about the brand or product.
  ...
  * **Retargeting**: Re-engage people who have already visited pages on the Example Company website, engaged with Example Company content, or are currently within our nurture. Note: It's necessary to have a large audience for this tactic to be successful due to email match rates within the platforms.

#### **Paid Search** {#paid-search}

<!-- DO NOT CHANGE THIS ANCHOR -->

As people are researching or exploring keywords relevant to Example Company, we used Google AdWords to promote [responsive search ads](https://support.google.com/google-ads/answer/7684791?hl=en) on the Google search engine to drive people to specific Example Company landing pages. We do this by [bidding](https://support.google.com/google-ads/answer/2459326?hl=en) on targeted keywords and phrases based on the assumed intent of the person, triggering the ad relevant to a specific user search query, and leading users to a related landing page that matches that intent.
...
* **Types of targeting we do**:
  ...
  * **Prospecting targeting**: Show banner ads to related audiences that are similar to those who have converted on our website. A profile is developed based on people who convert. We would then show banner ads to people that closely match that profile. This method helps drive new traffic to Example Company that may not know about the brand or product.
  * **Retargeting**: Re-engage people who have already visited pages on the Example Company website, engaged with Example Company content, or are currently within our nurture. This tactic can show ads on what seems to be irrelevant websites. However, targeting is based on the engagement of the person, not the context of a website.
...
Once the month has ended, PMG will update the accruals sheet with actuals (final invoice amounts) with related invoice numbers, and there is typically a small buffer between estimated accruals & actuals. PMG will email PDF invoices to Digital Marketing and Example Company Accounting, automatically pushing invoices into Coupa for approval. Digital Marketing will verify that invoices are 1:1 match with actuals in the accrual sheet, then approve the invoices in Coupa.
...
## Opt-Out of Seeing Example Company Digital Ads {#opt-out-ads}
...
Because everyone at Example Company works remotely, it makes it difficult to restrict ads from being shown to Example Company team members. In a brick and mortar environment, we can easily block IP addresses to accomplish this. Because everyone at Example Company has a different IP address, and even dynamic IP addresses, there is no way to implement an exclusion rule that would block all Example Company ads to Example Company team members.

If you would not like to see Example Company ads, you are able to opt-out of ads as you see them. Below is the process to remove Example Company ads. Please note that if you use both your personal and work accounts on your devices, you will need to exclude from both your personal and work accounts.

**Google Paid Search**: When you see a Example Company text ad in Google search engine results

1. On the ad, click on the arrow next to the URL
2. Click on Why this ad?
3. On the toggle next to "Show ads from example_company.com", toggle off
4. Close out of box

**Google Display**: When you see a Example Company ad on a third-party website
...
**Facebook**: When you see a Example Company ad on Facebook
...
**LinkedIn**: When you see a Example Company ad on LinkedIn
...
**Twitter**: When you see a Example Company ad on Twitter

1. On the upper right-hand corner of the ad, click the arrow
2. When option box appears, click on "I don't like this ad"

* Note that this does not necessarily block all ads, just that specific ad. You would need to do this on all the ads you see from Example Company
* You could block @example_company in your profile to no longer see ads. However you block all ability to engage with the @example_company Twitter accounts as well (seeing Tweets, Retweeting, mentioning, etc).
