...
Welcome to the Sales Development Organization at Example Company! We are a team designed to drive [results for customers](/handbook/values/#results) through both inbound and outbound strategies. Our structure is designed to maximize efficiency, responsiveness, and creativity in our outreach efforts.
...
Try searching for as many permutations of what you're looking for. For example, if you want to find information on lead scoring search for keywords like `score, scoring, lead, leads, scoring`. Remember that [information retrieval](/handbook.example_company.com/teamops/shared-reality/) is a core Example Company value, and a skill that will make a big difference in your careers.
...
| ------ | ----- |
| I am Field Marketer, and want to have people invited to my event | We typically work with the FM process outlined on the issue template called `FM-BDR-Collaboration-Template` that can be found [here](https://example_company.com/example_company-com/marketing/sales-development/-/issues/new), but are always eager to collaborate in making your events more succesful, if your ask is not covered in the template linked above, please write to us on the #sales_dev_global slack channel and we'll jump in to assist. |
...
| I am a Sales Manager, and want to gauge the quality and progress of the SAOs provided to my team. | We have a robust set of pipeline [progression dashboards](/handbook/marketing/sales-development/#our-sfdc-dashboards) that break down results in a lot of granularity. We also have a structured path for handing off opportunities from the SDR/BDR teams to the AE team that you can use to measure adherance to qualification criteria and [next steps](handbook.example_company.com/handbook/marketing/sales-development/#sdrbdr-to-ae-sao-handoff-process). |

## Our Slack Channels

| Channel                                             | Slack Handle                                      |
| ---------------------------------------------------- | ------------------------------------------------- |
| **Main Channel - (Global VP - JB Larramendy)**       | [`#sales_dev_global`](https://example_company.slack.com/messages/C2V1KLY0Z) |
| **Announcements - (SDR Ops/Enablement - Chris Wang)**| [`#sales_dev_fyi`](https://app.slack.com/client/T02592416/C011P828JRL) |
| **All - AMER (Manager - Brian Tabbert)**            | [`#amer_sales_dev`](https://example_company.enterprise.slack.com/archives/C06J0U9EC8L) |
| **SDR AMER and EMEA (Manager - Jonathan Rivat)**              | [`#sdr_amer_emea_inbound`](https://example_company.enterprise.slack.com/archives/C077J5ANZ0T) |
| **BDR COMM AMER MM (Manager - Christie Park)**       | [`#bdr_amer_comm`](https://example_company.enterprise.slack.com/archives/C014PHFNE2U) |
| **BDR ENTG AMER WEST & LATAM (Manager - Charlotte Platt)** | [`#bdr_entg_amer_west_latam`](https://example_company.enterprise.slack.com/archives/C04R8DN5H8R) |
| **BDR ENTG AMER EAST (Manager - Brian Tabbert)**       | [`#bdr_entg_amer_east`](https://example_company.enterprise.slack.com/archives/C04QL1YSXGW) |
| **BDR PUBSEC (Manager - Josh Downey)**          | [`#bdr_amer_pubsec`](https://example_company.enterprise.slack.com/archives/C04R54N159P)|
| **All - EMEA (Manager - Elsje Smart)**                                      | [`#sdr_emea`](https://example_company.slack.com/messages/CCULKLB71) |
| **BDR COMM EMEA MM - (Manager - Fintan Harrington)**     | [`#bdr_comm_emea_mm`](https://example_company.slack.com/archives/C04NA4BQP54) |
| **BDR ENTG EMEA DACH - (Manager - Christopher Allenfort)** | [`#bdr_entg_emea_dach`](https://example_company.slack.com/archives/C04NP4VC449) |
| **BDR ENTG EMEA NEUR META - (Manager - Fintan Harrington)** | [`#bdr_entg_emea_neur_meta`](https://example_company.slack.com/archives/C04N) |
| **BDR ENTG EMEA SEUR - (Manager - Tati Fernandez)**   | [`#bdr_entg_emea_seur`](https://example_company.slack.com/archives/C04NE65S6AE) |
| **SDR APJ - (Manager - Robin Falkowski)**             | [`#apj_sales_dev`](https://example_company.slack.com/archives/C031T0L) |
| **BDR ENTG APJ - (Manager - Robin Falkowski)**          | [`#apj_sales_dev`](https://example_company.enterprise.slack.com/archives/C031EGFR5UK) |
| **BDR EGC META NL - (Manager - Carolina Marco Bellver)**          | [`#bdr_emea-egc-meta-nl`](https://example_company.enterprise.slack.com/archives/C04NA4BQP54) |

## Our Example Company Projects

| Name                                                                    | Description                                                                   |
|---------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| [Sales Development Issues](https://example_company.com/example_company-com/marketing/sales-development/-/issues) | The list of all issues we curently have on our project.           |
| [Sales Dev Ops Issue Board](https://example_company.com/example_company-com/marketing/sales-development/-/boards/5569691) | The main Kanban board we use to manage our operational projects, look here to see what we have in the pipeline. |
| [Sequence Creation Board](https://example_company.com/example_company-com/marketing/sales-development/-/boards/5540104) | The board we manage all new, and in-flight, sequences and messaging campaigns. |
| [FM Collaboration Board](https://example_company.com/example_company-com/marketing/sales-development/-/boards/5665082) | The board we use to communicate with the Field Marketing team to help support their events. |
| [PTO Requests Board](https://example_company.com/example_company-com/marketing/sales-development/-/boards/7220707) | The board we use to submit and manage Paid Time Off (PTO) requests.  |
| [Sales Systems Issues](https://example_company.com/example_company-com/sales-team/field-operations/systems/-/issues) | This is the Sales Systems issue list, we collaborate closely with them.     |
| [Marketing Operations Issues](https://example_company.com/example_company-com/marketing/marketing-operations/-/issues) | This is the Marketing Operation's team space, we also work closely with them too.  |
...
|-----------------------------------------------------------------------|--------------------------------------------------------|
| [1:1 Report - Tableau Self-Managed Instances Database](https://10az.online.tableau.com/#/site/example_company/views/FreetoPaidCockpitSSAOfficial/FreeSelf-ManagedInstances?%3Aiid=1) | 1:1 Dashboard that breaks down our database in terms of Self-Managed Free Instances.    |
| [1:1 Report - Tableau Inbound Lead Database](https://10az.online.tableau.com/#/site/example_company/views/InboundInterestFeedSSAOfficial/InboundInterestFeed-ProspectLevel?:iid=1) | 1:1 Dashboard that breaks down our database in terms of inbound and existing leads.    |
| [1:1 Dashboards - Accounts: EMEA COMM](https://example_company.my.salesforce.com/01Z8X000000u7O4) | 1:1 dashboard for accounts in the EMEA COMM segment.    |
| [1:1 Dashboards - Accounts: AMER COMM](https://example_company.my.salesforce.com/01ZPL000001I5n3) | 1:1 dashboard for accounts in the AMER COMM segment.    |
| [1:1 Dashboards - Accounts: ENTG AMER/LATAM](https://example_company.my.salesforce.com/01ZPL000001I6Ub) | 1:1 dashboard for accounts in the ENG AMER/LATAM segment. |
| [1:1 Dashboards - Accounts: COMM/ENTG APJ](https://example_company.my.salesforce.com/01ZPL000001I5qH)   | 1:1 dashboard for accounts in the Commercial and Enterprise APJ segment.     |
| [1:1 Dashboards - Accounts: ENTG EMEA](https://example_company.my.salesforce.com/01ZPL000001I77J)   | 1:1 dashboard for accounts in the ENTG EMEA segment.     |
| [1:1 Dashboards - Accounts: ENTG AMER](https://example_company.my.salesforce.com/01ZPL000001I6Ub)   | 1:1 dashboard for accounts in the ENTG EMEA segment.     |
| [1:1 Dashboards - Accounts: PUBSEC](https://example_company.my.salesforce.com/01ZPL000001Mcm1)     | 1:1 dashboard for accounts in the PUBSEC segment.       |

### Dashboards For Leaders

| Name/Link                                                            | Description                                            |
|-----------------------------------------------------------------------|--------------------------------------------------------|
| [Action Needed: SDR Global](https://example_company.my.salesforce.com/01ZPL000000ULrp) | Dashboard outlining items where immediate action is needed in the SDR team.   |
| [Action Needed: PubSec Global](https://example_company.my.salesforce.com/01ZPL000000UN7F) | Dashboard outlining items where immediate action is needed in the PubSec team. |
| [Action Needed: APJ BDR](https://example_company.my.salesforce.com/01ZPL000000bkbl) | Dashboard outlining items where immediate action is needed for APJ BDR.          |
| [Action Needed: EMEA BDR](https://example_company.my.salesforce.com/01Z4M000000soBO) | Dashboard outlining items where immediate action is needed for EMEA BDR.          |
| [Action Needed: AMER BDR](https://example_company.my.salesforce.com/01ZPL00000069v3) | Dashboard outlining items where immediate action is needed for AMER BDR.        |
| [Action Needed: SDR Global](https://example_company.my.salesforce.com/01ZPL000000ULrp) | Dashboard outlining items where immediate action is needed for SDR Global.        |
| [Pipeline Progression Dashboard](https://example_company.my.salesforce.com/01Z8X000000u6mP) | The dashboard we use to measure the progress, or lack of thereof, of opportunities sourced by our org. |
| [Global/Regional Sales Dev Results Dashboard](https://10az.online.tableau.com/#/site/example_company/views/DraftSalesDevAnalyticsHub/Overview?:iid=2) | A Tableau dashboard that breaks down attainment in regions or teams, and current/previous Quarters. |
| [Global SDR Ops Dashboard](https://example_company.my.salesforce.com/01ZPL000001KPuX) | This dashboard shows all of the important activities and opportunities related to the global SDR teams. |
...
| :------: | :---------: |
| [Example Company LevelUp Training channel](https://levelup.example_company.com/learn/) | Access to Example Company LevelUp Training channel for additional learning resources. |
...
| [Marketing Resource Links](https://docs.google.com/spreadsheets/d/1NK_0Lr0gA0kstkzHwtWx8m4n-UwOWWpK3Dbn4SjLu8I/edit?usp=sharing) | Example Company whitepapers, ebooks, webcasts, analyst reports, and more for Sales & Sales Development education. |
...
| [Example Company Buyer Personas](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/roles-personas/buyer-persona/) | Resource to help Example Company sellers better understand our buyers and audiences. |
| [Sales handbook page](/handbook/sales/) | Example Company Sales team handbook. |
...
| [Sales Training handbook page](/handbook/sales/training/) | Link to Example Company sales training resources. |
| [Command of the Message](/handbook/sales/command-of-the-message/) | "Command of the Message" training and the Example Company value framework. |
| [Most commonly used sales resources](https://example_company.highspot.com/spots/615dd7e3911d70c4887812a7) | Sales resources page. |
...
| [Example Company Values](/handbook/values/#:~:text=Example Company's%20six%20core%20values%20are,other%20by%20assuming%20good%20intent.) | The guiding principles we try to live up to each day. |
...
Lastly, Every so often you may be assigned a lead that has no value to Example Company and is not worth keeping within our database. Qualities that define these types of leads include:

| Step                                                    | Description                                                                                                                                                           |
|---------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Identify leads with no value to Example Company                  | Look for leads with characteristics such as incoherent or obviously forged information, or email addresses from temporary domains that self-terminate.            |
| Verify lead removal necessity                           | Ensure that the leads meet the criteria for removal and are unlikely to provide any value to Example Company.                                                                  |
...
Leads with certain criteria will be automatically labeled as **Do Not Call** and or **Do Not Email** shortly after loading into our database. It's understandable this can be frustrating for certain territories. Please keep in mind, the criteria behind this automation has been set in order to follow local law. Please see the [Internal Example Company handbook](https://internal.example_company.com/handbook/marketing/marketing-ops-and-analytics/marketing-operations/do-not-contact/?search=do+not+call) for more information on the triggers.
...
Please log an issue [here](https://example_company.com/example_company-com/marketing/sales-development/-/issues/new) by selecting the template `BDR_Sequence_Creation_Request.`
...
By dogfooding Example Company we have a structured and simplified cadence of quantifying sequence creation in terms of value and results without limiting agency.
...
- For [guiding prospects](https://example_company.com/example_company-com/marketing/sales-development/-/issues/817) to web-direct, we also have [a sequence that you should use](https://web.outreach.io/sequences/14652/overview) to ensure that you streamline their buyer's journey.
...
- [Intro Slide Deck](https://docs.google.com/presentation/d/1IpTVE4-Nkblfuiu6f1OUnFbi8IpjRPK7UDSx4eSfQCg/edit#slide=id.g5a343b482a_2_10) and [Training Video](https://example_company.edcast.com/journey/weeks/cards/7257647)
  - password should be in onboarding issue or ask your manager
- Example Company Edcast: [Advanced Outreach Training](https://example_company.edcast.com/journey/weeks)
...
1. [Log into Terminus](https://email2.terminusplatform.com/users/sign_in/) using your Example Company Google Account
...
- Identifying instances of Example Company usage by employees or as a past customer.
...
To submit a trial extension ticket for a prospect you will navigate [to this internal request form](https://support-super-form-example_company-com-support-support-op-651f22e90ce6d7.example_company.io/) and fill it out the form using the **"Example Company L&R internal request for global customers"** option and then select extend a example_company.com trial. Keep in mind it only works for SaaS and not self-managed.

You are also able to downgrade a Trial from Ultimate to Premium through the internal request form. You just have to choose "Change existing Example Company.com Trial plan"
...
1. [SAO Report for SDRs](https://example_company.my.salesforce.com/00O8X000008QeFh?sdtd=1)
1. [SAO Report BDRs](https://example_company.my.salesforce.com/00O8X000008QdwB)
...
You can find three examples of our cold call scripts in the description of the [BDR 101 Level Up Course](https://university.example_company.com/learn/course/bdr101-outbound-cold-calling/bdr101-outbound-calls/f50b8a1c-712b-44e7-a30f-2ddbbc835ccf?client=internal-team-members&page=5)
...
- If you as a {{title}} wanted to purchase Example Company, what process internally would you have to follow, and how can we help you navigate it?
...
[Video Walkthrough of how to make changes to the Example Company Handbook for the Sales Development org](https://www.youtube.com/watch?v=P7Nv7bzksiY&t=1032s)
...
We have an additional process where leads that [were automatically moved to disqualify lead status because of a wrong email]https://example_company.com/example_company-com/marketing/marketing-operations/-/issues/7718(), BUT have a phone number associated to them, will automatically be enrolled to a [sequence.](https://web.outreach.io/sequences/13842)
...
Organizing a shared demo makes it more simple for us to offer spontaneously a demonstration of Example Company, which should result in a easier handover of opps, and ease to create opps. As BDRs, we arranged the execution of this demo by creating a zoom webinar, and configuring the whole event so that the administrative side is automated.
...
| 1. Get a Zoom Webinars license                                              | You don't have a Webinar licence by default, so you need to open an access request issue on Example Company to ask for one.                                                                                                                                                                                            |
...
- Free to paid upgrades: Existing Core/CE users can be targeted to upgrade to a paid version of Example Company
...
| TEDD                      | Technology, Engineering, Development and Design - used to estimate the maximum potential users of Example Company at a company                                                       |
| Won Opportunity           | Contract signed to Purchase Example Company                                                                                                                                          |
...
- Example Company Edcast: [ZoomInfo Introduction Training](https://example_company.edcast.com/journey/week)
- Example Company Edcast: [ZoomInfo Advanced Training](https://example_company.edcast.com/journey/week-note)
...
- Example Company Handbook: [Zoominfo handbook page](/handbook/marketing/marketing-operations/zoominfo/)
...
- Example Company Edcast: [LinkedIn Navigator Training](https://example_company.edcast.com/journey/week-note)
- Example Company Video: [Peer Tips](https://drive.google.com/file/d/1xzz8cEiSFqZ7bOw-dpqoNlHjSDwrIFE4/view)
- Example Company Video: [LinkedIn Personalization](https://www.youtube.com/watch?v=7vEVB-WgDPA)
- Example Company Video: [Loading Accounts from Salesforce into LinkedIn](https://www.youtube.com/watch?v=_D8walmmOAU)

### 6Sense

6Sense is a targeting and personalization platform that we use to reach our different audiences based on intent data and our ideal customer profiles. While the content beblow is more specific to our Sales Development team, please visit the [Marketing Operation's handbook page here](https://internal.example_company.com/handbook/marketing/marketing-ops-and-analytics/marketing-operations/6sense/) for a full breakdown of 6Sense's functionality.
...
[Qualified](https://www.qualified.com/) is the Sales Dev Org's tool we use to chat with visitors on the Example Company website. Currently the SDR teams primarily respond to inbound chats and visitors using Qualified. The BDRs also have the ability to initiate chats with known leads from their actively working accounts.

### Gong

Refer to the [Gong](https://internal.example_company.com/handbook/sales/sales-tools/gong/) handbook page for full details on how Gong is leveraged at Example Company.
...
SDR and BDR team members are able to leverage the `Gong Meeting` option when creating meeting invites for prospects and customers. By using this option and adding an Account Executive with Gong recorder access to the meeting invite, Gong will leverage the AE's recorder access to record the meeting, assuming all meeting participants consent to record. More details about the Gong consent page can be found in the [Gong internal handbook page](https://internal.example_company.com/handbook/sales/sales-tools/gong/#global-privacy-compliance). Once the recording is processed, the Account Executive that was added to the invite will be listed in Gong as the host and owner of the call with the SDR or BDR as an attendee.

### Crayon Competitive Messaging Resources

[Crayon](https://app.crayon.co/intel/example_company/battlecards/) hosts competitive messaging resources that are maintained by Example Company's product marketing team.

This is where you can find messaging related to Example Company vs some of our competiors such as GitHub, Atlassian, and Azure DevOps
...
- Generation of pipeline from these efforts is tracked on our [Pipeline Progress Dashboard on SFDC](https://example_company.my.salesforce.com/01Z8X000000u6mP?)
...
Onboarding is essential for all Sales Development Managers at Example Company. As part of onboarding, a [Becoming a Example Company Manager](https://example_company.com/example_company-com/people-group/Training/blob/master/.example_company/issue_templates/becoming-a-example_company-manager.md) issue will be created for each manager when they join, or are promoted. This issue is intended to connect new managers with the crucial information they need, and ensure they have access to all the resources and training available.

#### Outbound BDR Process Manager Onboarding

The BDR process that we have defined here in Example Company is meant to provide a repeatable set of steps that an outbound BDR can follow to achieve results. It is very important for an onboarding manager to align themselves as quickly as possible to this process as it is a proven method that will help them manage their team in a efficient and data-driven way.
...
To help structure your usage of the above, you can follow the steps below during your first month at Example Company while [the document here will be your main go-to resource](https://docs.google.com/document/d/18k1_jDHVgNzy2SzcPZ7GAOdJ6zb9i37Z4-V1-dEFKiU/edit#)
...
| Resource | Purpose |
| :----: | :----: |
|  [Leadership Handbook](/handbook/leadership/) | Tools and resources to assist people managers in effectively leading and developing team members at Example Company |
...
|  [Transitioning to a Manager Role at Example Company](/handbook/people-group/learning-and-development/manager-development/) | New manager resources and what to expect |
...
|  [Territory Change Request Issue Board](https://example_company.com/example_company-com/marketing/sales-development/-/boards/5569691) | Use the territory Change Request Issue Board and the BDR_Territory_Change Sales Development Issue Template in order to request a territory change for your rep.  |
|  [Sales Dev Internal Onboarding and Transition issue template](https://example_company.com/example_company-com/marketing/sales-development/-/blob/main/.example_company/issue_templates/Internal_Onboarding_and_Transition_Template.md) | This issue template is to be used when a new teamember is joining the Sales Development Org for the first time or they are transitioning from SDR to BDR or vice versa. |
|  [BDR Territory Change Request issue template](https://example_company.com/example_company-com/marketing/sales-development/-/issues/new) | Use the BDR Territory Change issue template when you would like to request territory changes for your BDRs. |
|  [Sales Dev Exit Handover Template](https://example_company.com/example_company-com/marketing/sales-development/-/blob/main/.example_company/issue_templates/BDR_Territory_Change.md) | This template is meant to be used for team members that are departing from a team to hand off their pending tasks to their peers. |
...
|                                                          [Add a new page to the handbook](https://www.youtube.com/watch?v=9NcJG9Bv6sQ)                                                           | This Example Company Unfiltered video will walk you through how to create a new handbook page |
|                                            [Create a new job family](/handbook/hiring/job-families/#job-family-creation-using-web-version-of-example_company)                                             | For each job at Example Company, the job family is the single source of truth for the expectations of that role. If you need information about when to create a new job family vs when to use an existing one watch [this video](https://www.youtube.com/watch?v=5EcFz1qNj2E&feature=emb_title) |
...
| [Sales Development Onboarding Job Specific Task Section](https://example_company.com/example_company-com/people-group/employment-templates/-/blob/main/.example_company/issue_templates/onboarding_tasks/department_sales_development.md) | This task section will automatically be added to the general onboarding issue for new SDRs based on their role when hired. |

### Tracking & Monitoring Resources

| Resource | Purpose |
| :----: | :-----: |
|  [SDR Issue Board](https://example_company.com/example_company-com/marketing/sales-development/-/boards/5569691)  | Used to track Example Company issues involving the SDR team. This is a global issue board. |
|  [SDR Event Tracker Issue Board](https://example_company.com/groups/example_company-com/-/boards/1718115) | Used to follow upcoming events globally |
|  [SDR Sisense Dashboard](https://10az.online.tableau.com/#/site/example_company/views/DraftSalesDevAnalyticsHub/Overview?:iid=1) | SalesDev Analytics Hub Dashboard  |
...
| Teams | Boards |
| :----: | :-----: |
|  **AMER BDR TEAMS**  | [AMER BDR Action Needed](https://example_company.my.salesforce.com/01ZPL00000069v3) -  [AMER BDR Manager Attention Needed](https://example_company.my.salesforce.com/01ZPL00000069VF) |
|  **EMEA BDR TEAMS**  | [EMEA BDR Action Needed](https://example_company.my.salesforce.com/01Z4M000000soBO) -  [EMEA BDR Manager Attention Needed](https://example_company.my.salesforce.com/01ZPL0000006ABB) |
|  **APAC BDR TEAMS**  | [APAC BDR Action Needed](https://example_company.my.salesforce.com/01ZPL000000bkbl) -  [APAC BDR Manager Attention Needed](https://example_company.my.salesforce.com/01ZPL000000cUJd) |
|  **Global SDR Inbound Teams**  | [SDR Global Action Needed](https://example_company.my.salesforce.com/01Z4M000000soBT) - [SDR Global Manager Attention Needed](https://example_company.my.salesforce.com/01ZPL000000pryL)  |
...
On folder #5 in the [6Sense segments list](https://example_company.abm.6sense.com/segments/manage), you'll find the templates for the main three categories of accounts that we have. These templates are meant to be cloned and edited for your teams as per the guidelines below and will assist with coaching on 1:1s and team calls, as well as driving more predictable pipeline building.

**[Currently Actively Working Accounts Template](https://example_company.abm.6sense.com/segments/segment/495284/accounts/?mode=edit&segment_type=6sense_network)**
...
**[CE/SFDC Accounts not in Actively Working Status](https://example_company.abm.6sense.com/segments/segment/495296/accounts/?mode=edit&segment_type=6sense_network)**
...
**[Greenfield Accounts not in Actively Workin](https://example_company.abm.6sense.com/segments/segment/495295/accounts/?mode=edit&segment_type=6sense_network)**
...
**[Sales Dev by Salesforce Profile and Role -](https://example_company.my.salesforce.com/00O8X000008gonx)**
...
**[Sales Dev Territories by Team role/member associated with each territory -](https://example_company.my.salesforce.com/00O8X000008gpBL)**
...
- Use [this report](https://example_company.my.salesforce.com/00O8X000008gmAA) to figure out the territory name for the account you are working. Use command F to find the zip/state/country and figure out correct territory name.
- Then use [this report](https://example_company.my.salesforce.com/00O8X000008glPn) by plugging in the territory name to figure out who the correct AE is
...
Example Company People Connect Team members will [create the onboarding issue](https://internal.example_company.com/handbook/people-group/people-operations/people-connect/onboarding_process/#timing) and start completing the onboarding tasks, no later than one week before the new team member joins. People Connect Team members require a minimum of 4 business days (with the new hire timezone as the basis) before the new hire's start date to complete all onboarding tasks. This issue will be automatically assigned to you. As a manager, you will [also have tasks](/handbook/people-group/general-onboarding/#managers-of-new-team-members) that need to be completed prior to the new team member's start date.

The general onboarding issue will also automatically add a ['Sales Development' section](https://example_company.com/example_company-com/people-group/employment-templates/-/blob/main/.example_company/issue_templates/onboarding_tasks/department_sales_development.md) under 'Job Specific Tasks' based on the role of the new SDR. Both you and your new hire will have tasks to complete in this section.

With the creation of this issue, an [access request (AR) will also be automatically created](https://example_company.com/example_company-com/team-member-epics/access-requests/-/tree/master/.example_company/issue_templates/role_baseline_access_request_tasks/department_sales_development) for a new team member on their second day at Example Company. This AR lists the role based entitlements (pre-defined groups and system-level access that are granted automatically to team members depending on their role) your new hire will need.
     *See what is being auto provisioned on this AR [here](https://example_company.com/example_company-com/team-member-epics/access-requests/-/tree/master/.example_company/issue_templates/role_baseline_access_request_tasks/department_demand_generation).

#### New Hire's First Day

On your new hire's first day, the assigned People Connect Team member will [schedule a welcome email](https://internal.example_company.com/handbook/people-group/people-operations/people-connect/onboarding_process/#day-1-onboarding-tasks) to arrive at 7:30am (local time of the new team member) on their start date detailing how your new hire can access Example Company and begin their onboarding process.
...
- Schedule a welcome call at the start of your new hire's first day to discuss:
  ...
  - What you can expect in regards to [onboarding at Example Company as an SDR](/handbook/marketing/sales-development/sdr-playbook-onboarding/)
...
A career mobility issue should be opened 2 weeks before the transition date by the people connect team. If the aligned manager does not see that issue created 2 days before the scheduled transition date, the manager should reach out to the People Connect Team via the [#people-connect Slack Channel](https://example_company.slack.com/archives/C02360SQQFR).
...
The full process for offboarding at Example Company differs based on whether it is voluntary or involuntary. These processes can be found on the [offboarding handbook page](/handbook/people-group/offboarding/#offboarding).
...
- When a teamember is either leaving Example Company, leaving the Sales Dev Org, or transferring to another BDR team the departing team's manager must created a [Sales Dev Handover Issue](https://example_company.com/example_company-com/marketing/sales-development/-/blob/main/.example_company/issue_templates/Exit_handover_template.md?ref_type=heads)

### Sequence Creation

- We follow the process outlined [here](/handbook/marketing/sales-development/how-tos/#new-outreach-sequenceworkflow-creation) for creating new content, when it comes to reviewing this content, the Sales Dev Ops team will follow a quarterly cadence of reviewing the sequences/campaigns that are on the In-flight column on the board [here](https://example_company.com/example_company-com/marketing/sales-development/-/boards/5540104). We use the criteria below:
...
1. The People Team initiates a general Example Company onboarding issue for every new Example Company team member. On your first day, you will receive a welcome email with a link to your specific onboarding issue and steps to get started. You will also meet with your manager to discuss:
...
1. Within 3 days of starting at Example Company, you will receive an email giving you access to [Command of the Message (CoM)](/handbook/sales/command-of-the-message/) e-learning materials. CoM is our value-driven conversation framework that will be covered during SQS.
...
- Complete Example Company general onboarding issue
...
For BDRs and SDRs joining Example Company on the 15th or after of the month
...
6. Does the account have activity placed by the BDR in the last 30 days?
    ...
    **No:** Check to see if there are leads related to the account that have activity using [this report](https://example_company.my.salesforce.com/00O8X000008RfvU)
...
**A:** SDRs get credit for opportunities where the SDR had meaningful two way communication with a prospect 60 days before they bought Example Company through our website. The best way to search for a web direct opportunity is to use [this report](https://example_company.my.salesforce.com/00O4M000004dkX4). First, set the date range to the time you think the prospect would have bought. Next, find the opportunity that is tied to your prospect's account. Then follow the process to request SAO credit.
**Note: Sometimes someone else from your prospect's company actually made the Example Company purchase, leading to the opportunity being related to them instead.**
...
3. Explain how you influenced their decision to purchase Example Company (helped with evaluation, uncovered a need, provided value, etc)
...
**A:** Immediately reach out to the Privacy Team via #privacy-team-help and forward any email from the contact to dpo@example_company.com.
...
| ---------- | -------- | ------- | --------- | -------------- |
| Example Company ultimate/premium, Duo | SDR | FO + New Connected | SMB/Comm | 1 (Duo Pro is excluded) |
| Example Company ultimate/premium, Duo | SDR | FO + New Connected + Growth (new groups) | Enterprise | 2 (Example Company + Duo Pro) |
| Example Company ultimate/premium, Duo | BDR | FO | Comm/Ent | 2 |
| Example Company ultimate/premium, Duo | BDR | New Connected + Growth | Comm/Ent | 2 |
| Additional seats in current customer department | BDR | Growth | Comm/Ent | 1 |
| Tier upgrade | BDR | Growth | Comm/Ent | 1 |
| Example Company ultimate/premium, agile planning | everyone | All motions | All segments | 1 (agile planning is excluded) |
...
|                                        | - Demonstration of Example Company's Values                                                                                                                                                  |
...
|                                        | - Hitting quota cumulatively over the last 2 fully-ramped quarters (neither quarter below 80% attainment)                                                                          |
|                                        | - Endorsement from BDR management                                                                                                                                                   |
|                                        | - Demonstration of Example Company Values                                                                                                                                                    |
...
In accordance with the [Time Off Policy](/handbook/people-group/paid-time-off/#a-example_company-team-members-guide-to-time-off), you need give your manager a heads up early of your intended time off so that they can help arrange cover for your tasks, if necessary.

We want to help our team members being able to fully unplug from work during their PTO, while not having to worry about their workload or target attainment. Based on this, we have created this PTO Territory Planning Issue that you can use to strategize your work and be aligned to the Example Company value of being a [Manager of One.](/handbook/leadership/#managers-of-one)

To log a PTO Territory Planning request, please go to the Issue list on the SDR Example Company project [here](https://example_company.com/example_company-com/marketing/sdr/-/issues/new#) and choose `PTO_Coverage_Template` from the Description drop-down list. All of these requests are then managed through the board here. and all next steps and guidelines are on the issue description.
