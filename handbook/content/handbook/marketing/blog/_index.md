---
title: "Blog Handbook"
description: "Everything you need to know about suggesting and publishing a post on the Example Company Blog."
---

Welcome to the Example Company Blog handbook! The [Example Company Blog](https://about.example_company.com/blog/) is managed by the Content Marketing team. The managing editor of the blog is Sandra Gittlen (@sgittlen).

## What is a blog post?

At Example Company, blog posts largely focus on sharing helpful information with the audience ([DevSecOps professionals](/handbook/product/personas/)). When you suggest or write a blog post, always consider what it offers the reader. If the post is more internal-focused or a personal essay of sorts, it is likely not a fit for the blog (but could go on your personal LinkedIn page).
...
## Who can publish content to the Example Company Blog?

[Everyone can contribute at Example Company](/handbook/company/mission/#mission). For the blog, this means we welcome your blog suggestions, ideas, and drafts. However, the [main blog](https://about.example_company.com/blog/) is one of the many official voices of Example Company – meaning content that is published there must be carefully vetted to ensure we are accurately representing Example Company – both the company and the product. The Blog Managing Editor and the Director of Global Content Marketing are the [directly responsible individuals (DRIs) for the official Example Company blog](/handbook/people-group/directly-responsible-individuals/) and are tasked with this responsibility.

If you have questions about the Example Company Blog, please reach out to [sgittlen@example_company.com](mailto:sgittlen@example_company.com).

## How to suggest a blog idea - NEW PROCESS {#how-to-suggest-a-blog-post}

Please create an issue using the [blog submission template](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/blog/-/issues/new?issuable_template=blog-post-submission).
...
**Note: You can also notify the Blog team of a typo or request a change via the [blog submission template](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/blog/-/issues/new?issuable_template=blog-post-submission).

### External contributions

**Note:** Example Company does not accept unsolicited blog submissions. If you are a Example Company partner and would like to pitch a blog post idea for consideration, please [email sgittlen@example_company.com](mailto:sgittlen@example_company.com). If you are a Example Company community member and would like to pitch a blog post idea for consideration, please [email contributors@example_company.com](mailto:contributors@example_company.com). Please DO NOT SEND drafts of your blogs with your pitch.

Pitch ideas must be relevant to the Example Company Blog and our readers and include the following information:
...
- [ ] best practices for how to use the Example Company platform
- [ ] the open source community and Example Company
- [ ] partner/alliance integration
- [ ] other - please explain

**All blog pitch ideas and submissions will be vetted and reviewed by Example Company team members.**

Blog editors, please add the following two sentences at the beginning of contributed articles:

***Editor's note: From time to time, we invite members of the community to contribute to the Example Company Blog. Thanks to [entity name] for co-creating with us.***

External contributions are subject to the [External Blog Submissions Terms](https://about.example_company.com/externalblogsubmissionsterms/). Please read this document and agree to terms before submitting material to Example Company.
...
Example Company has a bias for action, and the Blog team is no different. However, the Example Company Blog is a public-facing asset and represents the company. If the Blog team has concerns or questions about the information contained in the blog post, the Blog team has the authority to hold a blog post until Legal, Corporate Commmunications, Partner Marketing, the CMO, etc., can review the blog post to mitigate any potential risk for the company.
...
If you are internal to Example Company and want to suggest a change to a published Example Company blog, please post the change you need in detail with the URl in the `#content` Slack channel and tag @sgittlen or ping @sgittlen directly in Slack.

If you are external to Example Company, please email Sandra Gittlen at  `sgittlen@example_company.com` with the details of your suggested change.
...
- Add newsletter content requests to [this issue](https://example_company.com/example_company-com/marketing/brand-product-marketing/content-strategy-and-ops/content-ops/-/issues/902)

## Other related pages

- [Editorial style guide](/handbook/marketing/brand-and-product-marketing/content/editorial-team/)
- [Brand guidelines](https://design.example_company.com/)
...
- Example Company is a global team with a global community, so you want to write for a global audience. This means limiting your use of regional metaphors and not writing in a manner that is United States-centric.
...
- If you still have questions, don't hesitate to tag the editorial team lead @sgittlen, leads of the appropriate [team member resource group (TMRG)](/handbook/company/culture/inclusion/erg-guide/) in your blog issue, or email diversityinclusionandbelonging@example_company.com with your questions.
...
- `customer stories` - posts about how our customers are using Example Company DevSecOps platform
...
These are included to help readers find similar posts if they are interested in a particular subject. Tags appear at the top of each blog post, and clicking on a tag takes you to [/blog/tags](https://about.example_company.com/blog/tags.html) where you can view all tagged posts and browse by tag.
...
Details about how to embed mermaid charts into your blog can be found in [this MR](https://example_company.com/example_company-com/marketing/digital-experience/example_company-blog/-/merge_requests/211#usage-notes). Please read as there are nuances that might prevent your chart from rendering properly.
...
- `Example Company handle` field

    It corresponds to Author's Example Company username in lowercase format. This field has to be unique.
...
5. Once published, always verify that it's working as expected on about.example_company.com/blog/.
