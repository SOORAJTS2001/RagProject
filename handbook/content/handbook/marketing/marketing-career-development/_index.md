...
In the annual employee engagement and satisfaction survey, Marketing's lowest score was for career development within Example Company. Due to the team structure, hiring is made for specific roles and the team is kept as lean and efficient as possible. This makes mobility more difficult.
...
Todd provides an overview of the purpose and goals of the Marketing Career Development Program as well as insights into the marketing organization and what each team does, in this welcome [video](https://example_company.edcast.com/insights/welcome-video).

## Competencies

### Analytics

Know how to read and interpret the marketing analytics Example Company's marketing team uses to inform business decisions and strategy
...
- [DataStudio training on Example Company about.com](https://www.youtube.com/watch?v=7IFDCl_6SsM) - Empirical Path and Shane Rice sharing how to use DataStudio
...
- [Learning Example Company](https://www.linkedin.com/learning/learning-example_company-2/version-control-and-more?u=2255073) - This training teaches markdown basics and even directs folks to Example Company flavored markdown. These simple tips can transform your epics and issues. It covers headings, bulleted lists, numbered lists, bold and italic text, and how to insert links and images.

### Revenue basics

- [Annual recurring revenue](/handbook/sales/sales-term-glossary/arr-in-practice/) (HB)
- [Customer lifecycle at Example Company](/handbook/sales/field-operations/gtm-resources/#customer-lifecycle) (HB)
...
- [Understand Example Company GTM Plans, Motions and Use Cases](/handbook/marketing/plan-fy23/)
- [What is Demand Generation at Example Company](/handbook/marketing/demand-generation/)
- [Email marketing from Tanuki Tech](https://example_company.com/example_company-com/marketing/sdr/-/issues/628)
- [Demand Generation metrics](https://app.periscopedata.com/app/example_company/793304/Demand-Gen-Dashboard) [and how to understand the data](/handbook/marketing/demand-generation/#dashboard-metrics)
...
- [Accrual vs. cash based accounting](https://www.linkedin.com/learning/quickbooks-pro-2008-essential-training/differentiating-accrual-from-cash-based-accounting?u=2255073) - Example Company runs an accrual based accounting method.
