...
An ISCP provides established procedures for the assessment and recovery of a system following a system disruption. The ISCP provides key information needed for system recovery, including roles and responsibilities, inventory information, assessment procedures, detailed recovery procedures, and testing of a system. An ISCP will be created for Example Company.com and [Tier 1 systems]({{< ref "critical-systems" >}}), working in conjunction with the [Business Continuity Plan (BCP)](/handbook/business-technology/example_company-business-continuity-plan/) and [Disaster Recovery Plan (DRP)](https://example_company.com/example_company-com/gl-infra/readiness/-/blob/master/library/disaster-recovery/index.md).
...
- [BCP]( https://handbook.example_company.com/handbook/business-technology/example_company-business-continuity-plan/)
