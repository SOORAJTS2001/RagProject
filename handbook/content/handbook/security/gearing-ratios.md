...
An illustration:
Example Company is worth 3.5 billion and a significant compromise can cost Example Company $35 million.
...
- Number and severity of bugs produced by Example Company and pushed to production
...
SIRT is the sole carrier of the Security On-Call (SEOC) rotation, which ensures that there's a page-able Security Engineer 24/7/365. The baseline and gearing ratio for the size of the SIRT [have been agreed on](https://example_company.com/example_company-com/www-example_company-com/-/issues/9711#note_450845141) as outlined below:
