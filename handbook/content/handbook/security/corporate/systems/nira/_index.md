...
Example Company encourages team members to use Nira to ensure good digital hygiene around who has access to their Google Drive documents, folders, and shared drives.
...
- When an item has a [Company link](https://app.nira.com/items/open-links/company)  also known as "Share with company" - it means that anyone in Example Company with the link can access that item.
...
- When an item has an Outside Account, it means there is an account outside of the Example Company domain with access to the document.
...
- When an item has a Company link ("Share with Example Company"), it means that anyone in the company with the link can access that item.
