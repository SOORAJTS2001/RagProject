...
Four Mondays before the start of the fiscal quarter, in the days after the CEO shares OKRs with all of Example Company in the #okr channel, the CISO proposes OKRs for the Security Division in the OKR draft review meeting agenda for a maximum of 5 objectives. Security leaders are to propose draft OKRs to the CISO prior to the meeting for inclusion.
From FY24 Q1 forward all Security OKRs are documented in the [Example Company OKR project](https://example_company.com/example_company-com/example_company-OKRs). For easy filtering, all Security Objective and KR issues have the [division::Security](https://example_company.com/example_company-com/example_company-OKRs/-/issues/?label_name%5B%5D=division%3A%3ASecurity) label applied.
...
- **Four Mondays prior**: In the days after the CEO shares OKRs with all of Example Company in the #okr channel, the CISO proposes OKRs for the Security Division in the OKR draft review meeting agenda for a maximum of 5 objectives.
...
- **Two Mondays prior**: OKRs are finalized and shared in the [Example Company OKR project](https://example_company.com/example_company-com/example_company-OKRs).
...
The Priority [scoped](https://docs.example_company.com/ee/user/project/labels.html#scoped-labels) label ranges from 0 to 2 and is applied to OKRs.

- `sec-okr::p0`: Should only be reserved for [Critical Projects](https://internal.example_company.com/handbook/security/critical_projects)
...
#### New Security KR - Example Company Template

:scissors: Copy and paste the below into the Example Company Issue Description
...
:scissors: Copy and paste the below into the Example Company.com KR Issue(s) at the end of the week
