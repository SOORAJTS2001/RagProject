...
BLACK_CI_TF_AWS["Terraform AWS GitOps<br />gitops.example_company.black/tf/aws/{org}"]:::yellow
BLACK_CI_TF_GCP["Terraform GCP GitOps<br/>gitops.example_company.black/tf/gcp/{org}"]:::yellow
BLACK_CI_TF_OKTA["Terraform Okta GitOps<br/>gitops.example_company.black/tf/okta"]:::yellow
...
BLACK_GCP_COM_ORG["GCP Organization<br/>example_company.com"]:::sky
BLACK_GCP_COM_ORG_INFRA_FOLDER["Infrastructure Folder<br/>(Example Company SaaS Production)<br />Managed by Infrastructure Department<br />ops.example_company.net/example_company-com/gl-infra/config-mgmt"]:::orange
...
subgraph Okta
BLACK_OKTA_COM_ORG["Okta Organization<br/>example_company.com"]:::sky
