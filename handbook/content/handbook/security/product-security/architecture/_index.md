...
trusted security advisors of Example Company Engineering. Security Architecture is a natural extension of the
greater [Architecture](/handbook/engineering/architecture/) initiative at Example Company. It is the
...
- Reference our [Example Company Cryptography Standard]({{< ref "cryptographic-standard" >}})
...
- <https://handbook.example_company.com/handbook/security/access-management-policy.html#principle-of-least-privilege>
...
- Example Company team members don't have access to billing data, nor anything else [classified red data]({{< ref "data-classification-standard" >}})
...
- [Zero Trust](/handbook/security/product-security/architecture/zero-trust) at Example Company
...
- Introducing a new server in Example Company means updating Omnibus builds, Helm charts, our reference
...
- Enable [GuardDuty](https://aws.amazon.com/guardduty/) in AWS or [Cloud Audit Logs](https://cloud.google.com/logging/docs/audit?hl=en) in GCP to record activity and detect malicious
  intent.
- Leverage [Panther](/handbook/business-technology/tech-stack/#panther) (for example_company.com only) to collect, normalize, and analyze logs.
...
- Run [Dependency Scanning](https://docs.example_company.com/ee/user/application_security/dependency_scanning/)
...
- [RCE when removing metadata with ExifTool](https://example_company.com/example_company-org/example_company/-/issues/327121)
...
[issue](https://example_company.com/example_company-com/gl-security/security-department-meta/-/issues/1315)).

## Communication channels

- **Slack**: #security-architecture
- **Example Company namespace**: <https://example_company.com/example_company-com/gl-security/security-architecture>
