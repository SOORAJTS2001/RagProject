...
For HackerOne reports, you can also import the report into a Example Company issue and then mention `@example_company-com/gl-security/security-operations/sirt` on it. Keep in mind this may not be appropriate, since it will ping all team members of SIRT.
