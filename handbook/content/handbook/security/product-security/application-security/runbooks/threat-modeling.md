...
description: "This threat modeling process is tailored to Example Company features."
---
...
[`threat-models`](https://example_company.com/example_company-com/gl-security/product-security/appsec/threat-models/-/issues/new?issuable_template=Threat%20Model)(internal link) project.
...
for various threat modeling cases throughout Example Company.
...
For the typical AppSec review of a new Example Company feature a few things should be
...
`agentk` and the `Example Company` components. The flow of data is also depicted
...
More specific instructions and steps are listed in the [review template](https://example_company.com/example_company-com/gl-security/product-security/appsec/appsec-reviews/-/tree/master/.example_company/issue_templates/AppSec%20Review.md).
