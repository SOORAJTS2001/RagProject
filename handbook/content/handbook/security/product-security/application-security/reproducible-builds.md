...
description: "Learn how Example Company is implementing Reproducible Builds for our build processes"
---
...
- Expected Inputs: describes everything included in the build. This field allows the verifier to correlate the source to the artifact
  - Sources: within the expected inputs field. This might look like "`git commit 291e...494d`" from `https://example_company.com/example_company-org/example_company`" or even "`example_company-ee-17.0.1`" with SHA256 hash "`75a4...9982`"
...
- Commands: each command used to intiate the build needs to be outlined in such a way as to allow for autmated analysis
  - Example: `{"example_company-omnibus": {"command": "build", "target": "//main:hello_world"}}"`
