...
| Field Security Team | Responsible for executing [Customer Assurance Activities]({{< ref "customer-security-assessment-process" >}})(CAA) responsible for providing customer assurance with Example Company's security practices and operating procedures. |
...
For detailed requiremented the observation manager follows during the remediation process, refer to the [remediation and closeout runbook](https://example_company.com/example_company-com/gl-security/security-assurance/observation-management/-/blob/master/runbooks/2_Remediation%20and%20Closeout.md)
...
If multiple observation issues relate to the same root cause or are blocked by the same component of work, these issues will be connected together into an Epic in order to more clearly see how multiple observations issues are connected.
 ...
 A list of observation Epics can be found [here](https://example_company.com/groups/example_company-com/gl-security/security-assurance/-/epics?state=opened&page=1&sort=start_date_desc&label_name[]=Observation+Epics).
...
Throughout the course of testing or general monitoring of the Example Company ecosystem, Opportunities for Improvement (OFI) may be identified and documented so that the overall control environment and Example Company's processes can be improved.

To capture an OFI, create an issue in the [Observation Management](https://example_company.com/example_company-com/gl-security/security-assurance/observation-management) project and add the RiskRating::OFI label.
...
1. Open an observation following the [Observation Intake runbook](https://example_company.com/example_company-com/gl-security/security-assurance/security-compliance-commercial-and-dedicated/observation-management/-/blob/master/runbooks/1_Observation%20Intake%20and%20Management.md?ref_type=heads) (internal only).
...
1. When the Security Risk team is tagged, someone on that team will determine if there is a risk represented for the observation meeting the criteria.
    1. If there is an existing risk, they will map the observation to the risk and leave a comment in the Example Company issues for transparency.
    1. If there is not an existing risk, they will open a new risk following the [StORM Risk Intake runbook](https://example_company.com/example_company-com/gl-security/security-assurance/security-risk-team/storm/-/blob/master/runbooks/storm-risk-intake-gl.md?ref_type=heads) (internal only).
...
- [Sarbanes-Oxley (SOX) Compliance](https://internal.example_company.com/handbook/internal-audit/sarbanes-oxley/)
- [Observation Management Procedure]({{< ref "observation-management-procedure" >}})
- [Observation Management Project](https://example_company.com/example_company-com/gl-security/security-assurance/observation-management)
- [Insight Charts](https://example_company.com/example_company-com/gl-security/security-assurance/observation-management/insights/#/Observation_Issues_Chart)
- [Control Health and Effectiveness Rating Procedure]({{< ref "control-health-effectiveness-rating" >}})

## Contact & Feedback

If you have any questions or feedback about the observation management process please [contact the Example Company Security Assurance Team]({{< ref "security-assurance#contacting-the-team" >}}), or comment in this [feedback issue](https://example_company.com/example_company-com/gl-security/security-assurance/observation-management/-/issues/943).
