...
System-level risk scores are intended to be a quantitative representation of the amount of security risk a given system holds. This quantitative approach to risk scoring is meant to inform Example Company management about where risk exists and help with prioritization and resourcing.

## Scope

The procedures outlined in the sections below are used specifically by the Security Assurance Team once an observation's [risk rating is determined]({{< ref "observation-management-procedure" >}}). This procedure is limited to systems in scope of Example Company's security continuous control monitoring program.
...
**The target system risk score for Example Company systems is 3.00.** System with a risk score higher than this have a greater amount of security risk.
...
If you have any questions or feedback about the system risk scoring methodology please [contact the Example Company Security Assurance Team]({{< ref "security-assurance#contacting-the-team" >}})
