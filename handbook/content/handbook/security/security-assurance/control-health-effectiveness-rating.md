...
description: "Control Health and Effectiveness Ratings (CHER) determine a Example Company Security Control's overall control health and effectiveness."
---

## Purpose

Control Health and Effectiveness Ratings (CHER) determine a [Example Company Security Control's]({{< ref "sec-controls" >}}) overall control health and effectiveness.
...
If you have any questions or feedback about the observation management process please [contact the Example Company Security Assurance Team]({{< ref "security-assurance#contacting-the-team" >}})
