...
summary: "The purpose of the Critical System Tiering Methodology is to support Example Company in identifying and understanding the specific systems utilized across the organization that are considered critical to serving Example Company's Customers."
controlled_document: true
---

## Purpose

The purpose of the Critical System Tiering Methodology is to support Example Company in categorizing systems based on their impact on Example Company's SaaS subscriptions (delivery of Example Company.com or Example Company Dedicated). By classifying systems into specific tiers, Example Company may appropriately prioritize risk mitigation activities and tailor internal controls.

## Scope

The Critical System Tiering methodology is applicable to all systems utilized across Example Company which are tracked within the [Tech Stack](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/tech_stack.yml).
...
Defining what a critical system means at Example Company can be complex given the nature of our environment and the number of integrations that exist across the many systems that are used to carry out business activities. Example Company's [Business Impact Analysis (BIA)]({{< ref "business-impact-analysis" >}}) procedure enables the designation of a Critical System Tier for a new system by the Security Risk Team. The BIA questions used to designate Critical System Tier are:
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-zqun">Disruption or breach has an immediate and significant impact on the availability/security of Example Company SaaS subscriptions and Customer data (See <a href="{{< ref "data-classification-standard#data-classification-definitions" >}}">Data Classification Standard</a> for definitions).</td>
    <td class="tg-zqun">Example Company.com, Google Cloud Platform, Devo</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-zqun">Disruption affects productivity/well-being of individual Example Company Team Members.</td>
...
{{% /note %}}
{{% note %}}
<span style="color:#DB3B21;"><b>*\*\*</b></span> By default, any system in-scope for [SOX](https://internal.example_company.com/handbook/internal-audit/sarbanes-oxley/) will be a **Tier 2 Business Critical** system, at minimum.
{{% /note %}}
{{% /panel %}}
...
Critical System Tiers help prioritize risk mitigation activities for systems critical to serving Example Company's Customers. Example Company's core service offerings are  SaaS.  Thus, the systems that have an immediate and significant impact on the availability/security of Example Company SaaS subscriptions and Customer data in the event of a disruption are priority.  These are *Tier 1 Mission Critical* systems.
{{% /panel %}}

### Why does Example Company need this methodology?

Tiering systems utilized across Example Company enables team members to make decisions on prioritizing work related to a specific system(s). For example, if multiple risks have been identified across many systems and require remediation, team members can leverage the designated Critical System Tiers to make decisions on how to prioritize remediation efforts. This methodology also provides Example Company with a mechanism to easily identify systems which are most critical across the organization so that teams can proactively protect and secure those systems.

### Maintaining Critical System Tiers

Critical System Tiers for existing systems are validated periodically. A system's designated tier can be found in the [tech_stack.yml file](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/tech_stack.yml) which is the Single Source of Truth for all systems used at Example Company.
