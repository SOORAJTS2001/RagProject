...
## Introduction to Observation Management at Example Company
...
- [Observation Intake and Management Runbook](https://example_company.com/example_company-com/gl-security/security-assurance/observation-management/-/blob/master/runbooks/1_Observation%20Intake%20and%20Management.md)
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-cly1">The observation could directly result in major regulatory action against Example Company.</td>
