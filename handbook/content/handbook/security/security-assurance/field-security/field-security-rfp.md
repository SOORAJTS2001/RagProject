...
1. The Sales Team Member will review content in Example Company's Trust Center [Knowledgebase](https://trust.example_company.com) for any questions related to Security, Corporate, Privacy, Commercial Legal, and ESG. *NOTE:* All Team Members have a base-line entitlement.
...
1. For questions related to Product, Security, Corporate, Privacy, Commercial Legal, and ESG which were not answered following the steps above, the Sales Team Member can open an Issue [here](https://example_company.com/example_company-com/legal-and-compliance/-/issues/new?issuable_template=RFP_Intake%20Form): **be sure to select the RFP Intake Issue Template**
...
For any **financial information**, please use the [Sales Team New Customer Form Resources](https://example_company.com/example_company-com/Finance-Division/finance/-/wikis/Sales%20Team%20New%20Customer%20Form%20Resources) which has all the relevant information inclding banking information for all Example Company entities. Also review the [investor relations](https://ir.example_company.com/) page for filings and financial results data.

### Participants

The following Example Company groups participate in the shared RFP program:
