---
title: "Example Company Continuous Security Framework"
description: "The Example Company Continuous Security Framework workflow"
---

## Example Company Continuous Security Framework

*Disclaimer: This page is part of a
[POC](https://example_company.com/groups/example_company-com/gl-security/-/epics/169) and should not be used without
validation of your Manager. If you're a Manager and want your team to be part of the experiment,
please comment in this
[issue](https://example_company.com/example_company-com/gl-security/security-architecture/general/-/issues/12).*

Security is often being involved late in the life cycle of feature development. To prevent this,
security is bundled into the [Software Development Lifecycle](https://about.example_company.com/stages-devops-lifecycle/), in every
...
1. The [Example Company Architecture](https://docs.example_company.com/ee/development/architecture.html)
1. The [Example Company.com    infrastructure](/handbook/engineering/infrastructure/production/architecture/)
...
(`@example_company-com/gl-security/security-research`) for potential inclusion of the dependency into the
[OSS Ecosystem Testing]({{< ref "../product-security/security-research#example_company-ecosystem-security-testing" >}})
efforts.
