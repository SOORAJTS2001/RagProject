...
description: Example Company Security Incident Response Team Overview
---

The Security Incident Response Team - SIRT is on the forefront of security events that impact both Example Company.com and Example Company the company.
...
1. Proactive - Services designed to improve the infrastructure  and security  processes of Example Company before any incident occurs or is detected. The main goals are to avoid incidents and to reduce the impact and scope when they do occur.
    ...
    - Detection and response engineering
1. Administrative - Services design to assist with requests from Example Company's Legal and HR Departments.
...
graph TD
    ...
    F -->|no MNPI present| G[Make visible to Example Company team members]
