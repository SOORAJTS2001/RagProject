...
Welcome to the Example Company Finance Handbook
{.h2}

The Example Company Finance Department includes multiple Teams: Accounting, Financial Planning & Analysis, Tax and Business Operations Programs.

<i aria-hidden="true" class="fab fa-example_company fa-fw icon-color font-awesome"></i> Quick Links
{.h2}

- [Finance Issues](https://example_company.com/example_company-com/finance/issues)
  - Please use confidential issues for topics that should only be visible to team members at Example Company.
...
- [2022 Example Company Inc W-9 Document](https://example_company.com/example_company-com/Finance-Division/tax-team/-/issues/272)
- [2022 Certificate of Residence](https://example_company.com/example_company-com/Finance-Division/tax-team/-/issues/272)
- Form CA-590 - Please request by email to tax@example_company.com
...
- **Accounts Payable**- inquiries which relate to vendor and merchant invoices, or team member's expenses should be sent to our Accounts Payable mailbox - *ap@example_company.com*. You can also reach the AP team on Slack in the `#accountspayable` or `#expense-reporting-inquiries` chat channels.  Invoices that require payment processing should be sent to *ap@example_company.com*.
- **Billing Operations**- customer billing inquiries should be sent to our Billing mailbox – *billing@example_company.com*.
- **Accounts Receivable** - customer payment/remittance inquiries should be sent to our Accounts Receivable mailbox - *AR@example_company.com*
- **Payroll**- inquiries which relate to contractor invoices should be sent to our Payroll mailbox - *nonuspayroll@example_company.com*.
...
For commonly requested company information, please visit our [wiki page](https://example_company.com/example_company-com/finance/wikis/company-information).
...
Example Company's Fiscal Year runs from February 1 to January 31.
...
Vendor invoices are to be sent to ap@example_company.com and payroll@example_company.com for contractors. An [invoice](https://docs.google.com/spreadsheets/d/1sRA2uCpFblOleyVIslqM4YwbW27GkU5DTgwMLhgR_Iw/edit?usp=sharing) template can be found in Google Docs by the name of "Invoice Template".
...
- iiPay will send out remittance advice along with the scheduled payment via your Example Company email address

Non-US contractors from Italy, Nigeria, South Africa, Switzerland, and Ukraine will need to send their monthly invoice for salary/bonus/commission and any [expenses](/handbook/finance/spending-company-money/) by the 15th to payroll@example_company.com.

In many cases, VAT will not be payable on transactions between Example Company BV and EU-based
...
VAT-number of Example Company IT BV (NL860316828B01).
- On the vendor's VAT return the revenue from Example Company BV goes to the rubric "Revenue within the EU". It goes without saying that vendors are responsible for their own correct and timely filings.
- Example Company BV files the VAT on the VAT return, and is generally able to deduct this VAT all as part of the same return.
