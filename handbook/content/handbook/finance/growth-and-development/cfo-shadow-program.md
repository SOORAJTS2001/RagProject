...
### Create an onboarding and offboarding issue
 ...
 We currently track onboarding and offboarding in the [cfo-shadow](https://example_company.com/example_company-com/Finance-Division/cfo-shadow) project.  For questions, reach out to the [Sr EBA to the CFO](/handbook/eba/#e-group-member-ebas) in the `#cfo-shadow` channel
...
1. Meetings with those outside of Example Company may not be on Zoom. Prior to the call, check the CFO's calendar and load any other conferencing programs that may be needed. It may be necessary to dial in via phone for audio-conferences. If you have any problems confirming the link, reach out to the `#cfo-shadow` slack channel.
...
1. Download [setalarm](https://example_company.com/example_company-com/content-sites/handbook/-/blob/main/scripts/setalarm.sh), making sure to preserve the .sh extension. (recommended within your Home folder for easy access)
