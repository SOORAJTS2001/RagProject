...
decription: >-
  This page contains Example Company's Navan Physical Card guidelines and procedures.
---
...
- To bypass the Example Company Procurement process.
...
- If a charge is made in error, please reach out to expenses@example_company.com on the process to reimburse Example Company. It is an arduous process, so we ask to avoid this at all cost.
...
### Gift Card Purchases to Non-Example Company employees
...
- If any charges/expenses are rejected, the cardholder is responsible to reimburse Example Company.
...
- An authorized user must follow Example Company's Code of Business Conduct and Ethics as these cards are considered Example Company Property.
- Any reports with continuous violations to our policy will be subject to management review and could be taken away for non-compliance.
- A cardholder must detail any disputed transaction in writing to expenses@example_company.com with a copy to the issuing bank to resolve any disputes. The cardholder must ensure that a refund, if processed, should be in favor of Example Company.
...
- At the earliest opportunity, a written notification must also be given to Expenses@Example Company.com  and Card administrator so that the cancellation of the card may be confirmed and a reconciliation of the card account from the date the card was lost or stolen may be performed.

### 8.5 Cancellation of Card

- Navan Physical Cards will be automatically deactivated by the system once the cardholder leaves Example Company (as it is integrated with Workday).
