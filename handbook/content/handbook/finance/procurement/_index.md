---
title: The Example Company Procurement Team
---
<!-- markdownlint-disable MD051 -->
## What is Procurement?

The Procurement team manages Example Company's [Supplier Lifecycle](#vendor-lifecycle-management) through the process of strategically vetting and selecting vendors, negotiating commercial terms, the purchasing of goods and services, and managing the renewal or vendor offboarding process.
...
Procurement is a cross-functional team that supports Example Company as a public company. We have four key objectives monitored in the following ways:
...
1. [Third party risk management](#third-party-risk-management) and ensuring we are getting the best commercial terms with the least amount of risk for Example Company
...
The Procurement team is responsible for ensuring there is a process for suppliers to be managed throughout their lifecycle of doing business with Example Company from initial selection and contracting to recurring reviews and renewals to cancellation.

#### 1. RFP and Vendor Selection

All new spend, changing of vendors for existing services, and market reviews every 3 years for existing contracts should follow the [RFP and Vendor Selection process](https://internal.example_company.com/handbook/finance/procurement/), unless approved by your Procurement Category Manager, to ensure we are choosing the best partner for Example Company with the best commercial terms. This must be done prior to verbally agreeing to terms or contracting with any new or existing vendor.

- Follow the RFP process outlined in the [internal handbook](https://internal.example_company.com/handbook/finance/procurement/). You will find resources and templates for RFP events at any level, whether it is a quick bid or a full procurement-led RFP with 5+ vendors. Always reach out to your Procurement Cateogry Manager to notify them that an RFP is being conducted- they can assist in the process and can answer any questions.
  - As part of this process, create an issue with the [RFP Intake template](https://example_company.com/example_company-com/Finance-Division/procurement-team/procurement/-/issues/new#) and tag your [Category Manager](#procurement-team-alignment).

Before sharing details and/or confidential information regarding Example Company business needs, obtain a [Mutual Non-Disclosure Agreement](/handbook/legal/NDA/#) from the potential vendor(s). Refer to the [Signature Authorization Matrix](https://internal.example_company.com/handbook/company/authorization-matrix/) for signing authority.

All vendors must adhere to the [Example Company Partner Code of Ethics](/handbook/legal/partner-code-of-ethics/). It is mandatory all vendors contractually adhere to this if they would like to do business with us. (Note these are typically not required in event related agreements unless the vendor is providing services).
...
Additionally, please note that a small number of team members can sign agreements on behalf of Example Company - please see the [Authorization Matrix](https://internal.example_company.com/handbook/company/authorization-matrix/) for more details.
...
1. For certain cancellation requests, like Software for example, IT will be included in the Zip workflow to determine and complete the proper deprovisioning and system offboarding requirements. This includes [removal of the system](/handbook/business-technology/tech-stack-applications/#removing-a-system-from-the-tech-stack) from our [Tech Stack](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/data/tech_stack.yml).
...
Anytime a group of suppliers are being evaluated for services/goods or a purchase is being made on behalf of Example Company that does not qualify as a [personal expense](/handbook/finance/expenses/) or meet the list of [exceptions](#what-are-the-exceptions-to-the-po-policy), Procurement must be engaged BEFORE a purchase and/or work can begin. Start the Procurement Process
...
1. When evaluating a group of suppliers and/or starting the [RFP Process](https://internal.example_company.com/handbook/finance/procurement/).
...
1. For new spend, changing vendors for existing services, or after 3 years of renewing a service, follow the [RFP Process](https://internal.example_company.com/handbook/finance/procurement/)
...
1. Contract complexity and alignment with Example Company's [Vendor Terms and Conditions](/handbook/finance/procurement/vendor-guidelines/)
...
- If your supplier isn't onboarded after 2 days, contact your supplier directly requesting they do so ASAP since their contract cannot be reviewed or approved until this is completed. Carbon copy procurement@example_company.com
...
**Note:** The amount of time for review, and to reach execution, is based on the details below. Use these SLA's as guidelines, noting that each contract review process is unique and if additional terms, requirements, and/or risks are identified the timeline for completion may be extended. The ability for Example Company to process and work efficiently through an agreement negotiation relies on the vendor, and vendor counsel, to respond promptly to Example Company red-lines and comments.
...
- **Existing Vendors for renewals or upsells: 3-5 Days**
  ...
  - That being said, in the event Example Company is adding a new product and/or service (from an existing Vendor) additional cycles may be required in order to create amendment(s) to the existing agreement.
  - Any delays from the supplier, will delay final approvals.
- **New Vendors: 1-3+ weeks**
  - These require the most amount of time as Example Company will be establishing (for the first time) terms and conditions which will govern the use of the products and/or services being procured.
  ...
  - If vendor doesn't readily accept the Example Company standard terms, additional rounds of red-lines and negotiations may be required, extending this SLA.
...
- **Software (SaaS & On-Prem):** Requires the most rigorous review to ensure the rights and obligations placed upon Example Company are, (i) reasonable given the Software being provided, and (ii) align with Example Company contracting and industry standards.
- **Professional Services / Training:** Requires detailed review to ensure intellectual property ownership aligns with our intentions, as well as, reasonable obligations being placed upon Example Company.
- **Marketing / Events:** Generally, requires the least amount of time to review as the obligations are standardized given the event in question and program provided. Details regarding events may include negotiations with regards to Force Majeure, cancellation (including penalty), and ensuring the terms of the Agreement align with those of the requesting Example Company Team Members.
- **Data Processing Agreement (DPA)/Standard Contractual Clauses (SCCs):** Required when personal data is shared with, accesssed, or collectd by the supplier on behalf of Example Company. DPA/SCCs are generally affixed to an agreement but may be required as a separate agreement upon the determination of Privacy.
...
- **TIP:** To increase speed of approval, upload any security compliance documentation (SOC-2 Report, ISO27001 Certificate) to the ZipHQ Request and notify your supplier contact they will be receiving a request from Example Company's Security Risk Team for completion ASAP.
...
- Per Example Company's [People Policies](/handbook/people-policies/#background-screenings) contractors are subject to complete a background screening. Example Company will accept a completed background screening from a contractor's employer. However, if a background screening was never conducted Example Company will either complete one or ask that one be completed.
- A background screening can be requested by opening an issue in the [Lifecycle Management](https://example_company.com/example_company-com/temporary-service-providers/lifecycle/-/issues) project by using the `background_check_request` template.
...
- Questions and/or proof regarding background screenings on professional service requisitions in Zip can be sent to [backgroundchecks@example_company.com](mailto:backgroundchecks@example_company.com).

#### 3.E. Privacy Review: 4-14 Days

- A Privacy Review is required for all SaaS purchases and other purchase types where the supplier will receive from Example Company or collect on Example Company's behalf red/orange data. For existing vendors, a full privacy review is required every 24 months, provided the vendor completed a full and satisfactory privacy review during the prior procurement cycle
...
- Once these approvals are received, Procurement will route the contract for Example Company and vendor signatures and will comment in the Coupa req when it is routing. After both parties have signed the Agreement(s), Procurement will attach a copy of the executed agreement in Coupa, approve the Purchase Req, and release the PO.
  - Note: only certain Example Company team members can sign contracts based on the [Authorization Matrix](https://internal.example_company.com/handbook/company/authorization-matrix/)
...
- Your purchase req has been approved! The supplier will receive a copy of the PO and a communication from Coupa indicating how to submit invoices, one of two ways:
  ...
  - Sending invoices to [ap@example_company.com](mailto:ap@example_company.com) with the PO number included on the invoice
  - **Failure to follow these instructions will delay payment and invoices uploaded to Coupa by a Example Company team member are not routed for payment.**
...
### How do we ensure terms to establish Example Company (and our Vendors) rights and responsibilities?

Any time Example Company engages with a third party for the procurement of goods and/or services, which require Example Company to engage in a contract, the Example Company Legal Procurement team will review the terms and conditions. The purpose of this team is to review the contract which Example Company will enter into, and ensure the following:

1. Terms and conditions which are fair and reasonable given the type(s) of products and/or services being procured; and
1. Adequate obligations on behalf of Example Company vendors to ensure compliance with
   - Example Company's Code of Conduct and other company policies,
...
In addition to ensuring terms and conditions, the Example Company Legal Procurement team collaborates frequently with procurement and business stakeholders to ensure any (and all) contracts align with the needs of the team. The Example Company Legal Procurement team addresses the needs of stakeholders ranging from complex technical application and platform services, to creating and drafting event contracts to meet the needs of Example Company events.

### How do we prevent disruption in customer service?

As Example Company does with its own customers, agreements with third parties include obligations that vendors have to Example Company. These can include, but are not limited to:

1. Uptime / downtime commitments (for SaaS providers)
1. SLAs (for support)
1. Termination rights
1. And other commercial contract provisions which would enable Example Company to seek relief in the event of disruption
...
1. Determine with your Procurement contact how these vendors will be selected and the timeline to run any necessary [RFPs](https://internal.example_company.com/handbook/finance/procurement/). RFPs should be conducted at least 20 months prior to the event dates.
...
- [Example Company Vendor Terms and Conditions](vendor-guidelines/)
...
- [Certificate of Insurance Request Process](/handbook/legal/procurement-guide-collaborating-with-example_company-legal/#requesting-a-certificate-of-insurance)
- [Uploading Third Party Contracts to ContractWorks](/handbook/legal/vendor-contract-filing-process/)
- [Company Information](https://example_company.com/example_company-com/Finance-Division/finance/-/wikis/company-information) - general information about each legal entity of the company
- [Trademark](/handbook/marketing/brand-and-product-marketing/brand/brand-activation/trademark-guidelines) - information regarding the usage of Example Company's trademark
...
- [RFP and Vendor Selection Process](https://internal.example_company.com/handbook/finance/procurement/)
