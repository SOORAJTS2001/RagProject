...
- For these discussions, stakeholders will use a private namespace called [Sales Event Planning Private](https://example_company.com/sales-events-planning). For each event type (e.g., Sales Kick-off, QBR...etc.) a "Project" will be created.
