...
description: "The page outlines the current and planned utilization of operational data at Example Company, including Product, Sales, Customer Success, and Marketing."
---
...
Enhance customers' ability to realize value from the Example Company platform swiftly, ensuring a seamless journey towards their desired business outcomes. We are committed to providing a world-class customer experience by leveraging insights derived from product usage data.

2. Enhance Value, Quality, and Usability:
Utilize data-driven insights into customer interactions with Example Company to continually improve the value proposition, quality standards, and usability of our platform. By closely analyzing how customers engage with Example Company features, we strive to enhance their experience and satisfaction.
...
By aligning our efforts with these objectives, we endeavor to optimize customer adoption, satisfaction, and overall success with the Example Company platform.

## Benefits

### Customer

Understanding a customer's use of the Example Company platform enables Example Company to:

- Ensure expected value is delivered through the adoption of the Example Company platform
...
- Identify adoption issues, delays, or barriers to trigger assistance by Example Company team members or digital content
...
The benefit to Example Company is based on the premise that customers will renew and expand if they realize continuous value with a positive experience and are able to achieve their business outcomes and goals with the platform. Additionally, the data can be used to:
...
*Note: The use cases, approaches, and metrics below include current and planned use cases. The following are some examples of how Example Company may use operational data. Use cases may also be dependent on customer settings or consents the customer has provided to Example Company.*
...
- Identify customers who are using certain Example Company stages or use cases for feedback (through surveys, interviews, etc.)
...
- [xMAU](https://internal.example_company.com/handbook/company/performance-indicators/product/#three-versions-of-xmau) leverages usage stats and is a key performance indicator (KPI) for the Product Team
...
The collection and use of operational data will governed in accordance with the [Example Company Privacy Policy](https://about.example_company.com/privacy/).
...
- [Metrics Dictionary](https://docs.example_company.com/ee/development/internal_analytics/metrics/metrics_dictionary.html)
