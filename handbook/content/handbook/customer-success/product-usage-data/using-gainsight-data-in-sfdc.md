...
description: "This page is intended for the broader Example Company team to know what Gainsight metrics, fields, entries, and other attributes are available to them in Salesforce. Example: With syncing customer health to Salesforce, it is important to know what those fields are and how to use them."
---
...
This page is intended for the broader Example Company team to know what Gainsight metrics, fields, entries, and other attributes are available to them in Salesforce. Example: with syncing customer health to Salesforce, it is important to know what those fields are and how to use them.
...
| [GS] Geo? | Is your customer using Geo? Manually filled by the CSM |  | [Link](https://about.example_company.com/solutions/geo/) |
| [GS] Example Company Issue Link | Account related Example Company Issue(s) |  |  |
| [GS] Google Doc Notes | Google Doc Notes URL Manually filled by the CSM |  |  |
| [GS] High Availability? | Does your customer require High Availability (HA) solutions and/or zero-downtime upgrade? Manually filled by the CSM |  | [Link](https://docs.example_company.com/ee/administration/reference_architectures/) |
...
| [GS] Triage Issue URL  | Deep link to triage issue. Remove link once triage period is complete. Manually filled by the CSM | Quick link to the Example Company triage issue if the customer is at-risk | [Link](/handbook/sales/field-operations/customer-success-operations/gainsight/#gainsight-to-salesforce-sync-data) |
...
| Field Name | Description | Best Practices | Reference |
|:---|:---|:---|:---|
| [GS] Architecture Diagram Link | The URL for the customer's architectural diagram, whether housed in Example Company or elsewhere. Manually filled by the CSM  |  |[Link](/handbook/sales/field-operations/customer-success-operations/gainsight/#gainsight-to-salesforce-sync-data)|
...
| [GS] Health: CI  | Automated scoring of the customer's usage of the CI use case. See Handbook for details | Helpful indicator to know if the customer is using CI across their team. Since CI is a sticky feature in Example Company, this is a good indicator of risk and strength for an existing customer |[Link](/handbook/customer-success/customer-health-scoring/#devops-score)|
...
| [GS] Health: User Engagement | To measure the overall user-level engagement with Example Company, irrespective of use cases. | Useful to know how many users are logging in and active within Example Company |[Link](/handbook/customer-success/csm/health-score-triage/#gainsight-scorecard-attributes-and-calculations)|
...
| Example Company Role | Determines the level of access assigned to any specific user in a business | [Link](/handbook/sales/field-operations/customer-success-operations/cs-ops-programs/#example_company-admin-contacts)  |
...
| Survey Results | These surveys are used to measure customer loyalty, satisfaction, and enthusiasm with Example Company and can act as an early warning system about a customer's adoption.  | [Link](/handbook/sales/field-operations/customer-success-operations/cs-ops-programs/nps-csat-scores/)|
