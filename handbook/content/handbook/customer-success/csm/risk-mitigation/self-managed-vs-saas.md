...
- **Infrastructure Cost Savings**
  - They do not need to pay for infrastructure to host their Example Company instance, or employees to manage this infrastructure
- **Mitigate Administration Issues**
  - Customers do not necessarily want to manage being a Example Company admin
- **Have Latest Features**
  - Customers will always be on the latest version of Example Company
...
1. What are you hoping to accomplish as a result of moving to SaaS?
   - Infrastructure cost savings?
   - Automatic Example Company version upgrades to stay up-to-date?
...
1. What features are you using on the admin panel?
   ...
   - Are you utilizing the Example Company API to do things that require admin privileges?
...
1. Do your employees ever need to access your code base off of the corporate network?
   - *If the customer answers YES, we DO NOT need to explore example_company-sshd and the IP allowlisting bug, since they would be accessing the code base outside of an allow-listed VPN.*
