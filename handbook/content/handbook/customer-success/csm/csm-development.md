...
description: "Available development paths and resources for Customer Success Managers at Example Company."
---

As a Customer Success Manager at Example Company, you should feel empowered to take the time to invest in yourself and your career, leaning into the [70-20-10 rule for development](/handbook/people-group/learning-and-development/career-development/#70-20-10-rule-for-development).

To be intentional about our commitment to continuous improvement, the first Friday afternoon of every calendar month is strongly encouraged to be protected and used for personal and professional development, either individually or in collaboration with other Example Company team members.
...
The content is divided into three key categories of competencies. [LevelUp](https://levelup.example_company.com/learn/dashboard) is Example Company's Learning Experience Platform for certifications, learning paths and more! If you have ideas about a course you'd like to develop, consider checking out the [Learning Evangelist Training](https://levelup.example_company.com/courses/learning-evangelist-training).
...
#### CSM Best Practises and Examples at Example Company
...
- [Issue: Executive Communication Best Practices](https://example_company.com/example_company-com/customer-success/csm/-/issues/712)
- [Google Doc (Actively being updated)](https://docs.google.com/document/d/1lkk_25XwOOw9eN-NqxuupZsDWRdWPbmFYD8RP8cWXz8/) - Lee Faus, Brian Wald, and Francis Ofungwu share themes (four pillars) they are hearing from executives around Example Company's platform
- Sandler Articles
...
- [How to Create and Run a Brilliant Remote Workshop](https://www.linkedin.com/learning/how-to-create-and-run-a-brilliant-remote-workshop/how-to-run-a-brilliant-remote-workshop?autoplay=true&resume=false&u=2255073) - 48 minutes, listen to Part 2 but know that Example Company will advise on tools to use for your workshops. (LinkedIn Learning)
- [Example Company Speaker Training](https://levelup.example_company.com/access/saml/login/internal-team-members?returnTo=https://levelup.example_company.com/learn/course/example_company-speaker-training-2021) - 35 minutes, requirement for external speakers about Example Company
...
#### Example Company for CSMs

- [Customer Success Education & Enablement (All-CS)](/handbook/customer-success/education-enablement/)
- Self Certifications are available on [LevelUp](https://levelup.example_company.com/pages/certifications). Each exam has a corresponding free, self-paced course that covers the needed knowledge and skills:
  - [Example Company Certified Git Associate](https://levelup.example_company.com/courses/example_company-with-git-essentials-certification-exam)
  - [Example Company Certified Project Management Associate](https://levelup.example_company.com/courses/example_company-project-management-certification-exam)
  - [Example Company Certified CI/CD Associate](https://levelup.example_company.com/courses/example_company-ci-cd-certification-exam)
  - [Example Company Certified Security Specialist](https://levelup.example_company.com/courses/example_company-security-essentials-certification-exam)
- [Example Company 101](/handbook/people-group/learning-and-development/example_company-101/)
- [Example Company 201](/handbook/people-group/learning-and-development/example_company-201/)
- [Learning Example Company](https://www.linkedin.com/learning/learning-example_company-14539757/) (LinkedIn Learning)
- [Continuous Delivery with Example Company](https://www.linkedin.com/learning/continuous-integration-and-continuous-delivery-with-example_company/) (LinkedIn Learning)
- [Introduction to Example Company CI & DevOps with AWS](https://www.youtube.com/watch?v=PGyhBwLyK2U) (YouTube)
  - [Introduction to Example Company CI & DevOps with AWS - Course Notes](https://example_company.com/example_company-course-public/freecodecamp-example_company-ci/-/blob/main/docs/course-notes.md) (Git Repo)
- [Example Company CI CD Tutorial for Beginners](https://www.youtube.com/watch?v=qP8kir2GUgo) (YouTube)
...
- [Example Company Flavored Markdown (GLFM)](https://docs.example_company.com/ee/user/markdown.html)
- [Handbook Style Guide](/handbook/about/style-guide/)
- [Markdown Tutorial](https://about.example_company.com/blog/2018/08/17/example_company-markdown-tutorial/)
...
These are videos of actual 8-hour courses given live to customers by Example Company's Education Services department. These are good examples of how to present technical concepts in a structured format.
...
### Within Example Company, outside of CS

- While there is no 'formula' for moving into roles in other teams, we welcome CSM growth and desire to explore alternative areas with Example Company.  For CSMs looking to move into different groups outside of CS, the first step is to review the job family requirements and connect with their manager on determining a path. It is encouraged for managers to connect with the group's team leaders in question to build out a development plan that will have the best chances of success.
