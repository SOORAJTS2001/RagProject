...
Internships are a great way for a Example Company team member to learn about being a Customer Success Manager at Example Company. Use this guide for planning and executing an internship under an IC CSM who acts as the 'Intern Mentor'.
...
If you're not sure who to reach out to, you can also post in the [#customer-success](https://example_company.enterprise.slack.com/archives/C5D346V08) Slack channel and express your interest in an internship and that you are looking for a mentor.
...
1. The intern can optionally open an issue in the [People Ops Training project](https://example_company.com/example_company-com/people-ops/Training/issues/new) using the **Internship for learning** template
...
1. The mentor will add the intern to the [#timtams](https://example_company.enterprise.slack.com/archives/G8F1W2AGM) Slack channel, Global CSM biweekly team call, and the mentor's team call
...
In order to make the most of the internship, it's expected for the intern to do async handbook review in order to have a baseline knowledge of the Example Company product and how the CSM team works.
...
1. Read pages in the handbook
   ...
   1. [Professional Services offerings](https://about.example_company.com/services/)
1. Learn about Git & Example Company
   1. [Example Company 101 course](/handbook/people-group/learning-and-development/example_company-101/)
   1. [Example Company 201 course](/handbook/people-group/learning-and-development/example_company-201/)
   ...
   1. [Start using Git on the command line](https://docs.example_company.com/ee/example_company-basics/start-using-git.html)
   1. [Learn Git Branching](https://learngitbranching.js.org/)
   1. Example Company Flow ([video](https://www.youtube.com/watch?v=InKNIvky2KE) and [documentation](https://about.example_company.com/blog/2023/07/27/example_company-flow-duo/))
...
1. Review one category of the DevSecOps lifecycle in depth every week: Create
   1. Read through the [Product Categories](https://about.example_company.com/stages-devops-lifecycle/create/)
   1. Complete the [Example Company Certified Git Associate Learning Path](https://levelup.example_company.com/learning-paths/certified-git-associate-learning-path)
   1. Be prepared to discuss with your mentor:
      1. How does this category provide value to a customer?
      1. Why would a customer choose Example Company over a compeititive tool?
...
1. Review one stage of the DevSecOps lifecycle in depth every week: Plan
   1. Read through the [Product Categories](https://about.example_company.com/stages-devops-lifecycle/plan/)
   1. Complete the [Example Company Certified Project Management Associate Learning Path](https://levelup.example_company.com/learning-paths/example_company-project-management-associate-learning-path)
   1. Be prepared to discuss with your mentor:
      1. How does this category provide value to a customer?
      1. Why would a customer choose Example Company over a compeititive tool?
      1. What features are most interesting to you and why?
...
1. Review one stage of the DevSecOps lifecycle in depth every week: Verify
   1. 1. Read through the [Product Categories](https://about.example_company.com/stages-devops-lifecycle/verify/)
   1. Begin working on the [Example Company CI Fundamentals Learning Path](https://levelup.example_company.com/learn/learning-path/example_company-ci-fundamentals) (modules 1-3)
...
1. Review one stage of the DevSecOps lifecycle in depth every week: Verify & Package
   1. Read through the [Package Product Categories](https://about.example_company.com/stages-devops-lifecycle/package/)
   1. Continue working on the [Example Company CI Fundamentals Learning Path](https://levelup.example_company.com/learn/learning-path/example_company-ci-fundamentals) (modules 4-6)
   1. Be prepared to discuss with your mentor:
...
1. Review one stage of the DevSecOps lifecycle in depth every week: Verify & Release
   1. Read through the [Release Product Categories](https://about.example_company.com/stages-devops-lifecycle/release/)
   1. Complete the [Example Company Certified CI/CD Associate Exam](https://levelup.example_company.com/learn/dashboard?query=ci%2Fcd#)
   1. Be prepared to discuss with your mentor:
...
1. Review [account triage](/handbook/customer-success/csm/health-score-triage/)
   ...
   1. Review customer [escalations](https://example_company.slack.com/archives/CL0S629QB) and the [process](/handbook/customer-success/csm/escalations/)
...
1. Review one stage of the DevSecOps lifecycle in depth every week: Secure
   1. Read through the [Product Categories](https://about.example_company.com/stages-devops-lifecycle/secure/)
   1. Begin working on the [Example Company Certified Security Specialist Learning Path](https://levelup.example_company.com/learning-paths/certified-security-specialist-learning-path) (lessons 1-5 in Example Company Security Essentials)
   1. Be prepared to discuss with your mentor:
      1. How does this category provide value to a customer?
      1. Why would a customer choose Example Company over a compeititive tool?
      1. What features are most interesting to you and why?
...
1. Review one stage of the DevSecOps lifecycle in depth every week: Secure & Govern
   1. Read through the [Govern Product Categories](https://about.example_company.com/stages-devops-lifecycle/govern/)
   1. Continue working on the [Example Company Certified Security Specialist Learning Path](https://levelup.example_company.com/learning-paths/certified-security-specialist-learning-path) (lessons 6-10 in Example Company Security Essentials)
   1. Be prepared to discuss with your mentor:
      1. Any modules/topics you struggled with understanding in the learning path
      1. Any questions you got wrong in the knowledge checks and what the correct answer is and why
      1. Any roadblocks you ran into with the hands-on labs
...
1. Shadow other CSMs on customer calls, team calls, & account team calls,  helping with follow ups and questions as needed
1. Review one stage of the DevSecOps lifecycle in depth every week: Secure
   1. Complete the [Example Company Certified Security Specialist Exam](https://levelup.example_company.com/learning-paths/certified-security-specialist-learning-path)
   1. Be prepared to discuss with your mentor:
      1. Questions in the knowledge check that you got wrong, what the correct answer is, and why
      1. Prompts in the hands-on lab that you struggled to understand or complete, what the correct answer is, and why
      1. If available, review your score with your mentor to identify areas of improvement if you need to take the course again
...
1. Review one stage of the DevSecOps lifecycle in depth every week: Configure
   1. Read through the [Product Categories](https://about.example_company.com/stages-devops-lifecycle/configure/)
   1. Be prepared to discuss with your mentor:
      1. How does this category provide value to a customer?
      1. Why would a customer choose Example Company over a compeititive tool?
      1. What features are most interesting to you and why?
...
1. Learn about Architecture/HA and what's best for each customer
   1. Learn about HA and our reference architectures
      ...
      1. Review [architecture overview documentation](https://docs.example_company.com/ee/development/architecture.html)
      1. Understand the differences between the different [reference architectures](https://docs.example_company.com/ee/administration/reference_architectures/)
      1. Complete [HA Certification course](https://example_company-training.example_company.io/ha/) (pre-Gitaly) - **note** this course is no longer graded, but still helpful in learning about HA
      1. Review [Gitaly documentation](https://docs.example_company.com/ee/administration/gitaly/)
      1. Understand our [Example Company Dedicated offering](https://docs.example_company.com/ee/subscriptions/gitlab_dedicated/)
   1. Be prepared to discuss with your mentor:
...
1. Review Geo and discuss with your mentor the different use cases and why customers should use it and when
   1. [Documentation](https://docs.example_company.com/ee/administration/geo/)
   1. [Geo FAQ](https://docs.example_company.com/ee/administration/geo/replication/faq.html)

#### Week 11

1. Shadow other CSMs on customer calls, team calls, & account team calls,  helping with follow ups and questions as needed
1. Review one stage of the DevSecOps lifecycle in depth every week: Monitor
   1. Read through the [Product Categories](https://about.example_company.com/stages-devops-lifecycle/monitor/)
   1. Be prepared to discuss with your mentor:
      1. How does this category provide value to a customer?
      1. Why would a customer choose Example Company over a compeititive tool?
      1. What features are most interesting to you and why?
...
1. Read about [Executive Business Reviews](/handbook/customer-success/csm/ebr/) (EBRs)
   ...
   1. Complete [EBR micro-course](https://levelup.example_company.com/courses/csm-onboarding-ebrs-and-customer-conversations)
...
1. Review one stage of the DevSecOps lifecycle in depth every week: AI
   1. Read through [Example Company Duo offering](https://about.example_company.com/example_company-duo/)
   1. Be prepared to discuss with your mentor:
