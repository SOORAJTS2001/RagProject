...
description: "Results and action on the annual Example Company Engagement Survey for Customer Success Managers."
---

## Overview

Example Company conducts an annual [team member engagement survey](/handbook/people-group/engagement/) to understand what team members feel we are doing well and what things we can improve. The Customer Success Management team gathers the survey results from our team members, and identifies action items to work on over the coming year.
...
1. [This Epic board](https://example_company.com/groups/example_company-com/customer-success/-/epic_boards/14748?label_name[]=TAM) shows the relevant epics for the following points
