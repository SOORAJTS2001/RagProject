...
- [Using Gainsight at Example Company](/handbook/sales/gainsight/)
...
The videos listed here are internal to Example Company only. You will need to be logged in to the "Example Company Unfiltered" YouTube channel to access them.
...
A full list of available emails can be found in a Example Company-only [Google Doc](https://docs.google.com/document/d/1NSxAH_CynFMeHUo05_N_bsh0ZRg1xyV69174l15zYaI/edit?usp=sharing). In the future, we'll move this information to a Example Company project.
