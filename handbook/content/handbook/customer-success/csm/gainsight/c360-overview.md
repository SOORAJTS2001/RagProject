...
- Subscriptions - Example Company subscription details ([synced from Salesforce](/handbook/customer-success/csm/gainsight/#salesforce-and-zendesk-syncing))
...
- Whitespace (Use Case) - [use case technology tracking](/handbook/sales/understand-customer-example_company-use/#use-case-technology-tracking)
