...
- Do they have any other calls with Example Company apart from Cadence Calls?
...
- Who are the most important contacts within Example Company? Who should I talk to?
...
- What are their primary use cases for Example Company?
- How do they use Example Company?
...
Understand what [stages](/handbook/customer-success/csm/stage-adoption/) the customer is using on Example Company or on other tools; if any stages are unknown, ask the customer once you've started cadence calls with them.
...
Assess the environment where the customer's Example Company instance is hosted.

- Self-Managed Assessment:
  - Health Checks
  - Architecture diagrams
  - Machine specifications
  - Example Company configuration files
- Example Company.com (SaaS) Assessment:
  - Runners Evaluation
