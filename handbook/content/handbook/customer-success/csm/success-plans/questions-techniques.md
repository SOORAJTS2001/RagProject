...
This question creates an opening to explore driving additional value for the customer, with the customer leading.  From here, we can explore with the customer use cases or features they're interested in knowing more about, business problems they could solve using Example Company, or anything else related to Example Company or DevSecOps. This one question also sets you up for more targeted follow-ups.
...
Instead of asking about Example Company and how Example Company might help them, turn the conversation around to talk about their business. Listen actively, let the customer talk without interjecting, and then explore how what you heard could be activated in the Example Company platform.

- "Last time we spoke, you mentioned you had other initiatives you were working on outside of Example Company.  Would you be open to sharing what those goals are?  I would like to understand your focus now and in the future so that I can be continually bringing new features and strategies on Example Company to you as are relevant.
...
Ask your stakeholders about the metrics they care about, how they measure them now (if at all) and how Example Company can help measure those.
...
1. Are you measuring cycle time? Is this an important metric for you?
   ...
   - **Note:** There are [customizable stages](https://docs.example_company.com/ee/user/group/value_stream_analytics/#customizable-value-stream-analytics) in Premium.
...
1. Have you been able to reduce the size of your toolchain through your implementation of Example Company?
   - If not, why not?
...
1. What's important to you and how can Example Company help measure that?

## Stage Adoption

We also want to ask about Stage Adoption metrics so that we can tie their Example Company usage into Stage Adoption.
...
- **Plan**
  ...
  - What percentage of your users/teams are using Example Company for this?
...
- **Verify**
  ...
  - What percentage of projects/teams are using Example Company CI?
- **Package**
...
- **Release**
  - Are you using Example Company to deploy your applications?
  - Do you use Example Company Pages to create, manage and deploy static sites?
...
- **Configure**
  ...
  - Deploying software from Example Company CI/CD pipelines to Kubernetes
  - Using Kubernetes to manage runners attached to your Example Company instance
  - Running the Example Company application and services on a Kubernetes cluster
- **Monitor**
  - How are you monitoring the stability and performance of your Example Company instance?
...
As CSMs, customers often expect that our focus is on the technical details of their Example Company usage and environment. While we should be preprared to discuss technical and operational concerns, particularly related to Example Company implementation, we should always be thinking (and talking) about how those details relate to strategic business outcomes.
...
[Leveling up the conversation](#leveling-up-from-operationaltechnical-to-strategic) will sometimes reveal that our main points of contact are not familiar with the business outcomes that their company is trying to solve with Example Company. When that occurs, we want to identify and connect with the person who can help us understand those.
...
>
> **Customer:** We've been adding users to our Example Company instance and have seen some performance problems during times of peak usage, with occasional outages when the system is under heavy load.
>
...
>
> **Customer:** Improving Example Company's performance and reliability will make our development teams more effective, since they can count on Example Company to work well throughout the day.
>
...
By asking additional "why does this matter?" questions after the initial mention of wanting to set up Example Company with HA, the CSM in this scenario was able to get to a business outcome that comes straight from senior leadership. From here, the CSM can [ask about metrics](/handbook/sales/command-of-the-message/metrics/#connect-metrics-with-positive-business-outcomes), pain points, other tools in their DevOps workflow, and other discovery questions to understand success criteria for the business outcome.

If you'd like to see more examples of how to use the Five Whys framework and what it could look like in practice, take a look at the [Five Whys breakout session from SKO 2021](https://example_company.edcast.com/insights/breakout-leveling).

## Examples

### Customer meeting about DORA Metrics with Example Company

One of our customers has asked to have a meeting to understand what Example Company can offer related to metrics, specifically they've mentioned [Dora Metrics](https://docs.example_company.com/ee/user/analytics/ci_cd_analytics.html#dora4-metrics) as the topic of interest, their [Developer Experience Lead](/handbook/product/personas/#delaney-development-team-lead) will be attending. We can't lose the opportunity to gather valuable information to build a Metric adoption's Success Plan.
...
- Would API/export CSV from Example Company help display all data in one place?
