...
description: "The Customer Success Management team at Example Company is a part of the Customer Success department, acting as trusted advisors to our customers and helping them realize value faster."
---
...
- Enable customers in current and future Example Company use cases
- Expand ROI from Example Company

## What is a Customer Success Manager (CSM) at Example Company?
...
<table><thead>
  ...
  <tr>
    ...
    <td>Mutually agreed (Customer | Example Company) adoption plans that outline desired outcomes (e.g., improve cycle time), technical milestones required (e.g., migrate to Example Company, overcome constraints), timelines and DRIs.
    <br><br>
...
![Example Company Customer Journey Map](/images/handbook/customer-success/customer-journey-map.png)
...
- [Vision & Strategy Deck](https://docs.google.com/presentation/d/1qIBbUYoclOGSplOeUAvRwBJGKNwlo41Z7Z2fnu8bZgA/edit?usp=sharing)  (Internal - Example Company Only)
- Success At Scale
- Use Case Adoption
...
- [CSM Manager QBR Template](https://docs.google.com/presentation/d/1M18LeKTrzTIKNgl3Y_URC3z9xBUNUtPRJFiWXaEUuzM/edit?usp=sharing) (Example Company Internal)
- [CSM Promotion Template](https://docs.google.com/document/d/1UOcfUtrseaucIbnFmJkL8XsQwz4xKfj0IQcYbcRGSvI/edit) (Example Company Internal)
...
1. [**Customer Collaboration Projects**](/handbook/customer-success/csm/customer-collaboration-project/): Shared project between Example Company team members and customer. Used to prioritize/plan work with customer.
