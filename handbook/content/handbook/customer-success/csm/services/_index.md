...
description: "There are various services a Customer Success Manager will provide to ensure that customers get the best value possible out of their relationship with Example Company."
---
...
For an overview of CSM segments by ARR, please see [internal handbook](https://internal.example_company.com/handbook/customer-success/csm/#csm-segments)(Internal Example Company only)
...
- Communication
  - Frequent and honest communication with customers and internal stakeholders, so everyone knows what is happening and what to expect, in line with [Example Company communication guidelines](/handbook/communication/)
- Follow-through
...
- Internal Advocacy: CSM is the customer champion for guidance and requests, a liaison between the customer and other Example Company teams
...
- Upgrade planning (in partnership with Support)
  - Review the [Upgrade Assistance page](https://about.example_company.com/support/scheduling-upgrade-assistance/) with customers during upgrade planning to ensure a plan is in place (including a rollback strategy) and Support have enough time to review the plan
...
- Monitor SaaS based customer experience by adding them to the [Marquee Accounts alerts](https://example_company.com/example_company-com/gl-infra/marquee-account-alerts) project
