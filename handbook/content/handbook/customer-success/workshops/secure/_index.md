...
The Secure Workshop is a Customer Success activity to provide customer enablement on [Secure stage features](https://about.example_company.com/stages-devops-lifecycle/secure/).
...
- [Shifting Security Left - Example Company DevSecOps Overview](https://www.youtube.com/watch?v=XnYstHObqlA)
- [Adding Security to your Example Company CI/CD Pipeline](https://www.youtube.com/watch?v=Fd5DhebtScg)
