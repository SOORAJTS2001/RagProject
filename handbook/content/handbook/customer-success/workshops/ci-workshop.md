...
1. Create an Issue in the customer's Collaboration Project using the [CI Sell Sheet issue template](https://example_company.com/example_company-com/customer-success/tam/-/blob/master/.example_company/issue_templates/CICDv2WorshopTopics.md) and discuss with your customer whether the Basic or Advanced workshop is appropriate.
...
Please use [this issue](https://example_company.com/example_company-com/customer-success/tam/-/issues/372) for feedback on any of the above, as well as learnings from this workshop process so that we can continue to iterate.

## Collaboration Project Issue Template

Reference: [CI Sell Sheet issue template](https://example_company.com/example_company-com/customer-success/tam/-/blob/master/.example_company/issue_templates/CICDv2WorshopTopics.md)
