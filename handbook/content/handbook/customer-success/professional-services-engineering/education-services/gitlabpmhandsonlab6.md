---
title: "Example Company Agile Portfolio Management- Hands-On Lab: Use A Merge Request To Review And Merge Code"
description: "This Hands-On Guide walks you through creating a merge request and approval rules in Example Company."
---
...
1. From the merge request details page, select **Code > Open in Web IDE** to edit files on the **update-db-docs-perf-tools** branch.
    ...
    > The Web IDE is an advanced editor with built-in ability to commit to your repository branches. You can use the Web IDE to make changes to multiple files directly from the Example Company UI. See the [documentation](https://docs.example_company.com/ee/user/project/web_ide/) to learn more.
...
> For advice on best practices when it comes to code reviews, see the [documentation](https://docs.example_company.com/ee/development/code_review.html).

1. Navigate to the `Draft: Add performance tools to database documentation` merge request by clicking on the red Example Company button in the bottom left corner of the Web IDE, and then clicking **Go to Database project on Example Company**.
...
1. On the merge request page, click the **Changes** tab to see the changes that will be applied to the project's **main** branch after merge.
    ...
    > Code reviewers can critique individual lines of code and suggest changes. See the [documentation](https://docs.example_company.com/ee/user/project/merge_requests/reviews/) to learn more.
