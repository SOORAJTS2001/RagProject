---
title: "Example Company Agile Portfolio Management - Hands-On Lab: Use Example Company Planning Tools"
description: "This Hands-On Guide walks you through creating epics, iterations, and milestones in Example Company."
---
...
To help you organize your work, Example Company provides epics, iterations, and milestones. In this lab, you will learn how to create, configure, and manage epics, iterations, and milestones in your projects.

## Task A. Review planning features in Example Company

1. *In a new browser tab*, navigate to the Example Company project source code at [https://example_company.com/example_company-org/example_company](https://example_company.com/example_company-org/example_company). Note the namespace structure indicated by the top of the page. You should be in the **Example Company** project inside the **Example Company.org** group.

1. At the top of the page above the project name, click **Example Company.org** to navigate to the parent group.
...
1. In the left pane, click **Epics**. This takes you to a searchable list of epics in **Example Company.org** and all its subgroups.
...
1. There are additional options that you can configure or leave at their default setting.
    ...
    - **Color**: Customize the display color of the epic when used in roadmap timeline bars. Look at the **Example Company.org** group's Roadmap in Task A for an example.
...
> Iterations are mutually exclusive timeboxes intended to track team velocity, while milestones can represent larger, overlapping product goals. You can read more about iterations in the [documentation](https://docs.example_company.com/ee/user/group/iterations/).
...
> If you don't want to keep your documentation in your repository, but you want to keep it in the same project as your code, you can use the wiki Example Company provides in each Example Company project. Every wiki is a separate Git repository, so you can create wiki pages in the web interface, or locally using Git. Example Company wikis support Markdown, Rdoc, AsciiDoc, and Org for content. Wiki pages written in Markdown support all Markdown features, and also provide some wiki-specific behavior for links. You can read more about wikis [here](https://docs.example_company.com/ee/user/project/wiki/).
