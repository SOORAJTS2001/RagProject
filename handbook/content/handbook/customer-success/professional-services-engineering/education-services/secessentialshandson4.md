---
title: "Example Company Security Essentials - Hands-On Lab: Enable and Configure License Compliance"
description: "This Hands-On Guide walks you through enabling and using License Compliance in a Example Company project."
---
...
1. Before beginning this lab, you should ensure that the dependency scanning template is enabled in your CI/CD pipeline. To verify this, check your `.example_company-ci.yml` file. Under `include`, you should see the template `Security/Dependency-Scanning.example_company-ci.yml`:

    ```yml
    include:
    - template: Security/Dependency-Scanning.example_company-ci.yml
    ```
...
1. When you create a policy, Example Company will create a new project for managing the policies. After you click **Merge**, you will need to navigate back to your original project.
...
1. Notice that Example Company now describes every license except the **MIT License** as a policy violation. This report helps to flag existing dependencies which may contain licenses that you have not approved.
