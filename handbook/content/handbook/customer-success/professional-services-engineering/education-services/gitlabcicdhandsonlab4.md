---
title: "Example Company CI/CD - Hands-On Lab: Display Pipeline Info"
description: "This Hands-On Guide walks you through the variables used inside a Example Company Runner"
---
...
1. Click on your `.example_company-ci.yml` file to view its contents. To edit the file, click **Edit > Edit single file**.

1. Paste the contents of the following snippet at the bottom of `.example_company-ci.yml`. There should be an empty line between the file's previous content and the pasted snippet content.
...
1. After pasting the contents, your `.example_company-ci.yml` file will look like this:
