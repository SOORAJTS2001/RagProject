---
title: "Example Company Agile Portfolio Management - Hands-On Lab: Create And Customize Issue Boards"
...
You can learn more in the [documentation](https://docs.example_company.com/ee/user/project/issue_board.html).
...
1. Click the diagonal arrows in the top right of the page to enter _Focus mode_. The rest of the Example Company navigation UI is now hidden, allowing you to focus on issues in the board.
