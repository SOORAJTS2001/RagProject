---
title: "Example Company CI/CD - Hands-On Lab: Using Artifacts"
...
Artifacts in Example Company are files that are created in a job, and then passed to other jobs in later stages. An artifact in one stage cannot be passed to a job in the same stage. You can later access and download any artifacts created in a pipeline. For more information, click [here](https://docs.example_company.com/ee/ci/jobs/job_artifacts.html).

In this lab, you will learn how to create an artifact with your `.example_company-ci.yml` file. After creating the artifact, you will view the artifact in the Example Company UI.
...
1. Select your `.example_company-ci.yml` file to view its contents. Click **Edit > Edit single file**. Paste the following snippet at the end of the file.
