...
## Welcome to Example Company Professional Services Operations
...
[Internal Page](https://example_company.com/example_company-com/customer-success/professional-services-group/ps-leadership-team/ps-operations/-/wikis/home#link-professional-services-operations-useful-reference-pages)
...
The consulting operations team has a [board](https://example_company.com/example_company-com/customer-success/professional-services-group/ww-consulting/ps-plan/-/boards/3487648?label_name[]=pc-consulting-checklist) to track the scheduling progress of the consulting projects.  There is a [checklist](https://example_company.com/example_company-com/customer-success/professional-services-group/ww-consulting/ps-plan/-/blob/master/.example_company/issue_templates/pc-consulting-checklist.md) that is utilized to track the progress of each project as we work through Kantata project set up, project team assignment and partner paperwork. There is also a [Project Scheduling Intake Issue](https://example_company.com/example_company-com/customer-success/professional-services-group/ww-consulting/ps-plan/-/blob/master/.example_company/issue_templates/SchedulingPreparation.md) in which we request information pertinent to the scheduling process.
...
| [Project Scheduling Intake Issue](https://example_company.com/example_company-com/customer-success/professional-services-group/ww-consulting/ps-plan/-/blob/master/.example_company/issue_templates/SchedulingPreparation.md) populated with required details | Assigned Engagement Manager |
...
**1. Example Company lab environment invitation codes**
...
Refer to this [internal page](https://example_company.com/example_company-com/customer-success/professional-services-group/ps-leadership-team/ps-operations/-/wikis/home#calendar_spiral-training-operations) for more information on Professional Services Operations' processes.
...
To provide Kantata access to an internal Example Company team members, provide access by the following:
...
- Okta-Kantata- Users Google Group
 ...
 To provide Kantata access to a Example Company partner, provide access by the following:

- Kantata Access
  - Settings
  - Members
  - Invite Account Members
- Process a Example Company Access Request
  - Request Okta
...
- Notes are required for the PS Time Tracking Non Credit projects only, not on customer projects
  ...
  - PTO should be submitted in the time off feature in Kantata, and also follow the company guidelines, [time off process](/handbook/people-group/paid-time-off/#a-example_company-team-members-guide-to-time-off)
...
- [PS Time Tracking Non- Creditable](https://example_company.mavenlink.com/workspaces/34595955/?tab=project-workspace)
...
- All class hours are to be tracked against the task that gives the name of the training, example is Example Company Basics TRNG Hours

### Project Expenses

Refer to this [internal page](https://example_company.com/example_company-com/customer-success/professional-services-group/ps-leadership-team/ps-operations/-/wikis/Onsite-Travel-and-Expenses) for more information on onsite travel and expense processes.

If there are other questions in regards to the Example Company Travel policy, refer to the [Travel Handbook Page](/handbook/finance/travel/).
...
| Okay to Start- Light Green | Project setup complete / Welcome to Example Company Education Services email |
...
- Refer to the [Coupa handbook page](/handbook/business-technology/enterprise-applications/guides/coupa-guide/) for instructions on using Coupa, Example Company's vendor invoicing sys
...
- Notes:
  - What is the individual being hires to do
    - Example Company Customer Name- Partner Name- PSE/ PM Name
  - Are any Example Company employees already performing this service?
    - For the most part, answer "no"
  - Will Example Company provide the individual with the required hardware/ device to complete the work?
    - For the most part, answer "no"
  ...
  - Requisition Information
    - Add Partner Name
    - Description/ Item
      - Example Company -Partner Name- Customer Name- PSE/ PM Name
...
- Enter the Date Range and filter the Example Company User Type field for the partner that you wish to view.
...
- [PS automation](https://example_company.com/services-calculator/services-calculator.example_company.io) creates engagement epics in [Professional-Services-Group](https://example_company.com/groups/example_company-com/customer-success/professional-services-group/-/epics) and issues in [PS-Plan](https://example_company.com/example_company-com/customer-success/professional-services-group/ww-consulting/ps-plan/-/issues).
- It's useful to move the epics of engagements that require partner access to [Professional-Servies-Group > Consulting Delivery](https://example_company.com/groups/example_company-com/customer-success/professional-services-group/ww-consulting/-/epics)
...
- The directions do not use a [bulk edit](https://docs.example_company.com/ee/user/project/issues/managing_issues.html#bulk-edit-issues-from-a-project) due to [this epic search issue](https://example_company.com/example_company-org/example_company/-/issues/233729).

##### Directions

- Open the to-be-recreated epic in a browser tab
- Open the [destination epics list UI](https://example_company.com/groups/example_company-com/customer-success/professional-services-group/ww-consulting/-/epics) in another browser tab
  - _New Epic_
...
- For each issue in the to-be-recreated epic:
  - Browse to the issue
    - Use the `/epic <url>` [slash command](https://docs.example_company.com/ee/user/project/quick_actions.html) to move the issue to the new epic
      - e.g. `/epic https://example_company.com/groups/example_company-com/customer-success/professional-services-group/ww-consulting/-/epics/2`
