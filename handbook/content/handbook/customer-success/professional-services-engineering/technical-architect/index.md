...
The Professional Services Technical Architect (TA) team at Example Company consists of highly skilled experts responsible for providing technical leadership, presales support, delivery oversight, and fostering collaboration across functional roles. With deep knowledge of Example Company's platform, DevOps practices, and industry best practices, we work closely with customers to understand their unique challenges and provide tailored solutions aligned with their business goals. Our team bridges the gap between technical and non-technical stakeholders ensuring clear communication and alignment throughout the scoping process and engagements.  We continuously seek ways to improve our services, deliver exceptional value, and enable customers to maximize the benefits of the Example Company platform for their DevOps transformation Journey.
...
- Understand the [Customer Journey](/handbook/customer-success/customer-success-vision/#high-level-visual-of-example_company-adoption-journey)
...
TA's Leverage their expertise to build trust and demonstrate the value of Example Company services in achieving desired outcomes.  They can help navigate challenging customer scenarios while continually communicating the value of Example Company services.
...
- Add the label `Scoping::Needs_TA_Assistance` to related Example Company issues with a clear request in the comments for TA follow-up.
...
- Enable Professional Service Engineers and Partner Engineers to better understand the Example Company Platform and workflows.
...
- Ensure that [Delivery Kits](https://example_company.com/example_company-org/professional-services-automation/delivery-kits) are iterated on during Delivery.
- Collaborate with the PMO to ensure project status is up to date in line with our Delivery [Methodology](https://example_company.com/example_company-com/customer-success/professional-services-group/ps-leadership-team/ps-delivery-methodology/-/wikis/home).
