...
description: "Learn the processes and methodology that Example Company Professional Services uses to help ensure Customer Success."
---
...
[Iteration 0](professional-services-delivery-methodology/iteration-0/_index.md) includes the initial discovery and planning between the Example Company & Customer Project Team(s). This includes:
...
To prepare and deliver Iteration 0, the PM will work with the Example Company Project team to review the timeline against the agreed upon scope and dependencies. This ensures we are gathering the right information and understanding the potential risks. Allowing us to show up to Iteration 0 more aligned with our Customers and prepared to deliver against a more predictable schedule.

Proper Iteration 0 preparedness allows us to address risk early and instills confidence with our Customers.

## Managing a Project in Example Company

Example Company will be used as a project management and collaboration platform. We will be using the following features/terminology in Example Company defined below.

Please reference the following tips for [Gitlab best practices](professional-services-delivery-methodology/example_company-best-practices/_index.md) when navigating Gitlab.

How to initially configure Example Company as a Project Management tool can be found [here](professional-services-delivery-methodology/cp/_index.md).

## Project Management Mapping in Example Company

| PM Term    | Example Company Definition |
| -------- | ------- |
...
Reference [here](professional-services-delivery-methodology/agile-to-example_company-terminology/_index.md) for additional clarity around mapping Agile terminology to Gitlab.
...
- SOW-# or PO# - helps the Example Company team search for Projects within the Professional service Group
- PM name - helps the Example Company team sort by PM name
...
The [iteration schedule and cadence](professional-services-delivery-methodology/iteration-scheduling/_index.md) is first introduced in Iteration 0, and is part of the Communication Plan that lives within the Example Company Customer Project (Group). It is important the Customer agrees to an Iteration Schedule as an output of the Customer Kickoff, but should be introduced & collaborated with the Customer as part of our Stakeholder Planning meeting.
...
While the PM is expected to prepare for the various ceremonies, report on status, and work within Issues, the Example Company PSE (Professional Services Engineer) & TA (Technical Architect), along with the team members on the Customer side, are also expected to work within the planned issues (tasks) within the Project board.
...
| -------- | ------- | ------- |
| Managed in Example Company as SSOT | x | x |
| Iteration 0 | x | x |
...
1. **_Large Scale Tool Adoption -_** scaling usage of Example Company across the organization (tool adoption use case), or are
...
* Have been sold on Example Company benefits
  * One platform
...
1. Install Example Company SM / configure SasS / configure Dedicated
...
6. [Training and Education](https://university.example_company.com/)
...
5. Key Performance Indicators - [DORA metrics](https://docs.example_company.com/ee/user/analytics/dora_metrics.html)

#### Key Principles

##### A Word about Terminology

Just like Example Company in general, Professional Services follows a light-weight, iterative, process. The goal is to be efficient and effective while minimizing administrative burden.

Most agile, iterative, process methodologies (such as Scrum, SAFe, or PMI-DA), define a set of terms and conventions. So does Example Company, and there is a [simple mapping of agile to Example Company terminology](professional-services-delivery-methodology/agile-to-example_company-terminology/_index.md) that documents the differences while acknowledging that essentially their meaning is the same.

Because industry parlance and Example Company terminology only differ slightly (for example, the common industry standard term for a time-boxed development cycle is "sprint" or "iteration", whereas Example Company uses the term "milestone") PSDM uses some of the terminology interchangeably.

##### Principles

There are eight (8) key principles to make any Example Company engagement successful. These are generally acknowledged to be industry best practice, and customers that understand and fully embrace these principles are more likely to succeed. This is important for PS to stress with customers before and during engagements.
...
It is important to point out that Example Company’s PSDM is agnostic to popular implementation and process methodologies and can seamlessly be applied regardless of what the specific customer circumstances are.The steps are:
 ...
 7. [Identify metrics - make data centric decisions](https://about.example_company.com/solutions/value-stream-management/dora/)
...
It is recommended to encourage the customer to follow [Example Company Best Practices](professional-services-delivery-methodology/example_company-best-practices/_index.md).
...
4. [Sprinting](professional-services-delivery-methodology/cadence-backlog-sprints/_index.md) - The execution and delivery process for teams to **deliver the Example Company engagement**
...
* Example Company consultants are “catalysts” who show direction and provide coaching
* Focus is on setting up systems for people to work effectively
* Small, autonomous cross-functional teams deliver value constantly using Example Company, we live our values
...
* Cost savings are achieved due to a simplified tool chain using the Example Company platform -->
...
![!\[''\](/handbook/customer-success/professional-services-engineering/processes/customer-journey-mapped-ps-process.png)](<PS Delivery Customer Journey Flow - Page 1 (11).png>)
 ...
 [Source, Example Company Team Members Only](https://docs.google.com/presentation/d/1eC_ocJkzNkH4Vw3v4Vkd3S58a0NALYxXtnb6BZ7pJdc/edit?usp=sharing)
...
description: “Discover how Example Company Scopes Professional Services for customers who have requirements that fall outside the scope of the packaged services.”
---

## Overview

The purpose of this page is to document the sales-assisted selling motion used by Professional Services Engagement Managers and Regional Delivery Managers. If you're on a Example Company sales account team looking for information, try these pages on [positioning professional services](/handbook/customer-success/professional-services-engineering/positioning) or [selling professional services](/handbook/customer-success/professional-services-engineering/selling/#custom-scoped-services).
...
[Source](https://docs.google.com/presentation/d/1TOI2aoseBoyWYQC6-xpJVMknEncCNreSFfMvOHO7EBA/edit#slide=id.gbfb62d0c00_0_58) (Example Company Team Members Only)
...
Professional services can be positioned when a prospect becomes a customer (e.g. the Land of a new deal) or when an already existing customer is growing their staff or interesting in adopting new features of Example Company (e.g. expansion). The SA, SAE, AE, or CSM (e.g. "Account Team") is primarily responsible for this process, following the [Command of the Message](/handbook/sales/command-of-the-message/) and [MEDDPICC](/handbook/sales/meddppicc/) messaging frameworks.
...
Once the Engagement Manager can get buy in from the account team and/or customer on the size and activities included in the services engagement, the [SOW generation automation](https://example_company.com/services-calculator/services-calculator.example_company.io) can be run using the straw-man as an input.  The engagement manager is responsible for running this automation which can be done by following the instructions on the readme in the above project.
...
### Example Company to Example Company scoping questions
The following questions are about bringing multiple Example Company instances together into a single "parent" instance:
...
1. What is the version of every Example Company instance involved?
...
### Example Company self-managed to Example Company.com scoping questions

Self-Manged to Example Company.com questions:
...
1. Do you use other tools with Example Company. If so, which ones?
...
<!--
title: "Post-Sales"
description: "Describes the workflow governing delivery of Example Company professional service projects."
---
...
Update this below
Example Company professional services employs three different workflows that control projects for the following categories:  standard professional services, education, and dedicated engineers.  Each of these categories have unique attributes that warrant a different approach.
...
PSEs or Technical Instructors who deliver Example Company Education Services instructor-led courses can use the following workflow to ensure smooth interactions with customers. In addition, PSEs and Technical Instructors should complete these [Example Company Certified Trainer](/handbook/customer-success/professional-services-engineering/example_company-certified-trainer-process/) steps for each course they are scheduled to deliver.
...
1. During the training planning meeting, be sure to discuss and document all of the event logistics listed in the [Training Event Plan Template](https://docs.google.com/document/d/1huNauyfhFPvLCuo-9T7Ol3FtBDYowYxiP_T5ItP2FN4/edit?usp=sharing). The Project Coordinator will create a draft of the Training Event Plan prior to the meeting and update the document during the training planning meeting.
   - During the training planning meeting, the course outline and system requirements pages below are useful to use to review training logistics, topics, teleconferencing, and system requirements.
      - [Example Company with Git Fundamentals course outline](https://university.example_company.com/pages/example_company-fundamentals-training)
      - [Example Company CI/CD course outline](https://university.example_company.com/pages/ci-cd-training)
      - [Example Company Agile Portfolio Management course outline](https://university.example_company.com/pages/agile-training)
      - [Example Company Security Essentials course outline](https://university.example_company.com/pages/security-training)
      - [Example Company System Administration course outline](https://university.example_company.com/pages/system-admin-training)
      - [Example Company Duo Principles course outline](https://university.example_company.com/pages/duo-training)
      - [System Requirements](https://university.example_company.com/pages/example_company-ilt-sysreq)
...
1. Contact the Example Company Education Services team to confirm you have the latest versions of course slides and other materials.
...
1. Complete the Example Company Training Lab set up steps below. Make sure that you review the lab exercises and ensure that the labs are working properly prior to the first day of class.
...
PS uses the [Example Company Lab Environment](http://gitlabdemo.com/) as the standard environment for hands-on course lab activities and hands-on certification assessments. Follow these steps to set up your course attendees for lab access.

**1. Example Company Demo System invitation codes**
...
1. Follow the instructions on the [Example Company Lab Environment Invitation Code Redemption handbook page](/handbook/customer-success/demo-systems/#invitation-code-redemption) to redeem the invitation code and access the lab environment.
1. For any edits/extensions/etc or any custom redemption rules (different durations than our standards), contact the Example Company Professional Services Operations team for assistance.
