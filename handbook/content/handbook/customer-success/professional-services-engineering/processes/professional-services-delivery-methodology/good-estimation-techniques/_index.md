...
## Estimating Example Company Professional Services Projects

We recommend the below t-shirt sizing estimation if the Example Company and Customer Project teams decides to move forward with applying weight to Example Company Issues:
