...
description: "The Professional Services team at Example Company is a part of the Customer Success department helping customers achieve value faster."
---

The Professional Services team at Example Company is a part of the [Customer Success](/handbook/customer-success/) department.

## Quick links

Here are links to the most popular Professional Services topics.

* [Marketed Offerings](https://about.example_company.com/services/)
...
* [Example Company Technical Certifications](example_company-technical-certifications/)
...
| [Engagement Management](engagement-mgmt/) | Opportunity and SOW scoping and closing in collaboration with Example Company Sales team members |
...
Example Company Professional Services enables customers and partners to realize the full value of Example Company solutions to increase operational efficiencies, deliver better products faster, and reduce security and compliance risks.
...
1. Ensure high-quality service delivery for Example Company direct and partner delivered services

## Value of Professional Services

1. With PS engagement, customers start leveraging the full capabilities of Example Company earlier with improved proficiency, reduced risk, and increased competitive advantage.
...
1. Partners benefit from Example Company PS expertise, advocacy and credibility to help grow their business practice while helping improve customer success, and increase ARR.

## Example Company Professional Services Methodology

Example Company Professional Services offerings sold and scoped by the PS Engagement Management team in partnership with the Example Company Account teams. Services are delivered directly by Example Company team members or by partners. We are building out the partner selling and delivery process to:

* Ensure we have local coverage globally
* Scale professional services in alignment with Example Company business growth
...
Example Company Professional Services measures success through tracking business profitability and resource utilization. The targets for FY21 are as follows.
...
In simplest terms, any work done on behalf of advancing the customer engagement is considered "billable time". This includes white board time, research into features or tools, and discussion with other internal Example Company engineering teams.
...
This performance indicator measures how satisfied our customers are with their interaction with the Example Company PS team. This is based on survey responses from customers sent at the end of each engagement.  On a scale of 1-5, if the customer submits a 4 or 5, we consider this Customer to be `Satisfied` with the services delivered.

## Professional Services offerings

Example Company offers a full catalog of professional services including implementation, migration, and education delivered by Example Company experts. Click the links to learn more about our framework and for a detailed listing of our standard SKU offerings.

* [PS Offerings Framework](framework)
* [PS Standard SKUs](SKUs)
* [PS Full Catalog](https://about.example_company.com/services/catalog/)
