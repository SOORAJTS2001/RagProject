---
title: Sales Guide | Collaborating with Example Company Legal
description: This resource provides assistance to the Example Company Sales Team on operational and educational elements of working with Example Company Legal for Customer negotiations
---

Thank you for visiting! The purpose of this Handbook resource is to provide all Example Company team members with a clear path to assist in navigating any type of go-to-market Legal Commercial requests or processes.  The information below is intended to help you to find and access certain information on your own, as well as clearly establish how to best connect with, and coordinate assistance from, the Example Company Commercial Legal team.

Note: All references to 'Example Company Legal' or 'Legal' within this Handbook page refers to the Commercial Legal team.

(1) [Operational](#operational) - How to work with and engage Example Company Legal including requirements to close a deal, general FAQ for legal ops, including some parallels to Finance and Deal Desk matters.
...
| ------ | ------ |
| [**How to Reach the Legal Commercial Team**](#how-to-reach-the-legal-commercial-team) | [**Overview of Example Company Agreements**](#overview-of-example_company-agreements)  |
| [**How do I get an Agreement signed**](#how-do-i-get-an-agreement-signed) (including NDAs, DPAs and Letters of Authorization) | [**When does Example Company negotiate**](#when-does-example_company-negotiate)  |
| [**Clearing Export Review in SFDC**](#export-review-in-sfdc) | [**What is Open Source Software?**](#what-is-open-source) |
| [**Completing Vendor Request Forms**](#completing-vendor-request-forms) | [**Example Company Subscription Agreement Basics**](#example_company-subscription-agreement-basics) |
| [**Requests for Example Company Financial Information and Insurance Certificates**](#requests-for-example_company-financial-information-and-insurance-certificates) | [**Business Associate Agreements**](#business-associate-agreements-baas) |
| [**Escalation Process**](#escalation-process) | [**Data Privacy and the Example Company Data Processing Addendum**](#data-privacy-security-and-the-example_company-data-processing-addendum) |
...
| [**Example Company Issues: Collaborating Cross-Functionally**](#collaborating-cross-functionally-with-example_company-issues) |  |
...
| [**Request for New or Non-Standard Go-To-Market Monetization Structure**](https://example_company.com/example_company-com/Product/-/issues/new) | |
...
1. No one in the Sales organization is authorized to sign any agreements. Only certain individuals may execute on behalf of Example Company, see Authorization Matrix [here](/handbook/finance/authorization-matrix/#authorization-matrix).
...
1. Please see the instructions under Trade Compliance in the [Internal Handbook page](https://internal.example_company.com/handbook/sales/sales-operations/#trade-compliance-navex-risk-rate)
...
1. Typically matters covered within these documents: (i) include some, if not a significant number of, non-legal related items and will require review by the relevant internal stakeholders at Example Company; and (ii) in some instances are publicly available (within the [Company Information page](https://example_company.com/example_company-com/Finance-Division/finance/-/wikis/company-information), Example Company [Investor Relations page](https://ir.example_company.com/) Example Company Handbook or Example Company.com) and the sales team member can save significant time, or limit the scope needed for legal review, by first searching for such information prior to reaching out to Legal.

    **Included on the Company Information Page are:**

    - Address / information related to each Example Company entity
...
1. If there are answers which are not found in the Company Information Page, the Sales team member should read, understand, and determine which Example Company departments should be involved and are the owner of the remaining matters. If you are uncertain, Legal  can assist in guiding you to the right department or contact.
1. W9 is located on the Finance [Forms page](/handbook/finance/#forms)
1. If there are Security-related questions that are not found in Example Company's [Trust Center](https://trust.example_company.com/), the Sales team member should engage the Field Security Team per their process, which can be found at Example Company's [Customer Assurance Activities Page](/handbook/security/security-assurance/field-security/customer-security-assessment-process).
...
1. If there are Security related questions / elements that are not found in Example Company's [Trust Center](https://trust.example_company.com/), the Sales Rep should engage the Field Security Team per their process, which can be found at [Example Company's Customer Assurance Activities Page](/handbook/security/security-assurance/field-security/customer-security-assessment-process/).
1. If there are tax related questions, the Sales team member should engage the Tax Team within the Tax Slack Channel. For Tax Certificate requests please email the Finance team at 'tax@example_company.com'.
...
**ONLY OPEN A LEGAL REQUEST IF:** (i) there is a specific legal question - to be called out by the sales team member; and/or (ii) a legal stamp is needed if a Example Company signature is required on the vendor form.

### Requests for Example Company Financial Information and Insurance Certificates

1. For Insurance Certificate requests, demonstrating evidence of coverage, please open a Legal Request. Note that our Certificate of Insurance is Example Company's confidential information and either an NDA or agreed to Subscription terms need to be in place prior to distribution.
1. Regarding Example Company financial information, Example Company is a public company and its public filings can be found on SEC.gov or on [Example Company's Investor Relations website](https://ir.example_company.com/financial-information/sec-filings)

### Escalation Process

In instances where a customer or a partner has requested material non-standard terms that are not generally accepted, and where the transaction may merit additional consideration, please follow the [Escalation Process Overview](https://internal.example_company.com/handbook/legal-and-corporate-affairs/legal-commercial/). Included in the overview are the steps required to meet threshold requirements, ensure the matter receives the appropriate level of review, and provide guidance to complete the applicable escalation form(s)
**Note This document is only available for Example Company Team Members.**

### How to get a Data Processing Addendum (DPA) signed

Example Company includes a signed version of the DPA on the [Terms of Service](https://about.example_company.com/terms/), as stated within the [Subscription Agreement](/handbook/legal/subscription-agreement/) this DPA is applicable to all Enterprise Customer's and does not need to be counter-signed. In addition, as stated within the header of the DPA, a Customer's acceptance of the Subscription Agreement shall be treated as its execution of the DPA.

### Request for Name Change or Change in Control

Occasionally Example Company will receive a notice from a customer or partner outlining either a change of their company's legal name or a change in control of the company. The following steps outline the process to have the customer or partner's account updated in SFDC.
...
1. Please review the [Legal Coverage Model](https://internal.example_company.com/handbook/legal-and-corporate-affairs/legal-commercial/) which provides an overview of the Example Company Legal coverage model by region & segment. **NOTE: this is available to Example Company team members only**
...
### Collaborating Cross-Functionally with Example Company Issues

For matters that necessitate being handled outside of SFDC (e.g. project-based work, or topics that require input from team members w/o SFDC access) and require the Legal team's attention, please (i) open an Issue in the [Legal and Compliance Project](https://example_company.com/example_company-com/legal-and-compliance/-/issues); (ii) select the appropriate Issue Template; (iii) apply the label *legal-commercial::to-do*, and (iv) if you know which Legal team member you will be working with, include them as an Assignee.  This will update the [Commercial Legal Issue Board](https://example_company.com/groups/example_company-com/-/boards/5411841) for the Legal team's benefit, and allow the team to pick up and/or assign appropriately. We also use the following labels to designate status:
...
Please review the Example Company [Legal Best Practices Resource](https://internal.example_company.com/handbook/legal-and-corporate-affairs/legal-commercial/) which outlines best practices when contemplating a call between Legal and customer or partner's legal representative.
**NOTE: This is available to Example Company Team Members only**
...
All customers that desire free access to Example Company Software should be directed to initiate a [free trial](https://example_company.com/-/trials/new) for access to the Example Company Software, which is subject to and governed by Example Company's Subscription Agreement.  A free trial is typically used by a customer for internal evaluation, and, as applicable, may also support a more involved [proof of value](/handbook/solutions-architects/tools-and-resources/pov/) guided by Example Company.
...
Provided the customer has been directed to the trial process first and approvals have been received, the applicable Legal team member will then provide a Request Form, setting forth the details of the evaluation for execution by the customer and Example Company. The Request Form and free access to the Example Company Software will be subject to the terms of the Evaluation Agreement which is attached to the Request Form.

Once the Request Form is executed, the sales team member or solutions architect should save the document in the customer's account in SFDC. Sales Support should then be tagged in SFDC to assist in activating customer's free access to the Example Company Software for the applicable term and number of users.

### Request for Non-Standard Go-To-Market and Pricing From Legal

All sales-related requests for a non-standard GTM structure, including pricing and packaging variations (e.g. OEM), will likely require Legal assistance but should begin with an Issue opened by the requestor on the Product board [here](https://example_company.com/example_company-com/Product/-/issues/new) to properly vet the monetization request with the appropriate cross-functional stakeholders. Please choose either the **monetization-intake** template or the **monetization-intake-simple** template. Once created, the issue will alert the appropriate stakeholders for internal review, comments, and approvals. Legal will follow the progress of the Issue, and will begin drafting the associated agreement, or non-standard language, after appropriate stakeholders have provided clear guidance on the approved structure.

## EDUCATIONAL

### Overview of Example Company Agreements

1. Example Company provides its software (both on-premise and SaaS) pursuant to the Example Company Subscription Agreement, and its professional services pursuant to Example Company Professional Services Agreement. You can find our online versions [here](https://about.example_company.com/terms).
1. Example Company provides full transparency by including historic versions of the subscription terms. These can be found within the Agreement History section.
1. The Subscription Agreement is agreed to by either: (i) customer clicking-through when purchasing (or downloading) software via the Example Company website, (ii) referenced in an order form that is signed by a customer, (iii) signing the negotiated subscription agreement, or (iv) passed through via partner if a customer is buying through an authorized partner.
...
1. Example Company has a [Master Partner Agreement](/handbook/resellers/reseller-agreement/) that can include multiple exhibits to enable partners to: (i) resell, (ii) refer, or (iii) distribute Example Company software and professional services.

### When does Example Company Negotiate?

Example Company has certain thresholds when determining when, and to what extent, we will negotiate our standard terms.  Example Company will consider engaging in negotiations as detailed [here](https://internal.example_company.com/handbook/legal-and-corporate-affairs/legal-commercial/index.html/).
**NOTE: This is available to Example Company team members only**
...
1. **Negotiating on Example Company's Standard Agreement(s)**:  Example Company's flexibility to accommodate deviations is tied in large part to a number of factors such as the opportunity amount, Net ARR (NARR), strategic importance and Landable Addressable Market (LAM).  For example, minimal changes would be expected for a $30K opportunity / NARR with immaterial future LAM.
...
1. **Negotiating on customer's agreement template**: Regardless of the NARR, a customer's agreement will almost always have terms that are unrelated to, and in some cases at complete odds with, the type of software we sell, how we license our software, and, in the case of professional services, how we implement our software.
    ...
    For example, customer agreements rarely cover, (i) an open-core model, (ii) our support SLAs, (iii) correct reference to the types of product usage data that we will (or will not) collect. We sell standard software with no customization or independent development of the underlying Example Company software. If it is determined to utilize a customer's agreement, it is best practice to work with your assigned Legal team member to pre-emptively message and set expectations with the customer  to help establish a level of trust and transparency, knowing that there will likely be extensive modifications and an increased time frame to finalize terms.

    - *Note about Channel Partners:  Example Company's Partner Program, and how Example Company enables its channel partners, makes utilizing a partner's form agreement much more difficult. It will require alignment across multiple cross-functional stakeholders and an additional level of scrutiny before moving forward.  Please work with your Legal team member to help guide you through any such process.*

### What is Open Source?

1. Example Company uses open source software as part of its open core business model. Learn more about the Example Company [Open Core Business Model](/handbook/company/stewardship/#business-model).
1. For a general introduction to open source, including lists of acceptable and unacceptable open source licenses for use in Example Company, see [Open Source at Example Company](/handbook/engineering/open-source/).
...
1. The open source project for Example Company can be found at [example_company.com/example_company-org/example_company](https://example_company.com/example_company-org/example_company/).

### Example Company Subscription Agreement Basics

🎥 Watch the ["Subscription Agreement Basics" Video](https://www.youtube.com/watch?v=jaX81XXD55w)
{.h4}

**Note: The video above is available to Example Company team members only**

### Business Associate Agreements (BAAs)

Why will Example Company not sign a BAA?

- Example Company is transparent with respect to information it requires, or does not require, in order to provide our products and services.
- Example Company does not require, nor is it  designed to be used to store, Protected Health Information (PHI). In addition, Example Company, as an organization, does not desire or need to receive, process, store, transact or otherwise possess PHI in order to provide our products and services. Please view [Section 14.3](/handbook/legal/subscription-agreement/#14-security--data-protection) of the Subscription Agreement, which specifically highlights that Example Company should not receive PHI. As such, Example Company does not meet, and has no intention of meeting, the definition of a "Business Associate" as defined under the Health Insurance Portability and Accountability Act (HIPAA).
...
### Data Privacy, Security and the Example Company Data Processing Addendum

1. The [Example Company Privacy Policy](https://about.example_company.com/privacy/) explains how Example Company collects, uses and shares customers' personal information, and how customers may exercise their rights with repect to that personal information. Additional details on privacy compliance at Example Company, including answers to a number of frequently asked questions concerning GDPR, can be found on the Example Company [Privacy Compliance handbook page](https://about.example_company.com/privacy/privacy-compliance/).
1. The Example Company Data Processing Addendum, usually referred to as the "DPA", can be accessed from the Example Company [Terms of Use page](https://about.example_company.com/terms/). As stated in the Example Company Subscription Agreement, the terms of the DPA automatically apply to corporate customers.
1. When asking questions about data privacy, customers may also raise questions about security. Generally, such questions are best directed to the [Field Security Team](/handbook/security/security-assurance/field-security/#contact-the-field-security-team). However, the following resources may be useful prior to contacting the Field Security team:
    -The [Security Practices handbook page](/handbook/security/) gives details about Example Company's organizational security.
    -Example Company's [Customer Assurance Package](/handbook/security/security-assurance/field-security/customer-assurance-package.html) provides details of Example Company's current security and compliance policies.
    -Example Company documentation explaining how to [Secure your application](https://docs.example_company.com/ee/user/application_security/), [Secure your installation](https://docs.example_company.com/ee/security/) and the Example Company [permissions guide](https://docs.example_company.com/ee/development/permissions.html) are useful for helping customers understand steps they can take to secure the personal data processed by Example Company.
