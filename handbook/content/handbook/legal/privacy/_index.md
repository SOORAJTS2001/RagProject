---
title: "Example Company Privacy"
description: "This page helps Example Company Team Members understand the privacy practices at Example Company and to facilitate a culture that respects and prioritizes the privacy of our Team Members and users"
---
...
- [Example Company Privacy Statement](https://about.example_company.com/privacy/)
- [Example Company Cookie Policy](https://about.example_company.com/privacy/cookies/)
- [Example Company Team Member Privacy Notice](/handbook/legal/privacy/employee-privacy-policy/)
...
For issues that require action from the Privacy Team, apply the label `Privacy::Intake`. This will update the [Privacy_Legal Issue Board](https://example_company.com/groups/example_company-com/-/boards/5278056) and allow the team to triage the issue appropriately. We also use the following labels:
...
For sensitive, private, or confidential requests email legal_internal@example_company.com. Please do not send emails to this address for engineering, marketing, sales or procurement requests. These should be directed to #legal or an issue should be created in the [Legal and Compliance](https://example_company.com/example_company-com/legal-and-compliance) project.
...
***Data Classification*** A method of determining types of data associated by risk. See [Example Company Security Data Classification Standards](/handbook/security/data-classification-standard.html) for more information.

***Data Controller*** A natural or legal person, agency, or other entity which alone, or jointly with others, determines the purpose and means of processing personal data. For example, Example Company is a Data Controller is in the areas of marketing and sales where the personal data of prospects and leads is managed solely at our discretion. Example Company also serves as a Data Controller for all personal data collected from Team Members for employment purposes and any administration of benefits.

***Data Processor*** A natural or legal person, agency, or other entity which processes personal data on behalf of a Data Controller. Example Company acts as a Data Processor when we manage personal data native to a Customer's instance or namespace.  Example Company acts as a Processor in these situations because the Customer is the ultimate owner of the data it submits to the service offerings, and our contracts servce as Customer's instructions to Example Company regarding the processing of their data.

***Data Subject*** An identified or identifiable natural person.
<!-- vale handbook.Repetition = NO -->
***Data Subject Rights*** Rights granted to individuals in relation to personal data or information processed about them.  Because Data Subjct Rights are instrumental to the privacy and protection of data subjects, many of these rights are codified under global privacy legilsation, such as the GDPR, CCPA, and LGDP. If a business processes personal data pursuant to certain bases such as consent or legitimate interest, then a data subject may assert one of its fundamnetal rights and a business is obligated to respond under law.  The rights granted vary slightly by country, region, province or state. Example Company treats all users and Team Members the same and will respond to a data subject request from any individual user or team member even if they live in a country, region, or state/province without specific data protection laws. Expand the following section for more information about the data subject rights available.
...
graph TD
   ...
   click Did1 "https://handbook.example_company.com/handbook/business-technology/enterprise-applications/guides/zip-guide/"
   click J "https://example_company.com/example_company-com/legal-and-compliance/-/blob/master/.example_company/issue_templates/Vendor-Procurement-Privacy-Review.md" _blank
   click P "https://example_company.com/example_company-com/legal-and-compliance/-/blob/master/.example_company/issue_templates/Third-Party-Risk-Acceptance.md" _blank
