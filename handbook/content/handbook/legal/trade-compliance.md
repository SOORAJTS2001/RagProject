...
## How do trade control laws apply to Example Company Software?

Example Company Enterprise Edition, related technology, and services (collectively, "Example Company Software"), are subject to the Export Administration Regulations ("EAR"), administered by the U.S. Department of Commerce, Bureau of Industry and Security ("BIS"), and various sanctions programs administered by the U.S Treasury Department's Office of Foreign Assets Control ("OFAC"). The Example Company Community Edition is freely available to the public and is not subject to the EAR. Example Company continuosly monitors developments to these regulations to maintain compliance and to leverage any opportunity to broaden access to Example Company in a compliant manner that allows everyone to contribute.

The Example Company Software has been classified via CCATS G178430 as a 5D992.c mass market encryption product with eligibility for export to most destinations under 15 CFR 740.17(b)(1) of license exception ENC. Example Company users may not export, re-export, or transfer Example Company Software, without first obtaining authorization from the U.S. government, to (a) any U.S. embargoed country including but not limited to Cuba, Iran, North Korea, Syria, Russia, Belarus, and the Crimea, Donetsk, and Luhansk regions of Ukraine, (b) any party identified on OFAC's Specially Designated Nationals and Blocked Person list or the Department of Commerce Denied Persons, Entity, or Unverified lists, or (c) for end use involving sensitive nuclear, rocket systems, unmanned aerial vehicles, missiles, chemical or biological weapons, or for any other end use prohibited by 15 CFR 744.

Example Company provides this information, which is subject to change without notice, to facilitate Example Company users' compliance with applicable trade control law. Example Company users remain solely responsible for exporting, re-exporting, and transferring Example Company Software and any user-developed content in accordance with those regulations and should seek legal counsel as necessary.
