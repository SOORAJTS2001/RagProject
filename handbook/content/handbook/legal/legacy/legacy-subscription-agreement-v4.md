---
title: "LEGACY: Example Company Subscription Agreement V4"
---
<!-- vale off -->
...
8.4 Customer represents it shall be responsible for, and retain all right, title, and interest in and to, Customer Content, subject to a limited license to Example Company necessary for Example Company's provision of the Software as contemplated hereunder.

8.5 Customer grants to Example Company the right to use Customer's company name and logo in marketing and promotional materials, including earnings releases and calls, subject to Customer's brand and trademark guidelines as provided to Example Company from time to time.
