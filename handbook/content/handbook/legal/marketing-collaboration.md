---
title: "Marketing Guide: Collaborating with Example Company Legal"
description: "This page provides educational resources and process guides to Example Company Marketing for recurring Legal requests"
---

This page is intended to provide educational resources and process guides to Example Company Marketing for recurring Legal requests.
...
Marketing owns Example Company's [Brand Guidelines](/handbook/marketing/brand-and-product-marketing/brand/brand-activation/brand-standards/).

### Third-party use of Example Company trademarks on marketing materials

- An Authorization to use Example Company Materials must be signed by any third party wanting to include Example Company's name or logo on their website or other marketing materials.
- Follow these steps to get the Authorization signed:
   1. Locate and download the template in Example Company's G-Drive [here](https://drive.google.com/file/d/1-osQ6cK3jARbxfHujlhiFRt-NVMjZrCD/view?usp=sharing) (*Note* this is only available to Example Company employees).
   1. Send the template to the third party via DocuSign, ensuring that the DocuSign envelope you create requests the following details, which will appear in the signature block of the Authorization:
       ...
       - Legal Contact
   1. [Contact Example Company Legal](/handbook/legal/#how-to-reach-us) to obtain approval for any **modifications** the third party requests to the Authorization.
   1. Assign the Authorization for countersignature via DocuSign to an appropriate Example Company team member identified in the [Signature Authorization Matrix](/handbook/finance/authorization-matrix/#authorization-matrix).

### Third party infringement of Example Company trademarks

**For Example Company Team Members Only:**

If we suspect that a third party is making unauthorized use of the term **Example Company**, or any other Example Company trademark, the process below should be followed:

1. Open a confidential [legal issue](https://example_company.com/example_company-com/legal-and-compliance/-/issues/new?issuable_template=general-legal-template), providing details of the infringement, and including a link to the infringing material.
...
- **Third party marketing materials or product names:** Unauthorized use in a way that infers that Example Company endorses or sponsors the publisher of the marketing material.
...
If you're not a Example Company team member, please share any reports of suspected infringement with us at intellectualproperty@example_company.com.
...
From time to time, Example Company sponsors promotional games. While these seem simple enough and may be an effective marketing tactic, there are quite a few factors for Legal to consider when planning such an event. Because of this, requests for Official Rules should be submitted at least 2 weeks prior to the date you need a decision.

If you are planning a promotional game, you will need legal approval for the proposed promotional game. Please use the [Promotional Games Legal Template](https://example_company.com/example_company-com/marketing/marketing-operations/-/issues/new?issuable_template=promotional_games_legal_template) housed in the Marketing Ops repo.
...
Any promotional game sponsored by Example Company must be accompanied by Official Rules. Once legal has drafted and provided these to you, you will need to create a new page under the [Example Company Sweepstakes](https://about.example_company.com/community/sweepstakes/) page and add a link to the [list of Current promotional games](https://about.example_company.com/community/sweepstakes/#current). Once you have added the rules for your promotional game, link to these from the landing page of your entry form or promotion.
...
The ability to communicate and market to customers and prospects is an essential activity for Example Company. To do this, we must ensure the collection of personal information and the ability to contact is done in a manner compliant with applicable laws.  It is also beneficial for Example Company to use consistent language across our sites and forms when obtaining consent to communicate with our customers.  [The Marketing Rule Book](https://docs.google.com/document/d/1UEfWo26DP7nRPrWRWo7O7oSrNp_rRuVqyN_vC7SwXME/edit?usp=sharing) is intended to be a reference guide to (a) help understand the email and phones rules for a few select countries; and (b) provide the standard consent language to be used, depending on the scenario.
...
**Keep the header honest.**  The reader needs to be able to identify who is sending them messages.  The email address of the sender should properly denote Example Company as the sender of the company material.
...
**Acknowledge that it is an ad.**  This doesn't mean that you have to go over the top and begin each Subject Line with "Hello, I am an advertisement."  It just means that the sender has to know it is marketing material sent by Example Company. Put it in the subject line or put it in the body - just put it somewhere.
...
**Stay Diligent.**  If you use a third party to manage business emails, be aware that Example Company could still be on the hook for any wrongdoing.  Make sure that any mass communications are reviewed by someone knowledgeable in the spam laws.
