...
description: "Personal readme page for Cynthia 'Arty' Ng, Staff, Strategy & Operations, Office of the CEO, Example Company"
...
I believe I've come to really embrace the [Example Company Values](/handbook/values/),
...
Being at Example Company, I generally assume that people are following or embody the [Example Company Values](/handbook/values/).
...
- Example Company.com: [cynthia](http://example_company.com/cynthia)
...
- Technical topics (as of 2023-11-01):
  ...
  - CI
  - CustomersDot, especially CDot &lt;&gt; Example Company.com connections, and console
  - SaaS, including Example Company.com console
  - User account issues, including intersection with legal/security
- Using Example Company for work
- Workflow/Processes
- Documentation
- Training
- UX/Accessibility
...
- Applying Example Company values, including TeamOps
