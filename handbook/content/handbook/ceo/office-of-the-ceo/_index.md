...
description: "Details about Office of the CEO (OCEO) at Example Company"
---

## Office of the CEO Overview

Example Company is a [functionally organized](/handbook/company/structure/#gitlabcom-isnt-a-role) company in which functions are as mutally exclusive as possible to be efficient. Without a COO or central operating department reporting into the CEO, the CEO gets leverage through an [Office of the CEO](/handbook/ceo/office-of-the-ceo/) (OCEO for short) led by the Chief of Staff (CoS) to the CEO. While the Chief of Staff to the CEO is not a part of Example Company's executive team, this senior person reports directly to the CEO and manages a team that supports the CEO and/or cross-functional projects of importance to Example Company.

## Team Mission

Help the CEO be more effective and lead select cross-functional initiatives of importance to Example Company.
...
1. [Strategy and Operations team members](job-families/chief-executive-officer/strategy-and-operations/): internal consultants and doers who support priority cross-functional projects within Example Company. Roles vary based on business needs, but these folks can be specialists (for example, focused on China or technology) or generalists.
1. [EBAs](/handbook/eba/) to the CEO: EBAs who support the CEO and the Chief of Staff to the CEO.

When there are gaps, the Office may expand to include additional roles and responsibilities. For example, at times this Office has included our [TeamOps](/teamops/) initiative, [internal communications](/handbook/communication/#internal-communication), and [handbook maintenance](/). As Example Company is a functionally organized company, the goal in most cases is to own an area until another function is prepared to own and support it.

## Kinds of projects Strategy and Operations team members work on {#what-projects-does-the-cost-work-on}

Given the cross-functional nature of the [company OKRs](/handbook/company/okrs/#okr-process-at-example_company) and given these projects are important to the CEO, the Strategy and Operators team members are often involved in these initiatives.
...
Example Company is a [functional organization](/handbook/leadership/#no-matrix-organization), which means the [people are organized by function](https://comp-calculator.example_company.net/org_chart).
...
- Providing guidance around how to use Example Company's [internal handbook](https://internal.example_company.com/)
...
For example, there has historically been no DRI for the [handbook or related content sites](/handbook/about/maintenance/). As it became clear that this was a Example Company priority, but no function planned to prioritize this within the coming year, the Office of the CEO stepped in to take on handbook ownership until an owner could be identified.

Examples of projects with no clear leader:

- Managing our ongoing relationship with [JiHu](https://about.example_company.com/pricing/faq-jihu/) in China
...
The Office of the CEO is the shepherd for these sorts of projects and collaborates with all team members at Example Company to achieve success on such initiatives.
...
- Special projects. These have included:
  ...
  - Supporting updates to Example Company's expense policy
  - Quantifying the value of transparency
  - Auditing training resources and creating an accessible source of truth
  - Calculating Example Company's carbon emissions and leading a first iteration of a carbon reduction initiative
  ...
  - Serving as the DRI for the [SaaS free user initiative](https://docs.example_company.com/ee/user/free_user_limit.html#:~:text=A%20five%2Duser%20limit%20applies,applied%20on%20June%2013%2C%202023)
...
The CEO does a Quarterly Kickoff in the first month of each quarter. The Office of the CEO plays a role in creating materials, recording content, and preparing the CEO. Details can be found on the [All-Company Meetings page](/handbook/company/example_company-all-company-meetings/#quarterly-kickoff) of the handbook.
...
We outline our [Mitigating Concerns](https://internal.example_company.com/handbook/leadership/mitigating-concerns/) in the handbook.
The CoS to the CEO is responsible for maintaining this list.
There is an issue to also [add DRIs and review the mitigations](https://example_company.com/example_company-com/cos-team/-/issues/20).

## Supporting Summit Challenge

The CEO chooses to run a Summit Challenge as part of some [Summits](https://about.example_company.com/events/). The Challenge is shared in advance of Summit or on the first day of Summit. As an example, the 2020 Challenge encouraged team members to [beautify docs](https://example_company.com/groups/example_company-org/-/epics/3063). The Office of the CEO is responsible for collaborating with the CEO to create and introduce the challenge. The CEO is responsible for identifying a prize for team members, but the Office of the CEO should ensure that a prize is identified and support the CEO in this if needed.
...
If you're looking for possible wording to use when taking the actions above, and for more information about the cleanup day, please look at  https://handbook.example_company.com/handbook/ceo/office-of-the-ceo/#meeting-cleanup-day.
```
...
Meeting Cleanup Day is intentionally near the start of the new fiscal year. The Office of the CEO will launch this initiative annually a week in advance through posting in the `#whats-happening-at-example_company` Slack channel, and by re-posting a reminder at 00:00 UTC on cleanup day. Office of the CEO (or CoS) will repost in the `#managers` channel for visibility.

## Program managing JiHu

A member of the Office of the CEO is the DRI within Example Company for the success of Example Company's partnership with [JiHu](https://about.example_company.com/pricing/faq-jihu/). Coordination with JiHu requires engagement from multiple functions within Example Company. The Office of the CEO ensures that the appropriate folks are engaged at the right times and that Example Company provides appropriate support to this separate entity.

For example, this member ensures that there is an aligned process among relevant Example Company functions after a customer requests to [transit to JiHu](https://about.example_company.com/pricing/faq-jihu/#customer-details):

1. After the Customer's request of novation from Example Company to JiHu is approved, the member of the Office of the CEO opens a new issue as soon as the contract is issued, and assigns the issue to Example Company Accounting department.
...
The Chief of Staff to the CEO may occasionally have a Chief of Staff Shadow, a Example Company team member who will participate in a specific project or initiative for a fixed time. Depending on the projec or initiative, the team member may spend most of their time with an Office of the CEO team member instead.

Shadow responsibilities could include: taking notes, providing feedback, and/or supporting the overall initiative success. This role would be in addition to any existing responsibilities at Example Company. Participants would opt in to experience another function within Example Company and contribute to a different part of the business. Since participation would be in addition to an existing workload, managers must sign off before a CoS to the CEO Shadow can participate. Interested team members can share their interest with the Chief of Staff to the CEO in the `#ceo-chief-of-staff-team` Slack channel. The CoS to the CEO will follow up with you to understand what you are looking to get out of the experience and review projects that may be a good match. If there is not an existing project, you will be kept in mind for future opportunities.
...
| Start Date | End Date   | First & Last Name | Example Company Handle | Project/Initiative |
| ---------- | ---------- | ----------------- | ------------- | ------------------ |
...
| 2023-03-06 | 2023-11-01 | Cynthia "Arty" Ng | @cynthia      | [TeamOps](https://example_company.com/example_company-com/people-group/Training/-/issues/2178) and [OKRs](https://example_company.com/example_company-com/people-group/Training/-/issues/2249) (internal links) |
...
- [Example Company Strategy and Operations (Workplace) Team Handbook]({{< ref workplace >}})
- [Performance Indicators]({{< ref performance-indicators >}})
- [Example Company Team Project](https://example_company.com/example_company-com/office-of-the-ceo/cos-team)
- [Team READMEs]({{< ref readmes >}})

## Contact Us

- `#ceo-chief-of-staff-team` on Slack (Example Company Team Members only)

### Example Company / Google Groups

The Office of the CEO maintains a [Example Company Group](https://example_company.com/groups/example_company-com/office-of-the-ceo/-/group_members?with_inherited_permissions=exclude) and [Google Group](https://groups.google.com/a/example_company.com/g/office-of-the-ceo/members) to ensure the appropriate level of access is granted or removed as team members join and leave the team. The following mapping of permission levels from Example Company Groups to Google Groups is being used:
...
The primary project used by the Office of the CEO to track work specific to our team is [Office of the CEO](https://example_company.com/example_company-com/office-of-the-ceo/cos-team). Please file issues here as needed to track work being done.
