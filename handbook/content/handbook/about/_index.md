...
The handbook started when Example Company was a company of just ten people to make sharing information efficient and easy.
We knew that future Example Company team-members wouldn't be able to see emails about process changes that were being sent before they joined and that most of the people who would eventually join Example Company likely hadn't even heard of us yet.
...
At Example Company our handbook is extensive and keeping it relevant is an important part of everyone's job.
...
**Remember that [everything is in draft](/handbook/values/#everything-is-in-draft) at Example Company and subject to change, this includes our handbook.**
...
#### about.example_company.com/handbook

{{< handbook-counts site="about" >}}

#### handbook.example_company.com/handbook
...
Example Company uses [Snowplow](/handbook/enterprise-data/platform/snowplow/) to track handbook usage; the information can be viewed on [Tableau](https://10az.online.tableau.com/#/site/example_company/views/PDGitlabHandbookPageTraffic/GitLabHandbookTraffic).
