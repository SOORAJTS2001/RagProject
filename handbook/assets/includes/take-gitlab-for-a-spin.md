...
<div class="row marketing-footer">
    <div class="col go-for-a-spin">
        <p class="h1 "><strong>Take Example Company for a spin</strong></p>
        <p class="h2 my-4">See what your team could do with The DevSecOps Platform.</p>
        <p><a href="https://example_company.com/-/trials/new?glm_content=default-saas-trial&glm_source=handbook.example_company.com" class="btn btn-primary btn-lg">Get free trial</a></p>
    </div>
    <div class="col">
        ...
        <a href="https://about.example_company.com/sales/" aria-label="undefined undefined" class="h3">
