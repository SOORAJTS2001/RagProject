...
Engineering Allocation is also used in short-term situations in conjunction and in support of maintaining acceptable Error Budgets for Example Company.com and our [Example Company-hosted first](/direction/#example_company-hosted-first) theme.
...
1. Open an MR to the [direction content](https://example_company.com/example_company-com/www-example_company-com/blob/master/source/direction/)
...
To see an example for an Engineering Allocation Direction page, see [Continuous Integration Scaling](https://example_company.com/example_company-com/www-example_company-com/-/blob/master/source/direction/verify/continuous_integration_scaling/index.html.md). Once the Engineering Allocation is complete, delete the direction page.
